    ...
    <StrictMode>
      ...
      <div className="adu:flex adu:flex-col adu:items-start adu:gap-8 adu:bg-page adu:p-4">
        ...
        <div className="adu:flex adu:flex-col adu:gap-2">
          <DisplayText variant="heading-sm">Sample Downloads</DisplayText>
          <div className="adu:flex adu:gap-2">
            <Button
              variant="default"
              onClick={async () => {
                try {
                  ...
                  console.log('Sample downloaded successfully');
                } catch (error) {
                  console.error('Failed to download sample:', error);
                }
              }}
            >
              Download React Sample (GET)
            </Button>
            <Button
              variant="default"
              onClick={async () => {
                try {
                  await postSample(
                    ...
                    'react-auth0-sample.zip',
                  );
                  console.log('Sample downloaded with credentials');
                } catch (error) {
                  console.error('Failed to download sample:', error);
                }
              }}
            >
              Download React Sample (POST)
            </Button>
          </div>
        </div>
