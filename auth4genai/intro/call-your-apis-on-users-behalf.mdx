...
description: "Enable your AI agents to securely call your own APIs (first-party APIs) on behalf of authenticated users."
og:title: "Call Your APIs on User's Behalf - Auth0 for AI Agents"
og:description: "Enable your AI agents to securely call your own APIs (first-party APIs) on behalf of authenticated users."
og:url: "https://auth0.com/ai/docs"
twitter:title: "Call Your APIs on User's Behalf - Auth0 for AI Agents"
twitter:description: "Enable your AI agents to securely call your own APIs (first-party APIs) on behalf of authenticated users."
