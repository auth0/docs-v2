...
<Columns cols={1}>
    <Card href="https://auth0.com/signup?onboard_app=auth_for_aa" icon={<img src="https://mintlify-assets.b-cdn.net/auth0/bannerimage.png" alt="Developer Preview Program" />} title="Developer Preview Program">
