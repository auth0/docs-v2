...
description: Implement user authentication for AI agents to ensure secure user login with social, enterprise, and custom identity providers.
sidebarTitle: User Authentication for AI Agents
og:title: "User Authentication for AI Agents - Auth0"
og:description: "Implement user authentication for AI agents to ensure secure user login with social, enterprise, and custom identity providers."
og:url: "https://auth0.com/ai/docs"
twitter:title: "User Authentication for AI Agents - Auth0"
twitter:description: "Implement user authentication for AI agents to ensure secure user login with social, enterprise, and custom identity providers."
