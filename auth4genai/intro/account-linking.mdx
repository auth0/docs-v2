...
<Frame>
  <img
    ...
    src="/img/client_initiated_account_linking_dark.png"
    alt="Client-initiated account linking flow"
  />
  <img
    className="block dark:hidden"
    src="/img/client_initiated_account_linking_light.png"
    alt="Client-initiated account linking flow"
  />
</Frame>
  ...
  <OverviewTocs
    sections={[
      ...
      },
      {
        title: "Learn more",
        links: [
          { label: "Client-Initiated Account Linking Guide", href: "/guides/client-initiated-account-linking", target: "_self" },
          { label: "User Account Linking", href: "https://auth0.com/docs/manage-users/user-accounts/user-account-linking" },
          { label: "User-Initiated Account Linking: Client-Side Implementation", href: "https://auth0.com/docs/manage-users/user-accounts/user-account-linking/user-initiated-account-linking-client-side-implementation" },
          { label: "User Account Linking: Server-Side Implementation", href: "https://auth0.com/docs/manage-users/user-accounts/user-account-linking/suggested-account-linking-server-side-implementation" }
        ]
      }
    ]}
  />
