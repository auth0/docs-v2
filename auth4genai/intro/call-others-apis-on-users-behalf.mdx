...
<Columns cols={2}>
  <Card
    ...
    href="https://auth0.com/docs/secure/call-apis-on-users-behalf/token-vault/configure-token-vault"
    icon="gear"
    horizontal
  />
  <Card
    title="Refresh Token Exchange with Token Vault"
    href="https://auth0.com/docs/secure/call-apis-on-users-behalf/token-vault/refresh-token-exchange-with-token-vault"
    icon="key"
    horizontal
  />
  <Card
    title="Access Token Exchange with Token Vault"
    href="https://auth0.com/docs/secure/call-apis-on-users-behalf/token-vault/access-token-exchange-with-token-vault"
    icon="key"
    horizontal
  />
</Columns>
