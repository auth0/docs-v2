...
og:description: "Token Vault lets your AI agent call external APIs on the user's behalf using SDKs for Python, JavaScript, and popular AI frameworks."
og:url: "https://auth0.com/ai/docs"
twitter:title: "Call Others' APIs on User's Behalf - Auth0 for AI Agents"
twitter:description: "Token Vault lets your AI agent call external APIs on the user's behalf using SDKs for Python, JavaScript, and popular AI frameworks."
