---
title: Connections
description: An Auth0 Connection is a relationship between Auth0 and a source of users, such as third-party applications (like Slack or Salesforce) or external Identity Providers (like Google or Microsoft).
og:title: "Connections for Auth0 for AI Agents"
og:description: "An Auth0 Connection is a relationship between Auth0 and a source of users, such as third-party applications or external Identity Providers."
og:url: "https://auth0.com/ai/docs"
twitter:title: "Connections for Auth0 for AI Agents"
twitter:description: "An Auth0 Connection is a relationship between Auth0 and a source of users, such as third-party applications or external Identity Providers."
