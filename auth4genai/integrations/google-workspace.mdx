...
The Google Workspace integration allows users to log in to your AI Agents using their Google Workspace identity. To complete the [Call other's APIs on user's behalf quickstart](/get-started/call-others-apis-on-users-behalf), you need to set up a Google Workspace enterprise connection.
To set up a Google Workspace enterprise connection, you must:

To set up a Google Workspace connection, you must:

- Create Google OAuth credentials with the Google Auth Platform.
- Configure and test a Google Workspace connection with the Auth0 Dashboard.
