...
<Steps>
  ...
  <Step title="Enable Connected Accounts for Token Vault">
    ...
    In **Permissions**, select <strong>Offline Access</strong>, allowing your client application to obtain an Auth0 refresh token. When you get an access token for the Google social connection, it will contain the appropriate
