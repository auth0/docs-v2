...
<Steps>
  <Step title="Spotify setup">
    ...
    4. Configure Redirect URIs:
       ...
       <FindDomainInfoBlock />
    5. When you select **Save** you will be redirected to the configuration page for the application you just created. You will see **Client ID** and can select _View Client Secret_ to see your **Client Secret**. Make sure to note them down for the next steps:
