...
<Steps>
  <Step title="X setup">
    ...
    4. Navigate to **Project and Apps** and select on your app and go to **Settings**.
    5. Go to **User authentication settings** and select **Edit**.
    6. Configure your permissions.
    7. Select **type of App** to enable **OAuth 2.0 Authentication**.
    8. Configure OAuth redirect URL:
       - Redirect URL: `https://YOUR_AUTH0_DOMAIN/login/callback`
       <FindDomainInfoBlock />
    10. Select **Save**.
    11. Still on the **App settings** page, select the **Keys and tokens** tab.
