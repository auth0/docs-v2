...
With [Auth0 SDKs](/sdks/overview), you can easily integrate with popular agentic frameworks, including [Genkit](https://firebase.google.com/docs/genkit), [LangChain](https://www.langchain.com/), [AI SDK](https://ai-sdk.dev/docs/introduction), and [LlamaIndex](https://www.llamaindex.ai/).
...
<Columns cols={1}>
  <Card title="Retrieval" icon="square-1" iconType="solid" horizontal>
    The model fetches relevant external documents from databases, APIs, or the
    web based on the user query.
  </Card>
  <Card title="Augmentation" icon="square-2" iconType="solid" horizontal>
  ...
  <Card title="Generation" icon="square-3" iconType="solid" horizontal>
