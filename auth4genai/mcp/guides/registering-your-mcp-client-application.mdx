...
og:title: "Register MCP Client Application - Auth for MCP"
og:description: "Register MCP clients so AI Agents can safely connect to your resources using OAuth 2.1."
og:url: "https://auth0.com/ai/docs"
twitter:title: "Register MCP Client Application - Auth for MCP"
twitter:description: "Register MCP clients so AI Agents can safely connect to your resources using OAuth 2.1."
permalink: "/mcp/guides/registering-your-mcp-client-application"
---
...
You can register your MCP client with Auth0 manually or dynamically. For production scenarios, we recommend using manual CIMD registration for its superior security and control.
...
- Manual client registration: Create and register an MCP client using the Auth0 Dashboard or Management API.
...
To learn more about registering applications in Auth0, read the following:
