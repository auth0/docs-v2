...
For production MCP deployments, we recommend using [manual CIMD registration](/mcp/guides/registering-your-mcp-client-application/manual-cimd-registration) instead of DCR. CIMD offers superior security with domain-verified identities, simpler credential management (register once, deploy everywhere), and eliminates the risks associated with open registration endpoints.
