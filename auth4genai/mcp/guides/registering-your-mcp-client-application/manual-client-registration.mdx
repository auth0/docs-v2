...
In manual client registration, you can register any MCP client using the Auth0 Dashboard or Management API. For production use cases, we recommend manual client registration for the following advantages:
...
To learn more, read [Applications in Auth0](/get-started/auth0-overview/create-applications).
