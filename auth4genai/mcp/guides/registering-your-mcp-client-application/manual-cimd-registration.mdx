...
- [Per-application grant](#per-application-grant): Apply granular permissions to each application in your tenant.
- [Default grant](#default-grant): Apply default permissions to all third-party applications in your tenant. 
