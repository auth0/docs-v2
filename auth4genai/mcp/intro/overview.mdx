...
description: "Secure MCP clients and servers using OAuth 2.1 and OpenID Connect with user authentication, controlled API access, and scoped token exchange."
og:title: "Secure MCP with OAuth 2.1"
og:description: "Secure MCP clients and servers using OAuth 2.1 and OpenID Connect with user authentication, controlled API access, and scoped token exchange."
og:url: "https://auth0.com/ai/docs"
twitter:title: "Secure MCP with OAuth 2.1"
twitter:description: "Secure MCP clients and servers using OAuth 2.1 and OpenID Connect with user authentication, controlled API access, and scoped token exchange."
