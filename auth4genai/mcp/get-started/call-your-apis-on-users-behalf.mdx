...
* An MCP server that calls your protected APIs on behalf of authenticated users using OBO token exchange
* Token verification configured to enforce security policies (issuer, audience, algorithm)
