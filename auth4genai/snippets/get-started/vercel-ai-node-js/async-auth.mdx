...
- `@ai-sdk/openai`: [OpenAI](https://sdk.vercel.ai/providers/ai-sdk-providers/openai) provider for the [AI SDK](https://sdk.vercel.ai/docs).
...
```
    ...
    <Step title="Integrate Auth0 AI SDK">
...
<img
  ...
  src="https://cdn.auth0.com/website/auth0-ai/assets/diagrams/async-auth-gs-light.png"
  alt="CIBA sequence diagram"
/>

<img
  className="hidden dark:block"
  src="https://cdn.auth0.com/website/auth0-ai/assets/diagrams/async-auth-gs-dark.png"
  alt="CIBA sequence diagram"
/>
</Frame>
...
Create a file at `src/index.ts` and add tool calling to the AI SDK agent using the `generateText()` or `streamText()` functions:
