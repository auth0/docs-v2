...
For `MCP_AUTH0_CLIENT_ID` and `MCP_AUTH0_CLIENT_SECRET` you will use the values obtained from the [Create an Application for your MCP server](/mcp/get-started/call-your-apis-on-users-behalf#create-an-application-for-your-mcp-server) step.
