...
import MCPGetStartedEnableIssuerParamStep from "/snippets/mcp/get-started/pre-reqs/enable-issuer-param-step.mdx";
...
<AccordionGroup>
  ...
  <Accordion title="3. Enable Include Issuer in Authorization Responses">
  <MCPGetStartedEnableIssuerParamStep />
  </Accordion>
