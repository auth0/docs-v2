...
<div className="border-t dark:border-[#2a2a2a] border-[#e8e8e8]" />
...
<Update label="Aug 25, 2025" tags={["Token Vault", "Single Page App", "Vercel AI", "React"]}>
  ...
  Check it out with our new [quickstart using Vercel AI and a React SPA.](/calling-apis/vercel-ai/get-started/call-others-apis-on-users-behalf#react-spa)
</Update>
