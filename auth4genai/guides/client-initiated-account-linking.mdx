...
description: Learn how Auth0 for AI Agents enables AI agents to link user accounts.
    ...
    sections={[
      ...
      },
      {
        ...
        links: [
          ...
          { label: "Link User Accounts", href: "https://auth0.com/docs/manage-users/user-accounts/user-account-linking/link-user-accounts" },
          { label: "Unlink User Accounts", href: "https://auth0.com/docs/manage-users/user-accounts/user-account-linking/unlink-user-accounts" }
        ]
      }
    ]}
  />
