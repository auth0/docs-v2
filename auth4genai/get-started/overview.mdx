...
<Card title ="User Authentication" icon="user" href="/intro/user-authentication" iconType="solid" vertical>
...
<Card title ="Call Your APIs on User's Behalf" icon="shapes" href="/calling-apis/langgraph/get-started/call-your-apis-on-users-behalf" iconType="solid" vertical>

Manage tokens to enable AI agents to call first-party APIs.

`NEXT.JS`  `FASTAPI` `AI SDK` `LANGGRAPH` `CLOUDFLARE AGENTS`

</Card>

<Card title ="Call Other's APIs on User's Behalf" icon="plug" href="/calling-apis/langgraph/get-started/call-others-apis-on-users-behalf" iconType="solid" vertical>
...
`NEXT.JS` `FASTAPI` `AI SDK` `LANGGRAPH`

</Card>

<Card title ="Asynchronous Authorization" icon="clock" href="/async-authorization/langgraph/get-started/asynchronous-authorization" iconType="solid" vertical>
...
<Card title ="Authorization for RAG" icon="server" href="/authorization-for-rag/langgraph/get-started/authorization-for-rag" iconType="solid" vertical>
