...
permalink: /authorization-concepts
---
...
Auth0 FGA extends ReBAC by making it simpler to express additional ABAC scenarios using [Conditions](./modeling/conditions.mdx) or [Contextual Tuples](./modeling/token-claims-contextual-tuples.mdx).
...
<CardGroup cols={2}>
  <Card title="Auth0 FGA Concepts" href="/intro/fga-concepts">
