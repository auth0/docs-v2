...
---
<<<<<<< HEAD:main/customize/custom-domains/multiple-custom-domains/mcd-use-cases.mdx
Auth0 Multiple <Tooltip tip="Custom Domain: Third-party domain with a specialized, or vanity, name." cta="View Glossary" href="/glossary?term=Custom+Domains">Custom Domains</Tooltip> (MCD) feature offers powerful flexibility, allowing organizations to manage diverse branding, regional requirements, and partner integrations all from a single Auth0 tenant. This simplifies identity management while providing a seamless, branded experience for your users.
=======
<Warning>
...
>>>>>>> 78c8fef8 (Update mcd-use-cases.mdx):main/docs/customize/custom-domains/multiple-custom-domains/mcd-use-cases.mdx
