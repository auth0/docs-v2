...
* **Non-Verifable Callback URI End-User Confirmation**: (Global) Navigate to [Auth0 Dashboard > Tenant Settings > Advanced](https://manage.auth0.com/tenant/advanced). Enable the toggle to deactivate the prompt. Diasble the toggle to activate the prompt. To learn more, review [Tenant Settings](/docs/get-started/tenant-settings).
