...
3. Réglez **Provisioning Status** à **On** afin [de provisionner tous les utilisateurs attribués](https://learn.microsoft.com/en-us/entra/identity/app-provisioning/configure-automatic-user-provisioning-portal#provisioning-status).