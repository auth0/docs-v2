---
description: Configurez TLS mutuel entre le connecteur AD/LDAP Auth0 et Auth0 en émettant un certificat client que le connecteur présente pour chaque connexion sortante.
title: Configurer l’authentification du connecteur AD/LDAP avec des certificats client
---
...
1. Accédez à [Auth0 Dashboard &gt; Authentication &gt; Enterprise &gt; Active Directory/LDAP](https://manage.auth0.com/#/connections/enterprise/ad), puis sélectionnez la connexion que vous voulez configurer.
...
2. Téléversez les certificats SSL et AC vers le connecteur AD/LDAP :
   ...
   <Frame>![Écran de configuration de l’authentification du connecteur AD/LDAP avec des certificats clients](/docs/images/cdy7uua7fh8z/2zRux90ZHATIBFWyHlodue/c426e5a475ff528a467db6409980de12/connector-client-cert-config.png)</Frame>
