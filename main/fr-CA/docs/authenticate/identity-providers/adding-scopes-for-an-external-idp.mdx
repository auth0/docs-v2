---
description: Ajoutez des scopes OAuth supplémentaires à une connexion Auth0 pour qu’un fournisseur d’identité social ou d’entreprise configuré renvoie des champs de profil et des permissions d’API.
title: Ajouter des scopes/autorisations pour appeler les API d’un fournisseur d’identité
---
