...
* Requête HTTP
* Commande cURL
* JavaScript : selon le point de terminaison, chaque extrait peut utiliser la [bibliothèque Auth0.js](https://auth0.com/docs/libraries/auth0js), du code Node.js ou du JavaScript simple
