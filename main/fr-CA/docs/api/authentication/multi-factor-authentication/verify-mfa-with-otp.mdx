...
description: "Vérifiez l’authentification multifacteur (MFA) à l’aide d’un mot de passe à usage unique (OTP) pour terminer la requête de jeton."
---
...
<ResponseSchema>
  <ResponseField name="access_token" type="string">
    Le jeton d’accès pour la session authentifiée.
  </ResponseField>
