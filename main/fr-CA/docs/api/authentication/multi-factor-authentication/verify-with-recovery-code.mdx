...
description: "Vérifiez l’authentification multifacteur (MFA) à l’aide d’un code de récupération lorsque l’appareil inscrit de l’utilisateur n’est pas accessible."
---
