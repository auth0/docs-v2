...
description: "Vérifie l’authentification multifacteur (MFA) au moyen d’un défi hors bande (OOB) (notification Push, SMS ou appel vocal). Pour vérifier la MFA à l’aide d’un..."
---
