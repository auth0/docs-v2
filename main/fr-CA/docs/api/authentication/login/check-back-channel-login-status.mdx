...
description: "Pour vérifier le statut d’un flux de connexion par canal arrière, interrogez le point de terminaison `/oauth/token` à intervalles réguliers en transmettant les éléments suivants :"
---
