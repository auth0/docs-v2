...
description: "Authentifiez un utilisateur à l’aide de ses identifiants en utilisant l’octroi avec mot de passe du propriétaire de la ressource pour les applications de confiance qui ne peuvent pas utiliser de redirection."
---
