...
description: "Envoyez les paramètres d’autorisation au moyen d’une requête POST sécurisée côté serveur afin de protéger les valeurs sensibles contre leur exposition dans le navigateur."
---
