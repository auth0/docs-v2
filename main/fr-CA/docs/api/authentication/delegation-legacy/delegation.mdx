---
title: "Délégation"
description: "Par défaut, cette fonctionnalité est désactivée pour les locataires qui n’utilisaient aucun module complémentaire au 8 juin 2017. Les anciens locataires qui utilisent actuellement un module complémentaire nécessitant..."
---
...
* La délégation n’est **pas prise en charge** dans la version 8 de [auth0.js](http://auth0.com/libraries/auth0js). Pour voir un exemple avec la version 7 de la bibliothèque, consultez [Delegation Token Request](https://auth0.com/docs/libraries/auth0js#delegation-token-request).
