...
description: "Envoyez un code à usage unique ou un Magic Link à l’adresse courriel ou au numéro de téléphone d’un utilisateur pour démarrer l’authentification Passwordless."
---
