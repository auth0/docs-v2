---
title: "Vérifier"
description: "Cette fonctionnalité est désactivée par défaut pour les nouveaux locataires depuis le 8 juin 2017. Veuillez consulter [Types d’autorisation d’application](/applications/concepts/application-grant-types)..."
---
