...
description: "Déconnectez un utilisateur à l’aide du point de terminaison de déconnexion conforme à OIDC et, au besoin, redirigez-le vers un URI post-déconnexion."
---
