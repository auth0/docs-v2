...
description: "Commencez un flux d’autorisation OAuth 2.0 en redirigeant l’utilisateur vers l’URL d’autorisation pour obtenir le consentement et un code d’autorisation."
---
