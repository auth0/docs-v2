...
* **[Ajouter l’autorisation](https://auth0.com/docs/quickstart/webapp/express/02-user-profile)** - Implémentez le contrôle d’accès basé sur les rôles
* **[Appeler des API protégées](https://auth0.com/docs/quickstart/webapp/express/03-authorization)** - Utilisez des jetons d’accès pour appeler vos API backend
