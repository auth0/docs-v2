...
description: Ce guide montre comment intégrer Auth0, ajouter l’authentification et afficher les informations du profil utilisateur dans une application Web Fastify à l’aide du SDK Fastify d’Auth0.
mode: wide
---
