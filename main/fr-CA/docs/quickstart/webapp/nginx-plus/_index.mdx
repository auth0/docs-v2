...
export const sections = [
  ...
  { id: "checkout-nginx-openid-connect-template-repository", title: "Récupérer le dépôt de modèles nginx-openid-connect" },
  { id: "configure-nginx-with-your-auth0-application-details", title: "Configurer NGINX avec les renseignements de votre application Auth0" },
...
<Recipe isSingleColumn>
  <Content>
    Ce tutoriel explique comment utiliser le module nginx-openid-connect pour ajouter l&#39;authentification et l&#39;autorisation à
    ...
    <Section id={sections[0].id} title={sections[0].title} stepNumber="1" isSingleColumn>
      Ce tutoriel et ce projet de démarrage ont été testés avec les éléments suivants :
    ...
    <Section id={sections[1].id} title={sections[1].title} stepNumber="2" isSingleColumn>
      ...
      Une fois installé, vous devez l’activer dans NGINX en ajoutant la ligne suivante au début de votre fichier
    ...
    <Section id={sections[3].id} title={sections[3].title} stepNumber="4" isSingleColumn>
      Exécutez le script configure.sh dans le dossier nginx-openid-connect pour renseigner la configuration modèle de
      ...
      Ensuite, ajoutez l’[URL de déconnexion de votre locataire](https://auth0.com/docs/api/authentication#auth0-logout) dans votre
    ...
    <Section id={sections[6].id} title={sections[6].title} stepNumber="7" isSingleColumn>
      ...
      Dans la section **Application Authentication**, réglez **Authentication Method** à None.

      <LoggedInForm />
    </Section>

    <Section id={sections[7].id} title={sections[7].title} stepNumber="8" isSingleColumn>
      Ajoutez des en-têtes supplémentaires provenant du jeton d’identité (JWT) à la cible d’amont dans votre
    ...
    * [Auth0 Dashboard](https://manage.auth0.com/dashboard/us/dev-gja8kxz4ndtex3rq) - Découvrez comment configurer et gérer votre locataire et vos applications dans Auth0
