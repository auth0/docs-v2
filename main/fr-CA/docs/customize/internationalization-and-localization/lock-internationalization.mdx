---
description: Lock v11 prend en charge plusieurs langues, permet d’ajouter d’autres fichiers de langue personnalisés et de personnaliser les valeurs de certains textes affichés dans le widget Lock.
