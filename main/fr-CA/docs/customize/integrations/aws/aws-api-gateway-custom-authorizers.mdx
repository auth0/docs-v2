---
description: Comment sécuriser les points de terminaison d’AWS API Gateway à l’aide d’autorisateurs personnalisés qui acceptent des jetons d’accès émis par Auth0.
...
1. Cliquez sur **Test** (affiché dans le volet **Client** situé au milieu de la page). Vous serez redirigé vers la page `/pets - POST - Method Test`. Faites défiler jusqu’au bas de la page et entrez l’extrait suivant dans **Request Body** :
   ...
   Le corps de la requête contient les attributs de l’animal que vous voulez ajouter à la base de données, ainsi que son prix.<Frame>![AWS API Gateway - Request Body](/docs/images/cdy7uua7fh8z/5XKCxyYc5nBCsqln27HVLF/bcd9c16f9e3405fda8cc44f455cb819b/aws-pt1-5d.png)</Frame>
