...
Consultez notre page de [dépannage](/fr-CA/docs/troubleshoot/authentication-issues/troubleshoot-authorization-extension) pour connaître les problèmes fréquemment rencontrés.
...
* [Dépanner Authorization Extension](/fr-CA/docs/troubleshoot/authentication-issues/troubleshoot-authorization-extension)