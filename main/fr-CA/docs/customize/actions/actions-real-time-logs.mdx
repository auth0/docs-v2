...
Si vous rencontrez des problèmes de connectivité avec les journaux en temps réel d’Actions, consultez notre [section de dépannage](/fr-CA/docs/troubleshoot/integration-extensibility-issues/troubleshoot-actions-real-time-logs).
