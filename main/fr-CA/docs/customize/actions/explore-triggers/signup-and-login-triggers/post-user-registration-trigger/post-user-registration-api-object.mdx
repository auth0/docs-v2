...
s&#39;il en existe un. Si un enregistrement est trouvé, la valeur mise en cache se trouve
...
`ttl` ou `expires_at` spécifiées. Si aucune durée de vie n’est indiquée, une durée de vie
...
disponibles dans des transactions ultérieures, même s’ils se trouvent encore dans leur durée de vie prévue.
