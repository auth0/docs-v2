...
#
description: Découvrez l’objet `event` du déclencheur Action password-reset-post-challenge, qui fournit des renseignements contextuels sur l’exécution du déclencheur.
...
<ResponseField name="event.authentication" type="dictionary">
  ...
  <Expandable title="propriétés d’authentification" defaultOpen>
    <ResponseField name="méthodes" type="array of objects">
      ...
      Les éléments du tableau peuvent prendre l’une des formes suivantes :
      ...
      <Tabs>
        <Tab title="Premier facteur">
          <ResponseField name="name" type="string">
            ...
            * `sms` Une connexion Passwordless par SMS a été utilisée pour authentifier l’utilisateur comme premier facteur.
            * `email` Une connexion Passwordless par courriel a été utilisée pour authentifier l’utilisateur comme premier facteur ou pour vérifier le courriel lors de la réinitialisation du mot de passe.
            ...
            * Il peut également s’agir d’une URL indiquant une méthode d’authentification personnalisée (comme deuxième facteur ou facteur ultérieur).
          </ResponseField>
...
<ResponseField name="event.client" type="dictionary">
  ...
  <Expandable title="propriétés de l’application" defaultOpen>
    ...
    <ResponseField name="metadata" type="dictionary">
      Un objet destiné à contenir d’autres propriétés de l’application.
    </ResponseField>

    <ResponseField name="name" type="string">
      Le nom de l’application (tel qu’il est défini dans l’Auth0 Dashboard).
    </ResponseField>
  </Expandable>
</ResponseField>
