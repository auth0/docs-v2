...
sidebarTitle: Créez votre premier module Action
title: Créez votre premier module Action
---
...
<Steps>
  <Step title="Créer un module d’Action" titleSize="h3" stepNumber={1}>
    ...
    <Tabs>
      ...
      <Tab title="Dashboard">
        ...
        <Frame>![Modules Actions - Nouveau module d’Action](/docs/images/customize/actions/modules/actions-modules-new-module.png)</Frame>
      </Tab>
  ...
  <Step title="Ajouter un secret" titleSize="h3" stepNumber={2}>
    ...
    <Tabs>
      ...
      <Tab title="Dashboard">
        ...
        <Frame>![Modules Actions - Secret ajouté](/docs/images/customize/actions/modules/actions-modules-secret.png)</Frame>
  ...
  <Step title="Ajouter une logique personnalisée" titleSize="h3" stepNumber={3}>
    ...
    <Callout icon="file-lines" color="#0EA5E9" iconType="regular">
      ...
      * [Directives de codage](/fr-CA/docs/customize/actions/action-coding-guidelines#actions-modules)
      * [Limites](/fr-CA/docs/customize/actions/limitations#actions-modules)
    </Callout>
  </Step>
  ...
  <Step title="Enregistrer le brouillon" titleSize="h3" stepNumber={4}>
    ...
    <Tabs>
      ...
      <Tab title="Tableau de bord">
        ...
        <Frame>![Modules Actions - Brouillon enregistré](/docs/images/customize/actions/modules/actions-modules-draft.png)</Frame>
      </Tab>
  ...
  <Step title="Publier le module Action" titleSize="h3" stepNumber={5}>
    ...
    <Tabs>
      ...
      <Tab title="Dashboard">
        ...
        <Frame>![Modules Action - Historique des versions](/docs/images/customize/actions/modules/actions-modules-published-version.png)</Frame>
  ...
  <Step title="Ajoutez le module Action à une Action" titleSize="h3" stepNumber={6}>
  ...
  <Step title="Utiliser le module Action dans l’Action" titleSize="h3" stepNumber={7}>
    ...
    <Tabs>
      ...
      <Tab title="Dashboard">
        ...
        2. Ajoutez l’appel à `logger.sendLog` dans la **fonction de l’Action**, à l’endroit où vous souhaitez envoyer les journaux.
        ...
        <Frame>![Actions - Utiliser le module Action](/docs/images/customize/actions/modules/actions-modules-use-module.png)</Frame>
      </Tab>
...
<Check>
  **Point de contrôle**
  ...
  Vous devriez maintenant disposer d’un **module Action** entièrement fonctionnel utilisé par une **Action**.
</Check>
...
<Accordion title="Dépendances NPM">
  Chaque **module Action** peut ajouter et utiliser des **[dépendances NPM](https://www.npmjs.com/)**.
  ...
  <Tabs>
    ...
    <Tab title="Dashboard">
      ...
      <Frame>![Modules Actions - Dépendance ajoutée](/docs/images/customize/actions/modules/actions-modules-dependency.png)</Frame>
  ...
  <Warning>
    Lorsque vous enregistrez cette Action, Auth0 détermine la version la plus récente de votre dépendance et la remplace par un numéro de version précis afin d’éviter que de futures mises à jour du package ne brisent votre Action.

    Vous pouvez indiquer une version précise au lieu de la plus récente.
  </Warning>
</Accordion>

{/*
  <Accordion title="Déboguer et surveiller les modules Actions">
