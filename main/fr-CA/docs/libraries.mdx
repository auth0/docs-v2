...
<div id="regular-web-application-sdk-libraries">
  ## Bibliothèques SDK pour les Applications Web régulières
</div>

Vous avez une application Web traditionnelle hébergée sur un serveur ? Auth0 propose ces bibliothèques SDK pour les langages et environnements les plus populaires.
...
Application mobile ou de bureau qui s’exécute nativement sur un appareil
