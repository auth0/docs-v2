...
description: Aperçu des bibliothèques et des SDK Auth0
---

import {SectionCard} from "/snippets/fr-CA/SectionsWithCards.jsx";

Les bibliothèques SDK d’Auth0 permettent aux développeurs d’intégrer facilement Auth0 et d’interagir avec la plateforme. Consultez une bibliothèque sur GitHub, téléchargez une application d’exemple ou utilisez un guide de démarrage rapide pour obtenir de l’aide adaptée à vos besoins.

<div id="single-page-application-spa-sdk-libraries">
  ## Bibliothèques SDK pour application monopage (SPA)
</div>

Vous devez protéger une application JavaScript qui s’exécute entièrement dans le navigateur? Choisissez votre technologie ci-dessous.
...
links: [
  ...
  { label: "guide de démarrage rapide", url: "/docs/quickstart/spa/react/interactive" },
],
}}
  />
...
links: [
  ...
  { label: "guide de démarrage rapide", url: "/docs/quickstart/spa/vuejs/interactive" },
],
}}
  />
...
links: [
  ...
  { label: "guide de démarrage rapide", url: "/docs/quickstart/spa/angular/interactive" },
],
}}
  />
...
links: [
  ...
  { label: "guide de démarrage rapide", url: "/docs/quickstart/spa/vanillajs/interactive" },
],
}}
  />
...
links: [
  ...
  { label: "guide de démarrage rapide", url: "/docs/quickstart/spa/flutter/interactive" },
],
}}
  />
</Columns>
...
<div id="regular-web-application-sdk-libraries">
  ## Bibliothèques SDK pour Application Web régulière
</div>

Vous avez une application Web traditionnelle qui s’exécute sur un serveur ? Auth0 maintient ces bibliothèques SDK pour les langages et environnements les plus populaires.
...
<div id="backend-service-and-api-sdk-libraries">
  ## Bibliothèques SDK pour API et services backend
</div>

Votre API ou votre service nécessite-t-il une authentification ? Auth0 propose des SDK pour les outils courants de développement d’API et de services.
...
Étendez les fonctionnalités de [Universal Login](/fr-CA/docs/authenticate/login/auth0-universal-login/universal-login-vs-classic-login/universal-experience#universal-login-experience) pour prendre en charge le multimarque, des configurations de sécurité complexes et l’intégration de nombreuses plateformes d’analytique.
...
links: [
  ...
  { label: "Exemple d’application", url: "https://github.com/auth0-samples/auth0-acul-samples" },
  { label: "Commencer", url: "/docs/libraries/acul/js-sdk" }
],
}}
  />
...
links: [
  ...
  { label: "Exemple d’application", url: "https://github.com/auth0-samples/auth0-acul-samples" },
  { label: "Commencer", url: "/docs/libraries/acul/react-sdk" }
],
}}
  />
</Columns>
...
<div id="management-api-sdk-libraries">
  ## Bibliothèques SDK pour la Management API
</div>

Vous devez effectuer des tâches d’administration Auth0 par programmation ? Choisissez l’une de ces bibliothèques de gestion.
...
Utilisez-vous Lock, l’ancienne expérience de connexion autohébergée d’Auth0? Vous pouvez toujours compter sur ces bibliothèques pour la connexion autohébergée.

<Columns cols={2}>
  <SectionCard
    item={{
name: "Lock pour Android",
...
links: [
  ...
  { label: "Pour commencer", url: "/docs/libraries/lock-android" }
],
}}
  />
...
links: [
  ...
  { label: "Pour commencer", url: "/docs/libraries/lock-ios" }
],
}}
  />
...
links: [
  ...
  { label: "Pour commencer", url: "/docs/libraries/lock" }
],
}}
  />
</Columns>