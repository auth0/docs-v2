...
<Callout icon="file-lines" color="#0EA5E9" iconType="regular">
  ...
  À compter de février 2020, Google Chrome v80 a modifié la façon dont il gère les cookies. Auth0 a donc apporté les changements suivants à sa gestion des cookies :
...
Les cookies sans état sont autonomes; ils contiennent toutes les informations de session nécessaires (pour les utilisateurs authentifiés, l’identifiant de l’utilisateur) et sont stockés côté client. Pour empêcher toute falsification externe, les cookies sans état doivent être chiffrés (ou au moins signés).
...
* [Cookies de l’Authentication API](/fr-CA/docs/manage-users/cookies/authentication-api-cookies)
