---
description: Découvrez comment supprimer les permissions ajoutées à un rôle à l’aide de l’Auth0 Dashboard ou de la Management API.
title: Supprimer des permissions d’un rôle
---
...
Vous pouvez supprimer les [permissions](/fr-CA/docs/manage-users/access-control/rbac) attribuées à un rôle à l’aide de <Tooltip tip="Auth0 Dashboard : produit principal d’Auth0 pour configurer vos services." cta="Voir le glossaire" href="/fr-CA/docs/glossary?term=Auth0+Dashboard">Auth0 Dashboard</Tooltip> ou de la <Tooltip tip="Auth0 Dashboard : produit principal d’Auth0 pour configurer vos services." cta="Voir le glossaire" href="/fr-CA/docs/glossary?term=Management+API">Management API</Tooltip>. Les permissions et les rôles attribués sont utilisés avec l’ensemble de fonctionnalités API Authorization Core.
...
2. Cliquez sur l’onglet **Permissions**, puis sur l’icône de la corbeille à côté de l’autorisation que vous souhaitez supprimer, puis confirmez.

<div id="management-api">
  ## Management API
</div>

Effectuez une requête `DELETE` vers le [point de terminaison Delete Role Permissions](https://auth0.com/docs/api/management/v2#!/Roles/delete_role_permission_assignment). Assurez-vous de remplacer les valeurs fictives `ROLE_ID`, `MGMT_API_ACCESS_TOKEN`, `API_ID` et `PERMISSION_NAME` par l’ID de votre rôle, votre <Tooltip tip="Jeton d’accès : information d’identification d’autorisation, sous la forme d’une chaîne opaque ou d’un JWT, utilisée pour accéder à une API." cta="Voir le glossaire" href="/fr-CA/docs/glossary?term=access+token">jeton d’accès</Tooltip> de la Management API, le ou les ID d’API et le ou les noms d’autorisation, respectivement.
...
| Valeur                  | Description                                                                                                           |
| ----------------------- | --------------------------------------------------------------------------------------------------------------------- |
| `ROLE_ID`               | L’identifiant du rôle pour lequel vous souhaitez supprimer des permissions.                                           |
...
| `API_ID`                | Identifiant(s) de la ou des API associées à la ou aux permissions que vous souhaitez supprimer pour le rôle indiqué.  |
| `PERMISSION_NAME`       | Nom(s) de la ou des permissions que vous souhaitez supprimer pour le rôle indiqué.                                    |
...
* [Cas d’utilisation : contrôle d’accès basé sur les rôles](/fr-CA/docs/manage-users/access-control/sample-use-cases-role-based-access-control)