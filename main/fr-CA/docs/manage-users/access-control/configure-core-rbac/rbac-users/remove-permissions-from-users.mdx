---
description: Découvrez comment supprimer les autorisations attribuées directement à un utilisateur à l’aide de l’Auth0 Dashboard ou de la Management API.
title: Supprimer des autorisations attribuées à des utilisateurs
---
...
Vous pouvez supprimer les autorisations attribuées directement à un utilisateur à l’aide de <Tooltip tip="Auth0 Dashboard : le produit principal d’Auth0 pour configurer vos services." cta="Voir le glossaire" href="/fr-CA/docs/glossary?term=Auth0+Dashboard">Auth0 Dashboard</Tooltip> ou de la <Tooltip tip="Auth0 Dashboard : le produit principal d’Auth0 pour configurer vos services." cta="Voir le glossaire" href="/fr-CA/docs/glossary?term=Management+API">Management API</Tooltip>. Les autorisations attribuées sont utilisées avec l’ensemble de fonctionnalités API Authorization Core. Pour en savoir plus, consultez [le contrôle d’accès basé sur les rôles](/fr-CA/docs/manage-users/access-control/rbac).
...
| `API_ID`                | ID de l’API ou des API associées aux permissions que vous souhaitez supprimer pour l’utilisateur indiqué.             |
| `PERMISSION_NAME`       | Nom(s) des permissions que vous souhaitez supprimer pour l’utilisateur indiqué.                                       |

<div id="learn-more">
  ## En savoir plus
</div>

* [Attribuer des autorisations aux utilisateurs](/fr-CA/docs/manage-users/access-control/configure-core-rbac/rbac-users/assign-permissions-to-users)
* [Supprimer des autorisations de rôles](/fr-CA/docs/manage-users/access-control/configure-core-rbac/roles/remove-permissions-from-roles)
* [Consulter les autorisations d’un rôle](/fr-CA/docs/manage-users/access-control/configure-core-rbac/roles/view-role-permissions)
