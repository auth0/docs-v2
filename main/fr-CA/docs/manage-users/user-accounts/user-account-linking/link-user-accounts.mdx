...
Vous pouvez utiliser la bibliothèque Auth0.js pour effectuer une liaison de comptes côté client. Consultez [Référence Auth0.js &gt; Gestion des utilisateurs](/fr-CA/docs/libraries/auth0js#user-management) pour en savoir plus.
