---
description: Configuration d’Auth0 pour le scénario d’architecture SPA + API
title: Configuration d’Auth0 (SPA + API)
---
...
<Frame>![Auth0 Dashboard - Applications - APIs - permission](/docs/images/cdy7uua7fh8z/xxMOKezob6gNHJ0CcKhcg/ccbb9bbab29576a96ed8425329ecffb4/dashboard-apis-edit_view-permissions.png)</Frame>
