---
description: Configuration d’Auth0 pour le scénario d’architecture Server + API
title: Configuration d’Auth0 (applications côté serveur + API)
---
...
<Frame>![Auth0 Dashboard > APIs > Permissions](/docs/images/cdy7uua7fh8z/73FeuGyODcu3q7PKjLaQOO/63d8d20e9249e751152b4530005f4c71/Timesheets_API_-_Permissions_-_English.png)</Frame>
...
<Frame>![Auth0 Dashboard - Applications - APIs - Applications machine à machine - Autoriser](/docs/images/cdy7uua7fh8z/3PjvkTaoOZKWCMJol4ajCu/b5df50d1b78f95f5a2a8f82e6bb39e42/2025-02-26_18-58-47.png)</Frame>
