...
* Certains navigateurs rendent, par défaut, la communication dans un iFrame difficile si vous n’avez pas de domaine partagé. Par exemple, [l’ITP de Safari entraîne des problèmes de renouvellement de jetons Auth0](https://support.auth0.com/center/s/article/troubleshoot-auth0-token-renewal-issues-in-safari-with-itp-enabled).
