---
description: Découvrez comment configurer les Rich Authorization Requests (RAR) pour un serveur de ressources.
title: Configurer les Rich Authorization Requests (RAR)
---
