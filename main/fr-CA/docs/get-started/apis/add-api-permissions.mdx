---
description: Découvrez comment ajouter des autorisations aux API à l’aide de l’Auth0 Dashboard ou de la Management API.
title: Ajouter des autorisations aux API
---
...
Vous pouvez ajouter des autorisations à une API à l’aide du <Tooltip tip="Auth0 Dashboard : le principal produit d’Auth0 pour configurer vos services." cta="Voir le glossaire" href="/fr-CA/docs/glossary?term=Auth0+Dashboard">Auth0 Dashboard</Tooltip> ou de la <Tooltip tip="Auth0 Dashboard : le principal produit d’Auth0 pour configurer vos services." cta="Voir le glossaire" href="/fr-CA/docs/glossary?term=Management+API">Management API</Tooltip>.

<Warning>
  Par défaut, tout utilisateur de n’importe quelle application peut demander n’importe quelle autorisation définie ici. Vous pouvez mettre en place des politiques d’accès pour limiter ce comportement au moyen de [Rules](/fr-CA/docs/customize/rules).
</Warning>
...
1. Accédez à [Auth0 Dashboard &gt; Applications &gt; APIs](https://manage.auth0.com/#/apis) et cliquez sur le nom de l’API à consulter.
   ...
   <Frame>![Liste des API dans Auth0 Dashboard > Applications > APIs](/docs/images/cdy7uua7fh8z/3rhmhghYZDSi6YWHRA5yMQ/c71340259481b0b6787d5f3887cfda0f/dashboard-apis-list.png)</Frame>
2. Accédez à l’onglet **Permissions** et saisissez le nom et la description de l’autorisation que vous voulez ajouter. Assurez-vous de ne pas utiliser de noms d’autorisation réservés (consultez la section sur les noms réservés).
   ...
   <Frame>![Écran de définition des autorisations d’API dans Auth0 Dashboard > Applications > APIs > Permissions](/docs/images/cdy7uua7fh8z/32Pb185OFs2mC6z2fmunEw/2708c52c2869d016066cc456dd00b6a2/dashboard-applications-apis-permissions.png)</Frame>
...
| Valeur                  | Description                                                                                                                      |
| ----------------------- | -------------------------------------------------------------------------------------------------------------------------------- |
| `API_ID`                | ID de l’API pour laquelle vous souhaitez supprimer des autorisations.                                                            |
...
| `PERMISSION_NAME`       | Nom(s) de la ou des autorisations que vous souhaitez conserver pour l’API spécifiée.                                             |
| `PERMISSION_DESC`       | Description(s) en langage clair de la ou des autorisations que vous souhaitez conserver pour l’API spécifiée.                    |
...
* nickname
* offline&#95;access
* <Tooltip tip="OpenID : norme ouverte d’authentification qui permet aux applications de vérifier l’identité des utilisateurs sans recueillir ni stocker les informations de connexion." cta="Voir le glossaire" href="/fr-CA/docs/glossary?term=openid">openid</Tooltip>
* phone
* picture
* profile
...
* [Personnaliser les invites de Consent](/fr-CA/docs/customize/login-pages/customize-consent-prompts)
