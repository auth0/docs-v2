...
* **Enable RBAC** : Activez ce paramètre pour appliquer les stratégies RBAC à l’API. Pour en savoir plus, consultez [Contrôle d’accès basé sur les rôles](/fr-CA/docs/manage-users/access-control/rbac) et [Activer le contrôle d’accès basé sur les rôles pour les API](/fr-CA/docs/get-started/apis/enable-role-based-access-control-for-apis). Pour obtenir de l’aide sur le dépannage, consultez [Résoudre les problèmes liés au contrôle d’accès basé sur les rôles et à l’autorisation](/fr-CA/docs/troubleshoot/authentication-issues/troubleshoot-rbac-authorization).
...
Pour obtenir de l’aide pour le dépannage, consultez [Vérifier les appels d’API](/fr-CA/docs/troubleshoot/authentication-issues/check-api-calls).
