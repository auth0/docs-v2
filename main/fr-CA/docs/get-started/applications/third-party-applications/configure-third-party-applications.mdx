---
title: Configurer des applications tierces
description: "Créez et configurez des applications tierces dans Auth0 Dashboard ou au moyen de Management API."
---
...
<Tabs>
  <Tab title="Auth0 Dashboard">
    ...
    <Frame>![Boîte de dialogue Create Application du Dashboard avec l’option d’application tierce activée](/docs/images/third-party-applications/create-application-dialog.png)</Frame>
  </Tab>
...
<Tabs>
  <Tab title="Auth0 Dashboard">
    ...
    <Frame>![Paramètres d’API du Dashboard pour la politique d’accès des applications](/docs/images/third-party-applications/application_access_policy.png)</Frame>
...
<Tabs>
  <Tab title="Auth0 Dashboard">
    ...
    <Frame>![Paramètres de l’API dans le Dashboard avec les autorisations par défaut pour les applications tierces](/docs/images/third-party-applications/default-permissions-settings.png)</Frame>
  </Tab>
...
<Tabs>
  <Tab title="Auth0 Dashboard">
    ...
    <Frame>![Commutateur Open Redirect Protection dans le Dashboard](/docs/images/third-party-applications/open-redirect-protection.png)</Frame>
  </Tab>
