...
<Tabs>
  <Tab title="Auth0 Dashboard">
    ...
    <Frame>![Paramètres avancés du locataire dans le Dashboard avec la liste déroulante DCR Security Mode](/docs/images/third-party-applications/dcr-security-mode.png)</Frame>
  </Tab>
