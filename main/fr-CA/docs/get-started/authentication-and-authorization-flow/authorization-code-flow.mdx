...
<Callout icon="file-lines" color="#0EA5E9" iconType="regular">
  Si une application exécutée dans le navigateur, avec un en-tête Origin, envoie une requête `POST` au point de terminaison `/oauth/token`, Auth0 n’émet pas de jetons d’actualisation, même si l’application a activé [Allow Refresh Token Rotation](/fr-CA/docs/secure/tokens/refresh-tokens/configure-refresh-token-rotation) et envoie le scope [offline&#95;access](/fr-CA/docs/secure/tokens/refresh-tokens/configure-refresh-token-rotation#configure-with-the-auth0-spa-sdk).
</Callout>
