---
description: Découvrez comment utiliser Hooks pour modifier les scopes et ajouter des claims personnalisés au jeton d’accès obtenu à l’aide du flux d’identification du client.
title: Personnaliser les jetons à l’aide de Hooks avec le flux d’identification du client
---
