...
<Tabs>
  <Tab title="React">
      ...
      export default function App() {
        ...
        return (
          <Auth0Provider
            ...
            interactiveErrorHandler="popup" // Requis pour gérer les vérifications d’authentification renforcée au moyen de la fenêtre contextuelle Universal Login
          >
    ...
    **Type:** `ComponentAction<IdentityProvider, CreateIdpProvisioningScimTokenResponseContent>`
    ...
    Génère un nouveau Bearer Token SCIM permettant à votre fournisseur d&#39;identité de s&#39;authentifier auprès d&#39;Auth0.
