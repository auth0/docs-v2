...
description: "Interface à onglets pour modifier les fournisseurs SSO : paramètres SSO, provisionnement (SCIM) et gestion des domaines"
---

import Spinner from "/snippets/fr-CA/Spinner.jsx";
import { ComponentLoader } from "/snippets/fr-CA/ComponentLoader.jsx";

Le composant `SsoProviderEdit` offre une interface unifiée pour modifier les fournisseurs d’[authentification unique (SSO)](/fr-CA/docs/authenticate/enterprise-connections/self-service-enterprise-configuration).

<ComponentLoader componentSelector="sso-provider-edit" componentPreviewText="Aperçu du composant de modification du fournisseur SSO" />
...
<Tabs>
  <Tab title="React">
    ...
    <table class="table">
      ...
      <tbody>
        <tr>
          ...
          <td>
            <strong>Obligatoire.</strong> L’identifiant du fournisseur SSO à modifier.
          </td>
        </tr>
      </tbody>
    </table>
    ...
    <table class="table">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            Actions de l’onglet des domaines. <a href="#domains-tab-actions">Détails</a>
          </td>
        </tr>
      </tbody>
    </table>
    ...
    <table class="table">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            Supprimer définitivement le fournisseur d’identité.
          </td>
        </tr>
    ...
    **Type:** `ComponentAction<IdentityProvider>`
    ...
    Contrôle la suppression du fournisseur de l&#39;organisation sans le supprimer définitivement. Le fournisseur reste disponible pour être rajouté ultérieurement.
    ...
    **Type:** `ComponentAction<IdentityProvider, CreateIdpProvisioningScimTokenResponseContent>`
    ...
    Génère un nouveau jeton bearer SCIM permettant à votre fournisseur d&#39;identité de s&#39;authentifier auprès d&#39;Auth0.
    ...
    <table class="table">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            Associer un domaine au fournisseur.
          </td>
        </tr>
        ...
        <tr>
          ...
          <td>
            Retirer un domaine du fournisseur.
          </td>
        </tr>
      </tbody>
    </table>
    ...
    **Type:** `ComponentAction<Domain>`
    ...
    Contrôle la vérification du domaine via un enregistrement TXT DNS.
    ...
    **style**
    ...
    Personnalisez l&#39;apparence à l&#39;aide de variables CSS et de substitutions de classes. Prend en charge le style adapté aux thèmes.
    ...
    <table class="table">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>Gestion des associations de domaine</td>
        </tr>
    ...
    <table class="table">
      ...
      <tbody>
        <tr>
          ...
          <td>Chargement et mise à jour du fournisseur</td>
        </tr>
  ...
  <Tab title="Next.js">
    ...
    <Callout icon="file-lines" color="#0EA5E9" iconType="regular">
      L’exécution des commandes npm ou pnpm installe la dépendance @auth0/universal-components-core pour les utilitaires partagés et l’intégration avec Auth0.
    </Callout>
    ...
    Les props de base sont essentielles au fonctionnement du composant. `SsoProviderEdit` nécessite l&#39;ID du fournisseur pour charger et modifier le bon fournisseur.
    ...
    <table class="table">
      ...
      <tbody>
        <tr>
          ...
          <td>
            <strong>Obligatoire.</strong> ID du fournisseur SSO à modifier.
          </td>
        </tr>
      </tbody>
    </table>
    ...
    * `icon` - Composant d’icône Lucide personnalisé (optionnel, valeur par défaut : ArrowLeft)
    * `onClick` - Gestionnaire de clics pour la navigation
    ...
    <table class="table">
      ...
      <tbody>
        <tr>
          ...
          <td>
            Met à jour les paramètres du fournisseur.
          </td>
        </tr>
    ...
    * `onAfter(provider, result)` - S’exécute une fois que le fournisseur a été mis à jour avec succès. Utilisez-le pour afficher une notification ou faire le suivi de l’événement.
    ...
    <table class="table">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            Dissocier le domaine du fournisseur d’identité.
          </td>
        </tr>
      </tbody>
    </table>
    ...
    **customMessages**
    ...
    <Accordion title="Messages disponibles">
      ...
      * `title`, `description`
      * `fields.*` - Libellés des champs de formulaire par stratégie
      * `actions.save_button_text`, `actions.delete_button_text`
      * `delete_modal.*`, `remove_modal.*`
    ...
    **styling**
    ...
    Personnalisez l&#39;apparence à l&#39;aide de variables CSS et de remplacements de classes. Prend en charge le style adapté aux thèmes.
    ...
    ***
    ...
    Le composant `SsoProviderEdit` est composé de sous-composants et de hooks plus petits. Vous pouvez les importer individuellement pour créer des flux de travail de modification de fournisseur personnalisés.

    ### Sous-composants disponibles

    Pour les cas d&#39;utilisation avancés, vous pouvez importer des sous-composants individuels pour intégrer des onglets ou des sections spécifiques dans différents contextes.
  ...
  <Tab title="shadcn">
    ...
    * `disabled` - Désactive le bouton Enregistrer
    * `onBefore(provider)` - S’exécute avant la mise à jour. Renvoyez `false` pour empêcher l’enregistrement (par exemple, pour afficher une boîte de dialogue de confirmation).
    * `onAfter(provider, result)` - S’exécute après la mise à jour réussie du fournisseur. Utilisez-le pour afficher une notification ou effectuer le suivi de l’événement.
    ...
    <table class="table">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            Dissocier le domaine du fournisseur.
          </td>
        </tr>
      </tbody>
    </table>
    ...
    ***
    ...
    Le composant `SsoProviderEdit` est composé de sous-composants et de hooks plus petits. Vous pouvez les importer individuellement pour créer des flux de travail de gestion de fournisseurs SSO personnalisés si vous utilisez shadcn.

    ### Sous-composants disponibles

    Pour les cas d&#39;utilisation avancés, vous pouvez importer des composants d&#39;onglet individuels afin de créer des interfaces d&#39;édition de fournisseur personnalisées.
