...
description: Affichez et gérez les fournisseurs d’identité SSO dans une interface tabulaire avec des fonctions de création, de modification, de suppression et d’activation ou de désactivation.
---
...
<ComponentLoader componentSelector="sso-provider-table" componentPreviewText="Aperçu du composant du tableau des fournisseurs SSO" />
...
<Tabs>
  <Tab title="React">
    ...
    <Callout icon="file-lines" color="#0EA5E9" iconType="regular">
      **Configuration d’Auth0 requise** - Assurez-vous que votre locataire est configuré avec l’API
    ...
    <table class="table">
      ...
      <tbody>
        <tr>
          ...
          <td>
            <strong>Obligatoire.</strong> Redirige vers la page de création du fournisseur.
          </td>
        </tr>
        ...
        <tr>
          ...
          <td>
            <strong>Obligatoire.</strong> Redirige vers la page de modification du fournisseur.
          </td>
        </tr>
      </tbody>
    </table>
    ...
    **Type:** `ComponentAction<IdentityProvider>`
    ...
    Contrôle la suppression permanente d&#39;un fournisseur SSO. Cette opération est destructive — le fournisseur est définitivement supprimé de votre locataire Auth0.
    ...
    **Type:** `ComponentAction<IdentityProvider>`
    ...
    Contrôle la suppression d&#39;un fournisseur de l&#39;organisation sans le supprimer du locataire. Le fournisseur reste disponible pour être rajouté ultérieurement.
    ...
    **Type:** `ComponentAction<IdentityProvider>`
    ...
    Contrôle le bouton d&#39;activation/désactivation des fournisseurs. Les fournisseurs désactivés restent configurés, mais les utilisateurs ne peuvent pas s&#39;authentifier via ceux-ci.
    ...
    **styling**
    ...
    Personnalisez l&#39;apparence à l&#39;aide de variables CSS et de substitutions de classes. Prend en charge le style adapté au thème.
    ...
    <table class="table">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>Composant d’activation/désactivation</td>
        </tr>
    ...
    <table class="table">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>État d’interaction de l’interface utilisateur et gestionnaires (fenêtres modales, actions)</td>
        </tr>
      </tbody>
    </table>
  </Tab>
  ...
  <Tab title="Next.js">
    ...
    <table class="table">
      ...
      <tbody>
        <tr>
          ...
          <td>
            <strong>Obligatoire.</strong> Permet d’accéder à la création du fournisseur d’identité.
          </td>
        </tr>
        ...
        <tr>
          ...
          <td>
            <strong>Obligatoire.</strong> Permet d’accéder à la modification du fournisseur d’identité.
          </td>
        </tr>
      </tbody>
    </table>
    ...
    **Type:** `ComponentAction<IdentityProvider>`
    ...
    Contrôle la suppression d&#39;un fournisseur de l&#39;organisation sans le supprimer du locataire. Le fournisseur demeure disponible pour être rajouté ultérieurement.
    ...
    **styling**
    ...
    Personnalisez l&#39;apparence à l&#39;aide de variables CSS et de surcharges de classes. Prend en charge la stylisation adaptée au thème.
    ...
    <table class="table">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>Composant d’activation ou de désactivation</td>
        </tr>
        ...
        <tr>
          ...
          <td>Composant de rendu d’icône de stratégie (Okta, SAML, etc.)</td>
        </tr>
      </tbody>
    </table>
    ...
    <table class="table">
      ...
      <tbody>
        <tr>
          ...
          <td>Récupération et gestion de la liste des fournisseurs SSO</td>
        </tr>
        ...
        <tr>
          ...
          <td>État des interactions de l’interface utilisateur + gestionnaires (fenêtres modales, actions)</td>
        </tr>
      </tbody>
    </table>
  </Tab>
  ...
  <Tab title="shadcn">
    ...
    <Callout icon="file-lines" color="#0EA5E9" iconType="regular">
      **Configuration d’Auth0 requise** - Assurez-vous que votre locataire est configuré pour utiliser
      l’API My Organization. [Voir le guide de configuration
      →](/fr-CA/docs/get-started/universal-components/my-organization/build-delegated-admin#configure-auth0-dashboard)
    </Callout>
    ...
    <table class="table">
      ...
      <tbody>
        <tr>
          ...
          <td>
            <strong>Obligatoire.</strong> Permet d’accéder à la création d’un fournisseur d’identité.
          </td>
        </tr>
        ...
        <tr>
          ...
          <td>
            <strong>Obligatoire.</strong> Permet d’accéder à la modification d’un fournisseur d’identité.
          </td>
        </tr>
      </tbody>
    </table>
    ...
    <table class="table">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>Composant affichant l’icône de stratégie (Okta, SAML, etc.)</td>
        </tr>
      </tbody>
    </table>
