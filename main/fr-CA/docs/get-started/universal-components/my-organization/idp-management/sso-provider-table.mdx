...
<Tabs>
      ...
      export default function App() {
        ...
        return (
          <Auth0Provider
            ...
            interactiveErrorHandler="popup" // Requis pour gérer les vérifications d’authentification renforcée dans la fenêtre contextuelle Universal Login
          >
  ...
  <Tab title="shadcn">
    ...
    <Callout icon="file-lines" color="#0EA5E9" iconType="regular">
      ...
      pour les utilitaires communs et l’intégration Auth0.
    </Callout>
    ...
    * `disabled` - Désactive l’option de retrait
    * `onBefore(provider)` - S’exécute avant le retrait. Renvoyez `false` pour empêcher le retrait (p. ex. pour afficher une confirmation).
    * `onAfter(provider)` - S’exécute une fois le fournisseur retiré de l’organisation avec succès.
