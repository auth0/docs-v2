...
<Tabs>
    ...
    <table class="table">
      ...
      <tbody>
        <tr>
          ...
          <td>Logique de modification de l’organisation et intégration de l’API</td>
        </tr>
      </tbody>
    </table>
  </Tab>
  ...
  <Tab title="shadcn">
    ...
    <Callout icon="file-lines" color="#0EA5E9" iconType="regular">
      **Configuration requise d’Auth0** - Assurez-vous que votre tenant est configuré pour utiliser
    ...
    **styling**
    ...
    <Accordion title="Styles offerts">
      **Variables** - propriétés CSS personnalisées
      ...
      **Classes** - substitutions de classes du composant
