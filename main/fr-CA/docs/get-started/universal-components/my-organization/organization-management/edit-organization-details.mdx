---
title: Modifier les renseignements de l’organisation
sidebarTitle: Modifier les renseignements de l’organisation
description: Modifiez les renseignements de l’organisation, y compris le nom, le nom affiché, les couleurs de la marque et le logo.
---
...
<Tabs>
  <Tab title="React">
    ...
    **Type:** `ComponentAction<OrganizationPrivate>`
    ...
    Contrôle le flux de sauvegarde lorsque les utilisateurs soumettent des modifications à l&#39;organisation. Utilisez `onAfter` pour rediriger l&#39;utilisateur après une sauvegarde réussie.
    ...
    **styling**
    ...
    Personnalisez l&#39;apparence avec des variables CSS et des substitutions de classes. Prend en charge le style adapté aux thèmes.
    ...
    <table class="table">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>Champ de sélection de la couleur de marque</td>
        </tr>
  ...
  <Tab title="Next.js">
    ...
    **schema**
    ...
    <Accordion title="Champs de schéma disponibles">
      Tous les champs du schéma prennent en charge les éléments suivants : `regex`, `errorMessage`, `minLength`, `maxLength`, `required`
    ...
    ***
    ...
    Le composant `OrganizationDetailsEdit` est composé de sous-composants et de hooks plus granulaires. Vous pouvez les importer individuellement pour créer des flux de travail personnalisés de modification d&#39;organisation.
  ...
  <Tab title="shadcn">
      ...
      export default function App() {
        ...
        return (
          <Auth0Provider
            ...
            interactiveErrorHandler="popup" // Requis pour gérer les vérifications d'authentification par élévation de privilèges via la fenêtre contextuelle Universal Login
          >
            <Auth0ComponentProvider domain={domain}>
              <OrganizationSettingsPage />
            </Auth0ComponentProvider>
    ...
    * `icon` - composant d’icône Lucide personnalisé (optionnel, par défaut : ArrowLeft)
    * `onClick` - Gestionnaire de clic pour la navigation
    ...
    <table class="table">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>État du formulaire et gestion des actions</td>
        </tr>
      </tbody>
    </table>
  </Tab>
