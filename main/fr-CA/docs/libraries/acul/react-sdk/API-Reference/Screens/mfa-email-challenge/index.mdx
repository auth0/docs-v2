...
description: "Décrit tous les hooks et toutes les méthodes disponibles pour personnaliser l’écran `mfa-email-challenge` de l’Universal Login."
---

L’écran `mfa-email-challenge` invite l’utilisateur à saisir un code à usage unique envoyé à son adresse courriel pour compléter la vérification MFA.
...
* L’import racine vous permet de charger tous les écrans à partir d’un seul bundle, ce qui est utile si vous voulez qu’une version unifiée prenne en charge tous les écrans possibles.
...
<ParamField body="useBranding" type={<span>() =&gt; <a href="/fr-CA/docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/BrandingMembers">BrandingMembers</a></span>}>
  Ce hook fournit les paramètres d’image de marque, comme le logo, les couleurs et les réglages du thème affichés sur l’écran `mfa-email-challenge`.
...
<ParamField body="useClient" type={<span>() =&gt; <a href="/fr-CA/docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/ClientMembers">ClientMembers</a></span>}>
  Ce hook fournit les configurations liées à l’application, comme `id`, `name` et `logoUrl`, pour l’écran `mfa-email-challenge`.
...
<ParamField body="useOrganization" type={<span>() =&gt; <a href="/fr-CA/docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/OrganizationMembers">OrganizationMembers</a></span>}>
  Ce hook fournit des informations sur l’Organisation de l’utilisateur si le flux MFA est défini dans le contexte d’une Organisation. Il renvoie `null` lorsqu’aucun contexte d’Organisation n’est présent.
...
<ParamField body="useScreen" type={<span>() =&gt; <a href="/fr-CA/docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/ScreenMembersOnMfaEmailChallenge">ScreenMembersOnMfaEmailChallenge</a></span>}>
  Ce hook contient les détails propres à l’écran `mfa-email-challenge`, y compris sa configuration et son contexte.
...
<ParamField body="useTransaction" type={<span>() =&gt; <a href="/fr-CA/docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/TransactionMembers">TransactionMembers</a></span>}>
  Ce hook fournit des données propres à la transaction pour l’écran `mfa-email-challenge`, comme l’état actuel du flux MFA.
...
<ParamField body="useUntrustedData" type={<span>() =&gt; <a href="/fr-CA/docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/UntrustedDataMembersOnMfaEmailChallenge">UntrustedDataMembersOnMfaEmailChallenge</a></span>}>
...
<ParamField body="useMfaEmailChallenge" type={<a href="/fr-CA/docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/MfaEmailChallengeMembers">MfaEmailChallengeMembers</a>}>
  Ce hook renvoie toutes les méthodes et tout le contexte disponibles dans l’écran `mfa-email-challenge`.
</ParamField>
...
<ParamField body="continueMethod" type="Promise<void>">
  Cette méthode soumet le code à usage unique saisi par l’utilisateur pour terminer la vérification MFA par courriel.
  ...
  **Paramètres de la méthode**
  ...
  <Expandable title="Paramètres">
    <ParamField body="options">
      [ContinuePayloadOptions](/fr-CA/docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/ContinuePayloadOptions).
    </ParamField>
...
<ParamField body="pickEmail" type="Promise<void>">
  Cette méthode redirige vers l’écran de sélection du courriel si plusieurs adresses courriel sont disponibles pour la vérification.
...
<ParamField body={<a href="/fr-CA/docs/libraries/acul/react-sdk/API-Reference/Hooks/useErrors">useErrors</a>} type="Hooks">
  Ce hook permet de lire et de gérer les erreurs serveur, application et développeur sur l’écran.
</ParamField>