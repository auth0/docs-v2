...
description: "Décrit tous les hooks et toutes les méthodes disponibles pour personnaliser l’écran `login-passwordless-email-code` dans Universal Login."
---

L’écran `login-passwordless-email-code` invite l’utilisateur à saisir un code à usage unique envoyé à son adresse courriel afin de finaliser l’authentification Passwordless.
...
* L’utilisation de l’importation depuis la racine vous permet de charger tous les écrans à partir d’un seul bundle, ce qui est utile si vous voulez une version unifiée capable de gérer tous les écrans possibles.
...
Hooks propres à l’écran qui fournissent un accès en lecture seule aux données de contexte d’Auth0 sur l’écran `login-passwordless-email-code`. Importez-les depuis `@auth0/auth0-acul-react/login-passwordless-email-code`.
...
<ParamField body="useBranding" type={<span>() =&gt; <a href="/fr-CA/docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/BrandingMembers">BrandingMembers</a></span>}>
  Ce hook fournit la configuration de l’image de marque, comme le logo, les couleurs et les paramètres du thème affichés sur l’écran `login-passwordless-email-code`.
...
<ParamField body="useClient" type={<span>() =&gt; <a href="/fr-CA/docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/ClientMembers">ClientMembers</a></span>}>
  Ce hook fournit la configuration liée à l’application, comme `id`, `name` et `logoUrl`, pour l’écran `login-passwordless-email-code`.
...
<ParamField body="useOrganization" type={<span>() =&gt; <a href="/fr-CA/docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/OrganizationMembers">OrganizationMembers</a></span>}>
  Ce hook fournit des informations sur l’organisation de l’utilisateur si la connexion s’effectue dans le contexte d’une organisation. Renvoie `null` lorsqu’aucun contexte d’organisation n’est présent.
...
<ParamField body="useScreen" type={<span>() =&gt; <a href="/fr-CA/docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/ScreenMembersOnLoginPasswordlessEmailCode">ScreenMembersOnLoginPasswordlessEmailCode</a></span>}>
...
<ParamField body="useTransaction" type={<span>() =&gt; <a href="/fr-CA/docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/TransactionMembersOnLoginPasswordlessEmailCode">TransactionMembersOnLoginPasswordlessEmailCode</a></span>}>
...
<ParamField body="useUntrustedData" type={<span>() =&gt; <a href="/fr-CA/docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/UntrustedDataMembers">UntrustedDataMembers</a></span>}>
  Ce hook fournit les données non fiables transmises à l’écran, comme une adresse courriel préremplie à partir des paramètres d’URL.
...
<ParamField body="useLoginPasswordlessEmailCode" type={<a href="/fr-CA/docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/LoginPasswordlessEmailCodeMembers">LoginPasswordlessEmailCodeMembers</a>}>
  ...
  **Paramètres de la méthode**
  ...
  <Expandable title="Paramètres">
    ...
    <ParamField body="[`key`: `string`]" type="&#x22;string&#x22; | &#x22;number&#x22; | &#x22;boolean&#x22; | &#x22;undefined&#x22;">
      Champs personnalisés additionnels préfixés par `ulp-` (par exemple, `'ulp-custom-field'`).
    </ParamField>
  </Expandable>
</ParamField>

<ParamField body="submitCode" type="Promise<void>">
  Cette méthode envoie le code à usage unique pour terminer l’authentification Passwordless par courriel.
  ...
  **Paramètres de la méthode**
  ...
  <Expandable title="Paramètres">
    ...
    <ParamField body="captcha?" type="string">
      Valeur du captcha requise lorsque la détection de robots est activée sur le locataire.
    </ParamField>
...
<ParamField body="switchConnection" type="Promise<void>">
  ...
  **Paramètres de la méthode**
  ...
  <Expandable title="Paramètres">
    <ParamField body="options">
      [SwitchConnectionOptionsEmailCode](/fr-CA/docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/SwitchConnectionOptionsEmailCode).
    </ParamField>

    <ParamField body="connection" type="string" required>
      Le nom de la connexion vers laquelle passer. Utilisez &#39;email&#39; ou &#39;sms&#39; pour Passwordless, ou un nom de connexion de base de données pour l’authentification par mot de passe.
    </ParamField>
...
<ParamField body={<a href="/fr-CA/docs/libraries/acul/react-sdk/API-Reference/Hooks/useResend">useResend</a>} type="Hooks">
  Ce hook gère l’état du délai d’attente avant un nouveau renvoi et la disponibilité des actions de renvoi de code.
</ParamField>