...
L’écran `email-identifier-challenge` s’affiche lorsqu’un utilisateur doit vérifier son identité en entrant un code envoyé à son adresse de courriel. Il permet à l’utilisateur de saisir le code, d’en demander le renvoi ou de revenir à l’étape précédente.
...
Hooks propres à l’écran qui fournissent un accès en lecture seule aux données de contexte d’Auth0 sur l’écran `email-identifier-challenge`. Importez-les depuis `@auth0/auth0-acul-react/email-identifier-challenge`.
...
<ParamField body="useBranding" type={<span>() =&gt; <a href="/docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/BrandingMembers">BrandingMembers</a></span>}>
  Ce hook fournit les paramètres d’image de marque, comme le logo, les couleurs et les réglages du thème affichés sur l’écran `email-identifier-challenge`.
...
<ParamField body="useClient" type={<span>() =&gt; <a href="/docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/ClientMembers">ClientMembers</a></span>}>
  Ce hook fournit des données liées à l’application, comme `id`, `name` et `logoUrl`, pour l’écran `email-identifier-challenge`.
...
<ParamField body="useOrganization" type={<span>() =&gt; <a href="/docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/OrganizationMembers">OrganizationMembers</a></span>}>
  Ce hook fournit des renseignements sur l’Organisation de l’utilisateur si la vérification par courriel est associée à une Organisation. Il retourne `null` lorsqu’aucun contexte d’Organisation n’est présent.
...
<ParamField body="useUntrustedData" type={<span>() =&gt; <a href="/docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/UntrustedDataMembers">UntrustedDataMembers</a></span>}>
  Ce hook expose les données non fiables transmises à l’écran, comme les paramètres préremplis provenant des chaînes de requête de l’URL.
...
<ParamField body="useEmailIdentifierChallenge" type={<a href="/docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/EmailIdentifierChallengeMembers">EmailIdentifierChallengeMembers</a>}>
  Ce hook retourne toutes les méthodes et tout le contexte disponibles dans l’écran `email-identifier-challenge`.
</ParamField>
...
<ParamField body={<a href="/docs/libraries/acul/react-sdk/API-Reference/Hooks/useErrors">useErrors</a>} type="Hooks">
  Ce hook permet de lire et de gérer les erreurs du serveur, du côté client et du développeur à l’écran.
</ParamField>
