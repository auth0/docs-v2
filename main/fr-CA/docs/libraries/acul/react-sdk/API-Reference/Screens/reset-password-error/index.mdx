...
description: "Décrit tous les hooks et toutes les méthodes disponibles pour personnaliser l’écran `reset-password-error` dans Universal Login."
---

L’écran `reset-password-error` s’affiche lorsqu’une erreur survient dans le flux de réinitialisation du mot de passe, par exemple si le lien de réinitialisation est expiré ou invalide. Il informe l’utilisateur du problème et lui indique les prochaines étapes.
...
Hooks propres à l’écran qui fournissent un accès en lecture seule aux données de contexte d’Auth0 pour l’écran `reset-password-error`. Importez-les depuis `@auth0/auth0-acul-react/reset-password-error`.
...
<ParamField body="useBranding" type={<span>() =&gt; <a href="/fr-CA/docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/BrandingMembers">BrandingMembers</a></span>}>
  Ce hook fournit la configuration d’image de marque, comme le logo, les couleurs et les paramètres de thème affichés sur l’écran `reset-password-error`.
...
<ParamField body="useClient" type={<span>() =&gt; <a href="/fr-CA/docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/ClientMembers">ClientMembers</a></span>}>
  Ce hook fournit la configuration liée à l’application, comme `id`, `name` et `logoUrl`, pour l’écran `reset-password-error`.
...
<ParamField body="useScreen" type={<span>() =&gt; <a href="/fr-CA/docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/ScreenMembersOnResetPasswordError">ScreenMembersOnResetPasswordError</a></span>}>
...
<ParamField body="useResetPasswordError" type={<a href="/fr-CA/docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/ResetPasswordErrorMembers">ResetPasswordErrorMembers</a>}>
  Ce hook renvoie toutes les méthodes et le contexte disponibles pour l’écran `reset-password-error`.
</ParamField>
