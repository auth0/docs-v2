...
description: "Décrit tous les hooks et toutes les méthodes disponibles pour personnaliser l’écran `reset-password-mfa-phone-challenge` de Universal Login."
---

L’écran `reset-password-mfa-phone-challenge` s’affiche pendant le flux de réinitialisation du mot de passe lorsqu’une authentification multifacteur par téléphone est requise. Il invite l’utilisateur à choisir une méthode d’envoi (SMS ou appel vocal) pour recevoir un code de vérification et poursuivre le processus de réinitialisation.

<Frame>
  <img style={{maxHeight:"400px"}} src="/docs/images/cdy7uua7fh8z/5nxfRZqcpBBwzZGlJ7wm8y/a8b3a66ec4ffc07dd934b734e021c306/Screenshot_2025-04-24_at_09.53.31.png" alt="ACUL Défi MFA par téléphone pour la réinitialisation du mot de passe" />
</Frame>
...
* L’**import racine** vous permet de charger tous les écrans à partir d’un seul bundle, ce qui est utile si vous souhaitez utiliser un build unifié pour gérer tous les écrans possibles.
...
Hooks propres à l’écran qui fournissent un accès en lecture seule aux données contextuelles Auth0 sur l’écran `reset-password-mfa-phone-challenge`. Importez-les depuis `@auth0/auth0-acul-react/reset-password-mfa-phone-challenge`.
...
<ParamField body="useBranding" type={<span>() =&gt; <a href="/docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/BrandingMembers">BrandingMembers</a></span>}>
  Ce hook fournit la configuration d’image de marque, comme le logo, les couleurs et les paramètres de thème affichés sur l’écran `reset-password-mfa-phone-challenge`.
...
<ParamField body="useClient" type={<span>() =&gt; <a href="/docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/ClientMembers">ClientMembers</a></span>}>
  Ce hook fournit les configurations liées à l’application, comme `id`, `name` et `logoUrl`, pour l’écran `reset-password-mfa-phone-challenge`.
...
<ParamField body="useOrganization" type={<span>() =&gt; <a href="/docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/OrganizationMembers">OrganizationMembers</a></span>}>
  Ce hook fournit des renseignements sur l’Organisation de l’utilisateur si la réinitialisation du mot de passe s’effectue dans le contexte d’une Organisation. Retourne `null` si aucun contexte d’Organisation n’est présent.
...
<ParamField body="useUntrustedData" type={<span>() =&gt; <a href="/docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/UntrustedDataMembers">UntrustedDataMembers</a></span>}>
  Ce hook expose les données non fiables transmises à l’écran, comme un courriel ou un nom d’utilisateur prérempli à partir des paramètres de l’URL.
...
<ParamField body="useResetPasswordMfaPhoneChallenge" type={<a href="/docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/ResetPasswordMfaPhoneChallengeMembers">ResetPasswordMfaPhoneChallengeMembers</a>}>
  Ce hook renvoie l’ensemble des méthodes et du contexte disponibles sur l’écran `reset-password-mfa-phone-challenge`.
</ParamField>
...
<ParamField body="continueMethod" type="Promise<void>">
  Cette méthode transmet la méthode d’envoi choisie par l’utilisateur afin d’envoyer le code de vérification et de poursuivre l’étape MFA dans le flux de réinitialisation du mot de passe.
...
<ParamField body="tryAnotherMethod" type="Promise<void>">
  ...
  **Paramètres de la méthode**
  ...
  <Expandable title="Paramètres">
    ...
    <ParamField body="type" type="&#x22;sms&#x22; | &#x22;voice&#x22;">
      La méthode d’envoi qui a d’abord été affichée ou sélectionnée sur l’écran actuel.
