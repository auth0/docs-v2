...
description: "Décrit tous les hooks et toutes les méthodes disponibles pour personnaliser l’écran `organization-selection` d’Universal Login."
---

L’écran `organization-selection` s’affiche lorsqu’un utilisateur doit saisir le nom d’une organisation pour continuer le flux d’authentification. Il permet à l’utilisateur de saisir le nom de son organisation et de continuer.

<Frame>
  <img style={{maxHeight:"400px"}} src="/docs/images/cdy7uua7fh8z/3okogBPGS1KmSlhUSk9xhk/07bc19ad8b58772d3de872a49b8f6ca5/Screenshot_2025-03-25_at_20.27.41.png" alt="Sélection d’organisation ACUL" />
</Frame>
...
* Un import racine vous permet de charger tous les écrans à partir d’un seul bundle, ce qui est utile si vous voulez qu’une compilation unifiée prenne en charge tous les écrans possibles.
...
Hooks propres à l’écran qui fournissent un accès en lecture seule aux données de contexte d’Auth0 sur l’écran `organization-selection`. Importez-les depuis `@auth0/auth0-acul-react/organization-selection`.
...
<ParamField body="useBranding" type={<span>() =&gt; <a href="/fr-CA/docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/BrandingMembers">BrandingMembers</a></span>}>
  Ce hook fournit la configuration de l’image de marque, comme le logo, les couleurs et les paramètres de thème affichés sur l’écran `organization-selection`.
...
<ParamField body="useClient" type={<span>() =&gt; <a href="/fr-CA/docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/ClientMembers">ClientMembers</a></span>}>
  Ce hook fournit les configurations liées à l’application, comme `id`, `name` et `logoUrl`, pour l’écran `organization-selection`.
...
<ParamField body="useOrganization" type={<span>() =&gt; <a href="/fr-CA/docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/OrganizationMembers">OrganizationMembers</a></span>}>
  Ce hook fournit des renseignements sur l’organisation de l’utilisateur si la sélection est limitée à l’organisation. Renvoie `null` lorsqu’aucun contexte d’organisation n’est présent.
...
<ParamField body="useScreen" type={<span>() =&gt; <a href="/fr-CA/docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/ScreenMembersOnOrganizationSelection">ScreenMembersOnOrganizationSelection</a></span>}>
...
<ParamField body="useTransaction" type={<span>() =&gt; <a href="/fr-CA/docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/TransactionMembers">TransactionMembers</a></span>}>
  Ce hook fournit des données propres à la transaction pour l’écran `organization-selection`, comme les connexions actives et l’état actuel du flux.
...
<ParamField body="useUntrustedData" type={<span>() =&gt; <a href="/fr-CA/docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/UntrustedDataMembers">UntrustedDataMembers</a></span>}>
  Ce hook gère les données non fiables transmises à l’écran, par exemple des paramètres préremplis provenant de la chaîne de requête de l’URL.
...
<ParamField body="useOrganizationSelection" type={<a href="/fr-CA/docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/OrganizationSelectionMembers">OrganizationSelectionMembers</a>}>
  Ce hook renvoie toutes les méthodes et tout le contexte disponibles pour l’écran `organization-selection`.
</ParamField>
  ...
  **Paramètres de la méthode**
  ...
  <Expandable title="Paramètres">
    <ParamField body="options">
      [ContinueWithOrganizationNameOptions](/fr-CA/docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/ContinueWithOrganizationNameOptions).
    </ParamField>

    <ParamField body="organizationName" type="string" required>
      Le nom de l’organisation à utiliser pour continuer.
    </ParamField>
  </Expandable>
</ParamField>
