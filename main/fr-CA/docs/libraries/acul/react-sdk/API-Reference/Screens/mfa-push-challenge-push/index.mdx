...
description: "Décrit tous les hooks et toutes les méthodes disponibles pour personnaliser l’écran `mfa-push-challenge-push` d’Universal Login."
---
...
* L’importation à la racine vous permet de charger tous les écrans à partir d’un seul lot, ce qui est utile si vous voulez qu’une version unifiée prenne en charge tous les écrans possibles.
...
Hooks propres à l’écran qui fournissent un accès en lecture seule aux données de contexte d’Auth0 sur l’écran `mfa-push-challenge-push`. Importez-les depuis `@auth0/auth0-acul-react/mfa-push-challenge-push`.
...
<ParamField body="useBranding" type={<span>() =&gt; <a href="/fr-CA/docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/BrandingMembers">BrandingMembers</a></span>}>
  Ce hook fournit la configuration d’image de marque, comme le logo, les couleurs et les paramètres de thème affichés sur l’écran `mfa-push-challenge-push`.
...
<ParamField body="useClient" type={<span>() =&gt; <a href="/fr-CA/docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/ClientMembers">ClientMembers</a></span>}>
  Ce hook fournit la configuration liée à l’application, comme `id`, `name` et `logoUrl`, pour l’écran `mfa-push-challenge-push`.
...
<ParamField body="useScreen" type={<span>() =&gt; <a href="/fr-CA/docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/ScreenMembersOnMfaPushChallengePush">ScreenMembersOnMfaPushChallengePush</a></span>}>
...
<ParamField body="useUntrustedData" type={<span>() =&gt; <a href="/fr-CA/docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/UntrustedDataMembersOnMfaPushChallengePush">UntrustedDataMembersOnMfaPushChallengePush</a></span>}>
...
<ParamField body="useMfaPushChallengePush" type={<a href="/fr-CA/docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/MfaPushChallengePushMembers">MfaPushChallengePushMembers</a>}>
  Ce hook renvoie toutes les méthodes et tout le contexte disponibles pour l’écran `mfa-push-challenge-push`.
</ParamField>
...
<ParamField body="continueMethod" type="Promise<void>">
  Cette méthode termine la demande d’authentification par notification push une fois que l’utilisateur a approuvé la notification sur son appareil mobile.
...
<ParamField body={<a href="/fr-CA/docs/libraries/acul/react-sdk/API-Reference/Hooks/useChangeLanguage">useChangeLanguage</a>} type="Hooks">
  Ce hook renvoie une fonction qui permet de modifier la langue d’affichage de l’écran ACUL actuel.
</ParamField>
