...
description: "Décrit tous les hooks et méthodes disponibles pour personnaliser l’écran `signup-password` de Universal Login."
---

L’écran `signup-password` permet à l’utilisateur de saisir son mot de passe pour terminer la création du compte. Il s’agit de la deuxième étape d’un flux d’inscription en plusieurs étapes, après la saisie de l’identifiant. Il prend aussi en charge l’inscription fédérée au moyen de connexions sociales ou d’entreprise.

<Frame>
  <img style={{maxHeight:"400px"}} src="/docs/images/cdy7uua7fh8z/5h85r3sVhe8mVw7rDkDwTD/02c3521d9d6c4d490c1a64ae37ecca72/Signup_Password_with_Flexible_IDs.png" alt="Mot de passe d’inscription avec identifiants flexibles" />
</Frame>
...
* L’import racine vous permet de charger tous les écrans à partir d’un seul bundle, ce qui est utile si vous voulez un build unifié capable de gérer tous les écrans possibles.
...
Hooks propres à l’écran qui fournissent un accès en lecture seule aux données de contexte d’Auth0 sur l’écran `signup-password`. Importez-les depuis `@auth0/auth0-acul-react/signup-password`.
...
<ParamField body="useBranding" type={<span>() =&gt; <a href="/docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/BrandingMembers">BrandingMembers</a></span>}>
  Ce hook fournit la configuration d’image de marque, comme le logo, les couleurs et les paramètres du thème affichés sur l’écran `signup-password`.
...
<ParamField body="useClient" type={<span>() =&gt; <a href="/docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/ClientMembers">ClientMembers</a></span>}>
  Ce hook fournit des configurations liées à l’application, comme `id`, `name` et `logoUrl`, pour l’écran `signup-password`.
...
<ParamField body="useOrganization" type={<span>() =&gt; <a href="/docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/OrganizationMembers">OrganizationMembers</a></span>}>
  Ce hook fournit des renseignements sur l’Organisation de l’utilisateur si l’inscription est limitée à une Organisation. Renvoie `null` lorsqu’aucun contexte d’Organisation n’est présent.
...
<ParamField body="usePrompt" type={<span>() =&gt; <a href="/docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/PromptMembers">PromptMembers</a></span>}>
  Ce hook contient des données sur l’invite courante dans le flux d’authentification.
...
<ParamField body="useScreen" type={<span>() =&gt; <a href="/docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/ScreenMembersOnSignupPassword">ScreenMembersOnSignupPassword</a></span>}>
  Ce hook contient les détails propres à l’écran `signup-password`, y compris sa configuration et son contexte.
...
<ParamField body="useUntrustedData" type={<span>() =&gt; <a href="/docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/UntrustedDataMembers">UntrustedDataMembers</a></span>}>
  Ce hook fournit des données non fiables transmises à l’écran, comme un courriel ou un nom d’utilisateur prérempli à partir des paramètres de l’URL.
...
<ParamField body="useSignupPassword" type={<a href="/docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/SignupPasswordMembers">SignupPasswordMembers</a>}>
  Ce hook renvoie toutes les méthodes et tout le contexte disponibles dans l’écran `signup-password`.
</ParamField>
...
<ParamField body="signup" type="Promise<void>">
  Cette méthode envoie le mot de passe de l’utilisateur pour terminer la création du compte.
  ...
  **Paramètres de la méthode**
  ...
  <Expandable title="Paramètres">
    ...
    <ParamField body="captcha?" type="string">
      Valeur du captcha requise lorsque la détection de bot est activée sur le locataire.
    </ParamField>
