...
description: "Décrit tous les hooks et toutes les méthodes offerts pour personnaliser l’écran `mfa-phone-enrollment` d’Universal Login."
---

L’écran `mfa-phone-enrollment` permet à l’utilisateur d’inscrire un numéro de téléphone pour la MFA par SMS ou appel vocal en saisissant son numéro et en sélectionnant un mode de réception.
...
Hooks associés à l’écran qui fournissent un accès en lecture seule aux données de contexte Auth0 pour l’écran `mfa-phone-enrollment`. Importez-les à partir de `@auth0/auth0-acul-react/mfa-phone-enrollment`.
...
<ParamField body="useBranding" type={<span>() =&gt; <a href="/docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/BrandingMembers">BrandingMembers</a></span>}>
  Ce hook fournit des paramètres d’image de marque, comme le logo, les couleurs et les réglages de thème affichés sur l’écran `mfa-phone-enrollment`.
...
<ParamField body="useClient" type={<span>() =&gt; <a href="/docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/ClientMembers">ClientMembers</a></span>}>
  Ce hook fournit des configurations liées à l’application, comme `id`, `name` et `logoUrl`, pour l’écran `mfa-phone-enrollment`.
...
<ParamField body="useMfaPhoneEnrollment" type={<a href="/docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/MfaPhoneEnrollmentMembers">MfaPhoneEnrollmentMembers</a>}>
  Ce hook renvoie toutes les méthodes et tout le contexte disponibles sur l’écran `mfa-phone-enrollment`.
</ParamField>
...
<ParamField body="continueEnrollment" type="Promise<void>">
  Cette méthode soumet le numéro de téléphone de l&#39;utilisateur et le mode d&#39;envoi sélectionné pour inscrire ce numéro à la MFA.
...
<ParamField body={<a href="/docs/libraries/acul/react-sdk/API-Reference/Hooks/useErrors">useErrors</a>} type="Hooks">
  Ce hook lit et gère les erreurs serveur, côté client et développeur à l’écran.
</ParamField>