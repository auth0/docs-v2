...
description: "Décrit tous les hooks et toutes les méthodes disponibles pour personnaliser l’écran `mfa-recovery-code-challenge-new-code` de Universal Login."
---

L’écran `mfa-recovery-code-challenge-new-code` affiche un nouveau code de récupération à l’utilisateur après une authentification réussie et l’invite à l’enregistrer de façon sécuritaire.
...
Hooks propres à l’écran qui fournissent un accès en lecture seule aux données de contexte Auth0 sur l’écran `mfa-recovery-code-challenge-new-code`. Importez-les depuis `@auth0/auth0-acul-react/mfa-recovery-code-challenge-new-code`.
...
<ParamField body="useBranding" type={<span>() =&gt; <a href="/fr-CA/docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/BrandingMembers">BrandingMembers</a></span>}>
  Ce hook fournit la configuration d’image de marque, comme le logo, les couleurs et les paramètres de thème affichés sur l’écran `mfa-recovery-code-challenge-new-code`.
...
<ParamField body="useClient" type={<span>() =&gt; <a href="/fr-CA/docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/ClientMembers">ClientMembers</a></span>}>
  Ce hook fournit la configuration liée à l’application, comme `id`, `name` et `logoUrl`, pour l’écran `mfa-recovery-code-challenge-new-code`.
...
<ParamField body="useOrganization" type={<span>() =&gt; <a href="/fr-CA/docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/OrganizationMembers">OrganizationMembers</a></span>}>
  Ce hook fournit des renseignements sur l’organisation de l’utilisateur si le flux MFA est limité à l’organisation. Renvoie `null` lorsqu’aucun contexte d’organisation n’est présent.
...
<ParamField body="useScreen" type={<span>() =&gt; <a href="/fr-CA/docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/ScreenMembersOnMfaRecoveryCodeChallengeNewCode">ScreenMembersOnMfaRecoveryCodeChallengeNewCode</a></span>}>
...
<ParamField body="useUntrustedData" type={<span>() =&gt; <a href="/fr-CA/docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/UntrustedDataMembers">UntrustedDataMembers</a></span>}>
  Ce hook traite les données non fiables transmises à l’écran, comme les valeurs préremplies provenant de paramètres d’URL.
...
<ParamField body="useMfaRecoveryCodeChallengeNewCode" type={<a href="/fr-CA/docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/MfaRecoveryCodeChallengeNewCodeMembers">MfaRecoveryCodeChallengeNewCodeMembers</a>}>
  Ce hook renvoie toutes les méthodes et tout le contexte disponibles pour l’écran `mfa-recovery-code-challenge-new-code`.
</ParamField>
...
<ParamField body="continueMethod" type="Promise<void>">
  Cette méthode confirme que l’utilisateur a bien enregistré son nouveau code de récupération et permet de poursuivre le flux d’authentification.
...
<ParamField body={<a href="/fr-CA/docs/libraries/acul/react-sdk/API-Reference/Hooks/useErrors">useErrors</a>} type="Hooks">
  Ce hook permet de consulter et de gérer les erreurs côté serveur, côté client et du développeur sur l’écran.
</ParamField>