...
description: "Décrit tous les hooks et toutes les méthodes disponibles pour personnaliser l’écran `brute-force-protection-unblock-success` dans Universal Login."
---

L’écran `brute-force-protection-unblock-success` s’affiche après qu’un utilisateur a débloqué son compte avec succès à la suite d’un blocage causé par la protection contre les attaques par force brute.
...
Hooks propres à l’écran qui fournissent un accès en lecture seule aux données de contexte d’Auth0 sur l’écran `brute-force-protection-unblock-success`. Importez-les depuis `@auth0/auth0-acul-react/brute-force-protection-unblock-success`.
...
<ParamField body="useBranding" type={<span>() =&gt; <a href="/docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/BrandingMembers">BrandingMembers</a></span>}>
  Ce hook fournit les paramètres d’image de marque, comme le logo, les couleurs et les réglages du thème affichés sur l’écran `brute-force-protection-unblock-success`.
...
<ParamField body="useClient" type={<span>() =&gt; <a href="/docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/ClientMembers">ClientMembers</a></span>}>
  Ce hook fournit les configurations liées à l’application, comme `id`, `name` et `logoUrl`, pour l’écran `brute-force-protection-unblock-success`.
...
<ParamField body="useScreen" type={<span>() =&gt; <a href="/docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/ScreenMembersOnBruteForceProtectionUnblockSuccess">ScreenMembersOnBruteForceProtectionUnblockSuccess</a></span>}>
...
<ParamField body="useBruteForceProtectionUnblockSuccess" type={<a href="/docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/BruteForceProtectionUnblockSuccessMembers">BruteForceProtectionUnblockSuccessMembers</a>}>
  Ce hook renvoie toutes les méthodes et tout le contexte disponibles dans l’écran `brute-force-protection-unblock-success`.
</ParamField>
