...
<Frame>
  <img style={{maxHeight:"400px"}} src="/docs/images/cdy7uua7fh8z/7haU4kXN2y0zikB9kanO8J/f32a48edc265d906aa063de96e9f3b89/Passkey_Enrollment.png" alt="Inscription de clé d’accès ACUL" />
</Frame>
...
* L’importation depuis la racine vous permet de charger tous les écrans à partir d’un seul bundle, ce qui est utile si vous souhaitez qu’une compilation unifiée prenne en charge tous les écrans possibles.
...
Hooks propres à l’écran qui fournissent un accès en lecture seule aux données de contexte d’Auth0 pour l’écran `passkey-enrollment`. Importez-les depuis `@auth0/auth0-acul-react/passkey-enrollment`.
...
<ParamField body="useBranding" type={<span>() =&gt; <a href="/fr-CA/docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/BrandingMembers">BrandingMembers</a></span>}>
  Ce hook fournit les paramètres d’image de marque, comme le logo, les couleurs et les paramètres du thème affichés sur l’écran `passkey-enrollment`.
...
<ParamField body="useClient" type={<span>() =&gt; <a href="/fr-CA/docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/ClientMembers">ClientMembers</a></span>}>
  Ce hook fournit les configurations liées à l’application, comme `id`, `name` et `logoUrl`, pour l’écran `passkey-enrollment`.
...
<ParamField body="useOrganization" type={<span>() =&gt; <a href="/fr-CA/docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/OrganizationMembers">OrganizationMembers</a></span>}>
  Ce hook fournit des renseignements sur l’Organisation de l’utilisateur si l’inscription de la clé d’accès est associée à une Organisation. Retourne `null` lorsqu’aucun contexte d’Organisation n’est présent.
...
<ParamField body="useScreen" type={<span>() =&gt; <a href="/fr-CA/docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/ScreenMembersOnPasskeyEnrollment">ScreenMembersOnPasskeyEnrollment</a></span>}>
...
<ParamField body="usePasskeyEnrollment" type={<a href="/fr-CA/docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/PasskeyEnrollmentMembers">PasskeyEnrollmentMembers</a>}>
  Ce hook renvoie toutes les méthodes et tout le contexte disponibles dans l’écran `passkey-enrollment`.
</ParamField>
...
<ParamField body="continuePasskeyEnrollment" type="Promise<void>">
  Cette méthode démarre le processus d’inscription de la clé d’accès et poursuit le flux d’authentification.
...
<ParamField body="doNotShowAgain" type="Promise<void>">
  Cette méthode ignore l’inscription de la clé d’accès et enregistre la préférence de l’utilisateur afin qu’on ne lui demande plus d’inscrire une clé d’accès.
