...
description: "Décrit tous les hooks et toutes les méthodes disponibles pour personnaliser l’écran `customized-consent` dans Universal Login."
---

L’écran `customized-consent` s’affiche pendant le flux d’autorisation lorsqu’un utilisateur doit accorder ou refuser des autorisations à une application avec une expérience de consentement personnalisée. Il affiche les scopes demandés et permet à l’utilisateur d’accepter ou de refuser la demande de consentement.

<Frame>
  <img style={{maxHeight:"400px"}} src="/docs/images/cdy7uua7fh8z/6cK6DkpOJYTjubOGu2vpID/80c03b32275a2c332fe3216df0eca5c7/Consent.png" alt="ACUL Consentement personnalisé" />
</Frame>
...
Hooks propres à l’écran qui fournissent un accès en lecture seule aux données de contexte d’Auth0 sur l’écran `customized-consent`. Importez-les depuis `@auth0/auth0-acul-react/customized-consent`.
...
<ParamField body="useBranding" type={<span>() =&gt; <a href="/fr-CA/docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/BrandingMembers">BrandingMembers</a></span>}>
  Ce hook fournit la configuration d’image de marque, comme le logo, les couleurs et les paramètres de thème affichés sur l’écran `customized-consent`.
...
<ParamField body="useClient" type={<span>() =&gt; <a href="/fr-CA/docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/ClientMembers">ClientMembers</a></span>}>
  Ce hook fournit les configurations liées à l’application, comme `id`, `name` et `logoUrl`, pour l’écran `customized-consent`.
...
<ParamField body="useOrganization" type={<span>() =&gt; <a href="/fr-CA/docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/OrganizationMembers">OrganizationMembers</a></span>}>
  Ce hook fournit des renseignements sur l’organisation de l’utilisateur si la demande de consentement est limitée à l’organisation. Retourne `null` lorsqu’aucun contexte d’organisation n’est présent.
...
<ParamField body="useScreen" type={<span>() =&gt; <a href="/fr-CA/docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/ScreenMembersOnCustomizedConsent">ScreenMembersOnCustomizedConsent</a></span>}>
  Ce hook contient des renseignements propres à l’écran `customized-consent`, y compris sa configuration et son contexte.
...
<ParamField body="useUntrustedData" type={<span>() =&gt; <a href="/fr-CA/docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/UntrustedDataMembers">UntrustedDataMembers</a></span>}>
  Ce hook traite les données non fiables transmises à l’écran, comme les paramètres préremplis provenant des chaînes de requête d’URL.
...
<ParamField body="useUser" type={<span>() =&gt; <a href="/fr-CA/docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/UserMembers">UserMembers</a></span>}>
  Ce hook retourne des informations sur l’utilisateur actif, notamment `username`, `email` et les méthodes d’authentification disponibles.
...
<ParamField body="useCustomizedConsent" type={<a href="/fr-CA/docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/CustomizedConsentMembers">CustomizedConsentMembers</a>}>
  Ce hook retourne toutes les méthodes et le contexte disponibles sur l’écran `customized-consent`.
</ParamField>
...
<ParamField body="accept" type="Promise<void>">
  Cette méthode soumet le consentement de l’utilisateur et accorde à l’application les autorisations demandées.
...
<ParamField body={<a href="/fr-CA/docs/libraries/acul/react-sdk/API-Reference/Hooks/useAuth0Themes">useAuth0Themes</a>} type="Hooks">
  Ce hook récupère les options du thème actuel avec une configuration mise à plat issue du contexte d’image de marque.
</ParamField>
...
<ParamField body={<a href="/fr-CA/docs/libraries/acul/react-sdk/API-Reference/Hooks/useErrors">useErrors</a>} type="Hooks">
  Ce hook permet de lire et de gérer les erreurs serveur, côté client et de développement sur l’écran.
</ParamField>