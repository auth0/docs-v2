...
export interface ScreenMembersOnMfaWebAuthnChangeKeyNickname extends ScreenMembers {
  ...
  data: {
     ...
     * Cette valeur doit être affichée à l'utilisateur pour lui fournir du contexte.
     * @type {string}
     * @example "My YubiKey"
  ...
  * Déclaration de type : `{ nickname: string; }`
  ...
  <Expandable title="propriétés">
    <ParamField body="nickname" type="string">
      ...
      Cette valeur doit être affichée à l’utilisateur pour lui donner du contexte.
