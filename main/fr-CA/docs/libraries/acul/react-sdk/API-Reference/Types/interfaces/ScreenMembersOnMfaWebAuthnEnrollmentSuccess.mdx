...
<ParamField body="data" type={<span><a href="/fr-CA/docs-v2/main/docs/libraries/acul/react-sdkScreens/type-aliases/WebAuthnType">WebAuthnType</a></span>}>
  ...
  * Déclaration de type : `{ nickname: string; webauthnType: [WebAuthnType]; }`
  ...
  <Expandable title="propriétés">
    <ParamField body="nickname" type="string">
      ...
      Cela aide l’utilisateur à reconnaître l’authentificateur plus tard.
    ...
    <ParamField body="webauthnType" type={<span><a href="/fr-CA/docs-v2/main/docs/libraries/acul/react-sdkScreens/type-aliases/WebAuthnType">[WebAuthnType]</a></span>}>
      Le type d’authentificateur WebAuthn qui a été inscrit avec succès.
