...
<ParamField body="data" type={<span><a href="/fr-CA/docs-v2/main/docs/libraries/acul/react-sdkScreens/type-aliases/WebAuthnType">WebAuthnType</a></span>}>
  ...
  &#123; `errorType`: `string`; `webauthnType`: [`WebAuthnType`](/fr-CA/docs-v2/main/docs/libraries/acul/react-sdkScreens/type-aliases/WebAuthnType); &#125;
  ...
  Type d’authentificateur WebAuthn concerné.
