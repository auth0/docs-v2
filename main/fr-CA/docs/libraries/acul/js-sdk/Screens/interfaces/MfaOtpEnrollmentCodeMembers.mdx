...
<ParamField body="continue" type="Promise<void>">
  ...
  <Expandable title="Paramètres">
    <ParamField body="payload" type={<span><a href="/fr-CA/docs/libraries/acul/js-sdk/Screens/interfaces/MfaOtpContinueOptions">MfaOtpContinueOptions</a></span>}>
...
<ParamField body="tryAnotherMethod" type="Promise<void>">
  ...
  <Expandable title="Paramètres">
    <ParamField body="payload?" type={<span><a href="/fr-CA/docs/libraries/acul/js-sdk/Screens/interfaces/MfaOtpTryAnotherMethodOptions">MfaOtpTryAnotherMethodOptions</a></span>}>
