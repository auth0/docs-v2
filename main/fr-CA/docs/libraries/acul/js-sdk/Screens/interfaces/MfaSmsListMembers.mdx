...
export interface MfaSmsListMembers extends BaseMembers {
   ...
   * @param {MfaSmsListOptions} [payload] - Payload optionnel pour l'action.
   * @returns {Promise<void>}
   * @throws {Error} Si l'indice est hors limites.
   */
...
<ParamField body="selectPhoneNumber" type="Promise<void>">
  ...
  <Expandable title="Paramètres">
    <ParamField body="payload?" type={<span><a href="/fr-CA/docs/libraries/acul/js-sdk/Screens/interfaces/MfaSmsListOptions">MfaSmsListOptions</a></span>}>
      Payload facultatif pour l’action.
