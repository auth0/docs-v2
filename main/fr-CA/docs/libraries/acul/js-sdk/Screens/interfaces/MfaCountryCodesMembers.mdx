...
Interface définissant les méthodes et les propriétés disponibles pour l’écran mfa-country-codes
...
<ParamField body="selectCountryCode" type="Promise<void>">
  ...
  <Expandable title="Paramètres">
    <ParamField body="payload" type={<span><a href="/fr-CA/docs/libraries/acul/js-sdk/Screens/interfaces/SelectCountryCodeOptions">SelectCountryCodeOptions</a></span>}>
      Les options qui contiennent l’action de sélection du code de pays
