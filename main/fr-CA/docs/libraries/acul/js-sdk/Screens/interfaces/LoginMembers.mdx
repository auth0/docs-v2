...
<ParamField body="getLoginIdentifiers" type={<span><a href="/docs/libraries/acul/js-sdk/Screens/type-aliases/IdentifierType">IdentifierType</a>[]</span>}>
  **`Fonction utilitaire`**
  ...
  Renvoie les types d’identifiant actifs pour l’écran de connexion

  Un tableau contenant les types d’identifiant actifs, ou null si aucun n’est actif
</ParamField>

<ParamField body="login" type="Promise<void>">
  Effectue la connexion à l’aide d’un nom d’utilisateur et d’un mot de passe
