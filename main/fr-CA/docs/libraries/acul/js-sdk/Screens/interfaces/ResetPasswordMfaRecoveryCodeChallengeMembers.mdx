...
Interface décrivant les propriétés de l’écran de défi par code de récupération MFA de réinitialisation du mot de passe.
...
<ParamField body="tryAnotherMethod" type="Promise<void>">
  Dirige vers l’écran où l’utilisateur peut choisir une autre méthode de MFA.
