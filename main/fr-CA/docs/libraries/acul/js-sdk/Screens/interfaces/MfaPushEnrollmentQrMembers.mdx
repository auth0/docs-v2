...
Interface qui définit les méthodes et propriétés disponibles pour l’écran mfa-push-enrollment-qr
...
<ParamField body="pollingManager" type={<span><a href="/fr-CA/docs/libraries/acul/js-sdk/Screens/interfaces/MfaPushPollingControl">MfaPushPollingControl</a></span>}>
  <Expandable title="Paramètres">
    <ParamField body="options" type={<span><a href="/fr-CA/docs/libraries/acul/js-sdk/Screens/type-aliases/MfaPollingOptions">MfaPollingOptions</a></span>}>
      <ParamField body="MfaPollingOptions" type="object">
        ...
        des requêtes vers le point de terminaison de vérification et la façon dont les réussites et les échecs sont gérés.

        <Expandable title="Propriétés">
          <ParamField body="intervalMs?" type="number">
            Intervalle facultatif, en **millisecondes**, entre les requêtes de scrutation consécutives.
          ...
          <ParamField body="onCompleted()?" type="() => void">
            Fonction de rappel facultative exécutée une fois la demande MFA par notification push
            approuvée avec succès et la scrutation terminée.

            * Appelée exactement **une seule fois**, après quoi la scrutation s’arrête automatiquement.
            * Utile pour faire progresser le flux de connexion (p. ex., en appelant `continue()`).
          </ParamField>

          <ParamField body="onError()?" type="(error) => void">
            Fonction de rappel facultative invoquée si une erreur se produit pendant la scrutation.
            ...
            **Propriétés**
            ...
            <ParamField body="error" type={<span><a href="/fr-CA/docs/libraries/acul/js-sdk/Screens/interfaces/Error">Error</a></span>}>
              **Propriétés**
              ...
              <ParamField body="rules?" type={<span><a href="/fr-CA/docs/libraries/acul/js-sdk/Screens/interfaces/PasswordComplexityRule">PasswordComplexityRule[]</a></span>}>
                **Propriétés**
