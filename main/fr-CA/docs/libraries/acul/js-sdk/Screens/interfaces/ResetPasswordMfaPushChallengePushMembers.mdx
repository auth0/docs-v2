...
export interface ResetPasswordMfaPushChallengePushMembers extends BaseMembers {
  ...
  /**
   * Poursuit la demande d’authentification par notification push
  ...
  /**
   * Permet d'interroger le système en attente d'approbation de la demande d’authentification par notification push.
...
<ParamField body="pollingManager" type={<span><a href="/fr-CA/docs/libraries/acul/js-sdk/Screens/interfaces/MfaPushPollingControl">MfaPushPollingControl</a></span>}>
  Permet de vérifier périodiquement si la demande d’authentification par notification push a été approuvée.
