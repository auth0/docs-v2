...
<ParamField body="screen" type={<span><a href="/fr-CA/docs/libraries/acul/js-sdk/Screens/interfaces/ScreenMembersOnResetPasswordMfaWebAuthnPlatformChallenge">ScreenMembersOnResetPasswordMfaWebAuthnPlatformChallenge</a></span>}>
  Accès aux propriétés et données propres à l’écran &#39;reset-password-mfa-webauthn-platform-challenge&#39;.
</ParamField>
...
<ParamField body="continueWithPasskey" type="Promise<void>">
  Lance la vérification d’authentification par authentificateur de plateforme WebAuthn en appelant `navigator.credentials.get()`
  à l’aide des options de vérification fournies dans `screen.publicKey`.
  Si l’opération réussit, soumet l’assertion d’identifiants obtenue à Auth0 avec `action: "default"`.
  ...
  si `navigator.credentials.get()` échoue (par ex., annulation par l’utilisateur avec `NotAllowedError`),
  ...
  try {
    await sdk.continueWithPasskey({
      rememberDevice: true // si l’utilisateur a coché la case et que sdk.screen.showRememberDevice vaut true
    });
  ...
  <Expandable title="Paramètres">
    <ParamField body="options?" type={<span><a href="/fr-CA/docs/libraries/acul/js-sdk/Screens/interfaces/ResetPasswordMfaWebAuthnPlatformChallengeContinueOptions">ResetPasswordMfaWebAuthnPlatformChallengeContinueOptions</a></span>}>
...
<ParamField body="reportBrowserError" type="Promise<void>">
  ...
  Cela sert à informer Auth0 de problèmes comme l’annulation par l’utilisateur, un délai d’expiration ou du matériel non pris en charge.
  Soumet les détails de l’erreur avec `action: "showError::{errorDetailsJsonString}"`.

  Une promesse qui est résolue lorsque le signalement de l’erreur est soumis.

  #### Lève une erreur

  Si l’envoi du formulaire échoue (par ex., erreur réseau).
  ...
  try {
    ...
    // Auth0 peut réafficher la page ou rediriger en fonction de l’erreur.
  } catch (submitError) {
    console.error("Failed to report WebAuthn browser error:", submitError);
  }
  ```
  ...
  <Expandable title="Paramètres">
    <ParamField body="options" type={<span><a href="/fr-CA/docs/libraries/acul/js-sdk/Screens/interfaces/ResetPasswordMfaWebAuthnPlatformChallengeReportErrorOptions">ResetPasswordMfaWebAuthnPlatformChallengeReportErrorOptions</a></span>}>
...
<ParamField body="tryAnotherMethod" type="Promise<void>">
  Permet à l’utilisateur de se soustraire à la demande de vérification WebAuthn sur la plateforme et de sélectionner une autre méthode de MFA.
  ...
  <Expandable title="Paramètres">
    <ParamField body="options?" type={<span><a href="/fr-CA/docs/libraries/acul/js-sdk/Screens/interfaces/ResetPasswordMfaWebAuthnPlatformChallengeTryAnotherMethodOptions">ResetPasswordMfaWebAuthnPlatformChallengeTryAnotherMethodOptions</a></span>}>
