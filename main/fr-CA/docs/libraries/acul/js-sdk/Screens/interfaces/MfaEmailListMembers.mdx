...
Interface qui définit les méthodes et les propriétés disponibles pour l’écran `mfa-email-list`

```ts Example
export interface MfaEmailListMembers extends BaseMembers {
  screen: ScreenMembersOnMfaEmailList;
  /**
   * Sélectionne une adresse de courriel inscrite dans la liste
...
<ParamField body="selectMfaEmail" type="Promise<void>">
  ...
  <Expandable title="Paramètres">
    <ParamField body="payload" type={<span><a href="/fr-CA/docs/libraries/acul/js-sdk/Screens/interfaces/SelectMfaEmailOptions">SelectMfaEmailOptions</a></span>}>
