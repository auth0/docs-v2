...
export interface MfaPushListMembers extends BaseMembers {
   ...
   * @param payload Les options contenant l'indice de l'appareil.
   */
...
<ParamField body="selectMfaPushDevice" type="Promise<void>">
  Sélectionne un appareil inscrit dans la liste pour lancer MFA push.

  <Expandable title="Paramètres">
    <ParamField body="payload" type={<span><a href="/fr-CA/docs/libraries/acul/js-sdk/Screens/interfaces/SelectMfaPushDeviceOptions">SelectMfaPushDeviceOptions</a></span>}>
