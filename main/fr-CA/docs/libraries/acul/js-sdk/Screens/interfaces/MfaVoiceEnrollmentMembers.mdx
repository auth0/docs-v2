...
Interface décrivant les propriétés de l’écran d’inscription vocale MFA.
...
export interface MfaVoiceEnrollmentMembers extends BaseMembers {
  ...
  /**
   * Continue le processus d'inscription vocale.
   * @param payload - Le numéro de téléphone et les options personnalisées facultatives.
   * @returns Promise qui se résout lorsque l'inscription continue.
   */
  ...
  /**
   * Permet de sélectionner un code de pays pour le numéro de téléphone.
   * @param payload - Options personnalisées facultatives.
   * @returns Promise qui se résout lorsque le code de pays est sélectionné.
   */
...
<ParamField body="continue" type="Promise<void>">
  ...
  <Expandable title="Paramètres">
    <ParamField body="payload" type={<span><a href="/fr-CA/docs/libraries/acul/js-sdk/Screens/interfaces/MfaVoiceEnrollmentContinueOptions">MfaVoiceEnrollmentContinueOptions</a></span>}>
...
<ParamField body="selectPhoneCountryCode" type="Promise<void>">
  ...
  Promesse résolue lorsque le code de pays est sélectionné.
