...
<ParamField body="screen" type={<span><a href="/fr-CA/docs/libraries/acul/js-sdk/Screens/interfaces/ScreenMembersOnResetPasswordMfaVoiceChallenge">ScreenMembersOnResetPasswordMfaVoiceChallenge</a></span>} />
...
<ParamField body="continue" type="Promise<void>">
  ...
  Une promesse résolue lorsque la demande de défi est envoyée.
  ...
  <Expandable title="Paramètres">
    <ParamField body="payload" type={<span><a href="/fr-CA/docs/libraries/acul/js-sdk/Screens/interfaces/ResetPasswordMfaVoiceChallengeContinueOptions">ResetPasswordMfaVoiceChallengeContinueOptions</a></span>}>
...
<ParamField body="resendCode" type="Promise<void>">
  Renvoyer le code par appel vocal.
...
<ParamField body="tryAnotherMethod" type="Promise<void>">
  ...
  Une promesse résolue lorsque la requête est envoyée.
