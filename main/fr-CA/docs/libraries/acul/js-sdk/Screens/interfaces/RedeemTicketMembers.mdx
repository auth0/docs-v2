...
Interface décrivant les données disponibles dans l’écran Redeem Ticket.
...
export interface RedeemTicketMembers extends BaseMembers {
  ...
  /**
   * Effectue l'action par défaut sur l'écran redeem-ticket, ce qui implique généralement de continuer le flux.
...
<ParamField body="continue" type="Promise<void>">
  Exécute l’action par défaut sur l’écran redeem-ticket, ce qui fait généralement progresser le flux.
