...
export interface MfaEmailChallengeMembers extends BaseMembers {
  ...
  /**
   * Soumet l'action pour choisir une configuration de courriel différente, si disponible
   * @param payload Options personnalisées facultatives à inclure dans la requête
   */
...
<ParamField body="continue" type="Promise<void>">
  ...
  <Expandable title="Paramètres">
    <ParamField body="payload" type={<span><a href="/fr-CA/docs/libraries/acul/js-sdk/Screens/interfaces/ContinuePayloadOptions">ContinuePayloadOptions</a></span>}>
      Les options contenant le code et l’option rememberDevice
...
<ParamField body="pickEmail" type="Promise<void>">
  Soumet l’action permettant de sélectionner une autre configuration de courriel, si elle est disponible
...
<ParamField body="resendCode" type="Promise<void>">
  ...
  <Expandable title="Paramètres">
    <ParamField body="payload?" type={<span><a href="/fr-CA/docs/libraries/acul/js-sdk/Screens/interfaces/ResendCodePayloadOptions">ResendCodePayloadOptions</a></span>}>
      Options personnalisées facultatives à inclure dans la requête
    </ParamField>
  </Expandable>
</ParamField>
...
<ParamField body="resendManager" type={<span><a href="/fr-CA/docs/libraries/acul/js-sdk/Screens/interfaces/ResendControl">ResendControl</a></span>}>
  Fournit une fonctionnalité de renvoi avec gestion du délai d’attente pour cet écran
...
<ParamField body="tryAnotherMethod" type="Promise<void>">
  ...
  <Expandable title="Paramètres">
    <ParamField body="payload?" type={<span><a href="/fr-CA/docs/libraries/acul/js-sdk/Screens/interfaces/TryAnotherMethodPayloadOptions">TryAnotherMethodPayloadOptions</a></span>}>
      Options personnalisées facultatives à inclure dans la requête
    </ParamField>
  </Expandable>
</ParamField>