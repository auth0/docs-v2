...
<ParamField body="continuer" type="Promise<void>">
  ...
  <Expandable title="Paramètres">
    <ParamField body="payload" type={<span><a href="/fr-CA/docs/libraries/acul/js-sdk/Screens/interfaces/ContinueOTPOptions">ContinueOTPOptions</a></span>}>
      ...
      **Propriétés**
      ...
      <ParamField body="rememberDevice?" type="boolean">
        Indique s’il faut se souvenir de ce navigateur
      </ParamField>
    </ParamField>
  </Expandable>
</ParamField>
...
<ParamField body="tryAnotherMethod" type="Promise<void>">
  ...
  <Expandable title="Paramètres">
    <ParamField body="payload?" type={<span><a href="/fr-CA/docs/libraries/acul/js-sdk/Screens/interfaces/TryAnotherMethodMfaOtpChallengeOptions">TryAnotherMethodMfaOtpChallengeOptions</a></span>}>
