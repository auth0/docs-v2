...
<ParamField body="continue" type="Promise<void>">
  ...
  Une promesse résolue lorsque l’opération réussit.

  <Expandable title="Paramètres">
    <ParamField body="payload" type={<span><a href="/fr-CA/docs/libraries/acul/js-sdk/Screens/interfaces/MfaRecoveryCodeChallengeContinueOptions">MfaRecoveryCodeChallengeContinueOptions</a></span>}>
