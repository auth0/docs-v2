...
Représente l’interface de l’écran de défi OTP par courriel.
...
<ParamField body="submitCode" type="Promise<void>">
  ...
  <Expandable title="Paramètres">
    <ParamField body="options" type={<span><a href="/docs/libraries/acul/js-sdk/Screens/interfaces/OtpCodeOptions">OtpCodeOptions</a></span>}>
      Paramètres facultatifs à inclure lors de l’envoi.

      **Propriétés**

      <ParamField body="code" type="string">
        Le code OTP que l’utilisateur saisit pour l’envoi.
      </ParamField>
    </ParamField>
  </Expandable>
</ParamField>