...
Interface définissant les méthodes et propriétés disponibles pour l’écran de sélection de l’organisation.
...
<ParamField body="continueWithOrganizationName" type="Promise<void>">
  ...
  <Expandable title="Paramètres">
    <ParamField body="payload" type={<span><a href="/fr-CA/docs/libraries/acul/js-sdk/Screens/interfaces/ContinueWithOrganizationNameOptions">ContinueWithOrganizationNameOptions</a></span>}>
      Options contenant le nom de l’organisation.
