...
Interface qui définit les méthodes et propriétés disponibles pour l’écran `mfa-otp-enrollment-qr`
...
export interface MfaOtpEnrollmentQrMembers extends BaseMembers {
   ...
   * @param payload Charge utile contenant le code et les options personnalisées facultatives
   */
...
<ParamField body="continue" type="Promise<void>">
  ...
  <Expandable title="Paramètres">
    <ParamField body="payload" type={<span><a href="/fr-CA/docs/libraries/acul/js-sdk/Screens/interfaces/MfaOtpEnrollmentQrContinueOptions">MfaOtpEnrollmentQrContinueOptions</a></span>}>
      Charge utile contenant le code et des options personnalisées facultatives
