...
Interface définissant les méthodes et les propriétés offertes pour l’écran mfa-detect-browser-capabilities
...
<ParamField body="detectCapabilities" type="Promise<void>">
  ...
  <Expandable title="Paramètres">
    <ParamField body="payload" type={<span><a href="/fr-CA/docs/libraries/acul/js-sdk/Screens/interfaces/CustomOptions">CustomOptions</a></span>}>
      Les options qui contiennent les indicateurs de capacité du navigateur
    </ParamField>
  </Expandable>
</ParamField>