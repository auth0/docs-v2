...
export interface ResetPasswordMfaEmailChallengeMembers extends BaseMembers {
  ...
  /**
   * Continue le défi par courriel en utilisant le code fourni.
...
<ParamField body="screen" type={<span><a href="/fr-CA/docs/libraries/acul/js-sdk/Screens/interfaces/ScreenMembersOnResetPasswordMfaEmailChallenge">ScreenMembersOnResetPasswordMfaEmailChallenge</a></span>} />
...
<ParamField body="continue" type="Promise<void>">
  Permet de continuer le défi par courriel à l’aide du code fourni.

  <Expandable title="Paramètres">
    <ParamField body="payload" type={<span><a href="/fr-CA/docs/libraries/acul/js-sdk/Screens/interfaces/ContinueOptions">ContinueOptions</a></span>}>
...
<ParamField body="resendCode" type="Promise<void>">
  Renvoye le code par courriel.

  <Expandable title="Paramètres">
    <ParamField body="payload?" type={<span><a href="/fr-CA/docs/libraries/acul/js-sdk/Screens/interfaces/ResendCodeOptions">ResendCodeOptions</a></span>}>
...
<ParamField body="tryAnotherMethod" type="Promise<void>">
  ...
  <Expandable title="Paramètres">
    <ParamField body="payload?" type={<span><a href="/fr-CA/docs/libraries/acul/js-sdk/Screens/interfaces/TryAnotherMethodOptions">TryAnotherMethodOptions</a></span>}>
      Options personnalisées facultatives à inclure dans la requête.
    </ParamField>
  </Expandable>
</ParamField>