...
description: "Décrit toutes les propriétés et méthodes disponibles pour personnaliser l’écran `mfa-webauthn-not-available-error` d’Universal Login."
---
...
Créez une instance du gestionnaire de l’écran d’erreur « MFA WebAuthn non disponible » :
...
<ParamField body="client" type={<span><a href="/fr-CA/docs/libraries/acul/js-sdk/Screens/interfaces/ClientMembers">ClientMembers</a></span>}>
  Fournit la configuration liée à l’application, comme `id`, `name` et `logoUrl`, pour l’écran `mfa-webauthn-not-available-error`.
</ParamField>
...
<ParamField body="screen" type={<span><a href="/fr-CA/docs/libraries/acul/js-sdk/Screens/interfaces/ScreenMembers">ScreenMembers</a></span>}>
  Contient les détails propres à l’écran `mfa-webauthn-not-available-error`, notamment sa configuration et son contexte.
</ParamField>
...
<ParamField body="untrustedData" type={<span><a href="/fr-CA/docs/libraries/acul/js-sdk/Screens/interfaces/UntrustedDataMembers">UntrustedDataMembers</a></span>}>
  Gère les données non fiables transmises au SDK, comme la saisie de l’utilisateur lors du traitement de l’erreur d’indisponibilité de MFA WebAuthn.
</ParamField>

<ParamField body="user" type={<span><a href="/fr-CA/docs/libraries/acul/js-sdk/Screens/interfaces/UserMembers">UserMembers</a></span>}>
  Contient les détails sur l’utilisateur actif, notamment `username`, `email` et `roles`.
</ParamField>
