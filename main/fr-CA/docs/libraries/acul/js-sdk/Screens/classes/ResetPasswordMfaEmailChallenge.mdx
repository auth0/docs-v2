...
description: "Décrit toutes les propriétés et méthodes offertes pour personnaliser l’écran `reset-password-mfa-email-challenge` dans Universal Login."
---
...
<ParamField body="continue" type="Promise<void>">
  ...
  **Paramètres de la méthode**
  ...
  <Expandable title="Paramètres">
    <ParamField body="options">
      [ContinueOptions](/fr-CA/docs/libraries/acul/js-sdk/Screens/interfaces/ContinueOptions).
    </ParamField>
    ...
    <ParamField body="rememberDevice?" type="boolean">
      Indique s’il faut mémoriser l’appareil pour les prochains défis MFA.
    </ParamField>
  </Expandable>
</ParamField>
  ...
  **Paramètres de la méthode**
  ...
  <Expandable title="Paramètres">
    ...
    <ParamField body="onTimeout?" type="void">
      Fonction de rappel déclenchée lorsque le délai d’attente expire et que le bouton de renvoi devient disponible.
    </ParamField>
  </Expandable>
</ParamField>
