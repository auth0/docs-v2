---
title: "MfaPushList"
description: "Décrit toutes les propriétés et méthodes offertes pour personnaliser l’écran `mfa-push-list` de Universal Login."
---
  ...
  **Paramètres de la méthode**
  ...
  <Expandable title="Paramètres">
    ...
    <ParamField body="persist?" type="&#x22;session&#x22;">
      Lorsque la valeur `'session'` est utilisée, la langue sélectionnée est conservée pendant toute la durée de la session.
    </ParamField>
  </Expandable>
</ParamField>
...
<ParamField body="selectMfaPushDevice" type="Promise<void>">
  ...
  **Paramètres de la méthode**
  ...
  <Expandable title="Paramètres">
    <ParamField body="options">
      [SelectMfaPushDeviceOptions](/fr-CA/docs/libraries/acul/js-sdk/Screens/interfaces/SelectMfaPushDeviceOptions).
    </ParamField>

    <ParamField body="deviceIndex" type="number" required>
      L’indice de l’appareil à sélectionner dans la liste des appareils inscrits. L’indice commence à 0.
    </ParamField>
  </Expandable>
</ParamField>