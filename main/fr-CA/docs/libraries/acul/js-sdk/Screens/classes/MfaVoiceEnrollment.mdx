...
description: "Décrit toutes les propriétés et méthodes disponibles pour personnaliser l’écran `mfa-voice-enrollment` dans Universal Login."
---
...
<ParamField body="continue" type="Promise<void>">
  ...
  **Paramètres de la méthode**
  ...
  <Expandable title="Paramètres">
    <ParamField body="options">
      [MfaVoiceEnrollmentContinueOptions](/fr-CA/docs/libraries/acul/js-sdk/Screens/interfaces/MfaVoiceEnrollmentContinueOptions).
    </ParamField>

    <ParamField body="phone" type="string" required>
      Le numéro de téléphone de l’utilisateur qui recevra l’appel vocal.
    </ParamField>
  </Expandable>
</ParamField>
