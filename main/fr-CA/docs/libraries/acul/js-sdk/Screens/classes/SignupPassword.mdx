...
<ParamField body="screen" type={<span><a href="/fr-CA/docs/libraries/acul/js-sdk/Screens/interfaces/ScreenMembersOnSignupPassword">ScreenMembersOnSignupPassword</a></span>}>
...
<ParamField body="transaction" type={<span><a href="/fr-CA/docs/libraries/acul/js-sdk/Screens/interfaces/TransactionMembersOnSignupPassword">TransactionMembersOnSignupPassword</a></span>}>
  ...
  **Paramètres de la méthode**
  ...
  <Expandable title="Paramètres">
    ...
    <ParamField body="captcha?" type="string">
      Le code captcha ou la réponse du fournisseur CAPTCHA. Cette propriété est requise si la [détection des bots](/fr-CA/docs/secure/attack-protection/bot-detection) est activée pour votre locataire Auth0.
    </ParamField>
...
<ParamField body="switchConnection" type="Promise<void>">
  ...
  **Paramètres de la méthode**
  ...
  <Expandable title="Paramètres">
    <ParamField body="options">
      [SwitchConnectionOptionsSignupPassword](/fr-CA/docs/libraries/acul/js-sdk/Screens/interfaces/SwitchConnectionOptionsSignupPassword).
    </ParamField>
