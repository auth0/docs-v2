...
description: "Décrit toutes les propriétés et méthodes disponibles pour personnaliser l’écran `mfa-sms-enrollment` du Universal Login."
---
...
<ParamField body="screen" type={<span><a href="/fr-CA/docs/libraries/acul/js-sdk/Screens/interfaces/ScreenMembersOnMfaSmsEnrollment">ScreenMembersOnMfaSmsEnrollment</a></span>}>
  ...
  **Paramètres de la méthode**
  ...
  <Expandable title="Paramètres">
    ...
    <ParamField body="captcha?" type="string">
      Le code CAPTCHA ou la réponse du fournisseur CAPTCHA. Obligatoire si la détection des robots est activée dans votre locataire Auth0.
    </ParamField>
