...
description: "Décrit toutes les propriétés et méthodes disponibles pour personnaliser l’écran `mfa-email-challenge` dans Universal Login."
---

La classe MfaEmailChallenge implémente la fonctionnalité de l’écran `mfa-email-challenge`. Cet écran s’affiche lorsqu’un utilisateur doit vérifier son courriel dans le cadre de la MFA.

<Frame>
  <img style={{maxHeight:"400px"}} src="/docs/images/cdy7uua7fh8z/2MOpok82dGPfHvpb8hy1Yc/fda2d95621af85e0ea6ff73d51d815ad/Screenshot_2025-02-20_at_13.11.50.png" alt="ACUL MFA Vérification du courriel" />
</Frame>
...
Créez une instance du gestionnaire d’écran du défi MFA par courriel :
...
<ParamField body="client" type={<span><a href="/fr-CA/docs/libraries/acul/js-sdk/Screens/interfaces/ClientMembers">ClientMembers</a></span>}>
  Fournit la configuration de l’application, comme `id`, `name` et `logoUrl`, pour l’écran `mfa-email-challenge`.
</ParamField>
...
<ParamField body="screen" type={<span><a href="/fr-CA/docs/libraries/acul/js-sdk/Screens/interfaces/ScreenMembersOnMfaEmailChallenge">ScreenMembersOnMfaEmailChallenge</a></span>}>
...
<ParamField body="untrustedData" type={<span><a href="/fr-CA/docs/libraries/acul/js-sdk/Screens/interfaces/UntrustedDataMembersOnMfaEmailChallenge">UntrustedDataMembersOnMfaEmailChallenge</a></span>}>
  Gère les données non fiables transmises au SDK, comme les saisies de l’utilisateur lors du défi MFA par courriel.
</ParamField>
...
<ParamField body="continue" type="Promise<void>">
  ...
  **Paramètres de la méthode**
  ...
  <Expandable title="Paramètres">
    <ParamField body="options">
      [ContinuePayloadOptions](/fr-CA/docs/libraries/acul/js-sdk/Screens/interfaces/ContinuePayloadOptions).
    </ParamField>
...
<ParamField body="pickEmail" type="Promise<void>">
  Cette méthode soumet l’action permettant de sélectionner une autre configuration de courriel, si elle est disponible.
