...
Créez une instance du gestionnaire d’écran de modification du surnom de la clé MFA WebAuthn :
...
<ParamField body="branding" type={<span><a href="/fr-CA/docs/libraries/acul/js-sdk/Screens/interfaces/BrandingMembers">BrandingMembers</a></span>}>
  Fournit la configuration d’image de marque, comme le thème et les paramètres associés.
</ParamField>
...
<ParamField body="client" type={<span><a href="/fr-CA/docs/libraries/acul/js-sdk/Screens/interfaces/ClientMembers">ClientMembers</a></span>}>
  Fournit la configuration de l’application, comme `id`, `name` et `logoUrl`, pour l’écran `mfa-webauthn-change-key-nickname`.
</ParamField>
...
<ParamField body="untrustedData" type={<span><a href="/fr-CA/docs/libraries/acul/js-sdk/Screens/interfaces/UntrustedDataMembers">UntrustedDataMembers</a></span>}>
  Gère les données non fiables transmises au SDK, comme les saisies de l’utilisateur lors de la modification du surnom de la clé MFA WebAuthn.
</ParamField>
