...
description: "Décrit toutes les propriétés et méthodes disponibles pour personnaliser l’écran `accept-invitation` d’Universal Login."
---
...
<ParamField body="client" type={<span><a href="/fr-CA/docs/libraries/acul/js-sdk/Screens/interfaces/ClientMembers">ClientMembers</a></span>}>
  Fournit la configuration liée à l’application, comme `id`, `name` et `logoUrl`, pour l’écran `accept-invitation`.
</ParamField>
...
<ParamField body="screen" type={<span><a href="/fr-CA/docs/libraries/acul/js-sdk/Screens/interfaces/ScreenMembersOnAcceptInvitation">ScreenMembersOnAcceptInvitation</a></span>}>
  Contient des détails propres à l’écran `accept-invitation`, notamment sa configuration et son contexte.
</ParamField>
...
<ParamField body="untrustedData" type={<span><a href="/fr-CA/docs/libraries/acul/js-sdk/Screens/interfaces/UntrustedDataMembers">UntrustedDataMembers</a></span>}>
  Traite les données non fiables transmises au SDK, comme les saisies de l’utilisateur pendant le flux d’acceptation de l’invitation.
</ParamField>
  ...
  **Paramètres de la méthode**
  ...
  <Expandable title="Paramètres">
    ...
    <ParamField body="language" type="string" required>
      Le code local de la langue souhaitée (par exemple, `'en'`, `'fr'`, `'es'`).
    </ParamField>
