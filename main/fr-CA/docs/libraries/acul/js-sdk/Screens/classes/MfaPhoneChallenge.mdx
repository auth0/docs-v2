...
description: "Décrit toutes les propriétés et méthodes disponibles pour personnaliser l’écran `mfa-phone-challenge` dans Universal Login."
---
...
<ParamField body="continue" type="Promise<void>">
  ...
  **Paramètres de la méthode**
  ...
  <Expandable title="Paramètres">
    <ParamField body="options">
      [MfaPhoneChallengeContinueOptions](/fr-CA/docs/libraries/acul/js-sdk/Screens/interfaces/MfaPhoneChallengeContinueOptions).
    </ParamField>

    <ParamField body="type" type="&#x22;sms&#x22; | &#x22;voice&#x22;" required>
      Le mode d’envoi du code MFA.
    </ParamField>
  </Expandable>
</ParamField>
