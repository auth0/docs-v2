---
title: "LogoutAborted"
description: "Décrit toutes les propriétés et méthodes disponibles pour personnaliser l’écran `logout-aborted` dans Universal Login."
---

La classe LogoutAborted implémente la fonctionnalité de l’écran `logout-aborted`. Cet écran s’affiche lorsqu’un utilisateur annule le processus de déconnexion.
...
<ParamField body="client" type={<span><a href="/fr-CA/docs/libraries/acul/js-sdk/Screens/interfaces/ClientMembers">ClientMembers</a></span>}>
  Fournit la configuration liée à l’application, comme `id`, `name` et `logoUrl`, pour l’écran `logout-aborted`.
</ParamField>
...
<ParamField body="tenant" type={<span><a href="/fr-CA/docs/libraries/acul/js-sdk/Screens/interfaces/TenantMembers">TenantMembers</a></span>}>
  Contient des données sur le locataire, comme `id` et les métadonnées associées.
</ParamField>
