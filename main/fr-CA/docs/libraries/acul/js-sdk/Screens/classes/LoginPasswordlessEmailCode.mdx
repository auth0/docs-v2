...
description: "Décrit toutes les propriétés et méthodes offertes pour personnaliser l’écran `login-passwordless-email-code` de Universal Login."
---
...
<Frame>
  <img style={{maxHeight:"400px"}} src="/docs/images/cdy7uua7fh8z/4DKgjU2dGw0mpLJKGfGhp0/470b29266da87f9bfc3e7eef55069620/Login_Passwordless_Email_Code.png" alt="Connexion Passwordless par courriel avec code" />
</Frame>
  ...
  **Paramètres de la méthode**
  ...
  <Expandable title="Paramètres">
    ...
    <ParamField body="onTimeout?" type="() => void">
      Callback invoqué lorsque la période d’attente prend fin et que le renvoi redevient possible.
    </ParamField>
  </Expandable>
</ParamField>
