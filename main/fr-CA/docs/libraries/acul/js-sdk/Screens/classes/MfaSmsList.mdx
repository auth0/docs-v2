...
La classe MfaSmsList implémente la fonctionnalité de l’écran `mfa-sms-list`. Cet écran s’affiche lorsque l’utilisateur doit sélectionner un numéro de téléphone déjà inscrit pour la MFA par SMS.
...
Créez une instance du gestionnaire de l’écran de liste des SMS MFA :
...
<ParamField body="client" type={<span><a href="/fr-CA/docs/libraries/acul/js-sdk/Screens/interfaces/ClientMembers">ClientMembers</a></span>}>
  Fournit des configurations liées à l’application, comme `id`, `name` et `logoUrl`, pour l’écran `mfa-sms-list`.
</ParamField>
...
<ParamField body="screen" type={<span><a href="/fr-CA/docs/libraries/acul/js-sdk/Screens/interfaces/ScreenMembers">ScreenMembers</a></span>}>
  Contient des détails propres à l’écran `mfa-sms-list`, y compris sa configuration et son contexte.
</ParamField>
...
<ParamField body="untrustedData" type={<span><a href="/fr-CA/docs/libraries/acul/js-sdk/Screens/interfaces/UntrustedDataMembers">UntrustedDataMembers</a></span>}>
  Gère les données non fiables transmises au SDK, comme la saisie de l’utilisateur lors de la sélection dans la liste MFA par SMS.
</ParamField>
...
<ParamField body="selectPhoneNumber" type="Promise<void>">
  Cette méthode sélectionne un numéro de téléphone dans la liste des numéros de téléphone déjà inscrits.
