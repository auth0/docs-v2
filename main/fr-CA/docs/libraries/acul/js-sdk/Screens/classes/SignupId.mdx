---
title: "SignupId"
description: "Décrit toutes les propriétés et méthodes disponibles pour personnaliser l’écran `signup-id` d’Universal Login."
---

La classe SignupId implémente la fonctionnalité de l’écran `signup-id`. Cet écran collecte l’identifiant de l’utilisateur.

<Frame>
  <img style={{maxHeight:"400px"}} src="/docs/images/cdy7uua7fh8z/5lzGYj0k4VcxvPCBYH37SO/ebd291cc0dbd673a70f93530f724bf65/Signup_ID.png" alt="ID d’inscription" />
</Frame>
...
<ParamField body="screen" type={<span><a href="/fr-CA/docs/libraries/acul/js-sdk/Screens/interfaces/ScreenMembersOnSignupId">ScreenMembersOnSignupId</a></span>}>
...
<ParamField body="transaction" type={<span><a href="/fr-CA/docs/libraries/acul/js-sdk/Screens/interfaces/TransactionMembersOnSignupId">TransactionMembersOnSignupId</a></span>}>
  ...
  **Paramètres de la méthode**
  ...
  <Expandable title="Paramètres">
    ...
    <ParamField body="captcha?" type="string">
      Le code captcha ou la réponse du fournisseur CAPTCHA. Cette propriété est requise si la [détection des bots](/fr-CA/docs/secure/attack-protection/bot-detection) est activée dans votre locataire Auth0.
    </ParamField>
