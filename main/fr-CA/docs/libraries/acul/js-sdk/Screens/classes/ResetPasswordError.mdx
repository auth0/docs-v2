...
description: "Décrit toutes les propriétés et méthodes disponibles pour personnaliser l’écran `reset-password-error` dans Universal Login."
---

La classe ResetPasswordError implémente la fonctionnalité de l’écran `reset-password-error`. Cet écran s’affiche lorsqu’une erreur survient dans le flux de réinitialisation du mot de passe, par exemple si un lien de réinitialisation a expiré ou est invalide.
...
<ParamField body="client" type={<span><a href="/fr-CA/docs/libraries/acul/js-sdk/Screens/interfaces/ClientMembers">ClientMembers</a></span>}>
  Fournit la configuration liée à l’application, comme `id`, `name` et `logoUrl`, pour l’écran `reset-password-error`.
</ParamField>
...
<ParamField body="screen" type={<span><a href="/fr-CA/docs/libraries/acul/js-sdk/Screens/interfaces/ScreenMembersOnResetPasswordError">ScreenMembersOnResetPasswordError</a></span>}>
  Contient les détails propres à l’écran `reset-password-error`, y compris sa configuration et son contexte.
</ParamField>
...
<ParamField body="untrustedData" type={<span><a href="/fr-CA/docs/libraries/acul/js-sdk/Screens/interfaces/UntrustedDataMembers">UntrustedDataMembers</a></span>}>
  Gère les données non fiables transmises au SDK, comme la saisie de l’utilisateur pendant le flux de réinitialisation du mot de passe.
</ParamField>
