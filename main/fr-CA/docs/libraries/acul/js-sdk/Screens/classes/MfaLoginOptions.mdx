...
<Frame>
  <img style={{maxHeight:"400px"}} src="/docs/images/cdy7uua7fh8z/4TnKlKLKFyAdX6dcOvVlXw/ebd248e8aabf78d20ba1ffec746b4404/Screenshot_2025-02-20_at_17.25.02.png" alt="Options de connexion MFA d’ACUL" />
</Frame>
...
<ParamField body="enroll" type="Promise<void>">
  ...
  **Paramètres de la méthode**
  ...
  <Expandable title="Paramètres">
    <ParamField body="options">
      [LoginEnrollOptions](/fr-CA/docs/libraries/acul/js-sdk/Screens/interfaces/LoginEnrollOptions).
    </ParamField>
