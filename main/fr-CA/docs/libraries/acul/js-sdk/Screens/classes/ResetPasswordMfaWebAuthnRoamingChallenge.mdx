  ...
  **Paramètres de la méthode**
  ...
  <Expandable title="Paramètres">
    ...
    <ParamField body="rememberDevice?" type="boolean">
      Lorsque `true`, conserve la préférence « se souvenir de l’appareil » avec le rapport d’erreur.
    </ParamField>
  </Expandable>
</ParamField>
...
<ParamField body="tryAnotherMethod" type="Promise<void>">
  ...
  **Paramètres de la méthode**
  ...
  <Expandable title="Paramètres">
    ...
    <ParamField body="rememberDevice?" type="boolean">
      Lorsque `true`, conserve la préférence « se souvenir de l’appareil » lors du changement de méthode.
    </ParamField>
  </Expandable>
</ParamField>
...
<ParamField body="useSecurityKey" type="Promise<void>">
  ...
  **Paramètres de la méthode**
  ...
  <Expandable title="Paramètres">
    ...
    <ParamField body="rememberDevice?" type="boolean">
      Lorsque `true`, l’appareil est marqué comme fiable afin que l’utilisateur n’ait plus à effectuer l’AMF sur cet appareil.
    </ParamField>
  </Expandable>
</ParamField>