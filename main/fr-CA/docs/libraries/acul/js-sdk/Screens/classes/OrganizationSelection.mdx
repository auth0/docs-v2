...
description: "Décrit toutes les propriétés et méthodes disponibles pour personnaliser l’écran `organization-selection` d’Universal Login."
---

La classe OrganizationSelection implémente la fonctionnalité de l’écran `organization-selection`. Cet écran permet aux utilisateurs de sélectionner une organisation afin de continuer.
...
Créez une instance du gestionnaire de l’écran OrganizationSelection :
...
<ParamField body="branding" type={<span><a href="/fr-CA/docs/libraries/acul/js-sdk/Screens/interfaces/BrandingMembers">BrandingMembers</a></span>}>
  Fournit la configuration liée à l’image de marque, notamment le thème et les paramètres associés.
</ParamField>
...
<ParamField body="client" type={<span><a href="/fr-CA/docs/libraries/acul/js-sdk/Screens/interfaces/ClientMembers">ClientMembers</a></span>}>
  Fournit la configuration de l’application, comme `id`, `name` et `logoUrl`, pour l’écran `organization-selection`.
</ParamField>
...
<ParamField body="screen" type={<span><a href="/fr-CA/docs/libraries/acul/js-sdk/Screens/interfaces/ScreenMembersOnOrganizationSelection">ScreenMembersOnOrganizationSelection</a></span>}>
  Contient les détails propres à l’écran `organization-selection`, y compris sa configuration et son contexte.
</ParamField>
...
<ParamField body="untrustedData" type={<span><a href="/fr-CA/docs/libraries/acul/js-sdk/Screens/interfaces/UntrustedDataMembers">UntrustedDataMembers</a></span>}>
  Gère les données non fiables transmises au SDK, comme les entrées de l’utilisateur pendant le flux de sélection de l’organisation.
</ParamField>
  ...
  **Paramètres de la méthode**
  ...
  <Expandable title="Paramètres">
    ...
    <ParamField body="persist?" type="&#x22;session&#x22;">
      Lorsque la valeur est définie à `'session'`, la langue sélectionnée est conservée pendant toute la durée de la session.
    </ParamField>
  </Expandable>
</ParamField>

<ParamField body="continueWithOrganizationName" type="Promise<void>">
  Cette méthode poursuit le flux avec le nom de l’organisation sélectionnée.
  ...
  **Paramètres de la méthode**
  ...
  <Expandable title="Paramètres">
    <ParamField body="options">
      [ContinueWithOrganizationNameOptions](/fr-CA/docs/libraries/acul/js-sdk/Screens/interfaces/ContinueWithOrganizationNameOptions).
    </ParamField>
