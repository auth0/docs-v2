...
description: "Décrit toutes les propriétés et méthodes disponibles pour personnaliser l’écran `device-code-activation-denied` de la fonctionnalité Universal Login."
---
...
Créez une instance du gestionnaire d’écran DeviceCodeActivationDenied :
...
<ParamField body="screen" type={<span><a href="/fr-CA/docs/libraries/acul/js-sdk/Screens/interfaces/ScreenMembers">ScreenMembers</a></span>}>
  Contient des détails propres à l’écran `device-code-activation-denied`, notamment sa configuration et son contexte.
</ParamField>
