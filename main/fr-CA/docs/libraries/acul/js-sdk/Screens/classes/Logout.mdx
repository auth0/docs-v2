---
title: "Déconnexion"
description: "Décrit toutes les propriétés et méthodes disponibles pour personnaliser l’écran `logout` de Universal Login."
---

La classe Logout implémente la fonctionnalité de l’écran `logout`. Cet écran permet aux utilisateurs de confirmer ou d’annuler la déconnexion.
...
Créez une instance du gestionnaire d’écran Logout :
...
<ParamField body="client" type={<span><a href="/fr-CA/docs/libraries/acul/js-sdk/Screens/interfaces/ClientMembers">ClientMembers</a></span>}>
  Fournit des configurations liées à l’application, comme `id`, `name` et `logoUrl`, pour l’écran `logout`.
</ParamField>
...
<ParamField body="screen" type={<span><a href="/fr-CA/docs/libraries/acul/js-sdk/Screens/interfaces/ScreenMembers">ScreenMembers</a></span>}>
  Contient des détails propres à l’écran `logout`, notamment sa configuration et son contexte.
</ParamField>
...
<ParamField body="untrustedData" type={<span><a href="/fr-CA/docs/libraries/acul/js-sdk/Screens/interfaces/UntrustedDataMembers">UntrustedDataMembers</a></span>}>
  Contient des données non fiables transmises au SDK, comme les entrées de l’utilisateur pendant la connexion.
</ParamField>
...
<ParamField body="confirmLogout" type="Promise<void>">
  Cette méthode confirme l’action de déconnexion (accepter ou refuser).
  ...
  **Paramètres de la méthode**
  ...
  <Expandable title="Paramètres">
    <ParamField body="options">
      [ConfirmLogoutOptions](/fr-CA/docs/libraries/acul/js-sdk/Screens/interfaces/ConfirmLogoutOptions).
    </ParamField>
...
<ParamField body="getErrors" type={<span><a href="/fr-CA/docs/libraries/acul/js-sdk/Screens/interfaces/Error">Error</a>[]</span>}>
  Cette méthode récupère le tableau des erreurs de la transaction à partir du contexte, ou un tableau vide s’il n’y en a aucune. Elle renvoie un tableau d’objets d’erreur provenant du contexte de la transaction.
</ParamField>