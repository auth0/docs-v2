...
description: "Décrit toutes les propriétés et méthodes disponibles pour personnaliser l’écran `reset-password-mfa-phone-challenge` dans Universal Login."
---
...
<ParamField body="continue" type="Promise<void>">
  ...
  **Paramètres de la méthode**
  ...
  <Expandable title="Paramètres">
    <ParamField body="options">
      [ResetPasswordMfaPhoneChallengeContinueOptions](/fr-CA/docs/libraries/acul/js-sdk/Screens/interfaces/ResetPasswordMfaPhoneChallengeContinueOptions).
    </ParamField>

    <ParamField body="type" type="&#x22;sms&#x22; | &#x22;voice&#x22;" required>
      La méthode d’envoi du code de vérification. Utilisez `sms` pour l’envoyer par message texte ou `voice` pour l’envoyer par appel vocal.
    </ParamField>
  </Expandable>
</ParamField>
...
<ParamField body="tryAnotherMethod" type="Promise<void>">
  ...
  **Paramètres de la méthode**
  ...
  <Expandable title="Paramètres">
    <ParamField body="options">
      [ResetPasswordMfaPhoneChallengeTryAnotherMethodOptions](/fr-CA/docs/libraries/acul/js-sdk/Screens/interfaces/ResetPasswordMfaPhoneChallengeTryAnotherMethodOptions).
    </ParamField>

    <ParamField body="type?" type="&#x22;sms&#x22; | &#x22;voice&#x22;">
      La méthode d’envoi présentée sur l’écran actuel. Requise par l’API pour traiter correctement le changement de méthode.
    </ParamField>
  </Expandable>
</ParamField>