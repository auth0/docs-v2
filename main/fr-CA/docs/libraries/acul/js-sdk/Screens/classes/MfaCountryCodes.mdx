...
description: "Décrit toutes les propriétés et méthodes disponibles pour personnaliser l’écran `mfa-country-codes` d’Universal Login."
---

La classe MfaCountryCodes implémente la fonctionnalité de l’écran `mfa-country-codes`. Cet écran permet aux utilisateurs de sélectionner un code du pays pour la vérification du numéro de téléphone pour la MFA.

<Frame>
  <img style={{maxHeight:"400px"}} src="/docs/images/cdy7uua7fh8z/7hp8LeL9cbS3nbxw8wTuqK/3c862b1c47ae18fb43f22f55ea4d695a/Screenshot_2025-02-19_at_13.23.44.png" alt="ACUL MFA - Codes de pays" />
</Frame>
...
Créez une instance du gestionnaire de l’écran des codes de pays MFA :
...
<ParamField body="client" type={<span><a href="/docs/libraries/acul/js-sdk/Screens/interfaces/ClientMembers">ClientMembers</a></span>}>
  Fournit des configurations liées à l’application, comme `id`, `name` et `logoUrl`, pour l’écran `mfa-country-codes`.
</ParamField>
...
<ParamField body="untrustedData" type={<span><a href="/docs/libraries/acul/js-sdk/Screens/interfaces/UntrustedDataMembers">UntrustedDataMembers</a></span>}>
  Gère les données non fiables transmises au SDK, comme les saisies de l’utilisateur lors de la sélection de l’indicatif de pays MFA.
</ParamField>
...
<ParamField body="selectCountryCode" type="Promise<void>">
  Cette méthode sélectionne un code du pays parmi les options disponibles.
  ...
  **Paramètres de la méthode**
  ...
  <Expandable title="Paramètres">
    ...
    <ParamField body="country_code" type="string" required>
      Le code du pays (par exemple, `'US'`, `'GB'`).
    </ParamField>
