...
<ParamField body="reportBrowserError" type="Promise<void>">
  ...
  **Paramètres de la méthode**
  ...
  <Expandable title="Paramètres">
    <ParamField body="options">
      [MfaWebAuthnPlatformChallengeReportErrorOptions](/fr-CA/docs/libraries/acul/js-sdk/Screens/interfaces/MfaWebAuthnPlatformChallengeReportErrorOptions).
    </ParamField>
  ...
  **Paramètres de la méthode**
  ...
  <Expandable title="Paramètres">
    ...
    <ParamField body="rememberDevice?" type="boolean">
      Lorsque `true`, le navigateur est mémorisé pour les prochains défis MFA. S’applique uniquement si `screen.showRememberDevice` a la valeur `true`.
    </ParamField>
  </Expandable>
</ParamField>