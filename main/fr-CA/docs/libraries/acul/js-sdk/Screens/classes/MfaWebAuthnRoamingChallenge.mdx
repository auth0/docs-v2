...
description: "Décrit toutes les propriétés et méthodes disponibles pour personnaliser l’écran `mfa-webauthn-roaming-challenge` dans Universal Login."
---
...
<ParamField body="reportWebAuthnError" type="Promise<void>">
  ...
  **Paramètres de la méthode**
  ...
  <Expandable title="Paramètres">
    <ParamField body="options">
      [MfaWebAuthnRoamingChallengeReportErrorOptions](/fr-CA/docs/libraries/acul/js-sdk/Screens/interfaces/MfaWebAuthnRoamingChallengeReportErrorOptions).
    </ParamField>
  ...
  **Paramètres de la méthode**
  ...
  <Expandable title="Paramètres">
    ...
    <ParamField body="rememberDevice?" type="boolean">
      Lorsque `true`, mémorise le navigateur pour les futurs défis MFA. S’applique uniquement si `screen.showRememberDevice` est `true`.
    </ParamField>
  </Expandable>
</ParamField>