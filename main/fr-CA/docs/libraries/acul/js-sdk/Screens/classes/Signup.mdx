---
title: "Signup"
description: "Décrit toutes les propriétés et méthodes disponibles pour personnaliser l’écran `signup` de Universal Login."
---
...
<ParamField body="screen" type={<span><a href="/fr-CA/docs/libraries/acul/js-sdk/Screens/interfaces/ScreenMembersOnSignup">ScreenMembersOnSignup</a></span>}>
...
<ParamField body="transaction" type={<span><a href="/fr-CA/docs/libraries/acul/js-sdk/Screens/interfaces/TransactionMembersOnSignup">TransactionMembersOnSignup</a></span>}>
...
<ParamField body="federatedSignup" type="Promise<void>">
  Cette méthode gère la soumission du formulaire Signup social. Elle est semblable à la méthode [signup](#signup), mais elle est utilisée pour les Signups sociaux.
...
<ParamField body="getSignupIdentifiers" type={<span><a href="/fr-CA/docs/libraries/acul/js-sdk/Screens/interfaces/Identifier">Identifier</a>[] | null</span>}>
...
<ParamField body="validatePassword" type={<span><a href="/fr-CA/docs/libraries/acul/js-sdk/Screens/interfaces/PasswordValidationResult">PasswordValidationResult</a></span>}>
  Cette méthode retourne un objet de type [PasswordValidationResult](/fr-CA/docs/libraries/acul/js-sdk/Screens/interfaces/PasswordValidationResult) indiquant si le mot de passe est valide et, sinon, pourquoi.
...
<ParamField body="validateUsername" type={<span><a href="/fr-CA/docs/libraries/acul/js-sdk/Screens/interfaces/UsernameValidationResult">UsernameValidationResult</a></span>}>
