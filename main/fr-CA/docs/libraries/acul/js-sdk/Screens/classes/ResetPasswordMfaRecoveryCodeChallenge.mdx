...
description: "Décrit toutes les propriétés et méthodes disponibles pour personnaliser l’écran `reset-password-mfa-recovery-code-challenge` d’Universal Login."
---

La classe ResetPasswordMfaRecoveryCodeChallenge implémente les fonctionnalités de l’écran `reset-password-mfa-recovery-code-challenge`. Cet écran invite l’utilisateur à saisir un code de récupération dans le cadre de l’étape MFA du flux de réinitialisation du mot de passe.
...
Créez une instance du gestionnaire de l’écran ResetPasswordMfaRecoveryCodeChallenge :
...
<ParamField body="branding" type={<span><a href="/fr-CA/docs/libraries/acul/js-sdk/Screens/interfaces/BrandingMembers">BrandingMembers</a></span>}>
  Fournit des configurations liées à l’image de marque, comme le thème et d’autres paramètres.
</ParamField>
...
<ParamField body="client" type={<span><a href="/fr-CA/docs/libraries/acul/js-sdk/Screens/interfaces/ClientMembers">ClientMembers</a></span>}>
  Fournit des configurations liées à l’application, comme `id`, `name` et `logoUrl`, pour l’écran `reset-password-mfa-recovery-code-challenge`.
</ParamField>
...
<ParamField body="screen" type={<span><a href="/fr-CA/docs/libraries/acul/js-sdk/Screens/interfaces/ScreenMembersOnResetPasswordMfaRecoveryCodeChallenge">ScreenMembersOnResetPasswordMfaRecoveryCodeChallenge</a></span>}>
  Contient les détails propres à l’écran `reset-password-mfa-recovery-code-challenge`, y compris sa configuration et son contexte.
</ParamField>
...
<ParamField body="untrustedData" type={<span><a href="/fr-CA/docs/libraries/acul/js-sdk/Screens/interfaces/UntrustedDataMembers">UntrustedDataMembers</a></span>}>
  Contient des données non fiables transmises au SDK, comme les données saisies par l’utilisateur pendant le flux de défi MFA.
</ParamField>
...
<ParamField body="continue" type="Promise<void>">
  Cette méthode envoie le code de récupération pour continuer le défi MFA dans le flux de réinitialisation du mot de passe.
