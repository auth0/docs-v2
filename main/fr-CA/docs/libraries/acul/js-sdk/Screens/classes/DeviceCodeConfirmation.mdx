...
description: "Décrit toutes les propriétés et méthodes offertes pour personnaliser l’écran `device-code-confirmation` de Universal Login."
---
  ...
  **Paramètres de la méthode**
  ...
  <Expandable title="Paramètres">
    ...
    <ParamField body="language" type="string" required>
      Le code de langue correspondant aux paramètres régionaux souhaités (par exemple, `'en'`, `'fr'`, `'es'`).
    </ParamField>
