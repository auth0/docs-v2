---
title: "LoginPassword"
description: "Décrit toutes les propriétés et méthodes disponibles pour personnaliser l’écran `login-password` dans Universal Login."
---
  ...
  **Paramètres de la méthode**
  ...
  <Expandable title="Paramètres">
    ...
    <ParamField body="language" type="string" required>
      Le code de langue correspondant aux paramètres régionaux pour la langue souhaitée (par exemple, `'en'`, `'fr'`, `'es'`).
    </ParamField>
  ...
  **Paramètres de la méthode**
  ...
  <Expandable title="Paramètres">
    ...
    <ParamField body="captcha?" type="string">
      Le code captcha ou la réponse du fournisseur de captcha. Cette propriété est requise si la fonctionnalité [Bot Detection](/fr-CA/docs/secure/attack-protection/bot-detection) est activée dans votre locataire Auth0.
    </ParamField>
...
<ParamField body="switchConnection" type="Promise<void>">
  ...
  **Paramètres de la méthode**
  ...
  <Expandable title="Paramètres">
    <ParamField body="options">
      [SwitchConnectionOptionsLoginPassword](/fr-CA/docs/libraries/acul/js-sdk/Screens/interfaces/SwitchConnectionOptionsLoginPassword).
    </ParamField>
