---
title: Référence des paramètres de la Management API pour les règles de l’ACL du locataire
sidebarTitle: Paramètres de l’API
description: Consultez la description de tous les paramètres des points de terminaison de l’ACL du locataire dans la Management API.
---

Lorsque vous gérez l’ACL du locataire avec la [Management API](/fr-CA/docs/api/management/v2), les paramètres de règle suivants définissent le comportement de ces règles.
