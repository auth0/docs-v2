...
1. une qui affiche un drapeau, fonctionne avec les connexions de base de données et utilise la bibliothèque auth0.js pour créer l’utilisateur (utilisée par les applications monopages). Pour en savoir plus, consultez la [référence Auth0.js v9](/fr-CA/docs/libraries/auth0js).
