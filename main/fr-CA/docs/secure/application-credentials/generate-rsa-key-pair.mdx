---
description: Découvrez comment générer une paire de clés RSA.
title: Générer une paire de clés RSA
---

<Warning>
  Vous devriez générer une paire de clés distincte pour chaque type d’utilisation des justificatifs. Par exemple, ne réutilisez pas la même paire de clés pour JAR et pour l’authentification Private Key JWT.
</Warning>
...
1. Générez une clé privée et une clé publique au format PEM. Vous devriez protéger la clé privée et ne jamais la partager, même avec Auth0 :
...
3. Enregistrez le fichier PEM. Vous aurez besoin du contenu de la clé à d’autres étapes de configuration de l’application.
