---
description: Découvrez comment authentifier des utilisateurs à l’aide du flux Resource Owner Password avec MFA.
title: Authentifier à l’aide du flux Resource Owner Password avec MFA
---
