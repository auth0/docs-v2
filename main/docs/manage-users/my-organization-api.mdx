...
We strongly encourage starting with our embeddable UI components, [Auth0 Universal Compnents](/docs/get-started/universal-components/universal-components-overview), in favor of using an API-first integration. These resources should significantly reduce your development time and quickly deliver a self-service experience to your customers.
