...
To get a specific user by email address, call the [Search Users by Email endpoint](/docs/api/management/v2/users-by-email/get-users-by-email) (`GET /users-by-email`) and pass the email address as the [`email` path parameter](/docs/api/management/v2/users-by-email/get-users-by-email#parameter-email):
