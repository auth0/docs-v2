...
redirects:
  - "/docs/manage-users/user-search/retrieve-users-with-get-users-by-email-endpoint"
  - "/docs/manage-users/user-search/retrieve-users-with-get-users-by-id-endpoint"
  - "/docs/users/user-search/retrieve-users-with-get-users-by-id-endpoint"
  - "/docs/users/search/v3/get-users-by-id-endpoint"
  - "/docs/users/user-search/retrieve-users-with-get-users-by-email-endpoint"
  - "/docs/users/search/v3/get-users-by-email-endpoint"
---
