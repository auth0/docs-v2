...
sidebarTitle: Lucene Search Query Syntax
...
* All search values are case sensitive except for search values for [normalized user profile fields](/docs/manage-users/user-accounts/user-profiles/normalized-user-profiles) (`email`, `name`, `given_name`, `family_name`, and `nickname`), which are case insensitive.
