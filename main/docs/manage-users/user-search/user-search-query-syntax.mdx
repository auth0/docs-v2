...
| Users whose cities contain Paris | `q: user_metadata.preferences.addresses.cities:"Paris"` |
...
| Users whose name starts with "test" | `email:test*` |
...
| Users who last logged in before 2025 | `last_login:[* TO 2025-12-31]` |
