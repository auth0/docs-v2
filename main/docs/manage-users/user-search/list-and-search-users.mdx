...
redirects:
  - "/docs/manage-users/user-search/retrieve-users-with-get-users-endpoint"
  - "/docs/manage-users/user-search/sort-search-results"
  - "/docs/manage-users/user-search/user-search-best-practices"
  - "/docs/users/user-search/sort-search-results"
  - "/docs/users/search/v3/sort-search-results"
  - "/docs/users/user-search/retrieve-users-with-get-users-endpoint"
  - "/docs/users/user-search/retrieve-users-with-the-get-users-endpoint"
  - "/docs/users/search/v3/get-users-endpoint"
  - "/docs/best-practices/user-search-best-practices"
  - "/docs/users/search/best-practices"
  - "/docs/best-practices/search-best-practices"
---
...
* Auth0 user profiles have a size limit of 10 KB. For oversized user profiles that precede this size limit, there is a [1 MB per-user limit on user data](/docs/manage-users/user-accounts/metadata/metadata-fields-data#size-limits-and-storage) that can be indexed, queried, and returned when using the Management API's List or Search Users endpoint. To retrieve all user attributes for a large user profile, [get users by ID or email](/docs/manage-users/user-search/get-users-by-id-or-email).
