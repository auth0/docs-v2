---
title: How to List and Filter Users
sidebarTitle: List and Filter Users
description: TODO
---
...
This endpoint is eventually consistent, which means that the results may not reflect a recently-completed write operation. However, if you repeat your request after a short period of time, the response returns up-to-date data. We recommend that you use this endpoint for back office processes such as changing the display name of an existing user.
