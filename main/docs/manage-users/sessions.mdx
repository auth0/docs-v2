---
description: Learn how Auth0 sessions can help you manage you user's authentication status. 
sidebarTitle: Overview
title: Sessions
redirects:
  - "/docs/users/sessions"
  - "/docs/sessions"
  - "/docs/sessions-and-cookies/session-use-cases"
  - "/docs/sessions/references/sample-use-cases-sessions"
  - "/docs/sessions/concepts/session-lifetime"
  - "/docs/sessions/concepts/session"
  - "/docs/sessions-and-cookies"
---
...
Auth0 maintains a login session for any user who authenticates through an application. When a user performs a new standard login, Auth0 resets the login session. Updating a password, email, phone number, or username also causes a user's Auth0 session to expire.
...
<Frame>![Example e-commerce website Storezero.io](/docs/images/cdy7uua7fh8z/5XXxdX4fuApQtAapQfZU1b/2fd9161af60962e3de3fc951d95b83d1/use-case-storezero.png)</Frame>
