...
redirects:
  - "/docs/users/cookies/spa-authenticate-with-cookies"
  - "/docs/sessions/cookies/spa-authenticate-with-cookies"
  - "/docs/sessions-and-cookies/spa-authenticate-with-cookies"
  - "/docs/login/spa/authenticate-with-cookies"
  - "/docs/sessions/spa-authenticate-with-cookies"
---
