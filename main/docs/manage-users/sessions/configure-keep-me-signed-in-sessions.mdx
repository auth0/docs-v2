---
title: Configure "Keep Me Signed In" with Sesssions
description: Learn how to configure Keep Me Signed with Auth0 sessions to give users persistent or ephemeral sessions.
---
...
3. Set **Partial** to: `form-content-end`
