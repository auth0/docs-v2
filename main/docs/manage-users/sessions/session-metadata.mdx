---
description: Learn how to use Auth0 session metadata to store custom data on a session that persists across requests and is accessible from Actions, the Management API, and tokens.
