---
title: Sessions Use Cases
description: Explore different ways to use sessions to determine whether a user is authenticated based on the kind of application and authorization flow involved.
---
