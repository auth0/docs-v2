...
Define claim mappings on a client using the `custom_claim_mappings` array in the `access_token` configuration. Each mapping has:
...
- Maximum 10 custom claims per client.
