...
<CardGroup cols={2}>
  <Card title="Configure Anonymous Sessions" icon="gear" href="/docs/manage-users/sessions/anonymous-sessions/configure-anonymous-sessions">
    Learn how to configure anonymous sessions.
  </Card>

  <Card title="Configure Custom Claims for Anonymous Sessions" icon="key" href="/docs/manage-users/sessions/anonymous-sessions/configure-custom-claims-for-anonymous-sessions">
