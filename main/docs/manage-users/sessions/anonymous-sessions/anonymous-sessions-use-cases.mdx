...
You can use a [`pre-user-registration`](/docs/customize/actions/explore-triggers/pre-user-registration) Action trigger to copy anonymous metadata into the new user profile when they sign up:
...
You can use a [`post-login`](/docs/customize/actions/explore-triggers/post-login) Action trigger to save anonymous metadata to existing users when they log in:
...
You can use a [`post-login`](/docs/customize/actions/explore-triggers/post-login) Action trigger to merge anonymous metadata to an existing user metadata, such as a cart information, when they log in: 
...
You can use a [`post-login`](/docs/customize/actions/explore-triggers/post-login) Action trigger to manage anonymous session metadata from different devices, when the user logs in:
...
<CardGroup cols={2}>
  <Card title="Configure Anonymous Sessions" icon="gear" href="/docs/manage-users/sessions/anonymous-sessions/configure-anonymous-sessions" horizontal>
    Learn how to configure anonymous sessions.
  </Card>

  <Card title="Configure Custom Claims for Anonymous Sessions" icon="key" href="/docs/manage-users/sessions/anonymous-sessions/configure-custom-claims-for-anonymous-sessions" horizontal>
    Learn how to map anonymous session metadata into access token claims.
  </Card>

  <Card title="Anonymous Sessions" icon="user-secret" href="/docs/manage-users/sessions/anonymous-sessions" horizontal>
    Learn about anonymous sessions.
  </Card>
</CardGroup>