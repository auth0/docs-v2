...
redirects:
  - "/docs/users/sessions/configure-session-lifetime-settings"
  - "/docs/users/sessions/session-lifetimes/configure-session-lifetime-settings"
  - "/docs/sessions/configure-session-lifetime-settings"
  - "/docs/sso/current/configure-session-lifetime-limits"
  - "/docs/api/management/guides/tenants/configure-session-lifetime-settings"
  - "/docs/dashboard/guides/tenants/configure-session-lifetime-settings"
  - "/docs/get-started/dashboard/configure-session-lifetime-settings"
---
