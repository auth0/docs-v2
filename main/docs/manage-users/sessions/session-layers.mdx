---
description: Learn about Auth0 session layers created when a user logs in, the application session, the Auth0 session, and the IdP session layer.
title: Session Layers
redirects:
  - "/docs/users/sessions/session-layers"
  - "/docs/sessions/concepts/session-layers"
  - "/docs/sessions/session-layers"
---
