---
title: Manage User Sessions with the Management API
description: Manage user sessions with the Auth0 Management API to list active sessions, revoke individual sessions, or end all sessions.
---
