...
redirects:
  - "/docs/users/sessions/manage-multi-site-sessions"
  - "/docs/sessions-and-cookies/manage-multi-site-short-long-lived-sessions"
  - "/docs/sessions/references/example-short-lived-session-mgmt"
---
...
<Frame>![Diagram of Initial Authentication flow](/docs/images/cdy7uua7fh8z/2voC3vs36CJJlpDu4xl06Y/310fe5afe79ad7d083833baa2690dfa4/initial-authentication.png)</Frame>
...
<Frame>![Diagram of maintaining a session](/docs/images/cdy7uua7fh8z/7CI29ouvhuJ4TFC1G2C5n8/4d2bd0c9372a6cc16e75fc76f438a0bd/maintain-auth0-session.png)</Frame>
...
<Frame>![Diagram of seamless SSO flow for sessions](/docs/images/cdy7uua7fh8z/38heJlnN0letWMVhpTtXad/4d4127150fb818522ea29eea28ccc00e/seamless-sso.png)</Frame>
...
<Frame>![Diagram of prompting a user to maintain a session](/docs/images/cdy7uua7fh8z/6kH2G3oclCfSudwd0hJEUM/70651da37771c9945c5a34dcad409d9f/prompt-user-extend-session.png)</Frame>
...
<Frame>![Diagram of a user logging out](/docs/images/cdy7uua7fh8z/4b55FKM2vZBoskXTPY4nxs/1a9e69437677f2cfac9a3d8e6bff7ffe/user-explicitly-logs-out-of-app.png)</Frame>
...
<Frame>![Diagram of user returning to application after logging out](/docs/images/cdy7uua7fh8z/3geXGwsXkIgFkwopoGoLMx/01685b6b8e8473c6ce6f26e59b402cf3/user-returns-to-initial-app.png)</Frame>
