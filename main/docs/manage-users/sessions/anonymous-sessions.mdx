...
If you want more control over anonymous sessions, you can configure your tenant to not issue cookies for anonymous sessions at all. To learn more, read [Configure anonymous sessions in your Auth0 tenant](/docs/manage-users/sessions/anonymous-sessions/configure-anonymous-sessions#configure-anonymous-sessions-in-your-auth0-tenant).
