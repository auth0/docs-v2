...
To learn more about using anonymous sessions with Actions, read [Anonymous Sessions use cases](/docs/manage-users/sessions/anonymous-sessions/anonymous-sessions-use-cases).
