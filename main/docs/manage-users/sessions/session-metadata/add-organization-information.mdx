...
sidebarTitle: Organization Information in Session Metadata
description: Learn how to use Auth0 Actions to add user organization information to session metadata.
...
* If you use the Management API, you can query the data via the [/api/v2/sessions/{id}](https://auth0.com/docs/api/management/v2/sessions/get-session) endpoint with `GET /api/v2/sessions/{id}`.
