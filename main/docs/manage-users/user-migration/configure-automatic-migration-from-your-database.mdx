...
redirects:
  ...
  - "/docs/users/import-and-export-users/configure-automatic-migration-from-your-database"
  - "/docs/users/configure-automatic-migration-from-your-database"
  - "/docs/users/guides/configure-automatic-migration"
  - "/docs/users/migrations/automatic"
  - "/docs/migrating"
  - "/docs/connections/database/migrating"
  - "/docs/best-practices/custom-database-connections-scripts/anatomy"
  - "/docs/best-practices/custom-database-connection-and-action-script-best-practices/custom-db-connection-anatomy-best-practices"
  - "/docs/best-practices/custom-db-connections/size"
  - "/docs/best-practices/custom-db-connections/anatomy"
---
