...
<Steps>
  ...
  [Open a support case](https://support.auth0.com) requesting a password hash or MFA secrets export. **The request must be submitted by the same tenant administrator who generated the PGP key.** Include the following in your request:
