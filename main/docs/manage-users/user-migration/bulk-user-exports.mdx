...
5. In the **Export Fields** section, choose the fields you want the export to include:
    ...
    * Toggle **Include default fields** to add the fields in the [Auth0 normalized user profile schema](/docs/manage-users/user-accounts/user-profiles/normalized-user-profiles).
