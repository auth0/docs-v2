...
redirects:
  ...
  - "/docs/users/import-and-export-users/bulk-user-import-database-schema-and-examples"
  - "/docs/users/references/bulk-import-database-schema-examples"
  - "/docs/users/bulk-user-import-database-schema-and-examples"
---
