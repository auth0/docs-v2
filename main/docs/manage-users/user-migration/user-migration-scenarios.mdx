---
title: Use Case Examples for User Migration
sidebarTitle: Use Case Examples
description: Migrate users from Gigya, Okta, or Stormpath to Auth0 with these use case examples.
---
...
2. Import your Gigya users into Auth0:
    ...
    Use the Management API's [Create a job](https://auth0.com/docs/api/management/v2#!/Jobs/post_users_imports) to import your users to Auth0. For detailed instructions, read [Bulk User Imports](/docs/manage-users/user-migration/bulk-user-imports).
