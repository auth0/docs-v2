...
redirects:
  - "/docs/users/metadata"
  - "/docs/users/manage-user-metadata"
  - "/docs/users/guides/manage-user-metadata"
  - "/docs/users/guides/read-metadata"
  - "/docs/users/read-metadata"
  - "/docs/metadata"
  - "/docs/users/concepts/overview-user-metadata"
  - "/docs/microsites/manage-users/manage-users-and-user-profiles"
  - "/docs/microsites/manage-users/define-maintain-custom-user-data"
---
