...
2. Call the Management API [Send an email address verification email](https://auth0.com/docs/api/management/v2/jobs/post-verification-email) endpoint with the user's `user_id`.
...
You can check the status of the job created with the Management API [Send an email address verification email](https://auth0.com/docs/api/management/v2/jobs/post-verification-email) endpoint.
