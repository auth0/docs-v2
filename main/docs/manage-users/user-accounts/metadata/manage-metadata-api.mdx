...
redirects:
  - "/docs/users/metadata/manage-metadata-api"
  - "/docs/users/set-metadata-properties-on-creation"
  - "/docs/users/guides/set-metadata-properties-on-creation"
  - "/docs/metadata/apis"
  - "/docs/metadata/apiv2"
  - "/docs/metadata/management-api"
  - "/docs/users/update-metadata-with-the-management-api"
  - "/docs/update-metadata-with-the-management-api"
  - "/docs/users/guides/update-metadata-properties-with-management-api"
---
