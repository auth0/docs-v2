---
'og:description': Learn how to configure, update, and delete application metadata
...
3. On the **Application Metadata** tab, enter the key's name and value, then click **Add**.
   ...
   <Frame>![Dashboard Applications Applications Settings Tab Advanced Settings Application Metadata Tab](https://images.ctfassets.net/cdy7uua7fh8z/7GWHyQloNihda3fuYiVEWQ/b3cced7c53690e6f3cbf7b2e23ff8646/App_Metadata_-_English.png)</Frame>
