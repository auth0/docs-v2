...
redirects:
  - "/docs/users/metadata/manage-metadata-rules"
  - "/docs/rules/metadata"
  - "/docs/metadata/rules"
  - "/docs/metadata-in-rules"
  - "/docs/rules/metadata-in-rules"
  - "/docs/rules/guides/metadata"
  - "/docs/rules/current/metadata-in-rules"
---
<Warning>
