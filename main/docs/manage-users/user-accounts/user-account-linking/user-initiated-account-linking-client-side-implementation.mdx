...
redirects:
  - "/docs/users/user-account-linking/user-initiated-account-linking-client-side-implementation"
  - "/docs/users/user-initiated-account-linking-client-side-implementation"
  - "/docs/user/references/link-accounts-client-side-scenario"
  - "/docs/users/references/link-accounts-client-side-scenario"
  - "/docs/users/references/link-accounts-user-initiated-scenario"
  - "/docs/link-accounts/user-initiated-linking"
  - "/docs/link-accounts/user-initiated"
---
...
2. The user initiates account linking. Your SPA must provide a UI for the user to initiate a link to their other accounts. For example, your SPA could contain a user's settings page:<br/><br/>
   ...
   <Frame>![Example profile page with user account linking](/docs/images/cdy7uua7fh8z/4qxdXGBnlVRDaTkw2wv9WP/8792cff7c5fc21910ec12495828539da/account-linking-spa.png)</Frame>
