...
redirects:
  - "/docs/users/user-account-linking/suggested-account-linking-server-side-implementation"
  - "/docs/users/references/link-accounts-server-side-scenario"
  - "/docs/users/suggested-account-linking-server-side-implementation"
---
...
3. Prompt the user to link accounts.
   ...
   2. If the user wants to link a given account, they can click **Link** next to the appropriate account.
      ...
      <Frame>![Example application with server-side account linking page](/docs/images/cdy7uua7fh8z/7unQjUtxTZUc4tRFOxhaP3/050fb853d2b3be37795ce88b8a60ffed/account-linking-webapp-small__1_.png)</Frame>
