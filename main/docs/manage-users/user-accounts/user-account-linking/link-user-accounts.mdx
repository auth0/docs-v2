...
redirects:
  - "/docs/users/user-account-linking/link-user-accounts"
  - "/docs/users/link-user-accounts"
  - "/docs/link-accounts/suggested-linking"
  - "/docs/users/guides/link-user-accounts"
---
