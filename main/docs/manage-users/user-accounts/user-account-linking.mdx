...
redirects:
  - "/docs/users/user-account-linking"
  - "/docs/users/guide/concepts/overview-user-account-linking"
  - "/docs/users/concepts/overview-user-account-linking"
  - "/docs/link-accounts"
  - "/docs/link-accounts/auth-api"
---
