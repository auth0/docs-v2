---
title: How to Configure User Profile Attribute Synchronization from Upstream Identity Providers
sidebarTitle: Configure Attribute Sync from External IdPs
description: Enable synchronization to update user profile attributes from your external IdP each time users log in or disable synchronization to be able to edit user profile attributes directly.
---
