...
redirects:
  - "/docs/users/user-profiles/configure-connection-sync-with-auth0"
  - "/docs/api/management/guides/connections/configure-connection-sync"
  - "/docs/dashboard/guides/connections/configure-connection-sync"
  - "/docs/users/configure-connection-sync-with-auth0"
---
