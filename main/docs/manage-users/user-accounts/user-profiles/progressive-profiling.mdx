...
redirects:
  - "/docs/users/user-profiles/progressive-profiling"
  - "/docs/users/progressive-profiling"
  - "/docs/users/guides/implement-progressive-profiling"
  - "/docs/users/concepts/overview-progressive-profiling"
  - "/docs/user-profile/progressive-profiling"
---
