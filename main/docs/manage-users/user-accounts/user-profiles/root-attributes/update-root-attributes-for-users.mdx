...
redirects:
  - "/docs/users/user-profiles/root-attributes/update-root-attributes-for-users"
  - "/docs/api/management/guides/users/update-root-attributes-users"
  - "/docs/users/update-root-attributes-for-users"
---
...
| `MGMT_API_ACCESS_TOKEN` | [Access Token for the Management API](https://auth0.com/docs/api/management/v2/tokens) with the [scope](/docs/glossary?term=scope) `update:users`. |
