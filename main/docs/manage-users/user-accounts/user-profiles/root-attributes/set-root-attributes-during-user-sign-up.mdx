---
title: Set User Attributes During User Signup
description: Learn how to set attributes for users during signup using the Auth0 Management API.
redirects:
  - "/docs/users/user-profiles/root-attributes/set-root-attributes-during-user-sign-up"
  - "/docs/api/management/guides/users/set-root-attributes-user-signup"
  - "/docs/users/set-root-attributes-during-user-sign-up"
---
