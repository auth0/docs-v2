---
title: Normalized User Profile Attributes
sidebarTitle: Attribute Normalization
description: Understand how Auth0 normalizes common attributes in the user profile.
---
