...
redirects:
  - "/docs/manage-users/user-accounts/user-profiles/normalized-user-profile-schema"
  - "/docs/users/user-profiles/normalized-user-profiles"
  - "/docs/users/normalized/auth0"
  - "/docs/user-profile/normalized/auth0"
  - "/docs/users/normalized"
  - "/docs/users/normalized-user-profiles"
---
