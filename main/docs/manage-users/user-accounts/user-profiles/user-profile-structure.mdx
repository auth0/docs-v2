...
redirects:
  - "/docs/manage-users/user-accounts/user-profiles/sample-user-profiles"
  - "/docs/users/user-profiles/user-profile-structure"
  - "/docs/users/user-profile-structure"
  - "/docs/users/references/user-profile-structure"
  - "/docs/user-profile/user-profile-structure"
---
