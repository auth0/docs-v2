...
'og:title': Use Verified Email in User Profiles
'og:url': https://auth0.com/docs/
permalink: verified-email-usage
title: Use Verified Email in User Profiles
'twitter:description': Outlines proper usage of the email_verified field in a user
  profile.
'twitter:title': Use Verified Email in User Profiles
---
