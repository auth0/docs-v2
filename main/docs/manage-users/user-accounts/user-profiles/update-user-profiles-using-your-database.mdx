...
redirects:
  - "/docs/users/user-profiles/update-user-profiles-using-your-database"
  - "/docs/users/guides/update-user-profiles-using-your-database"
  - "/docs/user-profile/customdb"
  - "/docs/users/update-user-profiles-using-your-database"
---
