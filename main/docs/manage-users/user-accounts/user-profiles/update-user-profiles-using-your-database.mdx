---
title: How to Modify User Profile Attributes from Custom Database Connections
sidebarTitle: Modify Attributes from Custom Database Connections
description: Learn how to update user profiles when using your own user store as an identity provider.
---
...
The cached values for the [Normalized User Profile](/docs/manage-users/user-accounts/user-profiles/normalized-user-profiles) fields are based on the values returned from the Login Script of your custom database connection.
