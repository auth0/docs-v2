...
redirects:
  - "/docs/users/user-profiles"
  - "/docs/users/user-profiles-returned-from-oidc-compliant-pipelines"
  - "/docs/users/normalized/oidc"
  - "/docs/user-profile/user-profile-details"
  - "/docs/users/concepts/overview-user-profile"
  - "/docs/user-profile"
  - "/docs/user-profile/normalized/oidc"
  - "/docs/user-profile/normalized"
---
