...
<td>Applications can create users in any database or passwordless connection in an Auth0 tenant. This includes creating via the <code>/api/v2/users</code> and <code>/api/v2/jobs/users-import</code> endpoints.</td>
</tr>
<tr>
