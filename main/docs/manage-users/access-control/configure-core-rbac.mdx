...
redirects:
  - "/docs/authorization/rbac/auth-core-features"
  - "/docs/authorization/auth-core-features"
  - "/docs/authorization/guides/how-to"
  - "/docs/authorization/how-to-use-auth0s-core-authorization-feature-set"
---
