...
redirects:
  - "/docs/authorization/authorization-policies/sample-use-cases-rules-with-authorization"
  - "/docs/authorization/sample-use-cases-rules-with-authorization"
  - "/docs/authorization/restrict-access-api"
  - "/docs/authorization/concepts/sample-use-cases-rules"
  - "/docs/api-auth/restrict-requests-for-scopes"
  - "/docs/api-auth/restrict-access-api"
---
<Warning>
