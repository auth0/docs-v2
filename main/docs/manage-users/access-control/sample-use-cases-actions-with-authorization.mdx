---
description: Use Auth0 Actions to extend role-based access control with custom logic, evaluate user roles at login, and add or remove access token permissions.
title: 'Sample Use Cases: Actions with Authorization'
redirects:
  - "/docs/customize/actions/flows-and-triggers/login-flow/add-user-roles-to-id-and-access-tokens"
---
