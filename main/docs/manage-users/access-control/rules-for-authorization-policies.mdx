...
redirects:
  - "/docs/authorization/authorization-policies/rules-for-authorization-policies"
  - "/docs/authorization/concepts/authz-rules"
  - "/docs/authorization/rules-for-authorization-policies"
---
<Warning>
