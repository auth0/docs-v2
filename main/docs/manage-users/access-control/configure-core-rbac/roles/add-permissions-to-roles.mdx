...
redirects:
  - "/docs/authorization/rbac/roles/add-permissions-to-roles"
  - "/docs/api/management/guides/roles/add-permissions-roles"
  - "/docs/dashboard/guides/roles/add-permissions-roles"
---
