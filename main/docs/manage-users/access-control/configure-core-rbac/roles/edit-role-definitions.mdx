...
redirects:
  - "/docs/authorization/rbac/roles/edit-role-definitions"
  - "/docs/authorization/guides/api/edit-role-definitions"
  - "/docs/api/management/guides/roles/edit-role-definitions"
  - "/docs/dashboard/guides/roles/edit-role-definitions"
---
