...
redirects:
  - "/docs/authorization/rbac/roles/view-role-permissions"
  - "/docs/api/management/guides/roles/view-role-permissions"
  - "/docs/dashboard/guides/roles/view-role-permissions"
---
