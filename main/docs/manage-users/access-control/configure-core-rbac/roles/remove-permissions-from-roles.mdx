...
redirects:
  - "/docs/authorization/rbac/roles/remove-permissions-from-roles"
  - "/docs/api/management/guides/roles/remove-role-permissions"
  - "/docs/dashboard/guides/roles/remove-role-permissions"
---
