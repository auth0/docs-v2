...
redirects:
  - "/docs/authorization/rbac/rbac-users/view-user-permissions"
  - "/docs/users/view-user-permissions"
  - "/docs/api/management/guides/users/view-user-permissions"
  - "/docs/dashboard/guides/users/view-user-permissions"
---
...
2. Click the **Permissions** view.
   ...
   <Frame>![Auth0 Dashboard User Detail list of permissions assigned to this user](/docs/images/cdy7uua7fh8z/4vShfxoUcSpCDnM5FnAbsR/de85942623430e3cedc097addbaa2f9d/User_Details_-_Permissions_-_English.png)</Frame>
