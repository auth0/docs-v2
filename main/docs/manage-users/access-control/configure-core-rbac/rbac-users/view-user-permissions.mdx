---
description: ''
'og:description': Learn how to view permissions assigned to a user using the Auth0
...
2. Click the **Permissions** view.
   ...
   <Frame>![Auth0 Dashboard User Detail list of permissions assigned to this user](https://images.ctfassets.net/cdy7uua7fh8z/4vShfxoUcSpCDnM5FnAbsR/de85942623430e3cedc097addbaa2f9d/User_Details_-_Permissions_-_English.png)</Frame>
