...
redirects:
  - "/docs/authorization/rbac/rbac-users/remove-permissions-from-users"
  - "/docs/users/remove-permissions-from-users"
  - "/docs/api/management/guides/users/remove-user-permissions"
  - "/docs/dashboard/guides/users/remove-user-permissions"
---
