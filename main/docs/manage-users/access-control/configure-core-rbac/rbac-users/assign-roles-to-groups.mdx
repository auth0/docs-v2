...
You can assign both tenant roles and organization roles to enterprise groups within an organization. To learn more about organization roles, read [Organization Roles](/docs/manage-users/organizations/organization-roles).
...
The assigned roles appear in the group's details. Both tenant roles and Organization roles scoped to this Organization are available for assignment.
