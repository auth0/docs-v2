...
redirects:
  - "/docs/authorization/rbac/rbac-users/view-user-roles"
  - "/docs/users/view-user-roles"
  - "/docs/api/management/guides/users/view-user-roles"
  - "/docs/dashboard/guides/users/view-user-roles"
---
