...
redirects:
  - "/docs/manage-users/access-control/configure-core-rbac/rbac-users/assign-permissions-users"
  - "/docs/authorization/rbac/rbac-users/assign-permissions-to-users"
  - "/docs/users/assign-permissions-to-users"
  - "/docs/api/management/guides/users/assign-permissions-users"
  - "/docs/dashboard/guides/users/assign-permissions-users"
---
