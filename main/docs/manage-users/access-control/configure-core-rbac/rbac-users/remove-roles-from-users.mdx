...
redirects:
  - "/docs/authorization/rbac/rbac-users/remove-roles-from-users"
  - "/docs/users/remove-roles-from-users"
  - "/docs/api/management/guides/users/remove-user-roles"
  - "/docs/dashboard/guides/roles/remove-role-users"
  - "/docs/dashboard/guides/users/remove-user-roles"
---
