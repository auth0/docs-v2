...
redirects:
  - "/docs/authorization/rbac/rbac-users/assign-roles-to-users"
  - "/docs/api/management/guides/users/assign-roles-users"
  - "/docs/dashboard/guides/users/assign-roles-users"
  - "/docs/users/assign-roles-to-users"
---
