...
| [Grant Per-Application Access to an Organization](/docs/manage-users/organizations/configure-organizations/grant-per-application-access) | How to grant or revoke an Organization's access to specific applications using the Dashboard or Management API. |
