---
description: Configure Auth0 Organizations, including connections, membership, roles, and login behavior, via the Auth0 Dashboard or Management API.
sidebarTitle: Overview
title: Configure Organizations
redirects:
  - "/docs/organizations/configure/"
  - "/docs/organizations/configure-organizations"
---
...
| [Enable Third-Party Application Access](/docs/manage-users/organizations/configure-organizations/enable-third-party-application-access) | How to allow third-party applications to authenticate users in an Organization. |
| [Grant Per-Application Access to an Organization](/docs/manage-users/organizations/configure-organizations/grant-application-access) | How to grant or revoke an Organization's access to specific applications using the Dashboard or Management API. |
