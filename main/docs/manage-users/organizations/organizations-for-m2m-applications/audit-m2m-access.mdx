---
description: Audit machine-to-machine access for an Auth0 Organization through client grants and tenant logs to confirm which applications can call the API.
