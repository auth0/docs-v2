---
description: ''
'og:description': Learn how to retrieve member roles for an Organization using the
  Auth0 Dashboard and Management API.
'og:image': https://cdn2.auth0.com/docs-v2/1.14553.0/img/share-image.png
'og:title': Retrieve Member Roles for an Organization
...
'twitter:title': Retrieve Member Roles for an Organization
---
