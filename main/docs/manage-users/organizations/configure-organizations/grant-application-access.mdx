...
description: Enable per-application access for an Organization to control which applications members can log in to using the Auth0 Dashboard or Management API.
validatedOn:
---
