...
When working with [organizations](/docs/manage-users/organizations/organizations-overview) programmatically, you may need to retrieve a list of connections for an organization.
...
| Value | Description |
| --- | --- |
| `ORG_ID` | ID of the organization for which you want to retrieve connections. |
