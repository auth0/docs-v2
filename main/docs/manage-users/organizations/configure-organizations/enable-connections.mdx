...
To enable a connection for an organization, the connection **must** already exist in your tenant. Supported connections include [database connections](/docs/authenticate/identity-providers/database), [social connections](/docs/authenticate/identity-providers/identity-providers-social), and [enterprise connections](/docs/authenticate/identity-providers/identity-providers-enterprise).
