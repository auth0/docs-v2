...
<table class="table">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>Enables or disables a connection for an Organization. By disabling a connection, it is possible to keep the values for <code>show_as_button</code>, <code>assign_membership_on_login</code>, etc., while keeping the connection disabled.
    </tr>
    <tr>
