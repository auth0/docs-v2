...
This domain-level connection requirement doesn't apply to third-party application access granted through [Cross App Access (XAA)](/docs/secure/call-apis-on-users-behalf/xaa). For XAA, third-party app access is approved directly in the Enterprise IdP's Cross App Access policy instead. To learn more, read [Environment setup](/docs/secure/call-apis-on-users-behalf/xaa/set-up-xaa-test-environment).
