...
To learn more about how to manage application API access policies and their associated client grants, read [Application Access to APIs: Client Grants](/docs/get-started/apis/api-settings#application-access-to-apis-client-grants).
