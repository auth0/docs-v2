...
For [Connected Accounts with Token Vault](/docs/secure/tokens/token-vault/connected-accounts-for-token-vault), the My Account API supports the following scopes:
