...
Auth0 supports automatic migration of users from a [custom database connection](/docs/authenticate/identity-providers/database/custom-db) to Auth0. This practice is sometimes known as **trickle migration** or **lazy migration**. By activating this feature, your users are:
...
<Frame>![User Migration Diagram](https://images.ctfassets.net/cdy7uua7fh8z/JAHBs6NzVRf0N5iXI7Wby/d0bfa23a1485aeb5d64bd52fe977d4fe/import-export-diagram.png)</Frame>
