...
* If using [custom DB connections](/docs/authenticate/identity-providers/database/mysql), make sure all custom DB scripts are implemented and return a consistent user-profile with a unique user ID.
