...
redirects:
  - "/docs/deploy/pre-deployment/how-to-run-production-checks"
  - "/docs/pre-deployment/how-to-run-test"
  - "/docs/pre-deployment/how-to-run-production-checks"
---
...
<Frame>![](/docs/images/cdy7uua7fh8z/nHS8TrcMAsgUUWOv5gcNO/66d641136222fe6634b1d53f0a455ffd/Screenshot_2023-06-02_at_10.53.40_AM.jpeg)</Frame><Frame>![Auth0 Support pre-deployment production checks](/docs/images/cdy7uua7fh8z/4EjetzpVocGQKy6HYVTHMw/a4a4bfb85e8db8aaf393a7e97aeb8bb4/2025-01-28_15-33-08_copy.png)</Frame>
