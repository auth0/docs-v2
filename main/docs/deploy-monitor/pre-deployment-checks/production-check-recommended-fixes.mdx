...
redirects:
  - "/docs/deploy/pre-deployment/production-check-recommended-fixes"
  - "/docs/deploy/pre-deployment/how-to-run-production-checks/production-check-recommended-fixes"
  - "/docs/pre-deployment/tests/recommended"
  - "/docs/pre-deployment/how-to-run-production-checks/production-check-recommended-fixes"
---
