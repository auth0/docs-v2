...
redirects:
  - "/docs/deploy/pre-deployment/production-checks-best-practices"
  - "/docs/deploy/pre-deployment/how-to-run-production-checks/production-checks-best-practices"
  - "/docs/pre-deployment/tests/best-practice"
  - "/docs/pre-deployment/how-to-run-production-checks/production-checks-best-practices"
---
