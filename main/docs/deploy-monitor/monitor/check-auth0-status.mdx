...
redirects:
  - "/docs/monitor-auth0/check-auth0-status"
  - "/docs/monitoring/guides/check-status"
---
...
1. Follow [@auth0status](https://x.com/auth0status) on X to get the latest status updates.
