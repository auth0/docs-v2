---
description: Check the status of external services like Social and Enterprise identity providers to diagnose Auth0 login failures from upstream outages.
title: Check External Services Status
redirects:
  - "/docs/monitor-auth0/check-external-services-status"
  - "/docs/monitoring/guides/check-external-services"
---
