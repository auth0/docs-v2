...
redirects:
  - "/docs/migrate-private-cloud-custom-domains"
  - "/docs/private-saas-deployment/*"
  - "/docs/deploy-monitor/deploy-private-cloud/private-cloud-on-aws/*"
  - "/docs/appliance/*"
  - "/docs/onboarding/*"
  - "/docs/enterprise-support"
  - "/docs/enterprise/private-cloud/overview"
  - "/docs/updating-appliance"
  - "/docs/services/private-*"
---
