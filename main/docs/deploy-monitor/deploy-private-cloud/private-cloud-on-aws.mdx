...
Auth0 Private Cloud on AWS is available in multiple regions worldwide. All regions listed below have been validated for production deployment and meet Auth0's high availability and performance standards.

#### Production-Ready Regions

The following AWS regions are **fully validated and production-ready** for immediate deployment:
...
<Callout icon="file-lines" color="#0EA5E9" iconType="regular">
  ...
  - Multi-availability zone deployment verification
  - High availability (GeoHA) pairing validation
...
Auth0 can validate and deploy Private Cloud in additional AWS regions to meet your data residency requirements. Region validation ensures production-grade reliability and performance before deployment.

**Validation process:**
- **Timeline:** Typically 1-4 weeks depending on region complexity
- **Scope:** Multi-AZ deployment, capacity verification, GeoHA pairing (if applicable)
- **Requirements:** Active Private Cloud contract or purchase order

To request validation for a specific AWS region:
1. Contact your Auth0 Account Executive or Technical Account Manager
2. Provide your preferred region(s) and timeline requirements
3. Auth0 will assess feasibility and provide a validation timeline
4. Deployment proceeds after successful validation

<Warning>
  **Planning Ahead:** Request region validation during your sales cycle to ensure your preferred region is ready for deployment at contract start. Last-minute requests may delay your implementation timeline.
</Warning>
