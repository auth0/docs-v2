...
Additionally, a third "tie break" region is required for one of our data stores. This third region never receives live traffic but is required to elect a new leader in the event of a failover.
