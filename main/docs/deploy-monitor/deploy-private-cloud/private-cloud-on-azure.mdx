...
<td>100</td>
<td>100</td>
<td>500* RPS (5x)   <br/>1500* RPS (15x) <br/>3000* RPS (30x)<br/> <br/>3000* RPS (30x Burst)<br/></td>
</tr>
<tr>
...
Auth0 Private Cloud on Azure is available in multiple regions worldwide. All regions listed below have been validated for production deployment and meet Auth0's high availability and performance standards.

#### Production-Ready Regions

The following Azure regions are **fully validated and production-ready** for immediate deployment:
...
<Callout icon="file-lines" color="#0EA5E9" iconType="regular">
  All production-ready regions have undergone rigorous validation including:
  - Three availability zone deployment verification
  - High availability (GeoHA) pairing validation (if applicable)
  - Azure capacity and quota verification
  - Performance and security testing
</Callout>

#### Additional Regions Available Upon Request

Auth0 can validate and deploy Private Cloud in additional Azure regions to meet your data residency requirements. Azure region validation is more complex than AWS and requires additional time for thorough testing.

**Validation process:**
- **Timeline:** Typically 2-8 weeks depending on region complexity and Azure capacity
- **Complexity factors:**
  - Availability zone architecture validation
  - GeoHA pairing compatibility
  - Azure quota and capacity verification (can vary by region)
  - Microsoft coordination for capacity allocation
- **Requirements:** Active Private Cloud contract or purchase order

<Warning>
  **Azure Regional Complexity:** Azure region validation can encounter challenges including limited availability zone support, capacity constraints, and GeoHA pairing issues. Some regions may not be feasible for Private Cloud deployment due to Azure infrastructure limitations.
</Warning>

To request validation for a specific Azure region:
1. Contact your Auth0 Account Executive or Technical Account Manager **early in your sales cycle**
2. Provide your preferred region(s) and timeline requirements
3. Auth0 will assess feasibility, including Azure capacity availability
4. If feasible, validation proceeds with estimated timeline provided
5. Deployment proceeds after successful validation

For detailed information about the region validation process, see [Private Cloud Region Support](/docs/deploy-monitor/deploy-private-cloud/private-cloud-region-support).
