...
| `fapi` | Failed API Operation | Operation on API failed |
...
| `fc` | Failed by Connector | AD/LDAP Connector Failure |
...
| `limit_ui` | Too Many Calls to /userinfo | Rate limit exceeded to /userinfo endpoint |
| `limit_dc` | Too Many Invalid Device Codes | Rate limit exceeded for invalid device codes |
...
| `gd_recovery_rate_limit_exceed` | Too many failures | Multi-factor recovery code has failed too many times |
...
| `sys_os_update_end` | Auth0 OS Update Ended | Auth0 OS update ended |
| `sys_os_update_start` | Auth0 OS Update Started | Auth0 OS update started |
| `sys_update_end` | Auth0 Update Ended | Auth0 update ended |
| `admin_update_launch` | Auth0 Update Launched | New version of Auth0 released |
| `sys_update_start` | Auth0 Update Started | Auth0 update started |
...
| `appliance_configuration_api_read` | Configuration read | PSaaS configuration has been read |
| `appliance_configuration_api_status` | Configuration status checked | PSaaS configuration's status has been checked |
| `appliance_configuration_api_write` | Configuration updated | PSaaS configuration has been updated |
...
| `gd_module_switch` | Module switch | Multi-factor module switched |
...
| `scph` | Success Post Change Password Hook | Post-change password hook ran successfully |
...
| `gd_user_delete` | User delete | Deleted multi-factor user account |
