...
| Failed OIDC Back-Channel Logout Request | Back-Channel Logout request failed |
...
| Enrollment started | Multi-factor authentication enrollment has started |
| MFA enrollment complete | Multi-factor authentication enrollment has completed |
...
| Successful OIDC Back-Channel Logout request | OIDC Back-Channel Logout request completed successfully |
