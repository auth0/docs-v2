---
description: Review how long Auth0 retains tenant log data based on your subscription plan so you know when to export logs for longer-term analysis.
title: Log Data Retention
redirects:
  - "/docs/monitor-auth0/logs/log-data-retention"
  - "/docs/logs/references/log-data-retention"
  - "/docs/logs/log-data-retention"
---
