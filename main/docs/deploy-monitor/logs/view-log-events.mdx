---
description: Learn how to view logs in the Dashboard including user authentication and administrative actions such as adding and updating applications, connections, and rules.
title: View Logs
redirects:
  - "/docs/monitor-auth0/logs/view-log-events"
  - "/docs/logs/view-log-events-in-the-dashboard"
  - "/docs/logs/guides/view-log-data-dashboard"
  - "/docs/logs/view-log-events"
---
