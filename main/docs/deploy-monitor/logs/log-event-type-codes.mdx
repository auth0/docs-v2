...
redirects:
  - "/docs/monitor-auth0/logs/log-event-type-codes"
  - "/docs/logs/references/log-event-type-codes"
  - "/docs/logs/references/log-events-data"
  - "/docs/logs/references/log-event-data"
  - "/docs/logs/log-event-type-codes"
---
The following table lists the codes associated with each tenant log. Details for each log type code can be found in our [Tenant Log Catalog](/docs/tenant-logs). You can also reference our [GitHub repo](https://github.com/auth0/auth0-log-schemas).
...
| `custom_domain_verification_failed` | Custom Domain Verification Failed |  Unable to verify a custom domain |
| `depnote` | Deprecation Notice |   |
| `directory_sync_completed` | Inbound Directory Sync Completed |   |
