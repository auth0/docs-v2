---
description: Read the Auth0 deployment checklist before promoting a tenant to production so security and branding settings are all confirmed.
title: Deployment Checklist
redirects:
  - "/docs/deploy/deploy-checklist"
