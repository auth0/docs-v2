...
- **Auth0 Management API access**: Create a Machine-to-Machine (M2M) application with the following permissions:
  ...
  For detailed instructions, read [Get Management API Access Tokens](/secure/tokens/access-tokens/management-api-access-tokens/get-management-api-access-tokens/get-management-api-access-tokens-for-production).
