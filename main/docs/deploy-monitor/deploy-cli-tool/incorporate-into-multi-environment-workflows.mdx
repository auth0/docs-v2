...
redirects:
  - "/docs/deploy/deploy-cli-tool/incorporate-deploy-cli-into-build-environment"
  - "/docs/extensions/deploy-cli-tool/incorporate-deploy-cli-into-build-environment"
  - "/docs/extensions/deploy-cli/guides/incorporate-deploy-cli-into-build-environment"
  - "/docs/deploy-monitor/deploy-cli-tool/incorporating-into-multi-environment-workflows"
  - "/docs/deploy-monitor/deploy-cli-tool/incorporate-deploy-cli-into-build-environment"
---
