...
title: Use as a CLI
redirects:
  - "/docs/deploy/deploy-cli-tool/deploy-cli-tool-options"
  - "/docs/extensions/deploy-cli-tool/deploy-cli-tool-options"
  - "/docs/extensions/deploy-cli/references/deploy-cli-options"
  - "/docs/deploy-monitor/deploy-cli-tool/using-as-a-cli"
  - "/docs/deploy-monitor/deploy-cli-tool/deploy-cli-tool-options"
---
Lean how the [Auth0 Deploy CLI](https://github.com/auth0/auth0-deploy-cli) can be used as a standalone command line utility and provides a simple way to manage your Auth0 tenant configuration in CI/CD workflows.
