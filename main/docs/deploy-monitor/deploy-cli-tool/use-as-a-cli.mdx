...
title: Use as a CLI
---
The [Auth0 Deploy CLI](https://github.com/auth0/auth0-deploy-cli) can be used as a standalone command line utility. Doing so provides a simple way to manage your Auth0 tenant configuration in CI/CD workflows.
