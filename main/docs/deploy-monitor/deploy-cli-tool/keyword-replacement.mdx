...
redirects:
  - "/docs/deploy/deploy-cli-tool/environment-variables-and-keyword-mappings"
  - "/docs/extensions/deploy-cli-tool/environment-variables-and-keyword-mappings"
  - "/docs/extensions/deploy-cli/references/environment-variables-keyword-mappings"
  - "/docs/deploy/deploy-cli-tool/import-export-tenant-configuration-to-yaml-file"
  - "/docs/extensions/deploy-cli-tool/import-export-tenant-configuration-to-yaml-file"
  - "/docs/extensions/deploy-cli/guides/import-export-yaml-file"
  - "/docs/deploy/deploy-cli-tool/import-export-tenant-configuration-to-directory-structure"
  - "/docs/extensions/deploy-cli-tool/import-export-tenant-configuration-to-directory-structure"
  - "/docs/extensions/deploy-cli/guides/import-export-directory-structure"
  - "/docs/deploy-monitor/deploy-cli-tool/environment-variables-and-keyword-mappings"
  - "/docs/deploy-monitor/deploy-cli-tool/import-export-tenant-configuration-to-directory-structure"
  - "/docs/deploy-monitor/deploy-cli-tool/import-export-tenant-configuration-to-yaml-file"
---
...
To use the keyword replacement, the `AUTH0_KEYWORD_REPLACE_MAPPINGS` configuration property needs to contain the appropriate mappings. Then, in the resource configuration files, keywords can be injected through one of two ways:
