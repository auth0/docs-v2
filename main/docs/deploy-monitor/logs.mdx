---
description: Auth0 tenant logs capture every authentication event and configuration change so you can audit usage and feed the data into your SIEM.
sidebarTitle: Overview
title: Logs
redirects:
  - "/docs/monitor-auth0/logs"
  - "/docs/logs/concepts/logs-admins-devs"
  - "/docs/logs"
---
