...
redirects:
  - "/docs/deploy/deploy-cli-tool/install-and-configure-the-deploy-cli-tool"
  - "/docs/extensions/deploy-cli-tool/install-and-configure-the-deploy-cli-tool"
  - "/docs/extensions/deploy-cli/guides/install-deploy-cli"
  - "/docs/deploy/deploy-cli-tool/create-and-configure-the-deploy-cli-application"
  - "/docs/extensions/deploy-cli-tool/create-and-configure-the-deploy-cli-application"
  - "/docs/extensions/deploy-cli-tool/create-and-configure-the-deploy-cli-application-manually"
  - "/docs/extensions/deploy-cli/guides/create-deploy-cli-application-manually"
  - "/docs/deploy/deploy-cli-tool"
  - "/docs/deploy/deploy-cli-tool/whats-new-in-deploy-cli-tool"
  - "/docs/extensions/deploy-cli/references/whats-new-v2"
  - "/docs/extensions/deploy-cli/references/whats-new"
  - "/docs/extensions/deploy-cli"
  - "/docs/extensions/deploy-cli-tool"
  - "/docs/deploy-monitor/deploy-cli-tool/how-to-contribute"
  - "/docs/deploy-monitor/deploy-cli-tool/create-and-configure-the-deploy-cli-application"
  - "/docs/deploy-monitor/deploy-cli-tool/install-and-configure-the-deploy-cli-tool"
---
