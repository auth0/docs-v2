...
## エージェントの subject クレーム {#agent-subject-claims}
...
## エージェントのsubjectクレームを受信するようリソースサーバーを設定する {#configure-resource-server-to-receive-agent-subject-claims}
