...
## Okta テナントの作成と設定 {#create-and-configure-your-okta-tenant}
...
## Requesting App を Okta に登録する {#register-the-requesting-app-in-okta}

### Okta で Requesting App を作成する {#create-the-requesting-app-in-okta}
...
### Requesting App をテストユーザーに割り当てる {#assign-the-requesting-app-to-test-users}
...
## OktaでのAI agentの登録と構成 {#register-and-configure-the-ai-agent-in-okta}
...
### AI agentの作成 {#create-the-ai-agent}
...
### AI agentのクライアント登録を設定する {#set-client-registration-for-the-ai-agent}
...
### AI Agent を有効化する {#activate-the-ai-agent}

**Actions** から **Activate** を選択し、**Managed Status** が **Active** になっていることを確認します。

## Auth0 で Requesting App の接続を構成する {#configure-the-requesting-app-connection-in-auth0}
...
### offline_access スコープの追加とユーザーマッピングの更新 {#add-offline_access-scope-and-update-the-user-mapping}
...
### アプリケーションで接続を有効化する {#enable-connection-for-an-application}
...
### Okta で Resource App を作成する {#create-the-resource-app-in-okta}
...
### Resource Appをテストユーザーに割り当てる {#assign-resource-app-to-test-users}
...
### Resource App で Cross App Access を有効にする {#enable-cross-app-access-for-the-resource-app}
...
### Resource App を AI agent に割り当てる {#assign-the-resource-app-to-the-ai-agent}
...
## Auth0 で Resource App の接続を構成する {#configure-the-resource-app-connection-in-auth0}
...
### offline_access スコープの追加とマッピングの更新 {#add-offline_access-scope-and-update-mappings}
...
### Resource Appで接続を有効化する {#enable-the-connection-for-the-resource-app}
...
### 接続をテストする {#test-the-connection-2}
...
## Token Vault を使用した Cross App Access の設定 {#configure-cross-app-access-with-token-vault}
...
## Requesting App を OIN で公開する {#publish-your-requesting-app-in-oin}
