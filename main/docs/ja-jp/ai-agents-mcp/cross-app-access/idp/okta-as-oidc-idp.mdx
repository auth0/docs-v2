...
## Okta テナントを作成して構成する {#create-and-configure-your-okta-tenant}
...
### Resource App をテストユーザーに割り当てる {#assign-resource-app-to-test-users}
...
### Agentの資格情報を追加 {#add-agent-credentials}
...
### Agent Resource 接続を追加 {#add-agent-resource-connections}
...
## Auth0 で Okta Workforce Enterprise 接続を設定する {#configure-an-okta-workforce-enterprise-connection-in-auth0}
