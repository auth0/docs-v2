...
<Accordion title="よくある問題と解決策">
  ### コールバック URL の不一致エラー {#callback-url-mismatch-error}
  ...
  **対処方法:**
  ...
  ### iOS で SSO が機能しない {#sso-not-working-on-ios}
  ...
  ### ログイン後にブラウザーが閉じない {#browser-doesnt-close-after-login}
  ...
  ### ログインページがデバイスの既定のブラウザーアプリで開く {#login-page-opens-in-the-devices-default-browser-app}
