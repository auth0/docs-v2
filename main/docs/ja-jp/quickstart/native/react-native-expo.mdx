...
<Accordion title="よくある問題と解決策">
  ...
  **修正方法:**
  ...
  ### Prebuild が失敗する、またはプラグインが適用されない {#prebuild-fails-or-plugin-not-applied}
  ...
  **修正方法:**
  ...
  ### iOS ビルドが Pod エラーで失敗する {#ios-build-fails-with-pod-errors}
  ...
  **修正方法:**
  ...
  ### ユーザーによるキャンセルエラー {#user-cancelled-error}
