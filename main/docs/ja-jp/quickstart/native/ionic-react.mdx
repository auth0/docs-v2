...
<Accordion title="AI を使って Auth0 を組み込む" icon="microchip-ai" iconType="solid" defaultOpen>
  ...
  AI アシスタントが、Auth0アプリケーションの作成、資格情報の取得、Auth0 React SDK と Capacitor プラグインのインストール、ディープリンクの設定、さらにネイティブブラウザー連携によるログイン/ログアウト フローの実装まで自動で行います。詳しくは、[Auth0 agent skills](/docs/ja-jp/quickstart/agent-skills) をご覧ください。
</Accordion>
