...
## トラブルシューティングと詳細設定 {#troubleshooting-advanced}

<Accordion title="よくある問題と解決策">
  ### Chrome Custom Tab からアプリにリダイレクトされない {#chrome-custom-tab-doesnt-redirect-back-to-app}
  ...
  **解決策:**
  ...
  ### アプリがクラッシュする: &#39;Auth0 domain not found&#39; {#app-crashes-auth0-domain-not-found}
  ...
  **修正方法:**
  ...
  ### dependencies に関連するビルドエラー {#build-errors-with-dependencies}
  ...
  **修正方法:**
  ...
  ### 互換性のあるブラウザーがないというエラー {#no-compatible-browser-error}
...
<Accordion title="Android App Links を設定する">
  ...
  ### 署名証明書のフィンガープリントを取得する {#get-your-signing-certificate-fingerprint}
  ...
  ### Auth0 Dashboard で設定する {#configure-in-the-auth0-dashboard}
  ...
  ### 設定を確認する {#verify-the-configuration}
...
<Accordion title="高度な Android 連携">
  ### 強化された資格情報セキュリティ {#enhanced-credential-security}
  ...
  ### カスタム スコープと audience {#custom-scopes-and-audience}
