...
<Recipe>
  <Content>
    ...
    <Section id={sections[4].id} title={sections[4].title} stepNumber="5">
      ユーザーがログインやログアウトできるようになったら、認証済のユーザーに関連付けられた[プロファイル情報](/docs/ja-jp/manage-users/user-accounts/user-profiles)を取得できるようにしたいと考えるはずです。たとえば、ログインしたユーザーの名前やプロファイル画像をプロジェクトに表示できるようになりたいかもしれません。
