...
<Recipe>
  <Content>
    ...
    <Section id={sections[0].id} title={sections[0].title} stepNumber="1">
      ...
      <Frame>
        <img src="/docs/images/ja-jp/cdy7uua7fh8z/6SC7KnyzCyO8cwXQfril1X/c0d6756c28de0ddcbe938307e529d47a/client_settings.png" />
      </Frame>
      ...
      アプリのURLを[アプリケーションの設定](https://manage.auth0.com/#/applications/{yourClientId}/settings)で**［Allowed Web
