...
<QuickstartButtons
  githubLink="https://github.com/auth0-samples/auth0-django-web-app/tree/master/01-Login"
  lang="ja"
/>
...
export const sections = [
  ...
  {
    id: "アプリケーションをセットアップする",
    title: "アプリケーションをセットアップする",
  },
  {
    id: "ルートハンドラーをセットアップする",
    title: "ルートハンドラーをセットアップする",
  },
