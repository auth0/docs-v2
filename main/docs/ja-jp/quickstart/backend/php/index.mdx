...
## PHP Backend API との連携 {#integrating-your-php-backend-api}
...
### ユーザーを認証する {#authenticating-the-user}
...
### アクセストークンの認可 {#authorizing-an-access-token}
