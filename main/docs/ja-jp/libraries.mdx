---
title: SDKライブラリ
description: 利用可能な Auth0 SDK とライブラリを確認し、アプリケーションに Auth0 を統合します。 
---

import {sdkCardInfo} from "/snippets/sdks/versions.mdx";
import {SectionCard} from "/snippets/ja-jp/SectionsWithCards.jsx";
...
## シングルページアプリケーション (SPA) SDK ライブラリ {#single-page-application-spa-sdk-libraries}
...
## Regular Web Application 向け SDK ライブラリ {#regular-web-application-sdk-libraries}
...
## バックエンドサービス/API向けSDKライブラリ {#backend-service-and-api-sdk-libraries}
...
## Native/モバイルアプリ {#nativemobile-app}
...
## Universal Login 向け高度なカスタマイズ (ACUL) {#advanced-customization-for-universal-login-acul}

[Universal Login](/docs/ja-jp/authenticate/login/auth0-universal-login/universal-login-vs-classic-login/universal-experience#universal-login-experience) の機能を拡張し、マルチブランド対応、複雑なセキュリティ構成、複数の分析プラットフォームとの連携をサポートします。
...
## Management API SDKライブラリ {#management-api-sdk-libraries}
...
## Lock SDKライブラリ {#lock-sdk-libraries}
