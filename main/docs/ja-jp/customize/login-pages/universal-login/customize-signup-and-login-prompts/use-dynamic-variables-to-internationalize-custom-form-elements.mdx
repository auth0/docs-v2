---
description: 動的変数を使用して、ローカライズされたUniversal Loginのサインアップおよびログインプロンプトをレンダリングする方法を学びます。
...
### fr と es のロケールを有効にする {#enable-fr-and-es-locales}
...
### Custom Fields を条件付きでレンダリングする {#conditionally-render-custom-fields}
