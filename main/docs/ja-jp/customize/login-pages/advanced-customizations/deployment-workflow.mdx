---
description: ビルドしたバンドルを CDN にアップロードし、Auth0 の画面ごとの設定を更新して、Auth0 Advanced Customizations for Universal Login プロジェクトを本番環境にデプロイします。
...
### 1. Auth0 の設定 {#1-auth0-configuration}
...
### 2. Amazon Web Services でアセットをアップロードして配信する {#2-upload-and-serve-your-assets-with-amazon-web-services}
...
### 3. GitHub Action 用の AWS IAM ロールを作成する {#3-create-an-aws-iam-role-for-github-action}
...
### 4. GitHub リポジトリを設定する {#4-configure-your-github-repository}
...
### 5. デプロイを設定する {#5-configure-your-deployment}
