...
The パスワードリセット画面クラス is part of the [Identifier First Authentication](/docs/authenticate/login/auth0-universal-login/identifier-first) flow and resets the user's password.
...
The パスワードリセットメール画面クラス is part of the [Identifier First Authentication](/docs/authenticate/login/auth0-universal-login/identifier-first) flow and sends the user email instructions to reset their password.
...
The パスワードリセットエラー画面クラス is part of the [Identifier First Authentication](/docs/authenticate/login/auth0-universal-login/identifier-first) flow and sends the user back to your application.
...
The パスワードリセット要求画面クラス is part of the [Identifier First Authentication](/docs/authenticate/login/auth0-universal-login/identifier-first) flow and prompts the user for an email to send reset password instructions.
...
The パスワードリセット成功画面クラス is part of the [Identifier First Authentication](/docs/authenticate/login/auth0-universal-login/identifier-first) flow and confirms the password change and returns the user to your application.
