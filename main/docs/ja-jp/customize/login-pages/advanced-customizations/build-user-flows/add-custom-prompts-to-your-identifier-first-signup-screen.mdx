...
In your <Tooltip data-tooltip-id="react-containers-DefinitionTooltip-0" href="/docs/ja-JP/glossary?term=auth0-dashboard" tip="Auth0 Dashboard: サービスを構成するためのAuth0の主製品。" cta="用語集の表示">Auth0 Dashboard</Tooltip>, set up [Universal Login](/docs/ja-JP/authenticate/login/auth0-universal-login/universal-login-vs-classic-login/universal-experience), [Identifier First Authentication](/docs/ja-JP/authenticate/login/auth0-universal-login/identifier-first), and a [Database Connection](/docs/ja-JP/get-started/applications/set-up-database-connections) that uses passwords.
