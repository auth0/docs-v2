...
## スコープの説明を使って同意プロンプトのテキストを生成する {#use-scope-descriptions-to-generate-consent-prompt-text}
...
## スコープ名を使用して同意プロンプトのテキストを生成する {#use-scope-names-to-generate-consent-prompt-text}
