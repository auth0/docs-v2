...
## 基本的なカスタマイズ {#basic-customization}
...
### 更新に関する責任 {#responsibility-for-updates}
...
### ページのカスタマイズを有効にする {#enable-page-customization}
...
### ログインページをカスタマイズする {#customize-the-login-page}
...
#### Custom Login Form テンプレート {#custom-login-form-template}
