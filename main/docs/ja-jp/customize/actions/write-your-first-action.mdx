...
## 目標: ユーザーログイン時に Slack に通知する {#the-goal-notify-slack-on-user-login}
...
## テンプレートからActionを作成する {#create-an-action-from-a-template}
...
## Actionをデプロイする {#deploy-the-action}
...
## フロー に Action を追加する {#attach-the-action-to-a-flow}
...
## テナントログで Actions を確認する {#observe-actions-in-tenant-logs}
