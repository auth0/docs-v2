...
#
description: Learn about the custom-token-exchange Action trigger's API object, which provides methods for modifying the behavior of the trigger execution.
title: 'API Object'
