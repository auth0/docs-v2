...
#
description: Learn about the password-reset-post-challenge Action trigger's API object, which provides methods for modifying the behavior of the trigger execution.
title: 'API Object'
