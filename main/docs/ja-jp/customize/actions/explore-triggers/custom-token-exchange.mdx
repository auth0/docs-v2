...
## カスタムトークン交換とPost Login Actionsの比較 {#custom-token-exchange-vs-post-login-actions}
...
## 委譲におけるアクターのサポート {#actor-support-for-delegation}
...
## Post-Login Action とのデータ共有 {#share-data-with-post-login-actions}
