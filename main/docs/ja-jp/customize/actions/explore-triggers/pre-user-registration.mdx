...
### 場所に基づいて登録を拒否する {#deny-registration-by-location}
...
### ユーザープロファイルにメタデータを設定する {#set-metadata-in-the-user-profile}
...
### 別のシステムのユーザー ID をユーザープロファイルに保存する {#store-a-user-id-from-another-system-in-the-user-profile}
