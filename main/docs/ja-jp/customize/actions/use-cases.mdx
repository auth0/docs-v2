...
* [デフォルトのユーザー写真を設定する](/docs/ja-jp/manage-users/user-accounts/change-user-picture#change-default-picture-for-all-users)
* [外部ソースからユーザーの設定を取得し、ユーザーIDに追加する](/docs/ja-jp/customize/actions/flows-and-triggers/pre-user-registration-flow#store-a-user-id-from-another-system-in-the-user-profile)