...
1. [自己管理証明書を使ってカスタムドメインを構成する](/custom-domains/self-managed-certificates)作業がまだ済んでいない場合は、ここで行います。**［Origin Domain Name（オリジンのドメイン名）］**と**cname-api-key**の値が後で必要になるのでメモしておきます。
