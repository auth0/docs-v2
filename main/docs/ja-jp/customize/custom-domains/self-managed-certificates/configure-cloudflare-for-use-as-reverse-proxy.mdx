...
## Cloudflare を設定する {#configure-cloudflare}
...
## Managed Challenges を使用する {#use-managed-challenges}
...
### Universal Login のブラウザーベースのエンドポイント {#universal-login-browser-based-endpoints}
...
### 除外するエンドポイント {#endpoints-to-exclude}
