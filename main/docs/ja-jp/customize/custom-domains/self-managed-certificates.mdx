...
| 設定 | 値 |
| --- | --- |
| オリジンドメイン名 | カスタムドメイン設定プロセス中にAuth0 Dashboardから取得した**オリジンドメイン名**の値に設定します。 |
...
| ［Allow List Headers（許可リストヘッダー）］ | 次のヘッダーを使用できます：`User-Agent`、`Origin`、`Referer`、`Authorization`、`Accept`、`Accept-Language` |
