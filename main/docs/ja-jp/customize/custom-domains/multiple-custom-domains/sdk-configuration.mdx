...
## Management SDKs {#management-sdks}
...
### Node.js 管理用 SDK {#nodejs-management-sdk}
...
### Python向け管理SDK {#python-management-sdk}
...
## 環境ごとの設定 {#environment-specific-configuration}

環境変数を使用して、環境ごとにカスタムドメインを管理します。

### .env ファイルの構造 {#env-file-structure}
