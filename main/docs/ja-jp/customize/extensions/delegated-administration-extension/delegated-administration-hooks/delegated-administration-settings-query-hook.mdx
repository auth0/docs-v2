...
* **blocked&#95;for**: ユーザーが<Tooltip tip="攻撃対策: Auth0 が提供する、攻撃の検出と緩和のための機能です。これには、総当たり攻撃対策、不審な IP スロットリング、漏えいパスワードの検知、ボット検出、適応型多要素認証が含まれます。" cta="用語集を見る" href="/docs/ja-jp/glossary?term=attack+protection">攻撃対策</Tooltip>によってブロックされているかどうか
...
### ユーザーフィールドの作成と編集 {#create-and-edit-user-fields}
...
### 例: 言語辞書ファイルへのリンクを指定する {#example-provide-link-to-language-dictionary-file}
...
### 例: Language Dictionary オブジェクトを指定する {#example-provide-language-dictionary-object}
