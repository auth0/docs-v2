---
description: Authorization Extension を使用して、JSON ファイルで既存の認可データをインポートおよびエクスポートする方法を説明します。
...
* [Authorization Extension への API Access を有効にする](/docs/ja-jp/customize/extensions/authorization-extension/enable-api-access-to-authorization-extension)
