...
## 拡張機能はどのように動作しますか？ {#how-does-the-extension-work}
...
## 拡張機能のインストールと設定 {#install-and-configure-extension}
...
## 拡張機能の設定 {#set-up-extension}

### アプリケーション名を変更する {#change-application-name}
...
### ログインページを更新する {#update-the-login-page}
