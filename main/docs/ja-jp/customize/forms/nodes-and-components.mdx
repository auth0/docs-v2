---
description: Forms を使用してレンダリングできる利用可能なノードと入力フィールドコンポーネントについて説明します。
title: ノードとコンポーネント
---
...
#### フィールドの検証ルール {#field-validation-rules}
...
#### Formsで利用できるフィールド {#available-fields-in-forms}
...
##### テキストフィールドの設定 {#text-field-settings}
...
##### テキストフィールドの出力値 {#text-field-output-value}
...
##### メールフィールドの出力値 {#email-field-output-value}
...
##### 電話フィールドの設定 {#phone-field-settings}
...
##### 電話フィールドの出力値 {#phone-field-output-value}
...
##### Choice フィールドの設定 {#choice-field-settings}
...
##### Choice フィールドの出力値 {#choice-field-output-value}
...
##### カードフィールドの設定 {#cards-field-settings}
...
##### カードフィールドの出力値 {#cards-field-output-value}
...
##### URL フィールドの出力値 {#url-field-output-value}
...
##### パスワードフィールドの設定 {#password-field-settings}
...
##### パスワードフィールドの出力値 {#password-field-output-value}
...
##### 支払いフィールドの設定 {#payment-field-settings}
...
##### 支払いフィールドの出力値 {#payment-field-output-value}
...
##### Legal フィールドの出力値 {#legal-field-output-value}
...
##### ドロップダウンフィールドの設定 {#dropdown-field-settings}
...
##### ドロップダウンフィールドの出力値 {#dropdown-field-output-value}
...
##### 数値フィールドの出力値 {#number-field-output-value}
...
##### 日付 / 時刻フィールドの設定 {#date-time-field-settings}
...
##### 日付 / 時刻フィールドの出力値 {#date-time-field-output-value}
...
##### Boolean フィールドの出力値 {#boolean-field-output-value}
...
##### カスタムフィールドの設定 {#custom-field-settings}
...
#### Forms で使用できるブロック {#available-blocks-in-forms}
...
### Widgets コンポーネント {#widgets-components}
...
#### Forms で使用できるウィジェット {#available-widgets-in-forms}
...
##### Google Address ウィジェットの設定 {#google-address-widget-settings}
...
##### Google Address ウィジェットの出力値 {#google-address-widget-output-value}
...
##### Google reCAPTCHA ウィジェットの設定 {#google-recaptcha-widget-settings}
...
##### Google reCAPTCHA の出力値 {#google-recaptcha-output-value}
...
##### Verifiable Credentials ウィジェットの設定 {#verifiable-credentials-widget-settings}
...
##### Verifiable Credentials の出力値 {#verifiable-credentials-output-value}
