...
## カスタムドメインを使用する利点 {#benefits-of-using-a-custom-domain}
...
### カスタムドメインと認証 {#custom-domains-and-authentication}
...
### カスタムドメインと URI {#custom-domains-and-uris}
...
### カスタムドメインとトークンリクエスト {#custom-domains-and-token-requests}
...
## 証明書管理のオプション {#certificate-management-options}

### Auth0 管理の証明書 {#auth0-managed-certificates}
...
### 自己管理証明書 {#self-managed-certificates}
