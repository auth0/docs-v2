---
description: Auth0 を使用して、iOS向け Lock をアプリケーションに国際化対応させます。
...
### 英語の代替文字列を設定する {#providing-alternative-english-strings}
...
### 他言語への対応 {#supporting-other-languages}
