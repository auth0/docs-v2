...
<tbody>
<tr>
<td><a href="/docs/ja-jp/customize/hooks/create-hooks">フックを作成する</a></td>
<td>DashboardまたはManagement APIを使用してフックを作成する方法。</td>
</tr>
<tr>
<td><a href="/docs/ja-jp/customize/hooks/update-hooks">フックを更新する</a></td>
<td>DashboardまたはManagement APIを使用してフックを更新する方法。</td>
</tr>
<tr>
<td><a href="/docs/ja-jp/customize/hooks/delete-hooks">フックを削除する</a></td>
<td>DashboardまたはManagement APIを使用してフックを削除する方法。</td>
</tr>
<tr>
<td><a href="/docs/ja-jp/customize/hooks/enable-disable-hooks">フックの有効化/無効化</a></td>
<td>DashboardおよびManagement APIを使用してフックを有効化/無効化する方法。</td>
</tr>
<tr>
<td><a href="/docs/ja-jp/customize/hooks/view-hooks">フックを表示する</a></td>
<td>DashboardおよびManagement APIを使用してフックを表示する方法。</td>
</tr>
<tr>
<td><a href="/docs/ja-jp/customize/hooks/view-logs-for-hooks">フックのログを表示する</a></td>
...
<tr>
<td><a href="/docs/ja-jp/customize/hooks/hook-secrets">フックシークレット</a></td>
