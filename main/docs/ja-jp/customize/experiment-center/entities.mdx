...
Auth0の[Management API](/docs/ja-jp/api/management/v2)を使用すると、プロパティ、ライフサイクルの状態、検証ルールなど、Experiment Center エンティティの詳細を定義できます。
...
### `is_valid` ゲート {#the-is_valid-gate}
...
### フィーチャーフラグのライフサイクル {#feature-flag-lifecycle}
...
### 使用可能な条件属性 {#available-condition-attributes}
...
<Card title="ACUL 連携" icon="puzzle-piece" href="/docs/ja-jp/customize/experiment-center/integrations/acul-integration-guide" horizontal>
