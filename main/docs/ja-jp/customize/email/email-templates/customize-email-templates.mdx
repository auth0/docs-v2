...
### URL の有効期間と Redirect To {#url-lifetime-and-redirect-to}
...
特定のアプリケーションやユーザーに対しては、Management API の [Send an email address verification email](https://auth0.com/docs/api/management/v2/jobs/post-verification-email) エンドポイントを使用して、確認メールを手動で送信できます。

## カスタマイズのユースケース例 {#example-customization-use-cases}
