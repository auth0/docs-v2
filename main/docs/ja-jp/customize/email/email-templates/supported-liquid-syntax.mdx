...
### Redirect To 変数 {#redirect-to-variables}
...
## テンプレート固有の変数 {#template-specific-variables}

すべてのメールテンプレートで使用できる共通の Liquid 変数に加え、以下のメールテンプレートでは追加の変数も使用できます。

### アカウントがブロックされた際のメールテンプレート変数 {#blocked-account-email-template-variables}
...
### パスワード変更 (コード) メールテンプレートの変数 {#change-password-code-email-template-variables}

* `code`、パスワード変更用のコード

### パスワード変更 (リンク) メールテンプレートの変数 {#change-password-link-email-template-variables}

* `url`：パスワードリセット用のリンク

### MFA登録メールテンプレートの変数 {#mfa-enrollment-email-template-variables}

* `link`：MFA登録リンク。

### パスワードレス OTP メールテンプレート変数 {#passwordless-otp-email-template-variables}
...
### ユーザー招待メールテンプレートの変数 {#user-invitation-email-template-variables}
...
### 確認メール (コード) のテンプレート変数 {#verification-email-code-template-variables}

* `code`：確認コード

### 確認メール (リンク) のテンプレート変数 {#verification-email-link-template-variables}
