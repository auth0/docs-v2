...
sidebarTitle: 概要
description: デフォルトの電話プロバイダーではなく任意のゲートウェイを介して Auth0 の SMS および音声メッセージを送信する、custom-phone-provider Action を実装します。
---
...
## Auth0 Dashboard または Management API を使用してカスタム電話プロバイダーを設定する {#configure-a-custom-phone-provider-with-the-auth0-dashboard-or-management-api}
...
#### Auth0 Dashboard でカスタム電話プロバイダーを追加する {#add-a-custom-phone-provider-with-the-auth0-dashboard}
...
#### Auth0 Dashboard でカスタム電話プロバイダーを編集する {#edit-a-custom-phone-provider-with-the-auth0-dashboard}
...
#### Management API でカスタム電話プロバイダーを追加する {#add-a-custom-phone-provider-with-the-management-api}
...
#### Management API でカスタム電話プロバイダーを編集する {#edit-a-custom-phone-provider-with-the-management-api}
...
## custom-phone-provider Action の例 {#example-custom-phone-provider-action}
