...
<Tabs>
  <Tab title="Auth0 CLI">
## ステップ1: Auth0 CLI Beta をインストールする {#step-1-install-the-auth0-cli-beta}
...
## ステップ2：設定コマンドを実行する {#step-2-run-the-setup-command}
...
## ステップ 1: Auth0 Agent Skills をインストールする {#step-1-install-auth0-agent-skills}

    ```bash
    npx skills add auth0/agent-skills
    ```

## ステップ2：AI agent に Universal Portals の設定を依頼する {#step-2-ask-your-ai-agent-to-configure-universal-portals}
