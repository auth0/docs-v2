...
## Amazon Web Services の設定 {#configure-amazon-web-services}

### Auth0 アプリケーションの詳細を確認する {#get-auth0-application-details}
...
### 新しいOpenID Connect (OIDC) プロバイダーを作成 {#create-new-openid-connect-oidc-provider}
...
### Identity Pool を作成する {#create-identity-pool}
...
### 「Invalid login token」エラー {#invalid-login-token-error}
