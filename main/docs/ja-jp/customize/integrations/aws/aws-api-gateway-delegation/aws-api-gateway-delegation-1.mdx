...
<Frame>![DynamoDB Console - Create Table](/docs/images/ja-jp/cdy7uua7fh8z/2ZPhi7Ddx4TznSXEEhUSDK/52a06412f7c5e6d0ef0d13c6ffe17611/dynamodb-create-table.png)</Frame>
...
<Frame>![DynamoDB Console - Configure Newly Created Table](/docs/images/ja-jp/cdy7uua7fh8z/6MYJV97Xa3DxajG8DYj2dx/e428ab2ce137176d7771c61a9c528f7c/configure-newly-created-table.png)</Frame>
...
<Frame>![DynamoDB Console - Table Details - Amazon Resource Name](/docs/images/ja-jp/cdy7uua7fh8z/4ZFemddtUD8tRi0NUvzXJ2/38abd951974cad385ef7417f48adf359/table-arn.png)</Frame>
...
<Frame>![IAM Console - Roles - Create New Roles](/docs/images/ja-jp/cdy7uua7fh8z/4mgCTXLpycHLA8RbYoEFim/5d9eb81be979355aa9cd10d476ead515/roles.png)</Frame>

ロールに`APIGatewayLambdaExecRole`という名前を付け、 **［Next Step（次の手順）］** をクリックします。

［Role（ロール］タイプを選択します。［AWS Service Roles］の下の［AWS Lambda］を選択します。

<Frame>![IAM Console - Select the Role Type - Service Roles - AWS Lambda](/docs/images/ja-jp/cdy7uua7fh8z/326kKGbahlvIwVFTi61Gfw/026d1fc0c8c6e3a489ec4fb840f551da/select-role-type.png)</Frame>
