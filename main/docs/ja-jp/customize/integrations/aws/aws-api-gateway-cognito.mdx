...
## Cognito User Pool を API Gateway API と統合する {#integrate-the-cognito-user-pool-with-the-api-gateway-api}
...
## メソッドで ユーザープール Authorizer を有効にする {#enable-the-user-pool-authorizer-on-methods}
