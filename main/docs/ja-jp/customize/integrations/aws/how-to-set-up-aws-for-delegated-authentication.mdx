...
## AWS で SAML プロバイダーを作成する {#create-a-saml-provider-in-aws}
...
## SAML プロバイダー 用のロールを作成する {#create-a-role-for-your-saml-provider}
...
## ARN 値をコピーする {#copy-the-arn-values}

以下の手順では、Provider と Role の ARN 値がどこにあるかを確認できます。

### Provider ARN {#provider-arn}
