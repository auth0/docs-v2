...
## カスタム API を作成する {#create-a-custom-api}
...
## テストアプリケーションの変数をメモする {#note-variables-from-the-test-application}
...
## Client Credentialsフローを実装する {#implement-the-client-credentials-flow}
...
## アクセストークンを検証する {#validate-the-access-token}
