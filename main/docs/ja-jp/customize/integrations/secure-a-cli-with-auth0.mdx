---
description: デバイス認可フローとクライアントクレデンシャルグラントフローを使用して、Auth0 でコマンドラインツールを保護する方法を学びます。
...
## クライアントクレデンシャルズグラントフロー {#client-credentials-grant-flow}
...
## Resource Owner Password Grant フロー {#resource-owner-password-grant-flow}
