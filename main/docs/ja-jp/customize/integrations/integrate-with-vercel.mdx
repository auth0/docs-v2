---
title: Vercel と連携する
description: Auth0 Next.js SDK を使用して、Auth0 を Vercel プロジェクトに連携する方法を学びます。
...
## アプリケーション設定の管理 {#manage-application-settings}
...
#### 現在のインストールレベルのプラン {#current-installation-level-plan}
