---
description: Auth0のユーザーデータをエクスポートして、Adobe Marketo Engageにインポートする方法を説明します。
...
[Get Import Lead Status API](https://developer.adobe.com/marketo-apis/api/mapi#operation/getImportLeadStatusUsingGET) とインポート job の `batchId` を使用して、インポートのステータスを確認できます。例:
