---
description: アプリケーション用に Login by Auth0 WordPress Plugin を設定する方法
...
### Management API のためにアプリケーションを認可する {#authorize-the-application-for-the-management-api}
...
### データベース接続の設定 {#database-connection-setup}
...
## WordPress の設定 {#wordpress-configuration}
...
## PHP 定数による設定の保存 {#php-constant-setting-storage}
