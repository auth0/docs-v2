---
description: 制限付きの `auth0 ManagementClient` オブジェクトを使用して Rule 内から Auth0 Management API を呼び出す方法、または追加のエンドポイントとスコープのために新しいバージョンの `node-auth0` を使用する方法を学びます。
...
## ライブラリの新しいバージョンを利用する {#access-a-newer-version-of-the-library}
