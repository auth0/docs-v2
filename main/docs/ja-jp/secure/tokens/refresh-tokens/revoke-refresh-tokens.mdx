...
## トークン取り消し時にグラントも削除するかどうかを選択する {#choose-whether-token-revocation-deletes-grants}
...
## リフレッシュトークンを取り消す {#revoke-a-refresh-token}
...
### Authentication API の使用 {#using-the-authentication-api}
...
### Management API のデバイス資格情報エンドポイントを使用する {#using-the-management-api-device-credentials-endpoints}
...
### Management API のリフレッシュトークンエンドポイントを使用する {#using-the-management-api-refresh-token-endpoints}
