---
description: Auth0 Dashboard または Management API を使用してリフレッシュトークンローテーションを無効にする方法を説明します。 
...
## Auth0 Dashboardで無効にする {#disable-with-the-dashboard}
...
## Management API で無効にする {#disable-with-the-management-api}
