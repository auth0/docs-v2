---
description: Auth0のRefresh Tokenのローテーションを設定して、非ローテーション リフレッシュトークンからローテーションされるリフレッシュトークンへの移行と、その逆方向の移行を行う方法について説明します。
...
## Auth0 Dashboardで設定する {#configure-in-the-dashboard}
...
## Auth0 SPA SDK を使用して設定する {#configure-with-the-auth0-spa-sdk}
