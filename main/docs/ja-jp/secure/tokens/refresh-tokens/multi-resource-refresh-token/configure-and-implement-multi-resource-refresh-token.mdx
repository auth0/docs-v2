...
| --- | --- | --- |
| `audience` | string | The Auth0 API [identifier](https://auth0.com/docs/ja-jp/get-started/apis/api-settings#general-settings) of the application that will have access to using the refresh token. |
