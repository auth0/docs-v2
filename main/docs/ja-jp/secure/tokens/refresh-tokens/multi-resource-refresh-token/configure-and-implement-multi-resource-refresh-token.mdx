...
<td>`audience`</td>
<td>string</td>
<td>The Auth0 API <a href="https://auth0.com/docs/ja-jp/get-started/apis/api-settings#general-settings">identifier</a> of the application that will have access to using the refresh token.</td>
</tr>
<tr>
<td>`scope`</td>
