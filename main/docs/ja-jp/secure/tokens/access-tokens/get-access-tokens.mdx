...
## アクセストークンのaudienceを制御する {#control-access-token-audience}
...
### 複数のaudience {#multiple-audiences}
...
### カスタムドメインと Auth0 Management API {#custom-domains-and-the-auth0-management-api}
...
## アクセストークンを更新する {#renew-access-tokens}
