...
## 利用可能なスコープとエンドポイント {#available-scopes-and-endpoints}
...
## SPA から Management API を呼び出すための Management API トークンの使用 {#use-management-api-token-to-call-management-api-from-a-spa}
