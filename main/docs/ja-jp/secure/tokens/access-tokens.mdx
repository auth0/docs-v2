...
## 不透明アクセストークン {#opaque-access-tokens}
...
## JWT アクセストークン {#jwt-access-tokens}
...
### Management API アクセストークン {#management-api-access-tokens}
...
### カスタム API のアクセストークン {#custom-api-access-tokens}
...
## アクセストークンのサンプル {#sample-access-token}
...
## アクセストークンのセキュリティ {#access-token-security}
...
## アクセストークンの有効期間 {#access-token-lifetime}

### カスタム API のアクセストークン有効期間 {#custom-api-token-lifetime}
...
### /userinfo エンドポイントのトークン有効期間 {#userinfo-endpoint-token-lifetime}
