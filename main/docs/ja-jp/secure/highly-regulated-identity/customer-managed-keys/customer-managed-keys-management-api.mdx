...
1. Call the [Create the new encryption key](https://auth0.com/docs/api/management/v2/keys/post-encryption) endpoint to initiate the BYOK（Bring Your Own Key） process and obtain the `kid` (key identifier) of the pre-activated Customer Provided Root Key without cryptographic material.
