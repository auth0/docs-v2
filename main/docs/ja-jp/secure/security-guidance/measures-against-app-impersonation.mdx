...
## モバイルアプリケーション向けの推奨対策 {#recommended-mitigations-for-mobile-applications}

### 検証済み HTTPS URI (Universal Links / App Links) {#claimed-https-uris-universal-links-app-links}
...
## すべてのアプリケーションに推奨される緩和策 {#recommended-mitigations-for-all-application}
