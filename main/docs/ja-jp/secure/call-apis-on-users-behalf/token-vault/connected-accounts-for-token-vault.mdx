...
## ユーザー認証と Connected Accounts の違い {#user-authentication-vs-connected-accounts}
...
### My Account API を設定する {#configure-my-account-api}
...
### マルチリソース リフレッシュトークンを設定する {#configure-multi-resource-refresh-token}
...
## Connected Accounts を設定する {#configure-connected-accounts}
...
## Connected Accounts のアクセストークンを取得する {#get-access-token-for-connected-accounts}
...
### リフレッシュトークンを取得する {#fetch-a-refresh-token}
...
### リフレッシュトークンを My Account API のアクセストークンに交換する {#exchange-refresh-token-for-my-account-api-access-token}
...
## Connected Accounts リクエストを開始する {#initiate-connected-accounts-request}
...
## Connected Accounts リクエストの完了 {#complete-connected-accounts-request}
...
## Connected Accounts の管理 {#manage-connected-accounts}
...
### Connected Accounts の接続を照会する {#query-connected-accounts-connections}
...
### 接続済みアカウントを取得する {#query-connected-accounts}
...
### 特定の接続の接続済みアカウントを取得する {#query-connected-accounts-for-a-given-connection}
...
### 接続済みアカウントを削除 {#delete-connected-account}
