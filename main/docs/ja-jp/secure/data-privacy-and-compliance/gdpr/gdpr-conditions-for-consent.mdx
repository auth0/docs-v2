...
### 再同意とユーザー移行 {#re-consent-and-user-migration}
...
### メールアドレスでユーザーを検索する {#search-for-users-by-email-address}
...
### IDでユーザーを検索する {#search-for-users-by-id}
...
### 同意情報を更新する {#update-consent-information}
...
#### ルートプロパティの更新 {#update-root-property}
...
#### 内部プロパティを更新する {#update-inner-property}
...
### 同意情報をエクスポートする {#export-consent-information}
...
### ユーザーに削除済みフラグを付ける {#flag-user-as-deleted}
...
#### プロファイルにフラグを設定する {#flag-the-profile}
...
#### フラグが付けられたユーザーのログインを無効にする {#disable-login-for-flagged-users}
