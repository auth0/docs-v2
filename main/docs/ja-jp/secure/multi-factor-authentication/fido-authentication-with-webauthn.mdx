...
## WebAuthn と Web オリジン {#webauthn-and-web-origins}
...
## ローミング認証器 {#roaming-authenticators}
...
## プラットフォーム認証器 {#platform-authenticators}
...
## 多要素認証としてのWebAuthn {#webauthn-as-multi-factor-authentication}
