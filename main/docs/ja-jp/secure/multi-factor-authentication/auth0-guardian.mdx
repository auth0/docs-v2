...
<Frame>![Auth0 Guardian flow diagram](/docs/images/ja-JP/cdy7uua7fh8z/TdN0nXfYs0mqHpi9U3JQ9/e1018ba751dc3dc147c09d1e511c0d0a/diagram.png)</Frame>
...
<Frame>![Auth0 Dashboard > Security > Multi-factor Auth > Push Notification using Auth0 Guardian](/docs/images/ja-JP/cdy7uua7fh8z/fwjSKFNhsvObzdPDiA79N/bb3b226023807be99c2249ff4d8c0465/Auth0_Guardian_-_Dashboard_setting.png)</Frame>
...
2. MFAプロンプトで、ユーザーが**［Manuallay Enter Code（手動でコードを入力する）］** ボタンを選択する。OTPを使用して認証するには、このオプションを選択する必要がある。
   ...
   <Frame>![［Manuallay Enter Code（手動でコードを入力する）］ボタンを表示するMFAプロンプトの例](/docs/images/ja-JP/cdy7uua7fh8z/7reEOLI5CWxbpRzgZY7gxg/5cea15c9d8586a68df32c42d292c7478/MFA_-_Push_-_Japanese.png)</Frame>
...
<Frame>![Trouble Scanning?（スキャンできませんか？）リンクを表示するOTP登録プロンプトの例](/docs/images/ja-JP/cdy7uua7fh8z/3kbyOBiLOpJiY8vI0kUqwg/8dba996a91cf3a66a9c7e4bd6ffd0b90/OTP_Challenge_3_-_Japanese.png)</Frame>

* **携帯電話** ：ユニバーサルログインはQRコードではなく、登録コードを直接表示します。

<Frame>![The temporary one-time password enrollment screen as displayed on a mobile device. ](/docs/images/ja-JP/cdy7uua7fh8z/5QvQ9FLYnVZXINFAeLkIr9/e244b935a012172d8ce64f26d85f07b3/OTP_prompt_-_Japanese.png)</Frame>
