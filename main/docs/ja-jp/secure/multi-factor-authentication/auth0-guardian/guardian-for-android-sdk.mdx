...
## Guardian Android SDK をインストール {#install-guardian-android-sdk}
...
### ログインリクエストを承認する {#allow-login-requests}
...
##### Guardian SDK を使用する {#use-guardian-sdk}
...
#### アプリを使ってログインする {#log-in-with-your-app}
