...
```bash cURL lines
curl --request GET \
  --url https://{yourDomain}/api/v2/users/{userId}/authentication-methods \
  --header 'authorization: Bearer {yourMgmtApiAccessToken}'
```
```csharp C# lines
var client = new RestClient("https://{yourDomain}/api/v2/users/{userId}/authentication-methods");
...
```
```java Java lines
HttpResponse<String> response = Unirest.get("https://{yourDomain}/api/v2/users/{userId}/authentication-methods")
  .header("authorization", "Bearer {yourMgmtApiAccessToken}")
  .asString();
```
...
NSMutableURLRequest *request = [NSMutableURLRequest requestWithURL:[NSURL URLWithString:@"https://{yourDomain}/api/v2/users/{userId}/authentication-methods"]
...
curl_setopt_array($curl, [
  CURLOPT_URL => "https://{yourDomain}/api/v2/users/{userId}/authentication-methods",
...
conn.request("GET", "{yourDomain}/api/v2/users/{userId}/authentication-methods", headers=headers)
...
url = URI("https://{yourDomain}/api/v2/users/{userId}/authentication-methods")
...
let request = NSMutableURLRequest(url: NSURL(string: "https://{yourDomain}/api/v2/users/{userId}/authentication-methods")! as URL,
...
```bash cURL lines
curl --request GET \
  --url https://{yourDomain}/api/v2/users/{userId}/authentication-methods/{authenticationMethodId} \
  --header 'authorization: Bearer {yourMgmtApiAccessToken}'
```
```csharp C# lines
var client = new RestClient("https://{yourDomain}/api/v2/users/{userId}/authentication-methods/{authenticationMethodId}");
var request = new RestRequest(Method.GET);
request.AddHeader("authorization", "Bearer {yourMgmtApiAccessToken}");
IRestResponse response = client.Execute(request);
```
...
```
```java Java lines
HttpResponse<String> response = Unirest.get("https://{yourDomain}/api/v2/users/{userId}/authentication-methods/{authenticationMethodId}")
  .header("authorization", "Bearer {yourMgmtApiAccessToken}")
  .asString();
```
...
NSMutableURLRequest *request = [NSMutableURLRequest requestWithURL:[NSURL URLWithString:@"https://{yourDomain}/api/v2/users/{userId}/authentication-methods/{authenticationMethodId}"]
                                                       cachePolicy:NSURLRequestUseProtocolCachePolicy
                                                   timeoutInterval:10.0];
[request setHTTPMethod:@"GET"];
[request setAllHTTPHeaderFields:headers];
...
curl_setopt_array($curl, [
  CURLOPT_URL => "https://{yourDomain}/api/v2/users/{userId}/authentication-methods/{authenticationMethodId}",
  CURLOPT_RETURNTRANSFER => true,
  CURLOPT_ENCODING => "",
  CURLOPT_MAXREDIRS => 10,
  CURLOPT_TIMEOUT => 30,
...
conn.request("GET", "{yourDomain}/api/v2/users/{userId}/authentication-methods/{authenticationMethodId}", headers=headers)
...
url = URI("https://{yourDomain}/api/v2/users/{userId}/authentication-methods/{authenticationMethodId}")
...
let request = NSMutableURLRequest(url: NSURL(string: "https://{yourDomain}/api/v2/users/{userId}/authentication-methods/{authenticationMethodId}")! as URL,
                                        cachePolicy: .useProtocolCachePolicy,
                                    timeoutInterval: 10.0)
request.httpMethod = "GET"
request.allHTTPHeaderFields = headers
...
```
```java Java lines
HttpResponse<String> response = Unirest.post("https://{yourDomain}/api/v2/users/{userId}/authentication-methods")
  .header("authorization", "Bearer {yourMgmtApiAccessToken}")
...
conn.request("POST", "{yourDomain}/api/v2/users/{userId}/authentication-methods", payload, headers)
...
```
```java Java lines
HttpResponse<String> response = Unirest.put("https://{yourDomain}/api/v2/users/{userId}/authentication-methods")
  .header("authorization", "Bearer {yourMgmtApiAccessToken}")
...
conn.request("PUT", "{yourDomain}/api/v2/users/{userId}/authentication-methods", payload, headers)
...
```
```java Java lines
HttpResponse<String> response = Unirest.patch("https://{yourDomain}/api/v2/users/{userId}/authentication-methods/{authenticationMethodId}")
  .header("authorization", "Bearer {yourMgmtApiAccessToken}")
...
conn.request("PATCH", "{yourDomain}/api/v2/users/{userId}/authentication-methods/{authenticationMethodId}", payload, headers)
...
```
```java Java lines
HttpResponse<String> response = Unirest.delete("https://{yourDomain}/api/v2/users/{userId}/authentication-methods")
  .header("authorization", "Bearer {yourMgmtApiAccessToken}")
  .asString();
```
...
conn.request("DELETE", "{yourDomain}/api/v2/users/{userId}/authentication-methods", headers=headers)
...
```
```java Java lines
HttpResponse<String> response = Unirest.delete("https://{yourDomain}/api/v2/users/{userId}/authentication-methods/{authenticationMethodId}")
  .header("authorization", "Bearer {yourMgmtApiAccessToken}")
  .asString();
```
...
conn.request("DELETE", "{yourDomain}/api/v2/users/{userId}/authentication-methods/{authenticationMethodId}", headers=headers)
