---
description: Auth0 MFA の認証要素として Device Biometrics を使用する WebAuthn を設定し、ユーザーが Face ID、Touch ID、または Windows Hello で認証できるようにします。
...
## Relying Party を設定する {#configure-relying-party}
...
### Windows と iOS 14.5+ {#windows-and-ios-145}
