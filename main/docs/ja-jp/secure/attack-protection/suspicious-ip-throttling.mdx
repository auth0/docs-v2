...
<Frame>![Auth0 不審なIPのスロットリング設定 ](/docs/images/ja-jp/cdy7uua7fh8z/3CKuhfeU1nqDxrJJKAYR2k/9ee38b1e36fa5648a1a8baae9e1466bf/Suspicious_IP_Throtting_-_Japanese.png)</Frame>
...
応答の設定をまったく有効にせずに攻撃防御機能を有効にすると、モニタリングモードが作動し、関連イベントがテナントログにのみ記録されます。詳細については、「[攻撃防御のログイベントを表示する](/docs/ja-jp/secure/attack-protection/view-attack-protection-events)」をお読みください。
...
1. [［Dashboard］>［Security（セキュリティ）］>［Attack Protection（攻撃防御）］](https://manage.auth0.com/#/security/attack-protection)に移動し、**［Suspicious IP Throttling（不審なIPスロットリング）］** を選択します。
   ...
   <Frame>![Auth0 Dashboardで不審なIPのスロットリングをカスタマイズ](/docs/images/ja-jp/cdy7uua7fh8z/5yLYmDn0FvDB061WgTH2fk/e4f2e7b1e139642512a4634cad8fe287/Suspicious_IP_Throttling_setting.png)</Frame>
