...
<AccordionGroup>
  <Accordion title="新しい Universal Login の識別子 + パスワード">
    ...
    * `/u/signup/password`
    ...
    <div id="add-parameters-to-methods">
      ### メソッドにパラメーターを追加する
    </div>
  ...
  <Accordion title="新しい Universal Login の識別子ファースト">
    ...
    * `/u/signup/password`
    ...
    <div id="add-parameters-to-methods-2">
      ### メソッドにパラメーターを追加する
    </div>
  ...
  <Accordion title="ROPG">
    ...
    * `/oauth/token`
    ...
    <div id="add-parameters-to-methods-3">
      ### メソッドにパラメーターを追加
    </div>
