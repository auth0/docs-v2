...
## サポート対象のログインフロー {#supported-login-flows}
...
# ステップ1: Akamai で API を登録する {#step-1-register-an-api-in-akamai}
...
### メソッドにパラメーターを追加する {#add-parameters-to-methods}
...
### APIリソースを追加する {#add-api-resource-2}
...
### メソッドにパラメーターを追加する {#add-parameters-to-methods-2}
...
### API リソースを追加 {#add-api-resource-3}
...
### メソッドにパラメーターを追加 {#add-parameters-to-methods-3}
...
# ステップ 2: Akamai から Auth0 にボットの結果を転送する {#step-2-forward-bot-results-from-akamai-to-auth0}
...
# ステップ 3: Auth0 で Akamai ヘッダーの処理を有効にする {#step-3-enable-processing-of-akamai-headers-in-auth0}
...
# ステップ4: 設定をテストして検証する {#step-4-test-and-verify-configuration}
