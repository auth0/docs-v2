...
description: Akamai Account Protector シグナルを使用して、Akamai のエッジネットワークから得られる bot、不正、リスクのスコアでログイン時の判定を強化します。
---
...
## Action トリガー別のサポート対象 Supplemental Signals {#supported-supplemental-signals-by-action-trigger}
...
## Supplemental Signals オブジェクトのスキーマ {#supplemental-signal-object-schemas}
...
#### アプリメタデータをクリーンアップする {#clean-up-app-metadata}
