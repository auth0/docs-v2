...
## ログインフローにおけるエラー率 {#rate-of-errors-in-login-flow}
...
## 攻撃対策イベントの発生率 {#rate-of-attack-protection-events}
...
## エラーを発生させている IP の数とその所在地 {#number-of-ips-producing-errors-and-their-locations}
