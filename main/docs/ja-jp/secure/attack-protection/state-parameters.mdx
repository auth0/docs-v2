...
### state パラメータの値を設定して照合する {#set-and-compare-state-parameter-values}
...
### 保存した URL を使用してユーザーをリダイレクトする {#use-the-stored-url-to-redirect-users}
...
### 代替のリダイレクト方法 {#alternate-redirect-method}
...
## 制限事項と考慮点 {#limitations-and-considerations}
