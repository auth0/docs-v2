...
<Frame>![null](/docs/images/ja-jp/cdy7uua7fh8z/20iajPMtmICMORUfaVQH7a/0cf9a3707618185480ad5495bb4df213/image17.png)</Frame>

## 強力な顧客認証（SPA）

<Frame>![null](/docs/images/ja-jp/cdy7uua7fh8z/3JDIerJcevImoIDRd7OfIy/8fecb130efd2cc5f536b5d4c6ddd66ba/image14.png)</Frame>
...
[Actions](/docs/ja-jp/customize/actions)を使用することで、どの認証要素を使用するか動的に決定できます。これにより、コードロジックをカスタマイズする柔軟性が得られます。例えば、10米ドルを超える決済に対する第二認証要素を追加できます。詳しくは、「[動的ポリシーの適用](/docs/ja-jp/secure/highly-regulated-identity/transactional-authorization-with-authorization-code-flow#apply-dynamic-policy)」をお読みください。
