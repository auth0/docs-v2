...
<ResponseField name="options" type="enablemultifactoroptions" post={["optional"]}>
  ...
  <Expandable title="options properties" defaultOpen>
    ...
    <ResponseField name="providerOptions" type="object" post={["optional"]}>
      ...
      <Expandable title="providerOptions properties" defaultOpen>
        <ResponseField name="host" type="string" />

        <ResponseField name="ikey" type="string" />

        <ResponseField name="skey" type="string" />
...
<ResponseField name="nameIdentifierProbes" type="array of string" />
...
<ResponseField name="groups" type="array of string">
