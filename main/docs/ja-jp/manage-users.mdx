...
##### ユーザーをインポートし、グループ化・管理して、アクセスを制御します。 {#import-group-and-administer-users-and-control-their-access}
...
##### アプリケーション内で操作できるユーザーを制御します。 {#control-who-can-interact-within-your-applications}
