...
どちらを選ぶか、あるいは両方を選ぶかは、ユースケースや優先事項に左右されます。詳細については、「[Deploy CLIを構成する](/configure-the-deploy-cli)」をお読みください。
...
フラグとオプションをまとめたリストについては、「[CLIとして使用する](/use-as-a-cli)」をお読みください。