...
<td>An IP address is blocked because it attempted too many failed logins without a successful login. Or an IP address is blocked because it attempted too many sign-ups, whether successful or failed. For more information, see <a href="/docs/ja-jp/secure/attack-protection">Attack Protection</a>.</td>
</tr>
{/* <!-- Undocumented
  <tr>
    <td>`limit_sui`</td>
...
<td>`limit_sul`</td>
<td>Blocked Account</td>
<td>A user is temporarily prevented from logging in because they reached the maximum logins per time period from the same IP address. For more information, see <a href="/docs/ja-jp/secure/attack-protection">Attack Protection</a>.</td>
</tr>
{/* <!-- Undocumented
  <tr>
    <td>`limit_ui`</td>
...
<td>`mfar`</td>
<td>MFA Required</td>
<td>A user has been prompted for multi-factor authentication (MFA). When using Adaptive MFA, Auth0 includes details about the risk assessment. Available in only the <a href="/docs/ja-jp/get-started/authentication-and-authorization-flow/resource-owner-password-flow">Resource Owner Password Flow</a>.</td>
</tr>
<tr>
<td>`mgmt_api_read`</td>
