...
## config.jsonの例 {#example-configjson}
...
## tenant.yaml の例 {#example-tenantyaml}
...
## tenant.json の例 {#example-tenantjson}
...
### config.json の例 {#example-configjson-2}
...
### tenant.yaml の例 {#example-tenantyaml-2}
...
## エクスポート時にキーワードを保持する {#preserve-keywords-on-export}
