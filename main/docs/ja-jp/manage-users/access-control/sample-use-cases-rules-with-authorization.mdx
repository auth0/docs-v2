...
## 社内ネットワーク内からアクセスするユーザーにのみアクセスを許可する {#allow-access-only-to-users-who-are-inside-the-corporate-network}
...
## トークンにユーザーロールを追加する {#add-user-roles-to-tokens}
...
## Authorization Core 機能セットを使用して Delegated Administration Extension のロールを管理する {#manage-delegated-administration-extension-roles-using-the-authorization-core-feature-set}
