...
You can add permissions to [roles](/docs/manage-users/access-control/rbac) using the <Tooltip tip="Auth0 Dashboard: Auth0's main product to configure your services." cta="View Glossary" href="/docs/glossary?term=Auth0+Dashboard">Auth0 Dashboard</Tooltip> or the <Tooltip tip="Auth0 Dashboard: Auth0's main product to configure your services." cta="View Glossary" href="/docs/glossary?term=Management+API">Management API</Tooltip>. The roles and their permissions can be used with the API Authorization Core feature set.
...
* Roles are selected from pre-defined values. If your list of roles is blank, you need to [create a role](/docs/manage-users/access-control/configure-core-rbac/roles/create-roles).
* [Set up an API](/docs/get-started/auth0-overview/set-up-apis) in the Auth0 Dashboard.
