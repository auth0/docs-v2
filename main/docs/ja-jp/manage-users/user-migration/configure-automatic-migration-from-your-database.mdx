...
2. **［Custom Database（カスタムデータベース）］** ビューを選択し、**［Use my own database（独自のデータベースを使用する）］** を有効にします。
   ...
   <Frame>![Auth0 Dashboard 認証 データベース接続 カスタムデータベース設定 独自のデータベース使用有効](/docs/images/ja-jp/cdy7uua7fh8z/11HPAdVwJMmnWbzMVjHCJ8/e8a63cd05212da39164cab0114d1f89b/2025-02-27_17-26-24.png)</Frame>
...
<Frame>![Dashboard 認証 データベース接続 カスタムデータベースタブ データベースのアクションスクリプト](/docs/images/ja-jp/cdy7uua7fh8z/4LBIvvjaABo51It4eVCmX3/2783d88846c74a5766908fda8005783e/Database_Action_Scripts.png)</Frame>
