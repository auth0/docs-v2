...
## ユーザーのJSONスキーマ {#user-json-schema}
...
## ユーザーオブジェクトのプロパティ {#user-object-properties}
...
<ResponseField name="phone_number" type="string">
  ユーザーの電話番号です。`+12125550001` のように、国番号を含む E.164 形式である必要があります。
</ResponseField>
...
## ユーザーデータのJSON例 {#user-data-json-examples}
