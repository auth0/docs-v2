...
## M2Mアクセスを承認する {#authorize-m2m-access}
...
## M2M アクセスを取り消す {#revoke-m2m-access}
...
## M2M アクセスを監査する {#audit-m2m-access}
...
### 直接関連付けによって付与されたアクセス {#access-granted-via-direct-association}
...
### 任意の組織へのアクセスが許可された場合 {#access-granted-to-any-organization}
...
### 組織へのアクセスに基づくアプリケーションの検索 {#search-applications-based-on-organization-access}
