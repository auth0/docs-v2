...
## 組織の動作を定義する {#define-organization-behavior}
...
### 組織 の動作 の定義表 {#define-organization-behavior-table}
...
### アプリケーションの 組織 の動作 を定義する {#define-organization-behavior-for-an-application}
...
## デフォルトの組織を設定する {#set-default-organization}
...
### デフォルト組織設定表 {#set-default-organization-table}
...
### アプリケーションのデフォルト組織を設定する {#set-default-organization-for-an-application}
...
<Tabs>
  <Tab title="Auth0 Dashboard">
    ...
    <Frame>![Auth0 Dashboard > アプリケーション > Login Experience を選択](/docs/images/cdy7uua7fh8z/29rhTFMnYDp7TbGS9S6b5J/19241fae86a5fa01a90eeb364e96b0ca/2025-07-18_15-49-47.png)</Frame>
  </Tab>
