...
組織に接続を有効にするには、テナントにその接続がなくては**なりません** 。サポートされている接続には[データベース接続](/docs/ja-jp/authenticate/database-connections)、[ソーシャル接続](/docs/ja-jp/authenticate/identity-providers/social-identity-providers)や[エンタープライズ接続](/docs/ja-jp/authenticate/identity-providers/enterprise-identity-providers)が含まれます。
