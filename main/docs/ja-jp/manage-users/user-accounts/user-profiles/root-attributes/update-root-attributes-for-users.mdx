...
| --- | --- |
| `USER_ID` | 更新するユーザーのID。 |
| `MGMT_API_ACCESS_TOKEN` | `update:users`のスコープを持つ[Management APIのアクセストークン](/docs/ja-jp/api/management/v2/tokens)。 |
| `GIVEN_NAME_VALUE` | 更新するユーザーの名。 |
| `FAMILY_NAME_VALUE` | 更新するユーザーの姓。 |
| `NAME_VALUE` | 更新するユーザーのフルネーム。 |
| `NICKNAME_VALUE` | 更新するユーザーのニックネーム。 |
| `PICTURE_VALUE` | 更新するユーザーの写真のURL。 |
