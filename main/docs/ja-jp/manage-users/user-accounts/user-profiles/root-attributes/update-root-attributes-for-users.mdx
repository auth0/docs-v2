...
Auth0の[正規化ユーザープロファイル](/docs/ja-jp/manage-users/user-accounts/user-profiles/user-profile-structure)にはルート属性があり、更新することができます。更新できるルート属性は、使用している[接続](/docs/ja-jp/authenticate/identity-providers)の種類によって異なります。使用している接続の詳細については、「[ユーザープロファイルのルート属性を更新する](/docs/ja-jp/manage-users/user-accounts/user-profiles/root-attributes/update-root-attributes-for-users)」を参照してください。
