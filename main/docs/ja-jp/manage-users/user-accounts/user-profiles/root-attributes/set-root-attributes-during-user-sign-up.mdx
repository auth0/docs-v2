...
| 値                       | 説明                                                                                                                                  |
| ----------------------- | ----------------------------------------------------------------------------------------------------------------------------------- |
| `MGMT_API_ACCESS_TOKEN` | `create:users` の [スコープ](/docs/ja-jp/glossary?term=scope) を持つ [Management API のAccess Token](https://auth0.com/docs/api/management/v2/tokens)。 |
...
* [ユーザープロファイルの構成](/docs/ja-jp/manage-users/user-accounts/user-profiles/user-profile-structure)
* [ユーザーのルート属性を更新](/docs/ja-jp/manage-users/user-accounts/user-profiles/root-attributes/update-root-attributes-for-users)
* [ユーザーのインポート時にルート属性を設定](/docs/ja-jp/manage-users/user-accounts/user-profiles/root-attributes/set-root-attributes-during-user-import)