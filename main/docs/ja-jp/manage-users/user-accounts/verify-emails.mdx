...
<Frame>![](/docs/images/ja-jp/cdy7uua7fh8z/5SO4gvkdOOZEnPInXrIN1m/10f9cbd55c8749294cfe8e71f864cb83/Email_Config_-_Japanese.png)</Frame>
...
Microsoft Entra IDとADFSのエンタープライズ接続について、Auth0は一部のカスタムメール検証ワークフローに対応しています。これで、他のシステムからのユーザーが安全で正確な方法によってメール検証されていることを確認できます。詳細は、「[Microsoft Entra IDとADFSのメール検証](/docs/ja-jp/authenticate/identity-providers/enterprise-identity-providers/azuread-adfs-email-verification)」をお読みください。
...
Microsoft Entra IDとADFSのエンタープライズ接続について、Auth0は一部のカスタムメール検証ワークフローに対応しています。これで、他のシステムからのユーザーが安全で正確な方法によってメール検証されていることを確認できます。詳細については、「[Microsoft Entra IDとADFSのメール検証](/docs/ja-jp/authenticate/identity-providers/enterprise-identity-providers/azuread-adfs-email-verification)」をお読みください。
