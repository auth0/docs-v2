...
## アカウントをリンクするメリット {#advantages-of-linking-accounts}
...
### ユーザー主導のアカウントリンク {#user-initiated-account-linking}
...
### 推奨されるアカウントリンク {#suggested-account-linking}
