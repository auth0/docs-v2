---
description: Auth0 セッションを使用してユーザーの認証状態を管理する方法を学びます。 
sidebarTitle: 概要
title: セッション
---
...
## セッションのユースケース {#session-use-cases}
...
#### ユーザーがユーザー名とパスワードでログインする {#user-logs-in-with-username-and-password}
...
#### ユーザーがアイデンティティプロバイダーでログインする {#user-logs-in-with-identity-provider}
...
### SPA のセッション管理 {#session-management-for-spas}
