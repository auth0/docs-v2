---
description: Auth0 Management API を使用してユーザーセッションを管理し、アクティブなセッションの一覧表示、個別のセッションの取り消し、またはすべてのセッションの終了を行います。
...
## Management API エンドポイント {#management-api-endpoints}
...
## セッションのプロパティ {#session-properties}
...
## OIDC バックチャネルログアウトの開始元 {#oidc-back-channel-logout-initiators}
...
## セッションとリフレッシュトークン {#sessions-and-refresh-tokens}
