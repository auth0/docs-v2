---
description: Actions と Management API を使用して Auth0 セッションメタデータを設定する方法について説明します
...
### 既存のセッションメタデータを取得する {#retrieve-existing-session-metadata}
...
### 既存のセッションメタデータを追加または更新する {#add-or-update-existing-session-metadata}
...
### セッションメタデータを削除する {#delete-session-metadata}
...
### 既存のセッションメタデータを取得する {#retrieve-existing-session-metadata-2}
...
### 既存のメタデータを追加または更新する {#add-or-update-existing-metadata}
...
### セッションメタデータを削除する {#delete-session-metadata-2}
...
## OIDC バックチャネルログアウト {#oidc-back-channel-logout}
