...
HARファイルは、ログイントランザクション中に発生するリダイレクトのシーケンスを示しているため、認証の問題をデバッグするための優れたリソースとなります。[サポートリクエスト](%24%7Benv.DOMAIN_URL_SUPPORT%7D)にHARファイルを含めると、トラブルシューティングプロセスを迅速化できます。
