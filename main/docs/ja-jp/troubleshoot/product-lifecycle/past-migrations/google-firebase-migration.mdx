...
## Auth0のGuardian SDKs for iOS and Androidでは、Guardianの機能を搭載したカスタムモバイルアプリを作成し、プッシュ通知を使用して多要素認証（MFA）に安全にアクセスすることができます。
...
## GCMからFCMへの移行方法については、[Googleのドキュメント]()を参照してください。
