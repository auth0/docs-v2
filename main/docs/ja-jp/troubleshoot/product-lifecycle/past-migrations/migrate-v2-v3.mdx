...
## 影響を受けるExtensions {#impacted-extensions}
...
## テナントログを活用して User Search v2 の使用箇所を特定する {#leverage-your-tenant-logs-to-find-usage-of-user-search-v2}
