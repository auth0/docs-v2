...
| --- | --- | --- | --- |
| [Auth0 Java](https://github.com/auth0/auth0-java) | 1.8.0 | com.auth0.client.mgmt.UsersEntity.list | `UserFilter`に`withSearchEngine("v3")`を提供する |
| [Auth0 Python](https://github.com/auth0/auth0-python) | 3.0.0 | management.Users.list | `search_engine='v3'`パラメーターを提供する |
| [Auth0 Node](https://github.com/auth0/node-auth0) | 2.0.0 | UsersManager.getAll, ManagementClient.getUsers | `search_engine:'v3'`パラメーターを提供する |
| [Auth0 .NET](https://github.com/auth0/auth0.net) | 3.0.0または4.0.0 | Auth0.ManagementApi.IUsersClient.GetAllAsync | `GetUsersRequest`オブジェクトに`SearchEngine` = `"v3"`を提供する |
| [Auth0 PHP](https://github.com/auth0/auth0-php) | 5.2.0 | Auth0.SDK.API.Management.Users.getAll | `'search_engine' =&gt; 'v3'`パラメーターを提供する |
| [Auth0 Ruby](https://github.com/auth0/ruby-auth0) | 4.5.0 | Auth0.Api.V2.Users.users | `search_engine: 'v3'`パラメーターを提供する |
...
| 拡張機能 | v3対応バージョン | 考慮事項 |
| --- | --- | --- |
| [認可拡張機能](/docs/ja-jp/customize/extensions/authorization-extension/v2) | 2.5.0+ | 旧バージョンを使用している場合は、[拡張機能](https://manage.auth0.com/#/extensions)ページから拡張機能を手動で更新する必要があります。 |
| [委任管理](/docs/ja-jp/customize/extensions/delegated-admin/v3) | 3.1+ | 旧バージョンを使用している場合は、[拡張機能](https://manage.auth0.com/#/extensions)ページから拡張機能を手動で更新する必要があります。ユーザー検索v3のみが利用できるため、`SEARCH_ENGINE`構成設定は3.1にはもう存在しません。 |
