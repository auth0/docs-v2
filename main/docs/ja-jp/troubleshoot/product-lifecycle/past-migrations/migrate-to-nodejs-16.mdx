...
### Actions をアップグレードする {#upgrade-actions}
...
### ルールとフックをActionsに移行する {#migrate-rules-and-hooks-to-actions}
...
### Node 16 ランタイムを有効にする {#enable-node-16-runtime}
...
### 互換性のない変更 - ルールおよび Custom Database アクションスクリプトのみ {#breaking-changes-rules-and-custom-database-action-scripts-only}
