...
### アプリケーションで 検証不能なコールバック URI が使用されているか確認する {#review-whether-your-applications-are-using-non-verifiable-callback-uris}
...
### 新しいログイン確認プロンプトを事前に有効化する {#opt-in-to-new-login-confirmation-prompt}
...
### 新しいログイン確認プロンプトを使用しない {#opt-out-of-new-login-confirmation-prompt}
