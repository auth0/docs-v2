...
### 一般的な注意事項 {#general-considerations}
...
### Marketplaceとの連携 {#marketplace-integrations}

#### Social Connections の連携 {#social-connections-integrations}
...
### 新しいカスタム Actions を作成する {#create-new-custom-actions}
...
### 既存のカスタム Actions をアップグレードする {#upgrade-existing-custom-actions}
...
### その他の拡張製品では Node 22 を選択する {#choose-node-22-for-other-extensibility-products}
