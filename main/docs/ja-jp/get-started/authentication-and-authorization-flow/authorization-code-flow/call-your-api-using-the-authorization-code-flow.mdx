...
request.AddParameter("application/x-www-form-urlencoded", "grant_type=authorization_code&client_id={yourClientId}&client_secret={yourClientSecret}&code=yourAuthorizationCode}&redirect_uri={https://yourApp/callback}", ParameterType.RequestBody);
...
func main() {
	...
	payload := strings.NewReader("grant_type=authorization_code&client_id={yourClientId}&client_secret={yourClientSecret}&code=yourAuthorizationCode}&redirect_uri={https://yourApp/callback}")
...
HttpResponse response = Unirest.post("https://{yourDomain}/oauth/token")
  .header("content-type", "application/x-www-form-urlencoded")
  .body("grant_type=authorization_code&client_id={yourClientId}&client_secret={yourClientSecret}&code=yourAuthorizationCode}&redirect_uri={https://yourApp/callback}")
  .asString();
```
```javascript Node.JS
