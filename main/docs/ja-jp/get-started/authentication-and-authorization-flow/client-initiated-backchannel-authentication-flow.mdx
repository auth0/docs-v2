...
クライアントが開始するバックチャネル認証フローの使用方法について説明します。
...
<tbody>
<tr>
<td><a href="/user-authentication-with-ciba">CIBAでユーザーを認証する</a></td>
<td>クライアントが開始するバックチャネル認証（CIBA）フローでユーザーを認証する方法について説明します。</td>
</tr>
<tr>
