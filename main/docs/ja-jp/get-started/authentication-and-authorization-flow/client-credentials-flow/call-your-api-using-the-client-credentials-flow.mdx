...
サンプルの実装については、[サーバークライアント + API](/docs/ja-jp/get-started/architecture-scenarios/server-application-api)アーキテクチャのシナリオを参照してください。この一連のチュートリアルには、付録に[GitHubで提供されているコードのサンプル](https://github.com/auth0-samples/auth0-pnp-exampleco-timesheets)があります。
