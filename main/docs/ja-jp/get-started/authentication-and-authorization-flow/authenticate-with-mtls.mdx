---
description: 共有のクライアントシークレットを X.509 証明書に置き換え、必要に応じてアクセストークンをクライアントにバインドすることで、相互 TLS（mTLS）が OAuth フローを保護する仕組みを学びます。
title: Authenticate with mTLS
---

## OAuth/OIDC における mTLS {#mtls-in-oauthoidc}
...
## 認可サーバーを呼び出す {#call-the-authorization-server}
...
## リソースサーバーを呼び出す {#call-the-resource-server}
