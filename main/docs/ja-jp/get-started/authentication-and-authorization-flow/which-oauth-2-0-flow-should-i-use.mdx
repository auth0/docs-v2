---
description: サーバーサイドのWebアプリやSPAから、マシンツーマシンおよびデバイスフローまで、アプリケーションの種類に適したOAuth 2.0フローを見極める方法を学びます。
...
## OAuth 2.0の用語 {#oauth-20-terminology}
...
## クライアントはリソース所有者ですか？ {#is-the-client-the-resource-owner}
...
## クライアントはサーバー上で動作するウェブアプリですか？ {#is-the-client-a-web-app-executing-on-the-server}
...
## ユーザーの資格情報を託せるほど、クライアントは完全に信頼できますか？ {#is-the-client-absolutely-trusted-with-user-credentials}
...
## クライアントはシングルページアプリですか？ {#is-the-client-a-single-page-app}
...
## クライアントはネイティブ／モバイルアプリですか？ {#is-the-client-a-nativemobile-app}
...
## 異なるリソースサーバーと通信する必要があるアプリケーションがある場合 {#i-have-an-application-that-needs-to-talk-to-different-resource-servers}
...
## アプリケーションを実装する前にエンドポイントを試すことはできますか？ {#can-i-try-the-endpoints-before-i-implement-my-application}
...
## クライアントアプリケーションは、ブラウザーを使った操作なしでユーザーに認証を求める必要がありますか？ {#does-the-client-application-need-to-challenge-users-for-authentication-without-browser-interaction}
