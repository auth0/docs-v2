...
<Frame>![](/docs/images/ja-jp/cdy7uua7fh8z/2i8E4sBBWhQueL4NTt9gz4/a05084a6fd6d39b017572e93c2c9c7b9/Screenshot_2025-06-02_at_1.20.07_PM.png)</Frame>
...
<Frame>![](/docs/images/ja-jp/cdy7uua7fh8z/21qtk4F1cOQHMpbXxXYu75/51ba9c5fd1457ffee3f73893acf3c97f/Screenshot_2025-01-13_at_4.13.44_PM.png)</Frame>
...
| `authorization_details` | An optional JSON array of objects that describes the permissions to be authorized. You should register each object’s `type` value on the resource server using the resource server’s `authorization_details` parameter. To learn more, read [Configure Rich Authorization Requests](/docs/ja-jp/get-started/apis/configure-rich-authorization-requests). |
