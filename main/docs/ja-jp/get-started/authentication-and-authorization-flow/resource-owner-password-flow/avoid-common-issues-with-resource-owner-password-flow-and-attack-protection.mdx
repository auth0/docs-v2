...
## 攻撃対策とサーバーサイド API {#attack-protection-and-server-side-apis}
...
## IP アドレスを信頼するようにアプリケーションを設定する {#configure-your-application-to-trust-the-ip-address}
...
## サーバーからユーザーの IP アドレスを送信する {#send-the-users-ip-address-from-your-server}
...
## 漏えいパスワードの検知のレスポンスを処理する {#handle-breached-password-detection-responses}
