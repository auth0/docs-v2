...
1. Go to [Dashboard > Applications > APIs](https://manage.auth0.com/#/apis) and click the nickname of the API to view.
...
2. Go to the **Permissions** tab and enter a permission nickname and description for the permission you want to add. Be sure not to use any reserved permission names (see 次のアクセス許可名は予約されており、カスタムAPI許可として設定することはできません。 section).
...
* offline_access
* 電話
* <Tooltip tip="OpenID: Open standard for authentication that allows applications to verify users' nickname without collecting and storing login information." cta="View Glossary" href="/docs/glossary?term=openid">openid</Tooltip>
* picture
* profile
* profile
