...
## アプリケーションで接続を有効にする {#enable-a-connection-for-your-application}
...
## テストユーザーを作成する {#create-a-test-user}
...
## Auth0 で論理 API を登録する {#register-a-logical-api-in-auth0}
...
## 論理 API の権限を設定する {#configure-permissions-for-the-logical-api}
...
## 論理 API へのアクセスを付与する {#grant-access-to-the-logical-api}
...
### シングルログアウト (SLO) またはシングルサインオン (SSO) を実装する {#implement-single-logout-slo-or-single-sign-on-sso}
