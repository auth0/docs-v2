...
| --- | --- | --- |
| `allow_all` | When configured for an API, any application in your tenant can get an access token to the API. No specific grant is required. | The default for user-delegated access flows when you create an API. You can only configure allow_all for user-delegated access flows. |
