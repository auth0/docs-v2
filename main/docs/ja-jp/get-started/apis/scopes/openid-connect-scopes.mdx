...
<tr>
<td>`openid`</td>
<td>（必須）ユーザーを一意に識別する`sub`クレームを返します。IDトークンでは、`iss`、`aud`、`exp`、`iat`、`at_hash`の各クレームも表示されます。IDトークンクレームの詳細については、「<a href="/docs/ja-jp/secure/tokens/id-tokens/id-token-structure">IDトークンの構造</a>」をお読みください。</td>
</tr>
<tr>
<td>`profile`</td>
