...
[Management API v2](/docs/ja-jp/api/management/v2)を使用すると、テナント間でアセット（[ルール](/docs/ja-jp/customize/rules)やデータベース[接続](/docs/ja-jp/authenticate/identity-providers)など）の移行を自動化することができます。
