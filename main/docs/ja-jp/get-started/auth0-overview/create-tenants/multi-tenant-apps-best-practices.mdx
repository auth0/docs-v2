...
* 異なる接続からのユーザープールがある場合。たとえば、あるテナントがユーザーにユーザー名/パスワード資格情報の提供を要求し、別のテナントがユーザーにエンタープライズ<Tooltip data-tooltip-id="react-containers-DefinitionTooltip-2" href="/docs/ja-JP/glossary?term=idp" tip="IDプロバイダー（IdP）: デジタルIDを保存および管理するサービス。" cta="用語集の表示">IdP</Tooltip>経由でのログインを要求する場合があります。
