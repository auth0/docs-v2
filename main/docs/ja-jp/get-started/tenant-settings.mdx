...
<Frame>![undefined](/docs/images/ja-JP/cdy7uua7fh8z/27OH1jFXce97CSjk7TPeD7/1ee7cb22d4b19c9b10630c12ff4abcf5/Tenant_environment_tags.png)</Frame>

### APIの認可設定

<Frame>![Dashboard テナント設定 一般 API認可設定](/docs/images/ja-JP/cdy7uua7fh8z/17yNCRrB6dWcHp6zLFb74j/3f0339ea406b5c6b21a77457fd095525/Tenant_Setting_-_API_Authorization_Settings.png)</Frame>
...
<Frame>![Dashboard - テナントの設定 - 一般 - エラーページ](/docs/images/ja-JP/cdy7uua7fh8z/kteu7boTA7G67HZXHFYOF/b4162fe85e90c71e66e1eec2d421c506/Error_Pages_-_JP.png)</Frame>

### 言語

<Frame>![Dashboard - テナントの設定 - 一般タブ - 言語](/docs/images/ja-JP/cdy7uua7fh8z/2G20DUg0pvS4HEChCe3oM8/f94477478cc6a10733bfa8a067627c3f/Tenant_Settings_-_General_-_Languages_-_Japanese.png)</Frame>
...
<Frame>![Dashboard - テナントの設定 - テナントメンバータブ](/docs/images/ja-JP/cdy7uua7fh8z/3206A7slUJ1cwOjHM3o3Om/e4dafc2a852780cabf607c08ce59305a/Tenant_Settings_-_Tenant_Members_tab.png)</Frame>
...
<Frame>![Dashboard - テナントの設定 - カスタムドメインタブ](/docs/images/ja-JP/cdy7uua7fh8z/5RFqn9GqGZ0e9RCbHzvVIk/19a342668cf57f8ca8d7129e201c93a9/Tenant_Settings_-_Custom_Domains.png)</Frame>
...
<Frame>![Dashboard テナントの設定 高度な設定タブ ログインとログアウト](/docs/images/ja-JP/cdy7uua7fh8z/6hp2kPZBWMNB3al6p7gKWa/fd6b60296965bdfd3fb5f7fe591e7b53/Tenant_Settings_-_Advanced_-_Login_URLs.png)</Frame>
...
<Frame>![Dashboard テナントの設定 高度な設定タブ デバイスフローのユーザーコード形式](/docs/images/ja-JP/cdy7uua7fh8z/5bz66ACqxQh00GCuTLUbkT/42b9b0a973961355cecc72f3dba6bada/Tenant_Settings_-_Advanced_-_Device_Flow_User_Code_Format.png)</Frame>
...
<Frame>![Dashboard テナント設定 詳細設定タブ グローバルクライアント情報](/docs/images/ja-JP/cdy7uua7fh8z/1ILkvoM7wZx7OE1Ak8Fn8W/b5a4c156c277b9420f2fda2d37795a6b/Tenant_Settings_-_Global_Client_Information.png)</Frame>

### 設定（詳細）

<Frame>![Dashboard - テナントの設定 - 高度な設定タブ - 設定](/docs/images/ja-JP/cdy7uua7fh8z/5O4QX2T4anl9eqHEZLPM2o/e216463c0a867e7feb4cdb5cf1b3f7a5/Tenant_Settings_-_Advanced_-_Settings.png)</Frame>
...
<Frame>![Dashboard - テナントの設定 - 高度な設定タブ - 拡張性](/docs/images/ja-JP/cdy7uua7fh8z/3RVLXoBWLAuJkptdP60U2Y/c9745158c8488d8be84ecc92eea0d4eb/Tenant_Settings_-_Extensibility_-_Japanese.png)</Frame>
