...
## アイデンティティおよびアクセス管理 (IAM) とは？ {#what-is-identity-and-access-management-iam}
...
## 認証と認可の違い {#the-difference-between-authentication-and-authorization}
...
## IAM は何をするのですか？ {#what-does-iam-do}
...
## IAMはどのように機能するのでしょうか？ {#how-does-iam-work}
...
### アイデンティティプロバイダー {#identity-providers}
...
### 認証および認可の標準規格 {#authentication-and-authorization-standards}
...
## なぜIAMプラットフォームを利用するのですか？ {#why-use-an-iam-platform}
