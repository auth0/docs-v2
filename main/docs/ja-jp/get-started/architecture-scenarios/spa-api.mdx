...
* SPAとAPIはAuth0 Dashboardで設定する必要があります（[「Auth0の構成」](/docs/ja-jp/get-started/architecture-scenarios/spa-api/part-2#auth0-configuration)を参照）
* ユーザーの権限は、認可拡張機能を使用して強制することができます（[「認可拡張機能を構成する」](/docs/ja-jp/get-started/architecture-scenarios/spa-api/part-2#configure-the-authorization-extension)を参照）
