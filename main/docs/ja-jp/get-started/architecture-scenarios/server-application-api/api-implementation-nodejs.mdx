...
## ステップ 1. API エンドポイントを定義する {#step-1-define-the-api-endpoint}
...
### エンドポイントを実装する {#implement-the-endpoint}
...
## ステップ2. APIエンドポイントを保護する {#step-2-secure-the-api-endpoint}
...
## ステップ 3. クライアントの権限を確認する {#step-3-check-the-client-permissions}
