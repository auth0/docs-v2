...
### APIエンドポイントを保護する {#secure-the-api-endpoints}
...
## アプリケーションの権限を確認する {#check-the-application-permissions}
...
### Machine-to-Machine Application を実装する {#implement-the-machine-to-machine-application}

このセクションでは、このシナリオ向けに Machine-to-Machine Application を実装する方法を見ていきます。

### アクセストークンを取得する {#get-an-access-token-2}
