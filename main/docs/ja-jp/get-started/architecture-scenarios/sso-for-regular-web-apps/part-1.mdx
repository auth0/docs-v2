...
## どのプロトコルを使うか {#which-protocol-to-use}
...
<Info>
  ### OAuth と OpenID Connect (OIDC) の違い {#oauth-vs-openid-connect-oidc}
...
### ID Token を検証する方法 {#how-to-validate-an-id-token}
