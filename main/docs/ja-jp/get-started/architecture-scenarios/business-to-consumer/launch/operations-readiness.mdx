---
title: Business-to-Consumerの運用準備
sidebarTitle: 運用準備
...
## LoadBalancer のタイムアウトを確認 {#loadbalancer-timeouts-checked}
...
## ロードバランサーの設定 {#loadbalancer-configuration}
...
* フックで変数を使用する場合は、エディターで[シークレット](/docs/ja-jp/customize/hooks/hook-secrets)を設定する方法を参照してください
...
## 証明書のロールオーバー計画 {#certificate-rollover-plan}
