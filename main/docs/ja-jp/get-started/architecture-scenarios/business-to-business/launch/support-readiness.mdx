---
description: お客様の本番稼働前に必要な運用ポリシーを確認し、Auth0 B2B のローンチに向けてサポートチームを準備します。
title: サポート体制の準備（B2B）
---

## Auth0ポリシーを確認する {#review-auth0-policies}
...
## Support plan、SLA、重大度の定義、およびSupport Centerのドキュメントを確認する {#review-your-support-plan-slas-severity-definitions-and-support-center-documentation}
...
## トラブルシューティングツールを用意しておく {#have-troubleshooting-tools-ready}
...
### HARファイルをキャプチャする {#capture-har-file}
...
### SAML リクエスト/レスポンスを表示する {#view-saml-requestresponse}
...
## Auth0 サポートマトリックスを確認する {#review-auth0-support-matrix}
