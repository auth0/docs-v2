...
## スコープを設定する {#configure-the-scopes}
...
## Authorization Extension を設定する {#configure-the-authorization-extension}
...
### ユーザーをロールに割り当てる {#assign-users-to-roles}
...
### Authorization Extension の設定 {#configuring-the-authorization-extension}
...
### トークンのスコープを検証する Rule を作成する {#create-a-rule-to-validate-token-scopes}
