...
```
   ...
   | 値 | 説明 |
   | --- | --- |
   | `YOUR_KEY_ID` | 取り消す署名鍵のID。署名鍵IDを見つける方法については、「[JSON Web鍵セットを見つける](https://auth0.com/docs/ja-jp/tokens/guides/locate-jwks)」を参照してください。 |
   | `MGMT_API_ACCESS_TOKEN` | スコープ`update:signing_keys`を持つ[Management APIのアクセストークン](https://auth0.com/docs/ja-jp/api/management/v2/tokens)。 |
