...
| 値 | 説明 |
| --- | --- |
| `MGMT_API_ACCESS_TOKEN` | `read:signing_keys`スコープのある[Management APIのアクセストークン](https://auth0.com/docs/ja-jp/api/management/v2/tokens)。 |
...
| 値 | 説明 |
| --- | --- |
| `YOUR_KEY_ID` | 表示する署名鍵のID。署名鍵IDを見つける方法については、「[JSON Web鍵セットを見つける](https://auth0.com/docs/ja-jp/tokens/guides/locate-jwks)」を参照してください。 |
| `MGMT_API_ACCESS_TOKEN` | スコープ`read:signing_keys`を持つ[Management APIのアクセストークン](https://auth0.com/docs/ja-jp/api/management/v2/tokens)。 |
