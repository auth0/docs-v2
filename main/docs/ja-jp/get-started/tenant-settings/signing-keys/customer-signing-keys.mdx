---
title: お客様提供の公開署名鍵
description: Auth0 によって生成された鍵ではなく、お客様が管理する鍵でトークンに署名できるよう、独自の公開署名鍵を Auth0 テナントにインポートします。
---
...
## Management API でカスタムキーを設定する {#configure-your-custom-keys-with-management-api}
