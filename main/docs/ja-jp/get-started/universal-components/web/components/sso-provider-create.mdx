...
## サードパーティアプリケーションによるアクセスとCross App Access {#third-party-application-access-and-cross-app-access}
...
## インストール {#installation-3}
    ...
    <Accordion title="レガシー Vercel registry (非推奨)">
