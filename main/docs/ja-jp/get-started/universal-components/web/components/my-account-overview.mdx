...
### My Account API を有効化する {#enable-my-account-api}

    1. [**Auth0 Dashboard &gt; アプリケーション &gt; APIs**](https://manage.auth0.com/#/apis) に移動します。
    2. **Activate My Account API** を選択して、テナントで有効化します。

### アプリケーションを作成し、My Account API の権限を設定する {#create-the-application-and-configure-my-account-api-permissions}
...
## アプリケーションを設定する {#configure-your-application}

### コンポーネントをインストールする {#install-the-component}
...
### Universal Components を設定する {#configure-universal-components}
...
### My Account API を有効化する {#enable-my-account-api-2}

    1. [**Dashboard &gt; Applications &gt; APIs**](https://manage.auth0.com/#/apis) に移動します。
    2. **Activate My Account API** を選択して、テナントで有効化します。

### アプリケーションを作成し、My Account API の権限を設定する {#create-the-application-and-configure-my-account-api-permissions-2}
...
### データベースとテストユーザーを設定する {#set-up-the-database-and-test-user}
...
## アプリケーションを設定する {#configure-your-application-2}

### コンポーネントをインストールする {#install-the-component-2}
...
### Universal Components を設定する {#configure-universal-components-2}
  ...
  <Tab title="shadcn">
## 前提条件 {#prerequisites-3}

### My Account API を有効化する {#enable-my-account-api-3}

    1. [**Dashboard &gt; Applications &gt; APIs**](https://manage.auth0.com/#/apis) に移動します。
    2. **Activate My Account API** を選択して、テナントで有効化します。

### アプリケーションを作成し、My Account API の権限を設定する {#create-the-application-and-configure-my-account-api-permissions-3}
...
### データベース接続とテストユーザーを設定する {#set-up-the-database-and-test-user-2}
...
## アプリケーションを設定する {#configure-your-application-3}

### コンポーネントをインストールする {#install-the-component-3}
    ...
    <Accordion title="レガシー Vercel registry（廃止）">
      既存の利用者は、**2026年9月17日**までVercelホストのパスを引き続き使用できます。
      ...
      新しいプロジェクトでは、上記のGitHub Registryパスを使用してください。
    </Accordion>
...
### Universal Components を設定する {#configure-universal-components-3}
