...
<Tabs>
  ...
  <Tab title="Next.js（RWA）">
    <div id="prerequisites-2">
      ## 前提条件
    </div>

    <div id="enable-my-account-api-2">
      ### My Account API を有効化する
    </div>
    ...
    <div id="create-the-application-and-configure-my-account-api-permissions-2">
      ### アプリケーションを作成し、My Account API の権限を設定する
    </div>
    ...
    <div id="set-up-the-database-and-test-user">
      ### データベースとテストユーザーを設定する
    </div>
  ...
  <Tab title="shadcn">
    <div id="prerequisites-3">
      ## 前提条件
    </div>

    <div id="enable-my-account-api-3">
      ### My Account API を有効化する
    </div>
    ...
    <div id="create-the-application-and-configure-my-account-api-permissions-3">
      ### アプリケーションを作成し、My Account API の権限を設定する
    </div>
    ...
    <div id="set-up-the-database-and-test-user-2">
    ...
    <div id="install-the-component-3">
      ### コンポーネントをインストールする
    </div>
