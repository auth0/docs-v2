...
## コンポーネントごとのオーバーライド {#override-per-component}
...
## よくあるカスタマイズ {#common-customizations}
...
### コンパクトなタイポグラフィ {#compact-typography}
...
## テーマプリセット {#theme-presets-tailwind}
...
## JS API によるオーバーライド {#js-api-tailwind}
...
## コンポーネントごとのオーバーライド {#override-per-component-tailwind}
...
## よくあるカスタマイズ {#common-customizations-tailwind}

### ブランドカラー {#brand-color-tailwind}
...
### コンパクトなタイポグラフィ {#compact-typography-tailwind}
