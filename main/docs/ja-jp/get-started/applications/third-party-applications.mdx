...
## サポート対象のクライアントタイプ {#supported-client-types}
...
## サポート対象のグラントタイプ {#supported-grant-types}
...
### 手順 1: アプリケーションを作成する {#step-1-create-the-application}
...
### ステップ 2: API Access を設定する {#step-2-configure-api-access}
...
### ステップ 3: 接続を設定する {#step-3-configure-connections}
...
### ステップ 4: ユーザーが同意する {#step-4-users-provide-consent}
...
### ステップ 5 (任意) ：Organizations で有効化 {#step-5-optional-enable-for-organizations}
