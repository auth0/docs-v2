---
description: 各アプリケーションの種類について、Auth0 がサポートする OAuth 2.0 グラントタイプと、認証フローに合わせて設定する方法を説明します。
...
## 利用できるグラントタイプ {#available-grant-types}

### 仕様準拠のグラント {#specification-conforming-grants}
...
### Auth0 拡張グラント {#auth0-extension-grants}
...
### Auth0 レガシーグラント {#auth0-legacy-grants}
...
### パブリックアプリケーション {#public-applications}
...
### 機密アプリケーション {#confidential-applications}
...
### 信頼できるファーストパーティアプリケーション {#trusted-first-party-applications}
...
## サードパーティアプリケーションの制限事項 {#third-party-application-restrictions}
