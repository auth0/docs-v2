...
Sender constraining is an <Tooltip cta="View Glossary" href="/docs/glossary?term=OAuth+2.0" tip="">OAuth 2.0</Tooltip> and <Tooltip cta="View Glossary" href="/docs/glossary?term=OpenID" tip="">OpenID</Tooltip> Connect (OIDC) security mechanism that cryptographically binds access and <Tooltip cta="View Glossary" href="/docs/glossary?term=refresh+tokens" tip="">refresh tokens</Tooltip> to the application that requested them, preventing token theft and misuse.

Traditionally, OAuth 2.0 <Tooltip cta="View Glossary" href="/docs/glossary?term=access+tokens" tip="">access tokens</Tooltip> are bearer tokens, which means whoever “bears” or possesses the token can use it. If a bearer token is stolen or leaked, an attacker can present it to a <Tooltip cta="View Glossary" href="/docs/glossary?term=resource+server" tip="">resource server</Tooltip> (API) and gain unauthorized access by impersonating the legitimate client application or user.
