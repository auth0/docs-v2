...
NSMutableURLRequest *request = [NSMutableURLRequest requestWithURL:[NSURL URLWithString:@"https://{yourDomain}/api/v2/clients/{yourClientId}/rotate-secret"]
...
conn.request("POST", "/{yourDomain}/api/v2/clients/{yourClientId}/rotate-secret", headers=headers)
...
require 'net/http'
require 'openssl'
url = URI("https://{yourDomain}/api/v2/clients/{yourClientId}/rotate-secret")
...
let request = NSMutableURLRequest(url: NSURL(string: "https://{yourDomain}/api/v2/clients/{yourClientId}/rotate-secret")! as URL,
