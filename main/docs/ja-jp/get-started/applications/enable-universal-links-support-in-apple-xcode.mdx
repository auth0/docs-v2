...
## Apple Team ID と Bundle Identifier を確認する {#obtain-apple-team-id-and-bundle-identifier}
...
## Apple Team IDとBundle IdentifierをAuth0に設定する {#provide-apple-team-id-and-bundle-identifier-to-auth0}
