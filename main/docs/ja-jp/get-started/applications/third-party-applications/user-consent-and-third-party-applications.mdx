...
## 拒否されたアクセス許可への対応 {#handle-rejected-permissions}
...
## ファーストパーティアプリケーションの同意をスキップする {#skip-consent-for-first-party-applications}
...
## Organizations における同意 {#consent-with-organizations}
...
<Frame>![Acme 組織の同意ダイアログ — ユーザーの Acme アカウントへのアクセスをリクエストするサードパーティアプリケーション](/docs/images/third-party-applications/org-scoped-consent-acme.png)</Frame>
...
<Frame>![Contoso 組織の同意ダイアログ — 同じユーザーでも別の組織では再度同意が必要](/docs/images/third-party-applications/org-scoped-consent-contoso.png)</Frame>
...
## パスワードベースのフロー {#password-based-flows}
