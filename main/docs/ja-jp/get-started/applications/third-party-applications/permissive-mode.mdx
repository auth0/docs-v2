...
## 許容モード とは {#what-permissive-mode-means}
...
## `third_party_security_mode` プロパティ {#the-third_party_security_mode-property}
...
## 許容モード での Dynamic Client Registration {#dynamic-client-registration-in-permissive-mode}
...
## 強化されたセキュリティ制御を導入する {#adopt-enhanced-security-controls}
