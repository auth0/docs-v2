...
## URL 評価の仕組み {#how-url-evaluation-works}
...
## ワイルドカード URL プレースホルダー {#wildcard-url-placeholders}
...
## 組織URLのプレースホルダー {#organization-url-placeholders}

### 組織名プレースホルダー {#organization-name-placeholder}
...
### 組織メタデータのプレースホルダー {#organization-metadata-placeholder}
...
## カスタムドメイン URL のプレースホルダー {#custom-domain-url-placeholders}
...
### 組織プレースホルダーと併用する {#using-with-organization-placeholders}
