---
description: mTLS ハンドシェイクを実行し、クライアント証明書を検証して、トークン発行のためにリクエストを Auth0 に転送するようエッジネットワークを設定します。
...
## クライアント証明書を検証する {#verify-the-client-certificate}
...
### CA署名付き証明書 {#ca-signed-certificates}
...
## リクエストを転送する {#forward-the-request}
