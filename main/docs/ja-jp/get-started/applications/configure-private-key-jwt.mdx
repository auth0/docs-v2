...
<Tabs>
  <Tab title="Auth0 Dashboard">
    ...
    <div id="configure-a-new-application-for-private_key_jwt">
    ...
    <div id="configure-an-existing-application">
      #### 既存のアプリケーションを設定する
    </div>
    ...
    <div id="configure-an-application-to-use-client-secret-authentication">
    ...
    <div id="update-credential-expiration">
      #### 資格情報の有効期限を更新する
    </div>
  ...
  <Tab title="Management API">
    <div id="configure-a-new-application-for-private_key_jwt-2">
      #### `private_key_jwt` 用の新しいアプリケーションを設定する
    </div>
    ...
    <div id="configure-an-existing-application-2">
      #### 既存のアプリケーションを設定する
    </div>
    ...
    <div id="associate-the-credential">
      ##### 認証情報を関連付ける
    </div>
    ...
    <div id="configure-an-application-to-use-client-secret-authentication-2">
      #### Client Secret 認証を使用するようにアプリケーションを設定する
    </div>
    ...
    **例**
    ...
    <div id="patch-credentials-with-an-expiration-field">
      #### 有効期限フィールドで資格情報をパッチする
    </div>
