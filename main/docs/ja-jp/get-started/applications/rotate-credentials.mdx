---
description: 移行期間中に 2 つのアクティブなキーを維持することで、ダウンタイムをゼロにしてアプリケーションの Private Key JWT 資格情報をローテーションします。
title: 資格情報のローテーション
---
...
<Tabs>
  ...
  <Tab title="Management API を使用">
    ...
    4. Auth0 Authentication API 向けのアサーションに新しい秘密キーで署名するよう、アプリケーションを更新します。
