---
title: 'Authentication API を使用する'
description: Auth0-PHP SDK の Authentication クラスを使用して、認可コード、Client Credentials、logout フローで Auth0 の Authentication API に直接アクセスします。
...
## シングルサインオンのログアウト {#single-sign-on-logout}
