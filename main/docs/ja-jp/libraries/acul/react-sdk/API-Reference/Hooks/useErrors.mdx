...
<ParamField body="useErrors(options?: UseErrorOptions)" type={<span><a href="/docs/ja-jp/libraries/acul/react-sdk/API-Reference/Types/interfaces/UseErrorsResult">UseErrorsResult</a></span>}>
  ...
  * **dismiss の制御** — 個別のエラーを削除したり、すべてをまとめてクリアしたりできます。
  ...
  <ParamField body="options" type={<span><a href="/docs/ja-jp/libraries/acul/react-sdk/API-Reference/Types/interfaces/UseErrorOptions">UseErrorOptions</a></span>}>
    フックの任意の設定です。
  ...
  以下を含む [`UseErrorsResult`](/docs/ja-jp/libraries/acul/react-sdk/API-Reference/Types/interfaces/UseErrorsResult) オブジェクト:

  * `errors` — 型 [`ErrorsResult`](/docs/ja-jp/libraries/acul/react-sdk/API-Reference/Types/interfaces/ErrorsResult) の完全なエラー一覧。次のヘルパーが含まれます。
