...
<ParamField body="data" type={<span><a href="/docs/ja-jp/libraries/acul/react-sdk/API-Reference/Types/interfaces/PhonePrefix">PhonePrefix</a></span>}>
  <div id="type-declaration">
    #### 型宣言
  </div>

  &#123; `phone_prefixes`: [`PhonePrefix`](/docs/ja-jp/libraries/acul/react-sdk/API-Reference/Types/interfaces/PhonePrefix)[]; &#125;
