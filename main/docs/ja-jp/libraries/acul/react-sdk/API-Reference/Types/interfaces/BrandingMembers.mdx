...
## ブランディングSettings {#brandingsettings}
...
<ParamField body="default" type="object">
  <Expandable title="プロパティ">
    ...
    <ParamField body="identifiers?" type={<span><a href="/docs/ja-jp/libraries/acul/react-sdk/API-Reference/Types/interfaces/ThemeIdentifiers">ThemeIdentifiers</a></span>} />
