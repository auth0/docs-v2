...
<ParamField body="useScreen" type={<span>() =&gt; <a href="/docs/ja-jp/libraries/acul/react-sdk/API-Reference/Types/interfaces/ScreenMembersOnOrganizationSelection">ScreenMembersOnOrganizationSelection</a></span>}>
...
<ParamField body="useOrganizationSelection" type={<a href="/docs/ja-jp/libraries/acul/react-sdk/API-Reference/Types/interfaces/OrganizationSelectionMembers">OrganizationSelectionMembers</a>}>
  ...
  **メソッドのパラメーター**
  ...
  <Expandable title="パラメーター">
    <ParamField body="options">
      [ContinueWithOrganizationNameOptions](/docs/ja-jp/libraries/acul/react-sdk/API-Reference/Types/interfaces/ContinueWithOrganizationNameOptions)。
    </ParamField>
...
<ParamField body="skipOrganizationSelection" type="Promise<void>">
  このメソッドはOrganizationの選択をスキップし、ユーザーの個人アカウントで続行します。
