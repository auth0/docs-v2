...
`reset-password-mfa-webauthn-roaming-challenge` 画面は、ローミングセキュリティキーによる多要素認証が必要な場合に、パスワードリセットフロー中に表示されます。リセット処理を続行するために、外部ハードウェアのセキュリティキーを使って認証するようユーザーに求めます。
...
各画面には、それぞれ固有のフックとメソッドがあります。SDK は、各画面で **partial import** と **root import** の両方をサポートしています。

* partial import を使用すると、特定のユースケースに必要なコードだけを取り込めます。
* root import を使用すると、単一のバンドルからすべての画面を読み込めます。これは、想定されるすべての画面に対応する統一されたビルドが必要な場合に便利です。
...
`reset-password-mfa-webauthn-roaming-challenge` 画面で Auth0 のコンテキストデータに読み取り専用でアクセスできる、画面スコープのフックです。`@auth0/auth0-acul-react/reset-password-mfa-webauthn-roaming-challenge` からインポートします。
...
<ParamField body="useClient" type={<span>() =&gt; <a href="/docs/ja-jp/libraries/acul/react-sdk/API-Reference/Types/interfaces/ClientMembers">ClientMembers</a></span>}>
  このフックは、`reset-password-mfa-webauthn-roaming-challenge` 画面の `id`、`name`、`logoUrl` など、クライアントに関する設定を提供します。
...
<ParamField body="useScreen" type={<span>() =&gt; <a href="/docs/ja-jp/libraries/acul/react-sdk/API-Reference/Types/interfaces/ScreenMembersOnResetPasswordMfaWebAuthnRoamingChallenge">ScreenMembersOnResetPasswordMfaWebAuthnRoamingChallenge</a></span>}>
  このフックには、設定やコンテキストなど、`reset-password-mfa-webauthn-roaming-challenge` 画面に固有の詳細が含まれています。
...
<ParamField body="useTransaction" type={<span>() =&gt; <a href="/docs/ja-jp/libraries/acul/react-sdk/API-Reference/Types/interfaces/TransactionMembers">TransactionMembers</a></span>}>
  このフックは、アクティブな接続や現在のフロー状態など、`reset-password-mfa-webauthn-roaming-challenge` 画面に固有のトランザクションデータを提供します。
...
<ParamField body="useUntrustedData" type={<span>() =&gt; <a href="/docs/ja-jp/libraries/acul/react-sdk/API-Reference/Types/interfaces/UntrustedDataMembers">UntrustedDataMembers</a></span>}>
  このフックは、URLパラメーターから渡される事前入力済みのメールアドレスやユーザー名など、画面に渡された信頼できないデータを扱います。
...
<ParamField body="useResetPasswordMfaWebAuthnRoamingChallenge" type={<a href="/docs/ja-jp/libraries/acul/react-sdk/API-Reference/Types/interfaces/ResetPasswordMfaWebAuthnRoamingChallengeMembers">ResetPasswordMfaWebAuthnRoamingChallengeMembers</a>}>
  このフックは、`reset-password-mfa-webauthn-roaming-challenge` 画面で利用できるすべてのメソッドとコンテキストを返します。
</ParamField>

## メソッド {#methods}

<ParamField body="showError" type="Promise<void>">
  このメソッドは、ユーザーのデバイスでセキュリティキーのチャレンジが失敗した場合に、WebAuthn のブラウザーエラーを Auth0 に報告します。
  ...
  **メソッドのパラメーター**
  ...
  <Expandable title="パラメーター">
    <ParamField body="options">
      [ResetPasswordMfaWebAuthnRoamingChallengeShowErrorOptions](/docs/ja-jp/libraries/acul/react-sdk/API-Reference/Types/interfaces/ResetPasswordMfaWebAuthnRoamingChallengeShowErrorOptions).
    </ParamField>

    <ParamField body="rememberDevice?" type="boolean">
      `true` で、かつ `screen.showRememberDevice` も `true` の場合、現在のブラウザーから今後ログインする際は MFA をスキップします。
    </ParamField>

    <ParamField body="error" type={<span><a href="/docs/ja-jp/libraries/acul/react-sdk/API-Reference/Types/interfaces/WebAuthnErrorDetails">WebAuthnErrorDetails</a></span>} required>
...
<ParamField body="tryAnotherMethod" type="Promise<void>">
  このメソッドは、ユーザーが別の MFA方式 を選択する画面に移動します。
  ...
  **メソッドのパラメーター**
  ...
  <Expandable title="パラメーター">
    <ParamField body="options">
      [ResetPasswordMfaWebAuthnRoamingChallengeTryAnotherMethodOptions](/docs/ja-jp/libraries/acul/react-sdk/API-Reference/Types/interfaces/ResetPasswordMfaWebAuthnRoamingChallengeTryAnotherMethodOptions).
    </ParamField>
...
<ParamField body="useSecurityKey" type="Promise<void>">
  ...
  **メソッドのパラメーター**
  ...
  <Expandable title="パラメーター">
    <ParamField body="options">
      [ResetPasswordMfaWebAuthnRoamingChallengeUseSecurityKeyOptions](/docs/ja-jp/libraries/acul/react-sdk/API-Reference/Types/interfaces/ResetPasswordMfaWebAuthnRoamingChallengeUseSecurityKeyOptions).
    </ParamField>
