...
<ParamField body="useScreen" type={<span>() =&gt; <a href="/docs/ja-jp/libraries/acul/react-sdk/API-Reference/Types/interfaces/ScreenMembersOnLoginPassword">ScreenMembersOnLoginPassword</a></span>}>
...
<ParamField body="useTransaction" type={<span>() =&gt; <a href="/docs/ja-jp/libraries/acul/react-sdk/API-Reference/Types/interfaces/TransactionMembersOnLoginPassword">TransactionMembersOnLoginPassword</a></span>}>
...
<ParamField body="useLoginPassword" type={<a href="/docs/ja-jp/libraries/acul/react-sdk/API-Reference/Types/interfaces/LoginPasswordMembers">LoginPasswordMembers</a>}>
  ...
  **メソッドパラメーター**
  ...
  <Expandable title="パラメーター">
    <ParamField body="options">
      [FederatedLoginPayloadOptions](/docs/ja-jp/libraries/acul/react-sdk/API-Reference/Types/interfaces/FederatedLoginPayloadOptions).
    </ParamField>
...
<ParamField body="switchConnection" type="Promise<void>">
  ...
  **メソッドパラメーター**
  ...
  <Expandable title="パラメーター">
    <ParamField body="options">
      [SwitchConnectionOptionsLoginPassword](/docs/ja-jp/libraries/acul/react-sdk/API-Reference/Types/interfaces/SwitchConnectionOptionsLoginPassword).
    </ParamField>
...
<ParamField body="switchToOtp" type="Promise<void>">
  このメソッドは、このサインインでパスワード入力からワンタイムコードのチャレンジに切り替えます。

  オプションを表示する前に `screen.data.showSwitchToOtpButton` を確認してください。これにより、この取引で切り替えが可能かどうかを確認できます。
