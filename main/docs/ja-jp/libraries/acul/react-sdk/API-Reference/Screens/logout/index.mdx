...
<ParamField body="useLogout" type={<a href="/docs/ja-jp/libraries/acul/react-sdk/API-Reference/Types/interfaces/LogoutMembers">LogoutMembers</a>}>
  ...
  **メソッドのパラメーター**
  ...
  <Expandable title="パラメーター">
    <ParamField body="options">
      [ConfirmLogoutOptions](/docs/ja-jp/libraries/acul/react-sdk/API-Reference/Types/interfaces/ConfirmLogoutOptions)。
    </ParamField>
