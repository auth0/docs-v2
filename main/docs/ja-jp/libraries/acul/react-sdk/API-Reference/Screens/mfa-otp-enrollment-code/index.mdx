...
<ParamField body="useScreen" type={<span>() =&gt; <a href="/docs/ja-jp/libraries/acul/react-sdk/API-Reference/Types/interfaces/ScreenMembersOnMfaOtpEnrollmentCode">ScreenMembersOnMfaOtpEnrollmentCode</a></span>}>
...
<ParamField body="useMfaOtpEnrollmentCode" type={<a href="/docs/ja-jp/libraries/acul/react-sdk/API-Reference/Types/interfaces/MfaOtpEnrollmentCodeMembers">MfaOtpEnrollmentCodeMembers</a>}>
  ...
  **メソッドのパラメーター**
  ...
  <Expandable title="パラメーター">
    <ParamField body="options">
      [MfaOtpContinueOptions](/docs/ja-jp/libraries/acul/react-sdk/API-Reference/Types/interfaces/MfaOtpContinueOptions)。
    </ParamField>
