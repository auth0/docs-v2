...
<ParamField body="useScreen" type={<span>() =&gt; <a href="/docs/ja-jp/libraries/acul/react-sdk/API-Reference/Types/interfaces/ScreenMembersOnMfaWebAuthnPlatformChallenge">ScreenMembersOnMfaWebAuthnPlatformChallenge</a></span>}>
...
<ParamField body="useMfaWebAuthnPlatformChallenge" type={<a href="/docs/ja-jp/libraries/acul/react-sdk/API-Reference/Types/interfaces/MfaWebAuthnPlatformChallengeMembers">MfaWebAuthnPlatformChallengeMembers</a>}>
  ...
  **メソッドパラメーター**
  ...
  <Expandable title="パラメーター">
    <ParamField body="options">
      [MfaWebAuthnPlatformChallengeReportErrorOptions](/docs/ja-jp/libraries/acul/react-sdk/API-Reference/Types/interfaces/MfaWebAuthnPlatformChallengeReportErrorOptions).
    </ParamField>
...
<ParamField body="verify" type="Promise<void>">
  ...
  **メソッドパラメーター**
  ...
  <Expandable title="パラメーター">
    <ParamField body="options">
      [VerifyPlatformAuthenticatorOptions](/docs/ja-jp/libraries/acul/react-sdk/API-Reference/Types/interfaces/VerifyPlatformAuthenticatorOptions).
    </ParamField>
