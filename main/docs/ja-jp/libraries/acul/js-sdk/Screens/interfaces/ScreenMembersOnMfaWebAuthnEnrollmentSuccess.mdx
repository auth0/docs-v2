...
<ParamField body="data" type={<span><a href="/docs/ja-jp/libraries/acul/js-sdk/Screens/type-aliases/WebAuthnType">WebAuthnType</a></span>}>
  画面固有のデータ。
  ...
  * 型宣言: `{ nickname: string; webauthnType: [WebAuthnType]; }`
  ...
  <Expandable title="プロパティ">
    <ParamField body="nickname" type="string">
      新たに登録された WebAuthn 認証器に、ユーザー (またはシステム) が付けたニックネームです。
    ...
    <ParamField body="webauthnType" type={<span><a href="/docs/ja-jp/libraries/acul/js-sdk/Screens/type-aliases/WebAuthnType">[WebAuthnType]</a></span>}>
