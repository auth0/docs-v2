...
<ParamField body="federatedSignup" type="Promise<void>">
  <Expandable title="パラメータ">
    <ParamField body="payload" type={<span><a href="/docs/ja-jp/libraries/acul/js-sdk/Screens/interfaces/FederatedSignupPayloadOptions">FederatedSignupPayloadOptions</a></span>}>
      **プロパティ**
...
<ParamField body="getSignupIdentifiers" type={<span><a href="/docs/ja-jp/libraries/acul/js-sdk/Screens/interfaces/Identifier">Identifier</a>[]</span>}>
  **`ユーティリティ機能`**
  ...
  有効な [Identifier](/docs/ja-jp/libraries/acul/js-sdk/Screens/interfaces/Identifier) オブジェクトの配列を返します。トランザクションが初期化されていない場合は `null` を返します。
...
<ParamField body="signup" type="Promise<void>">
  <Expandable title="パラメータ">
    <ParamField body="payload" type={<span><a href="/docs/ja-jp/libraries/acul/js-sdk/Screens/interfaces/SignupPayloadOptions">SignupPayloadOptions</a></span>}>
      **プロパティ**
