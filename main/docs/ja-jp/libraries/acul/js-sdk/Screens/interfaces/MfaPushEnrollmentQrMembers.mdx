...
<ParamField body="pollingManager" type={<span><a href="/docs/ja-jp/libraries/acul/js-sdk/Screens/interfaces/MfaPushPollingControl">MfaPushPollingControl</a></span>}>
  <Expandable title="パラメーター">
    <ParamField body="options" type={<span><a href="/docs/ja-jp/libraries/acul/js-sdk/Screens/type-aliases/MfaPollingOptions">MfaPollingOptions</a></span>}>
        ...
        <Expandable title="プロパティ">
          ...
          <ParamField body="onError()?" type="(error) => void">
            ...
            **プロパティ**
            ...
            <ParamField body="error" type={<span><a href="/docs/ja-jp/libraries/acul/js-sdk/Screens/interfaces/Error">Error</a></span>}>
              **プロパティ**
              ...
              <ParamField body="rules?" type={<span><a href="/docs/ja-jp/libraries/acul/js-sdk/Screens/interfaces/PasswordComplexityRule">PasswordComplexityRule[]</a></span>}>
                **プロパティ**
