...
<ParamField body="federatedLogin" type="Promise<void>">
  <Expandable title="パラメーター">
    <ParamField body="payload" type={<span><a href="/docs/ja-jp/libraries/acul/js-sdk/Screens/interfaces/FederatedLoginPasswordOptions">FederatedLoginPasswordOptions</a></span>}>
      **プロパティ**
...
<ParamField body="login" type="Promise<void>">
  <Expandable title="パラメーター">
    <ParamField body="payload" type={<span><a href="/docs/ja-jp/libraries/acul/js-sdk/Screens/interfaces/LoginPasswordOptions">LoginPasswordOptions</a></span>}>
      **プロパティ**
