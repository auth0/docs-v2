...
<ParamField body="federatedLogin" type="Promise<void>">
  ...
  <Expandable title="パラメーター">
    <ParamField body="payload" type={<span><a href="/docs/ja-jp/libraries/acul/js-sdk/Screens/interfaces/FederatedLoginPayloadOptions">FederatedLoginPayloadOptions</a></span>}>
      ソーシャルログインのオプション
...
<ParamField body="getLoginIdentifiers" type={<span><a href="/docs/ja-jp/libraries/acul/js-sdk/Screens/type-aliases/IdentifierType">IdentifierType</a>[]</span>}>
  **`ユーティリティ機能`**
...
<ParamField body="login" type="Promise<void>">
  ...
  <Expandable title="パラメーター">
    <ParamField body="payload" type={<span><a href="/docs/ja-jp/libraries/acul/js-sdk/Screens/interfaces/LoginPayloadOptions">LoginPayloadOptions</a></span>}>
      ログインオプション
