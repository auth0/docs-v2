...
<ParamField body="continue" type="Promise<void>">
  ...
  <Expandable title="パラメータ">
    <ParamField body="payload" type={<span><a href="/docs/ja-jp/libraries/acul/js-sdk/Screens/interfaces/ResetPasswordMfaOtpChallengeContinueOptions">ResetPasswordMfaOtpChallengeContinueOptions</a></span>}>
      コードを含むオプションです。
...
<ParamField body="tryAnotherMethod" type="Promise<void>">
  ...
  <Expandable title="パラメータ">
    <ParamField body="payload?" type={<span><a href="/docs/ja-jp/libraries/acul/js-sdk/Screens/interfaces/ResetPasswordMfaOtpChallengeTryAnotherMethodOptions">ResetPasswordMfaOtpChallengeTryAnotherMethodOptions</a></span>}>
