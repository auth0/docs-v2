...
export interface MfaCountryCodesMembers extends BaseMembers {
   ...
   * @param payload 国コード選択のActionを含むオプション
   */
...
<ParamField body="selectCountryCode" type="Promise<void>">
  ...
  <Expandable title="パラメーター">
    <ParamField body="payload" type={<span><a href="/docs/ja-jp/libraries/acul/js-sdk/Screens/interfaces/SelectCountryCodeOptions">SelectCountryCodeOptions</a></span>}>
      国コードを選択するためのオプション
