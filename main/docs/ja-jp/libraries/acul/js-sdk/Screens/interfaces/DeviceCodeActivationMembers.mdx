...
<ParamField body="continue" type="Promise<void>">
  ...
  <Expandable title="パラメーター">
    <ParamField body="payload" type={<span><a href="/docs/ja-jp/libraries/acul/js-sdk/Screens/interfaces/DeviceCodeActivationContinueOptions">DeviceCodeActivationContinueOptions</a></span>}>
