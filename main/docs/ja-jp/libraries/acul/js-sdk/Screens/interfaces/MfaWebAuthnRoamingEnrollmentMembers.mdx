...
<ParamField body="screen" type={<span><a href="/docs/ja-jp/libraries/acul/js-sdk/Screens/interfaces/ScreenMembersOnMfaWebAuthnRoamingEnrollment">ScreenMembersOnMfaWebAuthnRoamingEnrollment</a></span>} />
...
<ParamField body="showError" type="Promise<void>">
  ...
  <Expandable title="パラメータ">
    <ParamField body="payload" type={<span><a href="/docs/ja-jp/libraries/acul/js-sdk/Screens/interfaces/ShowErrorOptions">ShowErrorOptions</a></span>}>
      エラーの詳細を含むオプション。
...
<ParamField body="tryAnotherMethod" type="Promise<void>">
  ...
  <Expandable title="パラメータ">
    <ParamField body="payload?" type={<span><a href="/docs/ja-jp/libraries/acul/js-sdk/Screens/interfaces/MfaWebAuthnRoamingEnrollmentTryAnotherMethodOptions">MfaWebAuthnRoamingEnrollmentTryAnotherMethodOptions</a></span>}>
      リクエストに含める省略可能なカスタムオプション。
    </ParamField>
  </Expandable>
</ParamField>