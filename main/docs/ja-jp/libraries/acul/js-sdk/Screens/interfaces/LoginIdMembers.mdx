...
<ParamField body="federatedLogin" type="Promise<void>">
  <Expandable title="パラメータ">
    <ParamField body="payload" type={<span><a href="/docs/ja-jp/libraries/acul/js-sdk/Screens/interfaces/FederatedLoginOptions">FederatedLoginOptions</a></span>}>
      **プロパティ**
...
<ParamField body="login" type="Promise<void>">
  <Expandable title="パラメータ">
    <ParamField body="payload" type={<span><a href="/docs/ja-jp/libraries/acul/js-sdk/Screens/interfaces/LoginOptions">LoginOptions</a></span>}>
      **プロパティ**
