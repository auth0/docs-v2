...
<ParamField body="federatedSignup" type="Promise<void>">
  <Expandable title="パラメータ">
    <ParamField body="payload" type={<span><a href="/docs/ja-jp/libraries/acul/js-sdk/Screens/interfaces/FederatedSignupOptions">FederatedSignupOptions</a></span>}>
      **プロパティ**
...
<ParamField body="getSignupIdentifiers" type={<span><a href="/docs/ja-jp/libraries/acul/js-sdk/Screens/interfaces/Identifier">Identifier</a>[]</span>} />
...
<ParamField body="signup" type="Promise<void>">
  <Expandable title="パラメータ">
    <ParamField body="payload" type={<span><a href="/docs/ja-jp/libraries/acul/js-sdk/Screens/interfaces/SignupOptions">SignupOptions</a></span>}>
      **プロパティ**
