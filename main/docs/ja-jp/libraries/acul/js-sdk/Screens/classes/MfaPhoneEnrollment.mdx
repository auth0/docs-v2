...
<ParamField body="countryCodes" type={<span><a href="/docs/ja-jp/libraries/acul/js-sdk/Screens/interfaces/CountryCodesMembers">CountryCodesMembers</a></span>}>
  電話番号入力用の国番号データ (`available` や `recommended` など) を `mfa-phone-enrollment` 画面に提供します。
</ParamField>
...
<ParamField body="continueEnrollment" type="Promise<void>">
  ...
  **メソッドのパラメータ**
  ...
  <Expandable title="パラメータ">
    <ParamField body="options">
      [MfaPhoneEnrollmentContinueOptions](/docs/ja-jp/libraries/acul/js-sdk/Screens/interfaces/MfaPhoneEnrollmentContinueOptions).
    </ParamField>
