...
<ParamField body="countryCodes" type={<span><a href="/docs/ja-jp/libraries/acul/js-sdk/Screens/interfaces/CountryCodesMembers">CountryCodesMembers</a></span>}>
  `mfa-begin-enroll-options` 画面向けに、`available` や `recommended` など、電話番号入力用の国番号データを提供します。
</ParamField>
...
<ParamField body="enroll" type="Promise<void>">
  ...
  **メソッドのパラメーター**
  ...
  <Expandable title="パラメーター">
    <ParamField body="options">
      [MfaEnrollOptions](/docs/ja-jp/libraries/acul/js-sdk/Screens/interfaces/MfaEnrollOptions)。
    </ParamField>
