...
<ParamField body="countryCodes" type={<span><a href="/docs/ja-jp/libraries/acul/js-sdk/Screens/interfaces/CountryCodesMembers">CountryCodesMembers</a></span>}>
  `mfa-sms-list` 画面で電話番号を入力する際に使用する、`available` や `recommended` などの国コードデータを提供します。
</ParamField>
...
<ParamField body="selectPhoneNumber" type="Promise<void>">
  ...
  **メソッド パラメーター**
  ...
  <Expandable title="パラメーター">
    <ParamField body="options">
      [MfaSmsListOptions](/docs/ja-jp/libraries/acul/js-sdk/Screens/interfaces/MfaSmsListOptions)。
    </ParamField>
