...
<ParamField body="countryCodes" type={<span><a href="/docs/ja-jp/libraries/acul/js-sdk/Screens/interfaces/CountryCodesMembers">CountryCodesMembers</a></span>}>
  `login-passwordless-email-code` 画面における電話番号入力用の国番号データ (`available` や `recommended` など) を提供します。
</ParamField>
...
<ParamField body="screen" type={<span><a href="/docs/ja-jp/libraries/acul/js-sdk/Screens/interfaces/ScreenMembersOnLoginPasswordlessEmailCode">ScreenMembersOnLoginPasswordlessEmailCode</a></span>}>
...
<ParamField body="transaction" type={<span><a href="/docs/ja-jp/libraries/acul/js-sdk/Screens/interfaces/TransactionMembersOnLoginPasswordlessEmailCode">TransactionMembersOnLoginPasswordlessEmailCode</a></span>}>
...
<ParamField body="resendManager" type={<span><a href="/docs/ja-jp/libraries/acul/js-sdk/Screens/interfaces/ResendControl">ResendControl</a></span>}>
  このメソッドは、タイムアウト管理付きの再送機能を提供します。`startResend()` メソッドを持つ [`ResendControl`](/docs/ja-jp/libraries/acul/js-sdk/Screens/interfaces/ResendControl) オブジェクトを返し、このメソッドで再送を開始すると、ユーザーが再度再送できるようになるまでクールダウン期間が適用されます。
...
<ParamField body="submitCode" type="Promise<void>">
  このメソッドは、メールコードを使用してログインプロセスを続行します。
  ...
  **メソッドのパラメータ**
  ...
  <Expandable title="パラメータ">
    ...
    <ParamField body="captcha?" type="string">
      CAPTCHA プロバイダーからの CAPTCHA コードまたは応答です。Auth0 テナントで[ボット検出](/docs/ja-jp/secure/attack-protection/bot-detection)が有効になっている場合、このプロパティは必須です。
    </ParamField>
  </Expandable>
</ParamField>
...
<ParamField body="switchConnection" type="Promise<void>">
  ...
  **メソッドのパラメータ**
  ...
  <Expandable title="パラメータ">
    <ParamField body="options">
      [SwitchConnectionOptionsEmailCode](/docs/ja-jp/libraries/acul/js-sdk/Screens/interfaces/SwitchConnectionOptionsEmailCode)。
    </ParamField>
