...
<ParamField body="countryCodes" type={<span><a href="/docs/ja-jp/libraries/acul/js-sdk/Screens/interfaces/CountryCodesMembers">CountryCodesMembers</a></span>}>
  `reset-password-mfa-recovery-code-challenge` 画面向けに、`available` や `recommended` など、電話番号入力用の国番号データを提供します。
</ParamField>
...
<ParamField body="screen" type={<span><a href="/docs/ja-jp/libraries/acul/js-sdk/Screens">ScreenMembersOnResetPasswordMfaRecoveryCodeChallenge</a></span>}>
