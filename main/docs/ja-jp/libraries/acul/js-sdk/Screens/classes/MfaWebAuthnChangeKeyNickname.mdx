...
<ParamField body="countryCodes" type={<span><a href="/docs/ja-jp/libraries/acul/js-sdk/Screens/interfaces/CountryCodesMembers">CountryCodesMembers</a></span>}>
  `mfa-webauthn-change-key-nickname` 画面の `available` や `recommended` など、電話番号入力用の国番号データを提供します。
</ParamField>
...
<ParamField body="continueWithNewNickname" type="Promise<void>">
  ...
  **メソッドのパラメータ**
  ...
  <Expandable title="パラメータ">
    <ParamField body="options">
      [MfaWebAuthnChangeKeyNicknameContinueOptions](/docs/ja-jp/libraries/acul/js-sdk/Screens/interfaces/MfaWebAuthnChangeKeyNicknameContinueOptions).
    </ParamField>
