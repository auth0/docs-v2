...
<ParamField body="countryCodes" type={<span><a href="/docs/ja-jp/libraries/acul/js-sdk/Screens/interfaces/CountryCodesMembers">CountryCodesMembers</a></span>}>
  電話番号入力用の `available` や `recommended` などの国番号データを、`mfa-webauthn-roaming-challenge` 画面向けに提供します。
</ParamField>
...
<ParamField body="reportWebAuthnError" type="Promise<void>">
  ...
  **メソッドのパラメーター**
  ...
  <Expandable title="パラメーター">
    <ParamField body="options">
      [MfaWebAuthnRoamingChallengeReportErrorOptions](/docs/ja-jp/libraries/acul/js-sdk/Screens/interfaces/MfaWebAuthnRoamingChallengeReportErrorOptions).
    </ParamField>
