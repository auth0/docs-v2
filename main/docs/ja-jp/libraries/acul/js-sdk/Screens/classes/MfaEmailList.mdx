...
<ParamField body="countryCodes" type={<span><a href="/docs/ja-jp/libraries/acul/js-sdk/Screens/interfaces/CountryCodesMembers">CountryCodesMembers</a></span>}>
  電話番号入力用の国番号データ (`available` や `recommended` など) を、`mfa-email-list` 画面向けに提供します。
</ParamField>
...
<ParamField body="screen" type={<span><a href="/docs/ja-jp/libraries/acul/js-sdk/Screens/interfaces/ScreenMembersOnMfaEmailList">ScreenMembersOnMfaEmailList</a></span>}>
...
<ParamField body="selectMfaEmail" type="Promise<void>">
  ...
  **メソッドのパラメーター**
  ...
  <Expandable title="パラメーター">
    <ParamField body="options">
      [SelectMfaEmailOptions](/docs/ja-jp/libraries/acul/js-sdk/Screens/interfaces/SelectMfaEmailOptions)。
    </ParamField>
