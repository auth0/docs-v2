...
<ParamField body="countryCodes" type={<span><a href="/docs/ja-jp/libraries/acul/js-sdk/Screens/interfaces/CountryCodesMembers">CountryCodesMembers</a></span>}>
  `logout` 画面での電話番号入力用に、`available` や `recommended` などの国コードデータを提供します。
</ParamField>
...
<ParamField body="confirmLogout" type="Promise<void>">
  ...
  **メソッドのパラメータ**
  ...
  <Expandable title="Parameters">
    <ParamField body="options">
      [ConfirmLogoutOptions](/docs/ja-jp/libraries/acul/js-sdk/Screens/interfaces/ConfirmLogoutOptions)。
    </ParamField>
