...
<ParamField body="countryCodes" type={<span><a href="/docs/ja-jp/libraries/acul/js-sdk/Screens/interfaces/CountryCodesMembers">CountryCodesMembers</a></span>}>
  `mfa-push-list` 画面での電話番号入力用に、`available` や `recommended` などの国コードデータを提供します。
</ParamField>
...
<ParamField body="selectMfaPushDevice" type="Promise<void>">
  ...
  **メソッド パラメーター**
  ...
  <Expandable title="パラメーター">
    <ParamField body="options">
      [SelectMfaPushDeviceOptions](/docs/ja-jp/libraries/acul/js-sdk/Screens/interfaces/SelectMfaPushDeviceOptions).
    </ParamField>
