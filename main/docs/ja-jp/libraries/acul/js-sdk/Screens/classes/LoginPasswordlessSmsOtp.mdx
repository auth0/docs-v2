...
<ParamField body="countryCodes" type={<span><a href="/docs/ja-jp/libraries/acul/js-sdk/Screens/interfaces/CountryCodesMembers">CountryCodesMembers</a></span>}>
  `login-passwordless-sms-otp` 画面での電話番号入力用に、`available` や `recommended` などの国番号データを提供します。
</ParamField>
...
<ParamField body="screen" type={<span><a href="/docs/ja-jp/libraries/acul/js-sdk/Screens/interfaces/ScreenMembersOnLoginPasswordlessSmsOtp">ScreenMembersOnLoginPasswordlessSmsOtp</a></span>}>
...
<ParamField body="transaction" type={<span><a href="/docs/ja-jp/libraries/acul/js-sdk/Screens/interfaces/TransactionMembersOnLoginPasswordlessSmsOtp">TransactionMembersOnLoginPasswordlessSmsOtp</a></span>}>
...
<ParamField body="resendManager" type={<span><a href="/docs/ja-jp/libraries/acul/js-sdk/Screens/interfaces/ResendControl">ResendControl</a></span>}>
  このメソッドは、タイムアウト管理を備えた再送機能を提供します。`startResend()` メソッドを持つ [`ResendControl`](/docs/ja-jp/libraries/acul/js-sdk/Screens/interfaces/ResendControl) オブジェクトを返します。このメソッドは再送信をトリガーし、ユーザーが再度再送信できるようになるまでクールダウン期間を適用します。
  ...
  **メソッドのパラメータ**
  ...
  <Expandable title="パラメータ">
    ...
    <ParamField body="captcha?" type="string">
      captcha コード、または CAPTCHA provider からのレスポンス。Auth0 テナントで [ボット検出](/docs/ja-jp/secure/attack-protection/bot-detection) が有効になっている場合、このプロパティは必須です。
    </ParamField>
...
<ParamField body="switchConnection" type="Promise<void>">
  ...
  **メソッドのパラメータ**
  ...
  <Expandable title="パラメータ">
    <ParamField body="options">
      [SwitchConnectionOptionsSmsOtp](/docs/ja-jp/libraries/acul/js-sdk/Screens/interfaces/SwitchConnectionOptionsSmsOtp)。
    </ParamField>
