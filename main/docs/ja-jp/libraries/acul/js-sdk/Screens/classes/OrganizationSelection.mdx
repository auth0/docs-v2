...
<ParamField body="countryCodes" type={<span><a href="/docs/ja-jp/libraries/acul/js-sdk/Screens/interfaces/CountryCodesMembers">CountryCodesMembers</a></span>}>
  `organization-selection` 画面向けに、`available` や `recommended` など、電話番号入力用の国コードデータを提供します。
</ParamField>
...
<ParamField body="screen" type={<span><a href="/docs/ja-jp/libraries/acul/js-sdk/Screens/interfaces/ScreenMembersOnOrganizationSelection">ScreenMembersOnOrganizationSelection</a></span>}>
...
<ParamField body="transaction" type={<span><a href="/docs/ja-jp/libraries/acul/js-sdk/Screens/interfaces/TransactionMembers">TransactionMembers</a></span>}>
  現在有効な識別子やフローの状態など、`organization-selection` 画面に関する取引固有のデータを提供します。
</ParamField>
...
<ParamField body="continueWithOrganizationName" type="Promise<void>">
  ...
  **メソッドのパラメータ**
  ...
  <Expandable title="パラメータ">
    <ParamField body="options">
      [ContinueWithOrganizationNameOptions](/docs/ja-jp/libraries/acul/js-sdk/Screens/interfaces/ContinueWithOrganizationNameOptions)。
    </ParamField>
...
<ParamField body="getErrors" type={<span><a href="/docs/ja-jp/libraries/acul/js-sdk/Screens/interfaces/Error">Error</a>[]</span>}>
  このメソッドは、コンテキストから取引エラーの配列を取得します。存在しない場合は空の配列を返します。
</ParamField>

<ParamField body="skipOrganizationSelection" type="Promise<void>">
  このメソッドは、組織の選択をスキップし、ユーザーの個人アカウントで続行します。
