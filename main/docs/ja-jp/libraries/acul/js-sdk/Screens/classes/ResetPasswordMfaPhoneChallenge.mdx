...
<ParamField body="countryCodes" type={<span><a href="/docs/ja-jp/libraries/acul/js-sdk/Screens/interfaces/CountryCodesMembers">CountryCodesMembers</a></span>}>
  電話番号入力用の `available` や `recommended` などの国コードデータを、`reset-password-mfa-phone-challenge` 画面向けに提供します。
</ParamField>
...
<ParamField body="continue" type="Promise<void>">
  ...
  **メソッドパラメーター**
  ...
  <Expandable title="パラメーター">
    <ParamField body="options">
      [ResetPasswordMfaPhoneChallengeContinueOptions](/docs/ja-jp/libraries/acul/js-sdk/Screens/interfaces/ResetPasswordMfaPhoneChallengeContinueOptions)。
    </ParamField>
...
<ParamField body="tryAnotherMethod" type="Promise<void>">
  ...
  **メソッドパラメーター**
  ...
  <Expandable title="パラメーター">
    <ParamField body="options">
      [ResetPasswordMfaPhoneChallengeTryAnotherMethodOptions](/docs/ja-jp/libraries/acul/js-sdk/Screens/interfaces/ResetPasswordMfaPhoneChallengeTryAnotherMethodOptions)。
    </ParamField>
