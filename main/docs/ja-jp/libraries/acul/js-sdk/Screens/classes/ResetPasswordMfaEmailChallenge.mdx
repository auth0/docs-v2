...
<ParamField body="countryCodes" type={<span><a href="/docs/ja-jp/libraries/acul/js-sdk/Screens/interfaces/CountryCodesMembers">CountryCodesMembers</a></span>}>
  `reset-password-mfa-email-challenge` 画面に対する、`available` や `recommended` など、電話番号入力用の国番号データを提供します。
</ParamField>
...
<ParamField body="continue" type="Promise<void>">
  ...
  **メソッドのパラメータ**
  ...
  <Expandable title="Parameters">
    <ParamField body="options">
      [ContinueOptions](/docs/ja-jp/libraries/acul/js-sdk/Screens/interfaces/ContinueOptions)。
    </ParamField>
