...
<ParamField body="countryCodes" type={<span><a href="/docs/ja-jp/libraries/acul/js-sdk/Screens/interfaces/CountryCodesMembers">CountryCodesMembers</a></span>}>
  `signup-password` 画面用の `available` や `recommended` など、電話番号入力のための国番号データを提供します。
</ParamField>
...
<ParamField body="screen" type={<span><a href="/docs/ja-jp/libraries/acul/js-sdk/Screens/interfaces/ScreenMembersOnSignupPassword">ScreenMembersOnSignupPassword</a></span>}>
...
<ParamField body="transaction" type={<span><a href="/docs/ja-jp/libraries/acul/js-sdk/Screens/interfaces/TransactionMembersOnSignupPassword">TransactionMembersOnSignupPassword</a></span>}>
  アクティブな識別子やフローの状態など、取引 固有のデータを提供します。
</ParamField>
...
<ParamField body="getErrors" type={<span><a href="/docs/ja-jp/libraries/acul/js-sdk/Screens/interfaces/Error">Error</a>[]</span>}>
  このメソッドは、コンテキストから取引エラーの配列を取得します。エラーが存在しない場合は空の配列を返します。
</ParamField>

<ParamField body="skipPassword" type="Promise<void>">
  このメソッドは、現在のサインアップでのパスワード作成をスキップします。`screen.data.showSkipPassword` が `true` に設定されている場合にのみ利用できます。
  ...
  **メソッドのパラメータ**
  ...
  <Expandable title="パラメータ">
    <ParamField body="options">
      [SkipPasswordOptions](/docs/ja-jp/libraries/acul/js-sdk/Screens/interfaces/SkipPasswordOptions)。
    </ParamField>

    <ParamField body="captcha?" type="string">
      captcha プロバイダーから返される captcha コードまたはレスポンスです。Auth0 テナントで [ボット検出](/docs/ja-jp/secure/attack-protection/bot-detection) が有効になっている場合、このプロパティは必須です。
    </ParamField>
  </Expandable>
</ParamField>
...
<ParamField body="switchConnection" type="Promise<void>">
  ...
  **メソッドのパラメータ**
  ...
  <Expandable title="パラメータ">
    <ParamField body="options">
      [SwitchConnectionOptionsSignupPassword](/docs/ja-jp/libraries/acul/js-sdk/Screens/interfaces/SwitchConnectionOptionsSignupPassword)。
    </ParamField>
...
<ParamField body="validatePassword" type={<span><a href="/docs/ja-jp/libraries/acul/js-sdk/Screens/interfaces/PasswordValidationResult">PasswordValidationResult</a></span>}>
  このメソッドは、現在の取引のパスワードポリシーに照らしてパスワード文字列を検証します。パスワードが有効かどうか、およびその理由を示すオブジェクトを返します。
