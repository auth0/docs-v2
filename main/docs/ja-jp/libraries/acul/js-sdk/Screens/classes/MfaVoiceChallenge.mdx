...
<ParamField body="countryCodes" type={<span><a href="/docs/ja-jp/libraries/acul/js-sdk/Screens/interfaces/CountryCodesMembers">CountryCodesMembers</a></span>}>
  `mfa-voice-challenge` 画面での電話番号入力に使用する、`available` や `recommended` などの国コードデータを提供します。
</ParamField>
...
<ParamField body="continue" type="Promise<void>">
  ...
  **メソッドのパラメータ**
  ...
  <Expandable title="パラメータ">
    <ParamField body="options">
      [MfaVoiceChallengeContinueOptions](/docs/ja-jp/libraries/acul/js-sdk/Screens/interfaces/MfaVoiceChallengeContinueOptions)。
    </ParamField>
