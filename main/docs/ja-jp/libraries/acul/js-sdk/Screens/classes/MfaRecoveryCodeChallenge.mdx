...
<ParamField body="countryCodes" type={<span><a href="/docs/ja-jp/libraries/acul/js-sdk/Screens/interfaces/CountryCodesMembers">CountryCodesMembers</a></span>}>
  `mfa-recovery-code-challenge` 画面向けに、`available` や `recommended` などの電話番号入力用の国番号データを提供します。
</ParamField>
...
<ParamField body="continue" type="Promise<void>">
  ...
  **メソッドのパラメーター**
  ...
  <Expandable title="パラメーター">
    <ParamField body="options">
      [MfaRecoveryCodeChallengeContinueOptions](/docs/ja-jp/libraries/acul/js-sdk/Screens/interfaces/MfaRecoveryCodeChallengeContinueOptions)。
    </ParamField>
