...
<ParamField body="countryCodes" type={<span><a href="/docs/ja-jp/libraries/acul/js-sdk/Screens/interfaces/CountryCodesMembers">CountryCodesMembers</a></span>}>
  電話番号入力用に、`available` や `recommended` などの国コードデータを `reset-password-mfa-webauthn-platform-challenge` 画面向けに提供します。
</ParamField>
...
<ParamField body="continueWithPasskey" type="Promise<void>">
  ...
  **メソッドパラメーター**
  ...
  <Expandable title="パラメーター">
    <ParamField body="options">
      [ResetPasswordMfaWebAuthnPlatformChallengeContinueOptions](/docs/ja-jp/libraries/acul/js-sdk/Screens/interfaces/ResetPasswordMfaWebAuthnPlatformChallengeContinueOptions)。
    </ParamField>
...
<ParamField body="reportBrowserError" type="Promise<void>">
  ...
  **メソッドパラメーター**
  ...
  <Expandable title="パラメーター">
    <ParamField body="options">
      [ResetPasswordMfaWebAuthnPlatformChallengeReportErrorOptions](/docs/ja-jp/libraries/acul/js-sdk/Screens/interfaces/ResetPasswordMfaWebAuthnPlatformChallengeReportErrorOptions)。
    </ParamField>

    <ParamField body="error" type={<span><a href="/docs/ja-jp/libraries/acul/js-sdk/Screens/interfaces/WebAuthnErrorDetails">WebAuthnErrorDetails</a></span>} required>
