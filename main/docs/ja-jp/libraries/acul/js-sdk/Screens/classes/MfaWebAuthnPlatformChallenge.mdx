...
<ParamField body="countryCodes" type={<span><a href="/docs/ja-jp/libraries/acul/js-sdk/Screens/interfaces/CountryCodesMembers">CountryCodesMembers</a></span>}>
  電話番号入力用に、`available` や `recommended` などの国番号データを `mfa-webauthn-platform-challenge` 画面向けに提供します。
</ParamField>
...
<ParamField body="reportBrowserError" type="Promise<void>">
  ...
  **メソッドパラメータ**
  ...
  <Expandable title="パラメータ">
    <ParamField body="options">
      [MfaWebAuthnPlatformChallengeReportErrorOptions](/docs/ja-jp/libraries/acul/js-sdk/Screens/interfaces/MfaWebAuthnPlatformChallengeReportErrorOptions)。
    </ParamField>
