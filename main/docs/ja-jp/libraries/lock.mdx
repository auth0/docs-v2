...
### 依存関係のバンドル {#bundling-dependencies}
...
### クロスオリジン認証 {#cross-origin-authentication}
...
### Step 1. Lock を初期化する {#step-1-initializing-lock}
...
### ステップ 2. 認証してユーザー情報を取得する {#step-2-authenticating-and-getting-user-info}
...
### ステップ 3. Lock を表示する {#step-3-showing-lock}
...
### パスワードレスの使用例 {#passwordless-example}
...
### 埋め込み認証でのシングルサインオン {#single-sign-on-with-embedded-authentication}
