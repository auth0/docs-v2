...
1. Auth0 Dashboardに移動して[［Social Connections（ソーシャル接続）］](%24%7Bmanage_url%7D/#/connections/social)）をクリックします。
...
7. Auth0 Dashboardに移動して[［Applications（アプリケーション）］](%24%7Bmanage_url%7D/#/applications)をクリックします。作成がまだの場合は、まずは作成してからアプリケーションの構成ページに移動します。
...
Google開発者コンソールでOAuth資格情報を新たに作成する場合は、アプリケーションにサインする際に使う証明書のSHA-1を提供する必要があります。Auth0 Dashboardでアプリケーションの構成を完了する際は、SHA-256値も提供する必要があります。以下に、値を取得するためのターミナルコマンド例とその結果例を示します。
...
6. Auth0 Dashboardに移動して[［Applications（アプリケーション）］](%24%7Bmanage_url%7D/#/applications)をクリックします。作成がまだの場合は、まずは作成してからアプリケーションの構成ページに移動します。
