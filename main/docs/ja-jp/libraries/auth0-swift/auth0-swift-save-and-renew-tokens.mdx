...
### ユーザー資格情報の取得 {#retrieving-user-credentials}
...
## 代替方法 - SimpleKeychain {#alternative-method-simplekeychain}
...
### ユーザーの資格情報の更新 {#renewing-user-credentials}
