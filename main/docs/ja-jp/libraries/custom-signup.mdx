...
### 別のページにリダイレクトする {#redirect-to-another-page}
...
### 段階的プロファイリング {#progressive-profiling}
...
## API の利用 {#using-the-api}

### カスタムフィールドを収集するサインアップフォームを作成する {#create-a-signup-form-to-capture-custom-fields}
...
### フォームデータを送信する {#send-the-form-data}
...
## カスタムフィールドの制限事項 {#custom-fields-limitations}
...
## サインアップフォームにユーザー名を追加する {#add-username-to-the-signup-form}
...
## 任意: パスワード強度を確認する {#optional-verify-password-strength}
