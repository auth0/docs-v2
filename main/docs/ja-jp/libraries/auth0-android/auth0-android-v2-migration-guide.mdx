...
## [](https://github.com/auth0/Auth0.Android/blob/v2-dev/V2_MIGRATION_GUIDE.md#requirements-changes)要件の変更
...
## [](https://github.com/auth0/Auth0.Android/blob/v2-dev/V2_MIGRATION_GUIDE.md#oidc-only)Open ID Connect限定
...
## [](https://github.com/auth0/Auth0.Android/blob/v2-dev/V2_MIGRATION_GUIDE.md#authorization-code-with-pkce)PKCEを使用した認可コード
...
## [](https://github.com/auth0/Auth0.Android/blob/v2-dev/V2_MIGRATION_GUIDE.md#removal-of-webview-support)WebView対応の削除

`WebView`コンポーネントを使用した非推奨の認証機能が削除されました。これに代わり、セキュリティとユーザーの信頼を強化するため、外部のブラウザーアプリケーションが必ず使用されます。

## [](https://github.com/auth0/Auth0.Android/blob/v2-dev/V2_MIGRATION_GUIDE.md#removal-of-legacy-authentication-api-support)レガシー認証API対応の削除
...
## [](https://github.com/auth0/Auth0.Android/blob/v2-dev/V2_MIGRATION_GUIDE.md#request-interfaces-changes)要求インターフェイスの変更
...
## [](https://github.com/auth0/Auth0.Android/blob/v2-dev/V2_MIGRATION_GUIDE.md#networking-client-customization)ネットワーククライアントのカスタマイズ
...
### [](https://github.com/auth0/Auth0.Android/blob/v2-dev/V2_MIGRATION_GUIDE.md#timeout-configuration)タイムアウト構成



### [](https://github.com/auth0/Auth0.Android/blob/v2-dev/V2_MIGRATION_GUIDE.md#logging-configuration)ロギング構成



## [](https://github.com/auth0/Auth0.Android/blob/v2-dev/V2_MIGRATION_GUIDE.md#detailed-change-listing)変更内容の詳細

### [](https://github.com/auth0/Auth0.Android/blob/v2-dev/V2_MIGRATION_GUIDE.md#files-that-changed-their-package)パッケージを変更したファイル
...
### [](https://github.com/auth0/Auth0.Android/blob/v2-dev/V2_MIGRATION_GUIDE.md#internal-package)内部パッケージ
...
### [](https://github.com/auth0/Auth0.Android/blob/v2-dev/V2_MIGRATION_GUIDE.md#classes-and-interfaces-removed)削除されたクラスおよびインターフェイス
...
### [](https://github.com/auth0/Auth0.Android/blob/v2-dev/V2_MIGRATION_GUIDE.md#constants-removed)削除された定数
...
### [](https://github.com/auth0/Auth0.Android/blob/v2-dev/V2_MIGRATION_GUIDE.md#classes-and-interfaces-changed)変更されたクラスおよびインターフェイス
...
### [](https://github.com/auth0/Auth0.Android/blob/v2-dev/V2_MIGRATION_GUIDE.md#constructors-changed)変更されたコンストラクター
...
### [](https://github.com/auth0/Auth0.Android/blob/v2-dev/V2_MIGRATION_GUIDE.md#methods-removed-or-changed)削除または変更されたメソッド

#### [](https://github.com/auth0/Auth0.Android/blob/v2-dev/V2_MIGRATION_GUIDE.md#auth0-methods-removed)削除された`Auth0`のメソッド
...
#### [](https://github.com/auth0/Auth0.Android/blob/v2-dev/V2_MIGRATION_GUIDE.md#authenticationapiclient-methods-removed-or-changed)削除または変更された`AuthenticationAPIClient`のメソッド
...
#### [](https://github.com/auth0/Auth0.Android/blob/v2-dev/V2_MIGRATION_GUIDE.md#authenticationrequest-methods-removed)削除された`AuthenticationRequest`のメソッド
...
#### [](https://github.com/auth0/Auth0.Android/blob/v2-dev/V2_MIGRATION_GUIDE.md#webauthproviderbuilder-methods-removed)削除された`WebAuthProvider.Builder`のメソッド
...
#### [](https://github.com/auth0/Auth0.Android/blob/v2-dev/V2_MIGRATION_GUIDE.md#webauthproviderlogoutbuilder-methods-removed)削除された`WebAuthProvider.LogoutBuilder`のメソッド
...
#### [](https://github.com/auth0/Auth0.Android/blob/v2-dev/V2_MIGRATION_GUIDE.md#webauthprovider-methods-removed)削除された`WebAuthProvider`のメソッド
...
#### [](https://github.com/auth0/Auth0.Android/blob/v2-dev/V2_MIGRATION_GUIDE.md#parameterbuilder-methods-removed)削除された`ParameterBuilder`のメソッド

* `setDevice("{DEVICE}")`は削除されました。`set("device", "{VALUE}")`を使用してください。

#### [](https://github.com/auth0/Auth0.Android/blob/v2-dev/V2_MIGRATION_GUIDE.md#usersapiclient-methods-changed)変更された`UsersAPIClient`のメソッド
...
#### [](https://github.com/auth0/Auth0.Android/blob/v2-dev/V2_MIGRATION_GUIDE.md#requestfactory-methods-removed-or-changed)削除または変更された`RequestFactory`のメソッド
...
#### [](https://github.com/auth0/Auth0.Android/blob/v2-dev/V2_MIGRATION_GUIDE.md#profilerequest-methods-changed)変更された`ProfileRequest`のメソッド

* 今後、`addParameters`メソッドには値として、文字列からオブジェクトへのマッピングではなく、文字列から文字列へのマッピング（`addParameters(mapOf("key" to "val"))`）が必要です。

#### [](https://github.com/auth0/Auth0.Android/blob/v2-dev/V2_MIGRATION_GUIDE.md#signuprequest-methods-changed)変更された`SignUpRequest`のメソッド
