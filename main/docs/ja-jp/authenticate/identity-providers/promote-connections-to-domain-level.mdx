...
| 値 | 説明 |
| --- | --- |
| `CONNECTION_ID` | 昇格させる接続のID。 |
| `MGMT_API_ACCESS_TOKEN` | `update:connections` [スコープ](/docs/ja-jp/glossary?term=scope)を持つ[Management APIのアクセストークン](/docs/ja-jp/api/management/v2/tokens)。 |