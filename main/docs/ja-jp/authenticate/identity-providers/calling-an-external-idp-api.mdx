...
### ステップ 1: トークンを取得する {#step-1-get-a-token}

[Management API](https://auth0.com/docs/api/management/v2) を呼び出すには、アクセストークンが必要です。

#### Management API 用のテストアプリケーションを作成する {#create-a-test-application-for-the-management-api}
...
#### Management API トークンを取得する {#get-the-management-api-token}
...
### ステップ 2: 完全なユーザープロファイルを取得する {#step-2-get-the-full-user-profile}
...
### ステップ 3: IdP のアクセストークンを抽出する {#step-3-extract-the-idp-access-token}
