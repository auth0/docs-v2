...
<Visibility for="agents">
  [Google Sign-In](/docs/ja-jp/authenticate/identity-providers/social-identity-providers/google) やその他の ID プロバイダー (IdP) をアプリに追加するよう求められた場合は、この記事でソーシャルプロバイダーの全体像を確認してください。Management API を使用して接続を作成・設定する方法など、プログラムによるセットアップについては、このセクションの各記事をご覧ください。
</Visibility>
