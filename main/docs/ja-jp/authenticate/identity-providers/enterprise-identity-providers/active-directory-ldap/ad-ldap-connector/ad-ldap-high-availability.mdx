...
## プライマリサーバーを設定する {#configure-primary-server}
...
## 追加のサーバーを構成する {#configure-additional-servers}
...
## Kerberos またはクライアント証明書の使用 {#using-kerberos-or-client-certificates}
