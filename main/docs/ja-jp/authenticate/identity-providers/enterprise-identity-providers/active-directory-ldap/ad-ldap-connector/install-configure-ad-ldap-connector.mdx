...
## Windows 用のコネクタをインストールする {#install-the-connector-for-windows}

### インストーラーをダウンロードして実行する {#download-and-run-the-installer}
...
## 他のプラットフォーム向けにコネクタをインストールする {#install-the-connector-for-other-platforms}
