...
2. 接続の詳細を入力し、 **［Create（作成）］** を選択します。
   ...
   <td>Auth0がユーザープロファイルの`email_verified`フィールドを設定する方法を選択します。詳細については、「<a href="/docs/ja-jp/authenticate/identity-providers/enterprise-identity-providers/azuread-adfs-email-verification">Azure ADとADFSのメール検証</a>」を参照してください。</td>
   </tr>
   </tbody>
   </table>
