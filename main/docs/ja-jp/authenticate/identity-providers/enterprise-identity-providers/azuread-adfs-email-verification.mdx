...
## Azure AD/ADFS の Email Verification 移行設定 {#azure-adadfs-email-verification-migration-setting}
...
## Azure AD/ADFS 接続のメール確認フロー {#email-verification-flow-for-azure-adadfs-connections}
