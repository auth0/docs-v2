...
### 接続の機能と考慮事項 {#connection-features-and-considerations}
...
### 接続の機能と考慮事項 {#connection-features-and-considerations-2}
...
### 接続の機能と考慮事項 {#connection-features-and-considerations-3}
