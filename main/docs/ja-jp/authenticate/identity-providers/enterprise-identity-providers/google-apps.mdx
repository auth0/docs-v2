...
## Google でアプリケーションを登録する {#register-your-application-with-google}
...
## Auth0 で Google Workspace のエンタープライズ接続を設定する {#configure-a-google-workspace-enterprise-connection-in-auth0}
...
### ユーザープロファイルの同期をカスタマイズまたは自動化する {#customize-or-automate-user-profile-synchronization}
...
### アクセストークンとリフレッシュトークンを取得する {#get-access-and-refresh-tokens}
...
### ユーザーとグループの追加情報を取得する {#retrieve-additional-user-and-group-details}
...
### Actionsで認証を検証する {#validate-authentication-with-actions}
