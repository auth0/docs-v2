...
## 手動設定パート 1: 証明書利用者信頼を追加する {#manual-setup-part-1-add-a-relying-party-trust}
...
## 手動設定パート 2: クレーム発行ポリシー ルールを追加する {#manual-setup-part-2-add-a-claim-issuance-policy-rule}
...
### LDAP 属性を追加する {#add-additional-ldap-attributes}
