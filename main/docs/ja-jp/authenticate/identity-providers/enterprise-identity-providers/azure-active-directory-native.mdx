...
## Microsoft Azure ポータルでアプリケーションを設定する {#set-up-your-applications-in-the-microsoft-azure-portal}
...
### 新しいWebアプリケーションを登録する {#register-a-new-web-application}
...
### API を公開するように Web アプリケーションを構成する {#configure-your-web-application-to-expose-an-api}
...
### 新しいネイティブアプリケーションを登録する {#register-a-new-native-application}
...
### ネイティブアプリケーションのClient Secretを作成する {#create-a-client-secret-for-your-native-application}
...
### ネイティブ アプリケーションの権限を追加する {#add-permissions-for-your-native-application}
...
## Auth0 で接続を設定する {#configure-the-connection-in-auth0}
...
## グループメンバーシップと高度なプロファイル情報 {#group-memberships-and-advanced-profile-information}
