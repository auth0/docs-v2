...
2. 接続の詳細を入力し、 **［Create（作成）］** をクリックします。
   ...
   <td>Auth0がユーザープロファイルで`email_verified`フィールドを設定する方法を選択します。詳細については、<a href="/docs/ja-jp/authenticate/identity-providers/enterprise-identity-providers/azuread-adfs-email-verification">Microsoft Entra IDとADFSのメール検証</a>をご覧ください。</td>
   </tr>
   </tbody>
   </table>
