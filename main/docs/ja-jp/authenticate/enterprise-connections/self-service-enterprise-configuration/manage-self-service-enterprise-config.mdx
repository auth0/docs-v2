...
## セルフサービスプロファイルを作成する {#create-self-service-profiles}
...
## セルフサービスアクセスチケットを管理する {#manage-self-service-access-tickets}
...
### SAML IdP-Initiated SSO {#saml-idp-initiated-sso}
...
### メールドメインの検証と事前検証済みドメイン {#email-domain-verification-and-pre-verified-domains}
...
#### 事前検証済みドメイン {#pre-verified-domain}
...
#### 検証対象のドメイン {#domains-to-be-verified}
...
#### メールドメインの検証 {#email-domain-verification}
...
### 新しい接続用のアクセスチケットを生成する {#generate-access-tickets-for-new-connections}
...
### 既存の接続用のアクセスチケットを生成する {#generate-access-tickets-for-existing-connections}
...
### アクセスチケットを取り消す {#revoke-an-access-ticket}
