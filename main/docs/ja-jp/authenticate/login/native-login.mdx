...
## ネイティブソーシャルログイン {#native-social-login}
...
#### 有料顧客の本番テナントに適用される制限 {#limits-for-production-tenants-of-paying-customers}

| エンドポイント | パス             | 制限対象                    | レート制限                     |
| ------- | -------------- | ----------------------- | ------------------------- |
| トークン取得  | `/oauth/token` | すべてのネイティブソーシャルログインリクエスト | 1分あたり50件、バースト時は最大500リクエスト |

#### 有料顧客の非本番テナントおよび無料顧客のすべてのテナントに適用される制限 {#limits-for-non-production-tenants-of-paying-customers-and-all-tenants-of-free-customers}
