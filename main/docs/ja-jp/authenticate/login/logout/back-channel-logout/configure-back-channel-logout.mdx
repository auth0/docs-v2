...
## バックチャネルログアウトの制限 {#back-channel-logout-restrictions}
...
#### アプリケーションを登録する {#subscribe-applications}
...
#### アプリケーションの登録を解除する {#unsubscribe-applications}
...
#### アプリケーションを登録する {#subscribe-application}
...
#### アプリケーションの登録を解除する {#unsubscribe-application}
...
## OIDC バックチャネルログアウト リクエストの例 {#oidc-back-channel-logout-request-example}
...
## トラブルシューティング {#troubleshoot-issues}

### アプリケーションがログアウトイベントを受信しなかった {#application-did-not-receive-the-logout-events}
...
#### OIDC バックチャネルログアウトのテナントログが見つかりません {#i-cant-find-oidc-back-channel-logout-tenant-logs}
...
### クライアントアプリで受信したログアウトトークンを検証できない {#client-app-cannot-verify-the-received-logout-token}
...
### 応答タイムアウトエラー {#response-timeout-errors}
