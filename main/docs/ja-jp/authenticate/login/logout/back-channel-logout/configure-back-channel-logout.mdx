...
5. 完了したら、 **［Save Changes（変更を保存）］** を選択します。
   ...
   <Frame>![Auth0 Dashboard > Applications > Settings](/docs/images/ja-JP/cdy7uua7fh8z/19uQRkVswdmaO8gHTVTXCc/02e3bc83d556166bbc340e11c14e382e/Backchannel_Logout_-_URI.png)</Frame>
...
6. 完了したら、 **［Save Changes（変更を保存）］** を選択します。
   ...
   <Frame>![Auth0 Dashboard > Applications > Settings](/docs/images/ja-JP/cdy7uua7fh8z/5SlrBhwrNbJx0Wdw2kQ19t/5c11c2d03587393e542ef07677edbf42/Backchannel_Logout_-_URI.png)</Frame>
