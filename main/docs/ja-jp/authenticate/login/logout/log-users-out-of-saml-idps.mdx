---
description: アプリケーションのコールバック SLO URL を設定して、外部 SAML IdP のユーザーがログアウトした際にサインアウトする方法について説明します。
...
## アプリケーションが SAML IdP に接続されている場合の SLO の設定 {#configure-slo-when-application-is-connected-to-a-saml-idp}
...
## Auth0 が SAML IdP の場合の SLO 設定 {#configure-slo-when-auth0-is-the-saml-idp}
...
### アプリケーション起点のログアウト {#application-initiated-logout}
...
### IdP 起点 ログアウト {#idp-initiated-logout}
