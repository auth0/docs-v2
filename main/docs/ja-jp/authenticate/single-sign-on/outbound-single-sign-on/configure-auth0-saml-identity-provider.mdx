...
## Auth0 組み込みサポートに対応した SSO 連携 {#sso-integrations-with-built-in-auth0-support}
...
## SSO 連携を手動で設定する {#manually-configure-sso-integrations}
...
### サービスプロバイダーからアプリケーションのコールバック URL を取得する {#obtain-the-application-callback-url-from-the-service-provider}
...
### サービスプロバイダーで SAML SSO を設定する {#configure-saml-sso-on-the-service-provider}
