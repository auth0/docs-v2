...
<Card title="利用可否はAuth0プランによって異なります">
  この機能は、B2C Professional、B2B Professional、Enterpriseプランで利用できます。詳細については、[料金](https://auth0.com/pricing)を参照してください。
</Card>
...
### パート 1: Session Transfer Token を取得する {#part-1-get-a-session-transfer-token}
...
### パート 2: Session Transfer Token の引き換え (ブラウザーリダイレクト) {#part-2-redeem-the-session-transfer-token-browser-redirect}
