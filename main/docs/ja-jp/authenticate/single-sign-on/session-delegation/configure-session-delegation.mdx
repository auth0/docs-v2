---
title: セッション委譲を設定する
description: 委譲セッションをリクエストして受け入れるために必要なクライアント設定の方法を説明します。
---
...
## アプリケーションを設定する {#configure-your-applications}

### 要求元アプリケーションを構成する {#configure-the-requesting-application}
...
### 対象の Web アプリケーションを設定する {#configure-the-target-web-application}
