---
description: Auth0 ネイティブからWebへのSSOは、認証済みセッションをiOSまたはAndroidアプリからブラウザーベースのアプリケーションへ引き継ぐため、ユーザーは2回目のログインを省略できます。
...
## セッションとリフレッシュトークンの取り消し {#sessions-and-refresh-token-revocation}
