...
<Card title="始める前に">
  ...
  * [Android Quickstart](/docs/ja-jp/quickstart/native/android/interactive)
  ...
  4. ネイティブアプリケーションに [refresh&#95;token](/docs/ja-jp/secure/tokens/refresh-tokens/get-refresh-tokens) のサポートを追加します。
...
## Auth0 CLI を設定する {#configure-auth0-cli}
...
### ネイティブアプリケーションでネイティブからWebへのSSOを有効にする {#enable-native-to-web-sso-in-your-native-application}
...
### WebアプリケーションでネイティブからWebへのSSOを有効にする {#enable-native-to-web-sso-in-your-web-application}
...
## Webアプリケーションにサブスクリプションページを作成する {#create-a-subscription-page-in-the-web-application}

サブスクリプションページを作成するため、`/src/views/` に新しいファイルを追加します:

### ステップ 1: 新しいビューファイルを追加する {#step-1-add-a-new-view-file}
...
### 手順 2: 新しいルートを追加する {#step-2-add-a-new-route}
...
## ネイティブアプリケーションを設定する {#configure-the-native-application}
...
#### ステップ 1: `Subscribe to Membership` ボタンを追加する {#step-1-add-a-subscribe-to-membership-button}
...
#### ステップ 2: ネイティブからWebへのSSOを使ってサブスクリプション フローを実装する {#step-2-implement-the-subscription-flow-using-native-to-web-sso}
...
#### ステップ 1: メインページにSubscribeボタンを追加する {#step-1-add-a-subscribe-button-to-the-main-page}
...
#### ステップ 2: ネイティブからWebへのSSOを使用してサブスクリプションフローを実装する {#step-2-implement-subscription-flow-using-native-to-web-sso}
...
## ネイティブからWebへのSSOの実装をテストする {#test-your-native-to-web-sso-implementation}
