...
### Federation Metadata ファイルをインポートする {#import-federation-metadata-file}
...
### Federation Metadata endpoint を有効にする {#enable-the-federation-metadata-endpoint}
