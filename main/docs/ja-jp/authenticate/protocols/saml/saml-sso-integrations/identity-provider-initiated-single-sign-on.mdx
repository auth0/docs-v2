...
## リスクと注意事項 {#risks-and-considerations}
...
### OpenID Connect の IdP 起点フロー {#openid-connect-idp-initiated-flow}
...
## IDP-initiated SSO を設定する {#set-up-idp-initiated-sso}
...
## アプリケーションのドロップダウンリストは100件までに制限されています {#application-drop-down-list-limited-to-100}
