...
## OneLogin を設定する {#configure-onelogin}
...
## Auth0 接続を設定する {#configure-auth0-connection}
...
### Auth0 の設定値 {#auth0-configuration-values}
...
## IDプロバイダー主導のシングルサインオン {#identity-provider-initiated-sso}
...
## 接続マッピングを編集する {#edit-connection-mappings}
...
### SAML アサーションに新しいパラメーターを追加する {#add-new-parameter-to-saml-assertion}
