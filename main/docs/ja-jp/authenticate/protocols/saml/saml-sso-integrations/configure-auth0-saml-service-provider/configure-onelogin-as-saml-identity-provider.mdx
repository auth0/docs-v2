...
## OneLoginでは、ユーザーにアプリケーションポータル/ランチャーが用意されています。この機能を利用したい場合は、OneLoginダッシュボードで`connection`パラメーターを含めるように**SAMLのコンシューマーURL**を変更（`
