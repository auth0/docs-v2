...
## アイデンティティプロバイダーとしてのAuth0 {#auth0-as-identity-provider}
...
#### 例: SAML tokenの有効期間を変更し、NameIDとしてUPNを使用する {#example-changing-the-saml-token-lifetime-and-use-upn-as-nameid}
...
#### 例: user_metadata 属性をアサーションに含める {#example-include-user_metadata-attributes-in-an-assertion}
...
## SAMLアサーションの属性 {#saml-assertion-attributes}
