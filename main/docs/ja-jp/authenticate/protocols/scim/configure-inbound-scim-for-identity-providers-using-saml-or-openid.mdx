...
description: SAML または OpenID Connect で認証する Auth0 エンタープライズ接続にインバウンド SCIM を設定すると、同じアイデンティティプロバイダーから Auth0 にもユーザーをプロビジョニングできるようになります。
---

## SAML IDプロバイダー {#saml-identity-providers}
...
## OpenID Connect IDプロバイダー {#openid-connect-identity-providers}
