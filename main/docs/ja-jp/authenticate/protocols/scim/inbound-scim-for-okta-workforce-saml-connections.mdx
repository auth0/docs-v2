...
description: SAML でサインインする Auth0 Okta Workforce 接続で Inbound SCIM を設定し、Okta がユーザーを Auth0 にプロビジョニングおよびプロビジョニング解除できるようにします。
---
...
## Auth0でSCIM設定を構成する {#configure-scim-settings-in-auth0}
...
## SCIM endpoint URL とトークンを取得する {#retrieve-scim-endpoint-url-and-token}
...
## Okta WorkforceでSAMLアプリケーション向けにSCIMを設定する {#configure-scim-in-okta-workforce-for-saml-apps}
...
### Okta SAML アプリケーション {#okta-saml-application}
...
### Okta SCIM テンプレートアプリケーション {#okta-scim-template-application}
