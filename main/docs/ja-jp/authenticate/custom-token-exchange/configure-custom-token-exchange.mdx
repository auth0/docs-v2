...
## カスタムトークン交換プロファイルを設定する {#configure-custom-token-exchange-profile}
...
### カスタムトークン交換プロファイルを作成する {#create-the-custom-token-exchange-profile}
...
### カスタムトークン交換プロファイルを管理する {#manage-custom-token-exchange-profile}
