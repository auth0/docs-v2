...
## カスタムメールプロバイダーを使用してパスワードレスメールを送信する {#send-passwordless-email-with-a-custom-email-provider}
...
## カスタム電話プロバイダーでパスワードレス SMS を送信する {#send-passwordless-sms-with-a-custom-phone-provider}
