...
## Auth0のSDKを使用して埋め込みログインを実装する {#using-auth0s-sdks-to-implement-embedded-login}
...
### Cross-Origin Resource Sharing (CORS) を設定する {#configure-cross-origin-resource-sharing-cors}
