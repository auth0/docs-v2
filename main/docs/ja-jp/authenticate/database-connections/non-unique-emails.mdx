...
#### 主識別子の要件 {#primary-identifier-requirements}
...
#### 元に戻せない設定 {#irreversible-settings}
...
### API の動作変更 {#api-behavior-changes}
...
### Auth0 Dashboard で非一意のメールアドレスを有効にする {#enable-non-unique-emails-in-the-auth0-dashboard}
...
### Management API で Non-Unique Emails を有効にする {#enable-non-unique-emails-via-the-management-api}
...
### 共有メールに関するリスク免責事項 {#shared-email-risk-disclaimer}
