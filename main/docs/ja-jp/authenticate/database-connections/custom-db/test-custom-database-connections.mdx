...
3. このアプリケーションに対して、**パスワード** と **クライアント資格情報** 付与の両方を有効にします（このテストでは両方の付与を有効にしてください）。
   ...
   <Frame>![Auth0 Dashboard > Applications > Advanced Settings](/docs/images/ja-jp/cdy7uua7fh8z/4caAveuhYurCDb5F8mdImm/a32588c23fc0799266928f1d9dae8386/Grant_Types_-_CC_and_PW.png)</Frame>
...
7. ドロップダウンメニューを選択して、次のAuth0 Management APIのスコープを有効にします。
   ...
   * `create:users_app_metadata`
     ...
     <Frame>![Auth0 Dashboard > APIs > Management API >  M2M Tab > App Permissions](/docs/images/ja-jp/cdy7uua7fh8z/2vW8zD1iIObuqb0i59yw77/b2baf521c0d982ab982e4f75a9bf1dda/Management_API_-_M2M_-_Permissions.png)</Frame>
...
| `auth0_domain` | Auth0ドメイン内のテナント名：`yourTenant.us.auth0.com` |
...
8. 各スクリプトで **［Save and Try（保存して試す）］** を選択します。Actions リアルタイムログ`console.log`出力を監視してください。詳細については、「[Actions リアルタイムログ](/docs/ja-jp/customize/actions/actions-real-time-logs)」をお読みください。
