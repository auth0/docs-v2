...
### 公開 npm モジュール {#public-npm-modules}
...
## 提供されるアーティファクト {#provided-artifacts}
...
### `configuration` オブジェクト {#configuration-object}
