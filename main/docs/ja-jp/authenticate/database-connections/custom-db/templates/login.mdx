...
### ユーザープロファイルを返す {#return-the-user-profile}
...
### WrongUsernameOrPasswordError 型オブジェクト {#wrongusernameorpassworderror-type-object}
...
## ログインのたびにユーザープロファイル属性を同期する {#sync-user-profile-attributes-at-each-login}
