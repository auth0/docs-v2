...
<tr>
<td>`username`</td>
<td>ユーザーのユーザー名です。カスタムデータベース接続の<a href="/docs/ja-jp/authenticate/database-connections/require-username"><b>［Requires Username（ユーザー名を要求する）］</b></a>設定が有効の場合は、必須です。</td>
</tr>
<tr>
<td>`connection`</td>
<td>Auth0接続名です。</td>
