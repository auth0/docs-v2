...
### ValidationError 型オブジェクト {#validationerror-type-object}
...
## User オブジェクトのパラメータ {#user-object-parameter}
...
### username プロパティ {#username-property}
