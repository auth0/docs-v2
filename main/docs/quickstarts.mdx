...
<Columns cols={2}>
  ...
  <SectionCard item={{
    ...
    badge: "",
    links: [
      { label: "Quickstart", url: "/docs/quickstart/webapp/express" }
    ],
  }}/>
  ...
  <SectionCard item={{
    ...
    badge: "",
    links: [
      { label: "Quickstart", url: "/docs/quickstart/webapp/python" }
    ],
  }}/>
  ...
  <SectionCard item={{
    ...
    badge: "",
    links: [
      { label: "Quickstart", url: "/docs/quickstart/webapp/fastapi" }
    ],
  }}/>
  ...
  <SectionCard item={{
    ...
    badge: "",
    links: [
      { label: "Quickstart", url: "/docs/quickstart/webapp/java" }
    ],
  }}/>
  ...
  <SectionCard item={{
    ...
    badge: "",
    links: [
      { label: "Quickstart", url: "/docs/quickstart/webapp/java-ee" }
    ],
  }}/>
  ...
  <SectionCard item={{
    ...
    badge: "",
    links: [
      { label: "Quickstart", url: "/docs/quickstart/webapp/aspnet-core-blazor-server" }
    ],
  }}/>
...
<Columns cols={2}>
  ...
  <SectionCard item={{
   ...
   <SectionCard item={{
    ...
    badge: "",
    links: [
      { label: "Quickstart", url: "/docs/quickstart/native/ios-swift-facebook-login" },
    ],
  }}/>
...
<Columns cols={2}>
  ...
  <SectionCard item={{
    ...
    badge: "",
    links: [
      { label: "Quickstart", url: "/docs/quickstart/backend/python" },
    ],
  }}/>
  ...
  <SectionCard item={{
    ...
    badge: "",
    links: [
      { label: "Quickstart", url: "/docs/quickstart/backend/fastapi" }
    ],
  }}/>
  ...
  <SectionCard item={{
    ...
    badge: "",
    links: [
      { label: "Quickstart", url: "/docs/quickstart/backend/java-spring-security5" },
    ],
  }}/>
