...
redirects:
  - "/docs/libraries/lock-ios/v1/passwordless"
  - "/docs/libraries/lock-ios/passwordless"
  - "/docs/libraries/lock-ios/v1/touchid-authentication"
  - "/docs/libraries/lock-ios/touchid-authentication"
  - "/docs/libraries/lock-ios/v1/sms-lock-ios"
  - "/docs/libraries/lock-ios/sms-lock-ios"
  - "/docs/libraries/lock-ios/v2/passwordless"
---
