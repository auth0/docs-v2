...
redirects:
  - "/docs/libraries/lock-ios/v1/customization"
  - "/docs/libraries/lock-ios/v1/use-your-own-ui"
  - "/docs/libraries/lock-ios/v1/use-your-own-uis"
  - "/docs/libraries/lock-ios/use-your-own-ui"
  - "/docs/libraries/lock-ios/v2/customization"
---
