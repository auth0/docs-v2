...
redirects:
  - "/docs/libraries/lock-android/v1/use-your-own-ui"
  - "/docs/libraries/lock-android/v1/sending-authentication-parameters"
  - "/docs/libraries/lock-android/v1"
  - "/docs/libraries/lock-android/v2"
---
