...
In this article, you’ll see how to migrate your single page app (SPA) from [auth0.js](/docs/libraries/auth0-single-page-app-sdk) to [auth0-spa-js](/docs/libraries/auth0-single-page-app-sdk). Listed below are scenarios using auth0.js and the equivalent auth0-spa-js code.
