...
'og:title': 'Auth0.swift: Touch ID / Face ID Authentication'
'og:url': https://auth0.com/docs/
permalink: auth0-swift-touchid-faceid
title: 'Auth0.swift: Touch ID / Face ID Authentication'
'twitter:description': How to implement Touch ID / Face ID authentication with Auth0.swift.
'twitter:title': 'Auth0.swift: Touch ID / Face ID Authentication'
---
...
You can download a sample project and follow the instructions in the iOS quickstart section on [Touch ID / Face ID in iOS](/docs/quickstart/native/ios-swift/08-touch-id-authentication).