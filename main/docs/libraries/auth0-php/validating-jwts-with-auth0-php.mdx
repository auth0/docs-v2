---
title: 'Validate JWTs (JSON Web Tokens)'
description: Use the Auth0-PHP SDK Token class to parse, verify, and validate HS256 and RS256 JSON Web Tokens within your PHP application.
validatedOn: 2026-07-17
redirects:
  - "/docs/libraries/auth0-php/jwt-validation"
---
