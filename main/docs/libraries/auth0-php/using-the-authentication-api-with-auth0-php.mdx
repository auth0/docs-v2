...
An [Authorization Code Flow](/docs/get-started/authentication-and-authorization-flow/authorization-code-flow) is the basic way to grant users access to your application. This flow is the same one used on the [Configure Log In, Log Out, and Return User Profiles with the PHP SDK](/docs/libraries/auth0-php/auth0-php-basic-use) page. If you need more granular control over the login or callback process, this section walks through how to use the Authentication API directly.
...
* [Configure Log In, Log Out, and Return User Profiles with the PHP SDK](/docs/libraries/auth0-php/auth0-php-basic-use)
