---
title: 'Use the Authentication API'
description: Use the Auth0-PHP SDK Authentication class to directly access Auth0's Authentication API for Authorization Code, Client Credentials, and logout flows.
validatedOn: 07-20-2026
redirects:
  - "/docs/libraries/auth0-php/authentication-api"
---
...
An [Authorization Code Flow](/docs/get-started/authentication-and-authorization-flow/authorization-code-flow) is the basic way to grant users access to your application. This flow is the same one used on the [Manage Login, Logout, and User Profiles](/docs/libraries/auth0-php/auth0-php-basic-use) page. If you need more granular control over the login or callback process, this section walks through how to use the Authentication API directly.
...
To learn more, read [Use the Management API](/docs/libraries/auth0-php/using-the-management-api-with-auth0-php) for more information on how to use this Access Token.
...
* [Troubleshoot Your Auth0-PHP Integration](/docs/libraries/auth0-php/troubleshoot-auth0-php-library)