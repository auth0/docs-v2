...
title: Auth0.js
redirects:
  - "/docs/libraries/auth0js/migration-guide"
  - "/docs/login/embedded-login/auth0js"
  - "/docs/libraries/auth0js-v9-reference"
  - "/docs/libraries/lock/v11/auth0js"
  - "/docs/libraries/lock/v10/auth0js"
  - "/docs/libraries/auth0js/v9"
  - "/docs/libraries/auth0js/v8"
  - "/docs/libraries/auth0js/v7"
  - "/docs/auth0js"
---
