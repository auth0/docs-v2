...
title: Lock for Web
redirects:
  - "/docs/login/embedded-login/lock"
  - "/docs/libraries/lock/using-a-refresh-token"
  - "/docs/libraries/lock/using-refresh-tokens"
  - "/docs/libraries/lock/v11"
  - "/docs/libraries/lock/v10/installation"
  - "/docs/libraries/lock/v10"
  - "/docs/libraries/lock/v9/types-of-applications"
  - "/docs/libraries/lock/v9/display-modes"
  - "/docs/libraries/lock/v9"
  - "/docs/migrations/guides/legacy-lock-api-deprecation"
  - "/docs/lock"
  - "/docs/login-widget2"
  - "/docs/widget"
---
