...
redirects:
  - "/docs/libraries/lock-android/v1/passwordless"
  - "/docs/libraries/lock-android/v2/passwordless"
  - "/docs/connections/passwordless/android-email"
  - "/docs/libraries/lock-android/passwordless"
  - "/docs/libraries/auth0-android/passwordless"
---
