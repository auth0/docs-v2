...
redirects:
  ...
  - "/docs/libraries/lock-android/refresh-jwt-tokens"
  - "/docs/libraries/lock-android/v1/refresh-jwt-tokens"
  - "/docs/libraries/lock-android/v2/refresh-jwt-tokens"
  - "/docs/libraries/lock-android/lock-android-delegation"
  - "/docs/libraries/lock-android/v1/delegation-api"
  - "/docs/libraries/lock-android/v2/delegation-api"
---
