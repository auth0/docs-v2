...
The Lock-Google is available through [Maven Central](http://search.maven.org). To install it, simply add the following line to your `build.gradle`:

`compile 'com.auth0.android:lock-google:1.+'`

You can check for the latest version on the repository [Readme](https://github.com/auth0/Lock-Google.Android#install) or in [Maven](https://central.sonatype.com/artifact/com.auth0.android/lock-google).
...
The Lock-Facebook is available through [Maven Central](http://search.maven.org). To install it, simply add the following line to your `build.gradle`:

`compile 'com.auth0.android:lock-facebook:3.+'`

You can check for the latest version on the repository [Readme](https://github.com/auth0/Lock-Facebook.Android#install) or in [Maven](https://central.sonatype.com/artifact/com.auth0.android/lock-facebook).
