...
redirects:
  - "/docs/libraries/lock/v10/selecting-the-connection-for-multiple-logins"
  - "/docs/protocols/saml/saml-configuration/selecting-between-multiple-idp"
  - "/docs/libraries/lock/v11/selecting-the-connection-for-multiple-logins"
  - "/docs/hrd"
---
