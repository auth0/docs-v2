...
redirects:
  - "/docs/libraries/lock/authentication-modes"
  - "/docs/libraries/lock/v11/authentication-modes"
  - "/docs/libraries/lock/v11/popup-mode"
  - "/docs/libraries/lock/v10/authentication-modes"
  - "/docs/libraries/lock/v10/popup-mode"
---
