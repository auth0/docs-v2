---
description: Install and configure the Auth0-PHP SDK, create an Auth0 application, and prepare your PHP project to start authenticating users.
title: 'Get Started with Auth0-PHP'
...
// The `AUTH0_BASE_URL` must exactly match the callback URL set in your Auth0 application.
