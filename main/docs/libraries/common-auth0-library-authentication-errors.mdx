...
| **PasswordHistoryError** | The password provided for sign up/update has already been used (reported when [password history](/docs/authenticate/identity-providers/database/password-options#password-history) feature is enabled) |
