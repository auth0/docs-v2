...
> **getCurrentThemeOptions**(): [`FlattenedTheme`](/docs-v2/main/docs/libraries/acul/js-sdk/Screens/interfaces/FlattenedTheme) \| `null`
...
[`FlattenedTheme`](/docs-v2/main/docs/libraries/acul/js-sdk/Screens/interfaces/FlattenedTheme) \| `null`
