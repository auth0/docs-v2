...
<ParamField body='data' type={<span><a href="/docs-v2/main/docs/libraries/acul/js-sdkScreens/interfaces/PhonePrefix">PhonePrefix</a></span>}>

#### Type Declaration

\{ `phone_prefixes`: [`PhonePrefix`](/docs-v2/main/docs/libraries/acul/js-sdkScreens/interfaces/PhonePrefix)[]; \}
