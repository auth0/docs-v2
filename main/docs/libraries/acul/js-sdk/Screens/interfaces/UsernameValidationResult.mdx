...
<ParamField body='errors' type={<span><a href="/docs-v2/main/docs/libraries/acul/js-sdkScreens/interfaces/UsernameValidationError">UsernameValidationError</a></span>}>

An array of [UsernameValidationError](/docs-v2/main/docs/libraries/acul/js-sdkScreens/interfaces/UsernameValidationError) objects representing
the individual rules that failed, if any.
