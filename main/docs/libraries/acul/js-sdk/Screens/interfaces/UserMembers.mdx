...
* OPT-IN: These are properties that must be explicit configured to make them available to the screen. To learn more, read [Configure](/docs/customize/login-pages/advanced-customizations/configure). 
...
<ParamField body='appMetadata' type='{[key: string]: string; | Optional}'> 
...
<ParamField body='organizations' type={<span><a href="/docs/libraries/acul/js-sdk/Screens/interfaces/Organizations">Organizations</a></span>} | Optional />

<ParamField body='phoneNumber' type='string'/>

<ParamField body='picture' type='string'/>

<ParamField body='userMetadata' type='{[key: string]: string; | Optional }'>
