...
<ParamField body='options' type={<span><a href="/docs-v2/main/docs/libraries/acul/js-sdk/Screens/type-aliases/MfaPollingOptions">MfaPollingOptions</a></span>}>
  ...
  Receives an [ULError](/docs-v2/main/docs/libraries/acul/js-sdk/Screens/interfaces/Error) object containing:
  ...
  **Properties**
  ...
  <ParamField body='error' type={<span><a href="/docs-v2/main/docs/libraries/acul/js-sdk/Screens/interfaces/Error">Error</a></span>}>
  **Properties**
  ...
  <ParamField body='rules?' type={<span><a href="/docs-v2/main/docs/libraries/acul/js-sdk/Screens/interfaces/PasswordComplexityRule">PasswordComplexityRule[]</a></span>}>
**Properties**
