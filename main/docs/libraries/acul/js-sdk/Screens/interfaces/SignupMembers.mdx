...
An array of enabled [Identifier](/docs-v2/main/docs/libraries/acul/js-sdk/Screens/interfaces/Identifier) objects, or `null` if the transaction is not initialized.
