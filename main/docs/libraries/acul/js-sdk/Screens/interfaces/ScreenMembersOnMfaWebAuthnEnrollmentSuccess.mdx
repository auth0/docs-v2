...
<ParamField body='data' type={<span><a href="/docs-v2/main/docs/libraries/acul/js-sdkScreens/type-aliases/WebAuthnType">WebAuthnType</a></span>}>
...
<ParamField body="webauthnType" type={<span><a href="/docs-v2/main/docs/libraries/acul/js-sdkScreens/type-aliases/WebAuthnType">[WebAuthnType]</a></span>}>
