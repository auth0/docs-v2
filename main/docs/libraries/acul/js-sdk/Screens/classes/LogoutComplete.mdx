...
description: "Describes all the properties and methods available to customize the Universal Login `logout-complete` screen."
---

The LogoutComplete class implements the `logout-complete` screen functionality. This screen is displayed when a user completes the logout process.
