...
The MfaEmailChallenge class implementing the `mfa-email-challenge` screen functionality. This screen is shown when a user needs to verify their email during MFA.

<Frame><img style={{maxHeight:"400px"}} src="https://mintlify.s3.us-west-1.amazonaws.com/auth0/docs/images/ja-jp/cdy7uua7fh8z/2MOpok82dGPfHvpb8hy1Yc/fda2d95621af85e0ea6ff73d51d815ad/Screenshot_2025-02-20_at_13.11.50.png" alt="MfaEmailChallenge" /></Frame>
