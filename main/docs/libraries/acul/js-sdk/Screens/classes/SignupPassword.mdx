...
This method skips password creation for the current signup. Check `screen.data.showSkipPassword` to determine whether skipping is available for this transaction before rendering the option.
...
<ParamField body="options">
  [SkipPasswordOptions](/docs/libraries/acul/js-sdk/Screens/interfaces/SkipPasswordOptions).
</ParamField>
