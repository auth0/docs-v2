---
title: "Logout"
description: "Describes all the properties and methods available to customize the Universal Login `logout` screen."
---
...
Create an instance of the Logout screen manager:
