...
This method allows the user to opt out of WebAuthn platform enrollment and select a different MFA method.

```typescript Example
import MfaWebAuthnPlatformEnrollment from '@auth0/auth0-acul-js/mfa-webauthn-platform-enrollment';

const mfaWebAuthnPlatformEnrollment = new MfaWebAuthnPlatformEnrollment();
await mfaWebAuthnPlatformEnrollment.tryAnotherMethod();
```
</ParamField>
