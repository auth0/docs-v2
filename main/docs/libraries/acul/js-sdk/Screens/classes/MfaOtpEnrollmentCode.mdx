...
description: "Describes all the properties and methods available to customize the Universal Login `mfa-otp-enrollment-code` screen."
---
...
<Frame><img style={{maxHeight:"400px"}} src="/docs/images/cdy7uua7fh8z/5x7zKvx9RtgMzJqkIgvE5Z/17d50fc705c6e0bf0bd75444d2b486ff/Screenshot_2025-03-26_at_00.01.21.png" alt="ACUL MFA OTP Enrollment Code"/></Frame>

## Constructors

Create an instance of MFA OTP Enrollment Code screen manager:
...
Provides transaction-specific data for the `mfa-otp-enrollment-code` screen, such as active identifiers and flow states.
</ParamField>
