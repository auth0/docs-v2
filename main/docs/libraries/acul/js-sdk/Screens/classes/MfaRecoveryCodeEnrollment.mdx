...
description: "Describes all the properties and methods available to customize the Universal Login `mfa-recovery-code-enrollment` screen."
---
...
<Frame><img style={{maxHeight:"400px"}} src="/docs/images/cdy7uua7fh8z/2uWvPBVRFNE3pRVctzxyOP/986cc0aa6e64db27944bbcc3c5b4ea04/Screenshot_2025-04-23_at_19.05.21.png" alt="ACUL MFA Recovery Code Enrollment" /></Frame>

## Constructors

Create an instance of MFA Recovery Code Enrollment screen manager:
...
Provides transaction-specific data for the `mfa-recovery-code-enrollment` screen, such as active identifiers and flow states.
</ParamField>

<ParamField body="untrustedData" type={<span><a href="/docs/libraries/acul/js-sdk/Screens/interfaces/UntrustedDataMembers">UntrustedDataMembers</a></span>}>
Handles untrusted data passed to the SDK, such as user input during MFA recovery code enrollment.
</ParamField>
...
This method declares that the user has saved the recovery code and continues the enrollment flow.
