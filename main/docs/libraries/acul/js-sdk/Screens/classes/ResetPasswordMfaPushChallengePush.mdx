...
description: "Describes all the properties and methods available to customize the Universal Login `reset-password-mfa-push-challenge-push` screen."
---
...
<ParamField body="options">
  [MfaPollingOptions](/docs/libraries/acul/js-sdk/Screens).
</ParamField>
