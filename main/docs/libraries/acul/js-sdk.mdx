...
After installing the SDK, you can import your sceen modules to configure
...
Explore the [ACUL JS SKD screen and its methods](/docs/libraries/acul/js-sdk/screens) 
