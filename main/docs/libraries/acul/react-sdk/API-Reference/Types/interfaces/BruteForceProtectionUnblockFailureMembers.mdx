...
export interface BruteForceProtectionUnblockFailureMembers extends BaseMembers {
  /**
   * Provides access to the specific properties and data of the Brute Force Protection Unblock Failure screen.
...
Screen-specific data for the brute force protection unblock failure screen.
