...
<ParamField body='publicKey' type={<span><a href="/docs-v2/main/docs/libraries/acul/react-sdkAPI-Reference/Types/interfaces/AllowCredential">AllowCredential</a></span>}>
