...
<ParamField body='errors' type={<span><a href="/docs-v2/main/docs/libraries/acul/react-sdkAPI-Reference/Types/interfaces/UsernameValidationError">UsernameValidationError</a></span>}>

An array of [UsernameValidationError](/docs-v2/main/docs/libraries/acul/react-sdkAPI-Reference/Types/interfaces/UsernameValidationError) objects representing
the individual rules that failed, if any.
