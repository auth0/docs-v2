...
Options object for the [`useError`](/docs/libraries/acul/react-sdk/API-Reference/Hooks/useErrors) hook. Controls error display behavior within Auth0 Universal Login screens.
