...
description: "Describes all the hooks and methods available to customize the Universal Login `logout-complete` screen."
---

The `logout-complete` screen is displayed after a user successfully completes the logout process.

<Frame><img style={{maxHeight:"400px"}} src="/docs/images/cdy7uua7fh8z/5bso8fSMLDlnt4RHURVAYm/c583500e939a6aed729a04bd9da6a1f6/Screenshot_2025-05-15_at_19.20.19.png" alt="Logout Complete"/></Frame>
