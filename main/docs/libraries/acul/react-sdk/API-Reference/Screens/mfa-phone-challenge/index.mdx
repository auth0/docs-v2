...
description: "Describes all the hooks and methods available to customize the Universal Login `mfa-phone-challenge` screen."
---
...
<ParamField body="options">
  [MfaPhoneChallengeContinueOptions](/docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/MfaPhoneChallengeContinueOptions).
</ParamField>
