...
description: "Describes all the hooks and methods available to customize the Universal Login `mfa-webauthn-not-available-error` screen."
---
...
This hook provides branding configurations, such as logo, colors, and theme settings displayed on the `mfa-webauthn-not-available-error` screen.
...
This hook provides client-related configurations, such as `id`, `name`, and `logoUrl`, for the `mfa-webauthn-not-available-error` screen.
...
This hook contains details specific to the `mfa-webauthn-not-available-error` screen, including its configuration and context.
...
This hook provides transaction-specific data for the `mfa-webauthn-not-available-error` screen, such as the current MFA flow state.
...
This hook returns all methods and context available on the `mfa-webauthn-not-available-error` screen.
