...
<Expandable title="Parameters">
<ParamField body='payload' type={<span><a href="/docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/EmailChallengeOptions">EmailChallengeOptions</a></span>}>
...
The CAPTCHA token, if CAPTCHA is enabled on the tenant.
</ParamField>
