...
<ParamField body="options">
  [ContinueWithOrganizationNameOptions](/docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/ContinueWithOrganizationNameOptions).
</ParamField>
...
This method skips the Organization selection, proceeding with the user's personal account.

```jsx Example
import { useOrganizationSelection } from '@auth0/auth0-acul-react/organization-selection';

function SkipButton() {
  const { skipOrganizationSelection } = useOrganizationSelection();
  return (
