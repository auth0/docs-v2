...
This method redirects the user to the [Social](/docs/authenticate/identity-providers/social-identity-providers) or [Enterprise Identity Provider](/docs/authenticate/identity-providers/enterprise-identity-providers) (IdP) for signup.
