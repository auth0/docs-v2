...
The `screen.data` object exposes three optional fields: `phone`, `messageType`, and `username`. Use `screen.data?.username` to display the username associated with the current enrollment session.
