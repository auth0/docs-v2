...
description: "Describes all the hooks and methods available to customize the Universal Login `mfa-detect-browser-capabilities` screen."
---
...
This hook provides branding configurations, such as logo, colors, and theme settings displayed on the `mfa-detect-browser-capabilities` screen.
...
This hook provides client-related configurations, such as `id`, `name`, and `logoUrl`, for the `mfa-detect-browser-capabilities` screen.
...
This hook contains details specific to the `mfa-detect-browser-capabilities` screen, including its configuration and context.
...
This hook provides transaction-specific data for the `mfa-detect-browser-capabilities` screen, such as the current MFA flow state.
...
This hook returns all methods and context available on the `mfa-detect-browser-capabilities` screen.
</ParamField>
