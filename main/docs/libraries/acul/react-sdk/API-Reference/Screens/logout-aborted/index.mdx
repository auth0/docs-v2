---
title: "LogoutAborted"
description: "Describes all the hooks and methods available to customize the Universal Login `logout-aborted` screen."
---
...
This hook provides branding configurations, such as logo, colors, and theme settings displayed on the `logout-aborted` screen.
...
This hook provides client-related configurations, such as `id`, `name`, and `logoUrl`, for the `logout-aborted` screen.
...
This hook contains details specific to the `logout-aborted` screen, including its configuration and context.
...
This hook provides transaction-specific data for the `logout-aborted` screen, such as active connections and current flow state.
...
This hook returns all methods and context available on the `logout-aborted` screen.
</ParamField>
