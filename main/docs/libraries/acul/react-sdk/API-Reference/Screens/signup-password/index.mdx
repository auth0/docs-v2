...
<ParamField body="options">
  [SkipPasswordOptions](/docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/SkipPasswordOptions).
</ParamField>

<ParamField body='captcha?' type='string'>
  Captcha value required when [Bot Detection](/docs/secure/attack-protection/bot-detection is enabled on the tenant.
</ParamField>
