...
Provides transaction-specific data for the `login-id` screen, such as active connections, available login methods, and current flow state.
...
Enables passkey autofill on an input field for a seamless passwordless login experience.
</ParamField>
