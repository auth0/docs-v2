...
[MfaPollingOptions](docs/libraries/acul/react-sdk/API-Reference/Types/type-aliases/MfaPollingOptions) specifying the polling interval, success callback (`onCompleted`), and optional error handler (`onError`).
</ParamField>

## Returns

[`MfaPollingResult`](docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/MfaPollingResult)

object [MfaPollingResult](docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/MfaPollingResult) containing:
...
- The `onError` callback receives an [ULError](docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/Error) object
