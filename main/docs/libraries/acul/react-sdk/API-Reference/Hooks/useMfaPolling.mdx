...
<ParamField body="options" type={<span><a href='/docs/libraries/acul/react-sdk/API-Reference/Types/type-aliases/MfaPollingOptions'>MfaPollingOptions</a></span>}>
  Specifies the polling interval, success callback (`onCompleted`), and optional error handler (`onError`).
</ParamField>

## Returns

[`MfaPollingResult`](/docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/MfaPollingResult) containing:
