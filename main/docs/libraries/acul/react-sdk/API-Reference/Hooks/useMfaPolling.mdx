...
<ParamField body="useMfaPolling(options?)" type={<span><a href="/docs-v2/main/docs/libraries/acul/react-sdkAPI-Reference/Types/interfaces/MfaPollingResult">MfaPollingResult</a></span>}>
...
[MfaPollingOptions](/docs-v2/main/docs/libraries/acul/react-sdkAPI-Reference/Types/type-aliases/MfaPollingOptions) specifying the polling interval, success callback (`onCompleted`), and optional error handler (`onError`).
</ParamField>

## Returns

[`MfaPollingResult`](/docs-v2/main/docs/libraries/acul/react-sdkAPI-Reference/Types/interfaces/MfaPollingResult)

object [MfaPollingResult](/docs-v2/main/docs/libraries/acul/react-sdkAPI-Reference/Types/interfaces/MfaPollingResult) containing:
...
- The `onError` callback receives an [ULError](/docs-v2/main/docs/libraries/acul/react-sdkAPI-Reference/Types/interfaces/Error) object
