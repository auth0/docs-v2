...
<ParamField body="usePasswordValidation(password, options?)" type={<span><a href="/docs-v2/main/docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/PasswordValidationResult">PasswordValidationResult</a></span>}>
...
[`PasswordValidationResult`](/docs-v2/main/docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/PasswordValidationResult)

A [PasswordValidationResult](/docs-v2/main/docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/PasswordValidationResult) object containing:
