...
<ParamField body="usePasswordValidation(password, options?)" type={<span><a href="/docs-v2/main/docs/libraries/acul/react-sdkAPI-Reference/Types/interfaces/PasswordValidationResult">PasswordValidationResult</a></span>}>
...
A [PasswordValidationResult](/docs-v2/main/docs/libraries/acul/react-sdkAPI-Reference/Types/interfaces/PasswordValidationResult) object containing:
