...
<ParamField body="useCurrentScreen()" type={<span><a href="/docs-v2/main/docs/libraries/acul/react-sdkAPI-Reference/Types/interfaces/CurrentScreenOptions">CurrentScreenOptions</a></span>}>
...
[`CurrentScreenOptions`](/docs-v2/main/docs/libraries/acul/react-sdkAPI-Reference/Types/interfaces/CurrentScreenOptions) \| `null`
