...
<ParamField body="useCurrentScreen()" type={<span><a href="/docs/customize/login-pages/advanced-customizations/reference/react-sdk/API-Reference/Types/interfaces/CurrentScreenOptions">CurrentScreenOptions</a></span>}>
