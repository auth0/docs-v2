...
<ParamField body="useErrors(options)" type={<span><a href="/docs/customize/login-pages/advanced-customizations/reference/react-sdk/API-Reference/Types/interfaces/UseErrorsResult">UseErrorsResult</a></span>}>
...
<ParamField body="options" type={<span><a href='/docs/customize/login-pages/advanced-customizations/reference/react-sdk/API-Reference/Types/interfaces/UseErrorOptions'>[UseErrorOptions]</a> = {}</span>}>
**Properties**
