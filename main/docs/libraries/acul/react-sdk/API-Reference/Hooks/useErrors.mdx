...
<ParamField body="useErrors(options)" type={<span><a href="/docs-v2/main/docs/libraries/acul/react-sdkAPI-Reference/Types/interfaces/UseErrorsResult">UseErrorsResult</a></span>}>
...
An object of type [UseErrorsResult](/docs-v2/main/docs/libraries/acul/react-sdkAPI-Reference/Types/interfaces/UseErrorsResult), containing:
- `errors` — the full error list of type [ErrorsResult](/docs-v2/main/docs/libraries/acul/react-sdkAPI-Reference/Types/interfaces/ErrorsResult), with helpers:
...
<ParamField body="options" type={<span><a href='/docs-v2/main/docs/libraries/acul/react-sdkAPI-Reference/Types/interfaces/UseErrorOptions'>[UseErrorOptions]</a> = {}</span>}>
**Properties**
