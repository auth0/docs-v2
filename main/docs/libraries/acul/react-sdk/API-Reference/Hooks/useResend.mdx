...
<ParamField body="useResend(options?)" type={<span><a href="/docs-v2/main/docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/UseResendReturn">UseResendReturn</a></span>}>
...
<ParamField body="options" type={<span><a href='/docs-v2/main/docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/UseResendOptions'>UseResendOptions</a></span>}>
Optional configuration such as `timeoutSeconds` and `onTimeout`.
</ParamField>

## Returns

[`UseResendReturn`](/docs-v2/main/docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/UseResendReturn)
