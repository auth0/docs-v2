...
<ParamField body="useSignupIdentifiers()" type={<span>[] | <a href="/docs-v2/main/docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/Identifier">Identifier[]</a></span>}>
...
\[\] \| [`Identifier`](/docs-v2/main/docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/Identifier)[]

An array of [Identifier](/docs-v2/main/docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/Identifier) objects, where each contains a `type` (identifier type)
