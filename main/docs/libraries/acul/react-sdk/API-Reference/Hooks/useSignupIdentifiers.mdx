...
<ParamField body="useSignupIdentifiers()" type={<span>[] | <a href="/docs/customize/login-pages/advanced-customizations/reference/react-sdk/API-Reference/Types/interfaces/Identifier">Identifier[]</a></span>}>
