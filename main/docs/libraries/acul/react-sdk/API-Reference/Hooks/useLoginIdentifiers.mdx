...
<ParamField body="useLoginIdentifiers()" type={<span><a href="/docs/customize/login-pages/advanced-customizations/reference/react-sdk/API-Reference/Types/type-aliases/IdentifierType">IdentifierType[]</a></span>}>
