...
<ParamField body="useLoginIdentifiers()" type={<span><a href="/docs-v2/main/docs/libraries/acul/react-sdk/API-Reference/Types/type-aliases/IdentifierType">IdentifierType[]</a></span>}>
...
[`IdentifierType`](/docs-v2/main/docs/libraries/acul/react-sdk/API-Reference/Types/type-aliases/IdentifierType)[]

An array of [IdentifierType](/docs-v2/main/docs/libraries/acul/react-sdk/API-Reference/Types/type-aliases/IdentifierType) representing active identifiers.
