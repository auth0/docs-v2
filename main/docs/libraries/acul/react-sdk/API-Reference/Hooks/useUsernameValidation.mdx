...
<ParamField body="useUsernameValidation(username, options?)" type={<span><a href="/docs-v2/main/docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/UsernameValidationResult">UsernameValidationResult</a></span>}>

> **useUsernameValidation**(`username`, `options?`): [`UsernameValidationResult`](/docs-v2/main/docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/UsernameValidationResult)
...
[`UsernameValidationResult`](/docs-v2/main/docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/UsernameValidationResult)

A [UsernameValidationResult](/docs-v2/main/docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/UsernameValidationResult) object with:
