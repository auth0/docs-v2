...
<Frame>![Request Device Activation](https://cdn2.auth0.com/docs-v2/1.14550.0/media/articles/flows/guides/device-auth/request-device-activation.png)</Frame>
...
<Frame>![Enter User Code](https://cdn2.auth0.com/docs-v2/1.14550.0/media/articles/flows/guides/device-auth/enter-user-code.png)</Frame>

A confirmation page will be shown to have the user confirm that this is the right device:

<Frame>![Confirm Device](https://cdn2.auth0.com/docs-v2/1.14550.0/media/articles/flows/guides/device-auth/confirm-device.png)</Frame>
...
<Frame>![Authenticate User](https://cdn2.auth0.com/docs-v2/1.14550.0/media/articles/flows/guides/device-auth/user-auth.png)</Frame>

Upon successful authentication and consent, the confirmation prompt will be shown:

<Frame>![User Confirmation](https://cdn2.auth0.com/docs-v2/1.14550.0/media/articles/flows/guides/device-auth/user-confirmation.png)</Frame>
