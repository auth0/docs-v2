---
icon: https://cdn2.auth0.com/docs-v2/1.14494.0/img/platforms/auth0.svg
mode: wide
'og:description': This tutorial demonstrates how to call your API from an input-constrained
  device using the Device Authorization Flow.
'og:image': https://cdn2.auth0.com/docs-v2/1.14553.0/img/share-image.png
'og:title': 'Auth0 Device Authorization Flow SDK Quickstarts: Device Authorization
  Flow'
'og:url': https://auth0.com/docs/
title: Device Authorization Flow
'twitter:description': This tutorial demonstrates how to call your API from an input-constrained
  device using the Device Authorization Flow.
'twitter:title': 'Auth0 Device Authorization Flow SDK Quickstarts: Device Authorization
  Flow'
---
...
<Recipe>
  <Content>
    ...
    <Section id={sections[1].id} title={sections[1].title} stepNumber="2">
      ...
      To get the device code, your application must call the Authentication API Device Authorization Flow [Authorize endpoint](/docs/api/authentication#-post-oauth-device-code-):
    ...
    <Section id={sections[3].id} title={sections[3].title} stepNumber="4">
      ...
      <Frame>
        <img src="https://images.ctfassets.net/cdy7uua7fh8z/3Q9q41wocl6SojRoiGefXT/a98582a3c86740aaeb3d957f2dc4afe6/request-device-activation.png" />
      </Frame>
    ...
    <Section id={sections[4].id} title={sections[4].title} stepNumber="5">
      While your device application waits for the user to activate it, it should call the Authentication API [POST /oauth/token endpoint](/docs/api/authentication#-post-oauth-token-) intermittently
    ...
    <Section id={sections[5].id} title={sections[5].title} stepNumber="6">
      ...
      <Frame>
        <img src="https://images.ctfassets.net/cdy7uua7fh8z/7IwrVX4s5a36CvfY95rKCo/dfc962ecde65502945741b1dc8b5c879/Device_Activation_-_English.png" />
      </Frame>

      A confirmation page will be shown to have the user confirm that this is the right device:

      <Frame>
        <img src="https://images.ctfassets.net/cdy7uua7fh8z/5dwhOyM1HRNwfV3Co4Da2o/424a2bc1a1bb44a54c587a0bcddd8222/Device_Confirmation_-_English.png" />
      </Frame>
      ...
      <Frame>
        <img src="https://images.ctfassets.net/cdy7uua7fh8z/3GqqaNB7sjcAYTQiTnEEsn/7199a9b319283686057ca32c853f7a05/Login_screen_-_English.png" />
      </Frame>

      Upon successful authentication and consent, the confirmation prompt will be shown:

      <Frame>
        <img src="https://images.ctfassets.net/cdy7uua7fh8z/2TsQpMa8fzifiojuEXLvDo/484a49b775ec5a6b3522983a425599fe/Success_message_-_English.png" />
      </Frame>
    ...
    <Section id={sections[6].id} title={sections[6].title} stepNumber="7">
      ...
      Access tokens are used to call the Authentication API [Get User Info endpoint](/docs/api/authentication#get-user-info) (if your device
      ...
      ID tokens contain user information that must be [decoded and extracted](/docs/tokens/id-tokens#id-token-payload). The Authentication API
    ...
    <Section id={sections[8].id} title={sections[8].title} stepNumber="9">
      To get a new access token for a user, your device application can call the Authentication API [POST /oauth/token endpoint](/docs/api/authentication#-post-oauth-token-) with the
