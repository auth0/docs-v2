  ...
  <Step title="Install and configure the Auth0 SDK" stepNumber={2}>
    ...
    **Initialize the Auth0 SDK in your Activity:**
    ...
    <Note>
      ...
      If you do plan to support Web Authentication, see [Authentication via Universal Login](/docs/quickstart/native/android).
    </Note>
  </Step>
...
<CardGroup cols={2}>
  ...
  <Card title="Android SDK Reference" icon="android" href="https://github.com/auth0/Auth0.Android" iconType="solid">
