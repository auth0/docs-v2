...
<Recipe>
  <Content>
    ...
    <Section id={sections[9].id} title={sections[9].title} stepNumber="10">
      The SDK must be instantiated before use. Note how the credentials defined in the step above are passed to the
            `Auth0` constructor and then a new instance of the `AuthenticationAPIClient` is created with it.
      ...
      It's a good practice to keep all the values that you know won't change as constants at the top of the
                      ...
                      Auth0 scopes. You can read more about Auth0 scopes in the dedicated [article](/docs/get-started/apis/scopes/openid-connect-scopes).
      </Info>
    </Section>
