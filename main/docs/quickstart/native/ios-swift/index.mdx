...
<Frame>![Screenshot of the iOS section inside the Auth0 application settings page](https://cdn2.auth0.com/docs-v2/1.14550.0/media/articles/native-platforms/ios-swift/ios-device-settings.png)</Frame>
...
<Frame>![Screenshot of the capabilities library inside Xcode](https://cdn2.auth0.com/docs-v2/1.14550.0/media/articles/native-platforms/ios-swift/ios-xcode-capabilities.png)</Frame>
...
<Frame>![Screenshot of the Auth0 application settings page](https://cdn2.auth0.com/docs-v2/1.14550.0/media/articles/dashboard/client_settings.png)</Frame>
...
<Frame>![Screenshot of the Universal Login page](https://cdn2.auth0.com/docs-v2/1.14550.0/media/articles/native-platforms/ios-swift/login-ios.png)</Frame>
