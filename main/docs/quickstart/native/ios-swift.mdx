---
title: Add Login to Your iOS or macOS Application using the Auth0.swift SDK
sidebarTitle: iOS / macOS
mode: wide
redirects:
  - "/docs/quickstart/native/swift-beta"
  - "/docs/quickstart/native/ios-swift/08-touch-id-authentication"
  - "/docs/quickstart/native/ios-swift/07-linking-accounts"
  - "/docs/quickstart/native/ios-swift/05-authorization"
  - "/docs/quickstart/native/ios-swift/04-calling-apis"
  - "/docs/quickstart/native/ios-swift/03-user-sessions"
  - "/docs/quickstart/native/ios-swift/02-custom-login-form"
  - "/docs/quickstart/native/ios-swift/01-embedded-login"
  - "/docs/quickstart/native/ios-swift/00-login"
  - "/docs/quickstart/native/ios-swift-siwa"
  - "/docs/native-platforms/ios-objc"
  - "/docs/quickstart/native/ios-objc"
  - "/docs/quickstart/native/ios"
  - "/docs/ios-tutorial"
  - "/docs/quickstart/native/ios-swift/interactive"
---
