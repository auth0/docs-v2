...
mode: wide
redirects:
  - "/docs/quickstart/native/ionic/09-customizing-lock"
  - "/docs/quickstart/native/ionic/08-mfa"
  - "/docs/quickstart/native/ionic/06-authorization"
  - "/docs/quickstart/native/ionic/05-rules"
  - "/docs/quickstart/native/ionic/04-linking-accounts"
  - "/docs/quickstart/native/ionic/03-user-profile"
  - "/docs/quickstart/native/ionic/02-custom-login"
  - "/docs/quickstart/native/ionic/00-intro"
  - "/docs/quickstart/native/ionic4"
  - "/docs/quickstart/native/ionic"
  - "/docs/ionic-tutorial"
---
