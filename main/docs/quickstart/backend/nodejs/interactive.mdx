---
icon: https://cdn2.auth0.com/docs-v2/1.14494.0/img/platforms/nodejs.svg
mode: wide
  ...
  <Content>
    ...
    **New to Auth0?** Learn [how Auth0 works](https://auth0.com/docs/overview)
    ...
    <Section id={sections[0].id} title={sections[0].title} stepNumber="1">
      ...
      <Frame>
        <img src="https://images.ctfassets.net/cdy7uua7fh8z/5EnGfdqLVZ8fuIxbUn7gm1/7e6b2fb38a7452b2b540099a4a888822/configure-permissions.png" />
      </Frame>
      <Callout icon="file-lines" iconType="regular">
    ...
    <Section id={sections[3].id} title={sections[3].title} stepNumber="4">
      ...
      <Frame>
        <img src="https://images.ctfassets.net/cdy7uua7fh8z/5HUMcKGXoNOvdJNXFI73oi/46a590997c56f9ca9aaf4d7da916575a/Tokens_-_English.png" />
      </Frame>
