---
title: "Secure Express API with Auth0"
sidebarTitle: "Express API"
mode: wide
description: "Protect your Express.js API with JWT authentication using Auth0. Validate access tokens and implement scope-based authorization."
---
...
2. Navigate to **Applications** → **APIs** in the sidebar
3. Click **+ Create API**
...
> ℹ️ Your API is now running at [http://localhost:3000](http://localhost:3000).
...
1. In the Auth0 Dashboard, go to **Applications** → **APIs** → Your API
...
1. Verify the scopes are defined in your Auth0 API (Dashboard → APIs → Permissions)
