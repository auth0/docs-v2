---
icon: https://cdn2.auth0.com/docs-v2/1.14494.0/img/platforms/python.svg
mode: wide
...
'og:title': 'Auth0 Python API SDK Quickstarts: Add Authorization to Your Flask API
  Application'
...
'twitter:description': This guide demonstrates how to integrate Auth0 with any new
  or existing Python API built with Flask.
'twitter:title': 'Auth0 Python API SDK Quickstarts: Add Authorization to Your Flask
  API Application'
---
  ...
  <Content>
    ...
    **New to Auth0?** Learn [how Auth0 works](https://auth0.com/docs/overview)
    ...
    <Section id={sections[3].id} title={sections[3].title} stepNumber="4">
      ...
      <Frame>
        <img src="https://images.ctfassets.net/cdy7uua7fh8z/6jeVBuypOGX5qMRXeJn5ow/5e79037f6c852d2043789d622bdb9562/Quickstart_Example_App_-_English.png" />
      </Frame>
