...
redirects:
  - "/docs/quickstart/backend/rails/00-getting-started"
  - "/docs/rubyapi-tutorial"
  - "/docs/quickstart/backend/ruby"
  - "/docs/quickstart/backend/ruby/00-getting-started"
  - "/docs/server-apis/ruby"
---
