...
<CardGroup cols={3}>
<Card title="SDK Documentation" icon="book" href="https://github.com/auth0/auth0-aspnetcore-api">
  Complete SDK documentation and API reference
</Card>
<Card title="Migration Guide" icon="arrow-right-arrow-left" href="https://github.com/auth0/auth0-aspnetcore-api/blob/master/MIGRATION.md">
  Migrate from JWT Bearer authentication
</Card>
<Card title="Code Examples" icon="code" href="https://github.com/auth0/auth0-aspnetcore-api/blob/master/EXAMPLES.md">
...
<Card title="Playground Application" icon="github" href="https://github.com/auth0/auth0-aspnetcore-api/tree/master/Auth0.AspNetCore.Authentication.Api.Playground">
