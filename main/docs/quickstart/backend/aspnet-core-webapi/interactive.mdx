---
icon: https://cdn2.auth0.com/docs-v2/1.14494.0/img/platforms/dotnet-platform.svg
mode: wide
...
'og:title': 'Auth0 ASP.NET Core Web API SDK Quickstarts: Add Authorization to Your
...
'twitter:description': This tutorial demonstrates how to add authorization to an ASP.NET
  Core Web API application using the standard JWT middleware.
'twitter:title': 'Auth0 ASP.NET Core Web API SDK Quickstarts: Add Authorization to
  Your ASP.NET Core Web API Application'
---
  ...
  <Content>
    ...
    **New to Auth0?** Learn how Auth0 works and
    ...
    <Section id={sections[0].id} title={sections[0].title} stepNumber="1">
      ...
      <Frame>
        <img src="https://images.ctfassets.net/cdy7uua7fh8z/1s3Yp5zqJiKiSWqbPSezNO/e61793a2822d095666002c3f65c71ac2/configure-permissions.png" />
      </Frame>
    </Section>
