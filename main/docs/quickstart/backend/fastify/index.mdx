...
<Accordion title="Custom Token Claims with TypeScript">
  ...
  <Note>
    Custom claims must use namespaced URLs (e.g., `https://myapp.com/roles`) unless they're standard OIDC claims. [Learn more about custom claims](/docs/secure/tokens/json-web-tokens/create-custom-claims).
  </Note>
</Accordion>
...
<Accordion title="Permission-Based Authorization">
  ...
  <Note>
    Permissions must be configured in your Auth0 API settings and granted to clients. [Learn more about API permissions](/docs/manage-users/access-control/configure-core-rbac/rbac-users/assign-permissions-to-users).
  </Note>
</Accordion>
...
<Accordion title="Role-Based Authorization">
  ...
  <Note>
    Roles must be added to tokens using Auth0 Actions. [Learn how to add roles to tokens](/docs/manage-users/access-control/sample-use-cases-actions-with-authorization#add-user-roles-to-tokens).
  </Note>
</Accordion>
...
- **[Role-Based Access Control](/docs/manage-users/access-control/rbac)** - Implement fine-grained permissions
- **[API Authorization Best Practices](/docs/secure/tokens/access-tokens)** - Learn about access token best practices
- **[Monitor Your API](/docs/deploy-monitor/logs)** - Set up logging and monitoring
...
- **[Auth0 API Authentication](/docs/secure/tokens/access-tokens)** - Understanding access tokens
