...
<Frame>![Response for unauthorized API request](https://cdn2.auth0.com/docs-v2/1.14550.0/media/articles/server-apis/using/private-unauthorized.png)</Frame>
...
<Frame>![Response for authorized API request](https://cdn2.auth0.com/docs-v2/1.14550.0/media/articles/server-apis/using/private.png)</Frame>
...
<Frame>![Response for scoped API request](https://cdn2.auth0.com/docs-v2/1.14550.0/media/articles/server-apis/using/private-scoped.png)</Frame>

If the required scope is not present, the API returns a 403 HTTP Status (Forbidden):

<Frame>![Response for forbidden scoped API request](https://cdn2.auth0.com/docs-v2/1.14550.0/media/articles/server-apis/using/private-scoped-forbidden.png)</Frame>
