...
<QuickstartButtons githubLink="https://github.com/auth0-samples/auth0-golang-api-samples/tree/master/01-Authorization-RS256" />
    ...
    **New to Auth0?** Learn how Auth0 works and
    ...
    <Section id={sections[3].id} title={sections[3].title} stepNumber="4">
      ...
      By default, your API will be set up to use RS256 as the algorithm for signing tokens. Since RS256 works by using
            ...
            accessible at `https://{yourDomain}/.well-known/jwks.json`.
