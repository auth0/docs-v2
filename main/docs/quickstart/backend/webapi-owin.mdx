...
redirects:
  - "/docs/quickstart/backend/webapi-owin/00-getting-started"
  - "/docs/quickstart/backend/webapi-owin/06-authorization-legacy"
  - "/docs/quickstart/backend/webapi-owin/06-authorization-deprecated"
  - "/docs/quickstart/backend/webapi-owin/05-authentication-hs256-legacy"
  - "/docs/quickstart/backend/webapi-owin/05-authentication-hs256-deprecated"
  - "/docs/quickstart/backend/webapi-owin/04-authentication-rs256-legacy"
  - "/docs/quickstart/backend/webapi-owin/04-authentication-rs256-deprecated"
