...
redirects:
  - "/docs/quickstart/backend/aspnet-core-webapi-2"
  - "/docs/quickstart/backend/aspnet-core-webapi-2/*"
  - "/docs/quickstart/backend/aspnet-core-webapi/00-getting-started"
  - "/docs/quickstart/backend/aspnet-core-webapi/06-authorization-legacy"
  - "/docs/quickstart/backend/aspnet-core-webapi/06-authorization-deprecated"
  - "/docs/quickstart/backend/aspnet-core-webapi/05-authentication-hs256-legacy"
  - "/docs/quickstart/backend/aspnet-core-webapi/05-authentication-hs256-deprecated"
  - "/docs/quickstart/backend/aspnet-core-webapi/04-authentication-rs256-legacy"
  - "/docs/quickstart/backend/aspnet-core-webapi/04-authentication-rs256-deprecated"
  - "/docs/quickstart/backend/aspnet-core-webapi/interactive"
---
