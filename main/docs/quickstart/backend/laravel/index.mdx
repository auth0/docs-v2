...
title: "Laravel API"
redirects:
  - "/docs/quickstart/backend/laravel/00-getting-started"
  - "/docs/quickstart/backend/php-laravel"
  - "/docs/laravelapi-tutorial"
---
...
{/* <Card title="View on Github" href="https://github.com/auth0-samples/laravel/tree/7.x/sample" icon="github">
...
[Edit on GitHub](https://github.com/auth0/docs/edit/master/articles/quickstart/backend/laravel/01-authorization.md)