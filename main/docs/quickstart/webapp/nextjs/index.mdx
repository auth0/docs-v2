...
<Accordion title="Using Auth0 Tokens with Third-Party Backends">
  ...
  **Client-side:**
  ...
  <Note>
    **Important:** Ensure your Auth0 application is configured with an API audience if your backend requires it. You can set this in the Auth0 Dashboard under Applications → APIs, or add `AUTH0_AUDIENCE` to your `.env.local` and configure the SDK accordingly.
  </Note>
