...
redirects:
  - "/docs/quickstart/webapp/java-spring-security-mvc"
  - "/docs/quickstart/webapp/java-spring-security-mvc/00-intro"
  - "/docs/quickstart/webapp/java-spring-mvc"
  - "/docs/quickstart/webapp/java-spring-mvc/interactive"
  - "/docs/quickstart/webapp/java-spring-mvc/getting-started"
