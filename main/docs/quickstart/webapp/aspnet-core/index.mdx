...
```bash
npx skills add https://github.com/auth0/agent-skills --skill auth0-quickstart --skill auth0-aspnet-core
```
...
Your AI assistant will automatically create your Auth0 application, fetch credentials, install Auth0.AspNetCore.Authentication, configure Program.cs and appsettings.json, and create AccountController. [Full agent skills documentation →](/quickstart/agent-skills)
