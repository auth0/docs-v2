...
Create a new sub-directory in your project folder named `templates`, and create one file within: `home.html`. You can paste the content from the two fields below into the `home.html` file, respectfully: 
