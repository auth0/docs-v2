...
redirects:
  - "/docs/quickstart/webapp/nodejs/01-login"
  - "/docs/quickstart/webapp/nodejs/02-user-profile"
  - "/docs/server-platforms/nodejs"
  - "/docs/nodejs-tutorial"
  - "/docs/quickstart/webapp/nodejs"
...
<Note>
Claims like `role` must be added to your tokens via Auth0 Rules or Actions. [Learn more about adding custom claims](/docs/manage-users/access-control/sample-use-cases-actions-with-authorization#add-user-roles-to-tokens).
</Note>
...
- **[Add Authorization](/docs/manage-users/access-control/rbac)** - Implement role-based access control
- **[Call Protected APIs](/docs/secure/tokens/access-tokens/get-access-tokens)** - Use access tokens to call your backend APIs
- **[Customize Universal Login](/docs/customize/universal-login-pages)** - Brand your login experience
- **[Add Social Connections](/docs/connections/social)** - Enable Google, GitHub, and other social logins
- **[Implement MFA](/docs/secure/multi-factor-authentication)** - Add multi-factor authentication
