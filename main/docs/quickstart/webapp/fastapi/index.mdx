...
<Accordion title="AI Prompt (FastAPI-specific)" icon="microchip-ai" iconType="sharp-solid">
  Alternatively, add this prompt to Cursor, Windsurf, Copilot, Claude Code or your favourite AI-powered IDE to speed up development.
