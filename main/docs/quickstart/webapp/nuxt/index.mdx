...
Your AI assistant will automatically create your Auth0 application, fetch credentials, install `@auth0/auth0-nuxt`, configure the module, and set up your routes. [Full agent skills documentation →](/quickstart/agent-skills)
