...
For information about the userinfo hash, see [User Profile](/docs/manage-users/user-accounts/user-profiles).

## Logging Out

To log the user out, clear the data from the session and redirect the user to the Auth0 logout endpoint. You can find
more information about this in the [logout documentation](/docs/authenticate/login/logout).
