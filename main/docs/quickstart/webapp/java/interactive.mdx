---
icon: https://cdn2.auth0.com/docs-v2/1.14494.0/img/platforms/java.svg
mode: wide
...
<Recipe>
  <Content>
    ...
    <Section id={sections[8].id} title={sections[8].title} stepNumber="9">
      ...
      <Frame>
        <img src="https://images.ctfassets.net/cdy7uua7fh8z/7L6lZ6xCi1L7sJBFZUPb9g/b7697bfa1bc83a1072c2de2f15cec93c/Login_Screen_-_English.png" />
      </Frame>

      After a successful authentication, you'll be able to see the home page contents.

      <Frame>
        <img src="https://images.ctfassets.net/cdy7uua7fh8z/FzK3jxfSGoeIDYQamxnJl/6b608e39ff39e044644193cfd2ee0f69/java-step-9-2.png" />
      </Frame>
