...
redirects:
  - "/docs/quickstart/webapp/rails/09-customizing-lock"
  - "/docs/quickstart/webapp/rails/08-mfa"
  - "/docs/quickstart/webapp/rails/07-authorization"
  - "/docs/quickstart/webapp/rails/06-rules"
  - "/docs/quickstart/webapp/rails/05-linking-accounts"
  - "/docs/quickstart/webapp/rails/03-user-profile"
  - "/docs/quickstart/webapp/rails/04-user-profile"
  - "/docs/quickstart/webapp/rails/02-session-handling"
  - "/docs/quickstart/webapp/rails/03-session-handling"
  - "/docs/quickstart/webapp/rails/02-custom-login"
  - "/docs/quickstart/webapp/rails/00-introduction"
  - "/docs/rails-tutorial"
---
