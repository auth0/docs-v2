...
```bash
npx skills add https://github.com/auth0/agent-skills --skill auth0-quickstart --skill auth0-capnweb
```
...
Your AI assistant will automatically create your Auth0 application, fetch credentials, install required packages, create secure WebSocket RPC authentication, and set up your configuration. [Full agent skills documentation →](/quickstart/agent-skills)
