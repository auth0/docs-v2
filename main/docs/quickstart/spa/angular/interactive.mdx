...
<Steps>
  ...
  <Step title="Configure the Auth0 module" stepNumber={4}>
    Import and configure the Auth0 module in your app

    ```typescript src/main.ts {3,4,12-18} lines
    ...
    <Note>
      The configuration automatically reads your Auth0 domain and client ID from the `.env` file created in the previous step.
    </Note>
  </Step>
