...
mode: wide
redirects:
  - "/docs/quickstart/spa/angular2/06-token-renewal"
  - "/docs/quickstart/spa/angular2/05-authorization"
  - "/docs/quickstart/spa/angular2/04-calling-an-api"
  - "/docs/quickstart/spa/angular2/03-user-profile"
  - "/docs/quickstart/spa/angular2/00-login"
  - "/docs/quickstart/spa/angular2"
  - "/docs/quickstart/spa/angular-next"
  - "/docs/quickstart/spa/angularjs"
  - "/docs/client-platforms/angular2"
  - "/docs/client-platforms/angularjs"
