...
'og:title': 'Auth0 Flutter (Web) SDK Quickstarts: Add Login to Your Flutter Application'
...
'twitter:title': 'Auth0 Flutter (Web) SDK Quickstarts: Add Login to Your Flutter Application'
---
...
<Recipe>
  <Content>
    ...
    <Section id={sections[0].id} title={sections[0].title} stepNumber="1">
      ...
      <Frame>
        <img src="https://images.ctfassets.net/cdy7uua7fh8z/6SC7KnyzCyO8cwXQfril1X/c0d6756c28de0ddcbe938307e529d47a/client_settings.png" />
      </Frame>
