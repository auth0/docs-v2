---
icon: https://cdn2.auth0.com/docs-v2/1.14494.0/img/platforms/react.svg
mode: wide
...
'twitter:description': This guide demonstrates how to integrate Auth0 with any new
  or existing React application using the Auth0 React SDK.
    ...
    * Have a working React project that you want to integrate with. Alternatively, you can view or download a sample application after logging in.
    ...
    <Section id={sections[1].id} title={sections[1].title} stepNumber="2">
      ...
      - `domain`: The domain of your Auth0 tenant. Generally, you can find this in the Auth0 Dashboard
                under your Application's Settings in the Domain field. If you are using a [custom domain](/docs/custom-domains), you should set this to the
    ...
    <Section id={sections[3].id} title={sections[3].title} stepNumber="4">
      Users who log in to your project will also need a way to log out. Create a logout button using the SDK’s logout()
            method. When users log out, they will be redirected to your [Auth0 logout](/docs/api/authentication?javascript#logout) endpoint,
    ...
    <Section id={sections[4].id} title={sections[4].title} stepNumber="5">
      ...
      <Frame>
        <img src="https://images.ctfassets.net/cdy7uua7fh8z/5Lp4Zahxd2v6wSJmy9JaM4/8625115fc5b27b7f6f4adf9003c30b3a/Login_Screen_-_English.png"/>
      </Frame>
