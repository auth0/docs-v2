...
<QuickstartButtons
  githubLink="https://github.com/auth0-samples/auth0-xamarin-oidc-samples/tree/master/Quickstart/01-Login"
  lang="ja"
/>
...
export const sections = [
  ...
  {
    id: "auth0clientをインスタンス化する",
    title: "Auth0Clientをインスタンス化する",
  },
