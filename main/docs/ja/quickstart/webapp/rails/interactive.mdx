...
<QuickstartButtons
  githubLink="https://github.com/auth0-samples/auth0-rubyonrails-sample/tree/master/sample"
  lang="ja"
/>
...
export const sections = [
  ...
  {
    id: "omniauthミドルウェアを構成する",
    title: "OmniAuthミドルウェアを構成する",
  },
  {
    id: "auth0コントローラーを追加する",
    title: "Auth0コントローラーを追加する",
  },
