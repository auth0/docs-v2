...
redirects:
  - "/docs/customize/extensions/auth0-management-api-webhooks"
  - "/docs/extensions/auth0-management-api-webhooks"
  - "/docs/extensions/management-api-webhooks"
  - "/docs/customize/extensions/auth0-authentication-api-webhooks"
  - "/docs/extensions/auth0-authentication-api-webhooks"
  - "/docs/extensions/authentication-api-webhooks"
  - "/docs/extensions"
  - "/docs/extensions/visual-studio-team-services-deployments"
  - "/docs/extensions/visual-studio-team-services-deploy"
  - "/docs/extend-integrate"
  - "/docs/topics/extensibility"
  - "/docs/extensions/using-provided-extensions"
---
<Warning>
