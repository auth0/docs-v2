...
redirects:
  - "/docs/extensions/authorization-extension"
  - "/docs/extensions/authorization-dashboard-extension"
  - "/docs/api/authorization-dashboard-extension"
  - "/docs/extensions/authorization-extension/v1"
  - "/docs/extensions/authorization-extension/v2"
---
...
* [Enable API access to the extension](/docs/customize/extensions/authorization-extension/enable-api-access-to-authorization-extension): Learn about the Authorization Extension's API endpoints and how you can use them.
