...
redirects:
  - "/docs/extensions/delegated-administration-extension/install-delegated-admin-extension"
  - "/docs/dashboard/guides/extensions/delegated-admin-use-extension"
  - "/docs/dashboard/guides/extensions/delegated-admin-install-extension"
---
