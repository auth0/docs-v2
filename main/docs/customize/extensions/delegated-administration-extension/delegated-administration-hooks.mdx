...
redirects:
  - "/docs/extensions/delegated-administration-extension/delegated-administration-hooks"
  - "/docs/extensions/delegated-admin/hooks"
  - "/docs/extensions/delegated-admin/v2/hooks"
  - "/docs/extensions/delegated-admin/v3/hooks"
---
