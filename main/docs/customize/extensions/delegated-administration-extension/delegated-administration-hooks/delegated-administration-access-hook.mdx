...
redirects:
  - "/docs/extensions/delegated-administration-extension/delegated-administration-access-hook"
  - "/docs/extensions/delegated-administration-extension/delegated-administration-hooks/delegated-administration-access-hook"
  - "/docs/extensions/delegated-admin/hooks/access"
  - "/docs/extensions/delegated-admin/v2/hooks/access"
  - "/docs/extensions/delegated-admin/v3/hooks/access"
---
