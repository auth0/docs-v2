...
redirects:
  - "/docs/extensions/delegated-administration-extension/delegated-administration-settings-query-hook"
  - "/docs/extensions/delegated-administration-extension/delegated-administration-hooks/delegated-administration-settings-query-hook"
  - "/docs/extensions/delegated-admin/hooks/settings"
  - "/docs/extensions/delegated-admin/v2/hooks/settings"
  - "/docs/extensions/delegated-admin/v3/hooks/settings"
---
...
For more information, you can review the [Delegated Administration Extension Language Dictionary file](https://github.com/auth0-extensions/auth0-delegated-administration-extension/blob/master/tests/utils/en.json).
