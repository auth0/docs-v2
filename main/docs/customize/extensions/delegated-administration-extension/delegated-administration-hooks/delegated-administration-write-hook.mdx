...
redirects:
  - "/docs/extensions/delegated-administration-extension/delegated-administration-write-hook"
  - "/docs/extensions/delegated-administration-extension/delegated-administration-hooks/delegated-administration-write-hook"
  - "/docs/extensions/delegated-admin/hooks/write"
  - "/docs/extensions/delegated-admin/v2/hooks/write"
  - "/docs/extensions/delegated-admin/v3/hooks/write"
---
