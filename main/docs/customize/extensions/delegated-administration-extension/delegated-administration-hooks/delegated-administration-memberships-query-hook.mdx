...
redirects:
  - "/docs/extensions/delegated-administration-extension/delegated-administration-memberships-query-hook"
  - "/docs/extensions/delegated-administration-extension/delegated-administration-hooks/delegated-administration-memberships-query-hook"
  - "/docs/extensions/delegated-admin/hooks/membership"
  - "/docs/extensions/delegated-admin/v2/hooks/membership"
  - "/docs/extensions/delegated-admin/v3/hooks/membership"
---
