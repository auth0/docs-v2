...
redirects:
  - "/docs/extensions/delegated-administration-extension/delegated-administration-filter-hook"
  - "/docs/extensions/delegated-administration-extension/delegated-administration-hooks/delegated-administration-filter-hook"
  - "/docs/extensions/delegated-admin/hooks/filter"
  - "/docs/extensions/delegated-admin/v2/hooks/filter"
  - "/docs/extensions/delegated-admin/v3/hooks/filter"
---
