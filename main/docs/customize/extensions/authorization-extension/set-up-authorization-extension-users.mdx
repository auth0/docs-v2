---
'og:description': Learn how to set up users, groups, roles, and permissions in the
...
<Frame>![Authorization Extension Corporate Groups Diagram](https://images.ctfassets.net/cdy7uua7fh8z/jRZWY5HDZRf1dzXVI0L2C/19a192472218b704d675d9bec966ebd4/corporation.png)</Frame>
...
<Frame>![Authorization Extension Roles Permissions Diagram](https://images.ctfassets.net/cdy7uua7fh8z/5EOgccyg3hxlSu00MIEZ1f/8e38920f5b67a0dc2e51be0be1f532f6/roles-permissions.png)</Frame>
...
<Frame>![Authorization Extension Groups Roles Permissions Diagram](https://images.ctfassets.net/cdy7uua7fh8z/uAkCNyDbbGjUxDhWJPScV/6bec8d56519c319e4a3df683be7707c0/groups-roles-permissions.png)</Frame>
...
<Frame>![Dashboard - Extensions - Authorization Dashboard - Users](https://images.ctfassets.net/cdy7uua7fh8z/1ALaqm8mvtleQfm3XKvBtf/73fb69c35e2eed4dae74b1baa8e372a2/auth-dashboard-v2.png)</Frame>
...
* Opening the **group** and managing the group's users
  ...
  <Frame>![Dashboard - Extensions - Authorization Extension - Group Membership - Group Management](https://images.ctfassets.net/cdy7uua7fh8z/5mGdeDG5kWbbEm8NQK7h8L/8c9371d19b7987c0251086181353fc78/group-membership-v2.png)</Frame>
* Opening the **user** and managing the user's group membership(s)

  <Frame>![Dashboard - Extensions - Authorization Extension - Group Membership - User Management](https://images.ctfassets.net/cdy7uua7fh8z/3a5gnzfB6PNxvyeJ6Zjk6z/c4986b454485b34715bd9e2f428e1451/user-membership-v2.png)</Frame>
...
<Frame>![Dashboard - Extensions - Authorization Extensions Dashboard - Group Mapping](https://images.ctfassets.net/cdy7uua7fh8z/o77WUpuOKc5LOPZw2Bcu4/d0275f49951fbb114852f04ffd8acd19/group-mapping-v2.png)</Frame>
...
<Frame>![Dashboard - Extensions - Authorization Extensions Dashboard - Permissions](https://images.ctfassets.net/cdy7uua7fh8z/4nTv8DofRA0Xyz6mbJASCl/eeca2e8bd741b764a98ddfdfea24aee4/roles.png)</Frame>
...
<Frame>![Dashboard - Extensions - Authorization Extensions Dashboard - Add Role to User](https://images.ctfassets.net/cdy7uua7fh8z/3adPx2VSqkK7560VixOZLN/926e19500a0633f602469bb975f4a0f7/add-role-to-user.png)</Frame>
...
<Frame>![Dashboard - Extensions - Authorization Extensions Dashboard - Permissions](https://images.ctfassets.net/cdy7uua7fh8z/1KuY9kChurITXwOkfvT7Jd/44b2996aa8976acd0fd27b7360bd2c56/permissions.png)</Frame>
...
<Frame>![Dashboard - Extensions - Authorization Extensions Dashboard - Create Permissions](https://images.ctfassets.net/cdy7uua7fh8z/4iyUqIAjXwutcNa5pKjeie/6295453f5a9c956c006e481eabc6df0c/create-permission.png)</Frame>
