...
redirects:
  - "/docs/extensions/single-sign-on-dashboard-extension/create-sso-dashboard-application"
  - "/docs/dashboard/guides/extensions/sso-dashboard-create-app"
  - "/docs/get-started/dashboard/create-sso-dashboard-application"
---
