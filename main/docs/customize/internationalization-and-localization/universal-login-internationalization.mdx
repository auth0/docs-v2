...
* The `Accept-Language` HTTP header sent by the browserr, Auth0 renders the pages in this language if it is allowed by the settings above. If not, the pages render in the default language.
...
You can also specify the enabled languages for the tenant via the Management API using the [Update Tenants endpoint](https://auth0.com/docs/api/management/v2#!/Tenants/patch_settings). The first language in the list will be the default one.
...
<Warning>
Right-to-left language support is available in Early Access. To request this feature, [contact Auth0 Support](https://support.auth0.com/center/s/).  By using this feature, you agree to the applicable Free Trial terms in Okta’s [Master Subscription Agreement](https://www.okta.com/legal/). To learn more about Auth0's product release cycle, read [Product release stages](/docs/troubleshoot/product-lifecycle/product-release-stages).
</Warning>
