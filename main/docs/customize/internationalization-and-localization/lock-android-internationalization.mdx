---
description: Add internationalization support to your Android applications using Auth0 Lock for Android.
title: Lock.Android Internationalization
redirects:
  - "/docs/libraries/lock-android/lock-android-internationalization"
  - "/docs/libraries/lock-android/v1/internationalization"
  - "/docs/libraries/lock-android/v2/internationalization"
  - "/docs/i18n/i18n-guide-android"
---
By default, [**Lock.Android**](/docs/libraries/lock-android) displays all text in English. If you wish to display text in another language, you may provide a `strings.xml` file and define values to be used for the various text items that Lock might display.
...
For a full list of the names used by Lock, see the [default strings.xml file](https://github.com/auth0/Lock.Android/blob/main/lib/src/main/res/values/strings.xml) the Lock.Android repository.