...
<Frame>![Lock.swift: Localize](https://images.ctfassets.net/cdy7uua7fh8z/2dL3QXXrURBjNjyF5R0xYG/68cf0217f351bfb5e5a0bf45a7361b03/xcode_localize.png)</Frame>

Then select `English`:

<Frame>![Lock.swift: Localize English](https://images.ctfassets.net/cdy7uua7fh8z/2dffBsE133pnk0Y7Y0nxHU/8b82700bbd844d5df0864287b7a0acdf/xcode_localize_english.png)</Frame>
...
<Frame>![Lock.swift: Add language](https://images.ctfassets.net/cdy7uua7fh8z/3mHt6UmbEq7Xl05OZqtF70/20055f0037971f7b8c921d5902559b93/xcode_add_language.png)</Frame>

Add the new language and ensure that **Lock.strings** is selected

<Frame>![Lock.swift: Add Language step 2](https://images.ctfassets.net/cdy7uua7fh8z/6E7BZaCVtkHcCQFhEcgSTq/3314eb8142c03266b25ab84fbefbb8f6/xcode_add_language_step_2.png)</Frame>
