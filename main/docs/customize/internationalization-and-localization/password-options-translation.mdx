---
description: Translate the password requirement strings shown by Auth0 Lock so the password policy text users see during signup matches their locale.
title: Customize Translation of Lock Password Options
redirects:
  - "/docs/i18n/password-strength"
  - "/docs/i18n/password-options"
  - "/docs/i18n/password-options-translation"
---
