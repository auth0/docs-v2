---
title: "Create a Universal Portal"
...
Create your first Universal Portal using the CLI or the Dashboard. The CLI path provisions and configures everything in a single command, while the Dashboard path walks through the manual setup steps.
