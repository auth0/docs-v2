---
title: "Get started with Universal Portals"
...
<Callout icon="circle-exclamation" color="#F59E0B" iconType="regular">
  Universal Portals beta is for non-production tenants only.
</Callout>

## Prerequisites

- A non-production Auth0 tenant with beta access
...
- [Universal Portals overview](/docs/customize/portals/overview) - key features and how portals work
- [Universal Components](/docs/get-started/universal-components/universal-components-overview) - the component library used in portals
