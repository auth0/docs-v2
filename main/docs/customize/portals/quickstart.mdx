...
description: "Learn how to set up your first Universal Portal using the Auth0 CLI, Auth0 Agent Skill, or the Dashboard."
...
You can create a Universal Portal using:
...
<Tabs>
  ...
  <Tab title="Auth0 Agent Skills">
    ...
    ## Step 1: Install the Auth0 skill
    ...
    To learn more about agent skills, read [Auth0 Agent Skills](https://github.com/auth0/agent-skills).
