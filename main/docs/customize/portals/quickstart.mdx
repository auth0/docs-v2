...
description: "Set up your first Auth0 Universal Portal using the CLI or the Dashboard."
...
This guide walks you through creating your first portal. The CLI path provisions and configures everything in a single command. The Dashboard path walks through the manual setup steps.

<Warning>
  Universal Portals beta is for non-production tenants only.
</Warning>


<Accordion title="AI Skill" defaultOpen icon="microchip-ai" iconType="sharp-solid">
...
- A non-production Auth0 tenant with Universal Portals beta access
...
<CardGroup cols={3}>
  <Card title="Universal Portals overview" icon="key" href="/docs/customize/portals/overview">
    Learn about Universal Portals, uses cases, how it works, and key features.
  </Card>
