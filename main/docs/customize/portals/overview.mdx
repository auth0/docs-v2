...
This use case replaces the **My Account** page that every application builds from scratch.
...
This use case replaces the **My Organization** page that every B2B application builds from scratch.
