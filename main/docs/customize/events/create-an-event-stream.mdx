...
To provision your event stream using Terraform, you need a structured project directory. We recommend using the following configuration when setting this up for the first time:
