...
<Tabs><Tab title="Terraform">

<Note>
Before getting started with Terraform, ensure you have:
  * The Terraform CLI installed
  * The Auth0 CLI installed and authenticated via `auth0 login`
  * Your AWS Account ID and AWS region for configuring an EventBridge stream
