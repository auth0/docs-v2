...
title: Log Streams
redirects:
  - "/docs/deploy-monitor/logs/export-log-events-with-rules"
  - "/docs/monitor-auth0/streams"
  - "/docs/logs/streams"
  - "/docs/logs/export-log-events-with-log-streaming"
  - "/docs/monitor-auth0/logs/export-log-events-with-rules"
  - "/docs/logs/export-log-events-with-rules"
  - "/docs/monitoring/guides/send-events-to-segmentio"
  - "/docs/monitoring/guides/send-events-to-keenio"
  - "/docs/monitoring/guides/send-events-to-splunk"
---
...
If we fail to reach your server for 7 consecutive days, we'll automatically [pause](/docs/customize/log-streams/check-log-stream-health) the stream. You'll need to resolve the issue, and then resume the stream manually.
