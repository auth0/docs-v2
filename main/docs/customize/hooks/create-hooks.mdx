...
redirects:
  - "/docs/create-hooks"
  - "/docs/hooks/create-hooks"
  - "/docs/auth0-hooks/cli/create-delete"
  - "/docs/hooks/guides/create-hooks-using-dashboard"
  - "/docs/hooks/guides/create-hooks-using-cli"
  - "/docs/hooks/cli/create-delete"
  - "/docs/hooks/dashboard/create-delete"
  - "/docs/hooks/create"
---
...
| Value | Description |
| --- | --- |
| `MGMT_API_ACCESS_TOKEN` | Access Token for the Management API with the [scope](/docs/glossary?term=scope) `create:hooks`. To learn more, read [Management API Access Tokens](https://auth0.com/docs/api/management/v2/tokens). |
...
| `EXTENSIBILITY_POINT_NAME` | Name of the extensibility point for which the Hook should execute. Options include: `credentials-exchange`, `pre-user-registration`, `post-user-registration`, `post-change-password`. To learn more about extensibility points, read [Extensibiity Points](/docs/customize/actions/explore-triggers). |
