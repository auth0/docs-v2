...
| `MGMT_API_ACCESS_TOKEN` | Access Tokens for the Management API with the [scope](/docs/glossary?term=scope) `update:hooks`. To learn more, read [Management API Access Tokens](https://auth0.com/docs/api/management/v2/tokens). |
