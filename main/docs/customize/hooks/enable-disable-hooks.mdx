...
redirects:
  - "/docs/hooks/enable-disable-hooks"
  - "/docs/auth0-hooks/cli/enable-disable"
  - "/docs/hooks/guides/enable-disable-hooks-using-dashboard"
  - "/docs/hooks/guides/enable-disable-hooks-using-cli"
  - "/docs/hooks/dashboard/enable-disable"
  - "/docs/hooks/cli/enable-disable"
  - "/docs/hooks/enable-disable"
---
...
You can enable or disable hooks using the Dashboard or <Tooltip tip="Management API: A product to allow customers to perform administrative tasks." cta="View Glossary" href="/docs/glossary?term=Management+API">Management API</Tooltip>.
