...
<tbody>
<tr>
<td><a href="/docs/customize/events/event-types">Events Types </a></td>
<td>How to work with supported event types.</td>
</tr>
<tr>
<td><a href="/docs/customize/events/create-an-event-stream">Create an Event Stream</a></td>
<td>How to create an Event Stream with AWS EventBridge or webhooks.</td>
</tr>
<tr>
<td><a href="/docs/customize/events/event-testing-observability-and-failure-recovery">Event Testing, Observability, and Failure Recovery</a></td>
<td>How to test and manage your active event streams.</td>
</tr>
<tr>
<td><a href="/docs/customize/events/events-best-practices">Events Best Practices</a></td>
