...
| --- | --- |
| Body | The payload of Auth0 user properties to add. To learn more, read [Create a user](/docs/api/management/v2/users/post-users) API documentation. |

### Output object

Review [Create a user](/docs/api/management/v2/users/post-users#response-messages) for expected response and status code.
...
| Parameter | Description |
| --- | --- |
| User ID | ID of the user to retrieve. To learn more, read [Get a user](/docs/api/management/v2/users/get-users-by-id) API documentation. |

### Output object

Review [Get a user](/docs/api/management/v2/users/get-users-by-id#response-messages) for expected response and status code.
...
| Body | The payload of Auth0 user properties to update. To learn more, read [Update a user](/docs/api/management/v2/users/patch-users-by-id) API documentation. |

### Output object

You can find the expected response and status codes at [Update a user](/docs/api/management/v2/users/patch-users-by-id#response-messages) API documentation.
...
Review [Auth0 Management API](/docs/api/management/v2) for expected responses and status codes.
...
Subject and Message can use a combination of Liquid syntax with [common variables](/docs/customize/email/email-templates/supported-liquid-syntax) or custom variables using `{{custom_vars.your_variable_key}}` syntax.
...
Send a custom SMS using your [configured phone provider](/docs/customize/phone-messages/configure-phone-messaging-providers).

<Warning>
[Phone Provider](/docs/customize/phone-messages/configure-phone-messaging-providers) must be enabled for text message delivery before using this Action.
</Warning>
...
<Callout icon="file-lines" color="#0EA5E9" iconType="regular">
Message can use a combination of Liquid syntax with [common variables](/docs/customize/email/email-templates/supported-liquid-syntax) or custom variables using `{{custom_vars.your_variable_key}}` syntax.
...
Send a custom voice message using your [configured phone provider](/docs/customize/phone-messages/configure-phone-messaging-providers).

<Warning>
[Phone Provider](/docs/customize/phone-messages/configure-phone-messaging-providers) must be enabled  for voice message delivery before using this Action.
</Warning>
