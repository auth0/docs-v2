...
Review [Create a user](/docs/api/management/v2/users/post-users) for expected response and status code.
...
Review [Get a user](/docs/api/management/v2/users/get-users-by-id) for expected response and status code.
...
You can find the expected response and status codes at [Update a user](/docs/api/management/v2/users/patch-users-by-id) API documentation.
