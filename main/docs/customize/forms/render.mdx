...
* The same form can not be rendered more than once across the same trigger.
  For example, if you have a `post-login` trigger with two Actions, you can not render the same form in both Actions, you need to create different Forms for each Action.
