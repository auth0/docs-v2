...
redirects:
  - "/docs/monitor-auth0/streams/custom-log-streams"
  - "/docs/logs/streams/stream-http-event-logs"
  - "/docs/logs/streams/http-event"
  - "/docs/logs/export-log-events-with-log-streaming/stream-http-event-logs"
  - "/docs/customize/extensions/export-log-events-with-extensions/auth0-logs-to-sumo-logic"
  - "/docs/extensions/log-export-extensions/auth0-logs-to-sumo-logic"
  - "/docs/extensions/sumologic"
  - "/docs/extensions/auth0-logs-to-sumo-logic"
  - "/docs/customize/extensions/export-log-events-with-extensions/export-logs-to-splunk"
  - "/docs/extensions/log-export-extensions/export-logs-to-splunk"
  - "/docs/extensions/splunk"
  - "/docs/extensions/export-logs-to-splunk"
  - "/docs/customize/extensions/export-log-events-with-extensions/export-logs-to-segment"
  - "/docs/extensions/log-export-extensions/export-logs-to-segment"
  - "/docs/extensions/segment"
  - "/docs/extensions/export-logs-to-segment"
  - "/docs/customize/extensions/export-log-events-with-extensions/export-logs-to-papertrail"
  - "/docs/extensions/log-export-extensions/export-logs-to-papertrail"
  - "/docs/extensions/papertrail"
  - "/docs/extensions/export-logs-to-papertrail"
  - "/docs/customize/extensions/export-log-events-with-extensions/export-logs-to-mixpanel"
  - "/docs/extensions/log-export-extensions/export-logs-to-mixpanel"
  - "/docs/extensions/mixpanel"
  - "/docs/extensions/export-logs-to-mixpanel"
  - "/docs/customize/extensions/export-log-events-with-extensions/export-logs-to-logstash"
  - "/docs/extensions/log-export-extensions/export-logs-to-logstash"
  - "/docs/extensions/logstash"
  - "/docs/extensions/export-logs-to-logstash"
  - "/docs/customize/extensions/export-log-events-with-extensions/export-logs-to-loggly"
  - "/docs/extensions/log-export-extensions/export-logs-to-loggly"
  - "/docs/extensions/loggly"
  - "/docs/extensions/export-logs-to-loggly"
  - "/docs/customize/extensions/export-log-events-with-extensions/export-logs-to-logentries"
  - "/docs/extensions/log-export-extensions/export-logs-to-logentries"
  - "/docs/extensions/logentries"
  - "/docs/extensions/export-logs-to-logentries"
  - "/docs/customize/extensions/export-log-events-with-extensions/export-logs-to-azure-blob-storage"
  - "/docs/extensions/log-export-extensions/export-logs-to-azure-blob-storage"
  - "/docs/extensions/azure-blob-storage"
  - "/docs/extensions/export-logs-to-azure-blob-storage"
  - "/docs/customize/extensions/export-log-events-with-extensions/export-logs-to-cloudwatch"
  - "/docs/extensions/log-export-extensions/export-logs-to-cloudwatch"
  - "/docs/extensions/cloudwatch"
  - "/docs/extensions/export-logs-to-cloudwatch"
  - "/docs/customize/extensions/export-log-events-with-extensions/export-logs-to-application-insights"
  - "/docs/extensions/log-export-extensions/export-logs-to-application-insights"
  - "/docs/extensions/application-insight"
  - "/docs/extensions/export-logs-to-application-insights"
  - "/docs/customize/extensions/export-log-events-with-extensions"
  - "/docs/extensions/log-export-extensions"
  - "/docs/logs/log-export-extensions"
  - "/docs/logs/export-log-events-with-extensions"
---
