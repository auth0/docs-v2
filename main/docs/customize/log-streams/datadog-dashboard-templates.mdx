...
redirects:
  - "/docs/monitor-auth0/streams/datadog-dashboard-templates"
  - "/docs/logs/streams/datadog-dashboard-templates"
  - "/docs/logs/export-log-events-with-log-streaming/datadog-dashboard-templates"
---
