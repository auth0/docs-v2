...
---
[Forms](https://auth0.com/features/forms) is a visual editor that allows you to create customizable forms that can extend your identity flows with additional steps and business logic.
