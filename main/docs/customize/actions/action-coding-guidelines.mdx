...
* Use [transaction metadata](/docs/customize/actions/transaction-metadata/transaction-metadata-overview) to share data between [post-login triggers](/docs/customize/actions/explore-triggers/signup-and-login-triggers/login-trigger) during the same execution.
