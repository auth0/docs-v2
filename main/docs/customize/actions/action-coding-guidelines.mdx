...
* Action Modules versions are not upgraded automatically at the Actions, preventing potential breakage when the upgrade is not compatible with the Action.
