...
#
description: Learn about the post-change-password Action trigger's API object, which provides methods for modifying the behavior of the trigger execution.
title: 'API Object'
