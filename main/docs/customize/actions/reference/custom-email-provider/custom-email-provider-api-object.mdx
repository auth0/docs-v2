...
#
description: Reference the custom-email-provider Action trigger API object, which includes methods to deliver or drop email notifications through your provider.
title: 'API Object'
sidetitle: 'API Object'
