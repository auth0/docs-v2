...
#
description: Learn about the custom-phone-provider Action trigger's API object, which provides methods for modifying the behavior of the trigger execution.
title: 'API Object'
...
<ParamField body="api.notification.drop(reason)" type="void">
...
<ParamField body="api.notification.retry(reason)" type="void">
