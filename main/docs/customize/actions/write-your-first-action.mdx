...
* [Publish the Action Module](#deploy-the-action-module)
...
Because this Action Module will be sending messages to an external service, you need to follow the service specifications to send a compatible an HTTP request.
