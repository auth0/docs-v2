...
redirects:
  - "/docs/customize/actions/flows-and-triggers/login-flow/redirect-with-actions"
  - "/docs/customize/actions/triggers/post-login/redirect-with-actions"
  - "/docs/actions/triggers/post-login/redirect-with-actions"
  - "/docs/customize/actions/explore-triggers/signup-and-login-triggers/login-trigger/redirect-with-actions"
---
