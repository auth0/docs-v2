...
<Steps titleSize="h3">
  <Step title="Create an Action Module">
  ...
  <Step title="Publish the Action Module">
  ...
  <Step title="Add the Action Module in an Action">
  ...
  <Step title="Use the Action Module in the Action">
