...
<Steps titleSize="h3">
  <Step title="Create an Action Module" stepNumber={1}>
    ...
    <Tabs>
      ...
      <Tab title="Management API">
        ...
        2. Call [Create an Actions Module](/docs/api/management/v2/actions/post-action-module):
      ...
      <Tab title="Auth0 CLI">
        ...
        Call [Create an Actions Module](/docs/api/management/v2/actions/post-action-module) with `auth0 api`:
  ...
  <Step title="Add a Secret" stepNumber={2}>
    ...
    <Tabs>
      <Tab title="Dashboard">
        Next, store the external service URL as a Secret.
      ...
      <Tab title="Management API">
        Next, store the external service URL as a Secret. Call [Update an Actions Module](/docs/api/management/v2/actions/patch-action-module) with the `update:actions` scope:
      ...
      <Tab title="Auth0 CLI">
        Next, store the external service URL as a Secret. Call [Update an Actions Module](/docs/api/management/v2/actions/patch-action-module) with `auth0 api`:
      ...
      <Tab title="Terraform">
        Next, store the external service URL as a Secret using a `secrets` block:
        ...
        <Callout icon="file-lines" color="#0EA5E9" iconType="regular">
          We do not support partial management of `secrets`. Each `terraform apply` sends the complete list of secrets defined on the resource.
        </Callout>
      </Tab>
      <Tab title="Auth0 Deploy CLI">
        Next, store the external service URL as a Secret.
  ...
  <Step title="Add Custom Logic" stepNumber={3}>
    ...
    <Tabs>
      ...
      <Tab title="Management API">
        Call [Update an Actions Module](/docs/api/management/v2/actions/patch-action-module) with the following request:
      ...
      <Tab title="Auth0 CLI">
        ...
        Then pipe it into [Update an Actions Module](/docs/api/management/v2/actions/patch-action-module) via `auth0 api`:
  ...
  <Step title="Save the Draft" stepNumber={4}>
    ...
    <Tabs>
      ...
      <Tab title="Management API">
        There is no separate "save" call. Every [Update an Actions Module](/docs/api/management/v2/actions/patch-action-module) request in the previous steps already persisted your changes to the module's draft. You can confirm this with [Get an Actions Module](/docs/api/management/v2/actions/get-action-module):
      ...
      <Tab title="Auth0 CLI">
        There is no separate "save" call. Every `auth0 api patch actions/modules/{moduleId}` request in the previous steps already persisted your changes to the module's draft. You can confirm this with [Get an Actions Module](/docs/api/management/v2/actions/get-action-module):
      ...
      <Tab title="Auth0 Deploy CLI">
        Set `all_changes_published` to `false` on the module's entry.
        ...
        <Tabs>
          <Tab title="YAML">
            ...
            Redeploy the configuration to publish the change:
          ...
          <Tab title="Directory (JSON)">
            Update `action-modules/logger.json`:
  ...
  <Step title="Publish the Action Module" stepNumber={5}>
    ...
    <Tabs>
      ...
      <Tab title="Management API">
        Call [Create an Actions Module Version](/docs/api/management/v2/actions/post-action-module-version), which takes a snapshot of the current draft and publishes it:
      ...
      <Tab title="Auth0 CLI">
        Call [Create an Actions Module Version](/docs/api/management/v2/actions/post-action-module-version) with `auth0 api`, which takes a snapshot of the current draft and publishes it:
      ...
      <Tab title="Auth0 Deploy CLI">
        Set `all_changes_published` to `true` on the module's entry.
        ...
        This publishes a new **Action Module Version** from the current draft after applying your changes.
      </Tab>
    </Tabs>
  ...
  <Step title="Add the Action Module in an Action" stepNumber={6}>
    Next, add the Action Module in an Action.
    ...
    <Tabs>
      ...
      <Tab title="Management API">
        Call [Update an Action](/docs/api/management/v2/actions/patch-action) with the module's `module_id` and `module_version_id` from the previous step:
      ...
      <Tab title="Auth0 CLI">
        <Callout icon="file-lines" color="#0EA5E9" iconType="regular">
          [`auth0 actions update`](https://auth0.github.io/auth0-cli/auth0_actions_update.html) has no flag for Action Modules, so call [Update an Action](/docs/api/management/v2/actions/patch-action) directly with `auth0 api`, using the module's `module_id` and `module_version_id` from the previous step:
        </Callout>
  ...
  <Step title="Use the Action Module in the Action" stepNumber={7}>
    ...
    <Tabs>
      ...
      <Tab title="Management API">
        1. Call [Update an Action](/docs/api/management/v2/actions/patch-action) to add the `require` statement and the call to `logger.sendLog` to the Action's `code`:
        ...
        2. Call [Deploy an Action](/docs/api/management/v2/actions/post-deploy-action):
...
<Accordion title="NPM Dependencies">
  ...
  <Tabs>
    ...
    <Tab title="Management API">
      Call [Update an Actions Module](/docs/api/management/v2/actions/patch-action-module) with a `dependencies` array:
    ...
    <Tab title="Auth0 CLI">
      Call [Update an Actions Module](/docs/api/management/v2/actions/patch-action-module) with `auth0 api`, using a `dependencies` array:
