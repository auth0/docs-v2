---
description: Understand Auth0 Actions Modules, a feature that lets you create reusable Auth0-hosted code with its own secrets and NPM dependencies to share functions across multiple Actions bound to different triggers.
...
By adopting Actions Modules according to the [Coding Guidelines](/docs/customize/actions/action-coding-guidelines), you can improve execution performance by sharing and reusing objects that have a costly instantiation process.
