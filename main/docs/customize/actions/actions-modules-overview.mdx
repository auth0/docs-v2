---
description: Describes how Auth0 Actions Modules work and what you can accomplish with them.
title: Understand How Auth0 Actions Modules Work
---
<Warning>
...
<td>Triggers when using a custom provider to send the messages for the enrollment and the challenge process. Does not run for social connection.</td>
</tr>
</tbody>
</table>
