...
'og:title': MFA Notifications Triggers
...
'twitter:description': Learn about Action's Send Phone Message flow and the send-phone-message
  Action trigger, which runs for the enrollment and challenge process if you have
  used SMS as a factor for Multi-factor Authentication (MFA).
'twitter:title': MFA Notifications Triggers
---
...
<Frame>![Diagram of the Actions Send Phone Message Flow.](https://images.ctfassets.net/cdy7uua7fh8z/FSkVXDdknDJq1hsK08EYu/e031ec0067a5460afae8d9ed5d462288/send-phone-message-flow.png)</Frame>
