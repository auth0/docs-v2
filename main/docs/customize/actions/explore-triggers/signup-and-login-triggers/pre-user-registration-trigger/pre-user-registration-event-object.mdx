---
description: Learn about the pre-user-registration Action trigger's event object,
...
<code>correlation_id</code> <em>Optional String</em>.
            <span>A unique 64 character value used to track events, such as MFA enrollment, successful login, and sign up. To learn more, read [Auth0 Universal Login](main/docs/authenticate/login/auth0-universal-login#correlated-events)</span>
</li>
<li>
