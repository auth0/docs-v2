        ...
        <ul>
          ...
          <li>
            ...
            <ul>
              ...
              <li><code>oidc-ciba-web-link</code> — Client-Initiated Backchannel Authentication, executing during a CIBA flow, once the user has logged into the verification web link.</li>
