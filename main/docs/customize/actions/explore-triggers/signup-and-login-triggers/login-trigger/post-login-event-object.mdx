    ...
    <tr>
      ...
      <td>
        ...
        <ul>
          ...
          <li><code>metadata</code> <em>Dictionary</em> — [Early Access] Refresh Token Metadata.</li>
          <li>
    ...
    <tr>
      ...
      <td>
        ...
        <ul>
          ...
          <li><code>last_interacted_at</code> <em>Optional string</em> — [Enterprise Customers] Last interaction time.</li>
          <li><code>metadata</code> <em>Optional dictionary</em> — [Private Early Access] Session Metadata.</li>
          <li>
            <code>session_transfer</code> <em>Optional object</em> — [Private Early Access] Defined when the session is created from a session transfer token (Native to Web SSO).<br/>
            Includes:
            <ul>
...
<code>correlation_id</code> <em>Optional string</em>.
            <span><Warning>Correlate events is currently in Limited Early Access. By using this feature, you agree to the applicable Free Trial terms in Okta’s [Master Subscription Agreement](https://www.okta.com/legal)</Warning>A unique 64 character value used to track events, such as MFA enrollment, successful login, and sign up. To learn more, read [Configure Correlated Events](/docs/authenticate/login/configure-correlated-events).</span>
</li>
          ...
          <li>
            ...
            <ul>
              ...
              <li><code>oidc-ciba-web-link</code> — Client-Initiated Backchannel Authentication, which is executed during a CIBA flow once the user has logged in using the verification web link.</li>
