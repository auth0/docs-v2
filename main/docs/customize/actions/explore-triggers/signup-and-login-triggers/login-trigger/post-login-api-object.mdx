  ...
  <table class="table">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>
          <p>
            <em>String</em>. The value of the metadata property. No special characters and a maximum of 256 characters. Setting to <code>null</code> removes the metadata property. 
          </p>
        </td>
      </tr>
    </tbody>
