...
Read Enterprise Groups synced from an Enterprise connection that the user is a member of. Requires Inbound SCIM or Google Workspace dirctory sync to be enabled for the connection.
