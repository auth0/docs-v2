...
redirects:
  - "/docs/customize/actions/flows-and-triggers/send-phone-message-flow"
  - "/docs/customize/actions/triggers/send-phone-message"
  - "/docs/actions/triggers/send-phone-message"
  - "/docs/customize/actions/explore-triggers/mfa-notifications-trigger"
---
