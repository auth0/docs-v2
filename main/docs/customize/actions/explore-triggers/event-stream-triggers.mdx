...
Event Stream Actions are logic-based functions executed asynchronously when specific events occur within your Auth0 tenant. These are non-blocking actions and won't impact the latency of your user's experience. 
