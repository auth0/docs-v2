...
* [Event object](/docs/customize/actions/reference/event-stream/event-stream-event-object): Provides context for both Event Stream message and Action execution.
* [API object](/docs/customize/actions/explore-triggers/event-stream/event-stream-api-object): Provides methods to modify the flow behavior.
