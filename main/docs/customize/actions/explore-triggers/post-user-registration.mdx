---
description: Learn about Post User Registration Actions, which run after a user has been created for a Database or Passwordless connection.
title: Post User Registration
sidebarTitle: Post User Registration
---
Post-user Registration Actions run after a user is added to a Database or <Tooltip tip="Passwordless: Form of authentication that does not rely on a password as the first factor." cta="View Glossary" href="/docs/glossary?term=Passwordless">Passwordless</Tooltip> Connection.
