...
redirects:
  - "/docs/auth0-hooks/extensibility-points/post-user-registration"
  - "/docs/customize/actions/flows-and-triggers/post-user-registration-flow"
  - "/docs/customize/actions/triggers/post-user-registration"
  - "/docs/actions/triggers/post-user-registration"
  - "/docs/customize/actions/explore-triggers/signup-and-login-triggers/post-user-registration-trigger"
---
