---
description: Learn about Pre User Registration Actions, which are excuted when a user attempts to register through a Database or Passwordless connection. They can be used to add metadata to the user profile before it is created or to deny a registration.
