...
redirects:
  - "/docs/customize/actions/flows-and-triggers/post-change-password-flow"
  - "/docs/customize/actions/triggers/post-change-password"
  - "/docs/actions/triggers/post-change-password"
  - "/docs/customize/actions/explore-triggers/password-reset-triggers/post-change-password-trigger"
---
