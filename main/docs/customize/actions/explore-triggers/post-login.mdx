...
redirects:
  - "/docs/customize/actions/flows-and-triggers/login-flow"
  - "/docs/customize/actions/triggers/post-login"
  - "/docs/actions/triggers/post-login"
  - "/docs/customize/actions/explore-triggers/signup-and-login-triggers/login-trigger"
---
