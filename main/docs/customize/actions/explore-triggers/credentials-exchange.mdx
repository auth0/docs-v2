...
redirects:
  - "/docs/customize/actions/explore-triggers/machine-to-machine-trigger"
  - "/docs/customize/actions/flows-and-triggers/machine-to-machine-flow"
  - "/docs/customize/actions/triggers/credentials-exchange"
  - "/docs/actions/triggers/credentials-exchange"
---
