...
---
This guide demonstrates how to create and deploy your first Action Module using the <Tooltip tip="Auth0 Dashboard: Auth0's main product to configure your services." cta="View Glossary" href="/docs/glossary?term=Auth0+Dashboard">Auth0 Dashboard</Tooltip>. This includes the foundation of writing any Action, regardless of its purpose or the flow.
