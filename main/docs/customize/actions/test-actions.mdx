---
description: Test and debug Auth0 Actions by running sample payloads in the Actions Code Editor or Management API, verifying end-to-end flows with tenant logs, and unit testing your handler code with mocked event and API objects.
title: Test Actions
---
