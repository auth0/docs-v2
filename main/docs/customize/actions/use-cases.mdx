---
description: Browse a curated index of example Auth0 Actions implementations to quickstart your own custom logic.
title: Action Use Cases
redirects:
  - "/docs/customize/rules/use-cases/track-new-sign-ups-in-salesforce"
  - "/docs/rules/use-cases/track-new-sign-ups-in-salesforce"
  - "/docs/monitor-auth0/track-new-sign-ups-in-salesforce"
  - "/docs/scenarios/mixpanel-fullcontact-salesforce"
  - "/docs/scenarios-mixpanel-fullcontact-salesforce"
  - "/docs/tutorials/track-signups-enrich-user-profile-generate-leads"
  - "/docs/monitoring/guides/track-signups-salesforce"
  - "/docs/customize/rules/use-cases/track-new-leads-in-salesforce"
  - "/docs/rules/use-cases/track-new-leads-in-salesforce"
  - "/docs/monitor-auth0/track-new-leads-in-salesforce"
  - "/docs/scenarios/rapleaf-salesforce"
  - "/docs/scenarios-rapleaf-salesforce"
  - "/docs/tutorials/tracking-new-leads-in-salesforce-and-raplead"
  - "/docs/monitoring/guides/track-leads-salesforce"
  - "/docs/customize/rules/use-cases"
  - "/docs/rules/use-cases"
  - "/docs/rules/references/use-cases"
  - "/docs/customize/rules/use-cases/integrate-salesforce"
  - "/docs/rules/integrate-salesforce"
  - "/docs/rules/guides/integrate-salesforce"
  - "/docs/customize/rules/use-cases/integrate-mixpanel"
  - "/docs/rules/integrate-mixpanel"
  - "/docs/rules/guides/integrate-mixpanel"
  - "/docs/customize/rules/use-cases/integrate-maxmind"
  - "/docs/rules/integrate-maxmind"
  - "/docs/rules/guides/integrate-maxmind"
  - "/docs/customize/rules/use-cases/integrate-hubspot"
  - "/docs/rules/integrate-hubspot"
  - "/docs/rules/guides/integrate-hubspot"
  - "/docs/customize/rules/use-cases/integrate-erfm-solutions"
  - "/docs/rules/integrate-erfm-solutions"
  - "/docs/rules/guides/integrate-erfm-solutions"
  - "/docs/customize/rules/use-cases/integrate-efm-solutions"
  - "/docs/rules/integrate-efm-solutions"
  - "/docs/rules/guides/integrate-efm-solutions"
  - "/docs/customize/rules/use-cases/integrate-user-id-verification"
  - "/docs/rules/integrate-user-id-verification"
  - "/docs/rules/guides/integrate-user-id-verification"
  - "/docs/customize/rules/use-cases/automatically-generate-leads-in-shopify"
  - "/docs/rules/automatically-generate-leads-in-shopify"
  - "/docs/rules/guides/automatically-generate-leads-shopify"
  - "/docs/rules/guides/automatically-generate-leads-in-shopify"
---
