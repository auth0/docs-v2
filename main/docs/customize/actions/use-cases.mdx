...
* [Exchange an existing Auth0 token to access another audience on behalf of the same user](/docs/authenticate/custom-token-exchange#use-case:-get-auth0-tokens-for-another-audience)
