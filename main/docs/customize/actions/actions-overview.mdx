...
---
[Actions](https://auth0.com/features/actions) are secure, tenant-specific, [versioned](/docs/customize/actions/manage-versions) functions written in Node.js that execute at certain points within the Auth0 platform. Actions are used to customize and extend Auth0's capabilities with custom logic.
...
* Create, manage, and share functions between Actions using [Actions Modules](/docs/customize/actions/modules).
...
* [Migrate from Actions Beta to Final](/docs/customize/actions/migrate)
