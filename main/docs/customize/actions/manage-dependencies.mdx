---
description: Add npm registry packages as dependencies to Auth0 Actions using the Actions Code Editor in the Auth0 Dashboard or the Management API and review security guidance and native and private module limitations.
...
auth0 api post "actions/actions" \
  --data '{              "name":"my-action",              "supported_triggers":[{"id":"post-login","version":"v2"}],              "code":"module.exports = () => {}",             "dependencies": [{                 "name":"lodash",                 "version":"4.17.21"             }],             "runtime":"node14"         }'
```
