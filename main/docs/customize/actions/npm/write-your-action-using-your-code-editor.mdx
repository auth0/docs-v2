...
<Steps titleSize="h3">
  <Step title="Install the package" stepNumber={1}>
  ...
  <Step title="Import the type definitions" stepNumber={2}>
  ...
  <Step title="Configure your project" stepNumber={3}>
  ...
  <Step title="Write your Action code" stepNumber={4}>
