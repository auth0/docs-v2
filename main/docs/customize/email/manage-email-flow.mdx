...
Outside of the change password link workflow, you can use the [Create a password change ticket](https://auth0.com/docs/api/management/v2/tickets/post-password-change) endpoint to generate password change tickets and customize the 
