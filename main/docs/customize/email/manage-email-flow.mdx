...
Outside of the email verification workflow, you can use the [Send an email address verification email endpoint](https://auth0.com/docs/api/management/v2/jobs/post-verification-email) to send these emails on demand.
