...
redirects:
  ...
  - "/docs/attack-protection/customize-blocked-account-emails"
  - "/docs/anomaly-detection/customize-blocked-account-emails"
  - "/docs/anomaly-detection/guides/customize-blocked-account-emails"
---
