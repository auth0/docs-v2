...
This page lists the variables, filters, and tags supported in email templates.

Some email templates have additional variables available that are relevant to that specific type of email, which you can view in the [email template reference](/docs/customize/email/email-templates/email-template-reference).
