...
redirects:
  ...
  - "/docs/auth0-email-services/email-template-descriptions"
  - "/docs/email/customize-email-templates/email-template-descriptions"
  - "/docs/email/customize-email-templates"
  - "/docs/auth0-email-services/spa-redirect"
  - "/docs/email/spa-redirect"
  - "/docs/auth0-email-services/customize-email-templates"
