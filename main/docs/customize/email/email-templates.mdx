...
* You can only use one template for each type of email, but you can use Liquid to implement conditionals and other logic for use cases like multilingual emails.
