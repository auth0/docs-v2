...
redirects:
  - "/docs/email/send-email-invitations-for-application-signup"
  - "/docs/auth0-email-services/send-email-invitations-for-application-signup"
  - "/docs/tutorials/creating-invite-only-applications"
  - "/docs/invite-only"
  - "/docs/design/creating-invite-only-applications"
---
