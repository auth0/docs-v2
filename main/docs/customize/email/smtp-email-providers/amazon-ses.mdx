---
title: Configure Amazon Simple Email Service (SES) as an External SMTP Provider
sidebarTitle: Configure Amazon SES
description: Instructions on how to configure Amazon Simple Email Service (SES) as an SMTP email provider with Auth0.
