---
title: Configure an Email Provider using SMTP Server Details
sidebarTitle: Configure an SMTP Server
description: Configure your tenant with SMTP server details to send emails in production and to use email templates to customize their appearance and content.
