---
title: Configure Mailgun as an External SMTP Provider
sidebarTitle: Configure Mailgun
description: Instructions on how to configure Mailgun as an external SMTP email provider with Auth0.
