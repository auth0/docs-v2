...
description: Diagnose and resolve Auth0 SMTP email provider failures, including authentication errors and provider-side throttling rejections that block delivery.
---
