---
title: Configure SparkPost as an External SMTP Email Provider
sidebarTitle: Configure SparkPost
description: Instructions on how to configure SparkPostas an SMTP email provider with Auth0.
