---
title: Configure a Custom Action for an Email Provider
sidebarTitle: Overview
description: Write an Action to connect to your SMTP email provider and implement custom logic for your use case.
Learn how to set up a code-based custom email provider.
'og:image': https://cdn2.auth0.com/docs/1.14553.0/img/share-image.png
---

As an alternative to using our SMTP email provider integrations or SMTP server details, you can set up an external SMTP provider by writing an <Tooltip tip="Action: A Node.js function that executes at defined points during the Auth0 runtime." cta="View Glossary" href="/docs/glossary?term=MFA">Action</Tooltip> using our [Actions Code Editor](/docs/customize/actions/actions-overview).

Because you write the code for your Action, you can integrate with any email provider's API or SMTP server. This gives you more control over the email delivery process and lets you implement logic for your use case, such as:
...
## Configure a Custom Email Provider with the Auth0 Dashboard
...
<Frame>![](/docs/images/cdy7uua7fh8z/5PvLzDdJEAbPoEbpLylw1D/c786a5946b44a7b015761e7fef87b76d/Custom_Email_Provider_-_English.png)</Frame>
...
<Frame>![](/docs/images/cdy7uua7fh8z/7El50nFDBDQG90i99iJEoe/b9451dc4ab9a83e03124bc33eecc2cec/expanded_editor.png)</Frame>
