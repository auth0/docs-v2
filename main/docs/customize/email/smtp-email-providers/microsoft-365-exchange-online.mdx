---
title: Configure Microsoft 365 Exchange Online as an External SMTP Provider
sidebarTitle: Configure Microsoft 365 Exchange Online
description: Instructions on how to configure 365 Exchange Online as an SMTP email provider with Auth0.
