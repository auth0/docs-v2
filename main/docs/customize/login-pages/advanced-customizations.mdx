...
With ACUL, you can write code in your preferred framework, integrate your existing analytics and A/B testing platforms, and define the user-experience. The [ACUL SDKs](/docs/libraries#advanced-customization-for-universal-login-acul) act as the connection between your custom code and Universal Login.
