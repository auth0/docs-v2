...
redirects:
  - "/docs/brand-and-customize/customize-consent-prompts"
  - "/docs/customize/universal-login-pages/customize-consent-prompts"
  - "/docs/scopes/current/guides/customize-consent-prompt"
  - "/docs/scopes/customize-consent-prompts"
---
