---
description: Override the Classic Login error messages using Auth0 Lock to match your application's tone and explanations.
title: Customize Lock Error Messages
redirects:
  - "/docs/brand-and-customize/customize-lock-error-messages"
  - "/docs/customize/customize-lock-error-messages"
  - "/docs/libraries/lock/customizing-error-messages"
  - "/docs/libraries/lock/v11/customizing-error-messages"
  - "/docs/libraries/lock/customize-lock-error-messages"
---
