...
With [Auth0's library for Web](/docs/libraries/auth0-single-page-app-sdk), you can customize the behavior and flow of the process used to trigger signup and authentication. You can also directly use the Authentication API, without any wrapper at all, if you so choose.
