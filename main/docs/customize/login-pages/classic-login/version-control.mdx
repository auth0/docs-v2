...
redirects:
  - "/docs/brand-and-customize/version-control-universal-login-pages"
  - "/docs/customize/universal-login-pages/version-control"
  - "/docs/customize/universal-login-pages/version-control-universal-login-pages"
  - "/docs/hosted-pages/version-control"
  - "/docs/universal-login/version-control"
  - "/docs/universal-login/version-control-universal-login-pages"
---
