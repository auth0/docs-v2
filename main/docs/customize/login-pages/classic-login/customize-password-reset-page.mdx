---
description: Customize the Classic Login password reset page to match the styling of your application.
title: Customize Classic Password Reset Page
redirects:
  - "/docs/brand-and-customize/customize-password-reset-page"
  - "/docs/customize/universal-login-pages/customize-password-reset-page"
  - "/docs/hosted-pages/password-reset"
  - "/docs/universal-login/password-reset"
  - "/docs/universal-login/customize-password-reset-page"
---
