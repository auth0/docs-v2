...
redirects:
  - "/docs/brand-and-customize/custom-error-pages"
  - "/docs/customize/universal-login-pages/custom-error-pages"
  - "/docs/hosted-pages/custom-error-pages"
  - "/docs/error-pages/custom"
  - "/docs/universal-login/custom-error-pages"
---
...
1. Navigate to [Auth0 Dashboard > Settings](https://manage.auth0.com/#/tenant/).
2. On the **General** tab, find the **Error Pages** section.
3. For **Default Error Page**, select **Custom**.
4. In the **Custom error page URL** field that appears, enter the URL of the error page you want your users to see.
5. Select **Save**.
