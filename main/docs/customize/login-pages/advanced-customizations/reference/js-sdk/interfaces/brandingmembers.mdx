...
The `brandingMembers` interface provides branding-related configurations, such as theme settings, colors, logos, and fonts for customizing authenticatin screens.
