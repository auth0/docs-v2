...
<ParamField body="useMfaPolling(options?)" type={<span><a href="/docs/customize/login-pages/advanced-customizations/reference/react-sdk/API-Reference/Types/interfaces/MfaPollingResult">MfaPollingResult</a></span>}>
...
[MfaPollingOptions](/docs/customize/login-pages/advanced-customizations/reference/react-sdk/API-Reference/Types/type-aliases/MfaPollingOptions) specifying the polling interval, success callback (`onCompleted`), and optional error handler (`onError`).
</ParamField>
