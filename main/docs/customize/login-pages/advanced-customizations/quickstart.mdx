...
The UL context inspector opens a new browser window with the Login Id screen. 
...
Using the UL Context Inspector, you can customize the default context data to test your authentication screens against tenant specific configurations.

1. Create a local version of the mock context data for a screen in your project:

Select the **Donwload JSON** icon to download the mock context data file. 


2. Rename and move the download file to the 

3 select lcoal development
