...
Universal Login provides a number of [prompts](https://auth0.com/docs/customize/login-pages/universal-login/customize-signup-and-login-prompts#terminology), or steps in the authentication process, each step includes at least one screen. You can use ACUL to apply a theme to all your custom screens.  
