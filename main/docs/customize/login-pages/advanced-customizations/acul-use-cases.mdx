---
description: Browse common Auth0 Advanced Customizations for Universal Login use cases, from Tailwind theming to plugging in your existing component library.
...
| [Migrate from Classic Login to Universal Login with ACUL](/docs/customize/login-pages/advanced-customizations/acul-use-cases/migrate-classic-universal-login)   | How to migrate from Classic to Universal Login with ACUL. |
