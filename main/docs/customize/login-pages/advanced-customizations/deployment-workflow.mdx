---
description: Deploy an Auth0 Advanced Customizations for Universal Login project to production by uploading the built bundle to your CDN and updating the per-screen configuration in Auth0.
