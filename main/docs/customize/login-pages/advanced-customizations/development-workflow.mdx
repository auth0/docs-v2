...
**Local development**
Local development with the [Auth0 CLI](https://github.com/auth0/auth0-cli/) command `auth0 acul dev` allows you to quickly iterate your ACUL screens without any delays or backend dependencies using the Universal Login Context Inspector. 
