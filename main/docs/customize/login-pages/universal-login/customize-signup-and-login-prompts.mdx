---
description: Learn how to add custom fields and text to the Auth0 Universal Login signup and login prompts. 
sidebarTitle: Overview
title: Customize Signup and Login Prompts
redirects:
  - "/docs/customize/universal-login-pages/customize-signup-and-login-prompts"
  - "/docs/sign-up-prompt-customizations"
---
...
When using [social](/docs/authenticate/identity-providers/social-identity-providers) or [enterprise](/docs/authenticate/identity-providers/enterprise-identity-providers/enable-enterprise-connections) connections:
