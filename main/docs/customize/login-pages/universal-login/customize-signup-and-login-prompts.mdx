...
* Data from the `passkey-enrollment` prompt is accessible on the Pre User Registration trigger, and if a validation error is returned, the user is prevented from registering.
