...
When using a custom datatabe connection:

* Data from from both the Signup and Login Prompts is accessible only for `create user`, `get user`, and `password reset` scripts. 
