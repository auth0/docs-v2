...
| Identifier display| Choose a single auto-detecting field or separate fields for each login method. This screen is skipped if a login_hint is used. |
| Social Buttons Layout | Choose if text should be at the top or bottom of the button. |

<Frame>![](/docs/images/universal-loing/widget.png)</Frame>
