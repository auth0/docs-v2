...
1. On the Auth0 Dashboard, navigate to [Branding > Universal Login > Update branding theme](https://manage.auth0.com/#/universal-login/customizations/colors).
...
<Frame>![](/docs/images/universal-login/update-branding-theme.png)</Frame>
...
| Identifier display| Choose a single auto-detecting field or separate fields for each login method. This screen is skipped if a `login_hint` is used. To learn more, read [Database connections flexible identifiers](/docs/authenticate/database-connections/activate-and-configure-attributes-for-flexible-identifiers) |
| Social Buttons Layout | Choose if text should be at the top or bottom of the button. |

<Frame>![](/docs/images/universal-login/widget.png)</Frame>
