---
description: Use Auth0 Actions to validate and store data from custom fields from a customized Universal Login signup page.
title: Use Actions to Validate and Store End-user Data Gathered By Signup Prompt Customizations
redirects:
  - "/docs/validate-and-store-user-data-with-actions"
---
