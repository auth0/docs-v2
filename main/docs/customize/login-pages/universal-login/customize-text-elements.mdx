...
<td>The language that the customization applies to. For a list of available languages, read <a href="/docs/customize/internationalization-and-localization/universal-login-internationalization">Universal Login Internationalization</a>.</td>
</tr>
<tr>
...
<Frame>![redeem-ticket reference screenshot](https://images.ctfassets.net/cdy7uua7fh8z/7H4DS8I8fnlUgtS4ttpMyK/90006ee36032cc1ee3d9674fe6bcf575/redeem-ticket.png)</Frame>
...
<Frame>![consent reference screenshot](https://cdn2.auth0.com/docs-v2/1.14516.0/media/articles/universal-login/text-customization/consent.png)</Frame>
...
<Frame>![device-code-activation reference screenshot](https://cdn2.auth0.com/docs-v2/1.14516.0/media/articles/universal-login/text-customization/device-code-activation.png)</Frame>
...
<Frame>![device-code-activation-allowed reference screenshot](https://cdn2.auth0.com/docs-v2/1.14516.0/media/articles/universal-login/text-customization/device-code-activation-allowed.png)</Frame>
...
<Frame>![device-code-activation-denied reference screenshot](https://cdn2.auth0.com/docs-v2/1.14516.0/media/articles/universal-login/text-customization/device-code-activation-denied.png)</Frame>
...
<Frame>![device-code-confirmation reference screenshot](https://cdn2.auth0.com/docs-v2/1.14516.0/media/articles/universal-login/text-customization/device-code-confirmation.png)</Frame>
...
<Frame>![email-otp-challenge reference screenshot](https://cdn2.auth0.com/docs-v2/1.14516.0/media/articles/universal-login/text-customization/email-otp-challenge.png)</Frame>
...
<Frame>![email-verification-result reference screenshot](https://cdn2.auth0.com/docs-v2/1.14516.0/media/articles/universal-login/text-customization/email-verification-result.png)</Frame>
...
<Frame>![accept-invitation reference screenshot](https://cdn2.auth0.com/docs-v2/1.14516.0/media/articles/universal-login/text-customization/accept-invitation.png)</Frame>
...
<Frame>![login reference screenshot](https://cdn2.auth0.com/docs-v2/1.14516.0/media/articles/universal-login/text-customization/login.png)</Frame>
...
<Frame>![login-id reference screenshot](https://cdn2.auth0.com/docs-v2/1.14516.0/media/articles/universal-login/text-customization/login-id.png)</Frame>
...
<Frame>![login-password reference screenshot](https://cdn2.auth0.com/docs-v2/1.14516.0/media/articles/universal-login/text-customization/login-password.png)</Frame>
...
<Frame>![login-passwordless-email-code reference screenshot](https://images.ctfassets.net/cdy7uua7fh8z/6zazshkUI5sdFDd2Fgbo6w/0193e17673250b5293d9581e34316c20/login-passwordless-email-code.png)</Frame>
...
<Frame>![login-passwordless-email-link reference screenshot](https://images.ctfassets.net/cdy7uua7fh8z/7EcEUmoEPC6GVgJjNyTugr/e160cb40af3a0c748ba1f9fe2307488b/login-passwordless-email-link.png)</Frame>
...
<Frame>![login-passwordless-sms-otp reference screenshot](https://images.ctfassets.net/cdy7uua7fh8z/5dk4vZpc06UojLdnelUInO/f5fb02e0adeeceaa1b8ce6eef8151bc2/login-passwordless-sms-otp.png)</Frame>
...
<Frame>![login-email-verification reference screenshot](https://cdn2.auth0.com/docs-v2/1.14516.0/media/articles/universal-login/text-customization/login-email-verification.png)</Frame>
...
<Frame>![logout reference screenshot](https://images.ctfassets.net/cdy7uua7fh8z/2lXg143oKAF4OlIilbwDCK/d770603ba5203adff07cf4e23e4fcbbb/logout.png)</Frame>
...
<Frame>![mfa-detect-browser-capabilities reference screenshot](https://images.ctfassets.net/cdy7uua7fh8z/2D7DbdMRJ7SdwxEzOYYsLX/595c1436aaa38ed342137c4a5227f4b0/mfa-detect-browser-capabilities.png)</Frame>
...
<Frame>![mfa-enroll-result reference screenshot](https://cdn2.auth0.com/docs-v2/1.14516.0/media/articles/universal-login/text-customization/mfa-enroll-result.png)</Frame>
...
<Frame>![mfa-login-options reference screenshot](https://cdn2.auth0.com/docs-v2/1.14516.0/media/articles/universal-login/text-customization/mfa-login-options.png)</Frame>
...
<Frame>![mfa-begin-enroll-options reference screenshot](https://cdn2.auth0.com/docs-v2/1.14516.0/media/articles/universal-login/text-customization/mfa-begin-enroll-options.png)</Frame>
...
<Frame>![mfa-email-challenge reference screenshot](https://cdn2.auth0.com/docs-v2/1.14516.0/media/articles/universal-login/text-customization/mfa-email-challenge.png)</Frame>
...
<Frame>![mfa-email-list reference screenshot](https://cdn2.auth0.com/docs-v2/1.14516.0/media/articles/universal-login/text-customization/mfa-email-list.png)</Frame>
...
<Frame>![mfa-otp-enrollment-qr reference screenshot](https://cdn2.auth0.com/docs-v2/1.14516.0/media/articles/universal-login/text-customization/mfa-otp-enrollment-qr.png)</Frame>
...
<Frame>![mfa-otp-enrollment-code reference screenshot](https://cdn2.auth0.com/docs-v2/1.14516.0/media/articles/universal-login/text-customization/mfa-otp-enrollment-code.png)</Frame>
...
<Frame>![mfa-otp-challenge reference screenshot](https://cdn2.auth0.com/docs-v2/1.14516.0/media/articles/universal-login/text-customization/mfa-otp-challenge.png)</Frame>
...
<Frame>![mfa-phone-challenge reference screenshot](https://cdn2.auth0.com/docs-v2/1.14516.0/media/articles/universal-login/text-customization/mfa-phone-challenge.png)</Frame>
...
<Frame>![mfa-phone-enrollment reference screenshot](https://cdn2.auth0.com/docs-v2/1.14516.0/media/articles/universal-login/text-customization/mfa-phone-enrollment.png)</Frame>
...
<Frame>![mfa-push-welcome reference screenshot](https://cdn2.auth0.com/docs-v2/1.14516.0/media/articles/universal-login/text-customization/mfa-push-welcome.png)</Frame>
...
<Frame>![mfa-push-enrollment-qr reference screenshot](https://cdn2.auth0.com/docs-v2/1.14516.0/media/articles/universal-login/text-customization/mfa-push-enrollment-qr.png)</Frame>
...
<Frame>![mfa-push-challenge-push reference screenshot](https://cdn2.auth0.com/docs-v2/1.14516.0/media/articles/universal-login/text-customization/mfa-push-challenge-push.png)</Frame>
...
<Frame>![mfa-push-list reference screenshot](https://cdn2.auth0.com/docs-v2/1.14516.0/media/articles/universal-login/text-customization/mfa-push-list.png)</Frame>
...
<Frame>![mfa-recovery-code-enrollment reference screenshot](https://cdn2.auth0.com/docs-v2/1.14516.0/media/articles/universal-login/text-customization/mfa-recovery-code-enrollment.png)</Frame>
...
<Frame>![mfa-recovery-code-challenge reference screenshot](https://cdn2.auth0.com/docs-v2/1.14516.0/media/articles/universal-login/text-customization/mfa-recovery-code-challenge.png)</Frame>
...
<Frame>![mfa-country-codes reference screenshot](https://cdn2.auth0.com/docs-v2/1.14516.0/media/articles/universal-login/text-customization/mfa-country-codes.png)</Frame>
...
<Frame>![mfa-sms-enrollment reference screenshot](https://cdn2.auth0.com/docs-v2/1.14516.0/media/articles/universal-login/text-customization/mfa-sms-enrollment.png)</Frame>
...
<Frame>![mfa-sms-challenge reference screenshot](https://cdn2.auth0.com/docs-v2/1.14516.0/media/articles/universal-login/text-customization/mfa-sms-challenge.png)</Frame>
...
<Frame>![mfa-sms-list reference screenshot](https://cdn2.auth0.com/docs-v2/1.14516.0/media/articles/universal-login/text-customization/mfa-sms-list.png)</Frame>
...
<Frame>![mfa-voice-enrollment reference screenshot](https://cdn2.auth0.com/docs-v2/1.14516.0/media/articles/universal-login/text-customization/mfa-voice-enrollment.png)</Frame>
...
<Frame>![mfa-voice-challenge reference screenshot](https://cdn2.auth0.com/docs-v2/1.14516.0/media/articles/universal-login/text-customization/mfa-voice-challenge.png)</Frame>
...
<Frame>![mfa-webauthn-error reference screenshot](https://cdn2.auth0.com/docs-v2/1.14516.0/media/articles/universal-login/text-customization/mfa-webauthn-error.png)</Frame>
...
<Frame>![mfa-webauthn-not-available-error reference screenshot](https://cdn2.auth0.com/docs-v2/1.14516.0/media/articles/universal-login/text-customization/mfa-webauthn-not-available-error.png)</Frame>
...
<Frame>![organization-selection reference screenshot](https://cdn2.auth0.com/docs-v2/1.14516.0/media/articles/universal-login/text-customization/organization-selection.png)</Frame>
...
<Frame>![organization-picker reference screenshot](https://cdn2.auth0.com/docs-v2/1.14516.0/media/articles/universal-login/text-customization/organization-picker-rev2.png)</Frame>
...
<Frame>![reset-password-request reference screenshot](https://cdn2.auth0.com/docs-v2/1.14516.0/media/articles/universal-login/text-customization/reset-password-request.png)</Frame>
...
<Frame>![reset-password-email reference screenshot](https://cdn2.auth0.com/docs-v2/1.14516.0/media/articles/universal-login/text-customization/reset-password-email.png)</Frame>
...
<Frame>![reset-password reference screenshot](https://cdn2.auth0.com/docs-v2/1.14516.0/media/articles/universal-login/text-customization/reset-password.png)</Frame>
...
<Frame>![reset-password-success reference screenshot](https://cdn2.auth0.com/docs-v2/1.14516.0/media/articles/universal-login/text-customization/reset-password-success.png)</Frame>
...
<Frame>![reset-password-error reference screenshot](https://cdn2.auth0.com/docs-v2/1.14516.0/media/articles/universal-login/text-customization/reset-password-error.png)</Frame>
...
<Frame>![reset-password-mfa-email-challenge reference screenshot](https://cdn2.auth0.com/docs-v2/1.14516.0/media/articles/universal-login/text-customization/reset-password-mfa-email-challenge.png)</Frame>
...
<Frame>![reset-password-mfa-otp-challenge reference screenshot](https://cdn2.auth0.com/docs-v2/1.14516.0/media/articles/universal-login/text-customization/reset-password-mfa-otp-challenge.png)</Frame>
...
<Frame>![reset-password-mfa-phone-challenge reference screenshot](https://cdn2.auth0.com/docs-v2/1.14516.0/media/articles/universal-login/text-customization/reset-password-mfa-phone-challenge.png)</Frame>
...
<Frame>![reset-password-mfa-push-challenge-push reference screenshot](https://cdn2.auth0.com/docs-v2/1.14516.0/media/articles/universal-login/text-customization/reset-password-mfa-push-challenge-push.png)</Frame>
...
<Frame>![reset-password-mfa-recovery-code-challenge reference screenshot](https://cdn2.auth0.com/docs-v2/1.14516.0/media/articles/universal-login/text-customization/reset-password-mfa-recovery-code-challenge.png)</Frame>
...
<Frame>![reset-password-mfa-sms-challenge reference screenshot](https://cdn2.auth0.com/docs-v2/1.14516.0/media/articles/universal-login/text-customization/reset-password-mfa-sms-challenge.png)</Frame>
...
<Frame>![reset-password-mfa-voice-challenge reference screenshot](https://cdn2.auth0.com/docs-v2/1.14516.0/media/articles/universal-login/text-customization/reset-password-mfa-voice-challenge.png)</Frame>
...
<Frame>![reset-password-mfa-webauthn-platform-challenge reference screenshot](https://cdn2.auth0.com/docs-v2/1.14516.0/media/articles/universal-login/text-customization/reset-password-mfa-webauthn-platform-challenge.png)</Frame>
...
<Frame>![reset-password-mfa-webauthn-roaming-challenge reference screenshot](https://cdn2.auth0.com/docs-v2/1.14516.0/media/articles/universal-login/text-customization/reset-password-mfa-webauthn-roaming-challenge.png)</Frame>
...
<Frame>![passkey-enrollment reference screenshot](https://cdn2.auth0.com/docs-v2/1.14516.0/media/articles/universal-login/text-customization/passkey-enrollment.png)</Frame>
...
<Frame>![passkey-enrollment-local reference screenshot](https://cdn2.auth0.com/docs-v2/1.14516.0/media/articles/universal-login/text-customization/passkey-enrollment-local.png)</Frame>
...
<Frame>![phone-identifier-challenge reference screenshot](https://cdn2.auth0.com/docs-v2/1.14516.0/media/articles/universal-login/text-customization/phone-identifier-challenge.png)</Frame>
...
<Frame>![phone-identifier-enrollment reference screenshot](https://cdn2.auth0.com/docs-v2/1.14516.0/media/articles/universal-login/text-customization/phone-identifier-enrollment.png)</Frame>
...
<Frame>![signup reference screenshot](https://cdn2.auth0.com/docs-v2/1.14516.0/media/articles/universal-login/text-customization/signup.png)</Frame>
...
<Frame>![signup-id reference screenshot](https://cdn2.auth0.com/docs-v2/1.14516.0/media/articles/universal-login/text-customization/signup-id.png)</Frame>
...
<Frame>![signup-password reference screenshot](https://cdn2.auth0.com/docs-v2/1.14516.0/media/articles/universal-login/text-customization/signup-password.png)</Frame>
