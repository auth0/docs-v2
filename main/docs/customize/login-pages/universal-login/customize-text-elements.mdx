...
redirects:
  - "/docs/brand-and-customize/customize-login-text-prompts/*"
  - "/docs/brand-and-customize/text-customization-new-universal-login/*"
  - "/docs/universal-login/text-customization-prompts/signup"
  - "/docs/customize/universal-login-pages/customize-login-text-prompts/prompt-signup-password"
  - "/docs/universal-login/prompt-signup-password"
  - "/docs/customize/universal-login-pages/customize-login-text-prompts/prompt-signup-id"
  - "/docs/universal-login/prompt-signup-id"
  - "/docs/customize/universal-login-pages/customize-login-text-prompts/prompt-signup"
  - "/docs/universal-login/prompt-signup"
  - "/docs/customize/universal-login-pages/customize-login-text-prompts/prompt-reset-password"
  - "/docs/universal-login/text-customization-prompts/reset-password"
  - "/docs/universal-login/prompt-reset-password"
  - "/docs/customize/universal-login-pages/customize-login-text-prompts/prompt-organization-selection"
  - "/docs/universal-login/prompt-organization-selection"
  - "/docs/customize/universal-login-pages/customize-login-text-prompts/prompt-mfa-webauthn"
  - "/docs/universal-login/prompt-mfa-webauthn"
  - "/docs/customize/universal-login-pages/customize-login-text-prompts/prompt-mfa-voice"
  - "/docs/universal-login/prompt-mfa-voice"
  - "/docs/customize/universal-login-pages/customize-login-text-prompts/prompt-mfa-sms"
  - "/docs/universal-login/text-customization-prompts/mfa-sms"
  - "/docs/universal-login/prompt-mfa-sms"
  - "/docs/customize/universal-login-pages/customize-login-text-prompts/prompt-mfa-recovery-code"
  - "/docs/universal-login/text-customization-prompts/mfa-recovery-code"
  - "/docs/universal-login/prompt-mfa-recovery-code"
  - "/docs/customize/universal-login-pages/customize-login-text-prompts/prompt-mfa-push"
  - "/docs/universal-login/text-customization-prompts/mfa-push"
  - "/docs/universal-login/prompt-mfa-push"
  - "/docs/customize/universal-login-pages/customize-login-text-prompts/prompt-mfa-phone"
  - "/docs/universal-login/prompt-mfa-phone"
  - "/docs/customize/universal-login-pages/customize-login-text-prompts/prompt-mfa-otp"
  - "/docs/universal-login/text-customization-prompts/mfa-otp"
  - "/docs/universal-login/prompt-mfa-otp"
  - "/docs/customize/universal-login-pages/customize-login-text-prompts/prompt-mfa-email"
  - "/docs/universal-login/text-customization-prompts/mfa-email"
  - "/docs/universal-login/prompt-mfa-email"
  - "/docs/customize/universal-login-pages/customize-login-text-prompts/prompt-mfa"
  - "/docs/universal-login/text-customization-prompts/mfa"
  - "/docs/universal-login/prompt-mfa"
  - "/docs/customize/universal-login-pages/customize-login-text-prompts/prompt-login-password"
  - "/docs/universal-login/prompt-login-password"
  - "/docs/customize/universal-login-pages/customize-login-text-prompts/prompt-login-id"
  - "/docs/universal-login/prompt-login-id"
  - "/docs/customize/universal-login-pages/customize-login-text-prompts/prompt-login-email-verification"
  - "/docs/universal-login/prompt-login-email-verification"
  - "/docs/customize/universal-login-pages/customize-login-text-prompts/prompt-login"
  - "/docs/universal-login/text-customization-prompts/login"
  - "/docs/universal-login/prompt-login"
  - "/docs/login/universal-login/prompt-login"
  - "/docs/customize/universal-login-pages/customize-login-text-prompts/prompt-accept-invitation"
  - "/docs/univeral-login/prompt-accept-invitation"
  - "/docs/customize/universal-login-pages/customize-login-text-prompts/prompt-email-verification"
  - "/docs/login/universal-login/prompt-email-verification"
  - "/docs/universal-login/text-customization-prompts/email-verification"
  - "/docs/universal-login/prompt-email-verification"
  - "/docs/customize/universal-login-pages/customize-login-text-prompts/prompt-email-otp-challenge"
  - "/docs/universal-login/prompt-email-otp-challenge"
  - "/docs/customize/universal-login-pages/customize-login-text-prompts/prompt-device-flow"
  - "/docs/login/universal-login/prompt-device-flow"
  - "/docs/universal-login/text-customization-prompts/device-flow"
  - "/docs/universal-login/prompt-device-flow"
  - "/docs/customize/universal-login-pages/customize-login-text-prompts/prompt-consent"
  - "/docs/login/universal-login/prompt-consent"
  - "/docs/universal-login/text-customization-prompts/consent"
  - "/docs/universal-login/prompt-consent"
  - "/docs/customize/universal-login-pages/customize-login-text-prompts/prompt-common"
  - "/docs/universal-login/text-customization-prompts/common"
  - "/docs/universal-login/prompt-common"
  - "/docs/login/universal-login/prompt-common"
  - "/docs/customize/universal-login-pages/customize-login-text-prompts"
  - "/docs/universal-login/text-customization"
  - "/docs/universal-login/new-experience/text-customization-new-universal-login"
---
