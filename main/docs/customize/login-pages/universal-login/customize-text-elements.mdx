...
<Frame>![async-approval-accepted reference screenshot](/docs/images/universal-login/customize-text/async-approval-error.png‎)</Frame>
...
<Frame>![interstitial-captcha screenshot](‎/docs/media/articles/universal-login/text-customization/captcha.png‎)</Frame>
