...
| ----- | ----- | ---- |
| `correlation_id ` | A unique identifier to track authentication events such as sign-up and successful login. 64 characters or less. Add `correlationId: "{{correlation_id}}"` to your template to track events through your custom login page. | `0001234` |
