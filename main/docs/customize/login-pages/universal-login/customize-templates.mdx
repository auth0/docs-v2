...
The term `prompt` refers to a specific step of the login flow. A specific prompt may consist of one or more screens. You can manage prompts through the [Auth0 Dashboard](https://manage.auth0.com/#/universal-login/customizations-new) or the prompts endpoints of the [Management API](https://auth0.com/docs/api/management/v2).
