...
When an application is created from a generative UI platform such as Vercel, Auth0 pre-populates the allowed origins from the platform. To learn more, read [Integrate with Vercel](/docs/customize/integrations/integrate-with-vercel).
</Step>
</Steps>
