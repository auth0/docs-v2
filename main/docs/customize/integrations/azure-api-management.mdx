---
'og:description': Using Auth0 as an OAuth 2.0 server to authenticate users wanting
...
If you already have a set of users, you can import them or create a [custom database connection](/docs/authenticate/identity-providers/database/mysql).
