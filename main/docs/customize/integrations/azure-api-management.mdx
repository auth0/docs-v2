...
redirects:
  - "/docs/integrations/azure-api-management"
  - "/docs/integrations/azure-api-management/configure-azure"
  - "/docs/integrations/azure-api-management/configure-auth0"
  - "/docs/tutorials/azure-tutorial"
  - "/docs/azure-tutorial"
  - "/docs/integrations/azure-tutorial"
---
