...
redirects:
  - "/docs/integrations/marketplace-partners/sso-integrations-for-partners"
  - "/docs/marketplace-partner-documentation/sso-integrations-for-partners"
  - "/docs/sso-integrations-for-partners"
  - "/docs/integrations/sso-integrations"
  - "/docs/sso/current/integrations"
  - "/docs/integrations/sso"
  - "/docs/customize/integrations/sso-integrations"
---
