---
description: Learn how to secure a command-line tool with Auth0 using the device authorization and client credentials grant flows.
title: Secure a CLI with Auth0
redirects:
  - "/docs/integrations/secure-a-cli-with-auth0"
  - "/docs/cli"
  - "/docs/tutorials/using-auth0-to-secure-an-api"
  - "/docs/integrations/using-auth0-to-secure-a-cli"
  - "/docs/tutorials/using-auth0-to-secure-a-cli"
---
