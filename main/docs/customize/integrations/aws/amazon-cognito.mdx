...
redirects:
  - "/docs/integrations/amazon-cognito"
  - "/docs/integrations/integrate-with-amazon-cognito"
  - "/docs/integrations/integrating-auth0-amazon-cognito-mobile-apps"
  - "/docs/tutorials/integrating-auth0-amazon-cognito-mobile-apps"
  - "/docs/scenarios/amazon-cognito"
---
