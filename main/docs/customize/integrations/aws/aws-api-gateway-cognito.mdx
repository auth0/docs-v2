...
redirects:
  - "/docs/integrations/aws-api-gateway-cognito"
  - "/docs/integrations/aws-api-gateway/secure-api-with-cognito"
  - "/docs/integrations/aws-api-gateway/delegation/secure-api-with-cognito"
---
