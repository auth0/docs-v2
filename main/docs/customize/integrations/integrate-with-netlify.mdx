...
<Frame>![](https://images.ctfassets.net/cdy7uua7fh8z/18pdegCJ6AHGyWsWY53aQt/f5ecef993ef893f1920dda33246e6840/netlify-directory.png)</Frame>
...
3. Select **Link an Auth0 tenant** and follow the prompts to connect to your Auth0 account. If you don't already have an Auth0 account, you can sign up at https://auth0.com/signup.
   ...
   <Frame>![](https://images.ctfassets.net/cdy7uua7fh8z/3wZZNNVMadwZjeLi9vyQtH/01821cd184326a004592f5e0e20a6f72/2025-03-03_12-12-09.png)</Frame>
4. Select your tenant from the dropdown list, and select **Accept** to authorize your account.

   <Frame>![](https://images.ctfassets.net/cdy7uua7fh8z/7mrUvgQh70cgtri09aOHso/a76600ebf472dcddb3977a8b9e726e01/netlify-link.png)</Frame>
...
6. Fill out the required information for your tenant and application, enable the **Redeploy site** checkbox and select **Create site tenant**.
   ...
   <Frame>![](https://images.ctfassets.net/cdy7uua7fh8z/hPxAU8mwd9035AXOPMqxp/f74d0864a6cc5a4aed963bfc77237d7c/auth0_tenant.png)</Frame>
7. You should now see the successfully linked site tenant in your site configuration.

   <Frame>![](https://images.ctfassets.net/cdy7uua7fh8z/1y8khKk4yjGvySB2QRItD3/0f9a5606373c69761ff6fefa4fe180af/netlify-success.png)</Frame>
