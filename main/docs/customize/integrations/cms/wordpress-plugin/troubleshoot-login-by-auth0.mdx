...
redirects:
  - "/docs/cms/wordpress-plugin/troubleshoot-login-by-auth0"
  - "/docs/cms/wordpress/troubleshoot"
---
...
* If you found a bug in the plugin code, [submit an issue](https://github.com/auth0/wordpress/issues) or [create a pull request](https://github.com/auth0/wordpress/pulls) in GitHub.
...
* The plugin exposes two endpoints to mark your custom database connection for **import to Auth0** mode. To learn more about the endpoints, read [Configure Automatic Migration from Your Database](/docs/manage-users/user-migration/configure-automatic-migration-from-your-database).
