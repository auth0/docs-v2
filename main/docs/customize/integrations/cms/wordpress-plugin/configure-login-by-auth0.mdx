---
description: Learn how to configure the Login by Auth0 WordPress plugin to your application. 
title: Configure Login by Auth0
redirects:
  - "/docs/cms/wordpress-plugin/configure-login-by-auth0"
  - "/docs/cms/wordpress/configuration"
---
