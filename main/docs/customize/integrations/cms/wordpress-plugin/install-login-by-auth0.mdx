---
description: Learn how to install the Login by Auth0 plugin to your self-hosted WordPress site using the WordPress admin interface.
...
1. Download the `.zip` file from the [Login by Auth0 GitHub releases page](https://github.com/auth0/wordpress/releases).
...
<Warning>
  The WordPress.org plugin directory contains an older version of this plugin. Use the GitHub installation method above to get the latest release.
</Warning>

This plugin can also be added using the **Plugins** screen in wp-admin, but this will install an outdated version:
