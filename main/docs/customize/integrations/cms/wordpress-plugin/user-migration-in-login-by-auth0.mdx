...
redirects:
  - "/docs/cms/wordpress-plugin/user-migration-in-login-by-auth0"
  - "/docs/cms/wordpress/user-migration"
---
...
12. **This step is for 3.11.0 and later:** Scroll down to **Settings** and add the following configuration variables:
    ...
    <Frame>![WordPress Plugin custom database settings](/docs/images/cdy7uua7fh8z/1icr0yX47nODUrzP7B6Xl2/b43621c3b6641f68bcb14ac38b237c11/auth0-custom-database-config.png)</Frame>
