...
12. **This step is for 3.11.0 and later:** Scroll down to **Settings** and add the following configuration variables:
    ...
    <Frame>![WordPress Plugin custom database settings](https://images.ctfassets.net/cdy7uua7fh8z/1icr0yX47nODUrzP7B6Xl2/b43621c3b6641f68bcb14ac38b237c11/auth0-custom-database-config.png)</Frame>
...
<Frame>![WordPress User Migration - Auth0 IP Addresses](https://images.ctfassets.net/cdy7uua7fh8z/3RnxoRlvXm8FmNfu02fXVn/3672806c9cbf2bfe28503be8b8a63eda/auth0-incoming-ip-addresses.png)</Frame>

Make sure all of those IP addresses appear in WordPress under **Auth0 > Settings > Advanced** in the plugin:

<Frame>![WordPress User Migration - IP Whitelist](https://images.ctfassets.net/cdy7uua7fh8z/3w6C1IrsSC9hoivpSY122l/d117857524ef8d7872f364d3a7dbabda/migration-ip-whitelist-setting-field.png)</Frame>
