---
description: Learn how to export your Auth0 user data and import it into Oracle
  Eloqua.
...
Before you get started, you can find more information by visiting [Oracle Eloqua Help Center: Uploading Contacts](https://docs.oracle.com/en/cloud/saas/marketing/eloqua-user/Help/Contacts/Tasks/UploadingContacts.htm).
