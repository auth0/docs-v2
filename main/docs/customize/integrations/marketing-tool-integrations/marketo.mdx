---
description: Learn how to export your Auth0 user data and import it into Adobe Marketo Engage.
...
You can check the status of your import using the [Get Import Lead Status API](https://developer.adobe.com/marketo-apis/api/mapi#operation/getImportLeadStatusUsingGET) and your import job's `batchId`. For example:
