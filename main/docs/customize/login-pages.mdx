---
description: Learn about the Login page customization options from theming Universal Login using the Dashboard to building a fully owned interface with Advanced Customizations for Universal Login.
sidebarTitle: Overview
title: Customize Login Pages
redirects:
  - "/docs/brand-and-customize/universal-login-page-templates"
  - "/docs/customize/universal-login-pages"
  - "/docs/customize/universal-login-page-templates"
  - "/docs/universal-login/universal-login-page-customization"
  - "/docs/universal-login/page-templates"
  - "/docs/universal-login/new-experience/universal-login-page-templates"
---
...
| [Advanced Customizations for Universal Login](/docs/customize/login-pages/advanced-customizations) | How to extend the capabilities of Universal Login to support multi-branding, complex security configurations, and integration of numerous analytics platforms. |
