...
title: Auth0 Hooks
redirects:
  - "/docs/customize/hooks/extensibility-points/client-credentials-exchange"
  - "/docs/hooks/extensibility-points/client-credentials-exchange"
  - "/docs/hooks/extensibility-points/credentials-exchange"
  - "/docs/hooks/client-credentials-exchange"
  - "/docs/hooks/guides/use-the-credentials-exchange-extensibility-point"
  - "/docs/hooks/concepts/credentials-exchange-extensibility-point"
  - "/docs/hooks"
  - "/docs/auth0-hooks/dashboard"
  - "/docs/auth0-hooks"
  - "/docs/hooks/overview"
  - "/docs/hooks/dashboard"
  - "/docs/auth0-hooks/cli"
  - "/docs/hooks/cli"
---
<Warning>
