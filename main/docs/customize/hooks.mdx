...
<tbody>
<tr>
<td><a href="/docs/customize/hooks/create-hooks">Create Hooks</a></td>
<td>How to create hooks using the  Dashboard or the Management API.</td>
</tr>
<tr>
<td><a href="/docs/customize/hooks/update-hooks">Update Hooks</a></td>
<td>How to update hooks using the  Dashboard or the Management API.</td>
</tr>
<tr>
<td><a href="/docs/customize/hooks/delete-hooks">Delete Hooks</a></td>
<td>How to delete hooks using the  Dashboard or the Management API.</td>
</tr>
<tr>
<td><a href="/docs/customize/hooks/enable-disable-hooks">Enable/Disable Hooks</a></td>
<td>How to enable and disable hooks using the Dashboard and Management API.</td>
</tr>
<tr>
<td><a href="/docs/customize/hooks/view-hooks">View Hooks</a></td>
<td>How to view hooks using the Dashboard and Management API.</td>
</tr>
<tr>
<td><a href="/docs/customize/hooks/view-logs-for-hooks">View Logs for Hooks</a></td>
<td>How to view real-time log events for specific configured hooks.</td>
</tr>
<tr>
<td><a href="/docs/customize/actions/explore-triggers">Extensibility Points</a></td>
<td>About Auth0 extensibility points where hooks can be executed.</td>
</tr>
<tr>
<td><a href="/docs/customize/hooks/hook-secrets">Hook Secrets</a></td>
