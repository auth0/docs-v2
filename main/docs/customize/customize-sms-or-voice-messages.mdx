...
redirects:
  - "/docs/mfa/customize-sms-or-voice-messages"
  - "/docs/mfa/guides/customize-phone-messages"
  - "/docs/multifactor-authentication/sms-templates"
  - "/docs/mfa/guides/guardian/customize-sms-messages"
  - "/docs/multifactor-authentication/administrator/sms-templates"
---
