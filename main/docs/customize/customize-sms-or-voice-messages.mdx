...
The endpoints support the `x-request-language` header and you can use it to send the locale. See [Multi-Language Support](/docs/authenticate/identity-providers/passwordless/guides/sms-otp#multi-language-support) for details.
