...
redirects:
  - "/docs/custom-domains/configure-custom-domains-with-self-managed-certificates/configure-cloudflare-for-use-as-reverse-proxy"
  - "/docs/custom-domains/set-up-cloudflare"
---
