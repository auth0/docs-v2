...
| `/u/login` | Login: identifier and identifier-first prompts |
| Organization endpoints: <br></br><ul><li>`u/organization`</li><li>`/u/organization-picker`</li><li>`/u/pre-organization-picker`</li></ul>| Organization selection prompts |
| `/u/login/password` | Login: password prompt |
| `/u/login-email-verification` | Login: email verification prompt |
| `/u/signup` | Signup: identifier prompts |
| `/u/signup/password` | Signup: password prompt |
| `/u/consent` | Consent prompt |
| `/u/customized-consent` | Customized consent prompt |
| `/u/reset-password` | Password reset prompts |
| `/u/reset-password/request` | Password reset: email/username prompt |
| `/u/reset-password/change` | Password reset: new password prompt |
| `/u/reset-verify` | Password reset verification |
| `/u/mfa-otp` | MFA: one-time password prompts |
| `/u/mfa-push` | MFA: push notification prompts |
| `/u/mfa-webauthn` | MFA: WebAuthn and passkey prompts |
| `/u/mfa-recovery-code` | MFA: recovery code prompts |
| `/u/mfa-sms` | MFA: SMS prompts |
| `/u/mfa-email` | MFA: email prompts |
| `/u/mfa-voice` | MFA: voice prompts |
| `/u/device-flow` | Device authorization flow |
...
| `/mfa/challenge` | MFA: challenge request |
| `/mfa/associate` | MFA: authenticator association |
| `/passwordless/start` | Passwordless: initiation request |
| `/samlp/*` | SAML protocol endpoints |
| `/wsfed/*` | WS-Federation endpoints |
| `/v2/logout` | Logout; may be called server-side in back-channel logout flows |
