...
|-------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Credentials Exchange          | [Event object](/docs/actions/reference/credentials-exchange/credentials-exchange-event-object)                                                    |
| Custom Email Provider         | [Event object](/docs/actions/reference/custom-email-provider/custom-email-provider-event-object)                                                     |
| Custom Phone Provider         | [Event object](/docs/actions/reference/custom-phone-provider/custom-phone-provider-event-object) |
| Post Login                    | [Event object](/docs/actions/reference/post-login/post-login-event-object)                                                 |
| Post User Registration        | [Event object](/docs/actions/reference/post-user-registration/post-user-registration-event-object)                    |
| Post Password Change          | [Event object](/docs/actions/reference/post-change-password/post-change-password-event-object)                          |
| Pre User Registration         | [Event object](/docs/actions/reference/pre-user-registration/pre-user-registration-event-object)                      |
| Reset Password Post Challenge | [Event object](/docs/actions/reference/password-reset-post-challenge/password-reset-post-challenge-event-object)                                      |
