...
redirects:
  - "/docs/custom-domains/auth0-managed-certificates"
  - "/docs/custom-domains/configure-custom-domains-with-auth0-managed-certificates"
---
...
If you are unable to complete the verification process, wait at least 4 hours before repeating these steps. To avoid any interruptions to your service, do not recreate the custom domain when reverifying.
