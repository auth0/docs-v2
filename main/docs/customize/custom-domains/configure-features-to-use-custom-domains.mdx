...
<tr>
<td>Custom domain with Auth0 emails and phone notifications</td>
<td><a href="#use-custom-domains-in-emails-and-phone">Use custom domains in emails and phone notifications</a></td>
</tr>
<tr>
