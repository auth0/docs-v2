---
'og:description': Learn how to configure custom domains where you are responsible
...
1. Go to [Dashboard > Branding > Custom Domains](https://manage.auth0.com/#/branding/custom_domains).
   ...
   <Frame>![Auth0 Branding Custom Domains Self-Managed Certificate Verify Domain](https://images.ctfassets.net/cdy7uua7fh8z/4XhEmQwKfoqydOldfHnnud/c63a58c72f79b4d19cd417f70ba262cc/Custom_Domains_-_Self_-_English.png)</Frame>
