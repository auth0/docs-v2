...
* Private Cloud deployments can configure up to 10,000 custom domains per tenant.
* Public Cloud tenants can configure beyond the base 20 custom domains with an add-on SKU, up to a maximum of 10,000 custom domains per tenant.
...
The Custom Domains page displays all configured domains with pagination support. You can:
