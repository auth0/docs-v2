...
Without the segment from Anonymous Sessions to divide your experiment Center data, the impact on a specific group of users is diluted into in the avearge across all users, so you risk missing real effects.
