...
description: Implement a custom-phone-provider Action to send Auth0 SMS and voice messages through any gateway instead of the default phone provider.
---
...
* [Action Triggers: custom-phone-provider API Object](/docs/customize/actions/reference/custom-phone-provider/custom-phone-provider-api-object)
* [Action Triggers: custom-phone-provider Event Object](/docs/customize/actions/reference/custom-phone-provider/custom-phone-provider-event-object)
