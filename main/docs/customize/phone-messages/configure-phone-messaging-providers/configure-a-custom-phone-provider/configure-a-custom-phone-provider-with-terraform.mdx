...
To reset the custom phone provider, navigate to [Auth0 Dashboard > Branding > Phone Provider](https://manage.auth0.com/#/phone/templates/phone/provider) and select **Phone Provider**. Then, select the **Reset** button to restore your custom provider to its default.
