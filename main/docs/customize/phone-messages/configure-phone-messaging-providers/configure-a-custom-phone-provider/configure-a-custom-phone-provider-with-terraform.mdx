...
redirects:
  - "/docs/customize/actions/configure-a-custom-provider-with-terraform"
  - "/docs/customize/phone-messages/unified-phone/configure-a-custom-provider-with-terraform"
---
