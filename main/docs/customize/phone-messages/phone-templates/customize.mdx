...
description: Instructions on how to use phone templates to customize the appearance and content of phone messages sent by Auth0's phone-based workflows.
...
5. Click **Save** to save your changes, **Try** to test your changes, or **Reset** to revert your changes.
