...
The Unified Phone Experience centralizes all your phone provider configurations in one location in your tenant. You will not need to configure a phone provider multiple times for various phone authentication factors. 

If you already have a phone provider configured for [SMS and Voice notificatiosn for Multi-Factor Authentication (MFA)](/docs/secure/multi-factor-authentication/multi-factor-authentication-factors/configure-sms-voice-notifications-mfa), you can migrate your configuration to the Unified Phone Experience and apply your configuration at the tenant-level.
...
3. New Auth0 tenants are able to use the Unified Phone Experience, a banner advises you to configure a tenant-level provider:

   <Frame>![](/docs/images/cdy7uua7fh8z/1mZryDWIpdkpGmhxn4Gr8K/4bdad7fbcd81dd0bf4855d94b7205e8b/mfa-phone-message-upe.png)</Frame>

* Existing tenants, from before March 2025, are able to configure SMS and Voice notificatiosn for Multi-Factor Authentication (MFA) along with the Unified Phone Experience. 
...
<Callout icon="file-lines" color="#0EA5E9" iconType="regular">
Auth0 encourages you to use the Unified Phone Experience. If you must use the [SMS and Voice notificatiosn for Multi-Factor Authentication (MFA)](/docs/secure/multi-factor-authentication/multi-factor-authentication-factors/configure-sms-voice-notifications-mfa) experience to configure your phone provider, and the toggle to use a tenant-level provider is missing, contact [Auth0 Support](/docs/troubleshoot/customer-support).
</Callout>
