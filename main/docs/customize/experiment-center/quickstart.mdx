...
To transition the experiment flag status to `active`, make a `POST` to the [`/api/v2/experimentation/experiments/{experiment_id}/status`](/docs/api/management/v2/experimentation/update-experiment-status) endpoint.
