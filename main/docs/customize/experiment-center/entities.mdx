...
With the Auth0 [Management API](/docs/api/management/v2), you can define Experiment Center's entities details, including properties, lifecycle states, and validation rules.
...
To transition between status use the Auth0 Management API [`/api/v2/experimentation/feature-flags/{id}/status`](/docs/api/management/v2/experimentation/update-feature-flag-status) endpoint.
...
The following assignment option is available:
