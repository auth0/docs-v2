...
When an experiment is active and a variation is assigned, the Experiment Center injects an `ExperimentContext` object into your [ACUL](https://auth0.com/docs/customize/login-pages/advanced-customizations) component as a prop named `experimentation`.
