...
When an experiment is active and a variation is assigned, the Experiment Center injects an `ExperimentContext` object into your [ACUL](/docs/customize/login-pages/advanced-customizations) component as an `experiment`.
