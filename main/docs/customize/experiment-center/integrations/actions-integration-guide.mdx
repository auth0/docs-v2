...
* [`post_login`](/docs/customize/actions/explore-triggers/post-login) trigger.
* [`pre_user_registration`](/docs/customize/actions/explore-triggers/pre-user-registration) trigger.
* [`post_user_registration`](/docs/customize/actions/explore-triggers/post-user-registration) trigger.
