...
When you customize Signup and Login prompts using [partials](/docs/customize/login-pages/universal-login/customize-signup-and-login-prompts#manage-partials-programmatically), the experiment context is passed explicitely as part of your partial. 
