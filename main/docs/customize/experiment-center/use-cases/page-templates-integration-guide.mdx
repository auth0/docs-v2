...
Experiment context is registered as a Universal Login state property and is passed to your template through `renderLocals`. Your template receives it as a local variable.
