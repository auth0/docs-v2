...
If you are reading directly from the Auth0 Dashboard (Monitoring > Logs), the enriched fields appear in the event's raw JSON. Select the event to expand the full JSON payload and look for the `experiment` key.
