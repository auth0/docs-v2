...
If `is_valid` is `false`, fix the listed errors before proceeding. Common blockers are covered in the [troubleshooting guide](/docs/customize/experiment-center/troubleshooting).
...
If you do not see `details.experiment`, check the [troubleshooting guide](/docs/customize/experiment-center/troubleshooting).
...
- Read the [ACUL integration guide](/docs/customize/experiment-center/use-cases/acul-integration-guide) to learn how to branch your ACUL component code on experiment context.
- Read the [Actions integration guide](/docs/customize/experiment-center/use-cases/actions-integration-guide) to use `event.experiment` in post-login and registration triggers.
