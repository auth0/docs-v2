...
- Read the [ACUL integration guide](/docs/experiment-center/uses-cases/acul-integration) to learn how to branch your ACUL component code on experiment context
- Read the [Actions integration guide](/docs/experiment-center/use-cases/actions-integration) to use `event.experimentation` in post-login and registration triggers
- See the [tenant log enrichment field reference](/docs/experiment-center/use-cases/log-enrichment) for the complete list of fields stamped on auth events
