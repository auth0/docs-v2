...
Auth0 Experiment Center is a native Auth0 experimentation engine. It lets you A/B test changes to your authentication experience and see the impact in your auth event logs.
...
Experiment Center is built around two entities:
...
To learn more about feature flag, read [Entities Details](/docs/customize/experiment-center/entities/#feature-flag)
...
To learn more about variations, read [Entities Details](/docs/customize/experiment-center/entities/#variation)
...
To learn more about segment, read [Entities Details](/docs/customize/experiment-center/entities/#segment)
...
When an experiment is active and a variation is assigned, the Experiment Center injects an `ExperimentContext` object into your runtime surfaces. ACUL screens receive it only when you opt the screen in via `context_configuration` (see the [ACUL integration guide](/docs/customize/experiment-center/use-cases/acul-integration-guide)). Actions and page templates receive it automatically whenever an experiment is active. The object shape:
