...
The following two entities manage EC:
...
To transition between status use the Management API `/api/v2/experimentation/feature-flags/{id}/status` endpoint.
...
You can also determine readiness explicitly using the Manamagent API:
