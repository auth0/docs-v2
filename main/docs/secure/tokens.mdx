...
redirects:
  ...
  - "/docs/security/tokens/revoke-tokens"
  - "/docs/tokens/guides/revoke-tokens"
  - "/docs/tokens/revoke-tokens"
  - "/docs/security/tokens"
  - "/docs/tokens/guides"
  - "/docs/tokens/concepts"
  - "/docs/token"
  - "/docs/security/token-exp"
  - "/docs/tokens"
---
