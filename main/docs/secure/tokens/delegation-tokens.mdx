---
description: Understand how Auth0 delegation tokens work and why the legacy `/delegation` endpoint is deprecated in favor of standard OAuth 2.0 token exchange.
title: Delegation Tokens
redirects:
  - "/docs/security/tokens/delegation-tokens"
  - "/docs/tokens/delegation-tokens"
  - "/docs/tokens/concepts/delegation-tokens"
  - "/docs/tokens/delegation"
  - "/docs/api-auth/tutorials/adoption/delegation"
---
<Warning>
