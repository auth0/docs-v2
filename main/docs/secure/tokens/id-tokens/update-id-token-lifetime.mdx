...
redirects:
  - "/docs/security/tokens/id-tokens/update-id-token-lifetime"
  - "/docs/dashboard/guides/applications/update-token-lifetime"
  - "/docs/tokens/id-tokens/update-id-token-lifetime"
---
