---
description: Validate Auth0 ID tokens in your application by verifying the signature, standard claims, and optional nonce to confirm user identity.
title: Validate ID Tokens
redirects:
  - "/docs/security/tokens/id-tokens/validate-id-tokens"
  - "/docs/tokens/guides/id-token/validate-id-token"
  - "/docs/tokens/guides/validate-id-tokens"
  - "/docs/tokens/guides/validate-id-token"
  - "/docs/tokens/id-tokens/validate-id-tokens"
---
