---
description: Learn what JSON Web Tokens (JWTs) are, how they are structured, and how Auth0 uses them for authentication and authorization.
sidebarTitle: Overview
title: JSON Web Tokens
redirects:
  - "/docs/security/tokens/json-web-tokens"
  - "/docs/jwt"
  - "/docs/tokens/jwt"
  - "/docs/tokens/concepts/why-use-jwt"
  - "/docs/tokens/concepts/jwts"
  - "/docs/tokens/json-web-tokens"
---
