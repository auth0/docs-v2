---
description: Learn how to configure Auth0 refresh token absolute and inactivity expiration to balance long-lived access with revocation responsiveness.
title: Configure Refresh Token Expiration
redirects:
  - "/docs/security/tokens/refresh-tokens/configure-refresh-token-expiration"
  - "/docs/security/tokens/configure-refresh-token-expiration"
  - "/docs/tokens/refresh-tokens/configure-refresh-token-expiration"
---
