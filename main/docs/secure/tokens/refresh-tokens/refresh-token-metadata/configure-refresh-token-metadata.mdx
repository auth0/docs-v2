---
description: Learn how to configure Auth0 refresh token metadata using Actions or the Management API.
title: Configure Refresh Token Metadata
validatedOn: 2026-02-04
---

To configure refresh token metadata, you can use an Auth0 [Post-Login Action](/docs/customize/actions/explore-triggers/signup-and-login-triggers/login-trigger) and the [Management API](/docs/api/management/v2).
...
Make a `GET` request to the [`/api/v2/refresh-tokens/{id}`](/docs/api/management/v2/refresh-tokens/get-refresh-token) endpoint:
...
Make a `PATCH` request to the [`/api/v2/refresh-tokens/{id}`](/docs/api/management/v2/refresh-tokens/patch-refresh-tokens-by-id) endpoint:
...
Make a `PATCH` request to the [`/api/v2/refresh-tokens/{id}`](/docs/api/management/v2/refresh-tokens/patch-refresh-tokens-by-id) endpoint with an empty metadata object:
...
You can also query the refresh token metadata via the [/api/v2/refresh-tokens/{id}](/docs/api/management/v2/refresh-tokens/get-refresh-token) endpoint:
