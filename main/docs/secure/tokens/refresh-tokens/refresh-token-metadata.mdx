---
description: Learn how Auth0 refresh token metadata can help you store custom data on a refresh token that persists across uses and is accessible from Actions and the Management API.
