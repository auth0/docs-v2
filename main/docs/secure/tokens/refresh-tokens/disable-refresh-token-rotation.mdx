---
description: Learn how to disable Auth0 refresh token rotation using the Dashboard or Management API. 
title: Disable Refresh Token Rotation
redirects:
  - "/docs/security/tokens/refresh-tokens/disable-refresh-token-rotation"
  - "/docs/tokens/refresh-tokens/disable-refresh-token-rotation"
  - "/docs/tokens/access-tokens/refresh-tokens/disable-refresh-token-rotation"
  - "/docs/tokens/guides/disable-refresh-token-rotation"
---
