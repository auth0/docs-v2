---
description: Learn how to configure Auth0 refresh token rotation to migrate non-rotating refresh token to a rotating refresh token and vice-versa.
title: Configure Refresh Token Rotation
redirects:
  - "/docs/security/tokens/refresh-tokens/configure-refresh-token-rotation"
  - "/docs/tokens/guides/configure-refresh-token-rotation"
  - "/docs/tokens/refresh-tokens/configure-refresh-token-rotation"
---
