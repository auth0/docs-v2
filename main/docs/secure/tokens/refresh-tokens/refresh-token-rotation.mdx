...
redirects:
  - "/docs/security/tokens/refresh-tokens/refresh-token-rotation"
  - "/docs/security/tokens/refresh-token-rotation"
  - "/docs/tokens/refresh-tokens/refresh-token-rotation"
  - "/docs/tokens/access-tokens/refresh-tokens/refresh-token-rotation"
  - "/docs/tokens/concepts/refresh-token-rotation"
---
...
<Frame>![Refresh Token Rotation Reuse Detection state diagram](/docs/images/cdy7uua7fh8z/33fe73R81Cpm6eTmOWfAnm/e7d168edc27861507a121910b32f1ee2/reuse-detection1.png)</Frame>
...
<Frame>![Refresh Token Rotation Reuse Detection State diagram](/docs/images/cdy7uua7fh8z/36rAUgLOAqW7k7Fdl1eRN1/c1a57be5093416b50d42ec41a1e3a233/reuse-detection2.png)</Frame>
