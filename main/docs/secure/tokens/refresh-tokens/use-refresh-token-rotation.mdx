...
redirects:
  - "/docs/security/tokens/refresh-tokens/use-refresh-token-rotation"
  - "/docs/tokens/refresh-tokens/refresh-token-rotation/use-refresh-token-rotation"
  - "/docs/tokens/refresh-token-rotation/use-refresh-token-rotation"
  - "/docs/tokens/guides/use-refresh-token-rotation"
---
