---
description: Reference for the properties in a JSON Web Key Set (JWKS), including `alg`, `kty`, `use`, `kid`, `n`, `e`, and `x5c`.
title: JSON Web Key Set Properties
redirects:
  - "/docs/security/tokens/json-web-tokens/json-web-key-set-properties"
  - "/docs/tokens/reference/jwt/jwks-properties"
  - "/docs/tokens/references/jwks-properties"
  - "/docs/tokens/json-web-tokens/json-web-key-set-properties"
---
