---
description: Validate JSON Web Tokens (JWTs) by verifying the signature, decoding the payload, and checking claims using an Auth0 SDK or third-party library.
title: Validate JSON Web Tokens
redirects:
  - "/docs/security/tokens/json-web-tokens/validate-json-web-tokens"
  - "/docs/tokens/guides/jwt/validate-jwt"
  - "/docs/tokens/guides/jwt/parse-validate-jwt-programmatically"
  - "/docs/tokens/guides/validate-jwts"
  - "/docs/tokens/json-web-tokens/validate-json-web-tokens"
---
<Card title="Overview">
