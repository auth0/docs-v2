---
description: Add custom claims to Auth0 access and ID tokens using namespaced keys in an Action to pass additional user or application data to your API.
title: Create Custom Claims
redirects:
  - "/docs/secure/tokens/json-web-tokens/create-namespaced-custom-claims"
  - "/docs/security/tokens/json-web-tokens/create-namespaced-custom-claims"
  - "/docs/tokens/concepts/claims-namespacing"
  - "/docs/tokens/guides/create-namespaced-custom-claims"
  - "/docs/tokens/create-namespaced-custom-claims"
---
