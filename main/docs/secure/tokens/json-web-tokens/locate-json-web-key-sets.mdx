...
redirects:
  - "/docs/security/tokens/json-web-tokens/locate-json-web-key-sets"
  - "/docs/tokens/guides/jwt/use-jwks"
  - "/docs/tokens/guides/jwt/verify-jwt-signature-using-jwks"
  - "/docs/tokens/guides/locate-jwks"
  - "/docs/tokens/json-web-tokens/json-web-key-sets/locate-json-web-key-sets"
---
