...
redirects:
  - "/docs/security/tokens/json-web-tokens/json-web-token-structure"
  - "/docs/tokens/reference/jwt/jwt-structure"
  - "/docs/tokens/references/jwt-structure"
  - "/docs/tokens/json-web-tokens/json-web-token-structure"
---
