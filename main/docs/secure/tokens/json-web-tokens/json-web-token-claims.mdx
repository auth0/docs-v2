---
description: Learn about registered and custom JSON Web Token (JWT) claims, how they are structured in Auth0 tokens, and how to avoid naming collisions with namespaced claims.
title: JSON Web Token Claims
redirects:
  - "/docs/security/tokens/json-web-tokens/json-web-token-claims"
  - "/docs/scopes/current/custom-claims"
  - "/docs/tokens/add-custom-claims"
  - "/docs/tokens/concepts/jwt-claims"
  - "/docs/tokens/jwt-claims"
  - "/docs/tokens/json-web-tokens/json-web-token-claims"
---
