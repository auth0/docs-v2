---
description: Learn about registered and custom JWT claims, how they are structured in Auth0 tokens, and how to avoid naming collisions with namespaced claims.
