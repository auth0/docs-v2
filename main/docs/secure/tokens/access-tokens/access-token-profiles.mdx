...
| `cnf`                   | Confirmation claim for [mTLS Token Binding](/docs/get-started/applications/configure-mtls/set-up-resource-server-for-token-binding).                                                                                                                                                                                                                                                                                   | Case-specific               | Case-specific            | `{"x5t#S256":"A4DtL2JmUMhAsvJj5tKyn64SqzmuXbMrJa0n761y5v0"}`                                                                 |
