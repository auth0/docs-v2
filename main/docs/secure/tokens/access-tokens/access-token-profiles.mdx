...
| `gty`                   | [Grant type](/docs/get-started/applications/application-grant-types) used to request the access token. Only present for `client_credentials`, `password`, and `refresh_token`.                                                                                                                                                                                                                                        | No                          | Case-specific            | Grant type: `password`, `client_credentials`                                                                                |
