---
description: Learn how to include an Auth0 access token in API requests using the Bearer HTTP authorization scheme.
title: Use Access Tokens
redirects:
  - "/docs/security/tokens/access-tokens/use-access-tokens"
  - "/docs/tokens/access-tokens/use-access-tokens"
  - "/docs/tokens/guides/access-token/use-access-tokens"
  - "/docs/tokens/use-access-tokens"
  - "/docs/tokens/guides/use-access-tokens"
---
