...
redirects:
  - "/docs/security/tokens/access-tokens/identity-provider-access-tokens"
  - "/docs/tokens/identity-provider-access-tokens"
  - "/docs/tokens/idp"
  - "/docs/tokens/overview-idp-access-tokens"
  - "/docs/tokens/concepts/idp-access-tokens"
---
