...
redirects:
  - "/docs/secure/tokens/access-tokens/get-management-api-access-tokens-for-production"
  - "/docs/security/tokens/access-tokens/get-management-api-access-tokens-for-production"
  - "/docs/api/management/v2/get-access-tokens-for-production"
  - "/docs/tokens/management-api-access-tokens/get-management-api-access-tokens-for-production"
---
...
| --- | --- |
| **grant_type** | Denotes which [OAuth 2.0 flow](/docs/authenticate/protocols/oauth#grant-types) you want to run. For machine to machine communication use the value `client_credentials`. |
| **client_id** | This is the value of the **Client ID** field of the Machine-to-Machine Application you created. You can find it on the [Settings tab of your Application](https://manage.auth0.com/#/applications/{yourClientId}/settings). |
| **client_secret** | This is the value of the **Client Secret** field of the Machine-to-Machine Application you created. You can find it at the [Settings tab of your Application](https://manage.auth0.com/#/applications/{yourClientId}/settings). |
