...
redirects:
  - "/docs/secure/tokens/access-tokens/get-management-api-tokens-for-single-page-applications"
  - "/docs/security/tokens/access-tokens/get-management-api-tokens-for-single-page-applications"
  - "/docs/api/management/v2/get-access-tokens-for-spas"
  - "/docs/tokens/management-api-access-tokens/get-management-api-tokens-for-single-page-applications"
---
