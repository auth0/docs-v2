...
2. Select the **Copy** icon to the right of the token. You can now make authorized calls to the [Management API](https://auth0.com/docs/api/management/v2) using this token.
   ...
   <Frame>![APIs - Management API access tokens - Testing - Copy token](https://images.ctfassets.net/cdy7uua7fh8z/3Y4I9YJR77j73FCYDiegnC/44f32f76d27357bc39aad9ee7c4d5561/management-api-access-token.png)</Frame>
