---
description: Validate Auth0 access tokens in your API by verifying the JSON Web Token (JWT) signature, audience, permissions, and standard claims.
title: Validate Access Tokens
redirects:
  - "/docs/security/tokens/access-tokens/validate-access-tokens"
  - "/docs/tokens/access-tokens/validate-access-tokens"
  - "/docs/tokens/guides/access-token/validate-access-token"
  - "/docs/api-auth/tutorials/verify-access-token"
