---
description: Encrypt access token payloads using JWE so that only the intended resource server can inspect the claims, protecting against data breaches and intermediary inspection.
