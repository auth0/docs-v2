...
redirects:
  - "/docs/security/tokens/access-tokens/get-access-tokens"
  - "/docs/tokens/access-tokens/get-access-tokens"
  - "/docs/tokens/guides/access-token/get-access-tokens"
  - "/docs/tokens/get-access-tokens"
  - "/docs/tokens/guides/get-access-tokens"
---
