...
redirects:
  - "/docs/security/tokens/access-tokens/management-api-access-tokens"
  - "/docs/tokens/management-api-access-tokens/management-api-access-token-faqs"
  - "/docs/api/management/v2/faq-management-api-access-tokens"
  - "/docs/tokens/management-api-access-tokens"
  - "/docs/api/management/v2/concepts/tokens"
  - "/docs/api/v2/tokens"
  - "/docs/tokens/apiv2"
  - "/docs/api/management/v2/tokens"
---
