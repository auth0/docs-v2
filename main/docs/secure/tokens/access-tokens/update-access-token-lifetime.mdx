...
redirects:
  - "/docs/security/tokens/access-tokens/update-access-token-lifetime"
  - "/docs/dashboard/guides/apis/update-token-lifetime"
  - "/docs/tokens/access-tokens/update-access-token-lifetime"
---
