...
redirects:
  - "/docs/security/tokens/refresh-tokens"
  - "/docs/tokens/refresh-tokens"
  - "/docs/tokens/preview/refresh-token"
  - "/docs/tokens/access-tokens/refresh-tokens"
  - "/docs/tokens/concepts/refresh-tokens"
  - "/docs/tokens/refresh-token/current"
  - "/docs/tokens/refresh-token/legacy"
  - "/docs/tokens/refresh-token"
  - "/docs/tokens/refresh_token"
  - "/docs/refresh-token"
  - "/docs/api-auth/tutorials/adoption/refresh-tokens"
---
