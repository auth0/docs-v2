...
Alternatively, if you use Auth0.js from a SPA, you can [use the `signup` method](/docs/libraries/auth0-single-page-app-sdk) to create the user in Auth0 and set the consent info as part of the `user_metadata`.
