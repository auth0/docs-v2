...
description: Customize Auth0 Lock to capture GDPR consent at signup by adding a consent checkbox, recording the choice in user metadata, and persisting it across logins.
redirects:
  - "/docs/compliance/gdpr/gdpr-track-consent-with-lock"
  - "/docs/compliance/gdpr/features-aiding-compliance/user-consent/track-consent-with-lock"
---
...
5. If you followed the third implementation option, choose **Sign Up with Google**. You will be navigated to the consent form. Check the **I agree** flag and click **Submit**.
   ...
   The user is created but they won't be able to log in. If they try to, they will be prompted again to provide consent.
