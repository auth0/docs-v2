...
redirects:
  ...
  - "/docs/compliance/auth0-gdpr-compliance"
  - "/docs/compliance/gdpr/definitions"
  - "/docs/compliance/gdpr/gdpr-summary"
  - "/docs/compliance/gdpr/roles-responsibilities"
  - "/docs/compliance/gdpr/security-advice-for-customers"
  - "/docs/compliance/gdpr/features-aiding-compliance"
---
...
| Data Controller | The entity that collects and processes personal data of data subjects ([read GDPR for exact definition](https://gdpr-info.eu/art-4-gdpr/)) |
| Data Processor | The entity that collects and processes personal data on behalf of a data controller ([read GDPR for exact definition](https://gdpr-info.eu/art-4-gdpr/)) |
