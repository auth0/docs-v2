...
description: Learn how Auth0 handles tenant data in its possession, including storage regions, retention, encryption, and access controls.
redirects:
  - "/docs/compliance/data-processing"
  - "/docs/compliance/gdpr/data-processing"
---
