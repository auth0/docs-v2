...
redirects:
  - "/docs/security/data-security/denylist"
  - "/docs/security/denylist-user-attributes"
  - "/docs/blacklist-attributes"
  - "/docs/tutorials/blacklisting-attributes"
  - "/docs/security/blacklisting-attributes"
  - "/docs/security/blacklist-user-attributes"
---
