...
redirects:
  - "/docs/security/data-security/allowlist"
  - "/docs/security/allowlist-ip-addresses"
  - "/docs/security/whitelist-ip-addresses"
  - "/docs/guides/ip-whitelist"
---
...
#### Detecting changes
You can detect changes to the machine-readable list programmatically based on the last_updated_at property or based on Auth0's response to a conditional HTTP request. Auth0 updates this list ahead of any functional impact to existing tenants. Schedule a weekly programmatic check to monitor changes and maintain adequate firewall configurations.
