...
redirects:
  - "/docs/security/data-security/user-data-storage"
  - "/docs/user-profile/user-data-storage"
  - "/docs/users/user-data-storage"
  - "/docs/users/references/user-data-storage-best-practices"
  - "/docs/best-practices/user-data-storage-best-practices"
  - "/docs/users/user-data-storage-scenario"
  - "/docs/users/references/user-data-storage-scenario"
  - "/docs/users/store-user-data"
  - "/docs/users/normalized/auth0/store-user-data"
---
...
<Frame>![iOS app settings screen with option to update display name.](/docs/images/cdy7uua7fh8z/33YxGQKYztHY3OM6mxJ4jN/0a06103e6b6455c2e1962a1f738b663a/4-settings.png)</Frame>
...
<Frame>![Example of user profile page with editor role.](/docs/images/cdy7uua7fh8z/1WEKC4eWvm8GPK2BlodGFk/3eb36843f22518ace800fc1507bd5816/3-home.png)</Frame>
