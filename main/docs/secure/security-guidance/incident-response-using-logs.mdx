---
description: Learn how to use Auth0 tenant logs as part of your incident response plan to investigate suspicious logins, identify the scope of a breach, and produce an audit timeline.
title: 'Incident Response: Using Logs'
redirects:
  - "/docs/security/incident-response-using-logs"
---
