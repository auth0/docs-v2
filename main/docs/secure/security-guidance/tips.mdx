---
description: Apply general Auth0 security tips to prevent breaches, including credential hygiene, secret rotation, tenant isolation, log monitoring, and access reviews.
title: General Security Tips
redirects:
  - "/docs/security/tips"
  - "/docs/security/general-security-tips"
---
