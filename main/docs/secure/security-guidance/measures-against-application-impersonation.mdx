...
Frame ![Auth0 Dashboard>Tenant Settings>Advanced>Skip Custom URI toggle](main/images/cdy7uua7fh8z/Auth0 Dashboard > Tenant Settings > Skip Custom URI toggle.png)

* **Non-Verifable Callback URI End-User Confirmation**: (Application) Navigate to [Auth0 Dashboard > Applications > Settings](https://manage.auth0.com/applications/settings).  Enable the toggle to activate the prompt. Disable the toggle to deactivate the prompt. To learn more, review [Application Settings](/get-started/applications/application-settings).