---
description: Describes how to use universal links rather than custom URL schemes to verify the legitimacy of authentication data.
title: Measures Against Application Impersonation
validatedOn: 2026-02-10
redirects:
  - "/docs/secure/security-guidance/measures-against-application-impersonation"
---
