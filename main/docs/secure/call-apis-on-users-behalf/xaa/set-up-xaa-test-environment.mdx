...
1. Configure and register your API in Auth0. To learn more, read [Create the API in Auth0](#create-the-api-in-auth0).
...
For the enterprise IdP-side configuration in each of these steps, read the applicable guide in IdP Integration — [Okta as OIDC IdP](/docs/secure/call-apis-on-users-behalf/xaa/idp/okta-as-oidc-idp), [Okta as SAML IdP](/docs/secure/call-apis-on-users-behalf/xaa/idp/okta-as-saml-idp), [Generic OIDC IdP](/docs/secure/call-apis-on-users-behalf/xaa/idp/generic-oidc-idp), or [Generic SAML IdP](/docs/secure/call-apis-on-users-behalf/xaa/idp/generic-saml-idp) — depending on the IdP and protocol you want to use to federate with it.
...
In the Auth0 Dashboard, [register a custom API](/docs/get-started/auth0-overview/set-up-apis) representing your SaaS API in your Auth0 tenant. If you're exposing an MCP server, read [Authorization for your MCP Server](https://auth0.com/ai/docs/mcp/get-started/authorization-for-your-mcp-server) too.
...
Once both are configured, read [End-to-end Testing](/docs/secure/call-apis-on-users-behalf/xaa/end-to-end-testing) to test the full flow.
