...
- To enable Cross App Access, email `developers@okta.com` to request XAA enablement for your Okta tenant. Once approved, the Okta team will share links to any available XAA Requesting and Resource Apps. 
