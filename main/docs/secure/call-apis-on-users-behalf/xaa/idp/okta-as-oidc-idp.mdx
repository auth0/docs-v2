...
In the Application section, select Resource application you created and set **AI agent's client ID registered in the app** to **client_id** of the **Agent0** application in your **Auth0 tenant**.

<Frame>![](/docs/images/xaa/xaa_okta_ai_agent_resource_connections_tab.png)</Frame>

Once resource connections are set correctly, checkbox appears on the side of the tab.
...
In your Auth0 Tenant's Management Console go to Authentication > Enterprise > Okta Workforce and select **+ Create Connection**.
