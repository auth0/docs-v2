...
[Promoting a connection to the domain level](/docs/authenticate/identity-providers/promote-connections-to-domain-level) makes the connection available to any third-party application in your tenant for standard authentication, not just through Cross App Access. Only promote the connection to the domain level if you want to grant all third-party applications in your tenant the ability to authenticate through the Okta Workforce Enterprise Connection.
