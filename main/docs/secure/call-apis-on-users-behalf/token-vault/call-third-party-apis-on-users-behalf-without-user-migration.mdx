---
description: Enable AI agents to call third-party APIs on the user's behalf without migrating your user identity store to Auth0.
title: Call Third-Party APIs on User's Behalf Without User Migration
sidebarTitle: Call Third-Party APIs on User's Behalf Without User Migration
---
