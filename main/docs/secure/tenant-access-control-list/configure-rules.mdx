---
title: How to Configure Tenant Access Control List Rules
sidebarTitle: Configure Rules
description: Define a rule's signal, condition, action, scope, and priority to define its behavior. Use the Management API or Auth0's SDKs, CLIs, or Terraform provider to configure and manage the Tenant ACL.
---
