---
title: Code Samples for Common Tenant Access Control List Use Cases
sidebarTitle: Code Samples
description: Implement common use cases for the Tenant ACL with these code samples for Management API requests, Auth0 SDKs and CLIs, and the Auth0 Terraform provider.
---
