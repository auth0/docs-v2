---
title: Management API Parameter Reference for Tenant Access Control List Rules
sidebarTitle: API Parameters
description: View descriptions of all parameters for Tenant ACL endpoints in the Management API.
---
