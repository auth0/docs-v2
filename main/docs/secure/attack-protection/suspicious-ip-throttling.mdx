...
redirects:
  - "/docs/configure/attack-protection/suspicious-ip-throttling"
  - "/docs/attack-protection/suspicious-ip-throttling"
  - "/docs/anomaly-detection/suspicious-ip-throttling"
  - "/docs/configure/anomaly-detection/suspicious-ip-throttling"
---
...
<Frame>![Auth0 suspicious IP throttling settings ](/docs/images/cdy7uua7fh8z/3CKuhfeU1nqDxrJJKAYR2k/1e2c42598ed6b00685f7623c11cc9f7e/Suspicious_IP_Throttling_-_English.png)</Frame>
...
1. Go to [Dashboard > Security > Attack Protection](https://manage.auth0.com/#/security/attack-protection), and select **Suspicious IP Throttling.**
   ...
   <Frame>![Suspicious IP throttling customization in the Auth0 dashboard](/docs/images/cdy7uua7fh8z/5yLYmDn0FvDB061WgTH2fk/0f3dce552a41aa5756a2eca788944965/Screen_Shot_2021-09-29_at_10.19.32_AM.png)</Frame>
