...
redirects:
  - "/docs/configure/attack-protection/breached-password-detection"
  - "/docs/attack-protection/breached-password-detection"
  - "/docs/anomaly-detection/breached-password-security"
  - "/docs/anomaly-detection/breached-passwords"
  - "/docs/anomaly-detection/concepts/breached-passwords"
  - "/docs/anomaly-detection/references/breached-password-detection-triggers-actions"
---
<Warning>
