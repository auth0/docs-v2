...
redirects:
  - "/docs/secure/attack-protection/bot-detection/configure-recaptcha-enterprise"
  - "/docs/configure/attack-protection/bot-detection/configure-recaptcha-enterprise"
  - "/docs/attack-protection/bot-detection/configure-recaptcha-enterprise"
  - "/docs/anomaly-detection/bot-detection/configure-recaptcha-enterprise"
  - "/docs/configure/anomaly-detection/bot-detection/configure-recaptcha-enterprise"
---
