...
redirects:
  - "/docs/configure/attack-protection/bot-detection/bot-detection-custom-login-pages"
  - "/docs/attack-protection/bot-detection/bot-detection-custom-login-pages"
  - "/docs/configure/anomaly-detection/bot-detection/bot-detection-custom-login-pages"
  - "/docs/anomaly-detection/bot-detection/bot-detection-custom-login-pages"
---
