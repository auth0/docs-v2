...
redirects:
  - "/docs/configure/attack-protection/bot-detection/bot-detection-native-apps"
  - "/docs/anomaly-detection/bot-detection/bot-detection-native-apps"
  - "/docs/configure/anomaly-detection/bot-detection/bot-detection-native-apps"
---
