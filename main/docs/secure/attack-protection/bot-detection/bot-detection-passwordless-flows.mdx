...
If you are using the [Auth0.js SDK](/docs/libraries/auth0-single-page-app-sdk), you must update to version 9.20.0 or higher to use Bot Detection for passwordless flows.
