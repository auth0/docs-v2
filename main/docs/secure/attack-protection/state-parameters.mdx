...
redirects:
  - "/docs/configure/attack-protection/state-parameters"
  - "/docs/authorization/protocols/state-parameters"
  - "/docs/protocols/state-parameters"
  - "/docs/protocols/oauth2/mitigate-csrf-attacks"
  - "/docs/protocols/oauth-state"
  - "/docs/protocols/oauth2/oauth-state"
---
