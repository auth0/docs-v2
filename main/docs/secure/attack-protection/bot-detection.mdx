...
3. In the **Response** section, choose a bot detection response.
   ...
   * when the Bot Detection service is unreacheable, the authentication process is prioritized and proceeds without a CAPTCHA challenge. The end user does not see an error message and are not blocked from logging in or registering. 
