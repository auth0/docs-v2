...
| :--- | :--- | :--- |
| Login | • `akamaiBot`<br />• `akamaiUserRisk` | [`event.authentication.riskAssessment.supplemental.akamai`](/docs/customize/actions/explore-triggers/signup-and-login-triggers/login-trigger/post-login-event-object) |
| Pre-User Registration | • `akamaiBot`<br />• `akamaiUserRisk` | [`event.authentication.riskAssessment.supplemental.akamai`](/docs/customize/actions/explore-triggers/signup-and-login-triggers/login-trigger/pre-user-registration-trigger/pre-user-registration-event-object) |
| Post-User Registration | • `akamaiBot`<br />• `akamaiUserRisk` | [`event.authentication.riskAssessment.supplemental.akamai`](/docs/customize/actions/explore-triggers/signup-and-login-triggers/login-trigger/post-user-registration-trigger/post-user-registration-event-object) |
| Send Phone Message | None | N/A |
| Post-Challenge | • `akamaiBot`<br />• `akamaiUserRisk` | [`event.authentication.riskAssessment.supplemental.akamai`](/docs/customize/actions/explore-triggers/password-reset-triggers/post-challenge-trigger/post-challenge-event-object) |
| Post-Change Password | • `akamaiBot`<br />• `akamaiUserRisk` | [`event.authentication.riskAssessment.supplemental.akamai`](/docs/customize/actions/explore-triggers/password-reset-triggers/post-change-password-trigger/post-change-password-event-object) |
