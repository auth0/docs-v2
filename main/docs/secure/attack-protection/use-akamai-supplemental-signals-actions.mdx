...
description: Use Auth0 Actions with Akamai Account Protector signals to enrich login decisions with bot, fraud, and risk scores from Akamai's edge network.
---
