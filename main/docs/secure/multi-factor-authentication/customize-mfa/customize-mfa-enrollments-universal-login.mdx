...
redirects:
  - "/docs/secure/multi-factor-authentication/customize-mfa-enrollments"
---
...
Tenant logs are available in the Auth0 Dashboard under [Monitoring > Logs](https://manage.auth0.com/#/logs). Alternatively, you can retrieve logs using the [Management API](/docs/api/management/v2).
