---
description: Customize the Auth0 MFA page for Classic Login with HTML, CSS, and Liquid templates, including branding options and enrollment invitation display.
title: Customize MFA for Classic Login
redirects:
  - "/docs/secure/multi-factor-authentication/customize-mfa/mfa-classic-experience"
  - "/docs/login/mfa/customize-mfa-user-pages/mfa-classic-experience"
  - "/docs/universal-login/classic-experience/mfa-classic-experience"
  - "/docs/universal-login/guardian"
  - "/docs/hosted-pages/guardian"
  - "/docs/universal-login/multifactor-authentication"
---
