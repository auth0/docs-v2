...
redirects:
  - "/docs/login/mfa/customize-mfa-user-pages/mfa-widget-theme-options"
  - "/docs/mfa/references/mfa-widget-reference"
  - "/docs/mfa/customize-mfa-user-pages/mfa-widget-theme-options"
---
