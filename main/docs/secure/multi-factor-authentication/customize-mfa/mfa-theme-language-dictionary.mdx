...
redirects:
  - "/docs/login/mfa/customize-mfa-user-pages/mfa-theme-language-dictionary"
  - "/docs/mfa/references/language-dictionary"
  - "/docs/mfa/customize-mfa-user-pages/mfa-theme-language-dictionary"
---
## defaultLocation
