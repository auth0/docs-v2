...
redirects:
  - "/docs/login/mfa/customize-mfa-user-pages"
  - "/docs/mfa/customize-mfa-user-pages"
  - "/docs/multifactor-authentication/google-auth/dev-guide"
  - "/docs/mfa/guides/customize-mfa-universal-login"
  - "/docs/multifactor-authentication/custom"
---
