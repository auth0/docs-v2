...
redirects:
  - "/docs/secure/multi-factor-authentication/authenticate-using-ropg-flow-with-mfa/manage-authenticator-factors-mfa-api"
  - "/docs/login/mfa/ropg-mfa/manage-authenticator-factors-mfa-api"
  - "/docs/mfa/authenticate-with-ropg-and-mfa/manage-authenticator-factors-mfa-api"
  - "/docs/multifactor-authentication/api/manage"
  - "/docs/mfa/guides/mfa-api/manage"
---
