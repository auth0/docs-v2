...
Auth0 recommends that tenant administrators [create an action](/docs/customize/actions/write-your-first-action) that sets `allowRememberBrowser` to false. This will hide **Remember this browser** from view in the end user's experience. You can further set `allowRememberBrowser` with intermitten login ranges using Advanced Factor Configurations. To learn more, read [Configure Advanced MFA Factor Settings](/docs/secure/multi-factor-authentication/customize-mfa/advanced-factor-configuration).
