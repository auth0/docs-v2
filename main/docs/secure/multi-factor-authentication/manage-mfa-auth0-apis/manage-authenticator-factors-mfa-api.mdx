...
Auth0 recommends that tenant administrators [create an action](/docs/customize/actions/write-your-first-action) that sets `allowRememberBrowser` to false. This will hide **Remember this browser** from view in the end user's experience. You can also configure trusted browser lifetime limits using the Auth0 Dashboard or Actions. To learn more, read [Change frequency of MFA prompts](/docs/secure/multi-factor-authentication/customize-mfa#change-frequency-of-mfa-prompts).
