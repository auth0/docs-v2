...
description: Customize Auth0 Adaptive MFA with Actions to use risk assessment confidence and details to decide when to challenge, allow, or block a login attempt.
validatedOn: 2026-02-02
redirects:
  - "/docs/secure/multi-factor-authentication/adaptive-mfa/adaptive-mfa-rules"
  - "/docs/secure/multi-factor-authentication/adaptive-mfa/adaptive-mfa-rule-actions"
  - "/docs/login/mfa/adaptive-mfa/adaptive-mfa-rule-actions"
  - "/docs/mfa/adpative-mfa/adaptive-mfa-rule-actions"
---
...
If you want to implement your own method for evaluating the overall confidence score of different scenarios, you can use the data available in the `riskAssessment` object, which contains the overall confidence score, versioning information, and details of the individual assessments.
