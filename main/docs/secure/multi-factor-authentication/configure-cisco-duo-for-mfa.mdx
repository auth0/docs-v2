---
description: Configure Cisco Duo Security as an Auth0 MFA factor with your Duo Web SDK credentials, including the integration key, secret key, and API hostname.
title: Configure Cisco Duo Security for MFA
redirects:
  - "/docs/login/mfa/mfa-factors/configure-cisco-duo-for-mfa"
  - "/docs/login/mfa/configure-cisco-duo-for-mfa"
  - "/docs/mfa/configure-cisco-duo-for-mfa"
  - "/docs/multifactor-authentication/duo/user-guide"
  - "/docs/multifactor-authentication/duo/dev-guide"
  - "/docs/mfa/guides/configure-cisco-duo"
  - "/docs/multifactor-authentication/duo/admin-guide"
  - "/docs/multifactor-authentication/duo"
  - "/docs/multifactor-authentication/factors/duo"
---
