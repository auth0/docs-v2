...
redirects:
  - "/docs/login/mfa/mfa-factors/configure-email-notifications-for-mfa"
  - "/docs/mfa/configure-email-notifications-for-mfa"
  - "/docs/mfa/guides/configure-email"
  - "/docs/multifactor-authentication/factors/email"
  - "/docs/mfa/guides/configure-email-universal-login"
---
