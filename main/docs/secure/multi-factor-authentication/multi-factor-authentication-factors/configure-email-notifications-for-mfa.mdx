...
To configure an email OTP digit length and expiry time, you can use Advanced Factor Configuration to set a new range of digits and expiration date for one-time password. To learn more, read [Configure Advanced MFA Factor Settings](/docs/secure/multi-factor-authentication/customize-mfa/advanced-factor-configuration).
