...
redirects:
  - "/docs/login/mfa/mfa-factors/configure-otp-notifications-for-mfa"
  - "/docs/mfa/configure-otp-notifications-for-mfa"
  - "/docs/mfa/guides/configure-otp"
  - "/docs/multifactor-authentication/factors/otp"
---
