...
1. Navigate to [**Auth0 Dashboard > Security > Multi-factor Auth**](https://manage.auth0.com/#/security/mfa).
...
4. Choose your delivery method:
  ...
  * Voice: Verification code delivery by voice message.
5. Configure the code length and code lifetime:
  * Code Length: Enter a value between 4 and 10 digits. The default is 6 digits.
