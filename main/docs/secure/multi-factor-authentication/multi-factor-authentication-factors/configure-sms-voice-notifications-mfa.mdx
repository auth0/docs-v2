...
redirects:
  - "/docs/login/mfa/mfa-factors/configure-sms-voice-notifications-mfa"
  - "/docs/mfa/configure-sms-voice-notifications-mfa"
  - "/docs/mfa/guides/configure-phone"
  - "/docs/mfa/guides/configure-sms"
  - "/docs/multifactor-authentication/factors/sms"
  - "/docs/multifactor-authentication/twilio-configuration"
  - "/docs/multifactor-authentication/administrator/sms-notifications"
  - "/docs/multifactor-authentication/administrator/twilio-configuration"
---
