---
description: Configure push notifications as an Auth0 MFA factor with AWS SNS, Firebase Cloud Messaging, or Apple Push Notifications via the Auth0 Guardian SDK.
title: Configure Push Notifications for MFA
redirects:
  - "/docs/login/mfa/mfa-factors/configure-push-notifications-for-mfa"
  - "/docs/mfa/configure-push-notifications-for-mfa"
  - "/docs/multifactor-authentication/administrator/push-notifications"
  - "/docs/mfa/guides/configure-push"
  - "/docs/multifactor-authentication/factors/push"
  - "/docs/multifactor-authentication/developer/sns-configuration"
---
