...
redirects:
  - "/docs/login/mfa/ropg-mfa"
  - "/docs/mfa/authenticate-with-ropg-and-mfa"
  - "/docs/mfa/guides/mfa-api/multifactor-resource-owner-password"
  - "/docs/mfa/guides/mfa-api/authenticate"
  - "/docs/api-auth/tutorials/multifactor-resource-owner-password"
---
