---
description: Configure WebAuthn with security keys as an Auth0 MFA factor, with options for user verification, Relying Party ID, and browser support requirements.
title: Configure WebAuthn with Security Keys for MFA
redirects:
  - "/docs/login/mfa/fido-authentication-with-webauthn/configure-webauthn-security-keys-for-mfa"
  - "/docs/mfa/configure-webauthn-with-security-keys-for-mfa"
  - "/docs/mfa/configure-webauthn-security-keys-for-mfa"
---
