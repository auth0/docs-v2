...
<Frame>![Auth0 Dashboard > Security > Multi-factor Auth > Guardian > Custom > Amazon SNS](https://images.ctfassets.net/cdy7uua7fh8z/6PKSyH99GJ2CalJoG38sfZ/fbe7229dcc6f7d303a582520001b3dc1/Amazon_SNS.png)</Frame>
...
1. Access the Auth0 login prompt and copy the provided code or a similar base32 encoded key obtained from another source.
   ...
   <Frame>![An example login prompt displaying a one-time code](https://images.ctfassets.net/cdy7uua7fh8z/1yoqiIuERVTwCU8yfx6IM8/047513dfe1d40a22ce811b131d5ea289/OTP_Challenge_2_-_English.png)</Frame>
...
<Frame>![The authentication method selection screen](https://images.ctfassets.net/cdy7uua7fh8z/1k7IsU9kfP5mrXU2jfGHuT/d61e0dcd09b633dbeb2cb54e1fd49018/2025-01-27_14-47-32.png)</Frame>
...
<Frame>![The Verify Your Identity screen prompting the user for a one-time code](https://images.ctfassets.net/cdy7uua7fh8z/S6uTieLjtuNUrQRMh8uch/21f1671d21ae9f61b63154ffaa21b5a2/OTP_Challenge_-_English.png)</Frame>
