...
redirects:
  - "/docs/login/mfa/ropg-mfa/enroll-challenge-sms-voice-authenticators"
  - "/docs/mfa/authenticate-with-ropg-and-mfa/enroll-challenge-sms-voice-authenticators"
  - "/docs/mfa/guides/mfa-api/oob"
  - "/docs/multifactor-authentication/api/oob"
  - "/docs/mfa/guides/mfa-api/phone"
---
