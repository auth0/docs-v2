...
redirects:
  - "/docs/login/mfa/ropg-mfa/enroll-and-challenge-otp-authenticators"
  - "/docs/mfa/authenticate-with-ropg-and-mfa/enroll-and-challenge-otp-authenticators"
  - "/docs/multifactor-authentication/google-authenticator"
  - "/docs/mfa/guides/mfa-api/otp"
  - "/docs/multifactor-authentication/api/otp"
---
