---
description: Import MFA enrollments into Auth0 alongside user records to preserve authenticator app, SMS, and email factors for existing users after migration.
title: Import User MFA Authenticator Enrollments
redirects:
  - "/docs/login/mfa/ropg-mfa/import-user-mfa-authenticator-enrollments"
  - "/docs/mfa/guides/import-user-mfa"
  - "/docs/mfa/import-user-mfa-authenticator-enrollments"
---
...
MFA enrollment imports provide a seamless user experience because users don't have to re-enroll after migration.
...
Any failures appear in your tenant logs as failed logins, and are distinguishable from other failures by their description: `Unable to import MFA factors`. For example:
