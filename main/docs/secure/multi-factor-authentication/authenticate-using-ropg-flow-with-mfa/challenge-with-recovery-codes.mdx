...
redirects:
  - "/docs/login/mfa/ropg-mfa/challenge-with-recovery-codes"
  - "/docs/mfa/authenticate-with-ropg-and-mfa/manage-authenticator-factors-mfa-api/challenge-with-recovery-codes"
  - "/docs/mfa/guides/mfa-api/recovery-code"
---
