...
redirects:
  - "/docs/login/mfa/ropg-mfa/enroll-and-challenge-email-authenticators"
  - "/docs/mfa/authenticate-with-ropg-and-mfa/enroll-and-challenge-email-authenticators"
  - "/docs/multifactor-authentication/administrator/guardian-enrollment-email"
  - "/docs/mfa/guides/mfa-api/email"
  - "/docs/multifactor-authentication/api/email"
---
