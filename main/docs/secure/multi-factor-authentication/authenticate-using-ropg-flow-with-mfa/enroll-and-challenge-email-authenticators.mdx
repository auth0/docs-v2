...
Default OTP length is 6 digits. You can configure email OTP length and expiry times with Advanced Factor Configuration. To learn more, read [Advanced MFA Factor Settings](/docs/secure/multi-factor-authentication/customize-mfa/advanced-factor-configuration).
