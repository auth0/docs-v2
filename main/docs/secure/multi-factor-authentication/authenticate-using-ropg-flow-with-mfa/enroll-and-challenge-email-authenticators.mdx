...
The user should receive an email containing the one-time code that they can provide to the application.

<Callout icon="file-lines" color="#0EA5E9" iconType="regular">

Default OTP length is 6 digits. You can configure email OTP code length and expiration time in the Auth0 Dashboard or using the Management API. To learn more, read [Configure OTP settings](/docs/secure/multi-factor-authentication/multi-factor-authentication-factors/configure-email-notifications-for-mfa#configure-otp-settings).
