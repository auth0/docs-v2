...
title: Adaptive MFA
redirects:
  - "/docs/login/mfa/adaptive-mfa"
  - "/docs/mfa/adaptive-mfa"
---
...
| Overall Risk Score | A combination of all 3 factors above. | Auth0 uses all 3 scores to assign an overall score. Use [Actions](/docs/secure/multi-factor-authentication/adaptive-mfa/customize-adaptive-mfa) if you want to implement your own business logic. |
...
| OIDC/OAuth2 | Custom Token Exchange | Not supported |
