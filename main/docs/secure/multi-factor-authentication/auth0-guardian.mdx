---
'og:description': Describes how Guardian works and how the Guardian SDK helps you
...
<Frame>![Auth0 Guardian flow diagram](https://images.ctfassets.net/cdy7uua7fh8z/TdN0nXfYs0mqHpi9U3JQ9/7bf919773ed8f94c7d5be25cc345eebd/diagram.png)</Frame>
...
<Frame>![Auth0 Dashboard > Security > Multi-factor Auth > Push Notification using Auth0 Guardian](https://images.ctfassets.net/cdy7uua7fh8z/fwjSKFNhsvObzdPDiA79N/65850980f88029cb23eef5eaef4f9b20/Auth0_Dashboard_-_Push_Notification_screen.png)</Frame>
...
2. On the MFA prompt, the user selects the **Manually Enter Code** button. The user must select this option to authenticate using OTPs.
   ...
   <Frame>![An example MFA prompt displaying the Manually Enter Code button](https://images.ctfassets.net/cdy7uua7fh8z/7reEOLI5CWxbpRzgZY7gxg/58da830927a33545d9a576974ec3ba6e/MFA_-_Push_-_English.png)</Frame>
...
<Frame>![An example OTP enrollment prompt displaying the Trouble Scanning? link](https://images.ctfassets.net/cdy7uua7fh8z/3kbyOBiLOpJiY8vI0kUqwg/b10f58a3b3ace74de613e28517726069/OTP_Challenge_3_-_English.png)</Frame>

* **For mobile devices**: Universal Login skips the QR code and instead displays the enrollment code directly.

<Frame>![The temporary one-time password enrollment screen as displayed on a mobile device. ](https://images.ctfassets.net/cdy7uua7fh8z/5QvQ9FLYnVZXINFAeLkIr9/04df9be004169ac06b8d9fee456dc599/OTP_prompt_-_English.png)</Frame>
