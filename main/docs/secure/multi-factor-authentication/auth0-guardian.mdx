...
redirects:
  - "/docs/login/mfa/auth0-guardian"
  - "/docs/mfa/auth0-guardian"
  - "/docs/multifactor-authentication/guardian/admin-guide"
  - "/docs/multifactor-authentication/guardian/dev-guide"
  - "/docs/mfa/concepts/guardian"
---
