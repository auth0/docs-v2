...
Auth0's Advanced Factor Configuration (AFC) feature allows you to configure the OTP expiry and length further than the default OTP length of 6 digits and expiry of 300 seconds. With AFC, you can set one-time passwords from 4-10 digits and expiry between 30–3600 seconds (1 hour).
