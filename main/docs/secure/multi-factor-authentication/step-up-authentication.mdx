...
redirects:
  - "/docs/login/mfa/step-up-authentication"
  - "/docs/mfa/step-up-authentication"
  - "/docs/multifactor-authentication/developer/step-up-with-acr"
  - "/docs/mfa/concepts/step-up-authentication"
  - "/docs/multifactor-authentication/step-up-authentication"
  - "/docs/tutorials/setup-up-authentication"
  - "/docs/tutorials/step-up-authentication"
  - "/docs/step-up-authentication"
  - "/docs/multifactor-authentication/developer/step-up-authentication"
---
