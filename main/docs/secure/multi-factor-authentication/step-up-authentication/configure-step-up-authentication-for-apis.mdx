...
redirects:
  - "/docs/login/mfa/step-up-authentication/configure-step-up-authentication-for-apis"
  - "/docs/mfa/step-up-authentication/configure-step-up-authentication-for-apis"
  - "/docs/mfa/guides/configure-step-up-apis"
  - "/docs/multifactor-authentication/step-up-authentication/step-up-for-apis"
  - "/docs/multifactor-authentication/developer/step-up-authentication/step-up-for-apis"
  - "/docs/multifactor-authentication/api/challenges"
---
