...
redirects:
  - "/docs/login/mfa/step-up-authentication/configure-step-up-authentication-for-web-apps"
  - "/docs/mfa/step-up-authentication/configure-step-up-authentication-for-web-apps"
  - "/docs/mfa/guides/configure-step-up-web-apps"
  - "/docs/multifactor-authentication/step-up-authentication/step-up-for-web-apps"
  - "/docs/multifactor-authentication/developer/step-up-authentication/step-up-for-web-apps"
---
