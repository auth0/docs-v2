...
redirects:
  - "/docs/login/mfa/mfa-developer-resources"
  - "/docs/mfa/mfa-developer-resources"
  - "/docs/mfa/concepts/developer-resources"
  - "/docs/multifactor-authentication/developer"
  - "/docs/mfa/concepts/mfa-developer-resources"
---
