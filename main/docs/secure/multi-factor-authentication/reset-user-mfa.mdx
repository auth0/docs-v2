...
redirects:
  - "/docs/login/mfa/reset-user-mfa"
  - "/docs/mfa/reset-user-mfa"
  - "/docs/multifactor-authentication/administrator/disabling-mfa"
  - "/docs/mfa/guides/reset-user-mfa"
  - "/docs/multifactor-authentication/administrator/reset-user"
  - "/docs/multifactor-authentication/reset-user"
---
