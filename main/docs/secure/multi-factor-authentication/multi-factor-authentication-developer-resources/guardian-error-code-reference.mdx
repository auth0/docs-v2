---
description: Use Auth0 Guardian error codes and descriptions to identify token, enrollment, push notification, SMS, and transaction errors.
title: Guardian Error Code Reference
redirects:
  - "/docs/secure/multi-factor-authentication/auth0-guardian/guardian-error-code-reference"
  - "/docs/login/mfa/auth0-guardian/guardian-error-code-reference"
  - "/docs/mfa/references/guardian-error-code-reference"
  - "/docs/mfa/auth0-guardian/guardian-error-code-reference"
---
