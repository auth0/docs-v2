...
redirects:
  - "/docs/secure/multi-factor-authentication/auth0-guardian/create-custom-enrollment-tickets"
  - "/docs/login/mfa/auth0-guardian/create-custom-enrollment-tickets"
  - "/docs/mfa/auth0-guardian/create-custom-enrollment-tickets"
  - "/docs/mfa/guides/guardian/create-enrollment-ticket"
  - "/docs/multifactor-authentication/developer/custom-enrollment-ticket"
---
