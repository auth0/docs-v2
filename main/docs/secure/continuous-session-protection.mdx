---
description: Learn about Auth0 Continuous Session Protection to re-evaluate session risk during long-lived sessions to detect token theft, account takeover, and anomalous activity in flight.
...
| Read... | To learn... |
| --- | --- |
| [Refresh Tokens with Actions](/docs/secure/tokens/refresh-tokens/manage-refresh-tokens-actions) | How to manage refresh tokens with Actions |
| [Sessions with Actions](/docs/manage-users/sessions/manage-sessions-actions) | How to manage sessions with Actions. |