...
redirects:
  - "/docs/configure/attack-protection"
  - "/docs/attack-protection"
  - "/docs/anomaly-detection"
  - "/docs/attack-protection/set-attack-protection-preferences"
  - "/docs/anomaly-detection/set-anomaly-detection-preferences"
  - "/docs/anomaly-detection/guides/set-anomaly-detection-preferences"
  - "/docs/anomaly-detection/references/anomaly-detection-restrictions-limitations"
  - "/docs/anomaly-detection/references/anomaly-detection-faqs"
  - "/docs/anomaly"
  - "/docs/anomaly-"
---
