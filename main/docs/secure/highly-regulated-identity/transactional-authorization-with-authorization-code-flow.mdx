---
description: Learn about how Highly Regulated Identity enables transactional authorization with the Authorization Code Flow.
title: Transactional Authorization with Authorization Code Flow
redirects:
  - "/docs/secure/highly-regulated-identity/transactional-authorization-with-contextual-sca"
---
