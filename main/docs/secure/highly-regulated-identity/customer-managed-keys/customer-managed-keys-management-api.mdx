---
description: Enable and configure Customer Managed Keys (BYOK) for your Auth0 tenant using the Management API to import and activate a customer-provided root key.
