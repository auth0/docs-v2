...
redirects:
  - "/docs/get-started/applications/configure-sender-constraining/configure-resource-server-for-sender-constraining"
  - "/docs/get-started/applications/configure-sender-constraining/configure-client-for-sender-constraining"
  - "/docs/configure-client-for-sender-constraining"
  - "/docs/secure/sender-constraining/configure-sender-constraining/configure-resource-server-for-sender-constraining"
---
