...
* DPoP is not configured. Verify `dpop_signing_alg` is set in the connection options using the Management API's [Update a connection](https://auth0.com/docs/api/management/v2/connections/patch-connections-by-id) endpoint as described above.
