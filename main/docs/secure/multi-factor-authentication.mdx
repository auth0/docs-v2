...
redirects:
  - "/docs/login/mfa"
  - "/docs/mfa"
  - "/docs/multi-factor-authentication/yubikey"
  - "/docs/multifactor-authentication/guardian/user-guide"
  - "/docs/multifactor-authentication/guardian"
  - "/docs/multifactor-authentication/yubikey"
  - "/docs/mfa-in-auth0"
  - "/docs/multifactor-authentication"
  - "/docs/multifactor-authentication/custom-provider"
  - "/docs/multi-factor-authentication2"
  - "/docs/multi-factor-authentication"
---
<Card title="Overview">
