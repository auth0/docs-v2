...
If you're prompted to add two-factor (2FA) or multi-factor authentcation (MFA) to an application's login flow, review this article to gain context on factors supported by Auth0 and review related pages on how to configure this approach.
</Visibility>
