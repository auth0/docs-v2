...
</Card><Card title="AI Agent" href="https://auth0.com/ai/docs">

An AI agent to call external APIs on the user’s behalf and use human-in-the-loop controls
...
</Card><Card title="Build with AI Tools" href="/docs/get-started/build-with-ai-tools">

Learn how to use AI tools to search and index the Auth0 knowledge base.

</Card><Card title="Agent Experience Score" href="/docs/get-started/agent-experience">

See how AI agents perform when implementing Auth0 across models and frameworks.
