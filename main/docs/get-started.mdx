...
description: Get started with Auth0 by setting up the tenant, applications, and identity connections you need to add authentication to your products.
redirects:
  - "/docs/identity-labs/*"
  - "/docs/labs"
  ...
  - "/docs/get-started/professional-services/*"
  - "/docs/troubleshoot/professional-services/*"
  - "/docs/auth0-professional-services"
  - "/docs/services/*"
---
