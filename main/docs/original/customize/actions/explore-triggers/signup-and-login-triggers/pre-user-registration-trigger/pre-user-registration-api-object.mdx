...
<em>Optional number</em>. The absolute expiry time in milliseconds
            ...
            <code>expires_at</code>. This value should not be supplied if a value was also provided for `ttl`. If both options are supplied, the earlier expiry of the two will be used.
          </p>
</td>
</tr>
<tr>
...
<em>Optional number</em>. The time-to-live value of this cache entry
           ...
           This value should not be supplied if a value was also
...
Note: The error is handled by Universal Login on signups performed through redirection journey.
...
<td>
<p><em>String</em>. A custom error message presented to users when their registrations are denied.</p>
</td>
</tr>
</tbody>
</table>
