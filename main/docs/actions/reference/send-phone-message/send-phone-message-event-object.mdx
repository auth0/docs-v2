...
redirects:
  - "/docs/customize/actions/flows-and-triggers/send-phone-message-flow/event-object"
  - "/docs/customize/actions/triggers/send-phone-message/event-object"
  - "/docs/actions/triggers/send-phone-message/event-object"
  - "/docs/customize/actions/explore-triggers/mfa-notifications-trigger/send-phone-message-event-object"
---
...
<ResponseField name="event.message_options" type="object">
  ...
  <Expandable title="event.message_options properties" defaultOpen>
