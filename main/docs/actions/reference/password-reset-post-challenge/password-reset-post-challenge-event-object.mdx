...
redirects:
  - "/docs/customize/actions/flows-and-triggers/password-reset/event-object"
  - "/docs/customize/actions/flows-and-triggers/post-change-password-flow/event-object"
  - "/docs/customize/actions/triggers/post-change-password/event-object"
  - "/docs/actions/triggers/post-change-password/event-object"
  - "/docs/customize/actions/explore-triggers/password-reset-triggers/post-challenge-trigger/post-challenge-event-object"
---
