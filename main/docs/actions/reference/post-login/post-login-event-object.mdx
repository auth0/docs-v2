...
redirects:
  - "/docs/customize/actions/flows-and-triggers/login-flow/event-object"
  - "/docs/customize/actions/triggers/post-login/event-object"
  - "/docs/actions/triggers/post-login/event-object"
  - "/docs/customize/actions/explore-triggers/signup-and-login-triggers/login-trigger/post-login-event-object"
---
