...
redirects:
  - "/docs/customize/actions/flows-and-triggers/login-flow/api-object"
  - "/docs/customize/actions/triggers/post-login/api-object"
  - "/docs/actions/triggers/post-login/api-object"
  - "/docs/customize/actions/explore-triggers/signup-and-login-triggers/login-trigger/post-login-api-object"
---
...
<ParamField body="provider" type="string">
  ...
  Allowed values: `none`, `guardian`, `google-authenticator`, `duo`, `any`
</ParamField>
...
<ParamField body="params" type="getusereffectiverolesparams">
  - Checkpoint pagination parameters.
  Optional.
  <Expandable title="params properties">
    <ParamField body="take" type="number">
...
<ParamField body="ids" type="array of string">
  - Array of role IDs to filter by (up to 100).
</ParamField>
</Expandable>
