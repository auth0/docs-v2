...
redirects:
  - "/docs/customize/actions/flows-and-triggers/post-user-registration-flow/event-object"
  - "/docs/customize/actions/triggers/post-user-registration/event-object"
  - "/docs/actions/triggers/post-user-registration/event-object"
  - "/docs/customize/actions/explore-triggers/signup-and-login-triggers/post-user-registration-trigger/post-user-registration-event-object"
---
