...
redirects:
  - "/docs/customize/actions/flows-and-triggers/machine-to-machine-flow/event-object"
  - "/docs/customize/actions/triggers/credentials-exchange/event-object"
  - "/docs/actions/triggers/credentials-exchange/event-object"
  - "/docs/customize/actions/explore-triggers/credentials-exchange/credentials-exchange-event-object"
---
...
<ResponseField name="event.accessToken" type="object">
  ...
  <Expandable title="event.accessToken properties" defaultOpen>
...
<ResponseField name="event.agent" type="object" post={["optional"]}>
  ...
  <Expandable title="event.agent properties" defaultOpen>
