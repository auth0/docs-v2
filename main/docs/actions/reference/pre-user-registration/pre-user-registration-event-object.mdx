...
redirects:
  - "/docs/customize/actions/flows-and-triggers/pre-user-registration-flow/event-object"
  - "/docs/customize/actions/triggers/pre-user-registration/event-object"
  - "/docs/actions/triggers/pre-user-registration/event-object"
  - "/docs/customize/actions/explore-triggers/signup-and-login-triggers/pre-user-registration-trigger/pre-user-registration-event-object"
---
