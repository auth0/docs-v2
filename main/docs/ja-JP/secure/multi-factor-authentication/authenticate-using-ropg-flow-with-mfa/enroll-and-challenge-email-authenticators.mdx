...
* Dashboardで、または[Management API](https://auth0.com/docs/api/management/v2#!/Guardian/put_factors_by_name)を使って要素として[メールを構成](/docs/ja-JP/ja-jp/secure/multi-factor-authentication/multi-factor-authentication-factors/configure-email-notifications-for-mfa)します。
...
ユーザーが受信するメールをカスタマイズするオプションもあります。詳細は、[「メールテンプレートをカスタマイズする」](/docs/ja-JP/ja-jp/customize/email/email-templates)をお読みください。
