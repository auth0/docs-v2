...
* Dashboardまたは[Management API](https://auth0.com/docs/api/management/v2#!/Guardian/put_factors_by_name)を使って、要素として[プッシュを構成](/docs/ja-JP/ja-jp/secure/multi-factor-authentication/multi-factor-authentication-factors/configure-push-notifications-for-mfa)します。
...
ユーザーがプッシュで登録すると、OTPでも登録されます。これは、ユーザーに接続がないシナリオについて、Guardianが[OTPでのチャレンジ](/docs/ja-JP/ja-jp/secure/multi-factor-authentication/authenticate-using-ropg-flow-with-mfa/enroll-and-challenge-otp-authenticators)に対応しているためです。
...
* [MFA用プッシュ通知を構成する](/docs/ja-JP/ja-jp/secure/multi-factor-authentication/multi-factor-authentication-factors/configure-push-notifications-for-mfa)
