...
* [スコープ](/docs/ja-JP/ja-jp/get-started/apis/scopes)
* [「サンプルユースケース」の「スコープとクレーム」](/docs/ja-JP/ja-jp/get-started/apis/scopes/sample-use-cases-scopes-and-claims)
...
* [メールアドレスに基づいたスコープの割り当てに関するAuth0のセキュリティ情報](/docs/ja-JP/ja-jp/secure/security-guidance/security-bulletins/2019-09-05-scopes)