...
<Frame>![Two Universal Login prompts showing the language selection menu. ](/docs/images/ja-jp/cdy7uua7fh8z/4Z5pt3aH3vpRRYV0RDDnba/dc7a5abc8ee2cb462b2be4b43490393c/Language_Selector_Prompts.png)</Frame>
...
* Enable the languages you plan to add to your prompts in your Auth0 tenant.
  ...
  * On the Auth0 Dashboard, navigate to [Settings &gt; General &gt; Languages](https://manage.auth0.com/#/tenant/general) and enable one or more desired languages.
    ...
    * For more information, review [Universal Login Internationalization](/docs/ja-JP/ja-jp/customize/internationalization-and-localization/universal-login-internationalization).
...
To get started, add the following script to your [Universal Login page template](/docs/ja-JP/ja-jp/customize/login-pages/universal-login/customize-templates) to facilitate language selection.
...
<Accordion title="Signup Prompt: Identifier + Password">
  To add language selection to the `signup` prompt, use the [Set partials for a prompt](/docs/ja-JP/ja-jp/api/management/v2/prompts/put-partials) endpoint:
...
<Accordion title="Login Prompt: Identifier First">
  To add language selection to the `login-id` prompt, use the [Set partials for a prompt](/docs/ja-JP/ja-jp/api/management/v2/prompts/put-partials) endpoint:
...
<Accordion title="Login Prompt: Passwordless (Email)">
  To add language selection to the `login-passwordless-email-code` prompt, use the [Set partials for a prompt](/docs/ja-JP/ja-jp/api/management/v2/prompts/put-partials) endpoint:
