...
<tbody>
<tr>
<td><a href="/docs/ja-JP/customize/extensions/authorization-extension/v2">認可拡張機能</a></td>
<td>2.5.0+</td>
<td>旧バージョンを使用している場合は、<a href="https://manage.auth0.com/#/extensions">拡張機能</a>ページから拡張機能を手動で更新する必要があります。</td>
</tr>
<tr>
<td><a href="/docs/ja-JP/customize/extensions/delegated-admin/v3">委任管理</a></td>
<td>3.1+</td>
