...
<QuickstartButtons githubLink="https://github.com/auth0-samples/auth0-python-api-samples/tree/master/00-Starter-Seed" lang="ja" />
...
export const sections = [
  ...
  {
    id: "flaskアプリケーションを作成する",
    title: "Flaskアプリケーションを作成する",
  },
];
...
<Recipe>
  <Content>
    ...
    または、Auth0 Dashboardを使って初めてAPIをセットアップする方法を[使用の開始ガイド](/docs/ja-JP/ja-jp/get-started/auth0-overview/set-up-apis)で確認することもできます。
    ...
    <Section id={sections[2].id} title={sections[2].title} stepNumber="3">
      ...
      AuthLibの`JWTBearerTokenValidator`バリデーターに多少の変更を加えて、[アクセストークンの検証](/docs/ja-JP/ja-jp/secure/tokens/access-tokens/validate-access-tokens)要件が満たされるようにします。
