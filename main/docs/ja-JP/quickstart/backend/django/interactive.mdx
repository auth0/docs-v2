...
<QuickstartButtons githubLink="https://github.com/auth0-samples/auth0-django-api/tree/master/01-Authorization" lang="ja" />

export const sections = [
  { id: "アクセス許可を定義する", title: "アクセス許可を定義する" },
  {
    id: "djangoにauth0の使用を構成する",
    title: "DjangoにAuth0の使用を構成する",
  },
