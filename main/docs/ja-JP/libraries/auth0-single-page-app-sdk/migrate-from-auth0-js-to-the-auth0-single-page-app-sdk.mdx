...
この記事では、シングルサインアプリ（SPA）を[auth0.js](/docs/ja-JP/ja-jp/libraries/auth0js)から[auth0-spa-js](/docs/ja-JP/ja-jp/libraries/auth0-single-page-app-sdk)に移行する方法について説明します。以下は、auth0.jsとそれに相当するauth0-spa-jsコードを使ったシナリオです。
