...
* ロールは事前に定義された値から選択されます。ロールのリストが空白の場合は、[ロールを作成](/docs/ja-JP/ja-jp/manage-users/access-control/configure-core-rbac/roles/create-roles)する必要があります。
* Auth0 Dashboardで[APIをセットアップ](/docs/ja-JP/ja-jp/get-started/auth0-overview/set-up-apis)します。
