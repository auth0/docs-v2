...
* Dashboardで[APIをセットアップ](/docs/ja-JP/ja-jp/get-started/auth0-overview/set-up-apis)します。
* 権限は事前に定義された値から選択されます。権限のリストが空白の場合は、APIに[権限を追加](/docs/ja-JP/ja-jp/get-started/apis/add-api-permissions)してください。
...
* [ユーザーから権限を削除する](/docs/ja-JP/ja-jp/manage-users/access-control/configure-core-rbac/rbac-users/remove-permissions-from-users)
* [ユーザーの権限を表示する](/docs/ja-JP/ja-jp/manage-users/access-control/configure-core-rbac/rbac-users/view-user-permissions)