...
<table class="table">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>`delete:organization_member_roles`のスコープを持つ<a href="/docs/ja-JP/ja-jp/tokens/management-api-access-tokens">Management APIのアクセストークン</a>。</td>
    </tr>
