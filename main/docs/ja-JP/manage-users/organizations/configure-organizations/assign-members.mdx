...
[組織](/docs/ja-JP/ja-jp/manage-users/organizations/organizations-overview)にメンバーを割り当てるには、先にテナント内に[ユーザーを作成](/docs/ja-JP/ja-jp/manage-users/user-accounts/create-users)しておく必要があります。ユーザーが見つからない場合には、代わりに[ユーザーを招待](/docs/ja-JP/ja-jp/manage-users/organizations/configure-organizations/invite-members)することもできます。
...
<table class="table">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>`create:organization_members`のスコープを持つ<a href="/docs/ja-JP/ja-jp/tokens/management-api-access-tokens">Management APIのアクセストークン</a>。</td>
    </tr>
