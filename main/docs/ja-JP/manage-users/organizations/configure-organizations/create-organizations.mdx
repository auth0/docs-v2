...
<table class="table">
  ...
  <tbody>
    <tr>
      ...
      <td>`read:organizations`スコープのある<a href="/docs/ja-JP/ja-jp/tokens/management-api-access-tokens">Management APIのアクセストークン</a>です。</td>
    </tr>
