...
プログラムで[組織](/docs/ja-JP/ja-jp/manage-users/organizations/organizations-overview)を操作するには、組織に対して有効になっている接続のリストを取得する必要がある場合があります。
...
<table class="table">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>`read:organization_connections`のスコープを持つ<a href="/docs/ja-JP/ja-jp/tokens/management-api-access-tokens">Management APIのアクセストークン</a>。</td>
    </tr>
  </tbody>
</table>
