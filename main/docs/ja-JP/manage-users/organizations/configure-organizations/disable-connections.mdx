...
<table class="table">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>スコープ`delete:organization_connections`を持つ<a href="/docs/ja-JP/ja-jp/tokens/management-api-access-tokens">Management APIのアクセストークン</a>。</td>
    </tr>
