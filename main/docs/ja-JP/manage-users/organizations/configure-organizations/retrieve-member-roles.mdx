...
プログラムで[組織](/docs/ja-JP/ja-jp/manage-users/organizations/organizations-overview)を操作するには、組織のメンバーに割り当てられたロールのリストを取得する必要がある場合があります。
...
<table class="table">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>`read:organization_member_roles`のスコープを持つ<a href="/docs/ja-JP/ja-jp/tokens/management-api-access-tokens">Management APIのアクセストークン</a>。</td>
    </tr>
  </tbody>
</table>
