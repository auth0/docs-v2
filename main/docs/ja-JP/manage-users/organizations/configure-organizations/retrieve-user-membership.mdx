...
[組織](/docs/ja-JP/ja-jp/manage-users/organizations/organizations-overview)をプログラム的に操作する際、ユーザーがメンバーシップを割り当てられている組織のリストを取得する必要があります。
...
| `MGMT_API_ACCESS_TOKEN` | スコープ`read:organizations`を持つ[Management APIのアクセストークン](/docs/ja-JP/ja-jp/tokens/management-api-access-tokens)。|
