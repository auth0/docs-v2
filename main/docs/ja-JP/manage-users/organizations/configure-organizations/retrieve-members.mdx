...
プログラムで[組織](/docs/ja-JP/ja-jp/manage-users/organizations/organizations-overview)を操作するには、組織メンバーのリストを取得する必要がある場合があります。
...
<table class="table">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>スコープ`read:organization_members`を持つ<a href="/docs/ja-JP/ja-jp/tokens/management-api-access-tokens">Management API</a>のアクセストークン。</td>
    </tr>
  </tbody>
</table>
