...
それぞれの[組織](/docs/ja-JP/ja-jp/manage-users/organizations/organizations-overview)メンバーには1つ以上のロールを割り当てることができます。ロールはユーザーが組織を通してログインするときに適用されます。ロールとその振る舞いについては、「[ロールベースのアクセス制御](/docs/ja-JP/ja-jp/manage-users/access-control/rbac)」をお読みください。
...
組織メンバーにロールを有効にするには、テナントですでにその[ロールが作成](/docs/ja-JP/ja-jp/manage-users/access-control/configure-core-rbac/roles/create-roles)されていなければなりません。
...
<table class="table">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>`create:organization_member_roles`のスコープを持つ<a href="/docs/ja-JP/ja-jp/tokens/management-api-access-tokens">Management APIのアクセストークン</a>。</td>
    </tr>
