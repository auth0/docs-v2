...
description: "Authenticate users with an identifer and either a password or passkeys. Store credentials in Auth0's database user store or use your own external one."
