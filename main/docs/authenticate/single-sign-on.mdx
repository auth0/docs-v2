...
redirects:
  - "/docs/configure/sso"
  - "/docs/sso"
  - "/docs/sso/current/index_old"
  - "/docs/sso/current/setup"
  - "/docs/sso/current"
  - "/docs/sso/single-sign-on"
  - "/docs/sso/current/introduction"
  - "/docs/sso/current/sso-auth0"
  - "/docs/sso/current/single-page-apps"
  - "/docs/sso/current/single-page-apps-sso"
  - "/docs/sso/legacy/single-page-apps-sso"
  - "/docs/sso/legacy/regular-web-apps-sso"
  - "/docs/sso/legacy/single-page-apps"
  - "/docs/sso/legacy"
  - "/docs/api-auth/tutorials/adoption/single-sign-on"
---
