...
redirects:
  - "/docs/connections/passwordless/guides/email-magic-link"
  - "/docs/connections/passwordless/authentication-methods/email-magic-link"
  - "/docs/connections/passwordless/authentication-factors/email-magic-link"
  - "/docs/connections/passwordless/email-magic-link"
---
