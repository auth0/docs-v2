...
---
You can configure a <Tooltip tip="Passwordless: Form of authentication that does not rely on a password as the first factor." cta="View Glossary" href="/docs/glossary?term=Passwordless">Passwordless</Tooltip> connection to send a Magic Link to a user through email to complete [authentication](https://auth0.com/platform/authentication).
...
<Frame>![Classic Login Flow with Magic Links](/docs/images/cdy7uua7fh8z/yYsZhaG5uzmVg1MwVCRix/0b735f499987539856fa9a251e2b09d1/Magic_Link_Flow.png)</Frame>

1. The user enters their email address in your application's login screen.
2. Auth0 sends an email to the user containing the magic link.
3. The user opens their email and clicks the magic link.
4. Auth0 validates the link and notifies the application.
5. The application logs in the user.
