...
redirects:
  - "/docs/connections/passwordless/authentication-methods/use-sms-gateway-passwordless"
  - "/docs/connections/passwordless/use-sms-gateway-passwordless"
  - "/docs/connections/passwordless/guides/use-sms-gateway-passwordless"
  - "/docs/connections/passwordless/sms-gateway"
---
