...
redirects:
  - "/docs/connections/passwordless/authentication-methods/email-otp"
  - "/docs/connections/passwordless/authentication-factors/email-otp"
  - "/docs/connections/passwordless/email-otp"
  - "/docs/connections/passwordless/guides/email-otp"
  - "/docs/connections/passwordless/email"
---
...
<Frame>![Passwordless email workflow diagram with embedded login](/docs/images/cdy7uua7fh8z/3HMLxPTq9eCsq1eR21s0bL/ad401ee9fbe0716250d49ea04993a056/SMS_Email_Flow_Updated.png)</Frame>

### Universal Login

<Frame>![Passwordless email workflow diagram with universal login](/docs/images/cdy7uua7fh8z/5p3cKrJwmc7MxpQ7pbXsjC/285f3b54caba8a05075b6a0036990aaa/Screenshot_2024-10-29_at_11.54.03.png)</Frame>
