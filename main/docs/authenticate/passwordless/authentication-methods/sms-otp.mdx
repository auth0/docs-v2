...
redirects:
  - "/docs/connections/passwordless/authentication-methods/sms-otp"
  - "/docs/connections/passwordless/authentication-factors/sms-otp"
  - "/docs/connections/passwordless/sms-otp"
  - "/docs/connections/passwordless/guides/sms-otp"
  - "/docs/connections/passwordless/sms"
---
...
<Frame>![SMS workflow for passwordless authentication](/docs/images/cdy7uua7fh8z/7A1AOmvvAQXheVt9swOtqM/cd38a66a41e3be5f95d9fb0a473b9079/Embedded-login.png)</Frame>

### Universal Login

<Frame>![Passwordless sms workflow diagram with universal login](/docs/images/cdy7uua7fh8z/5EmFoTLgH2ByPcFYdsQvXA/fdaf1add4592c70cda7e12e6b1ae60dd/Unvirsal-login.png)</Frame>
