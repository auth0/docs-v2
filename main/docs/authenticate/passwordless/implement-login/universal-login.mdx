...
redirects:
  - "/docs/connections/passwordless/implement-login/universal-login"
  - "/docs/connections/passwordless/universal-login"
  - "/docs/connections/passwordless/regular-web-app"
  - "/docs/connections/passwordless/guides/universal-login"
  - "/docs/connections/passwordless/spa"
---
