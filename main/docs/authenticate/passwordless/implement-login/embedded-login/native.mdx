...
redirects:
  - "/docs/connections/passwordless/implement-login/embedded-login/native"
  - "/docs/connections/passwordless/embedded-login/native"
  - "/docs/connections/passwordless/guides/embedded-login-native"
  - "/docs/connections/passwordless/embedded-login-native"
---
...
* [Auth0.Android Passwordless](/docs/libraries/auth0-android/auth0-android-passwordless)
