...
redirects:
  - "/docs/configure/saml-configuration/saml-identity-provider-configuration-settings"
  - "/docs/protocols/saml-protocol/saml-identity-provider-configuration-settings"
  - "/docs/protocols/saml/samlp"
  - "/docs/samlp"
  - "/docs/protocols/saml-configuration-options/saml-identity-provider-configuration-settings"
---
