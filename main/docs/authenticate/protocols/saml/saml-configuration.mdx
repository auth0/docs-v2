...
redirects:
  - "/docs/configure/saml-configuration"
  - "/docs/config/saml-configuration"
  - "/docs/saml-configuration"
  - "/docs/protocols/saml/saml-configuration"
  - "/docs/protocols/saml/saml-configuration/design-considerations"
  - "/docs/protocols/saml/saml-configuration/supported-options-and-bindings"
  - "/docs/protocols/saml/saml-apps"
  - "/docs/config/saml-protocol"
  - "/docs/configure/saml-protocol"
  - "/docs/protocols/saml-protocol"
  - "/docs/protocols/saml"
  - "/docs/protocols/saml/samlp-providers"
  - "/docs/samlp-providers"
  - "/docs/protocols/saml/identity-providers"
  - "/docs/saml-apps"
---
