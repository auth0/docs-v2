---
description: Remove user access in your SAML integration by deprovisioning users through your identity provider or directly in Auth0.
title: Deprovision Users in SAML Integrations
redirects:
  - "/docs/configure/saml-configuration/deprovision-users-in-saml-integrations"
  - "/docs/protocols/saml-protocol/deprovision-users-in-saml-integrations"
  - "/docs/protocols/saml/saml-configuration/deprovision-users"
  - "/docs/protocols/saml-configuration-options/deprovision-users-in-saml-integrations"
---
