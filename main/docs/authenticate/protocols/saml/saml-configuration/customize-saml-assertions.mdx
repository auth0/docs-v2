...
redirects:
  - "/docs/configure/saml-configuration/customize-saml-assertions"
  - "/docs/protocols/saml-protocol/customize-saml-assertions"
  - "/docs/protocols/saml/saml-configuration/saml-assertions"
  - "/docs/protocols/saml-configuration-options/customize-saml-assertions"
---
