...
redirects:
  - "/docs/configure/saml-configuration/configure-auth0-as-service-and-identity-provider"
  - "/docs/protocols/saml-protocol/configure-auth0-as-service-and-identity-provider"
  - "/docs/protocols/saml/saml-configuration/auth0-as-identity-and-service-provider"
  - "/docs/protocols/saml-configuration-options/configure-auth0-as-service-and-identity-provider"
  - "/docs/samlsso-auth0-to-auth0"
  - "/docs/protocols/saml/samlsso-auth0-to-auth0"
  - "/docs/protocols/saml-configuration-options/test-saml-sso-with-auth0-as-service-and-identity-provider"
---
