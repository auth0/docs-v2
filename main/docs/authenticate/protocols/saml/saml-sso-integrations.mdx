...
redirects:
  - "/docs/configure/saml-configuration/saml-sso-integrations"
  - "/docs/protocols/saml-protocol/saml-sso-integrations"
  - "/docs/protocols/saml-protocol/special-saml-configuration-scenarios"
  - "/docs/protocols/saml-protocol/saml-configuration-options/special-saml-configuration-scenarios"
  - "/docs/protocols/saml/saml-configuration/special-configuration-scenarios"
  - "/docs/config/saml-configuration/special-saml-configuration-scenarios"
  - "/docs/config/saml-configuration/saml-sso-integrations"
  - "/docs/protocols/saml/saml-configuration-options"
  - "/docs/protocols/saml-configuration-options"
---
