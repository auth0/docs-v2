---
'og:description': Describes how to configure Auth0 to serve as a service provider
...
<td>The username or email of the user logging in. If you are using <a href="/docs/authenticate/login/auth0-universal-login/identifier-first">Identifier First Authentication</a>, Auth0 can send this value to the IdP to pre-populate it in the IdP's login form.</td>
</tr>
<tr>
<td><code>ProtocolBinding</code></td>
