...
redirects:
  - "/docs/configure/saml-configuration/configure-auth0-saml-service-provider"
  - "/docs/protocols/saml-protocol/configure-auth0-saml-service-provider"
  - "/docs/protocols/saml/saml-configuration/auth0-as-service-provider"
  - "/docs/saml-sp-generic"
  - "/docs/protocols/saml/saml-sp-generic"
  - "/docs/protocols/saml-configuration-options/configure-auth0-saml-service-provider"
---
