...
redirects:
  - "/docs/configure/saml-configuration/saml-sso-integrations/enable-saml2-web-app-addon"
  - "/docs/protocols/saml-protocol/saml-configuration-options/enable-saml2-web-app-addon"
  - "/docs/protocols/saml/saml2webapp-tutorial"
  - "/docs/saml2webapp-tutorial"
---
