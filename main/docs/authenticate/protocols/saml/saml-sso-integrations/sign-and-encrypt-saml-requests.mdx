...
Some service providers accept only one identity provider signing certificate at a time. You need to plan the signing key rotation to keep it as short as possible.
