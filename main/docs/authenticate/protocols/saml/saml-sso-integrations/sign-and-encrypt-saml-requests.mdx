...
redirects:
  - "/docs/configure/saml-configuration/saml-sso-integrations/sign-and-encrypt-saml-requests"
  - "/docs/protocols/saml-protocol/saml-sso-integrations/sign-and-encrypt-saml-requests"
  - "/docs/protocols/saml-protocol/saml-configuration-options/sign-and-encrypt-saml-requests"
  - "/docs/protocols/saml/saml-configuration/special-configuration-scenarios/signing-and-encrypting-saml-requests"
  - "/docs/protocols/saml-configuration-options/sign-and-encrypt-saml-requests"
---
