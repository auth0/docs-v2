...
* [`aes256-cbc`](http://www.w3.org/2001/04/xmlenc#aes256-cbc) (default): It does not provide integrity guarantees. When an Action does not use the object `api.samlResponse.setEncryptionAlgorithm` to set the encryption algorithm, Auth0 defaults to the `aes256-cbc` algorithm and logs a deprecation warning in your tenant logs.
* [`rsa-oaep`](http://www.w3.org/2001/04/xmlenc#rsa-oaep-mgf1p), including MGF1 and SHA1 used for key transport.

<Warning>
The default encryption algorithm will change to `aes256-gcm` on <TODO: some date>. Actions currently issue a deprecation warning when using <TODO: other algorithms?>, and <TODO: what behavior happens if using another algorithm after the default changes>.
...
2. Set the encryption in your Action code with `api.samlResponse.setEncryptionAlgorithm("aes256-gcm");`.
</Warning>
