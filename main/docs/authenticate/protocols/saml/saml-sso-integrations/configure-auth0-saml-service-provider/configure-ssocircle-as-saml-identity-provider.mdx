...
redirects:
  - "/docs/configure/saml-configuration/configure-auth0-saml-service-provider/configure-ssocircle-as-saml-identity-provider"
  - "/docs/protocols/saml-protocol/saml-sso-integrations/configure-ssocircle-as-saml-identity-provider"
  - "/docs/protocols/saml-protocol/saml-configuration-options/configure-ssocircle-as-saml-identity-provider"
  - "/docs/protocols/saml-configuration-options/configure-ssocircle-as-saml-identity-provider"
  - "/docs/protocols/saml/identity-providers/ssocircle"
  - "/docs/saml/identity-providers/ssocircle"
  - "/docs/ssocircle"
---
