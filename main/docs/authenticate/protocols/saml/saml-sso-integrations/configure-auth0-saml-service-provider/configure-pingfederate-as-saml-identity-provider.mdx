...
redirects:
  - "/docs/connections/enterprise/ping-federate"
  - "/docs/configure/saml-configuration/configure-auth0-saml-service-provider/configure-pingfederate-as-saml-identity-provider"
  - "/docs/protocols/saml-protocol/saml-sso-integrations/configure-pingfederate-as-saml-identity-provider"
  - "/docs/protocols/saml-protocol/saml-configuration/configure-pingfederate-as-saml-identity-provider"
  - "/docs/protocols/saml-protocol/saml-configuration-options/configure-pingfederate-as-saml-identity-provider"
  - "/docs/protocols/saml-configuration-options/configure-pingfederate-as-saml-identity-provider"
  - "/docs/protocols/saml/identity-providers/ping7"
  - "/docs/saml/identity-providers/ping7"
  - "/docs/ping7"
---
