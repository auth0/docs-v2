...
redirects:
  - "/docs/configure/saml-configuration/configure-auth0-saml-service-provider/configure-salesforce-as-saml-identity-provider"
  - "/docs/protocols/saml-protocol/saml-sso-integrations/configure-salesforce-as-saml-identity-provider"
  - "/docs/protocols/saml-protocol/saml-configuration-options/configure-salesforce-as-saml-identity-provider"
  - "/docs/protocols/saml-configuration-options/configure-salesforce-as-saml-identity-provider"
  - "/docs/protocols/saml/identity-providers/salesforce"
  - "/docs/saml/identity-providers/salesforce"
---
