...
redirects:
  - "/docs/configure/saml-configuration/configure-auth0-saml-service-provider/configure-siteminder-as-saml-identity-provider"
  - "/docs/protocols/saml-protocol/saml-sso-integrations/configure-siteminder-as-saml-identity-provider"
  - "/docs/protocols/saml-protocol/saml-configuration-options/configure-siteminder-as-saml-identity-provider"
  - "/docs/protocols/saml-configuration-options/configure-siteminder-as-saml-identity-provider"
  - "/docs/protocols/saml/identity-providers/siteminder"
  - "/docs/saml/identity-providers/siteminder"
  - "/docs/siteminder"
---
