...
redirects:
  - "/docs/configure/saml-configuration/configure-auth0-saml-service-provider/configure-okta-as-saml-identity-provider"
  - "/docs/protocols/saml-protocol/saml-sso-integrations/configure-okta-as-saml-identity-provider"
  - "/docs/protocols/saml-protocol/saml-configuration-options/configure-okta-as-saml-identity-provider"
  - "/docs/protocols/saml-configuration-options/configure-okta-as-saml-identity-provider"
  - "/docs/saml/identity-providers/okta"
  - "/docs/okta"
  - "/docs/protocols/saml/identity-providers/okta"
---
