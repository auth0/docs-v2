---
description: Create a custom SAML connection to Microsoft Active Directory Federation Services (ADFS) with Auth0 as the service provider, including claim mapping configuration.
title: Configure ADFS as SAML Identity Provider
redirects:
  - "/docs/configure/saml-configuration/configure-auth0-saml-service-provider/configure-adfs-saml-connections"
  - "/docs/protocols/saml-protocol/saml-sso-integrations/configure-adfs-saml-connections"
  - "/docs/protocols/saml-protocol/saml-configuration-options/configure-adfs-saml-connections"
  - "/docs/protocols/saml/adfs"
---
