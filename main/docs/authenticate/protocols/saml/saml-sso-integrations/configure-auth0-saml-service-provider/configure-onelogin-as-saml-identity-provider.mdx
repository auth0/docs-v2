...
redirects:
  - "/docs/configure/saml-configuration/configure-auth0-saml-service-provider/configure-onelogin-as-saml-identity-provider"
  - "/docs/protocols/saml-protocol/saml-sso-integrations/configure-onelogin-as-saml-identity-provider"
  - "/docs/protocols/saml-configuration-options/configure-onelogin-as-saml-identity-provider"
  - "/docs/protocols/saml/identity-providers/onelogin"
  - "/docs/saml/identity-providers/onelogin"
  - "/docs/onelogin"
---
