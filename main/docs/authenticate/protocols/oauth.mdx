---
description: Learn how Auth0 implements the OAuth 2.0 authorization framework, including supported grant types and key endpoints for securing your APIs and applications.
title: OAuth 2.0 Authorization Framework
redirects:
  - "/docs/authorization/protocols/protocol-oauth2"
  - "/docs/protocols/oauth2"
  - "/docs/protocols/protocol-oauth2"
---
<Card title="Overview">
