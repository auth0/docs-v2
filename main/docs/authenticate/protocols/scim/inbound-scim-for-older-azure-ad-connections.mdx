...
description: Set up Inbound SCIM on an existing Auth0 Azure AD connection that predates the current Azure connector so it can also provision and deprovision its users into Auth0.
redirects:
  - "/docs/authenticate/protocols/scim/configure-inbound-scim/inbound-scim-for-older-azure-ad-connections"
---
