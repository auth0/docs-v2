...
7. Go to **Mappings** and select **Provision Azure Active Directory Users,** then find **Provision Azure Active Directory Users** and deselect **Create** under **Target Object Actions.**
   ...
   <Frame>![Azure AD Mappings for Inbound SCIM ](https://images.ctfassets.net/cdy7uua7fh8z/3ndwqpnyZvhWYSn2nvM2Qj/19e568c435d90aa8a294140f482b2257/azureadmappings.jpg)</Frame>
...
11. On the **Edit Attribute** screen, change **Match objects using this attribute** to **Yes,** thenset **Matching precedence** to **2** and choose **OK.**
    ...
    <Frame>![Edit Attribute in Azure AD for Inbound SCIM ](https://images.ctfassets.net/cdy7uua7fh8z/7EbSKlTnXlpQdqw6R5blBJ/01999edb569825e07004e0c2eb11508b/editattribute.jpg)</Frame>
12. Choose **Save** to save the attribute mappings. The following view appears:

    <Frame>![Attribute Mapping on Azure for Inbound SCIM](https://images.ctfassets.net/cdy7uua7fh8z/2xCmuXkW7GGF8n3C84jOwI/3e70b7ab835d8dd73b36fdffbc3f5eb6/Attributemapping.jpg)</Frame>
