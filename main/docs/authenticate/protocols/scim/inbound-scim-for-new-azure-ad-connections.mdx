---
title: Inbound SCIM for Azure AD Connections
description: Set up Inbound SCIM on a new Auth0 Azure AD enterprise connection so Azure provisions and deprovisions its users into Auth0 over the OpenID Connect-authenticated channel.
redirects:
  - "/docs/authenticate/protocols/scim/configure-inbound-scim/inbound-scim-for-new-azure-ad-connections"
---
