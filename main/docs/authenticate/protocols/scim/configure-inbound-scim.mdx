...
description: "Configure Inbound SCIM on an Auth0 enterprise connection so an upstream identity provider can provision and deprovision users in Auth0 over the SCIM 2.0 protocol."
---
...
* [GET /api/v2/users](/docs/api/management/v2/users/get-users)
* [GET /api/v2/users/:id](/docs/api/management/v2/users/get-users-by-id)
* [GET /api/v2/users/:id/groups](/docs/api/management/v2/users/get-user-groups)
* [GET /api/v2/groups](/docs/api/management/v2/groups/get-groups)
* [GET /api/v2/groups/:id](/docs/api/management/v2/groups/get-group)
* [GET /api/v2/groups/:id/members](/docs/api/management/v2/groups/get-group-members)
* [DELETE /api/v2/users/:id](/docs/api/management/v2/users/delete-users-by-id)
* [DELETE /api/v2/groups/:id](/docs/api/management/v2/groups/delete-group)
