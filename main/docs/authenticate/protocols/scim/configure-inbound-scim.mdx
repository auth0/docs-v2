...
Note the tenant-level entity limits for Enterprise groups and core authorizaton roles in the [Entity Limit Policy](/docs/troubleshoot/customer-support/operational-policies/entity-limit-policy#entity-limit-policy).
...
Then organizational roles can be assigned to any groups synced from the Enterprise connections associated with the Organization. For more information, see [Add Roles to Groups](/docs/manage-users/organizations/configure-organizations/add-group-roles).

Note the organization-level entity limits for Enterprise groups and core authorizaton roles in the [Entity Limit Policy](/docs/troubleshoot/customer-support/operational-policies/entity-limit-policy#entity-limit-policy). 
