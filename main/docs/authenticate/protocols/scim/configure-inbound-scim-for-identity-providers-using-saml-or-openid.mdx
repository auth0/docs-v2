...
description: Set up Inbound SCIM for an Auth0 enterprise connection that authenticates with SAML or OpenID Connect so the same identity provider can also provision its users into Auth0.
redirects:
  - "/docs/authenticate/protocols/scim/configure-inbound-scim/configure-inbound-scim-for-other-identity-providers-using-openid-or-saml"
---
