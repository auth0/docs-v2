...
description: Set up Inbound SCIM on an Auth0 Okta Workforce connection that signs in with SAML so Okta provisions and deprovisions its users into Auth0.
redirects:
  - "/docs/authenticate/protocols/scim/configure-inbound-scim/inbound-scim-for-okta-workforce-saml-connections"
---
