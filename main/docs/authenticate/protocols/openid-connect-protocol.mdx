---
description: Learn how OpenID Connect (OIDC) builds on OAuth 2.0 to verify user identity and return profile information as a JSON Web Token (JWT).
title: OpenID Connect Protocol
redirects:
  - "/docs/authorization/protocols/openid-connect-protocol"
  - "/docs/api-auth/tutorials/adoption"
  - "/docs/api-auth/intro"
  - "/docs/protocols/oidc"
  - "/docs/protocols/openid-connect-protocol"
---
