...
redirects:
  - "/docs/login/logout/log-users-out-of-saml-idps"
  - "/docs/logout/guides/logout-saml-idps"
  - "/docs/protocols/saml/saml-configuration/logout"
  - "/docs/logout/log-users-out-of-saml-idps"
---
