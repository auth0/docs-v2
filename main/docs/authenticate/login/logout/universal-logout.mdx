...
<Frame>![User workflow using Universal Logout](https://images.ctfassets.net/cdy7uua7fh8z/4tcRn1VmydyBGORCHlKuvt/725b95df1cddae8ed3b2d36f0c3495bb/universal_logout_flow_diagram.png)</Frame>
...
3. Under the **General** tab, select **Logout > Edit**.
   ...
   <Frame>![Okta Dashboard image for Universal Logout configuration](https://images.ctfassets.net/cdy7uua7fh8z/M957prYUhjyMxXgpdA8pB/224812ce3a76ac9d032abe50c4be3a1d/2025-01-23_13-03-21.png)</Frame>
...
3. Select **More Actions > Clear User Sessions**.
   ...
   <Frame>![Test Universal Logout in Okta Dashboard](https://images.ctfassets.net/cdy7uua7fh8z/Z8an5lN6WAlSAdgiBkKLa/fde264f71615c5eb7e07e0c48d8426bf/2025-01-23_13-08-29.png)</Frame>
