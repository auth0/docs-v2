...
If you decide to use Embedded Login, you must [configure your application for Cross-Origin Resource Sharing](/docs/get-started/applications/set-up-cors) and should [configure a custom domain](/docs/customize/custom-domains). You can then implement the [Lock SDK](/docs/libraries/lock) or [Auth0.js SDK](/docs/libraries/auth0-single-page-app-sdk) within your application, or call the [Auth0 Authentication API](https://auth0.com/docs/api/authentication) directly.
...
* [Auth0.js v9 Reference](/docs/libraries/auth0-single-page-app-sdk)
