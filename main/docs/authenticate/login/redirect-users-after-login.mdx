...
redirects:
  - "/docs/login/redirect-users-after-login"
  - "/docs/users/redirect-users-after-login"
  - "/docs/users/concepts/redirect-users-after-login"
  - "/docs/protocols/oauth2/redirect-users"
  - "/docs/users/guides/redirect-users-after-login"
  - "/docs/users/redirecting-users"
  - "/docs/tutorials/redirecting-users"
---
