---
'og:description': Describes how to redirect users to URLs that have not been added
  to the AllowList.
'og:image': https://cdn2.auth0.com/docs-v2/1.14553.0/img/share-image.png
'og:title': Redirect Users
'og:url': https://auth0.com/docs/
permalink: redirect-users-after-login
title: Redirect Users
'twitter:description': Describes how to redirect users to URLs that have not been
