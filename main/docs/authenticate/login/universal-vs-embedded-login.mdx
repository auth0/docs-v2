...
redirects:
  - "/docs/troubleshoot/product-lifecycle/past-migrations/migrate-from-embedded-login-to-universal-login"
  - "/docs/troubleshoot/product-lifecycle/deprecations-and-migrations/migrate-from-embedded-login-to-universal-login"
  - "/docs/product-lifecycle/deprecations-and-migrations/migrate-from-embedded-login-to-universal-login"
  - "/docs/guides/login/*-vs-embedded*"
  - "/docs/guides/login/*"
  - "/docs/libraries/when-to-use-lock"
---
...
1. Your application triggers an authentication request by invoking an Auth0 SDK’s login method or by calling the [Auth0 Authentication API Login endpoint](/docs/api/authentication/login/) directly.
...
* **Embedded Login**: Allows full control over the UI and keeps users inside your application. You can use Embedded Login for [factor enrollment](/docs/authenticate/login/embedded-login), step-up authentication, passkey registration with [Passkey APIs](/docs/authenticate/database-connections/passkeys), [link connected accounts](/docs/manage-users/user-accounts/user-account-linking), or sign-in using [Native Social Login](/docs/authenticate/identity-providers/social-identity-providers).
