...
redirects:
  - "/docs/login/universal-login"
  - "/docs/universal-login"
  - "/docs/login_page"
  - "/docs/universal-login/customization-new"
  - "/docs/hosted-pages"
  - "/docs/hosted-pages/login"
  - "/docs/hosted-pages/hosted-login-auth0js/v8"
  - "/docs/hosted-pages/hosted-login-auth0js/v7"
  - "/docs/hosted-pages/login/lock-passwordless"
  - "/docs/hosted-pages/login/lock"
  - "/docs/hosted-pages/login/auth0js"
  - "/docs/hosted-pages/hosted-login-auth0js"
---
