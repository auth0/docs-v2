...
redirects:
  - "/docs/authenticate/passwordless/passwordless-with-new-universal-login"
  - "/docs/login/universal-login/passwordless-login"
  - "/docs/login/universal-login/passwordless-login/configure-universal-login-with-passwordless"
  - "/docs/universal-login/configure-universal-login-with-passwordless"
  - "/docs/dashboard/guides/connections/configure-passwordless-sms"
  - "/docs/dashboard/guides/universal-login/configure-login-page-passwordless"
---
