...
redirects:
  - "/docs/authenticate/login/auth0-universal-login/new-universal-login-vs-classic-universal-login"
  - "/docs/login/universal-login/new-universal-login-vs-classic-universal-login"
  - "/docs/universal-login/new-universal-login-vs-classic-universal-login"
---
