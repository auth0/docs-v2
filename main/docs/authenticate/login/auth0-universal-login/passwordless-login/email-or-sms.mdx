...
This method uses a custom login page with the **Custom Login Form** template, and authenticates users with the [Auth0.js SDK](/docs/libraries/auth0-single-page-app-sdk). To learn more, read [Passwordless Authentication with Universal Login](/docs/authenticate/passwordless/implement-login/universal-login).
