...
redirects:
  - "/docs/login/universal-login/passwordless-login/webauthn-device-biometrics"
  - "/docs/universal-login/configure-universal-login-with-passwordless/webauthn-device-biometrics"
---
