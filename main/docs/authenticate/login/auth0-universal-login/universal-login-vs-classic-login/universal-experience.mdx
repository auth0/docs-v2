...
redirects:
  - "/docs/authenticate/login/auth0-universal-login/new-experience"
  - "/docs/universal-login/new-experience-limitations"
  - "/docs/login/universal-login/new-experience"
  - "/docs/universal-login/new"
  - "/docs/universal-login/new-experience"
---
...
* [Use Google One Tap with Universal Login](/docs/authenticate/identity-providers/social-identity-providers/google-one-tap)
