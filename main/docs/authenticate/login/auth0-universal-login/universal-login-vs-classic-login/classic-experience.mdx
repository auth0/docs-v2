...
redirects:
  - "/docs/authenticate/login/auth0-universal-login/classic-experience"
  - "/docs/login/universal-login/classic-experience"
  - "/docs/universal-login/classic"
  - "/docs/universal-login/classic-experience"
---
