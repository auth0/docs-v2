...
redirects:
  - "/docs/login/universal-login/configure-default-login-routes"
  - "/docs/hosted-pages/default-login-url"
  - "/docs/universal-login/default-login-url"
  - "/docs/universal-login/configure-default-login-routes"
---
