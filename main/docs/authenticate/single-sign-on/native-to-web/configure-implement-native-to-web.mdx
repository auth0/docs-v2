...
A. Navigate to [Dashboard > Applications](https://manage.auth0.com/dashboard/#/applications): 

		1. Select or create your application.
		2. Select the **Settings** tab.
		3. Under **Session Transfer**, enable **Allow Native to web SSO**.
		4. Select **Require Cascade Revocation** to automatically revoke the web application's session and associated tokens. 

<Frame><img src="/docs/images/cdy7uua7fh8z/sessions/session-transfer-native-app.png" alt="Session Transfer Native application" /></Frame>

B. Select **Save** to update your application. 
...
* Update your web application using the <Tooltip tip="Auth0 Dashboard: Auth0's main product to configure your services." cta="View Glossary" href="/docs/glossary?term=Auth0+Dashboard">Auth0 Dashboard</Tooltip>:

A. Navigate to [Dashboard > Applications](https://manage.auth0.com/dashboard/#/applications):

		1. Select or create your web application.
		2. Select the **Settings** tab.
		3. Under **Session Transfer**, enable **Native to web SSO Methods**.
		4. Select **Cookie Authentication** and **Query Authentication**.
		5. Enable **Device Binding Method**, either **None**, **ASN Binding** or **IP Address Binding**.
		6. Enable **Allow Refresh Token Requests** to issue new refresh tokens after a session transfer.
		7. Select **Use online refresh tokens**

<Frame><img src="/docs/images/cdy7uua7fh8z/sessions/session-transfer-web-application.png" alt="Session Transfer Web application" /></Frame>

B. Select **Save** to update your web application. 
