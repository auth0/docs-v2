---
description: Apply Auth0 Native to Web SSO best practices for session lifetime and refresh token handling to keep the native app-to-browser handoff seamless.
