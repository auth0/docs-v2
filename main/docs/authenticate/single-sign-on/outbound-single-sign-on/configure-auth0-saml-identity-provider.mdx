...
redirects:
  - "/docs/authenticate/protocols/saml/saml-sso-integrations/configure-auth0-saml-identity-provider"
  - "/docs/configure/saml-configuration/configure-auth0-saml-identity-provider"
  - "/docs/protocols/saml-protocol/configure-auth0-as-saml-identity-provider"
  - "/docs/protocols/saml/saml-configuration/auth0-as-identity-provider"
  - "/docs/protocols/saml/saml-idp-generic"
  - "/docs/saml-idp-generic"
  - "/docs/protocols/saml-configuration-options/configure-auth0-as-saml-identity-provider"
---
