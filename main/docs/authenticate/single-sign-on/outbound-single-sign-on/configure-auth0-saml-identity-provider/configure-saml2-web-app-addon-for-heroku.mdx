...
redirects:
  - "/docs/authenticate/protocols/saml/saml-sso-integrations/configure-auth0-saml-identity-provider/configure-saml2-web-app-addon-for-heroku"
  - "/docs/configure/saml-configuration/configure-auth0-saml-identity-provider/configure-saml2-web-app-addon-for-heroku"
  - "/docs/protocols/saml-protocol/saml-sso-integrations/configure-saml2-web-app-addon-for-heroku"
  - "/docs/protocols/saml-protocol/saml-configuration-options/configure-saml2-web-app-addon-for-heroku"
  - "/docs/saml-apps/heroku-sso"
  - "/docs/protocols/saml/saml-apps/heroku"
---
