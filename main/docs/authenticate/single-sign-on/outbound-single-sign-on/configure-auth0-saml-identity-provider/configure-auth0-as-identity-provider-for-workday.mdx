...
redirects:
  - "/docs/authenticate/protocols/saml/saml-sso-integrations/configure-auth0-saml-identity-provider/configure-auth0-as-identity-provider-for-workday"
  - "/docs/configure/saml-configuration/configure-auth0-saml-identity-provider/configure-auth0-as-identity-provider-for-workday"
  - "/docs/protocols/saml-protocol/saml-sso-integrations/configure-auth0-as-identity-provider-for-workday"
  - "/docs/protocols/saml-protocol/saml-configuration-options/configure-auth0-as-identity-provider-for-workday"
  - "/docs/protocols/saml/saml-apps/workday"
---
