...
redirects:
  - "/docs/authenticate/protocols/saml/saml-sso-integrations/configure-auth0-saml-identity-provider/configure-auth0-as-identity-provider-for-workpath"
  - "/docs/configure/saml-configuration/configure-auth0-saml-identity-provider/configure-auth0-as-identity-provider-for-workpath"
  - "/docs/protocols/saml-protocol/saml-sso-integrations/configure-auth0-as-identity-provider-for-workpath"
  - "/docs/protocols/saml-protocol/saml-configuration-options/configure-auth0-as-identity-provider-for-workpath"
  - "/docs/protocols/saml/saml-apps/workpath"
---
