...
redirects:
  - "/docs/authenticate/protocols/saml/saml-sso-integrations/configure-auth0-saml-identity-provider/configure-auth0-as-identity-provider-for-freshdesk"
  - "/docs/configure/saml-configuration/configure-auth0-saml-identity-provider/configure-auth0-as-identity-provider-for-freshdesk"
  - "/docs/protocols/saml-protocol/saml-sso-integrations/configure-auth0-as-identity-provider-for-freshdesk"
  - "/docs/protocols/saml-protocol/saml-configuration-options/configure-auth0-as-identity-provider-for-freshdesk"
  - "/docs/protocols/saml-configuration-options/configure-auth0-as-identity-provider-for-freshdesk"
  - "/docs/protocols/saml/saml-apps/freshdesk"
  - "/docs/saml-apps/freshdesk"
---
