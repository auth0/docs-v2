...
redirects:
  - "/docs/authenticate/protocols/saml/saml-sso-integrations/configure-auth0-saml-identity-provider/configure-saml2-addon-eloqua"
  - "/docs/configure/saml-configuration/configure-auth0-saml-identity-provider/configure-saml2-addon-eloqua"
  - "/docs/protocols/saml-protocol/saml-sso-integrations/configure-saml2-addon-eloqua"
  - "/docs/protocols/saml-protocol/saml-configuration-options/configure-saml2-addon-eloqua"
  - "/docs/protocols/saml/saml-apps/eloqua"
  - "/docs/protocols/saml/saml-idp-eloqua"
---
