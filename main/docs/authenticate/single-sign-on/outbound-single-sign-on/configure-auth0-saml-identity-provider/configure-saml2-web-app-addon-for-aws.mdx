...
redirects:
  - "/docs/authenticate/protocols/saml/saml-sso-integrations/configure-auth0-saml-identity-provider/configure-saml2-web-app-addon-for-aws"
  - "/docs/configure/saml-configuration/configure-auth0-saml-identity-provider/configure-saml2-web-app-addon-for-aws"
  - "/docs/protocols/saml-protocol/saml-sso-integrations/configure-saml2-web-app-addon-for-aws"
  - "/docs/protocols/saml-protocol/saml-configuration-options/configure-saml2-web-app-addon-for-aws"
  - "/docs/dashboard/guides/applications/set-up-addon-saml2-aws"
  - "/docs/configure/saml-configuration-options/configure-saml2-web-app-addon-for-aws"
---
