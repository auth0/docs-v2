...
redirects:
  - "/docs/configure/sso/api-endpoints-for-single-sign-on"
  - "/docs/sso/api-endpoints-for-single-sign-on"
  - "/docs/sso/current/relevant-api-endpoints"
  - "/docs/single-sign-on/api-endpoints-for-single-sign-on"
  - "/docs/configure/sso/outbound-single-sign-on"
  - "/docs/sso/current/outbound"
  - "/docs/sso/outbound-single-sign-on"
---
