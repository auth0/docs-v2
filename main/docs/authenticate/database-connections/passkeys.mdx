...
1. Prompts the user to enter their email address.
   ...
   <Frame>![](https://images.ctfassets.net/cdy7uua7fh8z/5SlpzscSseNOuJlvhOgBqr/318d95254ef48197a32e58c92be00d2b/signup-passkey_default.png)</Frame>
2. User enters their email address.

   <Frame>![](https://images.ctfassets.net/cdy7uua7fh8z/3r5pFsWx6SkYOHSHglRwzG/337e3569359c3431c82e80adfeceb470/signup-passkey_filled.png)</Frame>
3. Prompts the user to create a passkey.

   <Frame>![](https://images.ctfassets.net/cdy7uua7fh8z/7vZK4q4iUtxyld1Os6og4s/c6df982f684824ef9f11a7ef9a477700/Passkeys_-_UL_-_English.png)</Frame>
4. If the user selects **Create a passkey**, it triggers the browser (or operating system) flow to create a passkey.

   <Frame>![](https://images.ctfassets.net/cdy7uua7fh8z/IsWmSXNHc2fvRuEgn5DpK/52b2464e21c8dc68bb06869126043ba9/Signup_-_Passkey_-_Browser_OS_Create_a_Passkey.png)</Frame>
   * If the user selects **Continue**, it prompts them to authenticate with their device’s credentials.

     <Frame>![](https://images.ctfassets.net/cdy7uua7fh8z/6OJlPQrWBhgO8izXXoKbOw/a3c1af9a94aaeffc50793e3e9b88db8f/Signup_-_Passkeys_-_Chrome_Prompt_for_Device_Credentials.png)</Frame>
   * If the user selects **Try another way**, it prompts them to create a passkey on another device.

     <Frame>![](https://images.ctfassets.net/cdy7uua7fh8z/2yXrkVbYLxxp6MXnrZLqVN/5f67ddf9b8003729a11604a3af3e553d/passkey-browser-cross-device.png)</Frame>
...
1. Prompts the user for an email address or a passkey.
   ...
   <Frame>![](https://images.ctfassets.net/cdy7uua7fh8z/3qqI3Uo1z1yQhvb7boQ0cx/820f38ffdec77388331ef238ff80de88/login-passkey_default.png)</Frame>
2. User can use autofill or select **Continue with a passkey**.

   <Frame>![](https://images.ctfassets.net/cdy7uua7fh8z/3zvWl2rpxzJ5klloIihRYB/a311cc3cc54075b7b92aca677ced29ba/login-passkey_filled.png)</Frame><Frame>![](https://images.ctfassets.net/cdy7uua7fh8z/tC4UZmYFgo7Zjt9kviP9j/690b87af58068c18a4609c8e9431e5b7/Login_-_Passkeys_-_Choose_a_passkey.png)</Frame>
