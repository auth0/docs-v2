...
* Each user must be assigned a unique username, email address, and phone number regardless of connection type. You should note, phone number is unique even if not added as an attribute.
