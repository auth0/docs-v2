---
'og:description': Provides a custom callback script for those integrating with IBM
  DB2.
'og:image': https://cdn2.auth0.com/docs-v2/1.14553.0/img/share-image.png
'og:title': Login Script for IBM DB2
...
'twitter:description': Provides a custom callback script for those integrating with
  IBM DB2.
'twitter:title': Login Script for IBM DB2
---
