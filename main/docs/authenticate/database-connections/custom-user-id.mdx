...
There are different ways to set a custom user ID depending on how you create the user. The following table summarizes available creation methods and how the `user_id` is set by precedence:
