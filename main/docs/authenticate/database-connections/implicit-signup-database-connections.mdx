...
Customize the confirmation screen to your brand and copy with [Advanced Customizations for Universal Login (ACUL)](/docs/customize/login-pages/advanced-customizations).
</Callout>
