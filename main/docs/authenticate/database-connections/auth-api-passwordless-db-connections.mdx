...
| User not found, signup not allowed | User is blocked, Auth0 returns a generic invalid-OTP error such as `invalid_request` or `Invalid or expired OTP code`, regardless of the code entered. |
