...
6. Your application calls the [`POST /oauth/token`](/docs/api/authentication/passwordless/authenticate-user) endpoint with the `auth_session` and the user-entered code.
