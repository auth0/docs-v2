---
description: Track passkey enrollment and authentication events in Auth0 tenant logs by filtering on passkey-specific event codes in Auth0 Dashboard or Management API.
