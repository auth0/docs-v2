...
3. In the **Android** section, enter your:
   - Package name
   - SHA-256 fingerprint (of your app's signing certificate). To learn more, read [Signing Algorithms](/docs/get-started/applications/signing-algorithms).
4. Select **Save Changes**.
...
## Add the `Passkey` grant on all platforms:
