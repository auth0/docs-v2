...
* Either disable [using your own database](/docs/authenticate/database-connections/custom-db/create-db-connection) or, alternatively, use your own database with [import mode enabled](/docs/manage-users/user-migration/user-migration-scenarios).
...
### <Badge color="yellow">Early Access</Badge> Use your own database with import mode enabled
