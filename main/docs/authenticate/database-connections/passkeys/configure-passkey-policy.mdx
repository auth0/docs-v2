...
5. _Optional_. Review Relying Party IDs (RPID) to ensure passkeys are bound to the correct origin: <br></br>
    ...
    B. If the Relying Party ID is inaccurate, navigate to re-verify your [custom domain](/docs/customize/custom-domains/configure-features-to-use-custom-domains) with your domain origin (e.g. `example.com`) without suffix, schemas, or ports.
