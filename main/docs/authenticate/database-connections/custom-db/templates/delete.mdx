...
The script is only used in a [legacy authentication scenario](/docs/authenticate/database-connections/custom-db), and is required if you want to delete a user from Auth0 and your external database in the same operation.
