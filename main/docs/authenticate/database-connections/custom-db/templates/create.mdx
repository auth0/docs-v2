...
<td>The user's username. Required only if the custom database connection has the <a href="/docs/authenticate/identity-providers/database/require-username"><strong>Requires Username</strong></a> setting enabled.</td>
</tr>
<tr>
