...
redirects:
  - "/docs/authenticate/database-connections/password-strength"
  - "/docs/connections/database/password-options"
  - "/docs/connections/database/password"
  - "/docs/connections/database/password-strength"
...
* [Create a connection endpoint](/docs/api/management/v2/connections/post-connections)
* [Update a connection endpoint](/docs/api/management/v2/connections/patch-connections-by-id).

You can view a database connection's current password policies in the `options` object returned from the [Get a connection endpoint](/docs/api/management/v2/connections/get-connections-by-id).
