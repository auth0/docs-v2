...
| Policy | Legacy Behavior | Flexble Password Policy Behavior |
|--------|-----------------|----------------------------------|
...
First, get your database connection's current configuration using the [Get a connection endpoint](https://auth0.com/docs/api/management/v2/connections/post-connections). You can view the full response schema in the API reference.
