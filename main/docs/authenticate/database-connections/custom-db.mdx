...
redirects:
  ...
  - "/docs/connections/database/custom-db/overview-custom-db-connections"
  - "/docs/connections/database/custom-db"
  - "/docs/connections/database/custom-db/custom-db-connection-overview"
  - "/docs/mysql-connection-tutorial"
