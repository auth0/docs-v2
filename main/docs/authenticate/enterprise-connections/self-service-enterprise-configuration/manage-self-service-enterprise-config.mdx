...
4. In the **Settings** section, configure additional options as needed for the new connection:
   ...
   * **Allow IT admin to configure third-party application access**: When enabled, the IT admin sees an option in the setup wizard to allow third-party applications to use the connection. If you want to set this value yourself rather than delegating it, use the **Enable as a domain level connection** toggle instead. These two options are mutually exclusive.
