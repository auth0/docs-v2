...
redirects:
  - "/docs/authenticate/single-sign-on/self-service-SSO"
...
2. You then create a self-service access ticket associated with that self-service profile. When generating the ticket, you can decide whether your customer admin creates a new connection or modifies an existing connection through the self-service assistant.
...
| Domain Verification set to `Off` | Customer admins do nothing. This step does not appear to customer admins, and the flow ends after Test SSO. |
...
<Frame>![The fifth step of the self-service assistant that customer admins use to configure SSO. ](/docs/images/enterprise-config-assign-access.png)</Frame>
</Accordion>
...
<Frame>![Create an application to provision users.](/docs/images/enterprise-config-add-scim-template.png)</Frame>
</Accordion>

<Accordion title="9. Provisioning - Configure SCIM">
<Frame>![Confgure SCIM to provision users to your application.](/docs/images/enterprise-config-configure-scim.png)</Frame>
</Accordion>

<Accordion title="10. Provisioning - SCIM mapping">
<Frame>![Map user attributes to guarantee attributes are passed from IdP to SP.](/docs/images/enterprise-config-scim-mapping.png)</Frame>
</Accordion>

<Accordion title="11. Configure Groups">
<Frame>![Provision Enterprise Groups](/docs/images/enterprise-config-configure-groups.png)</Frame>
</Accordion>

<Accordion title="12. Domain verification">
