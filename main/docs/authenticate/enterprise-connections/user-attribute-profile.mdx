...
redirects:
  - "/docs/authenticate/enterprise-connections/self-service-SSO/user-attribute-profile"
---
...
To manage User Attribute Profiles, the following [Management API](/docs/api/management/v2) endpoints are available:
