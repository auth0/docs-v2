...
description: Exchange existing security tokens for Auth0 access, ID, and refresh tokens using a custom Action and token exchange profile, as defined in RFC 8693.
---
