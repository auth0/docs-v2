...
redirects:
  - "/docs/connections/passwordless"
  - "/docs/connections/passwordless/ios-sms"
  - "/docs/connections/passwordless/ios-sms-objc"
  - "/docs/connections/passwordless/guides/"
  - "/docs/connections/passwordless/spa-sms"
  - "/docs/connections/passwordless/spa-email-link"
  - "/docs/connections/passwordless/spa-email-code"
  - "/docs/connections/passwordless/faq"
  - "/docs/connections/passwordless/reference/troubleshoot"
  - "/docs/connections/passwordless/native-passwordless-universal"
  - "/docs/connections/passwordless/ios"
  - "/docs/api-auth/passwordless"
  - "/docs/dashboard/guides/connections/set-up-connections-passwordless"
  - "/docs/passwordless"
---
