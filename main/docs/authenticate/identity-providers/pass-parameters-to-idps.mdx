---
description: Learn how to control login behavior with a social or enterprise identity provider by passing query parameters from your Auth0 application during the authorize request.
