...
redirects:
  - "/docs/connections/promote-connections-to-domain-level"
  - "/docs/get-started/dashboard/promote-connections-to-domain-level"
  - "/docs/api/management/guides/connections/promote-connection-domain-level"
---
