...
description: Browse Auth0's supported social identity providers and connect any of them to your tenant from the Auth0 Dashboard or via the Management API.
redirects:
  - "/docs/connections/social"
  - "/docs/connections/nativesocial/"
  - "/docs/miicard-clientid"
  - "/docs/connections/social/miicard"
  - "/docs/thecity-clientid"
  - "/docs/connections/social/thecity"
  - "/docs/aol-clientid"
  - "/docs/connections/social/aol"
  - "/docs/connections/social/identity-providers"
  - "/docs/connections/social/identityproviders"
