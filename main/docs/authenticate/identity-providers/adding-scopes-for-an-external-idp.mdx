---
description: Add additional OAuth scopes to an Auth0 connection for a configured social or enterprise identity provider to return profile fields and API permissions.
title: Add Scopes/Permissions to Call Identity Provider APIs
redirects:
  - "/docs/connections/adding-scopes-for-an-external-idp"
  - "/docs/what-to-do-once-the-user-is-logged-in/adding-scopes-for-an-external-idp"
  - "/docs/tutorials/adding-scopes-for-an-external-idp"
---
...
<Frame>![Permissions for Google](/docs/images/cdy7uua7fh8z/61ACa6hnMtO5aUjus0fCb7/31411373a18463f272107e1124445c60/dashboard-connections-social-create_google.png)</Frame>
