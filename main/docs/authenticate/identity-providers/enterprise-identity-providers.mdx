...
redirects:
  - "/docs/migrations/guides/liveid-api-deprecation"
  - "/docs/connections/enterprise"
  - "/docs/sharepoint-clientid"
  - "/docs/connections/enterprise/sharepoint-apps"
  - "/docs/connections/enterprise/identity-providers"
  - "/docs/connections/enterprise/identityproviders"
  - "/docs/connections/identity-providers-enterprise"
---
