...
<Frame>![Consent screen](/docs/images/cdy7uua7fh8z/5YcLIDCt3RaAkmK1cTeCJL/e85e16195e84aa52f7675faacd126853/consent-screen.png)</Frame>
...
5. `prompt=none` won't work on the [/authorize](https://auth0.com/docs/api/authentication/reference#social) endpoint. [Auth0.js](/docs/libraries/auth0-single-page-app-sdk)' checkSession() method uses `prompt=none` internally, so that won't work either.
