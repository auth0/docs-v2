...
<Callout icon="file-lines" color="#0EA5E9" iconType="regular">
If you use Universal Login, you can enable Google One Tap to give users a one-tap sign-in experience using their active Google session. To learn more, read [Google One Tap for Universal Login](/docs/authenticate/identity-providers/social-identity-providers/google-one-tap).
