...
redirects:
  - "/docs/connections/social/facebook-native"
  - "/docs/connections/nativesocial/facebook"
  - "/docs/connections/nativesocial/facebook-native"
---
...
4. At the bottom of the settings page, select **Show Advanced Settings** and then the **Device Settings** view. Under **Native Social Login**, enable the **Enable Sign In with Facebook** toggle.
   ...
   <Frame>![Native Social Login Settings](/docs/images/cdy7uua7fh8z/5p2RaaeAtZyJzcoCfkF4tW/7326854f031e9c0a70f6b19de9cf9030/Native_Social_Login_-_English.png)</Frame>
