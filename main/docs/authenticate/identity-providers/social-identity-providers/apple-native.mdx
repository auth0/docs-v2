...
redirects:
  - "/docs/connections/social/apple-native"
  - "/docs/connections/nativesocial/apple"
  - "/docs/connections/nativesocial/add-siwa-to-native-app"
  - "/docs/connections/apple-siwa/add-siwa-to-native-app"
---
