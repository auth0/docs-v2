...
redirects:
  - "/docs/connections/calling-an-external-idp-api"
  - "/docs/what-to-do-once-the-user-is-logged-in/calling-an-external-idp-api"
  - "/docs/tutorials/calling-an-external-idp-api"
---
