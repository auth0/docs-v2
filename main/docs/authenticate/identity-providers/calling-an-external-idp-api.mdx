---
description: Call a social or enterprise identity provider's API from your Auth0 application using the upstream access token Auth0 stored after the user log in.
