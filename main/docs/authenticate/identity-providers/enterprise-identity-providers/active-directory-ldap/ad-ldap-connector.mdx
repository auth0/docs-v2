---
description: Understand how the Auth0 AD/LDAP Connector bridges your on-premises Active Directory or LDAP server to Auth0 over an outbound connection.
sidebarTitle: Overview
title: AD/LDAP Connector
redirects:
  - "/docs/customize/extensions/ad-ldap-connector"
  - "/docs/extensions/ad-ldap-connector"
  - "/docs/ad-ldap-connector"
  - "/docs/connector/considerations-non-ad"
  - "/docs/connector/overview"
  - "/docs/connector"
---
