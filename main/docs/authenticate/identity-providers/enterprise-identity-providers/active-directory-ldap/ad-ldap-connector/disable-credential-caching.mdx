...
redirects:
  - "/docs/customize/extensions/ad-ldap-connector/disable-credential-caching"
  - "/docs/extensions/ad-ldap-connector/disable-credential-caching"
  - "/docs/dashboard/guides/connections/disable-cache-ad-ldap"
---
