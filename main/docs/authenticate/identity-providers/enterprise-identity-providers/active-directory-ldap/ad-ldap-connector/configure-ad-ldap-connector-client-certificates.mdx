---
description: Configure mutual TLS between the Auth0 AD/LDAP Connector and Auth0 by issuing a client certificate the Connector presents on every outbound connection.
title: Configure AD/LDAP Connector Authentication with Client Certificates
redirects:
  - "/docs/customize/extensions/ad-ldap-connector/configure-ad-ldap-connector-client-certificates"
  - "/docs/extensions/ad-ldap-connector/configure-ad-ldap-connector-client-certificates"
  - "/docs/ad-ldap-connector/configure-ad-ldap-connector-authentication-with-client-certificates"
  - "/docs/connector/client-certificates"
---
