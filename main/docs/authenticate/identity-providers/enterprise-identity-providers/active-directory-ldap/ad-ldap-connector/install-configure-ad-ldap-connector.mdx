...
1. Download the **Auth0 Active Directory/LDAP Connector** package to `/tmp`:
   ...
   ``` curl
   -Lo /tmp/adldap.tar.gz \
    https://github.com/auth0/ad-ldap-connector/archive/refs/tags/v6.5.0.tar.gz
   ```
   
   <Callout icon="file-lines" color="#0EA5E9" iconType="regular">
   We recommend you review the [latest release](https://github.com/auth0/ad-ldap-connector/releases).
   </Callout>
