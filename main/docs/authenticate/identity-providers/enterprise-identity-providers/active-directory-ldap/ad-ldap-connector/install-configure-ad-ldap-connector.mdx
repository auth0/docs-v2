...
1. Download the latest version of the **[Auth0 Active Directory/LDAP Connector](https://github.com/auth0/ad-ldap-connector/releases)** package to `/tmp`. To learn more, review the [AD/LDAP Connector repository](https://github.com/auth0/ad-ldap-connector).
