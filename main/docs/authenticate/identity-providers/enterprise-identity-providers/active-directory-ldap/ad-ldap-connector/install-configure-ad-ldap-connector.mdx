---
description: Install the Auth0 AD/LDAP Connector on a Windows or Linux host inside your network and connect it to your Active Directory or LDAP server and your Auth0 tenant.
title: Install and Configure AD/LDAP Connector
redirects:
  - "/docs/customize/extensions/ad-ldap-connector/install-configure-ad-ldap-connector"
  - "/docs/extensions/ad-ldap-connector/install-configure-ad-ldap-connector"
  - "/docs/adldap-auth"
  - "/docs/connector/install"
  - "/docs/connector/install-other-platforms"
  - "/docs/adldap-x"
---
