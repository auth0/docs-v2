...
redirects:
  - "/docs/customize/extensions/ad-ldap-connector/configure-ad-ldap-connector-with-kerberos"
  - "/docs/extensions/ad-ldap-connector/configure-ad-ldap-connector-with-kerberos"
  - "/docs/ad-ldap-connector/configure-ad-ldap-connector-authentication-with-kerberos"
  - "/docs/connector/kerberos"
---
