...
<td>Enable the connection for Authentication, Connected Accounts for Token Vault, or both. To learn more, read [User authentication vs Connected Accounts](/docs/secure/tokens/token-vault/connected-accounts-for-token-vault#user-authentication-vs-connected-accounts).</td>
</tr>
</tbody>
</table>
...
<td>When enabled, Auth0 allows user profile data to be synced using SCIM. For more information, read <a href="/docs/authenticate/protocols/scim/configure-inbound-scim">Configure Inbound SCIM</a>.</td>
</tr>
</tbody>
</table>
