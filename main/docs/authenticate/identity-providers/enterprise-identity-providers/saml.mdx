...
redirects:
  - "/docs/connections/enterprise/ws-fed"
  - "/docs/connections/enterprise/sharepoint-online"
  - "/docs/connections/enterprise/saml"
  - "/docs/connections/enterprise/samlp"
---
...
For SAML connections, Auth0 enforces a size limit of 4 MB on metadata discovery documents with the error `SAML metadata document exceeded the maximum allowed size of 4 MB` when this limit is exceeded.
