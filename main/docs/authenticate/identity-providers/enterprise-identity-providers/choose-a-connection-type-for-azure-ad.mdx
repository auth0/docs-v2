---
description: Compare the Microsoft Azure AD connection types available in Auth0, then pick the one that matches your tenant model and the user attributes.
