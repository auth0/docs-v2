...
redirects:
  - "/docs/connections/enterprise/enable-enterprise-connections"
  - "/docs/get-started/dashboard/enable-enterprise-connections"
  - "/docs/dashboard/guides/connections/enable-connections-enterprise"
---
