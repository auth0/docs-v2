---
'og:description': Describes how to enable enterprise connections for applications
...
3. Select the **Applications** view, and enable or disable the connection for the appropriate application(s).
   ...
   <Frame>![Dashboard - Connections - Enterprise - Applications](https://images.ctfassets.net/cdy7uua7fh8z/2Jwoyem76rmja1sveD88It/38fbae514304297bbbf72beeedb8892f/SSL_-_EN.png)</Frame>
