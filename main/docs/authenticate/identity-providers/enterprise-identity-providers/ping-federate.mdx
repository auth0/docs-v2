...
If your SAML assertions are encrypted, you must [set additional values](/docs/authenticate/protocols/saml/saml-sso-integrations/sign-and-encrypt-saml-requests) for your connection to tell Auth0 how to handle decryption.
