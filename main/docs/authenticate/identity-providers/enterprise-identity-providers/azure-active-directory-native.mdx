...
redirects:
  - "/docs/connections/enterprise/azure-active-directory-native"
  - "/docs/connections/azure-active-directory-native"
---
...
<Frame>![Overview Diagram of Azure AD Apps using Resource Owner flow](/docs/images/cdy7uua7fh8z/6Uy9Q35rn0d9rankvlJuBT/6a5fa5175db76fd1cab35b79f0a213ea/azure-ad-native-app.png)</Frame>
...
| **Email Verification** | Choose how Auth0 sets the `email_verified` field in the user profile. To learn more, see [Email Verification for Azure AD and ADFS](/docs/authenticate/identity-providers/enterprise-identity-providers/azuread-adfs-email-verification). |
