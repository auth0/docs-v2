...
redirects:
  - "/docs/connections/enterprise/test-enterprise-connections"
  - "/docs/get-started/dashboard/test-enterprise-connections"
  - "/docs/dashboard/guides/connections/test-connections-enterprise"
---
