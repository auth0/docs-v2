---
description: Describes how to configure an application with Express Configuration.
'og:image': https://cdn2.auth0.com/docs/1.14553.0/img/share-image.png
'og:title': Configure Your application for Express Configuration
'og:url': https://auth0.com/docs/
permalink: application-express-configuration
title: Configure Your application for Express Configuration
'twitter:description': Describes how to configure an application with Express Configuration.
'twitter:title': Configure Your application for Express Configuration
---
