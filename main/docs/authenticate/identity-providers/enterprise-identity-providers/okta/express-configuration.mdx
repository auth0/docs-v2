...
When your application publishes in the OIN, you can update your product documentation to indicate you support Express Configuration with Okta. Your product documentation should indicate user roles or user types have permission to perform Express Configuration.

If your application already utilizes Auth0 Organizations with Organization administrator roles as exemplified in the SaaStart reference application, you can add the Express Configuration permissions to that role.
...
**Assign the Organization role with Express Configuration permissions**
 Retrieve the role ID with Express Configuration permissions as configured in [Assign express configuration permissions to users]().
