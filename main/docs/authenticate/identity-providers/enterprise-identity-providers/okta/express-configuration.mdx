...
## Assign Express Configuration permissions to users
...
For Auth0, any application user may be granted this permission, as long as the user is a member of an Auth0 organization where the `express-configured` connections is created, including:
...
*   A user in a social or pre-existing enterprise connection who is a member of one or more Organizations
