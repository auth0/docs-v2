...
For tips on provisioning administator accounts to use Express Configuration, read [Customer Enablement](/https://auth0.com/docs/authenticate/identity-providers/enterprise-identity-providers/okta/express-configuration#customer-enablement).
...
Whether you are using existing user accounts or deploying new ones to enable Express Configuration, use the following recommendations.
