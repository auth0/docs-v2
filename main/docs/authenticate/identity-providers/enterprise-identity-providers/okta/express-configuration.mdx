...
1. Under **OIDC Properties**, set the following fields:
    ...
    * **Initiate Login URI** should be automatically set to the value you configured for your application in Auth0, as described in Auth0 application and initiate login URI. Okta will use this URL to launch your application from the end-user dashboard. Note that the variable names have been modified to correspond to the integration variables shown on this screen.
