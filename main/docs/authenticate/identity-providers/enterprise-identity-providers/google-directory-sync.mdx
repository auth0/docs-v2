...
Update [user profiles](/docs/manage-users/user-accounts/user-profiles) in Auth0 with [Google's Directory Sync](https://knowledge.workspace.google.com/business-continuity/directory-sync/get-started-with-directory-sync).
...
* [Create an Enterprise connection for Google Workspace](/docs/authenticate/identity-providers/enterprise-identity-providers/google-apps).
...
1. [Create or update a Google Workspace enterprise connection.](/docs/authenticate/identity-providers/enterprise-identity-providers/google-directory-sync#enable-directory-sync)
2. [Enable Directory Sync for the connection in Auth0 Dashboard or Management API.](/docs/authenticate/identity-providers/enterprise-identity-providers/google-directory-sync#)
3. [Enable automated sync, or run a manual one-time sync on-demand.](/docs/authenticate/identity-providers/enterprise-identity-providers/google-directory-sync#)
...
```bash
https://{{GWSYNC_ENDPOINT_URL}}/api/v2/connections/{{CONNECTION-ID}} /directory-provisioning
```
...
To read the configuration settings, calll [Get a directory provisioning configuration](/docs/api/management/v2/connections/get-directory-provisioning)

```bash
GET https://{{GWSYNC-ENDPOINT-URL}}/api/v2/connections/{{CONNECTION-ID}} /directory-provisioning
```
...
```bash
PATCH https://{{GWSYNC-ENDPOINT-URL}}/api/v2/connections/{{CONNECTION-ID}} /directory-provisioning
```
...
```bash
POST https://{{GWSYNC-ENDPOINT-URL}}/api/v2/connections/{{CONNECTION-ID}} /directory-provisioning/synchronizations
```
...
```bash
DELETE https:// {{GWSYNC-ENDPOINT-URL}} /api/v2/connections/ {{CONNECTION-ID}} /directory-provisioning
```
</Tab></Tabs>
...
* A manual sync triggered within 30 minutes of the previous completed job will return a `400 Bad Request`.
