...
description: Update user profiles, group structures, and group memberships in Auth0 from Google Workspace automatically using Directory Sync.
...
3. Check the boxes next to the groups you want to sync, then select **Save Changes** at the bottom of the window.
</Tab>
...
Create the file in the following format, substituting the actual group IDs for the placeholder example values:
