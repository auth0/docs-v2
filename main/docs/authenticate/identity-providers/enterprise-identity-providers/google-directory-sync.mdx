...
If we detect that a synchornized group ID is deleted in Google Workspace Directory, we automatically remove that group ID from the configuration for subsequent job syncs.
</Step>
</Steps>
</Tab>
