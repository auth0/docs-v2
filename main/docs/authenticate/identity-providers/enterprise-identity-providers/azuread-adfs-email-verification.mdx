...
'og:title': Email Verification for Azure AD and ADFS
'og:url': https://auth0.com/docs/
permalink: azuread-adfs-email-verification
title: Email Verification for Azure AD and ADFS
'twitter:description': Describes how to control how the `email_verified` field is
  set for Azure AD and ADFS.
'twitter:title': Email Verification for Azure AD and ADFS
---
...
<Frame>![Dashboard - Advanced Tenant Settings - Migrations](https://images.ctfassets.net/cdy7uua7fh8z/4K1rQIv6p96KPCYOrhjXz4/be0f7b104d743fd0d3d42d18df97e144/dashboard-tenant-edit_view-advanced_migrations_azure-adfs.png)</Frame>
...
<Frame>![Auth0 - Email Verification Prompt - One-Time Code](https://images.ctfassets.net/cdy7uua7fh8z/i92GJgntVuU5QK37adugH/b767d4db92de5bafd23113042eca2600/Verify_Email_-_English.png)</Frame>
