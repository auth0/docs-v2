---
description: Test an Auth0 connection from the Dashboard to verify successful authentication against a configured identity provider and return of a valid user profile.
title: Test Connections
redirects:
  - "/docs/dashboard/guides/connections/test-connections-social"
  - "/docs/authenticate/identity-providers/how-to-test-partner-connection"
  - "/docs/connections/how-to-test-partner-connection"
  - "/docs/test-partner-connection"
  - "/docs/tutorials/how-to-test-partner-connection"
---
