---
title: Auth0 SDK Libraries and SDKs
sidebarTitle: Overview
description: Auth0 SDK libraries let developers integrate and interact with Auth0. Explore any library on GitHub, download a sample application, or use a quickstart for customized help.
---
...
Extend the capabilities of <a href="auth0.com/docs/authenticate/login/auth0-universal-login/universal-login-vs-classic-login/universal-experience#universal-login-experience">Universal Login</a> to support multi-branding, complex security configurations, and integration of numerous analytic platforms.
