...
## Check Actions Real-time Logs error console

You can put `console.log()` statements into Rules, Hooks, and custom database scripts. The output from those statements is viewable in Actions Real-time Logs. If you use Actions Real-time Logs, you can initiate a view of this log console by navigating to **Auth0 Dashboard > Monitoring > Actions Logs**.
