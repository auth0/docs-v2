...
redirects:
  - "/docs/product-lifecycle/past-migrations"
  - "/docs/product-lifecycle/deprecations-and-migrations/past-migrations"
  - "/docs/migrations/past-migrations"
  - "/docs/api/v1"
  - "/docs/api/management/v1/use-cases"
  - "/docs/migrations/guides/management-api-v1-v2"
  - "/docs/api/management-api-changes-v1-to-v2"
  - "/docs/api/management-api-v1-deprecated"
  - "/docs/product-lifecycle/deprecations-and-migrations/migrate-to-management-api-v2"
  - "/docs/api/v2/changes"
  - "/docs/apiv2Changes"
  - "/docs/api/management/v2/changes"
  - "/docs/api/management/v1/reference"
  - "/docs/api/v1/reference"
  - "/docs/api-reference"
  - "/docs/api/management/v1"
---
