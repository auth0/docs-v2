...
redirects:
  - "/docs/product-lifecycle/past-migrations/google-firebase-migration"
  - "/docs/product-lifecycle/deprecations-and-migrations/google-firebase-migration"
  - "/docs/migrations/guides/google_cloud_messaging"
---
