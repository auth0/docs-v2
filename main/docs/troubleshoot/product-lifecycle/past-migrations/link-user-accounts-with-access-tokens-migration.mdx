...
redirects:
  - "/docs/product-lifecycle/past-migrations/link-user-accounts-with-access-tokens-migration"
  - "/docs/product-lifecycle/deprecations-and-migrations/link-user-accounts-with-access-tokens-migration"
  - "/docs/users/guides/link-user-accounts-auth-api"
  - "/docs/migrations/guides/account-linking"
---
