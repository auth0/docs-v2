...
redirects:
  - "/docs/product-lifecycle/past-migrations/migration-oauthro-oauthtoken"
  - "/docs/product-lifecycle/deprecations-and-migrations/migration-oauthro-oauthtoken"
  - "/docs/migrations/guides/migration-oauthro-oauthtoken"
---
