...
redirects:
  - "/docs/product-lifecycle/past-migrations/migrate-to-tenant-log-search-v3"
  - "/docs/product-lifecycle/deprecations-and-migrations/migrate-to-tenant-log-search-v3"
  - "/docs/logs/guides/migrate-logs-v2-v3"
---
