...
redirects:
  - "/docs/troubleshoot/product-lifecycle/deprecations-and-migrations/migrate-v2-v3"
  - "/docs/product-lifecycle/deprecations-and-migrations/migrate-v2-v3"
  - "/docs/users/user-search/migrate-search-v2-v3"
  - "/docs/users/search/v3/migrate-search-v2-v3"
  - "/docs/users/user-search/migrate-v2-v3"
---
