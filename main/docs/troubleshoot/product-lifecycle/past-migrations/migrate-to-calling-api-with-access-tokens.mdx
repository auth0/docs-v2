...
redirects:
  - "/docs/product-lifecycle/past-migrations/migrate-to-calling-api-with-access-tokens"
  - "/docs/product-lifecycle/deprecations-and-migrations/migrate-to-calling-api-with-access-tokens"
  - "/docs/migrations/guides/calling-api-with-idtokens"
---
