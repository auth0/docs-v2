...
redirects:
  - "/docs/product-lifecycle/past-migrations/resource-owner-passwordless-credentials-exchange"
  - "/docs/product-lifecycle/deprecations-and-migrations/resource-owner-passwordless-credentials-exchange"
  - "/docs/migrations/guides/migration-oauthro-oauthtoken-pwdless"
---
