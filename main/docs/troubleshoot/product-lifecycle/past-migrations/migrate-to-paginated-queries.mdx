...
redirects:
  - "/docs/troubleshoot/product-lifecycle/deprecations-and-migrations/migrate-to-paginated-queries"
  - "/docs/product-lifecycle/deprecations-and-migrations/migrate-to-paginated-queries"
  - "/docs/migrations/guides/unpaginated-requests"
---
