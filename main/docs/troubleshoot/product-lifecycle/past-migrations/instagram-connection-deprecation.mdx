...
redirects:
  - "/docs/connections/social/instagram"
  - "/docs/product-lifecycle/past-migrations/instagram-connection-deprecation"
  - "/docs/product-lifecycle/deprecations-and-migrations/instagram-connection-deprecation"
  - "/docs/instagram-clientid"
  - "/docs/migrations/guides/instagram-deprecation"
---
