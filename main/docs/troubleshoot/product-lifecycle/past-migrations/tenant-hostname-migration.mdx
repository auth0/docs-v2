...
redirects:
  - "/docs/troubleshoot/product-lifecycle/deprecations-and-migrations/tenant-hostname-migration"
  - "/docs/product-lifecycle/deprecations-and-migrations/tenant-hostname-migration"
---
