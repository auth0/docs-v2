...
redirects:
  - "/docs/product-lifecycle/past-migrations/facebook-graph-api-changes"
  - "/docs/product-lifecycle/deprecations-and-migrations/facebook-graph-api-changes"
  - "/docs/migrations/guides/facebook-graph-api-deprecation"
---
