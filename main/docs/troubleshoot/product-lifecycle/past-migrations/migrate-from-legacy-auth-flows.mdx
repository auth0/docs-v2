...
redirects:
  - "/docs/product-lifecycle/past-migrations/migrate-from-legacy-auth-flows"
  - "/docs/product-lifecycle/deprecations-and-migrations/migrate-from-legacy-auth-flows"
  - "/docs/guides/migration-legacy-flows"
---
