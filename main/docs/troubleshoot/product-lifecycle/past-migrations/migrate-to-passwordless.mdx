...
redirects:
  - "/docs/product-lifecycle/past-migrations/migrate-to-passwordless"
  - "/docs/product-lifecycle/deprecations-and-migrations/migrate-to-passwordless"
  - "/docs/migrations/guides/passwordless-start"
---
