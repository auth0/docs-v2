...
redirects:
  - "/docs/product-lifecycle/past-migrations/yahoo-api-changes"
  - "/docs/product-lifecycle/deprecations-and-migrations/yahoo-api-changes"
  - "/docs/migrations/guides/yahoo-userinfo-updates"
---
