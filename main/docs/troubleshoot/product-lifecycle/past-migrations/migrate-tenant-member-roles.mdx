...
redirects:
  - "/docs/troubleshoot/product-lifecycle/deprecations-and-migrations/migrate-tenant-member-roles"
  - "/docs/product-lifecycle/deprecations-and-migrations/migrate-tenant-member-roles"
  - "/docs/product-lifecycle/deprecations-and-migrations/migrate-to-manage-dashboard-new-roles"
  - "/docs/deprecations-and-migrations/migrate-tenant-member-roles"
---
