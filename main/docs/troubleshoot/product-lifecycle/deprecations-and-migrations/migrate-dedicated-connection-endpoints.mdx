...
<Warning>
Private cloud tenant administrators can follow these instructions if their Auth0 private cloud deployment is version `v202608` or later. To learn more about the private cloud deployments, read [How to Check the Auth0 Private Cloud's Release Number and Deployment Date](https://support.auth0.com/center/s/article/How-to-check-the-Auth0-private-cloud-s-release-number-and-deployment-date).
</Warning>
...
Private cloud tenants received these notifications when their Auth0 private cloud deployment version reached `v202608`.
</Warning>
