...
validatedOn: "2026-04-20T00:00:00.000Z"
---
...
To determine which applications and integrations use the deprecated endpoints, review the tenant [logs](/docs/deploy-monitor/logs#logs) for deprecation notices.
