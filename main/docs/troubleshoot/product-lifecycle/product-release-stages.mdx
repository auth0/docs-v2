...
redirects:
  - "/docs/product-lifecycle/product-release-stages"
---
...
Developer Preview releases allow you to explore and implement new product capabilities for free before official pricing is applied at General Availability for continued use. These releases are made available for you to selectively opt-in to and use in both production and non-production environments, unless otherwise stated.  Developer Previews may be restricted to a select number of subscribers or rolled out to a subset of tenants.
