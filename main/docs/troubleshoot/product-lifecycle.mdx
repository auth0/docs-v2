...
| Read... | To learn... |
| --- | --- |
| [Product Release Stages](/docs/troubleshoot/product-lifecycle/product-release-stages) | How Auth0 stages, releases, and retires product functionality. |
| [Migration Process](/docs/troubleshoot/product-lifecycle/migration-process) | How Auth0's deprecation and migration process works. |
| [Deprecations and Migrations](/docs/troubleshoot/product-lifecycle/deprecations-and-migrations) | About current deprecations and how to migrate to new behaviors or features. |
| [Past Migrations](/docs/troubleshoot/product-lifecycle/past-migrations) | Past migrations previously enabled for customers. |
