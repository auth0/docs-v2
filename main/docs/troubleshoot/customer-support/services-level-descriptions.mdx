...
description: A summary of key elements of Auth0's Service Level Agreement (SLA) for both Enterprise Public Cloud and Enterprise Private Cloud deployments.
redirects:
  - "/docs/support/services-level-descriptions"
  - "/docs/support/sld"
  - "/docs/support/sla"
  - "/docs/sla"
---
...
If you require a [Private instance](/docs/deploy-monitor/deploy-private-cloud) of Auth0, contact [Auth0 Sales](https://auth0.com/get-started?place=documentation%20post&type=link&text=contact%20auth0%20sales) for additional information.
