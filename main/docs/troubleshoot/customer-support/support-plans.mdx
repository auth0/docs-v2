...
redirects:
  - "/docs/troubleshoot/customer-support/auth0-enterprise-and-premier-support"
  - "/docs/troubleshoot/customer-support/self-service-support"
  - "/docs/troubleshoot/customer-support/support-hours-and-languages"
  - "/docs/support/support-hours-and-languages"
  - "/docs/troubleshoot/customer-support/support-procedures"
  - "/docs/support/support-procedures"
  - "/docs/support/support-plans"
  - "/docs/support/support-overview"
---
