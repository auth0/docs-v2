...
redirects:
  - "/docs/support/open-and-manage-support-tickets"
...
Only paying and trial customers have access to open support tickets. For all other customers, select **Ask our Community** to use our [Community](https://community.auth0.com/) resources.
</Callout>
