...
title: Export Data
redirects:
  - "/docs/support/manage-subscriptions/export-data"
  - "/docs/support/export-data"
  - "/docs/moving-out"
  - "/docs/support/removing-auth0-exporting-data"
  - "/docs/tutorials/removing-auth0-exporting-data"
---
