...
redirects:
  - "/docs/support/manage-subscriptions/delete-or-reset-tenant"
  - "/docs/tutorials/delete-reset-tenant"
  - "/docs/support/delete-reset-tenant"
  - "/docs/support/delete-or-reset-tenant"
---
