...
If you have been subscribed to an Enterprise plan, after the term of the Subscription Period, you will be downgraded to the Free Plan. In case of any questions please contact your Technical Account Manager (TAM) and then [open a ticket with Auth0 Support](/docs/troubleshoot/customer-support/open-and-manage-support-tickets).
