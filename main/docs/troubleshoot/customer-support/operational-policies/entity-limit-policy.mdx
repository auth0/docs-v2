...
redirects:
  - "/docs/support/policies/entity-limit-policy"
  - "/docs/policies/global-limit"
  - "/docs/policies/entity-limits"
  - "/docs/policies/entity-limit-policy"
  - "/docs/authorization/rbac/authorization-core-rbac-limits"
  - "/docs/authorization/reference/rbac-limits"
---
