---
description: Rate limits for the Essentials and Professional pricing plans.
title: Essentials and Professional
---
See below for the rate limit policies for the Essentials and Professional pricing plans.

<AccordionGroup>

<Accordion title="Authentication API: Rate Limits for the Authentication API and API Endpoints in the Essentials and Professional pricing plans.">
...
| [Universal Logout](/docs/api/authentication/logout/global-token-revocation) | `POST` | 35 | 35/second | Any request |
...
| [Cross App Access (ID-JAG exchange)](/docs/ai-agents-mcp/cross-app-access) | `POST` | 25 | 25/second | Any Request |
...
<Accordion title="Management API: Rate Limits for the Management API, API Endpoints, and API Endpoint Groups in the Essentials and Professional pricing plans.">
...
| [Write Token Exchange Profiles](/docs/authenticate/custom-token-exchange/configure-custom-token-exchange#create-the-custom-token-exchange-profile) | `POST`, `PATCH`, `DELETE` | 5 | 100/minute | Any request |
...
| Resource | Burst Limit | Sustained Limit | Refresh Rate | Scope |
| --- | --- | --- | --- | --- |
| SCIM API Rate Limit – Tenant Scope (applies across all SCIM endpoints) | 100 | 100 | second | Tenant |
...
| Resource | Burst Limit | Sustained Limit | Refresh Rate | Scope |
| --- | --- | --- | --- | --- |
| My Account API Rate Limit – Authentication Methods Read (Tenant Scope) — Essentials and Professional | 5 | 5 | second | Tenant |
| My Account API Rate Limit – Authentication Methods Read Filtered (Tenant Scope) — Essentials and Professional | 20 | 20 | second | Tenant |
| My Account API Rate Limit – Authentication Methods Write (Tenant Scope) — Essentials and Professional | 5 | 5 | second | Tenant |
| My Account API Rate Limit – Connected Accounts Create Flow (Tenant Scope) — Essentials and Professional | 5 | 5 | second | Tenant |
| My Account API Rate Limit – Connected Accounts Read Accounts (Tenant Scope) — Essentials and Professional | 5 | 5 | second | Tenant |
| My Account API Rate Limit – Connected Accounts Read Connections (Tenant Scope) — Essentials and Professional | 5 | 5 | second | Tenant |
| My Account API Rate Limit – Connected Accounts Write (Tenant Scope) — Essentials and Professional | 1 | 1 | second | Tenant |
| My Account API Rate Limit – Factors Read (Tenant Scope) — Essentials and Professional | 25 | 25 | second | Tenant |
| My Account API Rate Limit – Organizations Read (Tenant Scope) — Essentials and Professional | 5 | 5 | second | Tenant |

Tenant, User level:

| Resource | Burst Limit | Sustained Limit | Refresh Rate | Scope |
| --- | --- | --- | --- | --- |
| My Account API Rate Limit – Authentication Methods Read (User Scope) — Essentials and Professional | 5 | 5 | minute | Tenant, User |
| My Account API Rate Limit – Authentication Methods Read Filtered (User Scope) — Essentials and Professional | 10 | 10 | minute | Tenant, User |
| My Account API Rate Limit – Authentication Methods Write (User Scope) — Essentials and Professional | 5 | 5 | minute | Tenant, User |
| My Account API Rate Limit – Connected Accounts Create Flow (User Scope) — Essentials and Professional | 10 | 10 | minute | Tenant, User |
| My Account API Rate Limit – Connected Accounts Read Accounts (User Scope) — Essentials and Professional | 5 | 5 | minute | Tenant, User |
| My Account API Rate Limit – Connected Accounts Read Connections (User Scope) — Essentials and Professional | 5 | 5 | minute | Tenant, User |
| My Account API Rate Limit – Connected Accounts Write (User Scope) — Essentials and Professional | 5 | 5 | minute | Tenant, User |
| My Account API Rate Limit – Factors Read (User Scope) — Essentials and Professional | 5 | 5 | minute | Tenant, User |
| My Account API Rate Limit – Organizations Read (User Scope) — Essentials and Professional | 1 | 1 | minute | Tenant, User |

</Accordion>

<Accordion title="My Organization API: Rate limits for the My Organization API in the Essentials and Professional subscription type.">
...
| Resource | Burst Limit | Sustained Limit | Refresh Rate | Scope |
| --- | --- | --- | --- | --- |
| My Org API Rate Limit – Read Endpoints (Tenant Scope) | 8 | 8 | second | Tenant |
| My Org API  Rate Limit – Write Endpoints (Tenant Scope) | 8 | 4 | second | Tenant |
