...
| Token Vault ([Connected Accounts](/ai/docs/call-apis-on-users-behalf/token-vault) and [token exchange](/ai/docs/call-apis-on-users-behalf/token-vault#supported-token-exchanges) | `POST` | 50 | 50/second | Any request |
| [On-Behalf-Of Token Exchange](/ai/docs/call-apis-on-users-behalf/on-behalf-of-token-exchange) | `POST` | 30 | 30/second | Any Request |
