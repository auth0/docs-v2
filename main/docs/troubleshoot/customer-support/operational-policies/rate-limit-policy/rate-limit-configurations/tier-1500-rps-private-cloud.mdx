...
| Token Vault ([Connected Accounts](/ai/docs/call-apis-on-users-behalf/token-vault) and [token exchange](/ai/docs/call-apis-on-users-behalf/token-vault#supported-token-exchanges) | `POST` | 700 | 700/second | Any request |
| [On-Behalf-Of Token Exchange](/ai/docs/call-apis-on-users-behalf/on-behalf-of-token-exchange) | `POST` | 450 | 450/second | Any Request |
