...
| Resource | Burst Limit | Sustained Limit | Refresh Rate | Scope |
| --- | --- | --- | --- | --- |
| SCIM API Rate Limit – Global, i.e. applies to all SCIM connections (Tenant Scope) — Private Cloud Performance Plus 6000 RPS (60x) | 3000 | 3000 | second | Tenant |
...
| Resource | Burst Limit | Sustained Limit | Refresh Rate | Scope |
| --- | --- | --- | --- | --- |
| My Org API Rate Limit – Read Endpoints (Tenant Scope) — Private Cloud Performance Plus 6000 RPS (60x) | 480 | 240 | second | Tenant |
| My Org API  Rate Limit – Write Endpoints (Tenant Scope) — Private Cloud Performance Plus 6000 RPS (60x) | 120 | 60 | second | Tenant |

Organization level:

| Resource | Burst Limit | Sustained Limit | Refresh Rate | Scope |
| --- | --- | --- | --- | --- |
| My Org API Rate Limit – Read Endpoints (Organization Scope) — Private Cloud Performance Plus 6000 RPS (60x) | 10 | 10 | second | Organization |
| My Org API  Rate Limit – Write Endpoints (Organization Scope) — Private Cloud Performance Plus 6000 RPS (60x) | 10 | 10 | second | Organization |
