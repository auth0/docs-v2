...
| [Universal Logout](/docs/api/authentication/logout/global-token-revocation) | `POST` | 1500 | 1500/second | Any request |
...
| [Cross App Access (ID-JAG exchange)](/docs/ai-agents-mcp/cross-app-access) | `POST` | 3000 | 3000/second | Any Request |
...
| [Read Organization Members](https://auth0.com/docs/api/management/v2/organizations/get-organization-members) | `GET` | 2400 | 30000/minute | Any request |
...
| [Read Members of an Organization](https://auth0.com/docs/api/management/v2/organizations/get-organization-members) | `GET` | 1200 | 12000/minute | Any request |
...
| --- | --- | --- | --- | --- |
| SCIM API Rate Limit – /scim/v2/connections/\{connection-id\} Endpoint (Connection Scope) — Private Cloud Performance Plus 6000 RPS (60x) | 25 | 25 | second | Connection, Tenant |

Tenant level:

| Resource | Burst Limit | Sustained Limit | Refresh Rate | Scope |
| --- | --- | --- | --- | --- |
| SCIM API Rate Limit – Tenant Scope (applies across all SCIM endpoints) — Private Cloud Performance Plus 6000 RPS (60x) | 3000 | 3000 | second | Tenant |
...
<Accordion title="My Organization API: Rate limits for the My Organization API in the Private Cloud Performance Plus 6000 RPS (60x) subscription type.">
...
| Resource | Burst Limit | Sustained Limit | Refresh Rate | Scope |
| --- | --- | --- | --- | --- |
| My Org API Rate Limit – Read Endpoints (Tenant Scope) — Private Cloud Performance Plus 6000 RPS (60x) | 640 | 640 | second | Tenant |
| My Org API  Rate Limit – Write Endpoints (Tenant Scope) — Private Cloud Performance Plus 6000 RPS (60x) | 320 | 320 | second | Tenant |

Organization level:

| Resource | Burst Limit | Sustained Limit | Refresh Rate | Scope |
| --- | --- | --- | --- | --- |
| My Org API Rate Limit – Read Endpoints (Organization Scope) — Private Cloud Performance Plus 6000 RPS (60x) | 64 | 64 | second | Organization |
| My Org API  Rate Limit – Write Endpoints (Organization Scope) — Private Cloud Performance Plus 6000 RPS (60x) | 32 | 32 | second | Organization |
