...
| Token Vault ([Connected Accounts](/ai/docs/call-apis-on-users-behalf/token-vault) and [token exchange](/ai/docs/call-apis-on-users-behalf/token-vault#supported-token-exchanges) | `POST` | 10 | 10/second | Any request |
