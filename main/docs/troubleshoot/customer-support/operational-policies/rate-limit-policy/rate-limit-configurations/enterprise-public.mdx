...
Review the following table for Gobal Authentication API Rate Limits, or the rate limit policy protecting nearly all Authentication API endpoints.
...
Review the following table for Gobal Management API Rate Limits. Most Management API endpoints, except those listed under "endpoints", are protected by these rate limit policies.
