...
See below for the rate limit policies for the Enterprise subscription type.

<AccordionGroup>

<Accordion title="Authentication API: Rate limits for the Authentication API and API endpoints in the Enterprise subscription type.">
...
These limits are constrained to 48 hours per month. After 48 hours, these limits revert to product limits. For more information, read [Public Performance Burst](/docs/troubleshoot/customer-support/operational-policies/rate-limit-policy#public-performance-burst).
...
<Accordion title="Management API: Rate limits for the Management API, API endpoints, and API endpoint groups in the Enterprise subscription type.">
...
<Accordion title="My Account API: Rate limits for the My Account API endpoints in the Enterprise subscription type.">
...
<Accordion title="My Organization API: Rate limits for the My Organization API endpoints in the Enterprise subscription type.">
