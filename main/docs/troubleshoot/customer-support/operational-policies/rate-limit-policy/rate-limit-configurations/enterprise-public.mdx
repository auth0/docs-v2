...
| [Cross App Access (ID-JAG exchange)](/docs/secure/call-apis-on-users-behalf/xaa) | `POST` | 50 | 50/second | Any Request |
...
| [Write Organization invitation](/docs/api/management/v2/organizations/get-invitations-by-invitation-id) | `POST` | 20 | 200/minute | Any request |
