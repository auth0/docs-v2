...
redirects:
  - "/docs/troubleshoot/customer-support/operational-policies/rate-limit-policy/understand-rate-limit-burst-capability"
  - "/docs/understand-rate-limit-burst-capability"
  - "/docs/troubleshoot/customer-support/operational-policies/rate-limit-policy/database-connections-rate-limits"
  - "/docs/support/policies/rate-limit-policy/database-connections-rate-limits"
  - "/docs/support/policies/database-connections-rate-limits"
  - "/docs/connections/database/rate-limits"
  - "/docs/policies/rate-limit-policy/database-connections-rate-limits"
  - "/docs/policies/database-connections-rate-limits"
  - "/docs/troubleshoot/customer-support/operational-policies/rate-limit-policy/management-api-endpoint-rate-limits"
  - "/docs/support/policies/rate-limit-policy/management-api-endpoint-rate-limits"
  - "/docs/policies/management-api-endpoint-rate-limits"
  - "/docs/policies/rate-limits-mgmt-api"
  - "/docs/policies/rate-limit-policy/management-api-endpoint-rate-limits"
  - "/docs/policies/rate-limit-policy/mgmt-api-endpoint-rate-limits-before-19-may-2020"
  - "/docs/troubleshoot/customer-support/operational-policies/rate-limit-policy/authentication-api-endpoint-rate-limits"
  - "/docs/support/policies/rate-limit-policy/authentication-api-endpoint-rate-limits"
  - "/docs/policies/authentication-api-endpoint-rate-limits"
  - "/docs/policies/rate-limits-api"
  - "/docs/policies/rate-limits-auth-api"
  - "/docs/policies/rate-limit-policy/authentication-api-endpoint-rate-limits"
  - "/docs/support/policies/rate-limit-policy"
  - "/docs/policies/rate-limit-policy"
  - "/docs/policies/legacy-rate-limits"
  - "/docs/policies/rate-limits"
  - "/docs/policies/rate-limit"
  - "/docs/rate-limits"
---
