...
redirects:
  - "/docs/support/policies/public-cloud-service-endpoints"
  - "/docs/security/public-cloud-service-endpoints"
  - "/docs/policies/endpoints"
  - "/docs/policies/public-cloud-service-endpoints"
---
