...
redirects:
  - "/docs/troubleshoot/customer-support/software-updates"
  - "/docs/support/policies"
  - "/docs/policies/unsupported-requests"
  - "/docs/policies/restore-deleted-tenant"
  - "/docs/policies/dashboard-authentication"
  - "/docs/policies"
---
...
To conduct these tests, notify us in advance by submitting a [Support Ticket](https://support.auth0.com). Auth0 requires at least 14 days' notice prior to your test's planned start date.
