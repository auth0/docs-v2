...
<div data-uc-component="organization-details-edit" data-uc-props="{}" style={{ minHeight: "300px", marginTop: "50px" }}>
  <img src="https://auth0-universal-components.vercel.app/img/my-organization/organization-details/organization-details-edit.png" alt="Organization Details Edit Component Loading Preview" style={{ width: "100%", height: "auto", borderRadius: "8px" }} />
</div>
...
| Prop | Type | Description |
|------|------|-------------|
| `schema` | `OrganizationDetailsEditSchemas` | Field validation rules. [Details](#schema-validation) |
| `customMessages` | `Partial<OrganizationDetailsEditMessages>` | i18n text overrides. [Details](#custom-messages) |
| `styling` | `ComponentStyling<OrganizationEditClasses>` | CSS variables and class overrides. [Details](#custom-styling) |
