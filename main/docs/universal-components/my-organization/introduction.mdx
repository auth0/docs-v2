...
<CardGroup cols={2}>
  ...
  <Card title="SsoProviderTable" icon="table" href="/docs/universal-components/my-organization/idp-management/sso-provider-table">
  ...
  <Card title="SsoProviderCreate" icon="plus" href="/docs/universal-components/my-organization/idp-management/sso-provider-create">
  ...
  <Card title="SsoProviderEdit" icon="pen-to-square" href="/docs/universal-components/my-organization/idp-management/sso-provider-edit">
...
<Check>
  ...
  - See the [Overview](/docs/universal-components) for installation and Auth0ComponentProvider configuration
</Check>
