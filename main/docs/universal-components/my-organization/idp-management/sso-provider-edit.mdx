...
| Prop | Type | Description |
|------|------|-------------|
| `schema` | `SsoProviderEditSchema` | Field validation rules. [Details](#schema-validation) |
| `customMessages` | `Partial<SsoProviderEditMessages>` | i18n text overrides. [Details](#custom-messages) |
| `styling` | `ComponentStyling<SsoProviderEditClasses>` | CSS variables and class overrides. [Details](#custom-styling) |
