...
Core props are fundamental to the component's operation. For `SsoProviderCreate`, there is only one core prop which controls what happens after a provider is successfully created.
