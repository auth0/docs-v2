---
description: Manage domains in your organization
'og:image': https://cdn2.auth0.com/docs/1.14553.0/img/share-image.png
'og:title': Domain Table
'og:url': https://auth0.com/docs/
permalink: domain-table
title: Domain Table
'twitter:description': Manage domains in your organization
'twitter:title': Domain Table
---
...
<Note>
  **Auth0 Configuration Required**
  ...
  Before using the **DomainTable** component, ensure your tenant is configured with the proper APIs, applications, and permissions.
