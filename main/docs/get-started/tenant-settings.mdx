...
redirects:
  - "/docs/configure/tenant-settings"
  - "/docs/config/tenant-settings"
  - "/docs/dashboard/dashboard-tenant-settings"
  - "/docs/dashboard-account-settings"
  - "/docs/tutorials/dashboard-tenant-settings"
  - "/docs/dashboard/reference/settings-tenant"
  - "/docs/best-practices/tenant-settings"
  - "/docs/best-practices/tenant-settings-best-practices"
  - "/docs/get-started/dashboard/tenant-settings"
  - "/docs/dashboard/tenant-settings"
---
...
* **Resource Parameter Compatibility Profile**: The resource parameter compatibility profile determines how Auth0 handles the `resource` parameter in authorization requests.                                               
  * When enabled (default for new tenants):
