---
description: Add tenant members to your Auth0 Dashboard and assign roles that control which Dashboard areas they can access, from full admin to read-only viewer.
title: Add Tenant Members
redirects:
  - "/docs/dashboard-access/add-dashboard-users"
---
