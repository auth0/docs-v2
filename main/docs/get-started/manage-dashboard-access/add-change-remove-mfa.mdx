---
title: Multi-Factor Authentication for the Auth0 Dashboard
sidebarTitle: Multi-Factor Authentication
description: Increase security for Dashboard logins by enrolling in multi-factor authentication.
---
