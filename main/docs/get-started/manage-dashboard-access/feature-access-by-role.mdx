...
redirects:
  - "/docs/get-started/manage-dashboard-access/support-center-users"
  - "/docs/dashboard-access/support-center-users"
  - "/docs/support/support-center-users"
  - "/docs/dashboard-access/feature-access-by-role"
  - "/docs/dashboard-access/dashboard-roles/feature-access-by-role"
---
