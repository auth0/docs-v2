---
description: Learn about what Auth0 does, how it handles authentication and authorization, and how to connect your users, applications, and APIs.
title: Introduction to Auth0
redirects:
  - "/docs/get-started/onboarding"
---
