...
* [Register your Auth0 application](/docs/get-started/auth0-overview/create-applications); If you do not have an Auth0 application, you can get started with an Auth0 [quickstart](https://auth0.com/docs/quickstart/spa/react).
