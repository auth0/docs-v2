...
- **Web** components use the [My Organization API](/docs/api/myorganization) to build **delegated administration** interfaces, where your business customers manage their own Organizations, domains, and SSO providers. They run on React, Next.js, and shadcn.
