...
Auth0 [Universal Components for iOS](https://github.com/auth0/ui-components-ios) use a design token model. Every visual property—colors, typography, spacing, corner radii, and component sizes—is expressed as a token that you can override without rewriting layouts.
