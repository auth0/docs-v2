...
* Programming language: `Swift 5+` (6 preferred), `Xcode 16+` (Preferred 26+)
...
The Universal Components for iOS SDK is distributed as the [`Auth0UniversalComponents`](/docs/get-started/universal-components/universal-components-overview) package.
...
Inside the sample application, `AppUIComponentsApp.swift` serves as the main SwiftUI entry point for SDK initialization, while `ThemeManager.swift` handles custom theme injection and runtime switching.
