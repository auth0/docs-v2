...
With the `MyAccountAuthMethodsView` component, users can manage their own authentication methods — multi-factor authentication (MFA) factors, passkeys, and recovery codes — directly inside your application, without leaving for a web browser or contacting support.
...
Use the Swift Package Manager or Carthage to install Auth0UniversalComponents.
