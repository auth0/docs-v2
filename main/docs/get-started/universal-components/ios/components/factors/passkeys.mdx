...
Unlike other factors, Auth0 [passkeys](/docs/authenticate/database-connections/passkeys) require application-side platform entitlements that the Universal Components for iOS SDK cannot configure.
...
4. Add your application bundle ID under **Allowed iOS Applications**.
