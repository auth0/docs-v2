---
title: Passkeys on Universal Component for iOS
...
To enable platform entitlements for Universal Component for iOS SDK passkeys support:
...
* **Confirm OS version**. Passkeys is supported on devices running **iOS 16.6+**, macOS **13.5+**, or visionOS **1.0+**.
...
* Open [**Xcode**](https://developer.apple.com/documentation/xcode)
...
The passkey educational and status screens inherit the `MyAccountAuthMethodsView` component active theme. 
