...
The `SsoProviderTable` component provides a unified interface to list and configure [Single Sign-On](/docs/authenticate/enterprise-connections/self-service-enterprise-config) providers for your organization.
