...
The `SsoProviderCreate` component provides a unified interface to add new [Single Sign-On](/docs/authenticate/enterprise-connections/self-service-enterprise-config) providers.
