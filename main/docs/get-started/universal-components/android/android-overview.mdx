...
The sample includes `MainActivity.kt`, which initializes the SDK via `Auth0UniversalComponents.initialize()`, and `LoginSecurityScreen.kt`, which renders the `AuthenticatorSettingsComponent`.
