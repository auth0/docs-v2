...
By default, the Auth0 React SDK uses silent authentication to obtain new access tokens. If your application enables refresh-token renewal, configure refresh tokens for the Auth0 application and set `useRefreshTokens={true}` on `Auth0Provider`:
...
### Use with My Organization components

My Organization components request user-scoped access tokens for the My Organization API. They supply the required audience and scopes when making API requests.
    ...
    <table class="table">
      ...
      <tbody>
        <tr>
          ...
          <td>Yes</td>
          <td>-</td>
          <td>Current language code (for example, "en", "es", "fr")</td>
        </tr>
        <tr>
          <td>
    ...
    <table class="table">
      ...
      <tbody>
        <tr>
          ...
          <td><code>string</code></td>
          <td>Yes</td>
          <td>Auth0 tenant domain (for example, "your-tenant.auth0.com"). Required for proxy mode.</td>
        </tr>
        <tr>
    ...
    <table class="table">
      ...
      <tbody>
        <tr>
          ...
          <td>Yes</td>
          <td>
            URL to your authentication proxy server (for example, "/api/auth"). API calls
    ...
    <table class="table">
      ...
      <tbody>
        <tr>
          ...
          <td><code>string</code></td>
          <td>Yes</td>
          <td>Auth0 tenant domain (for example, "your-tenant.auth0.com").</td>
        </tr>
        <tr>
