...
The component automatically disables controls that the signed-in administrator cannot use. It also prevents mutations for members whose access level is not `limited` or `full`.
...
- **Mutation controls:** Role assignment, role removal, and member removal controls are disabled with an explanatory tooltip when the administrator lacks the required permission.
- **Target member access levels:** Member mutations require the target member's access level to be `limited` or `full`. If the member has a `readonly`, `none`, absent, or unknown access level, mutation controls are disabled with an explanatory tooltip (`"This action is not available for this member"`).
...
<table class="table">
  ...
  <tbody>
    <tr>
      ...
      <td>
        Auth0 user ID of the member to display (for example, <code>auth0|64abc...</code>).
      </td>
    </tr>
  </tbody>
</table>
...
<table class="table">
  ...
  <tbody>
    <tr>
      ...
      <td>
        Hide the component header section (title and description). In the current Early Access release, this prop does not hide the Member Detail header.
      </td>
    </tr>
    <tr>
      <td>
      ...
      <td>
        Disable role management and member-removal actions.
      </td>
    </tr>
    <tr>
      <td>
      ...
      <td>
        <code>'details' | 'roles'</code>
      </td>
      <td>
        <code>'details'</code>
      </td>
      <td>
        The tab to display initially. Deep link here using router query parameters.
      </td>
    </tr>
  </tbody>
</table>
...
<div style={{ overflowX: "auto" }}>
  <table class="table">
    ...
    <tbody>
      ...
      <tr>
        <td>
          <code>removeRolesAction</code>
        </td>
        <td>
          <code>ComponentAction</code>
        </td>
        <td>
          Remove roles. Hooks receive <code>&#123; userId, roleIds &#125;</code>.
        </td>
      </tr>
    </tbody>
  </table>
...
<table class="table">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        <code>ComponentStyling&lt;OrganizationMemberDetailClasses&gt;</code>
      </td>
      <td>
...
`OrganizationMemberDetail` is composed of smaller subcomponents and a hook.

### Available subcomponents

When installed from npm, internal modals and sub-tabs are private implementation details. Supported public component exports are:
...
<table class="table">
  ...
  <tbody>
    <tr>
      <td>
        <code>OrganizationMemberDetail</code>
      </td>
      <td>Pre-configured container with built-in data fetching and modals.</td>
    </tr>
    <tr>
      <td>
        <code>OrganizationMemberDetailView</code>
      </td>
      <td>Stateless view layer; bring your own data via <code>useOrganizationMemberDetail</code>.</td>
    </tr>
  </tbody>
</table>

When installed via shadcn, the subcomponent source files (`OrganizationMemberEditDetailsTab`, `OrganizationMemberEditRolesTab`, and so on) are located in your local project directory and can be modified directly.
...
<table class="table">
  ...
  <tbody>
    <tr>
      <td>
        <code>useOrganizationMemberDetail</code>
      </td>
      <td>Full data and interaction layer: member query, role queries, modal state, and all event handlers.</td>
    </tr>
  </tbody>
</table>
