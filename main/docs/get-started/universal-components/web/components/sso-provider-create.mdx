---
title: Create SSO Providers on Web
sidebarTitle: SsoProviderCreate component
...
<Callout icon="file-lines" color="#0EA5E9" iconType="regular">
  `react-hook-form` and `@tanstack/react-query` are peer dependencies. The
  command also installs the @auth0/universal-components-core dependency for
  shared utilities and Auth0 integration.
</Callout>
