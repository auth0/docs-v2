...
## Configure application access
  ...
  3. Configure the following settings:
     - [Connection Profile](/docs/authenticate/enterprise-connections/connection-profile#connection-profile): Select or create a profile with connection attribute mappings.
     - [User Attribute Profile](/docs/authenticate/enterprise-connections/user-attribute-profile#user-attribute-profile): Select or create a profile with user attribute mappings.
