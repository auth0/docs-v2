...
<table class="table">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><code>Partial&lt;Record&lt;MFAType,<br /> &#123; visible?: boolean; enabled?: boolean &#125;&gt;&gt;</code></td>
      <td><code>&#123;&#125;</code></td>
...
| `factorConfig`   | `Partial<Record<MFAType,<br />{ visible?: boolean; enabled?: boolean }>>` | `{ }` | Per-factor-type visibility and enabled state. |
