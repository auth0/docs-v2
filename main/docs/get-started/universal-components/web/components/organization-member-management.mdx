...
| :--- | :--- | :--- | :--- |
| `hideHeader` | `boolean` | `false` | Hide the component header section (title and description). |
| `readOnly` | `boolean` | `false` | Disable all mutation actions (invite, revoke, resend, remove, assign). |
