...
<Callout icon="file-lines" color="#0EA5E9" iconType="regular">
  Color token overrides via `themeSettings.variables.light` / `.dark` always use `--auth0-*` names, regardless of your CSS setup. Border radius and typography tokens use their own names (`--radius-*`, `--font-size-*`).
</Callout>
