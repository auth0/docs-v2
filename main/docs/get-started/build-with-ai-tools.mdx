...
If successful, the Auth0 Docs MCP Server should appear as an available tool. To learn more, read OpenAI's [Connect from ChatGPT](https://developers.openai.com/apps-sdk/deploy/connect-chatgpt/) documentation.
...
If successful, the Auth0 Docs MCP Server should appear as a custom connector. To learn more, read Claude’s [Connect to remote MCP Servers](https://modelcontextprotocol.io/docs/tutorials/use-remote-mcp-server#connecting-to-a-remote-mcp-server) documentation.
...
If successful, the Auth0 Docs MCP Server should appear as an available MCP server. To learn more, read Claude’s [Installing MCP servers](https://docs.anthropic.com/en/docs/claude-code/mcp#installing-mcp-servers) documentation.
...
If successful, the Auth0 Docs MCP Server should appear as an available MCP server. To learn more, read Codex’s [Model Context Protocol](https://developers.openai.com/codex/mcp) documentation.
...
To verify, ask `What tools do you have available?` in Cursor’s chat. Cursor should list the Auth0 Docs MCP Server as an available tool. To learn more, read Cursor’s [Installing MCP servers](https://cursor.com/docs/context/mcp#installing-mcp-servers) documentation.
...
To verify, ask `What tools do you have available?` in Cascade’s chat. Cascade should list the Auth0 Docs MCP Server as an available tool. To learn more, read Windsurf’s [Model Context Protocol](https://docs.windsurf.com/plugins/cascade/mcp#model-context-protocol-mcp) documentation.
