...
sidebarTitle: Implement Advanced Security Monitoring
...
Claude will use the `auth0_list_logs` tool to retrieve and analyze your logs. This analysis gives you a baseline understanding of normal authentication patterns, which is essential for identifying anomalies.
...
Claude will use the `auth0_create_form` tool to create a custom Form.
