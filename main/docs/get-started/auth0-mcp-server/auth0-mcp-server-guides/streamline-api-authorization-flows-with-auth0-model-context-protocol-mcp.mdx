...
sidebarTitle: Streamline API Authorization Flows
validatedOn: 2026-02-20
redirects:
  - "/docs/get-started/mcp/mcp-guides/streamline-api-authorization-flows-with-auth0-model-context-protocol-mcp"
---
<Card title="Overview">
