---
description: Learn which management scopes are required for each Auth0 MCP Server tool and how to configure them using glob patterns during initialization.
title: Understanding Scopes
redirects:
  - "/docs/get-started/mcp/mcp-guides/understanding-scopes"
---
