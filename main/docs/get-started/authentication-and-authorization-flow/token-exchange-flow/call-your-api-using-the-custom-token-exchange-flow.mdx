---
description: Make a POST request to the /oauth/token endpoint with a subject token to exchange it for Auth0 access, ID, and refresh tokens using Custom Token Exchange.
