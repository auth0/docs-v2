...
redirects:
  - "/docs/get-started/authentication-and-authorization-flow/add-login-using-the-implicit-flow-with-form-post"
  - "/docs/login/authentication/add-login-using-the-implicit-flow-with-form-post"
  - "/docs/flows/add-login-using-the-implicit-flow-with-form-post"
  - "/docs/application-auth/legacy/client-side-web"
  - "/docs/client-auth/client-side-web"
  - "/docs/flows/guides/single-page-login-flow/add-login-using-single-page-login-flow"
  - "/docs/application-auth/current/client-side-web"
  - "/docs/flows/guides/implicit/includes/authorize-user-add-login"
  - "/docs/flows/guides/implicit/includes/request-tokens"
  - "/docs/flows/guides/implicit/includes/refresh-tokens"
  - "/docs/flows/guides/implicit/includes/sample-use-cases-add-login"
  - "/docs/flows/guides/implicit/add-login-implicit"
---
