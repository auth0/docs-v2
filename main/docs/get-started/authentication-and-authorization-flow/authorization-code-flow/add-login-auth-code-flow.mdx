...
redirects:
  - "/docs/get-started/authentication-and-authorization-flow/add-login-auth-code-flow"
  - "/docs/login/authentication/add-login-auth-code-flow"
  - "/docs/flows/add-login-auth-code-flow"
  - "/docs/application-auth/legacy/server-side-web"
  - "/docs/client-auth/server-side-web"
  - "/docs/application-auth/current/server-side-web"
  - "/docs/protocols/oauth2/oauth-web-protocol"
  - "/docs/protocols/oauth-web-protocol"
  - "/docs/oauth-web-protocol"
  - "/docs/flows/guides/regular-web-app-login-flow/add-login-using-regular-web-app-login-flow"
  - "/docs/flows/guides/auth-code/includes/request-tokens"
  - "/docs/flows/guides/auth-code/includes/refresh-tokens"
  - "/docs/flows/guides/auth-code/includes/sample-use-cases-add-login"
  - "/docs/flows/guides/auth-code/includes/authorize-user-add-login"
  - "/docs/flows/guides/auth-code/add-login-auth-code"
---
