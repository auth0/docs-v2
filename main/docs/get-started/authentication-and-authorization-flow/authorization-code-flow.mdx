...
redirects:
  - "/docs/authorization/flows/authorization-code-flow"
  - "/docs/flows/authorization-code-flow"
  - "/docs/api-auth/adoption/authorization-code"
  - "/docs/api-auth/tutorials/adoption/authorization-code"
  - "/docs/api-auth/grant/authorization-code"
  - "/docs/flows/concepts/regular-web-app-login-flow"
  - "/docs/flows/concepts/auth-code"
---
