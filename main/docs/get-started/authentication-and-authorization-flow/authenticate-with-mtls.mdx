---
description: Learn how mutual TLS (mTLS) secures OAuth flows by replacing shared client secrets with X.509 certificates and optionally binding access tokens to the client.
