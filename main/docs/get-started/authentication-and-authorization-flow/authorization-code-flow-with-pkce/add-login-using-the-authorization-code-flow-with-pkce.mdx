...
redirects:
  - "/docs/get-started/authentication-and-authorization-flow/add-login-using-the-authorization-code-flow-with-pkce"
  - "/docs/login/authentication/add-login-using-the-authorization-code-flow-with-pkce"
  - "/docs/flows/add-login-using-the-authorization-code-flow-with-pkce"
  - "/docs/flows/guides/mobile-login-flow/add-login-using-mobile-login-flow"
  - "/docs/application-auth/legacy/mobile-desktop"
  - "/docs/application-auth/current/mobile-desktop"
  - "/docs/flows/guides/auth-code-pkce/includes/authorize-user-add-login"
  - "/docs/flows/guides/auth-code-pkce/includes/create-code-challenge"
  - "/docs/flows/guides/auth-code-pkce/includes/create-code-verifier"
  - "/docs/flows/guides/auth-code-pkce/includes/refresh-tokens"
  - "/docs/flows/guides/auth-code-pkce/includes/request-tokens"
  - "/docs/flows/guides/auth-code-pkce/includes/sample-use-cases-add-login"
  - "/docs/flows/guides/auth-code-pkce/add-login-auth-code-pkce"
---
