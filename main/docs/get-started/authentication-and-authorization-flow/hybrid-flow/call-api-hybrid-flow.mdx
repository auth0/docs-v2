...
redirects:
  - "/docs/get-started/authentication-and-authorization-flow/call-api-hybrid-flow"
  - "/docs/authorization/flows/call-api-hybrid-flow"
  - "/docs/flows/call-api-hybrid-flow"
  - "/docs/api-auth/tutorials/hybrid-flow"
---
...
| `nonce` | A cryptographically random string that your app adds to the initial request and Auth0 includes inside the ID Token, [used to prevent token replay attacks](/docs/get-started/authentication-and-authorization-flow/implicit-flow-with-form-post/mitigate-replay-attacks-when-using-the-implicit-flow). |
