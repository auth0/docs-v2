---
description: Learn how to identify the right OAuth 2.0 flow for your application type, from server-side web apps and SPAs to machine-to-machine and device flows.
title: Which OAuth 2.0 Flow Should I Use?
redirects:
  - "/docs/authorization/flows/which-oauth-2-0-flow-should-i-use"
  - "/docs/authorization/which-oauth-2-0-flow-should-i-use"
  - "/docs/authorization/authentication-and-authorization-api-faq"
  - "/docs/api-auth/faq"
  - "/docs/api-auth/which-oauth-flow-to-use"
---
