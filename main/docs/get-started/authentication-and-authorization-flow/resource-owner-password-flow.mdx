...
redirects:
  - "/docs/authorization/flows/resource-owner-password-flow"
  - "/docs/flows/resource-owner-password-flow"
  - "/docs/api-auth/tutorials/adoption/password"
  - "/docs/api-auth/grant/password"
---
<Warning>
