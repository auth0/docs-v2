...
Once you have a user ID for the authorizing user, use the Authentication API or our [SDKs](/docs/libraries) to send an Async Authorization request to the `/bc-authorize` endpoint:
