---
description: Learn how to authenticate users with the Client-Initiated Backchannel Authentication Flow using mobile push notifications.
title: Mobile Push Notifications with CIBA
validatedOn: 2026-02-20
redirects:
  - "/docs/get-started/authentication-and-authorization-flow/client-initiated-backchannel-authentication-flow/user-authentication-with-ciba"
---
