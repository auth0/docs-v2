...
redirects:
  - "/docs/authorization/flows/client-credentials-flow"
  - "/docs/flows/client-credentials-flow"
  - "/docs/api-auth/tutorials/adoption/client-credentials"
  - "/docs/api-auth/grant/client-credentials"
  - "/docs/flows/concepts/m2m-flow"
  - "/docs/flows/concepts/client-credentials"
  - "/docs/microsites/call-api/call-api-m2m-app"
---
