...
redirects:
  - "/docs/authorization/flows/implicit-flow-with-form-post"
  - "/docs/flows/implicit-flow-with-form-post"
  - "/docs/flows/concepts/implicit"
  - "/docs/protocols/oauth2/oauth-implicit-protocol"
  - "/docs/api-auth/tutorials/implicit-grant"
  - "/docs/api-auth/tutorials/adoption/implicit"
  - "/docs/api-auth/grant/implicit"
  - "/docs/flows/guides/single-page-login-flow/call-api-using-single-page-login-flow"
  - "/docs/flows/guides/implicit/includes/authorize-user-call-api"
  - "/docs/flows/guides/implicit/includes/call-api"
  - "/docs/flows/guides/implicit/includes/sample-use-cases-call-api"
  - "/docs/flows/guides/implicit/call-api-implicit"
---
<Warning>
...
<Frame>![Flows - Implicit with Form Post - Authorization sequence diagram](/docs/images/cdy7uua7fh8z/6m0uE4E7Hpzbdhyh9dEuYK/e36c910ff47a7540bf27e23c02822624/auth-sequence-implicit-form-post.png)</Frame>
