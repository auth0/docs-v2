...
redirects:
  - "/docs/get-started/authentication-and-authorization-flow/avoid-common-issues-with-resource-owner-password-flow-and-attack-protection"
  - "/docs/authorization/flows/avoid-common-issues-with-resource-owner-password-flow-and-attack-protection"
  - "/docs/authorization/avoid-common-issues-with-resource-owner-password-flow-and-attack-protection"
  - "/docs/authorization/avoid-common-issues-with-resource-owner-password-flow-and-anomaly-detection"
  - "/docs/api-auth/tutorials/using-resource-owner-password-from-server-side"
---
