...
redirects:
  - "/docs/get-started/authentication-and-authorization-flow/call-your-api-using-resource-owner-password-flow"
  - "/docs/authorization/flows/call-your-api-using-resource-owner-password-flow"
  - "/docs/api-auth/tutorials/password-grant"
  - "/docs/flows/call-your-api-using-resource-owner-password-flow"
---
