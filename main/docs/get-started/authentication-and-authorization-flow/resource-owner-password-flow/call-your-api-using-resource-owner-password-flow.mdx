---
'og:description': Learn how to call your own API from highly-trusted applications
...
Any connection that supports active authentication can be configured as a realm, including [database connections](/docs/authenticate/identity-providers/database), [passwordless connections](/docs/authenticate/identity-providers/passwordless), and [AD/LDAP](/docs/authenticate/identity-providers/enterprise/active-directory-ldap), [ADFS](/docs/authenticate/identity-providers/enterprise/adfs), and [Azure Active Directory](/docs/authenticate/identity-providers/enterprise/azure-active-directory) enterprise connections.
