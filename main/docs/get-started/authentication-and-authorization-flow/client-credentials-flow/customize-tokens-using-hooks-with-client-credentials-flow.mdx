...
redirects:
  - "/docs/get-started/authentication-and-authorization-flow/customize-tokens-using-hooks-with-client-credentials-flow"
  - "/docs/authorization/flows/customize-tokens-using-hooks-with-client-credentials-flow"
  - "/docs/authorization/customize-tokens-using-hooks-with-client-credentials-flow"
  - "/docs/api-auth/grant/using-rules"
  - "/docs/api-auth/tutorials/client-credentials/customize-with-hooks"
---
