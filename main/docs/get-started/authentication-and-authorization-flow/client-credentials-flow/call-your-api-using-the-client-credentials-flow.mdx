...
redirects:
  - "/docs/get-started/authentication-and-authorization-flow/call-your-api-using-the-client-credentials-flow"
  - "/docs/authorization/flows/call-your-api-using-the-client-credentials-flow"
  - "/docs/flows/call-your-api-using-the-client-credentials-flow"
  - "/docs/api-auth/config/asking-for-access-tokens"
  - "/docs/api-auth/tutorials/client-credentials"
  - "/docs/flows/guides/m2m-flow/call-api-using-m2m-flow"
  - "/docs/flows/guides/client-credentials/includes/request-token"
  - "/docs/flows/guides/client-credentials/includes/call-api"
  - "/docs/flows/guides/client-credentials/includes/sample-use-cases"
  - "/docs/flows/guides/client-credentials/call-api-client-credentials"
---
