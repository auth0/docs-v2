...
To access your API, you must request an access token for it. To do so, you will need to `POST` to the [token URL](/docs/api/authentication/client-credential-flow/get-token).
...
To learn more, read about the Actions [Machine to Machine Flow](/docs/customize/actions/explore-triggers/credentials-exchange).
...
* [Machine to Machine Triggers](/docs/customize/actions/explore-triggers/credentials-exchange)
