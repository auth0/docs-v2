...
redirects:
  - "/docs/get-started/authentication-and-authorization-flow/call-your-api-using-the-device-authorization-flow"
  - "/docs/microsites/protect-api/protect-api"
  - "/docs/authorization/flows/call-your-api-using-the-device-authorization-flow"
  - "/docs/flows/guides/device-auth/call-api-device-auth"
  - "/docs/microsites/call-api/call-api-device"
---
