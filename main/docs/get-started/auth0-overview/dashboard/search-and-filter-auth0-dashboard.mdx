...
<Callout icon="magnifying-glass" color="#0EA5E9" iconType="regular">
...
Note that canonical domains (e.g., your-tenant.auth0.com) are not custom domains and will not appear in search results. If you're looking for your canonical domain, you can find it in your tenant settings.                                                                                         
### Limitations
