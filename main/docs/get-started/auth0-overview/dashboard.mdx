...
<Callout icon="sparkles" color="#0EA5E9" iconType="regular">
  We've redesigned the Dashboard navigation with an improved information architecture and more structured layout. [Learn more about the new navigation](/docs/get-started/auth0-overview/dashboard/use-dashboard-navigation.mdx).
</Callout>
