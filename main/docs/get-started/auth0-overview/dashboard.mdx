...
<Callout icon="sparkles" color="#0EA5E9" iconType="regular">
  **Try the new navigation (Early Access)**

  We've redesigned the dashboard navigation and information architecture with an improved information architecture and more structured layout. [Learn more about the new navigation](/docs/get-started/auth0-overview/dashboard/new-navigation-ui).
</Callout>
