...
---
Auth0 offers the ability for customers with an Enterprise subscription to link multiple tenants under a single Auth0 subscription. These are called child tenants or linked tenants.
