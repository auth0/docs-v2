...
redirects:
  - "/docs/get-started/create-tenants/create-multiple-tenants"
  - "/docs/dashboard/guides/tenants/create-multiple-tenants"
  - "/docs/get-started/dashboard/create-multiple-tenants"
---
