...
redirects:
  - "/docs/get-started/create-apps/single-page-web-apps"
  - "/docs/applications/set-up-an-application/register-single-page-app"
  - "/docs/applications/register-single-page-app"
  - "/docs/applications/application-settings/single-page-app"
  - "/docs/applications/spa"
  - "/docs/dashboard/guides/applications/register-app-spa"
---
