...
redirects:
  - "/docs/get-started/create-apps/regular-web-apps"
  - "/docs/applications/set-up-an-application/register-regular-web-applications"
  - "/docs/applications/register-regular-web-applications"
  - "/docs/applications/webapps"
  - "/docs/applications/application-settings/regular-web-app"
  - "/docs/dashboard/guides/applications/register-app-regular-web"
---
