...
redirects:
  - "/docs/get-started/create-apps/native-apps"
  - "/docs/applications/set-up-an-application/register-native-applications"
  - "/docs/applications/native"
  - "/docs/applications/application-settings/native"
