...
redirects:
  - "/docs/get-started/onboarding/self-service-m2m"
  - "/docs/get-started/create-apps/machine-to-machine-apps"
  - "/docs/applications/set-up-an-application/register-machine-to-machine-applications"
  - "/docs/applications/machine-to-machine"
  - "/docs/applications/application-settings/machine-to-machine"
  - "/docs/applications/application-settings/non-interactive"
  - "/docs/dashboard/guides/applications/register-app-m2m"
---
