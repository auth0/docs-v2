...
redirects:
  - "/docs/configure/tenant-settings/enable-sso-for-legacy-tenants"
  - "/docs/dashboard/guides/tenants/enable-sso-tenant"
  - "/docs/get-started/dashboard/enable-sso-for-legacy-tenants"
---
