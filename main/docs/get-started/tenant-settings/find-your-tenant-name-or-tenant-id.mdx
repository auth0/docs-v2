...
description: Find your Auth0 tenant name and ID in the Dashboard to use when you configure SDKs, call APIs, or substitute variables in Auth0 documentation.
---
