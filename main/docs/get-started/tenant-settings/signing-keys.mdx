...
description: Auth0 uses RS256 signing key pairs to sign ID tokens, access tokens, and SAML assertions. Learn how rotation keeps your applications trusting valid keys.
redirects:
  - "/docs/configure/tenant-settings/signing-keys"
  - "/docs/config/tenant-settings/signing-keys"
  - "/docs/tokens/guides/manage-signing-keys"
  - "/docs/tokens/manage-signing-keys"
---
