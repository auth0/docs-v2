...
1. Maintain rigorous security and interoperability. Enterprise customers require stringent IAM standards — not as a checkbox, but as a gatekeeper. 96% of enterprise customers explicitly included IAM requirements in formal RFPs in 2025. Security and baseline interoperability are no longer line items you can defer post-sale.
2. Deliver a flawless customer onboarding and lifecycle experience. Winning the customer is only half the battle. If they can't activate seamlessly, they never realize the value of your software — they churn, and you lose the business.
3. Unlock and enable innovation for your core product. When your identity team is playing catch-up, your business loses first-mover advantage, falls last to market, and strips away its competitive edge.
...
Use this type when you are using a purchased or managed authorization server such as Amazon Cognito, PingIdentity PingOne, Ory, Keycloak, or Transmit Security. The topology and wizard flow are identical to Type 1. Refer to your auth server provider's documentation for configuring Auth0 as an identity provider.
...
4. Integration created: Proceed to set up Organizations and SSEC.
...
3. Continue Setup: Integration created. Follow the Quickstart to add a Login with SSO button to your application and configure Organizations and SSEC.
