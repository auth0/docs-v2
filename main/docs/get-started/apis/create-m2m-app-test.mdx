...
redirects:
  - "/docs/configure/apis/create-m2m-app-test"
  - "/docs/tokens/management-api-access-tokens/create-and-authorize-a-machine-to-machine-application"
  - "/docs/api/management/v2/create-m2m-app"
  - "/docs/config/api-settings/create-m2m-app-test"
---
