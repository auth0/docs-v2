...
3. Select the **Application Access Policy** to configure the **user** and **client** flows. 
  * You can configure the **user flows** policy to **Allow**, **Allow via client-grant**, or **Deny**. 
  ...
  * You can configure the **client flows** policy to **Allow via client-grant** or **Deny**. 
