...
<td>The default for user access when you create an API. You can only configure `allow_all` for user access.</td>
</tr>
<tr>
...
<td>You can configure <code>deny_all</code> for both user and client access.</td>
</tr>
</tbody>
</table>
...
To configure baseline permissions for all third-party applications, read [Configure API Access Policies for Third-Party Applications](/docs/get-started/applications/third-party-applications/configure-third-party-applications#configure-api-access-policies).

1. Navigate to **Applications > APIs** and select the API.
2. Under **Settings** tab, navigate to **Default Permissions for Third Party Apps**.
