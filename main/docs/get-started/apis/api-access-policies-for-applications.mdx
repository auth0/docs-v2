...
description: Control which applications can access your APIs using allow-all, per-app authorization, or deny-all policies for both user-delegated and Client Credential flows.
