...
5. When **Allow via client-grant** is the policy configured for the API, select **Edit** to authorize **User-Delegated Access**, **Client Access**, or both for each individual Application.
