...
redirects:
  - "/docs/configure/apis/add-api-permissions"
  - "/docs/config/api-settings/add-api-permissions"
  - "/docs/get-started/dashboard/add-api-permissions"
  - "/docs/scopes/current/guides/define-api-scope-dashboard"
  - "/docs/scopes/current/guides/define-scopes-using-dashboard"
  - "/docs/api/management/guides/apis/update-permissions-apis"
  - "/docs/dashboard/guides/apis/add-permissions-apis"
---
