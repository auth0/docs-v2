...
redirects:
  - "/docs/configure/apis/delete-api-permissions"
  - "/docs/config/api-settings/delete-api-permissions"
  - "/docs/get-started/dashboard/delete-api-permissions"
  - "/docs/dashboard/guides/apis/delete-permissions-apis"
---
