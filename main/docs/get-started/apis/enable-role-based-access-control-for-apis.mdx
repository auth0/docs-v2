...
redirects:
  - "/docs/configure/apis/enable-role-based-access-control-for-apis"
  - "/docs/authorization/auth-core-features/enable-role-based-access-control-for-apis"
  - "/docs/authorization/rbac/enable-role-based-access-control-for-apis"
  - "/docs/authorization/guides/dashboard/enable-rbac"
  - "/docs/dashboard/guides/apis/enable-rbac"
  - "/docs/api/management/guides/apis/enable-rbac"
---
