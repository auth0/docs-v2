---
description: See practical examples of using OAuth 2.0 scopes and JWT claims to control what data and actions applications can access on behalf of users.
