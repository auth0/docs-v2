---
description: Learn from practical examples on how OAuth 2.0 scopes and JWT claims control what data and actions applications can access on behalf of users.
title: 'Sample Use Cases: Scopes and Claims'
redirects:
  - "/docs/configure/apis/scopes/sample-use-cases-scopes-and-claims"
  - "/docs/scopes/current/sample-use-cases"
  - "/docs/scopes/sample-use-cases-scopes-and-claims"
---
