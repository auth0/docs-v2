---
description: Define and use custom scopes on your Auth0 API to implement access control and enforce permissions in your application.
title: API Scopes
validatedOn: 2026-02-09
redirects:
  - "/docs/configure/apis/scopes/api-scopes"
  - "/docs/scopes/current/api-scopes"
  - "/docs/scopes/api-scopes"
---
