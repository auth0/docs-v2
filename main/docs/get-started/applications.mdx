...
redirects:
  - "/docs/configure/applications"
  - "/docs/applications/concepts/client-secret"
  - "/docs/applications/application-types"
  - "/docs/clients/client-types"
  - "/docs/api-auth/client-types"
  - "/docs/api-auth/tutorials/adoption/oidc-conformant"
  - "/docs/clients"
  - "/docs/applications/concepts/app-types-auth0"
  - "/docs/application"
  - "/docs/applications"
---
