---
title: Business-to-Consumer Authorization
...
redirects:
  - "/docs/architecture-scenarios/b2c/authorization"
  - "/docs/architecture-scenarios/implementation/b2c/b2c-authorization"
  - "/docs/architecture-scenarios/b2c/b2c-authorization"
---
...
As is the case with ID Tokens, you can [add custom claims to Access Tokens](/docs/get-started/apis/scopes/sample-use-cases-scopes-and-claims#add-custom-claims-to-a-token) using Auth0 Action extensibility. Once added, your API can then verify an Access Token for the necessary claims and either allow or prevent access to certain functionality as required.
