...
Native mobile applications (and desktop applications) should use the system browser for authentication, or they open themselves up to additional security risks. See [Native vs. Browser Login on Mobile](/docs/design/browser-based-vs-native-experience-on-mobile) for more information.
