---
title: Business-to-Consumer Logout
sidebarTitle: Logout
description: Plan user logout for a B2C IAM Auth0 implementation by deciding which session layers to end on each sign-out, from the application down to the identity provider.
redirects:
  - "/docs/architecture-scenarios/b2c/logout"
  - "/docs/architecture-scenarios/implementation/b2c/b2c-logout"
  - "/docs/architecture-scenarios/b2c/b2c-logout"
---
