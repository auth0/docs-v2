---
title: Business-to-Consumer Deployment Automation
sidebarTitle: Deployment Automation
description: Automate Auth0 tenant deployment for a B2C IAM implementation using the Deploy CLI alongside source control and environment-specific configuration files.
redirects:
  - "/docs/architecture-scenarios/b2c/deployment"
  - "/docs/architecture-scenarios/implementation/b2c/b2c-deployment"
  - "/docs/architecture-scenarios/b2c/b2c-deployment"
---
