---
title: Business-to-Consumer Provisioning
...
redirects:
  - "/docs/architecture-scenarios/b2c/provisioning"
  - "/docs/architecture-scenarios/implementation/b2c/b2c-provisioning"
  - "/docs/architecture-scenarios/b2c/b2c-provisioning"
---
