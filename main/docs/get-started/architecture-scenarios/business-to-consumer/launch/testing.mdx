...
* For use of variables in Custom DB Scripts, see the [configuration parameters](/docs/authenticate/identity-providers/database/custom-db/create-db-connection#step-3-add-configuration-parameters)
