---
title: Business-to-Consumer Testing Complete
sidebarTitle: Testing Complete
description: Plan testing for a B2C IAM Auth0 launch by covering Universal Login flows, social connections, and the consumer-specific signup configuration each app uses.
redirects:
  - "/docs/architecture-scenarios/b2c/launch/testing"
  - "/docs/architecture-scenarios/implementation/b2c/b2c-launch/b2c-launch-testing"
  - "/docs/architecture-scenarios/b2c/b2c-launch-testing"
---
