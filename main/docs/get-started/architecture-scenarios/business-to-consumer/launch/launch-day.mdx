---
title: Business-to-Consumer Launch Day Preparation
sidebarTitle: Launch Day Preparation
description: Review launch day considerations for a B2C IAM Auth0 implementation, like coordinating cutover and rollback paths across the consumer-facing applications going live.
redirects:
  - "/docs/architecture-scenarios/b2c/launch/launch-day"
  - "/docs/architecture-scenarios/implementation/b2c/b2c-launch/b2c-launch-launch"
  - "/docs/architecture-scenarios/b2c/b2c-launch-launch"
---
...
Your notification plan should include elements such as the target <Tooltip tip="Audience: Unique identifier of the audience for an issued token. Named aud in a token, its value contains the ID of either an application (Client ID) for an ID Token or an API (API Identifier) for an Access Token." cta="View Glossary" href="/docs/glossary?term=audience">audience</Tooltip>, the key takeaways for the audience, the message content, the plans for distributing the notification and how to test the messaging.
