---
title: Business-to-Consumer Compliance Readiness
sidebarTitle: Compliance Readiness
description: Compliance checks to perform before launch of your B2C IAM implementation.
redirects:
  - "/docs/architecture-scenarios/b2c/launch/compliance-readiness"
  - "/docs/architecture-scenarios/implementation/b2c/b2c-launch/b2c-launch-compliance"
  - "/docs/architecture-scenarios/b2c/b2c-launch-compliance"
---
