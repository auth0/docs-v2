---
title: Business-to-Consumer Support Readiness
sidebarTitle: Support Readiness
description: Get support ready for a B2C IAM Auth0 launch by training agents and preparing the escalation paths and diagnostic playbooks end-user issues will need.
redirects:
  - "/docs/architecture-scenarios/b2c/launch/support-readiness"
  - "/docs/architecture-scenarios/implementation/b2c/b2c-launch/b2c-launch-support"
  - "/docs/architecture-scenarios/b2c/b2c-launch-support"
---
