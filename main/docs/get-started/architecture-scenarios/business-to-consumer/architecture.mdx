---
description: Learn how to configure your Auth0 <Tooltip tip="A logically-isolated group of users who share common access with specific privileges to a single software instance." cta="View Glossary" href="/docs/glossary?term=Tenant">tenant</Tooltip> architecture affects your Business to Consumer (B2C) Identity and Access Management (IAM) implementation.
