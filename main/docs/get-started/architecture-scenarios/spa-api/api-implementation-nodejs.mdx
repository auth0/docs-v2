...
The first thing we need to do is to write a rule which will add the email address of the user to the Access Token. Go to the [Rules section](https://manage.auth0.com/#/rules}) of the Dashboard and click on the **Create Rule** button.
