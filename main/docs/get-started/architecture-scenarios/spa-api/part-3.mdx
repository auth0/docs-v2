...
To authorize the user we will be using the [auth0.js library](/docs/libraries/auth0-single-page-app-sdk). You can initialize a new instance of the Auth0 application as follows:
