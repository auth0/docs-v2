---
description: The Angular 2 implementation of the SPA for the SPA + API architecture
  scenario
'og:image': https://cdn2.auth0.com/docs/1.14553.0/img/share-image.png
'og:title': SPA Angular 2 Implementation (SPAs + API)
...
'twitter:description': The Angular 2 implementation of the SPA for the SPA + API architecture
  scenario
'twitter:title': SPA Angular 2 Implementation (SPAs + API)
---
