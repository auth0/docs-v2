...
redirects:
  - "/docs/architecture-scenarios/multiple-organization-architecture/single-idp-orgs/profile-management"
  - "/docs/architecture-scenarios/multiple-organization-architecture/users-isolated-by-organization/single-identity-provider-organizations/profile-management"
  - "/docs/architecture-scenarios/multiple-organization-architecture/single-identity-provider-organizations/profile-management"
---
