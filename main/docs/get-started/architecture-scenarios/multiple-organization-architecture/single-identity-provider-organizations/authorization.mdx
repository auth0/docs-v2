...
redirects:
  - "/docs/architecture-scenarios/multiple-organization-architecture/single-idp-orgs/authorization"
  - "/docs/architecture-scenarios/multiple-organization-architecture/users-isolated-by-organization/single-identity-provider-organizations/authorization"
  - "/docs/architecture-scenarios/multiple-organization-architecture/single-identity-provider-organizations/authorization"
---
