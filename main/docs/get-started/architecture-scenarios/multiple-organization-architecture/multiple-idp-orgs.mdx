...
redirects:
  - "/docs/architecture-scenarios/multiple-organization-architecture/multiple-idp-orgs"
  - "/docs/architecture-scenarios/multiple-organization-architecture/users-isolated-by-organization/multiple-identity-provider-organizations"
  - "/docs/architecture-scenarios/multiple-organization-architecture/multiple-identity-provider-organizations"
---
