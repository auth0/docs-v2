...
We also provide some additional resources:

* A [B2C IAM Project Planning Guide](https://assets.ctfassets.net/cdy7uua7fh8z/3er1aEQ7Ul0q3c9leJWczR/b1f18b4c16abb7e78b01e4eb2b52bb8e/B2C_Project_Planning.pdf) in PDF format that you can download and refer to for details about our recommended strategies.

* Implementation planning s preadsheets that include tasks for each phase of a Software Development Lifecycle (SDLC) project:
