---
'og:description': The Python implementation of the server cron job for the Server
  Client + API architecture scenario
'og:image': https://cdn2.auth0.com/docs-v2/1.14553.0/img/share-image.png
'og:title': 'Server Apps + API: Python Implementation for the Cron Job'
...
'twitter:description': The Python implementation of the server cron job for the Server
  Client + API architecture scenario
'twitter:title': 'Server Apps + API: Python Implementation for the Cron Job'
---
