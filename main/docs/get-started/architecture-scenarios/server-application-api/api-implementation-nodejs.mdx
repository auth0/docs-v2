---
description: The Node.js implementation of the API for the Server Client + API
  architecture scenario
'og:image': https://cdn2.auth0.com/docs/1.14553.0/img/share-image.png
'og:title': 'Server Apps + API: Node.js Implementation for the API'
...
'twitter:title': 'Server Apps + API: Node.js Implementation for the API'
---
...
Create a folder for your API, navigate into it and run `npm init`. This will set up your `package.json` file.
