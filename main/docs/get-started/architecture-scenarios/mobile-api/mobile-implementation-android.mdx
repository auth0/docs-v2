...
redirects:
  - "/docs/architecture-scenarios/mobile-api/mobile-implementation-android"
  - "/docs/architecture-scenarios/application/mobile-api/mobile-implementation-android"
---
...
[Download](./timesheets-mobile_android.zip)
