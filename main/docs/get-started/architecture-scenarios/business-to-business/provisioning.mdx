---
title: Business-to-Business Provisioning
sidebarTitle: Provisioning
description: User provisioning functionality and considerations for your B2B IAM implementation.
redirects:
  - "/docs/architecture-scenarios/b2b/provisioning"
  - "/docs/architecture-scenarios/implementation/b2b/b2b-provisioning"
  - "/docs/architecture-scenarios/b2b/b2b-provisioning"
---
