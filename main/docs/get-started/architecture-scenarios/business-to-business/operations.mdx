---
title: Business-to-Business Operations
sidebarTitle: Operations
description: Operationalize your Auth0 B2B tenants for production by configuring email providers, monitoring, log streaming, and Auth0 notifications, and by provisioning new customer Organizations and self-service IdP protals for business continuity.
redirects:
  - "/docs/architecture-scenarios/b2b/operations"
  - "/docs/architecture-scenarios/implementation/b2b/b2b-operations"
  - "/docs/architecture-scenarios/b2b/b2b-operations"
---
