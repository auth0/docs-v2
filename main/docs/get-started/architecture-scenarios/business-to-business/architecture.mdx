---
title: Business-to-Business Architecture
sidebarTitle: Architecture
description: How you configure your Auth0 tenant architecture affects your B2B IAM implementation.
redirects:
  - "/docs/architecture-scenarios/b2b/architecture"
  - "/docs/architecture-scenarios/implementation/b2b/b2b-architecture"
  - "/docs/architecture-scenarios/b2b/b2b-architecture"
---
