...
redirects:
  - "/docs/architecture-scenarios/b2b/profile-management"
  - "/docs/architecture-scenarios/implementation/b2b/b2b-profile-mgmt"
  - "/docs/architecture-scenarios/b2b/b2b-profile-mgmt"
---
