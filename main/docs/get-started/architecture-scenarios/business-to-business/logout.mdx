---
title: Business-to-Business Logout
sidebarTitle: Logout
description: Design logout for your Auth0 B2B application, deciding which local, Auth0, and Organization IdP sessions to terminate and how to implement single logout, federated logout, and post-logout redirects across multiple applications.
redirects:
  - "/docs/architecture-scenarios/b2b/logout"
  - "/docs/architecture-scenarios/implementation/b2b/b2b-logout"
  - "/docs/architecture-scenarios/b2b/b2b-logout"
---
