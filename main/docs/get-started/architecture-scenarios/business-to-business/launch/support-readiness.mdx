---
description: Prepare your support team for an Auth0 B2B launch by reviewing necessary operational policied before customers go-live.
title: Support Readiness (B2B)
redirects:
  - "/docs/architecture-scenarios/b2b/launch/support-readiness"
  - "/docs/architecture-scenarios/implementation/b2b/b2b-launch/b2b-launch-support"
  - "/docs/architecture-scenarios/b2b/b2b-launch-support"
---
