...
redirects:
  - "/docs/architecture-scenarios/b2b/launch/compliance-readiness"
  - "/docs/architecture-scenarios/implementation/b2b/b2b-launch/b2b-launch-compliance"
  - "/docs/architecture-scenarios/b2b/b2b-launch-compliance"
---
