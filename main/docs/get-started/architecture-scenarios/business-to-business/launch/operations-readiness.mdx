...
redirects:
  - "/docs/architecture-scenarios/b2b/launch/operations-readiness"
  - "/docs/architecture-scenarios/implementation/b2b/b2b-launch/b2b-launch-operations"
  - "/docs/architecture-scenarios/b2b/b2b-launch-operations"
---
## Status
