---
title: Business-to-Business Branding
...
redirects:
  - "/docs/architecture-scenarios/b2b/branding"
  - "/docs/architecture-scenarios/implementation/b2b/b2b-branding"
  - "/docs/architecture-scenarios/b2b/b2b-branding"
---
