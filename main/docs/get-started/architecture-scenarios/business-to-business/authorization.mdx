---
title: Business-to-Business Authorization
...
redirects:
  - "/docs/architecture-scenarios/b2b/authorization"
  - "/docs/architecture-scenarios/implementation/b2b/b2b-authorization"
  - "/docs/architecture-scenarios/b2b/b2b-authorization"
---
