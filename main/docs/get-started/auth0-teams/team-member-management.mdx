...
Members with this team-level role can perform delegated tenant management tasks like create tenants, manage tenant members, and delete tenants without requiring full Team Owner access. For a full review of  Team's roles, review the [role comparison](#role-comparison) table for a detailed breakdown of permissions.
...
| :--- | :---: | :---: | :---: | :---: |
| Create tenant | ✓ | ✓ | ✗ | ✗ |
| Delete tenant <Callout icon="file-lines" color="#0EA5E9" iconType="regular">Tenant Managers must also be assigned Tenant Admin role to delete a tenant.</Callout> | ✓ | ✓ | ✗ | ✗ |
