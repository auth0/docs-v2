...
Members with this team-level role can perform delegated tenant management tasks — such as creating tenants, managing tenant members, and deleting tenants — without requiring full Team Owner access. Refer to the [Role comparison](#role-comparison) table for a detailed breakdown of permissions.
