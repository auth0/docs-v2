...
The Tenant Manager is a **team-level** role. A Tenant Manager must also hold the [Tenant Admin](/docs/get-started/auth0-teams/tenant-member-management) role on a given tenant to manage its members or delete it.
