---
description: Learn which OAuth 2.0 grant types Auth0 supports for each application type and how to configure them to match your authentication flow.
title: Application Grant Types
redirects:
  - "/docs/configure/applications/application-grant-types"
  - "/docs/applications/application-grant-types"
  - "/docs/applications/concepts/grant-types-legacy"
  - "/docs/applications/concepts/application-grant-types"
  - "/docs/clients/client-grant-types"
  - "/docs/applications/reference/grant-types-auth0-mapping"
  - "/docs/applications/reference/grant-types-available"
---
