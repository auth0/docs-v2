...
redirects:
  - "/docs/get-started/applications/confidential-and-public-applications/view-application-type"
  - "/docs/configure/applications/confidential-public-apps/view-application-type"
  - "/docs/applications/view-application-type"
  - "/docs/dashboard/guides/applications/view-app-type-confidential-public"
  - "/docs/configure/applications/confidential-public-apps"
  - "/docs/applications/confidential-and-public-applications"
  - "/docs/applications/concepts/app-types-confidential-public"
---
