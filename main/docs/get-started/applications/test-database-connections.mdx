...
redirects:
  - "/docs/configure/applications/test-database-connections"
  - "/docs/dashboard/guides/connections/test-connections-database"
  - "/docs/get-started/dashboard/test-database-connections"
---
