...
redirects:
  - "/docs/configure/applications/update-grant-types"
  - "/docs/applications/update-grant-types"
  - "/docs/dashboard/guides/applications/update-grant-types"
  - "/docs/api/management/guides/applications/update-grant-types"
  - "/docs/api-auth/config/using-the-management-api"
  - "/docs/api-auth/config/using-the-auth0-dashboard"
---
...
| `MGMT_API_ACCESS_TOKEN` | [Access Tokens for the Management API](https://auth0.com/docs/api/management/v2/tokens) with the scope `update:clients`. |
