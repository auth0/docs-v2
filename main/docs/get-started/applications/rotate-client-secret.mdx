...
redirects:
  - "/docs/applications/how-to-rotate-client-secret"
  - "/docs/applications/how-to-rotate-application-secret"
  - "/docs/configure/applications/rotate-client-secret"
  - "/docs/applications/rotate-client-secret"
  - "/docs/get-started/dashboard/rotate-client-secret"
  - "/docs/api/management/guides/applications/rotate-client-secret"
  - "/docs/dashboard/guides/applications/rotate-client-secret"
  - "/docs/get-started/applications/how-to-rotate-application-secret"
---
