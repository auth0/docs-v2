...
redirects:
  - "/docs/configure/applications/enable-universal-links-support-in-apple-xcode"
  - "/docs/applications/enable-universal-links-support-in-apple-xcode"
  - "/docs/enable-universal-links-support-in-apple-xcode"
  - "/docs/applications/guides/enable-universal-links-dashboard"
  - "/docs/applications/enable-universal-links"
  - "/docs/clients/enable-universal-links"
  - "/docs/dashboard/guides/applications/enable-universal-links"
---
