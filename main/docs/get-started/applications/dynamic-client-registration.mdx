...
DCR clients need [default permissions for third-party applications](/docs/get-started/applications/application-access-to-apis-client-grants#default-permissions-for-third-party-applications) configured before they can access any APIs. Before enabling DCR, [configure default API permissions for third-party applications](/docs/get-started/applications/third-party-applications/configure-third-party-applications#default-permissions-for-all-third-party-applications). Without them, dynamically registered clients cannot access any APIs.
