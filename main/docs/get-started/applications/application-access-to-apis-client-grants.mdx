...
4. Select **Grant Access** to authorize **User-Delegated Access**, **Client Access**, or both.

<Callout icon="file-lines" color="#0EA5E9" iconType="regular">
For application-level authorization settings to take effect, you must set the API Access Policy to **Per-app authorization**. To learn more, read [API Access Policies for Applications](/docs/get-started/apis/api-access-policies-for-applications).
</Callout>

5. Select the API you want to configure the application access policy for. Then, select the **Settings** tab and scroll down to **Application Access Policy**. 
