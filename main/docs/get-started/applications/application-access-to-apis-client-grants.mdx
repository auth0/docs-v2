...
description: Manage which applications can access your APIs and what permissions they hold using client grants for both user-delegated and machine-to-machine flows.
