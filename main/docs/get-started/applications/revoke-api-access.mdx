...
redirects:
  - "/docs/configure/applications/revoke-api-access"
  - "/docs/authorization/revoke-api-access"
  - "/docs/blacklists-vs-application-grants"
  - "/docs/api-auth/blacklists-vs-grants"
  - "/docs/authorization/revoke-access-to-apis-using-blacklists-or-application-grants"
---
