...
* **Organizations**: Third-party applications support [Organizations](/docs/manage-users/organizations) for both user flows and machine-to-machine access. User flows require the organization to opt in. To learn more, read [Configure Organizations access](/docs/get-started/applications/third-party-applications/configure-third-party-applications#configure-organizations-access).
...
- **Cross App Access (XAA)**: A workforce application in another organization's tenant accesses your APIs through a trust relationship, where the requesting application is modeled as a third-party application in your tenant. To learn more, read [Cross App Access](/docs/ai-agents-mcp/cross-app-access).
...
### Step 5 (optional): Enable for Organizations

If your application authenticates users in an organizational context or accesses APIs on behalf of an organization, enable third-party access on each organization. To learn more, read [Enable Third-Party Application Access for an Organization](/docs/manage-users/organizations/configure-organizations/enable-third-party-application-access).
