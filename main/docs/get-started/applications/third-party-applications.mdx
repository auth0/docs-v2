...
* **Connections**: Third-party applications can only authenticate users through domain-level connections. To learn more, read [Configure Third-Party Applications](/docs/get-started/applications/third-party-applications/configure-third-party-applications).
