...
description: Configure a FAPI 1 or FAPI 2.0 compliance level for your Auth0 application to enforce stricter security requirements for financial-grade API scenarios.
---
