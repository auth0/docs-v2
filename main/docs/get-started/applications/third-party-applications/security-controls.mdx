...
| **`/userinfo` endpoint** | Not supported. Planned for a future release. |
| **Auth0 system APIs** (Management API, My Account API, MFA API) | Not supported. Third-party applications cannot access system APIs in user flows. |
