...
{/* TODO: Screenshot — org-scoped consent dialog showing the Organization context to the user */}
...
{/* TODO: Screenshot — same user, same application, different Organization (paired with the screenshot above to demonstrate per-org consent) */}
