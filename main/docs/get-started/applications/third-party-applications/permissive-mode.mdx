...
Auth0 recommends adopting enhanced security controls for all new third-party applications. To learn how to migrate a third-party application from permissive to enhanced security controls, read [Migrate to Enhanced Security Controls for Third-Party Applications](/docs/troubleshoot/product-lifecycle/deprecations-and-migrations/migrate-to-enhanced-security-third-party-applications).
