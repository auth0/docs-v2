...
description: "Learn about permissive mode for third-party applications and how it differs from the default strict security controls."
---
...
|---|---|---|
| **Grant types** | `authorization_code`, `refresh_token`, `client_credentials` | Most grant types (except `password`) |
