...
redirects:
  - "/docs/configure/applications/change-application-signing-algorithms"
  - "/docs/applications/change-application-signing-algorithms"
  - "/docs/tokens/guides/update-signing-algorithm-application"
  - "/docs/dashboard/guides/applications/update-signing-algorithm"
---
