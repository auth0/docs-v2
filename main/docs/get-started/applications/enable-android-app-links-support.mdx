...
redirects:
  - "/docs/configure/applications/enable-android-app-links-support"
  - "/docs/applications/enable-android-app-links-support"
  - "/docs/applications/guides/enable-android-app-links-dashboard"
  - "/docs/applications/enable-android-app-links"
  - "/docs/clients/enable-android-app-links"
  - "/docs/dashboard/guides/applications/enable-android-app-links"
---
...
To learn more about testing your app link, read [Verify Android App Links](https://developer.android.com/training/app-links/verify-applinks) at https://developer.android.com.
