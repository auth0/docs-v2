...
For [browsers that are supported](#browser-testing-support), you can use the `crossOriginVerification` method from the [Auth0.js SDK](/docs/libraries/auth0-single-page-app-sdk) in your application on a dedicated page to handle cases when third-party cookies are disabled.
...
1. Create a page in your application that instantiates `WebAuth` from [Auth0.js](/docs/libraries/auth0-single-page-app-sdk). Call `crossOriginVerification` immediately. The name of the page is up to you.
