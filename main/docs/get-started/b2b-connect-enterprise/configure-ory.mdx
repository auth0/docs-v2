...
After the setup wizard completes, you need to select the integration you just created and copy values from the **Settings** tab for you Ory configuration. You need to copy the:
