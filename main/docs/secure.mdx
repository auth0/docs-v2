---
description: Learn about various security-related issues, such as handling tokens, preventing security attacks, AllowListing, and data privacy.
title: Secure
redirects:
  - "/docs/security"
  - "/docs/secure/mdl-verification/*"
---
...
Learn basic tips to secure data and accounts.
