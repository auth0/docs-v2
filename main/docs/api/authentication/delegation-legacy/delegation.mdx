---
title: "Delegation"
description: "Deprecated endpoint that generates a delegation token to flow user identity from an application to an API add-on."
redirects:
  - "/docs/api/authentication/delegation"
