...
description: "Deprecated endpoint that validates a JWT and returns the associated user profile; use /userinfo instead."
redirects:
  - "/docs/api/authentication/get-token-info"
