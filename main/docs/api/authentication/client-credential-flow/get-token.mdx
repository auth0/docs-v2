...
When the application exchanging the authorization code is linked to an agent and agent subject claims are enabled for the target API, the issued access token identifies the agent as the subject:
