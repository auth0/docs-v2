...
description: "Deprecated active authentication endpoint for database, AD, and LDAP connections; use the Resource Owner Password grant instead."
redirects:
  - "/docs/api/authentication/database-ad-lapd-active"
---
