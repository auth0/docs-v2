...
description: "Send authorization parameters via a secure backend POST request to protect sensitive values from browser exposure."
redirects:
  - "/docs/api/authentication/push-authorization-requests"
