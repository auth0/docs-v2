...
description: "Exchange an authorization code for an access token after the user is redirected back to your callback."
redirects:
  - "/docs/api/authentication/exchange-authorization-code-for-token"
---
