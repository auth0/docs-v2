...
description: "Send an authentication request directly to a user’s enrolled device using the CIBA back-channel login flow."
redirects:
  - "/docs/api/authentication/start-back-channel-login"
