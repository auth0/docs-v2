...
description: "Poll the token endpoint to check the status of a pending Back-Channel Login request."
redirects:
  - "/docs/api/authentication/check-back-channel-login-status"
---
