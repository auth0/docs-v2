---
title: "Get Token"
description: "Exchange an Authorization Code for a token as the final step of the Authorization Code Flow with PKCE."
redirects:
  - "/docs/api/authentication/get-token-pkce"
---
