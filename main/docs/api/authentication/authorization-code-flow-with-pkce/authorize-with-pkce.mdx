---
title: "Authorize"
description: "Initiate the Authorization Code Flow with PKCE, the recommended OAuth 2.0 grant for mobile and single-page applications."
redirects:
  - "/docs/api/authentication/authorize-with-pkce"
---
