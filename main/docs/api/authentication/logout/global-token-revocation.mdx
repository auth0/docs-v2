...
description: "Revoke session cookies and refresh tokens for a user across all applications via Okta's Universal Logout."
redirects:
  - "/docs/api/authentication/global-token-revocation"
---
