...
redirects:
  - "/docs/manage-users/user-search/view-search-results-by-page"
  - "/docs/users/user-search/view-search-results-by-page"
  - "/docs/users/search/v3/view-search-results-by-page"
  - "/docs/api/management"
  - "/docs/api/v2"
  - "/docs/apiv2"
  - "/docs/api/management/v2/blacklists/post-tokens"
  - "/docs/api/management/v2/blacklists/get-tokens"
---
