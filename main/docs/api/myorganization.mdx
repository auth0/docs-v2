...
description: "Use the My Organization API to let Auth0 Organization admins manage their own identity providers and verified domains from inside your application.Use the My Organization API to let Auth0 Organization admins manage their own identity providers and verified domains from inside your application."
---
...
* Your business customers can retrieve Organization details or configure Identity Providers (IdPs) on behalf of their own Organizations.
