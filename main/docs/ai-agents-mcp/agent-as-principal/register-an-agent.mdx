...
| `client_id` | No | [Associate an existing client](/docs/ai-agents-mcp/agent-as-principal/associate-agent-client) on agent creation. |
...
- [Associate agent with a client](/docs/ai-agents-mcp/agent-as-principal/associate-agent-client) to issue tokens with agent identity
