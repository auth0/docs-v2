...
[XAA.dev](https://xaa.dev/) is our online sandbox environment for testing Cross App Access in your browser. 

1. Navigate to [XAA.dev](https://xaa.dev/):
  - Under **I have a...**, select **Resource App**.
  - Under **... and I want to**, select **Test it against a hosted Requesting App**.
  - Under **using...**, select ***OIDC** or **SAML**.
2. Select **Take me there**.
3. Enter your email to unlock the sandbox environment.
4. Under **Set up your app and credentials**:
  - 
