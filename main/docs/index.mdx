...
<div id="footer" class="mint-flex mint-flex-col mint-items-center mint-mx-auto mint-border-t mint-border-gray-100 dark:mint-border-gray-800/50 mint-w-full">
        ...
        <div class="mint-gap-4 mint-min-w-[140px] mint-max-w-[492px] mint-flex-wrap mint-h-fit mint-flex mint-justify-end md:mint-justify-start">
          ...
          >
            ...
            <svg
              ...
              style={{ maskImage: "url('https://d3gk2c5xim1je2.cloudfront.net/v7.1.0/brands/x-twitter.svg')", maskRepeat: "no-repeat", maskPosition: "center center", backgroundColor: "rgb(121, 121, 121)", width: "16px", height: "16px", display: "inline-block", verticalAlign: "middle" }}
            ></svg>
          </a>
          <a
          ...
          >
            ...
            <svg
              class="icon inline mint-w-5 mint-h-5 mint-text-gray-500 dark:mint-text-gray-600 hover:mint-text-gray-600 dark:hover:mint-text-gray-500"
              style={{ maskImage: "url('https://d3gk2c5xim1je2.cloudfront.net/v7.1.0/brands/github.svg')", maskRepeat: "no-repeat", maskPosition: "center center", backgroundColor: "rgb(121, 121, 121)", width: "16px", height: "16px", display: "inline-block", verticalAlign: "middle" }}
            ></svg>
          </a>
          <a
          ...
          >
            ...
            <svg
              class="icon inline mint-w-5 mint-h-5 mint-text-gray-500 dark:mint-text-gray-600 hover:mint-text-gray-600 dark:hover:mint-text-gray-500"
              style={{ maskImage: "url('https://d3gk2c5xim1je2.cloudfront.net/v7.1.0/brands/linkedin.svg')", maskRepeat: "no-repeat", maskPosition: "center center", backgroundColor: "rgb(121, 121, 121)", width: "16px", height: "16px", display: "inline-block", verticalAlign: "middle" }}
            ></svg>
          </a>
        </div>
      </div>
      <div class="mint-flex mint-flex-col sm:mint-grid max-md:!mint-grid-cols-2 mint-gap-8 mint-flex-1" style={{ gridTemplateColumns: "repeat(4, minmax(0px, 1fr))" }}>
