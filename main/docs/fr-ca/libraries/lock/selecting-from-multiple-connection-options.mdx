...
## Lock et plusieurs connexions {#lock-and-multiple-connections}
...
## Utilisation des domaines de courriel avec les connexions d’entreprise {#using-email-domains-with-enterprise-connections}
...
## Sélection parmi plusieurs connexions de base de données {#selecting-among-multiple-database-connections}
...
## Filtrer les connexions disponibles par programmation {#filtering-available-connections-programmatically}
...
## Envoi de l’information de realm à partir de l’application {#sending-realm-information-from-the-application}
