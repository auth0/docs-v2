...
<td>Lorsque vous utilisez `Auth0LockPasswordless` avec une connexion courriel, vous pouvez utiliser cette option pour choisir entre l’envoi d’un <a href="/docs/fr-ca/authenticate/passwordless/spa-email-code">code</a> ou un <a href="/docs/fr-ca/authenticate/passwordless/spa-email-link">magic link</a> pour authentifier l’utilisateur</td>
</tr>
</tbody>
</table>
