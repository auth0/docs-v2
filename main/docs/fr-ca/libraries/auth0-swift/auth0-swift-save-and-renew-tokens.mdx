...
### Vérification des identifiants {#credentials-check}
...
### Récupération des identifiants de l’utilisateur {#retrieving-user-credentials}
...
## Méthode alternative - SimpleKeychain {#alternative-method-simplekeychain}
...
### Renouvellement des identifiants de l’utilisateur {#renewing-user-credentials}
