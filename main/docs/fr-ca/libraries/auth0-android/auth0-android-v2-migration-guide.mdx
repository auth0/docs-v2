...
## [](https://github.com/auth0/Auth0.Android/blob/v2-dev/V2_MIGRATION_GUIDE.md#requirements-changes)Modifications apportées aux exigences
...
## [](https://github.com/auth0/Auth0.Android/blob/v2-dev/V2_MIGRATION_GUIDE.md#oidc-only)Open ID Connect uniquement
...
## [](https://github.com/auth0/Auth0.Android/blob/v2-dev/V2_MIGRATION_GUIDE.md#authorization-code-with-pkce)Code d’autorisation avec PKCE
...
## [](https://github.com/auth0/Auth0.Android/blob/v2-dev/V2_MIGRATION_GUIDE.md#removal-of-webview-support)Retrait de la prise en charge WebView
...
## [](https://github.com/auth0/Auth0.Android/blob/v2-dev/V2_MIGRATION_GUIDE.md#removal-of-legacy-authentication-api-support)Retrait de la prise en charge des anciennes Authentication API
...
## [](https://github.com/auth0/Auth0.Android/blob/v2-dev/V2_MIGRATION_GUIDE.md#request-interfaces-changes)Changements apportés aux interfaces de requêtes
...
## [](https://github.com/auth0/Auth0.Android/blob/v2-dev/V2_MIGRATION_GUIDE.md#networking-client-customization)Personnalisation des clients de réseau
...
### [](https://github.com/auth0/Auth0.Android/blob/v2-dev/V2_MIGRATION_GUIDE.md#timeout-configuration)Configuration du délai d’expiration



### [](https://github.com/auth0/Auth0.Android/blob/v2-dev/V2_MIGRATION_GUIDE.md#logging-configuration)Configuration de la journalisation



## [](https://github.com/auth0/Auth0.Android/blob/v2-dev/V2_MIGRATION_GUIDE.md#detailed-change-listing)Liste détaillée des modifications

### [](https://github.com/auth0/Auth0.Android/blob/v2-dev/V2_MIGRATION_GUIDE.md#files-that-changed-their-package)Fichiers qui ont modifié leur package
...
### [](https://github.com/auth0/Auth0.Android/blob/v2-dev/V2_MIGRATION_GUIDE.md#internal-package)Package interne
...
### [](https://github.com/auth0/Auth0.Android/blob/v2-dev/V2_MIGRATION_GUIDE.md#classes-and-interfaces-removed)Classes et interfaces retirées
...
### [](https://github.com/auth0/Auth0.Android/blob/v2-dev/V2_MIGRATION_GUIDE.md#constants-removed)Constantes retirées
...
### [](https://github.com/auth0/Auth0.Android/blob/v2-dev/V2_MIGRATION_GUIDE.md#classes-and-interfaces-changed)Classes et interfaces modifiées
...
### [](https://github.com/auth0/Auth0.Android/blob/v2-dev/V2_MIGRATION_GUIDE.md#constructors-changed)Constructeurs modifiés
...
### [](https://github.com/auth0/Auth0.Android/blob/v2-dev/V2_MIGRATION_GUIDE.md#methods-removed-or-changed)Méthodes retirées ou modifiées

#### [](https://github.com/auth0/Auth0.Android/blob/v2-dev/V2_MIGRATION_GUIDE.md#auth0-methods-removed)Méthodes `Auth0` retirées
...
#### [](https://github.com/auth0/Auth0.Android/blob/v2-dev/V2_MIGRATION_GUIDE.md#authenticationapiclient-methods-removed-or-changed)Méthodes`AuthenticationAPIClient` retirées ou modifiées
...
#### [](https://github.com/auth0/Auth0.Android/blob/v2-dev/V2_MIGRATION_GUIDE.md#authenticationrequest-methods-removed)Méthodes `AuthenticationRequest` retirées
...
#### [](https://github.com/auth0/Auth0.Android/blob/v2-dev/V2_MIGRATION_GUIDE.md#webauthproviderbuilder-methods-removed)Méthodes `WebAuthProvider.Builder` retirées
...
#### [](https://github.com/auth0/Auth0.Android/blob/v2-dev/V2_MIGRATION_GUIDE.md#webauthproviderlogoutbuilder-methods-removed)Méthodes `WebAuthProvider.LogoutBuilder` retirées
...
#### [](https://github.com/auth0/Auth0.Android/blob/v2-dev/V2_MIGRATION_GUIDE.md#webauthprovider-methods-removed)Méthodes `WebAuthProvider` retirées
...
#### [](https://github.com/auth0/Auth0.Android/blob/v2-dev/V2_MIGRATION_GUIDE.md#parameterbuilder-methods-removed)Méthodes `ParameterBuilder` retirées

* `setDevice("{DEVICE}")` a été retirée. Utilisez plutôt `set("device", "{VALUE}")`.

#### [](https://github.com/auth0/Auth0.Android/blob/v2-dev/V2_MIGRATION_GUIDE.md#usersapiclient-methods-changed)Les méthodes `UsersAPIClient` ont été modifiées
...
#### [](https://github.com/auth0/Auth0.Android/blob/v2-dev/V2_MIGRATION_GUIDE.md#requestfactory-methods-removed-or-changed)Les méthodes `RequestFactory` ont été retirées ou modifiées
...
#### [](https://github.com/auth0/Auth0.Android/blob/v2-dev/V2_MIGRATION_GUIDE.md#profilerequest-methods-changed)Les méthodes `ProfileRequest` ont été modifiées
...
#### [](https://github.com/auth0/Auth0.Android/blob/v2-dev/V2_MIGRATION_GUIDE.md#signuprequest-methods-changed)Les méthodes `SignUpRequest` ont été modifiées
