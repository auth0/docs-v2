...
## Installation de Lock {#lock-installation}
...
### Sources d’installation {#installation-sources}
...
### Regrouper les dépendances {#bundling-dependencies}
...
### Authentification inter-origine {#cross-origin-authentication}
...
### Étape 1. Initialisation de Lock {#step-1-initializing-lock}
...
### Étape 2. Authentifier l’utilisateur et obtenir ses renseignements {#step-2-authenticating-and-getting-user-info}
...
### Étape 3. Afficher Lock {#step-3-showing-lock}
...
### Options du mode sans mot de passe {#passwordless-options}
...
### Exemple d’utilisation de Passwordless {#passwordless-example}
...
### Single Sign-On avec authentification intégrée {#single-sign-on-with-embedded-authentication}
