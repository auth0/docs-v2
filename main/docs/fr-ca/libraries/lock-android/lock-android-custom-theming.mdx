...
## Liste des attributs pris en charge {#supported-attributes-list}
...
## Créer un nouveau fichier de ressources {#create-a-new-resource-file}
...
## Boutons de connexion OAuth personnalisés {#custom-oauth-connection-buttons}
