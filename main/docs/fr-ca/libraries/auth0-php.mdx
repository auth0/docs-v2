...
4. Cliquez sur l’onglet **Paramètres** pour obtenir les informations d’identification requises utilisées ci-dessous. Pour en savoir plus, voir [Paramètres de l’application](/applications/application-settings).
