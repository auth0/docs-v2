...
description: "Décrit tous les hooks et toutes les méthodes offerts pour personnaliser l’écran `mfa-recovery-code-challenge` d’Universal Login."
---

L’écran `mfa-recovery-code-challenge` invite l’utilisateur à saisir son code de récupération pour vérifier son identité lorsque les autres méthodes AMF ne sont pas disponibles.
...
* L’importation à la racine vous permet de charger tous les écrans à partir d’un seul bundle, ce qui est utile si vous voulez une compilation unifiée capable de prendre en charge tous les écrans possibles.
...
Hooks propres à l’écran qui fournissent un accès en lecture seule aux données de contexte Auth0 sur l’écran `mfa-recovery-code-challenge`. Importez-les depuis `@auth0/auth0-acul-react/mfa-recovery-code-challenge`.
...
<ParamField body="useTransaction" type={<span>() =&gt; <a href="/docs/fr-ca/libraries/acul/react-sdk/API-Reference/Types/interfaces/TransactionMembers">TransactionMembers</a></span>}>
  Ce hook fournit des données propres à la transaction pour l’écran `mfa-recovery-code-challenge`, comme l’état actuel du flux AMF.
...
<ParamField body="useUser" type={<span>() =&gt; <a href="/docs/fr-ca/libraries/acul/react-sdk/API-Reference/Types/interfaces/UserMembers">UserMembers</a></span>}>
  Ce hook fournit des renseignements sur l’utilisateur actuel, notamment `username`, `email` et les méthodes d’authentification disponibles.
...
<ParamField body="useMfaRecoveryCodeChallenge" type={<a href="/docs/fr-ca/libraries/acul/react-sdk/API-Reference/Types/interfaces/MfaRecoveryCodeChallengeMembers">MfaRecoveryCodeChallengeMembers</a>}>
  Ce hook renvoie toutes les méthodes et le contexte disponibles pour l’écran `mfa-recovery-code-challenge`.
</ParamField>

## Méthodes {#methods}

<ParamField body="continueMethod" type="Promise<void>">
  Cette méthode envoie le code de récupération de l’utilisateur pour terminer la vérification AMF.
...
<ParamField body={<a href="/docs/fr-ca/libraries/acul/react-sdk/API-Reference/Hooks/useAuth0Themes">useAuth0Themes</a>} type="Hooks">
  Ce hook permet d’obtenir les options du thème actuel avec une configuration à plat à partir du contexte de l’image de marque.
</ParamField>
...
<ParamField body={<a href="/docs/fr-ca/libraries/acul/react-sdk/API-Reference/Hooks/useErrors">useErrors</a>} type="Hooks">
  Ce hook permet de lire et de gérer les erreurs côté serveur, côté client et du développeur à l’écran.
</ParamField>