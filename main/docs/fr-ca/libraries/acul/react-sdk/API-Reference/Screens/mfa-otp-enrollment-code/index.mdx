...
description: "Décrit tous les hooks et toutes les méthodes disponibles pour personnaliser l’écran `mfa-otp-enrollment-code` dans Universal Login."
---

L’écran `mfa-otp-enrollment-code` invite l’utilisateur à saisir un code de vérification pour terminer l’enrôlement OTP de son application d’authentification.
...
<ParamField body="useBranding" type={<span>() =&gt; <a href="/docs/fr-ca/libraries/acul/react-sdk/API-Reference/Types/interfaces/BrandingMembers">BrandingMembers</a></span>}>
  Ce hook fournit les configurations d’image de marque, comme le logo, les couleurs et les paramètres de thème affichés sur l’écran `mfa-otp-enrollment-code`.
...
<ParamField body="useMfaOtpEnrollmentCode" type={<a href="/docs/fr-ca/libraries/acul/react-sdk/API-Reference/Types/interfaces/MfaOtpEnrollmentCodeMembers">MfaOtpEnrollmentCodeMembers</a>}>
  Ce hook renvoie toutes les méthodes et le contexte disponibles dans l’écran `mfa-otp-enrollment-code`.
</ParamField>

## Méthodes {#methods}

<ParamField body="continueMethod" type="Promise<void>">
  Cette méthode envoie le code OTP saisi par l’utilisateur pour finaliser l’enrôlement.
...
<ParamField body="toggleView" type="Promise<void>">
  Cette méthode bascule la vue dans l’écran `mfa-otp-enrollment-code`, par exemple pour passer de la vue du code QR à la vue de saisie manuelle.
