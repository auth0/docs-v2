...
description: "Décrit tous les hooks et toutes les méthodes disponibles pour personnaliser l’écran Universal Login `reset-password-mfa-webauthn-roaming-challenge`."
---

L’écran `reset-password-mfa-webauthn-roaming-challenge` s’affiche pendant le processus de réinitialisation du mot de passe lorsqu’une authentification multifacteur au moyen d’une clé de sécurité itinérante est requise. Il invite l’utilisateur à s’authentifier à l’aide de sa clé de sécurité matérielle externe afin de poursuivre le processus de réinitialisation.

<Frame>
  <img style={{maxHeight:"400px"}} src="/docs/images/cdy7uua7fh8z/oisvWlYTRgpQ030322WZk/23921a030cdb6f1cf7b147da5315ea8e/Screenshot_2025-05-28_at_13.12.43.png" alt="ACUL défi WebAuthn itinérant MFA de réinitialisation du mot de passe" />
</Frame>
...
Hooks associés à l’écran qui fournissent un accès en lecture seule aux données de contexte Auth0 sur l’écran `reset-password-mfa-webauthn-roaming-challenge`. Importez-les depuis `@auth0/auth0-acul-react/reset-password-mfa-webauthn-roaming-challenge`.
...
<ParamField body="useBranding" type={<span>() =&gt; <a href="/docs/fr-ca/libraries/acul/react-sdk/API-Reference/Types/interfaces/BrandingMembers">BrandingMembers</a></span>}>
  Ce hook fournit des configurations d’image de marque, comme le logo, les couleurs et les paramètres du thème affichés sur l’écran `reset-password-mfa-webauthn-roaming-challenge`.
...
<ParamField body="useUser" type={<span>() =&gt; <a href="/docs/fr-ca/libraries/acul/react-sdk/API-Reference/Types/interfaces/UserMembers">UserMembers</a></span>}>
  Ce hook fournit les détails de l’utilisateur actif, notamment le `username`, l’`email` et les méthodes d’authentication disponibles.
...
<ParamField body="showError" type="Promise<void>">
  Cette méthode signale à Auth0 une erreur de navigateur WebAuthn lorsque le défi par clé de sécurité échoue sur l’appareil de l’utilisateur.
  ...
  **Paramètres de la méthode**
  ...
  <Expandable title="Paramètres">
    ...
    <ParamField body="rememberDevice?" type="boolean">
      Si `true` et si `screen.showRememberDevice` est aussi `true`, l’AMF est ignorée lors des prochaines connexions à partir du navigateur actuel.
    </ParamField>
...
<ParamField body="tryAnotherMethod" type="Promise<void>">
  Cette méthode redirige l’utilisateur vers la sélection d’une autre méthode d’AMF.
...
<ParamField body="useSecurityKey" type="Promise<void>">
  Cette méthode lance le défi par clé de sécurité itinérante pour poursuivre l’AMF du processus de réinitialisation du mot de passe.
