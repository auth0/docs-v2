...
description: "Décrit tous les hooks et toutes les méthodes permettant de personnaliser l’écran `mfa-webauthn-change-key-nickname` d’Universal Login."
---

L’écran `mfa-webauthn-change-key-nickname` permet à l’utilisateur de définir ou de mettre à jour le nom d’affichage d’une clé de sécurité WebAuthn inscrite.
...
Hooks associés à l’écran qui fournissent un accès en lecture seule aux données de contexte Auth0 sur l’écran `mfa-webauthn-change-key-nickname`. Importez-les depuis `@auth0/auth0-acul-react/mfa-webauthn-change-key-nickname`.
...
<ParamField body="useBranding" type={<span>() =&gt; <a href="/docs/fr-ca/libraries/acul/react-sdk/API-Reference/Types/interfaces/BrandingMembers">BrandingMembers</a></span>}>
  Ce hook fournit des configurations d’image de marque, comme le logo, les couleurs et les paramètres de thème affichés sur l’écran `mfa-webauthn-change-key-nickname`.
...
<ParamField body="useScreen" type={<span>() =&gt; <a href="/docs/fr-ca/libraries/acul/react-sdk/API-Reference/Types/interfaces/ScreenMembersOnMfaWebAuthnChangeKeyNickname">ScreenMembersOnMfaWebAuthnChangeKeyNickname</a></span>}>
  Ce hook contient des détails propres à l’écran `mfa-webauthn-change-key-nickname`, y compris sa configuration et son contexte.
...
<ParamField body="useTransaction" type={<span>() =&gt; <a href="/docs/fr-ca/libraries/acul/react-sdk/API-Reference/Types/interfaces/TransactionMembers">TransactionMembers</a></span>}>
  Ce hook fournit des données propres à la transaction pour l’écran `mfa-webauthn-change-key-nickname`, comme l’état actuel du flux AMF.
...
<ParamField body="continueWithNewNickname" type="Promise<void>">
  Cette méthode envoie le nouveau surnom de la clé de sécurité WebAuthn inscrite.
...
<ParamField body={<a href="/docs/fr-ca/libraries/acul/react-sdk/API-Reference/Hooks/useAuth0Themes">useAuth0Themes</a>} type="Hooks">
  Ce hook récupère les options du thème actuel avec la configuration de l’image de marque à plat.
</ParamField>
