...
description: "Décrit tous les hooks et toutes les méthodes offerts pour personnaliser l’écran `brute-force-protection-unblock-success` dans Universal Login."
---

L’écran `brute-force-protection-unblock-success` s’affiche après qu’un utilisateur a débloqué son compte avec succès à la suite d’un verrouillage par Brute Force Protection.
...
<ParamField body="useBranding" type={<span>() =&gt; <a href="/docs/fr-ca/libraries/acul/react-sdk/API-Reference/Types/interfaces/BrandingMembers">BrandingMembers</a></span>}>
  Ce hook fournit des paramètres d’identité de marque, comme le logo, les couleurs et les réglages de thème affichés sur l’écran `brute-force-protection-unblock-success`.
...
<ParamField body="useClient" type={<span>() =&gt; <a href="/docs/fr-ca/libraries/acul/react-sdk/API-Reference/Types/interfaces/ClientMembers">ClientMembers</a></span>}>
  Ce hook fournit des paramètres liés au client, comme `id`, `name` et `logoUrl`, pour l’écran `brute-force-protection-unblock-success`.
...
<ParamField body="useBruteForceProtectionUnblockSuccess" type={<a href="/docs/fr-ca/libraries/acul/react-sdk/API-Reference/Types/interfaces/BruteForceProtectionUnblockSuccessMembers">BruteForceProtectionUnblockSuccessMembers</a>}>
  Ce hook renvoie toutes les méthodes et le contexte disponibles pour l’écran `brute-force-protection-unblock-success`.
</ParamField>
...
<ParamField body={<a href="/docs/fr-ca/libraries/acul/react-sdk/API-Reference/Hooks/useAuth0Themes">useAuth0Themes</a>} type="Hooks">
  Ce hook récupère les options du thème actuel avec une configuration aplatie issue du contexte d’identité de marque.
</ParamField>
