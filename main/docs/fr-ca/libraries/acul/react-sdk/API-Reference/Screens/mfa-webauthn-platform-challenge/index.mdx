...
L’écran `mfa-webauthn-platform-challenge` invite l’utilisateur à effectuer une vérification AMF à l’aide d’un authentificateur de plateforme, comme Touch ID ou Windows Hello, intégré à son appareil.
...
Hooks à portée d’écran qui fournissent un accès en lecture seule aux données de contexte Auth0 sur l’écran `mfa-webauthn-platform-challenge`. Importez-les depuis `@auth0/auth0-acul-react/mfa-webauthn-platform-challenge`.
...
<ParamField body="useBranding" type={<span>() =&gt; <a href="/docs/fr-ca/libraries/acul/react-sdk/API-Reference/Types/interfaces/BrandingMembers">BrandingMembers</a></span>}>
  Ce hook fournit la configuration d’image de marque, comme le logo, les couleurs et les paramètres de thème affichés sur l’écran `mfa-webauthn-platform-challenge`.
...
<ParamField body="useScreen" type={<span>() =&gt; <a href="/docs/fr-ca/libraries/acul/react-sdk/API-Reference/Types/interfaces/ScreenMembersOnMfaWebAuthnPlatformChallenge">ScreenMembersOnMfaWebAuthnPlatformChallenge</a></span>}>
  Ce hook contient des détails propres à l’écran `mfa-webauthn-platform-challenge`, notamment sa configuration et son contexte.
...
<ParamField body="useTransaction" type={<span>() =&gt; <a href="/docs/fr-ca/libraries/acul/react-sdk/API-Reference/Types/interfaces/TransactionMembers">TransactionMembers</a></span>}>
  Ce hook fournit des données propres à la transaction pour l’écran `mfa-webauthn-platform-challenge`, comme l’état actuel du flux d’AMF.
...
<ParamField body="useMfaWebAuthnPlatformChallenge" type={<a href="/docs/fr-ca/libraries/acul/react-sdk/API-Reference/Types/interfaces/MfaWebAuthnPlatformChallengeMembers">MfaWebAuthnPlatformChallengeMembers</a>}>
  Ce hook renvoie toutes les méthodes et tout le contexte disponibles à l’écran `mfa-webauthn-platform-challenge`.
</ParamField>

## Méthodes {#methods}

<ParamField body="reportBrowserError" type="Promise<void>">
  Cette méthode signale une erreur WebAuthn au niveau du navigateur survenue pendant la vérification avec l’authentificateur de plateforme.
...
<ParamField body="verify" type="Promise<void>">
  Cette méthode lance la vérification avec l’authentificateur de plateforme afin de compléter la vérification d’AMF.
  ...
  **Paramètres de la méthode**
  ...
  <Expandable title="Paramètres">
    ...
    <ParamField body="rememberDevice" type="boolean">
      Facultatif. Si la valeur est true, tente de mémoriser le navigateur pour de futures vérifications d’AMF.
