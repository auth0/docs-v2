...
description: "Décrit tous les hooks et toutes les méthodes permettant de personnaliser l’écran `passkey-enrollment-local` de Universal Login."
---

L’écran `passkey-enrollment-local` s’affiche lorsqu’un utilisateur est invité à inscrire une clé d’accès sur son appareil actuel. Il lui permet de poursuivre l’inscription de la clé d’accès ou d’annuler et, au besoin, de ne plus afficher les invites à l’avenir.
...
<ParamField body="useBranding" type={<span>() =&gt; <a href="/docs/fr-ca/libraries/acul/react-sdk/API-Reference/Types/interfaces/BrandingMembers">BrandingMembers</a></span>}>
  Ce hook fournit des configurations d’image de marque, comme le logo, les couleurs et les paramètres du thème affichés sur l’écran `passkey-enrollment-local`.
...
<ParamField body="useOrganization" type={<span>() =&gt; <a href="/docs/fr-ca/libraries/acul/react-sdk/API-Reference/Types/interfaces/OrganizationMembers">OrganizationMembers</a></span>}>
  Ce hook fournit des renseignements sur l’organisation de l’utilisateur si l’inscription de la clé d’accès est limitée à l’organisation. Il renvoie `null` lorsqu’aucun contexte d’organisation n’est présent.
...
<ParamField body="useScreen" type={<span>() =&gt; <a href="/docs/fr-ca/libraries/acul/react-sdk/API-Reference/Types/interfaces/ScreenMembersOnPasskeyEnrollmentLocal">ScreenMembersOnPasskeyEnrollmentLocal</a></span>}>
  Ce hook contient des détails propres à l’écran `passkey-enrollment-local`, y compris sa configuration et son contexte.
...
<ParamField body="usePasskeyEnrollmentLocal" type={<a href="/docs/fr-ca/libraries/acul/react-sdk/API-Reference/Types/interfaces/PasskeyEnrollmentLocalMembers">PasskeyEnrollmentLocalMembers</a>}>
  Ce hook renvoie toutes les méthodes et tout le contexte disponibles sur l’écran `passkey-enrollment-local`.
</ParamField>

## Méthodes {#methods}

<ParamField body="continuePasskeyEnrollment" type="Promise<void>">
  Cette méthode lance le processus d’inscription de clé d’accès sur l’appareil en cours d’utilisation et poursuit le flux d’authentification.
...
<ParamField body="abortPasskeyEnrollment" type="Promise<void>">
  Cette méthode annule le processus d’inscription de clé d’accès et poursuit le flux d’authentification sans inscrire de clé d’accès.
  ...
  **Paramètres de la méthode**
  ...
  <Expandable title="Paramètres">
    ...
    <ParamField body="doNotShowAgain" type="boolean">
      Lorsque `true`, masque les prochaines invites d’inscription de clé d’accès pour cet utilisateur.
    </ParamField>
  </Expandable>
</ParamField>
