...
description: "Décrit tous les hooks et les méthodes disponibles pour personnaliser l’écran `mfa-phone-enrollment` d’Universal Login."
---

L’écran `mfa-phone-enrollment` permet à l’utilisateur d’inscrire un numéro de téléphone pour la MFA par SMS ou par appel vocal en saisissant son numéro et en choisissant un mode de livraison.
...
Des hooks propres à l’écran qui fournissent un accès en lecture seule aux données de contexte Auth0 sur l’écran `mfa-phone-enrollment`. Importez-les depuis `@auth0/auth0-acul-react/mfa-phone-enrollment`.
...
<ParamField body="useBranding" type={<span>() =&gt; <a href="/docs/fr-ca/libraries/acul/react-sdk/API-Reference/Types/interfaces/BrandingMembers">BrandingMembers</a></span>}>
  Ce hook fournit les configurations de Branding, comme le logo, les couleurs et les paramètres du thème affichés sur l’écran `mfa-phone-enrollment`.
...
<ParamField body="continueEnrollment" type="Promise<void>">
  Cette méthode envoie le numéro de téléphone de l’utilisateur et le mode de livraison sélectionné pour inscrire ce téléphone à la MFA.
