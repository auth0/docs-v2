...
description: "Décrit tous les hooks et méthodes disponibles pour personnaliser l’écran `mfa-sms-challenge` dans Universal Login."
---
...
Hooks associés à l’écran qui fournissent un accès en lecture seule aux données de contexte Auth0 sur l’écran `mfa-sms-challenge`. Importez-les à partir de `@auth0/auth0-acul-react/mfa-sms-challenge`.
...
<ParamField body="useBranding" type={<span>() =&gt; <a href="/docs/fr-ca/libraries/acul/react-sdk/API-Reference/Types/interfaces/BrandingMembers">BrandingMembers</a></span>}>
  Ce hook fournit les paramètres d’image de marque, comme le logo, les couleurs et les paramètres de thème affichés sur l’écran `mfa-sms-challenge`.
...
<ParamField body="useTransaction" type={<span>() =&gt; <a href="/docs/fr-ca/libraries/acul/react-sdk/API-Reference/Types/interfaces/TransactionMembers">TransactionMembers</a></span>}>
  Ce hook fournit des données propres à la transaction pour l’écran `mfa-sms-challenge`, comme l’état actuel du flux AMF.
...
<ParamField body="useMfaSmsChallenge" type={<a href="/docs/fr-ca/libraries/acul/react-sdk/API-Reference/Types/interfaces/MfaSmsChallengeMembers">MfaSmsChallengeMembers</a>}>
  Ce hook renvoie toutes les méthodes et tout le contexte disponibles sur l’écran `mfa-sms-challenge`.
</ParamField>

## Méthodes {#methods}

<ParamField body="continueMfaSmsChallenge" type="Promise<void>">
  Cette méthode envoie le code à usage unique reçu par SMS pour terminer la vérification AMF.
  ...
  **Paramètres de la méthode**
  ...
  <Expandable title="Paramètres">
    ...
    <ParamField body="rememberDevice" type="boolean">
      Indique s’il faut se souvenir de l’appareil et ignorer l’AMF lors des prochaines connexions.
    </ParamField>
  </Expandable>
</ParamField>

<ParamField body="getACall" type="Promise<void>">
  Cette méthode remplace la vérification AMF par SMS par un appel vocal.
...
<ParamField body={<a href="/docs/fr-ca/libraries/acul/react-sdk/API-Reference/Hooks/useResend">useResend</a>} type="Hooks">
  Ce hook gère l’état et la logique du délai de renvoi pour les écrans offrant la fonctionnalité de renvoi de code.
</ParamField>
