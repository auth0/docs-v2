...
description: "Décrit tous les hooks et toutes les méthodes offerts pour personnaliser l’écran `organization-selection` de Universal Login."
---

L’écran `organization-selection` s’affiche lorsqu’un utilisateur doit saisir le nom de son organisation pour poursuivre le flux d’authentification. Il lui permet de saisir ce nom et de continuer.

<Frame>
  <img style={{maxHeight:"400px"}} src="/docs/images/cdy7uua7fh8z/3okogBPGS1KmSlhUSk9xhk/07bc19ad8b58772d3de872a49b8f6ca5/Screenshot_2025-03-25_at_20.27.41.png" alt="ACUL Sélection d’organisation" />
</Frame>
...
<ParamField body="useBranding" type={<span>() =&gt; <a href="/docs/fr-ca/libraries/acul/react-sdk/API-Reference/Types/interfaces/BrandingMembers">BrandingMembers</a></span>}>
  Ce hook fournit des configurations d’image de marque, comme le logo, les couleurs et les paramètres du thème affichés sur l’écran `organization-selection`.
...
<ParamField body="useOrganization" type={<span>() =&gt; <a href="/docs/fr-ca/libraries/acul/react-sdk/API-Reference/Types/interfaces/OrganizationMembers">OrganizationMembers</a></span>}>
  Ce hook fournit des renseignements sur l’organisation de l’utilisateur si la sélection est limitée à une organisation. Retourne `null` lorsqu’aucun contexte d’organisation n’est présent.
...
<ParamField body="useOrganizationSelection" type={<a href="/docs/fr-ca/libraries/acul/react-sdk/API-Reference/Types/interfaces/OrganizationSelectionMembers">OrganizationSelectionMembers</a>}>
  Ce hook renvoie toutes les méthodes et le contexte disponibles dans l’écran `organization-selection`.
</ParamField>

## Méthodes {#methods}

<ParamField body="continueWithOrganizationName" type="Promise<void>">
  Cette méthode transmet le nom de l’organisation saisi par l’utilisateur et poursuit le flux d’authentification.
  ...
  **Paramètres de la méthode**
  ...
  <Expandable title="Paramètres">
    ...
    <ParamField body="organizationName" type="string" required>
      Le nom de l’organisation avec laquelle poursuivre.
    </ParamField>
  </Expandable>
</ParamField>

<ParamField body="skipOrganizationSelection" type="Promise<void>">
  Cette méthode ignore la sélection de l’Organization et poursuit avec le compte personnel de l’utilisateur.
...
<ParamField body={<a href="/docs/fr-ca/libraries/acul/react-sdk/API-Reference/Hooks/useAuth0Themes">useAuth0Themes</a>} type="Hooks">
  Ce hook obtient les options du thème actuel avec une configuration aplatie à partir du contexte d’image de marque.
</ParamField>
...
<ParamField body={<a href="/docs/fr-ca/libraries/acul/react-sdk/API-Reference/Hooks/useCurrentScreen">useCurrentScreen</a>} type="Hooks">
  Ce hook obtient le contexte et l’état de l’écran actuel.
</ParamField>
