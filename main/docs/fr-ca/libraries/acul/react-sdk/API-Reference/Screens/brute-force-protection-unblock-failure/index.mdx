...
description: "Décrit tous les hooks et les méthodes disponibles pour personnaliser l’écran `brute-force-protection-unblock-failure` de Universal Login."
---
...
Chaque écran a son propre ensemble de hooks et de méthodes. Le SDK prend en charge **partial importation** et **root importation** pour chaque écran.

* L’utilisation de **partial importation** vous permet d’inclure uniquement le code nécessaire à votre cas d’utilisation.
* L’utilisation de **root importation** vous permet de charger tous les écrans à partir d’un seul bundle, ce qui est utile si vous souhaitez un build unifié capable de gérer tous les écrans possibles.
...
<ParamField body="useBranding" type={<span>() =&gt; <a href="/docs/fr-ca/libraries/acul/react-sdk/API-Reference/Types/interfaces/BrandingMembers">BrandingMembers</a></span>}>
  Ce hook fournit des configurations d’image de marque, comme le logo, les couleurs et les paramètres de thème affichés sur l’écran `brute-force-protection-unblock-failure`.
...
<ParamField body="useOrganization" type={<span>() =&gt; <a href="/docs/fr-ca/libraries/acul/react-sdk/API-Reference/Types/interfaces/OrganizationMembers">OrganizationMembers</a></span>}>
  Ce hook fournit des renseignements sur l’Organization de l’utilisateur si le flux de déblocage est limité à une Organization. Il retourne `null` lorsqu’aucun contexte Organization n’est présent.
...
<ParamField body={<a href="/docs/fr-ca/libraries/acul/react-sdk/API-Reference/Hooks/useAuth0Themes">useAuth0Themes</a>} type="Hooks">
  Ce hook récupère les options du thème actuel ainsi qu’une configuration à plat à partir du contexte d’image de marque.
</ParamField>
...
<ParamField body={<a href="/docs/fr-ca/libraries/acul/react-sdk/API-Reference/Hooks/useErrors">useErrors</a>} type="Hooks">
  Ce hook permet de lire et de gérer les erreurs serveur, côté client et développeur à l’écran.
</ParamField>