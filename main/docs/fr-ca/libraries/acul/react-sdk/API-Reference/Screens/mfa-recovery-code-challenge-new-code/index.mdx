...
description: "Décrit tous les hooks et toutes les méthodes offerts pour personnaliser l’écran `mfa-recovery-code-challenge-new-code` de Universal Login."
---
...
Hooks à portée d’écran qui fournissent un accès en lecture seule aux données de contexte Auth0 sur l’écran `mfa-recovery-code-challenge-new-code`. Importez-les depuis `@auth0/auth0-acul-react/mfa-recovery-code-challenge-new-code`.
...
<ParamField body="useBranding" type={<span>() =&gt; <a href="/docs/fr-ca/libraries/acul/react-sdk/API-Reference/Types/interfaces/BrandingMembers">BrandingMembers</a></span>}>
  Ce hook fournit les configurations de l’image de marque, comme le logo, les couleurs et les paramètres de thème affichés sur l’écran `mfa-recovery-code-challenge-new-code`.
...
<ParamField body="useClient" type={<span>() =&gt; <a href="/docs/fr-ca/libraries/acul/react-sdk/API-Reference/Types/interfaces/ClientMembers">ClientMembers</a></span>}>
  Ce hook fournit les configurations liées au client, comme `id`, `name` et `logoUrl`, pour l’écran `mfa-recovery-code-challenge-new-code`.
...
<ParamField body="useOrganization" type={<span>() =&gt; <a href="/docs/fr-ca/libraries/acul/react-sdk/API-Reference/Types/interfaces/OrganizationMembers">OrganizationMembers</a></span>}>
  Ce hook fournit des renseignements sur l’Organization de l’utilisateur si le flux d’AMF est défini dans le périmètre de l’Organization. Renvoie `null` lorsqu’aucun contexte d’Organization n’est présent.
...
<ParamField body="continueMethod" type="Promise<void>">
  Cette méthode confirme que l’utilisateur a enregistré son nouveau code de récupération et poursuit le flux d’authentification.
