...
description: "Décrit tous les hooks et toutes les méthodes disponibles pour personnaliser l’écran `mfa-voice-enrollment` de Universal Login."
---
...
* L’importation à la racine vous permet de charger tous les écrans à partir d’un seul bundle, ce qui est utile si vous souhaitez une build unifiée capable de prendre en charge tous les écrans possibles.
...
Hooks associés à l’écran qui fournissent un accès en lecture seule aux données de contexte Auth0 dans l’écran `mfa-voice-enrollment`. Importez-les depuis `@auth0/auth0-acul-react/mfa-voice-enrollment`.
...
<ParamField body="useBranding" type={<span>() =&gt; <a href="/docs/fr-ca/libraries/acul/react-sdk/API-Reference/Types/interfaces/BrandingMembers">BrandingMembers</a></span>}>
  Ce hook fournit des configurations d’image de marque, comme le logo, les couleurs et les paramètres du thème affichés dans l’écran `mfa-voice-enrollment`.
...
<ParamField body="useTransaction" type={<span>() =&gt; <a href="/docs/fr-ca/libraries/acul/react-sdk/API-Reference/Types/interfaces/TransactionMembers">TransactionMembers</a></span>}>
  Ce hook fournit des données propres à la transaction pour l’écran `mfa-voice-enrollment`, comme l’état actuel du flux d’AMF.
