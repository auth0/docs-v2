...
description: "Décrit tous les hooks et les méthodes disponibles pour personnaliser l’écran `phone-identifier-enrollment` de Universal Login."
---

L’écran `phone-identifier-enrollment` s’affiche lorsqu’un utilisateur doit inscrire un numéro de téléphone comme identifiant. Il lui permet de sélectionner sa méthode de vérification préférée (SMS ou appel vocal), puis de poursuivre le processus d’inscription ou de revenir à l’étape précédente.
...
Hooks associés à l’écran qui fournissent un accès en lecture seule aux données de contexte Auth0 sur l’écran `phone-identifier-enrollment`. Importez-les depuis `@auth0/auth0-acul-react/phone-identifier-enrollment`.
...
<ParamField body="useOrganization" type={<span>() =&gt; <a href="/docs/fr-ca/libraries/acul/react-sdk/API-Reference/Types/interfaces/OrganizationMembers">OrganizationMembers</a></span>}>
  Ce hook fournit de l’information sur l’Organization de l’utilisateur si l’inscription du téléphone est associée à une Organization. Retourne `null` lorsqu’aucun contexte Organization n’est présent.
...
<ParamField body="useScreen" type={<span>() =&gt; <a href="/docs/fr-ca/libraries/acul/react-sdk/API-Reference/Types/interfaces/ScreenMembersOnPhoneIdentifierEnrollment">ScreenMembersOnPhoneIdentifierEnrollment</a></span>}>
  ...
  L’objet `screen.data` expose trois champs facultatifs : `phone`, `messageType` et `username`. Utilisez `screen.data?.username` pour afficher le nom d’utilisateur associé à la session d’inscription actuelle.
...
<ParamField body="usePhoneIdentifierEnrollment" type={<a href="/docs/fr-ca/libraries/acul/react-sdk/API-Reference/Types/interfaces/PhoneIdentifierEnrollmentMembers">PhoneIdentifierEnrollmentMembers</a>}>
  Ce hook retourne toutes les méthodes et tout le contexte disponibles sur l’écran `phone-identifier-enrollment`.
</ParamField>

## Méthodes {#methods}

<ParamField body="continuePhoneEnrollment" type="Promise<void>">
  Cette méthode envoie le mode de vérification téléphonique privilégié par l’utilisateur et poursuit l’inscription.
  ...
  **Paramètres de la méthode**
  ...
  <Expandable title="Paramètres">
    ...
    <ParamField body="type" type="&#x22;text&#x22; | &#x22;voice&#x22;" required>
      Le mode d’envoi du code de vérification. Utilisez &quot;text&quot; pour les SMS ou &quot;voice&quot; pour un appel téléphonique.
    </ParamField>
  </Expandable>
</ParamField>
