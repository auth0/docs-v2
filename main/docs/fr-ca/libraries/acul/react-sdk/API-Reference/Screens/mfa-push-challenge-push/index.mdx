...
L’écran `mfa-push-challenge-push` invite l’utilisateur à approuver une notification push AMF envoyée à son appareil mobile.
...
* L’utilisation de l’importation racine vous permet de charger tous les écrans à partir d’un seul bundle, ce qui est utile si vous souhaitez une compilation unifiée capable de gérer tous les écrans possibles.
...
Des hooks propres à l’écran qui fournissent un accès en lecture seule aux données de contexte Auth0 sur l’écran `mfa-push-challenge-push`. Importez-les depuis `@auth0/auth0-acul-react/mfa-push-challenge-push`.
...
<ParamField body="useBranding" type={<span>() =&gt; <a href="/docs/fr-ca/libraries/acul/react-sdk/API-Reference/Types/interfaces/BrandingMembers">BrandingMembers</a></span>}>
  Ce hook fournit les configurations de l’image de marque, comme le logo, les couleurs et les paramètres du thème affichés sur l’écran `mfa-push-challenge-push`.
...
<ParamField body="useTransaction" type={<span>() =&gt; <a href="/docs/fr-ca/libraries/acul/react-sdk/API-Reference/Types/interfaces/TransactionMembers">TransactionMembers</a></span>}>
  Ce hook fournit des données propres à la transaction pour l’écran `mfa-push-challenge-push`, comme l’état actuel du flux AMF.
...
<ParamField body="useMfaPushChallengePush" type={<a href="/docs/fr-ca/libraries/acul/react-sdk/API-Reference/Types/interfaces/MfaPushChallengePushMembers">MfaPushChallengePushMembers</a>}>
  Ce hook renvoie toutes les méthodes et le contexte disponibles sur l’écran `mfa-push-challenge-push`.
</ParamField>

## Méthodes {#methods}

<ParamField body="continueMethod" type="Promise<void>">
  Cette méthode complète le push challenge une fois que l’utilisateur a approuvé la notification sur son appareil mobile.
  ...
  **Paramètres de la méthode**
  ...
  <Expandable title="Paramètres">
    ...
    <ParamField body="rememberDevice?" type="boolean">
      Si `true`, cet appareil sera mémorisé et l’AMF ne sera plus nécessaire sur celui-ci.
    </ParamField>
  </Expandable>
</ParamField>

<ParamField body="enterCodeManually" type="Promise<void>">
  Cette méthode ouvre l’écran de saisie manuelle du code pour que l’utilisateur puisse entrer un code OTP au lieu d’utiliser la notification push.
