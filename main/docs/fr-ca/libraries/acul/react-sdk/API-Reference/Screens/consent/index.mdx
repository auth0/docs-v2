---
title: "Consentement"
description: "Décrit tous les hooks et toutes les méthodes disponibles pour personnaliser l’écran `consent` dans Universal Login."
---
...
<Frame>
  <img style={{maxHeight:"400px"}} src="/docs/images/cdy7uua7fh8z/6cK6DkpOJYTjubOGu2vpID/80c03b32275a2c332fe3216df0eca5c7/Consent.png" alt="ACUL Consentement" />
</Frame>
...
* L’**importation racine** vous permet de charger tous les écrans à partir d’un seul bundle, ce qui est utile si vous voulez une build unifiée capable de gérer tous les écrans possibles.
...
Des hooks propres à l’écran qui fournissent un accès en lecture seule aux données de contexte Auth0 sur l’écran `consent`. Importez-les depuis `@auth0/auth0-acul-react/consent`.
...
<ParamField body="useOrganization" type={<span>() =&gt; <a href="/docs/fr-ca/libraries/acul/react-sdk/API-Reference/Types/interfaces/OrganizationMembers">OrganizationMembers</a></span>}>
  Ce hook fournit des renseignements sur l’Organization de l’utilisateur si la demande de consentement est limitée à l’Organization. Retourne `null` lorsqu’aucun contexte d’Organization n’est présent.
...
<ParamField body="accept" type="Promise<void>">
  Cette méthode soumet le consentement de l’utilisateur et accorde les permissions demandées à l’application.
...
<ParamField body="deny" type="Promise<void>">
  Cette méthode refuse la demande de consentement et révoque les permissions demandées pour l’application.
...
<ParamField body={<a href="/docs/fr-ca/libraries/acul/react-sdk/API-Reference/Hooks/useAuth0Themes">useAuth0Themes</a>} type="Hooks">
  Ce hook récupère les options du thème actuel à partir de la configuration aplatie du contexte de l’image de marque.
</ParamField>
