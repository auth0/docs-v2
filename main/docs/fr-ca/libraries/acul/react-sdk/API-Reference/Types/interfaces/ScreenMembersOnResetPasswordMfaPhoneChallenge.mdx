...
export interface ScreenMembersOnResetPasswordMfaPhoneChallenge extends ScreenMembers {
   ...
   * @property {string} data.phoneNumber - Le numéro de téléphone (souvent masqué pour des raisons de sécurité) associé à ce défi AMF lors de la réinitialisation du mot de passe.
   */
  data: {
