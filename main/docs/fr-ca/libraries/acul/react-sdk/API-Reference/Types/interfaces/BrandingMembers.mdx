...
<ParamField body="default" type="object">
  <Expandable title="propriétés">
    ...
    <ParamField body="identifiers?" type={<span><a href="/docs/fr-ca/libraries/acul/react-sdk/API-Reference/Types/interfaces/ThemeIdentifiers">ThemeIdentifiers</a></span>} />
