...
<ParamField body="useResend(options?)" type={<span><a href="/docs/fr-ca/libraries/acul/react-sdk/API-Reference/Types/interfaces/UseResendReturn">UseResendReturn</a></span>}>
  Ce hook React gère les actions de « renvoi » (p. ex., renvoyer un code de vérification) dans les écrans ACUL.
  ...
  * `startResend` — fonction pour lancer un renvoi immédiatement (si autorisé).
