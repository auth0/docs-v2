...
<ParamField body="useCurrentScreen()" type={<span><a href="/docs/fr-ca/libraries/acul/react-sdk/API-Reference/Types/interfaces/CurrentScreenOptions">CurrentScreenOptions</a></span>}>
  ...
  aux paramètres du tenant, à l’état de la transaction et aux paramètres d’autorisation pour créer une UI d’authentification personnalisée.
  ...
  * **`untrustedData`** - Paramètres d’autorisation du client (à valider avant utilisation)
