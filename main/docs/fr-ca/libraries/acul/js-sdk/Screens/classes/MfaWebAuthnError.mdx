...
La classe MfaWebAuthnError implémente la fonctionnalité de l’écran `mfa-webauthn-error`. Cet écran s’affiche lorsqu’une erreur survient au cours d’une opération WebAuthn.
...
<ParamField body="countryCodes" type={<span><a href="/docs/fr-ca/libraries/acul/js-sdk/Screens/interfaces/CountryCodesMembers">CountryCodesMembers</a></span>}>
  Fournit les données d’indicatifs de pays pour la saisie du numéro de téléphone, comme `available` et `recommended`, pour l’écran `mfa-webauthn-error`.
</ParamField>
...
<ParamField body="untrustedData" type={<span><a href="/docs/fr-ca/libraries/acul/js-sdk/Screens/interfaces/UntrustedDataMembers">UntrustedDataMembers</a></span>}>
  Gère les données non fiables transmises au SDK, comme les saisies de l’utilisateur pendant le traitement des erreurs MFA WebAuthn.
</ParamField>
