...
La classe RedeemTicket implémente la fonctionnalité de l’écran `redeem-ticket`. Cet écran s’affiche lorsqu’un utilisateur doit échanger un ticket afin de poursuivre le flux d’authentification.
...
Créez une instance du gestionnaire d’écran RedeemTicket :
...
<ParamField body="client" type={<span><a href="/docs/fr-ca/libraries/acul/js-sdk/Screens/interfaces/ClientMembers">ClientMembers</a></span>}>
  Fournit des configurations liées au client, comme `id`, `name` et `logoUrl`, pour l’écran `redeem-ticket`.
</ParamField>
...
<ParamField body="countryCodes" type={<span><a href="/docs/fr-ca/libraries/acul/js-sdk/Screens/interfaces/CountryCodesMembers">CountryCodesMembers</a></span>}>
  Fournit les données d’indicatifs de pays pour la saisie de numéros de téléphone, comme `available` et `recommended`, pour l’écran `redeem-ticket`.
</ParamField>
...
<ParamField body="untrustedData" type={<span><a href="/docs/fr-ca/libraries/acul/js-sdk/Screens/interfaces/UntrustedDataMembers">UntrustedDataMembers</a></span>}>
  Gère les données non fiables transmises au SDK, comme les données saisies par l’utilisateur pendant le flux d’échange de ticket.
</ParamField>
...
<ParamField body="continue" type="Promise<void>">
  Cette méthode exécute l’action `default` sur l’écran `redeem-ticket`, ce qui poursuit le flux d’authentification.
