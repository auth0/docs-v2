...
description: "Décrit toutes les propriétés et méthodes offertes pour personnaliser l’écran `reset-password-error` d’Universal Login."
---
...
<ParamField body="countryCodes" type={<span><a href="/docs/fr-ca/libraries/acul/js-sdk/Screens/interfaces/CountryCodesMembers">CountryCodesMembers</a></span>}>
  Fournit des données sur les indicatifs de pays pour la saisie d’un numéro de téléphone, comme `available` et `recommended`, pour l’écran `reset-password-error`.
</ParamField>
...
<ParamField body="prompt" type={<span><a href="/docs/fr-ca/libraries/acul/js-sdk/Screens/interfaces/PromptMembers">PromptMembers</a></span>}>
  Contient les données du prompt actuel dans le flux d’authentification.
</ParamField>
