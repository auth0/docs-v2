...
La classe DeviceCodeActivationDenied implémente la fonctionnalité de l’écran `device-code-activation-denied`. Cet écran s’affiche lorsque l’activation du code d’appareil a été refusée.
...
<ParamField body="countryCodes" type={<span><a href="/docs/fr-ca/libraries/acul/js-sdk/Screens/interfaces/CountryCodesMembers">CountryCodesMembers</a></span>}>
  Fournit les données d’indicatifs de pays pour la saisie du numéro de téléphone, comme `available` et `recommended`, pour l’écran `device-code-activation-denied`.
</ParamField>
...
<ParamField body="screen" type={<span><a href="/docs/fr-ca/libraries/acul/js-sdk/Screens/interfaces/ScreenMembers">ScreenMembers</a></span>}>
  Contient des renseignements propres à l’écran `device-code-activation-denied`, notamment sa configuration et son contexte.
</ParamField>
