...
description: "Décrit toutes les propriétés et méthodes disponibles pour personnaliser l’écran `device-code-activation` d’Universal Login."
---

La classe DeviceCodeActivation implémente la fonctionnalité de l’écran `device-code-activation`. Cet écran s’affiche lorsque l’utilisateur doit saisir le code affiché sur son appareil pour l’activer.
...
<ParamField body="countryCodes" type={<span><a href="/docs/fr-ca/libraries/acul/js-sdk/Screens/interfaces/CountryCodesMembers">CountryCodesMembers</a></span>}>
  Fournit les données d’indicatifs de pays pour la saisie du numéro de téléphone, comme `available` et `recommended`, pour l’écran `device-code-activation`.
</ParamField>
...
<ParamField body="untrustedData" type={<span><a href="/docs/fr-ca/libraries/acul/js-sdk/Screens/interfaces/UntrustedDataMembers">UntrustedDataMembers</a></span>}>
  Gère les données non fiables transmises au SDK, comme les données saisies par l’utilisateur pendant le flux d’activation du code d’appareil.
</ParamField>
...
<ParamField body="continue" type="Promise<void>">
  Cette méthode soumet le code d’appareil saisi par l’utilisateur afin de terminer l’activation.
  ...
  **Paramètres de la méthode**
  ...
  <Expandable title="Paramètres">
    <ParamField body="options">
      [DeviceCodeActivationContinueOptions](/docs/fr-ca/libraries/acul/js-sdk/Screens/interfaces/DeviceCodeActivationContinueOptions).
    </ParamField>

    <ParamField body="code" type="string" required>
      Le code d’appareil saisi par l’utilisateur.
    </ParamField>
  </Expandable>
</ParamField>
