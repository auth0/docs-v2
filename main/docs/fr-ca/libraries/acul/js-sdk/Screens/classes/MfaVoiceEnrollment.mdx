...
description: "Décrit toutes les propriétés et méthodes disponibles pour personnaliser l’écran `mfa-voice-enrollment` de Universal Login."
---

La classe MfaVoiceEnrollment implémente les fonctionnalités de l’écran `mfa-voice-enrollment`. Cet écran s’affiche lorsque l’utilisateur doit saisir un numéro de téléphone pour recevoir un appel vocal avec un code de vérification afin de poursuivre l’inscription.
...
Créez une instance du gestionnaire de l’écran d’inscription vocale AMF :
...
<ParamField body="countryCodes" type={<span><a href="/docs/fr-ca/libraries/acul/js-sdk/Screens/interfaces/CountryCodesMembers">CountryCodesMembers</a></span>}>
  Fournit les données d’indicatif de pays pour la saisie du numéro de téléphone, comme `available` et `recommended`, pour l’écran `mfa-voice-enrollment`.
</ParamField>
...
<ParamField body="untrustedData" type={<span><a href="/docs/fr-ca/libraries/acul/js-sdk/Screens/interfaces/UntrustedDataMembers">UntrustedDataMembers</a></span>}>
  Traite les données non fiables transmises au SDK, comme les entrées utilisateur pendant l’inscription vocale à l’AMF.
</ParamField>
...
<ParamField body="selectPhoneCountryCode" type="Promise<void>">
  Cette méthode mène à l’écran où l’utilisateur peut sélectionner l’indicatif du pays pour son numéro de téléphone.
