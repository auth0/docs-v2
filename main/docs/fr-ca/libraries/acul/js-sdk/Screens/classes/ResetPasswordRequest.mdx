...
description: "Décrit toutes les propriétés et méthodes disponibles pour personnaliser l’écran `reset-password-request` d’Universal Login."
---

La classe ResetPasswordRequest implémente les fonctionnalités de l’écran `reset-password-request`. Cet écran invite l’utilisateur à saisir son identifiant afin d’amorcer le processus de réinitialisation du mot de passe.
...
Créez une instance du gestionnaire d’écran ResetPasswordRequest :
...
<ParamField body="countryCodes" type={<span><a href="/docs/fr-ca/libraries/acul/js-sdk/Screens/interfaces/CountryCodesMembers">CountryCodesMembers</a></span>}>
  Fournit des données sur les indicatifs de pays pour la saisie d’un numéro de téléphone, comme `available` et `recommended`, pour l’écran `reset-password-request`.
</ParamField>
...
<ParamField body="screen" type={<span><a href="/docs/fr-ca/libraries/acul/js-sdk/Screens/interfaces/ScreenMembersOnResetPasswordRequest">ScreenMembersOnResetPasswordRequest</a></span>}>
...
<ParamField body="transaction" type={<span><a href="/docs/fr-ca/libraries/acul/js-sdk/Screens/interfaces/TransactionMembersOnResetPasswordRequest">TransactionMembersOnResetPasswordRequest</a></span>}>
...
<ParamField body="getLoginIdentifiers" type={<span><a href="/docs/fr-ca/libraries/acul/js-sdk/Screens/type-aliases/ScreenIdentifierType">ScreenIdentifierType</a>[]</span>}>
...
<ParamField body="resetPassword" type="Promise<void>">
  Cette méthode soumet l’identifiant de l’utilisateur pour lancer le processus de réinitialisation du mot de passe.
