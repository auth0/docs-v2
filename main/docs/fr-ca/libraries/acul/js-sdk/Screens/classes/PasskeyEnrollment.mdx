...
La classe PasskeyEnrollment implémente la fonctionnalité de l’écran `passkey-enrollment`. Cet écran permet aux utilisateurs d’inscrire une clé d’accès comme méthode d’authentification.
...
<ParamField body="countryCodes" type={<span><a href="/docs/fr-ca/libraries/acul/js-sdk/Screens/interfaces/CountryCodesMembers">CountryCodesMembers</a></span>}>
  Fournit des données sur les codes de pays pour la saisie d’un numéro de téléphone, comme `available` et `recommended`, pour l’écran `passkey-enrollment`.
</ParamField>
...
<ParamField body="screen" type={<span><a href="/docs/fr-ca/libraries/acul/js-sdk/Screens/interfaces/ScreenMembersOnPasskeyEnrollment">ScreenMembersOnPasskeyEnrollment</a></span>}>
  Contient des détails propres à l’écran `passkey-enrollment`, notamment sa configuration et son contexte.
</ParamField>
...
<ParamField body="untrustedData" type={<span><a href="/docs/fr-ca/libraries/acul/js-sdk/Screens/interfaces/UntrustedDataMembers">UntrustedDataMembers</a></span>}>
  Gère les données non fiables transmises au SDK, comme les saisies de l’utilisateur pendant l’inscription de la clé d’accès.
</ParamField>
  ...
  **Paramètres de la méthode**
  ...
  <Expandable title="Paramètres">
    ...
    <ParamField body="doNotShowAgain?" type="boolean">
      Lorsqu’elle est définie à `true`, l’invite d’inscription de la clé d’accès est masquée pour les prochaines sessions.
    </ParamField>
  </Expandable>
</ParamField>
