...
La classe MfaWebAuthnRoamingEnrollment implémente la fonctionnalité de l’écran `mfa-webauthn-roaming-enrollment`. Cet écran s’affiche lorsqu’un utilisateur doit inscrire un authentificateur WebAuthn itinérant, par exemple : une clé de sécurité.
...
Créez une instance du gestionnaire de l’écran AMF WebAuthn Roaming Enrollment :
...
<ParamField body="countryCodes" type={<span><a href="/docs/fr-ca/libraries/acul/js-sdk/Screens/interfaces/CountryCodesMembers">CountryCodesMembers</a></span>}>
  Fournit des données sur les codes de pays pour la saisie de numéros de téléphone, comme `available` et `recommended`, pour l’écran `mfa-webauthn-roaming-enrollment`.
</ParamField>
...
<ParamField body="untrustedData" type={<span><a href="/docs/fr-ca/libraries/acul/js-sdk/Screens/interfaces/UntrustedDataMembers">UntrustedDataMembers</a></span>}>
  Contient les données non fiables transmises au SDK, comme les saisies de l’utilisateur pendant l’inscription WebAuthn itinérante pour l’AMF.
</ParamField>
...
<ParamField body="enroll" type="Promise<void>">
  Cette méthode lance la création de l’information d’identification WebAuthn et envoie le résultat au serveur.
