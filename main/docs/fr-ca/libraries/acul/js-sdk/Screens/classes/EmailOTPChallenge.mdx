...
description: "Décrit toutes les propriétés et méthodes permettant de personnaliser l’écran `email-otp-challenge` de Universal Login."
---

La classe EmailOTPChallenge implémente les fonctionnalités de l’écran `email-otp-challenge`. Cet écran invite l’utilisateur à saisir un code à usage unique envoyé à son adresse courriel.
...
<ParamField body="countryCodes" type={<span><a href="/docs/fr-ca/libraries/acul/js-sdk/Screens/interfaces/CountryCodesMembers">CountryCodesMembers</a></span>}>
  Fournit des données de codes de pays pour la saisie de numéros de téléphone, comme `available` et `recommended`, pour l’écran `email-otp-challenge`.
</ParamField>
...
<ParamField body="untrustedData" type={<span><a href="/docs/fr-ca/libraries/acul/js-sdk/Screens/interfaces/UntrustedDataMembers">UntrustedDataMembers</a></span>}>
  Gère les données non fiables transmises au SDK, comme les saisies de l’utilisateur pendant le flux de défi Email OTP.
</ParamField>
...
<ParamField body="resendCode" type="Promise<void>">
  Cette méthode demande l’envoi d’un nouveau code OTP à l’adresse courriel.
