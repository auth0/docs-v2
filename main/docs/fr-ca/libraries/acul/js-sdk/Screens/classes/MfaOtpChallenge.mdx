...
La classe MfaOtpChallenge implémente les fonctionnalités de l’écran `mfa-otp-challenge`. Cet écran s’affiche lorsqu’un utilisateur doit saisir un code OTP pendant l’authentification MFA.

<Frame>
  <img style={{maxHeight:"400px"}} src="/docs/images/cdy7uua7fh8z/4EcKVu4uEjsNEpVcI5bW0b/e6fb47c9addc1c07f1f39516aafa5e0e/Screenshot_2025-03-26_at_00.01.07.png" alt="Défi OTP MFA d’ACUL" />
</Frame>

## Constructeurs {#constructors}

Créer une instance du gestionnaire d’écran MFA OTP Challenge :
...
<ParamField body="countryCodes" type={<span><a href="/docs/fr-ca/libraries/acul/js-sdk/Screens/interfaces/CountryCodesMembers">CountryCodesMembers</a></span>}>
  Fournit des données sur les indicatifs de pays pour la saisie d’un numéro de téléphone, comme `available` et `recommended`, pour l’écran `mfa-otp-challenge`.
</ParamField>
...
<ParamField body="untrustedData" type={<span><a href="/docs/fr-ca/libraries/acul/js-sdk/Screens/interfaces/UntrustedDataMembersOnMfaOtpChallenge">UntrustedDataMembersOnMfaOtpChallenge</a></span>}>
  Contient les données non fiables transmises au SDK, comme la saisie utilisateur durant le défi OTP de MFA.
</ParamField>
