...
La classe InterstitialCaptcha implémente la fonctionnalité de l’écran `interstitial-captcha`. Cet écran invite l’utilisateur à effectuer un défi CAPTCHA pendant le flux d’authentification.
...
Créer une instance du gestionnaire d’écran InterstitialCaptcha :
...
<ParamField body="countryCodes" type={<span><a href="/docs/fr-ca/libraries/acul/js-sdk/Screens/interfaces/CountryCodesMembers">CountryCodesMembers</a></span>}>
  Fournit des données sur les indicatifs de pays pour la saisie d’un numéro de téléphone, comme `available` et `recommended`, pour l’écran `interstitial-captcha`.
</ParamField>
...
<ParamField body="prompt" type={<span><a href="/docs/fr-ca/libraries/acul/js-sdk/Screens/interfaces/PromptMembers">PromptMembers</a></span>}>
  Contient des données sur l’étape en cours dans le flux d’authentification.
</ParamField>
...
<ParamField body="screen" type={<span><a href="/docs/fr-ca/libraries/acul/js-sdk/Screens/interfaces/ScreenMembers">ScreenMembers</a></span>}>
  Contient des détails propres à l’écran `interstitial-captcha`, notamment sa configuration et son contexte.
</ParamField>
...
<ParamField body="untrustedData" type={<span><a href="/docs/fr-ca/libraries/acul/js-sdk/Screens/interfaces/UntrustedDataMembers">UntrustedDataMembers</a></span>}>
  Gère les données non fiables transmises au SDK, comme les données saisies par l’utilisateur pendant le flux du défi CAPTCHA.
</ParamField>
