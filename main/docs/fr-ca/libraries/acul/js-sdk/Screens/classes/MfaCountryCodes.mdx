...
description: "Décrit toutes les propriétés et méthodes permettant de personnaliser l’écran `mfa-country-codes` de Universal Login."
---

La classe MfaCountryCodes implémente les fonctionnalités de l’écran `mfa-country-codes`. Cet écran permet aux utilisateurs de sélectionner un code de pays pour la vérification AMF d’un numéro de téléphone.
...
Créez une instance du gestionnaire d’écran AMF Country Codes :
...
<ParamField body="countryCodes" type={<span><a href="/docs/fr-ca/libraries/acul/js-sdk/Screens/interfaces/CountryCodesMembers">CountryCodesMembers</a></span>}>
  Fournit des données sur les codes de pays pour la saisie du numéro de téléphone, comme `available` et `recommended`, pour l’écran `mfa-country-codes`.
</ParamField>
...
<ParamField body="untrustedData" type={<span><a href="/docs/fr-ca/libraries/acul/js-sdk/Screens/interfaces/UntrustedDataMembers">UntrustedDataMembers</a></span>}>
  Gère les données non fiables transmises au SDK, comme les entrées utilisateur lors de la sélection du code de pays pour l’AMF.
</ParamField>
...
<ParamField body="selectCountryCode" type="Promise<void>">
  Cette méthode sélectionne un code de pays parmi les options disponibles.
  ...
  **Paramètres de la méthode**
  ...
  <Expandable title="Paramètres">
    <ParamField body="options">
      [SelectCountryCodeOptions](/docs/fr-ca/libraries/acul/js-sdk/Screens/interfaces/SelectCountryCodeOptions).
    </ParamField>

    <ParamField body="country_code" type="string" required>
      Le code de pays (par exemple, `'US'`, `'GB'`).
    </ParamField>
