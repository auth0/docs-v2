...
description: "Décrit toutes les propriétés et méthodes permettant de personnaliser l’écran `reset-password-email` d’Universal Login."
---

La classe ResetPasswordEmail implémente la fonctionnalité de l’écran `reset-password-email`. Cet écran informe l’utilisateur qu’un courriel de réinitialisation du mot de passe a été envoyé et lui permet d’en demander le renvoi au besoin.
...
<ParamField body="branding" type={<span><a href="/docs/fr-ca/libraries/acul/js-sdk/Screens/interfaces/BrandingMembers">BrandingMembers</a></span>}>
  Fournit des paramètres liés à l’image de marque, comme le thème et les paramètres de l’image de marque.
</ParamField>
...
<ParamField body="client" type={<span><a href="/docs/fr-ca/libraries/acul/js-sdk/Screens/interfaces/ClientMembers">ClientMembers</a></span>}>
  Fournit des paramètres liés au client, comme `id`, `name` et `logoUrl`, pour l’écran `reset-password-email`.
</ParamField>
...
<ParamField body="countryCodes" type={<span><a href="/docs/fr-ca/libraries/acul/js-sdk/Screens/interfaces/CountryCodesMembers">CountryCodesMembers</a></span>}>
  Fournit des données sur les indicatifs de pays pour la saisie du numéro de téléphone, comme `available` et `recommended`, pour l’écran `reset-password-email`.
</ParamField>
...
<ParamField body="screen" type={<span><a href="/docs/fr-ca/libraries/acul/js-sdk/Screens/interfaces/ScreenMembersOnResetPasswordEmail">ScreenMembersOnResetPasswordEmail</a></span>}>
...
<ParamField body="untrustedData" type={<span><a href="/docs/fr-ca/libraries/acul/js-sdk/Screens/interfaces/UntrustedDataMembers">UntrustedDataMembers</a></span>}>
  Gère les données non fiables transmises au SDK, comme les données saisies par l’utilisateur pendant le flux de réinitialisation du mot de passe.
</ParamField>
...
<ParamField body="resendEmail" type="Promise<void>">
  Cette méthode renvoie le courriel de réinitialisation du mot de passe à l’adresse courriel enregistrée de l’utilisateur.
