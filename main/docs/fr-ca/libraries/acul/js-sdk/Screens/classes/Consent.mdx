...
La classe Consent implémente les fonctionnalités de l’écran `consent`. Cet écran présente à l’utilisateur les permissions demandées et recueille sa décision d’accepter ou de rejeter l’accès.
...
Créez une instance du gestionnaire de l’écran de consentement :
...
<ParamField body="countryCodes" type={<span><a href="/docs/fr-ca/libraries/acul/js-sdk/Screens/interfaces/CountryCodesMembers">CountryCodesMembers</a></span>}>
  Fournit les données des codes de pays pour la saisie d’un numéro de téléphone, notamment `available` et `recommended`, sur l’écran `consent`.
</ParamField>
...
<ParamField body="screen" type={<span><a href="/docs/fr-ca/libraries/acul/js-sdk/Screens/interfaces/ScreenMembersOnConsent">ScreenMembersOnConsent</a></span>}>
  Contient des détails propres à l’écran `consent`, notamment la liste des `scopes` demandés et l’indicateur `hideScopes`.
</ParamField>
...
<ParamField body="untrustedData" type={<span><a href="/docs/fr-ca/libraries/acul/js-sdk/Screens/interfaces/UntrustedDataMembers">UntrustedDataMembers</a></span>}>
  Gère les données non fiables transmises au SDK, comme les données saisies par l’utilisateur pendant le flux de consentement.
</ParamField>
...
<ParamField body="accept" type="Promise<void>">
  Cette méthode transmet la décision de l’utilisateur d’accepter (d’accorder) les permissions demandées.
...
<ParamField body="deny" type="Promise<void>">
  Cette méthode transmet la décision de l’utilisateur de rejeter (de refuser) les permissions demandées.
...
<ParamField body="getErrors" type={<span><a href="/docs/fr-ca/libraries/acul/js-sdk/Screens/interfaces/Error">Error</a>[]</span>}>
  Cette méthode récupère le tableau des erreurs de transaction depuis le contexte, ou un tableau vide s’il n’en existe aucune.
</ParamField>