...
description: "Décrit toutes les propriétés et méthodes disponibles pour personnaliser l’écran `logout-complete` d’Universal Login."
---

La classe LogoutComplete implémente les fonctionnalités de l’écran `logout-complete`. Cet écran s’affiche lorsqu’un utilisateur a terminé le processus de déconnexion.
...
<ParamField body="countryCodes" type={<span><a href="/docs/fr-ca/libraries/acul/js-sdk/Screens/interfaces/CountryCodesMembers">CountryCodesMembers</a></span>}>
  Fournit des données sur les indicatifs de pays pour la saisie d’un numéro de téléphone, comme `available` et `recommended`, pour l’écran `logout-complete`.
</ParamField>
...
<ParamField body="screen" type={<span><a href="/docs/fr-ca/libraries/acul/js-sdk/Screens/interfaces/ScreenMembers">ScreenMembers</a></span>}>
  Contient des détails propres à l’écran `logout-complete`, notamment sa configuration et son contexte.
</ParamField>
  ...
  **Paramètres de la méthode**
  ...
  <Expandable title="Paramètres">
    ...
    <ParamField body="language" type="string" required>
      Le code de paramètre régional (locale) de la langue souhaitée (par exemple, `'en'`, `'fr'`, `'es'`).
    </ParamField>
