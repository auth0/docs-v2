---
title: "MfaSmsList"
description: "Décrit toutes les propriétés et méthodes offertes pour personnaliser l’écran `mfa-sms-list` de Universal Login."
---
...
<ParamField body="countryCodes" type={<span><a href="/docs/fr-ca/libraries/acul/js-sdk/Screens/interfaces/CountryCodesMembers">CountryCodesMembers</a></span>}>
  Fournit des données de codes de pays pour la saisie d’un numéro de téléphone, comme `available` et `recommended`, pour l’écran `mfa-sms-list`.
</ParamField>
...
<ParamField body="untrustedData" type={<span><a href="/docs/fr-ca/libraries/acul/js-sdk/Screens/interfaces/UntrustedDataMembers">UntrustedDataMembers</a></span>}>
  Gère les données non fiables transmises au SDK, comme les entrées utilisateur lors de la sélection dans la liste SMS MFA.
</ParamField>
...
<ParamField body="backAction" type="Promise<void>">
  Cette méthode ramène à l’écran précédent.
  ...
  **Paramètres de la méthode**
  ...
  <Expandable title="Paramètres">
    ...
    <ParamField body="language" type="string" required>
      Le code de paramètre régional de la langue voulue (par exemple, `'en'`, `'fr'`, `'es'`).
    </ParamField>
...
<ParamField body="selectPhoneNumber" type="Promise<void>">
  Cette méthode sélectionne un numéro de téléphone dans la liste des numéros de téléphone enregistrés.
