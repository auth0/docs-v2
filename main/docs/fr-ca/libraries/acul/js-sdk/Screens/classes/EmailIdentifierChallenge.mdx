...
<ParamField body="client" type={<span><a href="/docs/fr-ca/libraries/acul/js-sdk/Screens/interfaces/ClientMembers">ClientMembers</a></span>}>
  Fournit les configurations liées au client, comme `id`, `name` et `logoUrl`, pour l’écran `email-identifier-challenge`.
</ParamField>
...
<ParamField body="countryCodes" type={<span><a href="/docs/fr-ca/libraries/acul/js-sdk/Screens/interfaces/CountryCodesMembers">CountryCodesMembers</a></span>}>
  Fournit les données d’indicatifs de pays pour la saisie du numéro de téléphone, comme `available` et `recommended`, pour l’écran `email-identifier-challenge`.
</ParamField>
...
<ParamField body="screen" type={<span><a href="/docs/fr-ca/libraries/acul/js-sdk/Screens/interfaces/ScreenMembersOnEmailIdentifierChallenge">ScreenMembersOnEmailIdentifierChallenge</a></span>}>
  Contient des détails propres à l’écran `email-identifier-challenge`, notamment sa configuration et son contexte.
</ParamField>
...
<ParamField body="switchToPassword" type="Promise<void>">
  Cette méthode fait passer le flux d’authentification de la vérification par OTP par courriel à l’authentification par mot de passe.
...
<ParamField body="submitEmailChallenge" type="Promise<void>">
  Cette méthode soumet le code de vérification par courriel pour terminer la vérification.
  ...
  **Paramètres de la méthode**
  ...
  <Expandable title="Paramètres">
    ...
    <ParamField body="captcha?" type="string">
      Le token de réponse CAPTCHA, si CAPTCHA est activé pour ce tenant.
    </ParamField>
  </Expandable>
</ParamField>