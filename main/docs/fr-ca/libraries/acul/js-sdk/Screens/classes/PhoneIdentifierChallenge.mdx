...
<ParamField body="countryCodes" type={<span><a href="/docs/fr-ca/libraries/acul/js-sdk/Screens/interfaces/CountryCodesMembers">CountryCodesMembers</a></span>}>
  Fournit les données d’indicatifs de pays pour la saisie du numéro de téléphone, comme `available` et `recommended`, pour l’écran `phone-identifier-challenge`.
</ParamField>
...
<ParamField body="switchToPassword" type="Promise<void>">
  Cette méthode fait passer le flux d’authentification de la vérification par OTP téléphonique à l’authentification par mot de passe.
