...
description: "Décrit toutes les propriétés et méthodes disponibles pour personnaliser l’écran `organization-picker` de Universal Login."
---

La classe OrganizationPicker implémente la fonctionnalité de l’écran `organization-picker`. Cet écran permet aux utilisateurs de choisir une organisation dans une liste d’organisations disponibles.
...
<ParamField body="countryCodes" type={<span><a href="/docs/fr-ca/libraries/acul/js-sdk/Screens/interfaces/CountryCodesMembers">CountryCodesMembers</a></span>}>
  Fournit des données sur les indicatifs de pays pour la saisie d’un numéro de téléphone, comme `available` et `recommended`, pour l’écran `organization-picker`.
</ParamField>
...
<ParamField body="untrustedData" type={<span><a href="/docs/fr-ca/libraries/acul/js-sdk/Screens/interfaces/UntrustedDataMembers">UntrustedDataMembers</a></span>}>
  Gère les données non fiables transmises au SDK, comme la saisie de l’utilisateur pendant le flux de sélection d’organisation.
</ParamField>
...
<ParamField body="skipOrganizationSelection" type="Promise<void>">
  Cette méthode soumet l’action permettant d’ignorer la sélection d’organisation.
