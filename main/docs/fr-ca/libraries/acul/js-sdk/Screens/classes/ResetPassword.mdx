---
title: "ResetPassword"
description: "Décrit toutes les propriétés et méthodes disponibles pour personnaliser l’écran `reset-password` de Universal Login."
---

La classe ResetPassword implémente la fonctionnalité associée à l’écran `reset-password`. Cet écran permet à l’utilisateur de définir un nouveau mot de passe après avoir vérifié son identité.
...
<ParamField body="client" type={<span><a href="/docs/fr-ca/libraries/acul/js-sdk/Screens/interfaces/ClientMembers">ClientMembers</a></span>}>
  Fournit la configuration liée au client, comme `id`, `name` et `logoUrl`, pour l’écran `reset-password`.
</ParamField>
...
<ParamField body="countryCodes" type={<span><a href="/docs/fr-ca/libraries/acul/js-sdk/Screens/interfaces/CountryCodesMembers">CountryCodesMembers</a></span>}>
  Fournit des données sur les codes de pays pour la saisie d’un numéro de téléphone, comme `available` et `recommended`, pour l’écran `reset-password`.
</ParamField>
  ...
  **Paramètres de la méthode**
  ...
  <Expandable title="Paramètres">
    ...
    <ParamField body="language" type="string" required>
      Le code du paramètre régional correspondant à la langue souhaitée (par exemple, `'en'`, `'fr'`, `'es'`).
    </ParamField>
