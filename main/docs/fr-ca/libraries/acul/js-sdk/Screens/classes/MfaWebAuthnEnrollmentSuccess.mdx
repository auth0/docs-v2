...
La classe MfaWebAuthnEnrollmentSuccess implémente la fonctionnalité de l’écran `mfa-webauthn-enrollment-success`. Cet écran s’affiche lorsque l’utilisateur a inscrit avec succès une clé de sécurité WebAuthn.
...
Créez une instance du gestionnaire de l’écran de réussite de l’inscription WebAuthn pour la MFA :
...
<ParamField body="branding" type={<span><a href="/docs/fr-ca/libraries/acul/js-sdk/Screens/interfaces/BrandingMembers">BrandingMembers</a></span>}>
  Fournit la configuration liée à l’image de marque, comme le thème de l’image de marque et les paramètres.
</ParamField>
...
<ParamField body="countryCodes" type={<span><a href="/docs/fr-ca/libraries/acul/js-sdk/Screens/interfaces/CountryCodesMembers">CountryCodesMembers</a></span>}>
  Fournit des données sur les indicatifs de pays pour la saisie du numéro de téléphone, comme `available` et `recommended`, pour l’écran `mfa-webauthn-enrollment-success`.
</ParamField>
...
<ParamField body="untrustedData" type={<span><a href="/docs/fr-ca/libraries/acul/js-sdk/Screens/interfaces/UntrustedDataMembers">UntrustedDataMembers</a></span>}>
  Traite les données non fiables transmises au SDK, comme les saisies de l’utilisateur lors de la réussite de l’inscription WebAuthn à la MFA.
</ParamField>
