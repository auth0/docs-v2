...
description: "Décrit toutes les propriétés et méthodes offertes pour personnaliser l’écran `mfa-enroll-result` de Universal Login."
---

La classe MfaEnrollResult implémente les fonctionnalités de l’écran `mfa-enroll-result`. Cet écran affiche le résultat de l’inscription d’un facteur MFA.

<Frame>
  <img style={{maxHeight:"400px"}} src="/docs/images/cdy7uua7fh8z/lfXmpkRzf0XoXV12vYMe9/a426e0cce6d405a0314a59e79cb4f918/Screenshot_2025-02-20_at_17.10.00.png" alt="ACUL Résultat de l’inscription MFA" />
</Frame>
...
<ParamField body="countryCodes" type={<span><a href="/docs/fr-ca/libraries/acul/js-sdk/Screens/interfaces/CountryCodesMembers">CountryCodesMembers</a></span>}>
  Fournit des données sur les indicatifs de pays pour la saisie de numéros de téléphone, comme `available` et `recommended`, pour l’écran `mfa-enroll-result`.
</ParamField>
...
<ParamField body="untrustedData" type={<span><a href="/docs/fr-ca/libraries/acul/js-sdk/Screens/interfaces/UntrustedDataMembers">UntrustedDataMembers</a></span>}>
  Prend en charge les données non fiables transmises au SDK, comme les entrées utilisateur pendant l’inscription à la MFA.
</ParamField>
