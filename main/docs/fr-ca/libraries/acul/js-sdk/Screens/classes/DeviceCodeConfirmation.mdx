...
La classe DeviceCodeConfirmation implémente la fonctionnalité de l’écran `device-code-confirmation`. Cet écran s’affiche lorsque l’utilisateur doit confirmer ou annuler l’activation du code de l’appareil.
...
<ParamField body="countryCodes" type={<span><a href="/docs/fr-ca/libraries/acul/js-sdk/Screens/interfaces/CountryCodesMembers">CountryCodesMembers</a></span>}>
  Fournit les données d’indicatifs de pays pour la saisie du numéro de téléphone, comme `available` et `recommended`, pour l’écran `device-code-confirmation`.
</ParamField>
...
<ParamField body="screen" type={<span><a href="/docs/fr-ca/libraries/acul/js-sdk/Screens/interfaces/ScreenMembersOnDeviceCodeConfirmation">ScreenMembersOnDeviceCodeConfirmation</a></span>}>
...
<ParamField body="untrustedData" type={<span><a href="/docs/fr-ca/libraries/acul/js-sdk/Screens/interfaces/UntrustedDataMembers">UntrustedDataMembers</a></span>}>
  Gère les données non fiables transmises au SDK, comme les données saisies par l’utilisateur pendant le flux de confirmation du code de l’appareil.
</ParamField>
...
<ParamField body="cancel" type="Promise<void>">
  Cette méthode annule le flux d’activation du code de l’appareil.
...
<ParamField body="confirm" type="Promise<void>">
  Cette méthode confirme le code de l’appareil et poursuit l’activation.
