...
description: "Décrit toutes les propriétés et méthodes offertes pour personnaliser l’écran `mfa-webauthn-roaming-challenge` de Universal Login."
---
...
Créez une instance du gestionnaire de l’écran de défi WebAuthn AMF itinérant :
...
<ParamField body="countryCodes" type={<span><a href="/docs/fr-ca/libraries/acul/js-sdk/Screens/interfaces/CountryCodesMembers">CountryCodesMembers</a></span>}>
  Fournit des données sur les indicatifs de pays pour la saisie du numéro de téléphone, comme `available` et `recommended`, pour l’écran `mfa-webauthn-roaming-challenge`.
</ParamField>
...
<ParamField body="untrustedData" type={<span><a href="/docs/fr-ca/libraries/acul/js-sdk/Screens/interfaces/UntrustedDataMembers">UntrustedDataMembers</a></span>}>
  Traite les données non fiables transmises au SDK, comme les saisies de l’utilisateur lors du défi WebAuthn itinérant d’AMF.
</ParamField>
...
<ParamField body="reportWebAuthnError" type="Promise<void>">
  Cette méthode signale une erreur de l’API WebAuthn rencontrée lors de l’opération `navigator.credentials.get()`.
  ...
  **Paramètres de la méthode**
  ...
  <Expandable title="Paramètres">
    ...
    <ParamField body="rememberDevice?" type="boolean">
      Lorsque défini à `true`, mémorise le navigateur pour les futures vérifications d’AMF. S’applique uniquement si `screen.showRememberDevice` est `true`.
    </ParamField>
  </Expandable>
</ParamField>