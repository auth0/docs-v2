...
La classe MfaPushList implémente la fonctionnalité de l’écran `mfa-push-list`.
...
Créez une instance du gestionnaire d’écran de liste MFA Push :
...
<ParamField body="branding" type={<span><a href="/docs/fr-ca/libraries/acul/js-sdk/Screens/interfaces/BrandingMembers">BrandingMembers</a></span>}>
  Fournit des configurations liées à l’image de marque, notamment le thème d’image de marque et les paramètres.
</ParamField>
...
<ParamField body="client" type={<span><a href="/docs/fr-ca/libraries/acul/js-sdk/Screens/interfaces/ClientMembers">ClientMembers</a></span>}>
  Fournit des configurations relatives au client, comme `id`, `name` et `logoUrl`, pour l’écran `mfa-push-list`.
</ParamField>
...
<ParamField body="countryCodes" type={<span><a href="/docs/fr-ca/libraries/acul/js-sdk/Screens/interfaces/CountryCodesMembers">CountryCodesMembers</a></span>}>
  Fournit les indicatifs de pays pour la saisie d’un numéro de téléphone, notamment `available` et `recommended`, pour l’écran `mfa-push-list`.
</ParamField>
...
<ParamField body="untrustedData" type={<span><a href="/docs/fr-ca/libraries/acul/js-sdk/Screens/interfaces/UntrustedDataMembers">UntrustedDataMembers</a></span>}>
  Gère les données non fiables transmises au SDK, comme la saisie de l’utilisateur dans la liste MFA Push.
</ParamField>
...
<ParamField body="selectMfaPushDevice" type="Promise<void>">
  Cette méthode sélectionne un appareil enregistré dans la liste pour initier un MFA push.
