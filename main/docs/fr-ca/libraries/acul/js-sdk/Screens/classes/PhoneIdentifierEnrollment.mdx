...
description: "Décrit toutes les propriétés et méthodes disponibles pour personnaliser l’écran `phone-identifier-enrollment` de Universal Login."
---
...
<ParamField body="countryCodes" type={<span><a href="/docs/fr-ca/libraries/acul/js-sdk/Screens/interfaces/CountryCodesMembers">CountryCodesMembers</a></span>}>
  Fournit les données d’indicatifs de pays pour la saisie du numéro de téléphone, comme `available` et `recommended`, pour l’écran `phone-identifier-enrollment`.
</ParamField>
...
<ParamField body="screen" type={<span><a href="/docs/fr-ca/libraries/acul/js-sdk/Screens/interfaces/ScreenMembersOnPhoneIdentifierEnrollment">ScreenMembersOnPhoneIdentifierEnrollment</a></span>}>
  Contient des renseignements propres à l’écran `phone-identifier-enrollment`, y compris sa configuration et son contexte. L’objet `screen.data` expose trois champs facultatifs : `phone`, `messageType` et `username`. Utilisez `screen.data?.username` pour afficher le nom d’utilisateur associé à la session d’enrôlement actuelle.
</ParamField>
...
<ParamField body="untrustedData" type={<span><a href="/docs/fr-ca/libraries/acul/js-sdk/Screens/interfaces/UntrustedDataMembers">UntrustedDataMembers</a></span>}>
  Traite les données non fiables transmises au SDK, comme les entrées utilisateur pendant le flux d’enrôlement du téléphone.
</ParamField>
...
<ParamField body="continuePhoneEnrollment" type="Promise<void>">
  Cette méthode poursuit le processus d’enrôlement du téléphone avec le mode de livraison sélectionné.
