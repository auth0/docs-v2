...
<ParamField body="countryCodes" type={<span><a href="/docs/fr-ca/libraries/acul/js-sdk/Screens/interfaces/CountryCodesMembers">CountryCodesMembers</a></span>}>
  Fournit les données d’indicatifs de pays pour la saisie du numéro de téléphone, comme `available` et `recommended`, pour l’écran `mfa-webauthn-platform-enrollment`.
</ParamField>
...
<ParamField body="untrustedData" type={<span><a href="/docs/fr-ca/libraries/acul/js-sdk/Screens/interfaces/UntrustedDataMembers">UntrustedDataMembers</a></span>}>
  Gère les données non fiables transmises au SDK, comme les données saisies par l’utilisateur pendant l’inscription MFA à WebAuthn de plateforme.
</ParamField>
...
<ParamField body="tryAnotherMethod" type="Promise<void>">
  Cette méthode permet à l’utilisateur de renoncer à l’inscription à WebAuthn de plateforme et de sélectionner une autre méthode MFA.
