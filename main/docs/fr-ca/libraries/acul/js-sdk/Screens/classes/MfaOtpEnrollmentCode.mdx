...
La classe MfaOtpEnrollmentCode implémente les fonctionnalités de l’écran `mfa-otp-enrollment-code`. Cet écran s’affiche lorsque l’utilisateur doit saisir le code OTP reçu pendant l’inscription AMF.

<Frame>
  <img style={{maxHeight:"400px"}} src="/docs/images/cdy7uua7fh8z/5x7zKvx9RtgMzJqkIgvE5Z/17d50fc705c6e0bf0bd75444d2b486ff/Screenshot_2025-03-26_at_00.01.21.png" alt="ACUL Code d’inscription OTP AMF" />
</Frame>

## Constructeurs {#constructors}

Créez une instance du gestionnaire de l’écran MFA OTP Enrollment Code :
...
<ParamField body="countryCodes" type={<span><a href="/docs/fr-ca/libraries/acul/js-sdk/Screens/interfaces/CountryCodesMembers">CountryCodesMembers</a></span>}>
  Fournit des données sur les indicatifs de pays pour la saisie d’un numéro de téléphone, comme `available` et `recommended`, pour l’écran `mfa-otp-enrollment-code`.
</ParamField>
...
<ParamField body="untrustedData" type={<span><a href="/docs/fr-ca/libraries/acul/js-sdk/Screens/interfaces/UntrustedDataMembers">UntrustedDataMembers</a></span>}>
  Gère les données non fiables transmises au SDK, comme les données saisies par l’utilisateur pendant l’inscription à l’AMF OTP.
</ParamField>
