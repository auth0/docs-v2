...
description: "Décrit toutes les propriétés et méthodes disponibles pour personnaliser l’écran `email-verification-result` d’Universal Login."
---

La classe EmailVerificationResult implémente la fonctionnalité de l’écran `email-verification-result`. Cet écran affiche le résultat d’une tentative de vérification du courriel.
...
<ParamField body="client" type={<span><a href="/docs/fr-ca/libraries/acul/js-sdk/Screens/interfaces/ClientMembers">ClientMembers</a></span>}>
  Fournit des configurations relatives au client, comme `id`, `name` et `logoUrl`, pour l’écran `email-verification-result`.
</ParamField>
...
<ParamField body="countryCodes" type={<span><a href="/docs/fr-ca/libraries/acul/js-sdk/Screens/interfaces/CountryCodesMembers">CountryCodesMembers</a></span>}>
  Fournit des données sur les indicatifs de pays pour la saisie du numéro de téléphone, comme `available` et `recommended`, pour l’écran `email-verification-result`.
</ParamField>
...
<ParamField body="untrustedData" type={<span><a href="/docs/fr-ca/libraries/acul/js-sdk/Screens/interfaces/UntrustedDataMembers">UntrustedDataMembers</a></span>}>
  Traite les données non fiables transmises au SDK, comme les saisies de l’utilisateur pendant le flux de vérification du courriel.
</ParamField>
  ...
  **Paramètres de la méthode**
  ...
  <Expandable title="Paramètres">
    ...
    <ParamField body="persist?" type="&#x22;session&#x22;">
      Lorsque cette option est définie sur `'session'`, la langue sélectionnée est enregistrée pour toute la durée de la session.
    </ParamField>
  </Expandable>
</ParamField>
