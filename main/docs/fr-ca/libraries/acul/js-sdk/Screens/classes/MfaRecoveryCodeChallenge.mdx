...
description: "Décrit toutes les propriétés et méthodes disponibles pour personnaliser l’écran `mfa-recovery-code-challenge` dans Universal Login."
---

La classe MfaRecoveryCodeChallenge implémente les fonctionnalités de l’écran `mfa-recovery-code-challenge`. Cet écran s’affiche lorsque l’utilisateur doit saisir un code de récupération pour se connecter.
...
Créez une instance du gestionnaire de l’écran AMF Recovery Code Challenge :
...
<ParamField body="countryCodes" type={<span><a href="/docs/fr-ca/libraries/acul/js-sdk/Screens/interfaces/CountryCodesMembers">CountryCodesMembers</a></span>}>
  Fournit des données sur les indicatifs de pays pour la saisie d’un numéro de téléphone, comme `available` et `recommended`, pour l’écran `mfa-recovery-code-challenge`.
</ParamField>
...
<ParamField body="untrustedData" type={<span><a href="/docs/fr-ca/libraries/acul/js-sdk/Screens/interfaces/UntrustedDataMembers">UntrustedDataMembers</a></span>}>
  Gère les données non fiables transmises au SDK, comme les saisies de l’utilisateur pendant l’étape de code de récupération AMF.
</ParamField>
...
<ParamField body="continue" type="Promise<void>">
  Cette méthode poursuit le flux à l’aide du code de récupération fourni.
