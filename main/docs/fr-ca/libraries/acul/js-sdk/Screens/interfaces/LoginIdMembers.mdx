...
<ParamField body="federatedLogin" type="Promise<void>">
  <Expandable title="Paramètres">
    <ParamField body="payload" type={<span><a href="/docs/fr-ca/libraries/acul/js-sdk/Screens/interfaces/FederatedLoginOptions">FederatedLoginOptions</a></span>}>
      **Propriétés**
...
<ParamField body="login" type="Promise<void>">
  <Expandable title="Paramètres">
    <ParamField body="payload" type={<span><a href="/docs/fr-ca/libraries/acul/js-sdk/Screens/interfaces/LoginOptions">LoginOptions</a></span>}>
      **Propriétés**
