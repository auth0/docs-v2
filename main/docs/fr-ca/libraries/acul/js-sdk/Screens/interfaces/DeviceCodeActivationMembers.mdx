...
export interface DeviceCodeActivationMembers extends BaseMembers {
   ...
   *
   * @param {object} payload - Un objet contenant le code saisi par l'utilisateur et toute charge utile personnalisée.
...
<ParamField body="continue" type="Promise<void>">
  ...
  Une promesse qui se résout lorsque le code est soumis avec succès.
  Est rejetée avec une erreur si la soumission échoue.

  <Expandable title="Paramètres">
    <ParamField body="payload" type={<span><a href="/docs/fr-ca/libraries/acul/js-sdk/Screens/interfaces/DeviceCodeActivationContinueOptions">DeviceCodeActivationContinueOptions</a></span>}>
      Un objet contenant le code saisi par l’utilisateur et toute charge utile personnalisée.
