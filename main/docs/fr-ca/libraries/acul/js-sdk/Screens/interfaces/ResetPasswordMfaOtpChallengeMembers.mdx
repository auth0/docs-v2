...
export interface ResetPasswordMfaOtpChallengeMembers extends BaseMembers {
  /**
   * Poursuit le défi OTP en utilisant le code fourni.
...
<ParamField body="continue" type="Promise<void>">
  ...
  <Expandable title="Paramètres">
    <ParamField body="payload" type={<span><a href="/docs/fr-ca/libraries/acul/js-sdk/Screens/interfaces/ResetPasswordMfaOtpChallengeContinueOptions">ResetPasswordMfaOtpChallengeContinueOptions</a></span>}>
...
<ParamField body="tryAnotherMethod" type="Promise<void>">
  ...
  <Expandable title="Paramètres">
    <ParamField body="payload?" type={<span><a href="/docs/fr-ca/libraries/acul/js-sdk/Screens/interfaces/ResetPasswordMfaOtpChallengeTryAnotherMethodOptions">ResetPasswordMfaOtpChallengeTryAnotherMethodOptions</a></span>}>
