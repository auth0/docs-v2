...
Interface ScreenMembers étendue de l’écran de connexion
...
<ParamField body="data" type="username?, activeIdentifierType?">
  `activeIdentifierType` est le champ d&#39;identifiant à présélectionner. Absent lorsque le serveur n&#39;en a résolu aucun — utilisez alors le premier de `email`, `username`, `phone` dans `getLoginIdentifiers()`.
</ParamField>
