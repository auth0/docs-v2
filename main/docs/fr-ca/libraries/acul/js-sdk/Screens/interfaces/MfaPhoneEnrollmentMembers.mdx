...
<ParamField body="continueEnrollment" type="Promise<void>">
  ...
  <Expandable title="Paramètres">
    <ParamField body="payload" type={<span><a href="/docs/fr-ca/libraries/acul/js-sdk/Screens/interfaces/MfaPhoneEnrollmentContinueOptions">MfaPhoneEnrollmentContinueOptions</a></span>}>
...
<ParamField body="pickCountryCode" type="Promise<void>">
  Sélectionne l’indicatif du pays pour le numéro de téléphone.
