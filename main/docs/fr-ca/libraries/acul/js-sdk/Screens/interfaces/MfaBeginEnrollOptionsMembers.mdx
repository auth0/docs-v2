...
Interface des membres de l’écran MFA Begin Enroll Options
...
<ParamField body="enroll" type="Promise<void>">
  ...
  <Expandable title="Paramètres">
    <ParamField body="payload" type={<span><a href="/docs/fr-ca/libraries/acul/js-sdk/Screens/interfaces/MfaEnrollOptions">MfaEnrollOptions</a></span>}>
