...
<ParamField body="federatedSignup" type="Promise<void>">
  <Expandable title="Paramètres">
    <ParamField body="payload" type={<span><a href="/docs/fr-ca/libraries/acul/js-sdk/Screens/interfaces/FederatedSignupOptions">FederatedSignupOptions</a></span>}>
      **Propriétés**
...
<ParamField body="signup" type="Promise<void>">
  <Expandable title="Paramètres">
    <ParamField body="payload" type={<span><a href="/docs/fr-ca/libraries/acul/js-sdk/Screens/interfaces/SignupOptions">SignupOptions</a></span>}>
      **Propriétés**
