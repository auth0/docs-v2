...
<ParamField body="data" type={<span><a href="/docs/fr-ca/libraries/acul/js-sdk/Screens/interfaces/PhonePrefix">PhonePrefix</a></span>}>
  <div id="type-declaration">
    #### Déclaration de type
  </div>

  &#123; `phone_prefixes`: [`PhonePrefix`](/docs/fr-ca/libraries/acul/js-sdk/Screens/interfaces/PhonePrefix)[]; &#125;
