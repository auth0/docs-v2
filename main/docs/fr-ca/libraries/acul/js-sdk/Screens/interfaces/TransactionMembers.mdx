...
## Connexion sociale {#socialconnection}
...
<ParamField body="passwordSecurityInfo?" type={<span><a href="/docs/fr-ca/libraries/acul/js-sdk/Screens/interfaces/PasswordComplexityRule">[PasswordComplexityRule][]</a></span>} />
