...
export interface MfaSmsListMembers extends BaseMembers {
   ...
   * @param {MfaSmsListOptions} [payload] - payload facultatif pour l'action.
...
<ParamField body="selectPhoneNumber" type="Promise<void>">
  ...
  <Expandable title="Paramètres">
    <ParamField body="payload?" type={<span><a href="/docs/fr-ca/libraries/acul/js-sdk/Screens/interfaces/MfaSmsListOptions">MfaSmsListOptions</a></span>}>
      Payload facultatif pour l’action.
