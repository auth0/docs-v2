...
<ParamField body="resendManager" type={<span><a href="/docs/fr-ca/libraries/acul/js-sdk/Screens/interfaces/ResendControl">ResendControl</a></span>}>
  <Expandable title="Paramètres">
    <ParamField body="payload?" type={<span><a href="/docs/fr-ca/libraries/acul/js-sdk/Screens/interfaces/StartResendOptions">StartResendOptions</a></span>}>
      **Propriétés**
...
<ParamField body="submitEmailChallenge" type="Promise<void>">
  <Expandable title="Paramètres">
    <ParamField body="payload" type={<span><a href="/docs/fr-ca/libraries/acul/js-sdk/Screens/interfaces/EmailChallengeOptions">EmailChallengeOptions</a></span>}>
      **Propriétés**
