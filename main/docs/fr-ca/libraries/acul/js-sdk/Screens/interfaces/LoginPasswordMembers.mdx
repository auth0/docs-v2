...
<ParamField body="federatedLogin" type="Promise<void>">
  <Expandable title="Paramètres">
    <ParamField body="payload" type={<span><a href="/docs/fr-ca/libraries/acul/js-sdk/Screens/interfaces/FederatedLoginPasswordOptions">FederatedLoginPasswordOptions</a></span>}>
      **Propriétés**
...
<ParamField body="login" type="Promise<void>">
  <Expandable title="Paramètres">
    <ParamField body="payload" type={<span><a href="/docs/fr-ca/libraries/acul/js-sdk/Screens/interfaces/LoginPasswordOptions">LoginPasswordOptions</a></span>}>
      **Propriétés**
