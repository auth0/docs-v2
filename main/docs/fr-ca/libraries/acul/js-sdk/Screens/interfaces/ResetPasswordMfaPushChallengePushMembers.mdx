...
Interface définissant les méthodes et propriétés offertes pour l’écran reset-password-mfa-push-challenge-push
...
<ParamField body="pollingManager" type={<span><a href="/docs/fr-ca/libraries/acul/js-sdk/Screens/interfaces/MfaPushPollingControl">MfaPushPollingControl</a></span>}>
  Permet d’effectuer des vérifications périodiques jusqu’à ce que le défi de notification push soit approuvé.
