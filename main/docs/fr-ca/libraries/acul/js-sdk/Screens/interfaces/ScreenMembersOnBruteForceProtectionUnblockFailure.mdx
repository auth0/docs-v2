...
export interface ScreenMembersOnBruteForceProtectionUnblockFailure extends ScreenMembers {
  /**
   * Données propres à l'écran contenant le type d'erreur de la tentative de déblocage en échec.
...
<ParamField body="data" type="errorType">
  Données propres à l’écran contenant le type d’erreur associé à la tentative de déblocage échouée.
  ...
  Le type d’erreur à l’origine de l’échec de la tentative de déblocage.
