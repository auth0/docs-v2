...
<ParamField body="continue" type="Promise<void>">
  ...
  <Expandable title="Paramètres">
    <ParamField body="payload" type={<span><a href="/docs/fr-ca/libraries/acul/js-sdk/Screens/interfaces/ContinuePayloadOptions">ContinuePayloadOptions</a></span>}>
...
<ParamField body="resendCode" type="Promise<void>">
  ...
  <Expandable title="Paramètres">
    <ParamField body="payload?" type={<span><a href="/docs/fr-ca/libraries/acul/js-sdk/Screens/interfaces/ResendCodePayloadOptions">ResendCodePayloadOptions</a></span>}>
      Options personnalisées facultatives à inclure avec la requête
    </ParamField>
  </Expandable>
</ParamField>
...
<ParamField body="tryAnotherMethod" type="Promise<void>">
  ...
  <Expandable title="Paramètres">
    <ParamField body="payload?" type={<span><a href="/docs/fr-ca/libraries/acul/js-sdk/Screens/interfaces/TryAnotherMethodPayloadOptions">TryAnotherMethodPayloadOptions</a></span>}>
      Options personnalisées facultatives à inclure avec la requête
    </ParamField>
  </Expandable>
</ParamField>