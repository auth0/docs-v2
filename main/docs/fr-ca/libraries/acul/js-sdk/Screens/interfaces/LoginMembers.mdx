...
Interface des membres de l’écran de connexion qui étend l’interface de base des membres
...
<ParamField body="federatedLogin" type="Promise<void>">
  ...
  <Expandable title="Paramètres">
    <ParamField body="payload" type={<span><a href="/docs/fr-ca/libraries/acul/js-sdk/Screens/interfaces/FederatedLoginPayloadOptions">FederatedLoginPayloadOptions</a></span>}>
...
<ParamField body="getLoginIdentifiers" type={<span><a href="/docs/fr-ca/libraries/acul/js-sdk/Screens/type-aliases/IdentifierType">IdentifierType</a>[]</span>}>
  **`Fonction utilitaire`**
...
<ParamField body="login" type="Promise<void>">
  Effectue la connexion avec un nom d’utilisateur et un mot de passe

  <Expandable title="Paramètres">
    <ParamField body="payload" type={<span><a href="/docs/fr-ca/libraries/acul/js-sdk/Screens/interfaces/LoginPayloadOptions">LoginPayloadOptions</a></span>}>
