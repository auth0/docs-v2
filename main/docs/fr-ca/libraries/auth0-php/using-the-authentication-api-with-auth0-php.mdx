---
title: "Utiliser l’Authentication API"
description: Utilisez la classe Authentication du SDK Auth0-PHP pour accéder directement à l’Authentication API d’Auth0 pour les flows code d’autorisation, Client Credentials et déconnexion.
...
## Déconnexion de l’authentification unique {#single-sign-on-logout}
