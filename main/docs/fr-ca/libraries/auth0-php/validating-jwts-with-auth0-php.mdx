---
title: 'Valider les JWT (JSON Web Tokens)'
description: Utilisez la classe Token du SDK Auth0-PHP pour analyser, vérifier et valider les JSON Web Tokens HS256 et RS256 dans votre application PHP.
