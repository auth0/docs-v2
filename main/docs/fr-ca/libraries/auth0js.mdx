...
## Migrer de v9 à v10 {#migrate-from-v9-to-v10}
...
## Exemple prêt à l’emploi {#ready-to-go-example}
...
## Configuration et initialisation {#setup-and-initialization}
...
### Configurez votre application Auth0 pour la connexion intégrée {#configure-your-auth0-application-for-embedded-login}
...
### webAuth.authorize() {#webauthauthorize}
...
### webAuth.popup.authorize() {#webauthpopupauthorize}
...
#### Gérer les résultats de l’authentification dans une fenêtre contextuelle {#handle-popup-authentication-results}
...
### webAuth.crossOriginVerification() {#webauthcrossoriginverification}
...
### buildAuthorizeUrl(options) {#buildauthorizeurloptions}
...
### Authentification unique avec authentification intégrée {#single-sign-on-with-embedded-authentication}
...
## Connexion sans mot de passe {#passwordless-login}
...
### Démarrer l’authentification sans mot de passe {#start-passwordless-authentication}
...
### Finaliser l’authentification sans mot de passe {#complete-passwordless-authentication}
...
## Extraire le authResult et obtenir des renseignements sur l’utilisateur {#extract-the-authresult-and-get-user-info}
...
## Utilisation des nonces {#using-nonces}
...
## Codes d’erreur et descriptions {#error-codes-and-descriptions}
...
## Utilisation de `checkSession` pour obtenir de nouveaux jetons {#using-checksession-to-acquire-new-tokens}
...
### Vérification périodique avec checkSession() {#polling-with-checksession}
...
## Requêtes de réinitialisation du mot de passe {#password-reset-requests}
...
### Obtenir le profil de l’utilisateur {#get-the-user-profile}
...
### Mettre à jour le profil d’utilisateur {#update-the-user-profile}
...
### Lier des utilisateurs {#link-users}
