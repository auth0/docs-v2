...
Dans cet article, nous verrons comment migrer votre application à page unique de [auth0.js](/libraries/auth0js) à [auth0-spa-js](/libraries/auth0-single-page-app-sdk). Voici une liste de scénarios basés sur auth0.js et le code équivalent auth0-spa-js.
