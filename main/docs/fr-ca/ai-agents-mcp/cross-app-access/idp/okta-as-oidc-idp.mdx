...
## Enregistrez l’application demandeuse dans Okta {#register-the-requesting-app-in-okta}

### Créer une application demandeuse dans Okta {#create-requesting-app-in-okta}
...
### Créer une application de ressources dans Okta {#create-resource-app-in-okta}
...
### Attribuer l’application de ressources aux utilisateurs de test {#assign-resource-app-to-test-users}
...
### Activer l’accès interapplications (XAA) dans l’application de ressources {#enable-cross-app-access-xaa-in-resource-app}
...
## Enregistrer l’agent IA dans Okta {#register-ai-agent-in-okta}

### Créer un agent d’IA {#create-ai-agent}
...
### Ajouter les identifiants de l’agent {#add-agent-credentials}
...
## Configurer une connexion Okta Workforce Enterprise dans Auth0 {#configure-an-okta-workforce-enterprise-connection-in-auth0}
...
## Publier votre application de ressources sur l’OIN {#publish-your-resource-app-in-oin}
