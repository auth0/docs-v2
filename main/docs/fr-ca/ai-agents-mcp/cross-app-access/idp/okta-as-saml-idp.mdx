...
## Créez et configurez votre tenant Okta {#create-and-configure-your-okta-tenant}
...
### Créer une application requérante dans Okta {#create-requesting-app-in-okta}
...
### Attribuer l’application demandeuse aux utilisateurs de test {#assign-requesting-app-to-test-users}
...
## Enregistrer l’application de ressources dans Okta {#register-the-resource-app-in-okta}

### Créer l’application de ressources dans Okta {#create-resource-app-in-okta}
...
### Attribuer l’application ressource à des utilisateurs de test {#assign-resource-app-to-test-users}
...
### Activer l’accès interapplications (XAA) dans Resource App {#enable-cross-app-access-xaa-in-resource-app}
...
## Enregistrer un agent d’IA dans Okta {#register-ai-agent-in-okta}

### Créer un agent IA {#create-ai-agent}
...
### Ajouter des identifiants d’agent {#add-agent-credentials}
...
### Ajouter des délégations d’agent {#add-agent-delegations}
...
### Ajouter des connexions de ressources d’agent {#add-agent-resource-connections}
...
### Activer l’agent {#activate-the-agent}

Dans la liste déroulante **Agent&#39;s Actions**, sélectionnez **Activate**, puis vérifiez que le **MANAGED STATUS** est **Active**.

## Configurer une connexion d’entreprise SAML dans Auth0 {#configure-a-saml-enterprise-connection-in-auth0}
...
### Tester la connexion dans Auth0 {#test-connection-in-auth0}
...
## Publiez votre Resource App sur l’OIN {#publish-your-resource-app-in-oin}
