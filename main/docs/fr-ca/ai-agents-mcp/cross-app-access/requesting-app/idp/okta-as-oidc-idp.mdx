...
## Créer et configurer votre tenant Okta {#create-and-configure-your-okta-tenant}
...
### Créer la Requesting App dans Okta {#create-the-requesting-app-in-okta}
...
### Attribuer la Requesting App aux utilisateurs de test {#assign-the-requesting-app-to-test-users}
...
## Enregistrer et configurer l&#39;agent IA dans Okta {#register-and-configure-the-ai-agent-in-okta}
...
### Créer l&#39;agent IA {#create-the-ai-agent}
...
### Configurer l&#39;enregistrement du client pour l&#39;agent IA {#set-client-registration-for-the-ai-agent}
...
### Activer l&#39;agent IA {#activate-the-ai-agent}

Sous **Actions**, sélectionnez **Activate** et vérifiez que le **Managed Status** est bien **Active**.

## Configurer la connection de la Requesting App dans Auth0 {#configure-the-requesting-app-connection-in-auth0}
...
### Ajouter le scope offline_access et mettre à jour le mapping utilisateur {#add-offline_access-scope-and-update-the-user-mapping}
...
### Activer la connection pour une application {#enable-connection-for-an-application}
...
### Tester la connection {#test-the-connection}
...
### Créer la Resource App dans Okta {#create-the-resource-app-in-okta}
...
### Attribuer la Resource App aux utilisateurs de test {#assign-resource-app-to-test-users}
...
### Activer l&#39;accès interapplications pour la Resource App {#enable-cross-app-access-for-the-resource-app}
...
### Assigner la Resource App à l&#39;agent IA {#assign-the-resource-app-to-the-ai-agent}
...
## Configurer la connection de la Resource App dans Auth0 {#configure-the-resource-app-connection-in-auth0}
...
### Ajouter le scope offline_access et mettre à jour les mappings {#add-offline_access-scope-and-update-mappings}
...
### Activer la connection pour la Resource App {#enable-the-connection-for-the-resource-app}
...
### Tester la connection {#test-the-connection-2}
...
## Configurer l&#39;accès interapplications avec Token Vault {#configure-cross-app-access-with-token-vault}
...
## Publier votre Requesting App dans l’OIN {#publish-your-requesting-app-in-oin}
