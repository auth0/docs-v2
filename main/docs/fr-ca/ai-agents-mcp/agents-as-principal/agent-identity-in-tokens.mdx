...
## Claims du sujet de l’agent {#agent-subject-claims}
...
## Configurer le serveur de ressources pour recevoir les claims de sujet de l’agent {#configure-resource-server-to-receive-agent-subject-claims}
