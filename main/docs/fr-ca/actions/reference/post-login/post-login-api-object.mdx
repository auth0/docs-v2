...
<div id="apisamlresponsesetsignaturealgorithmsignaturealgorithm-2">
  ### `api.samlResponse.setSignatureAlgorithm(signatureAlgorithm)`
</div>
...
<div id="apisamlresponsesetdigestalgorithmdigestalgorithm-2">
  ### `api.samlResponse.setDigestAlgorithm(digestAlgorithm)`
</div>
...
<div id="apisamlresponsesetencryptionalgorithmencryptionalgorithm-2">
  ### `api.samlResponse.setEncryptionAlgorithm(encryptionAlgorithm)`
</div>
