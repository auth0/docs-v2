...
Pour que les champs soient enregistrés au niveau de base du profil de l’utilisateur, leurs clés doivent correspondre à celles énumérées dans la [Documentation des points de terminaison](/api/authentication#signup).