...
### Changements rétrocompatibles, sans rupture {#backward-compatible-non-breaking-changes}
...
### Changements non rétrocompatibles et avec rupture {#backward-incompatible-breaking-changes}
...
## L’engagement d’Auth0 {#auth0s-commitment}
...
## API non documentées {#undocumented-apis}
