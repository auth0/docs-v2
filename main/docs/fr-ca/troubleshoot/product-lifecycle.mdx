...
Tout changement avec rupture déclenche le processus de dépréciation. Les clients en sont informés et ont au moins six mois pour migrer vers le nouveau comportement. Pour plus de détails, reportez-vous au [processus de dépréciation et de fin de vie](/product-lifecycle/deprecations-and-migrations).
...
* **Fenêtre de migration** : Les utilisateurs ont au moins six mois pour passer à la nouvelle version des fonctionnalités, et notre [procédure de migration](/product-lifecycle/migration-process) leur offre un soutien.
