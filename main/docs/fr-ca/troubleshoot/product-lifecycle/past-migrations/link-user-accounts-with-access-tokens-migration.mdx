...
### Lier des comptes d’utilisateur {#link-user-accounts}
...
#### Lier les comptes de l’utilisateur courant avec la Management API {#link-current-user-accounts-with-the-management-api}
...
#### Lier les comptes de l’utilisateur actuel avec auth0.js {#link-current-user-accounts-with-auth0js}
...
#### Lier n’importe quel compte d’utilisateur avec la Management API {#link-any-user-account-with-the-management-api}
...
### Dissocier des comptes d’utilisateur {#unlink-user-accounts}
