...
1. Rendez-vous à [Dashboard > Paramètres de locataire > Membres du locataire](%24%7Bmanage_url%7D/#/tenant/admins) et identifiez les membres auxquels le rôle **Administrateur d’application** est attribué. (Vous pouvez indiquer à ces membres que leur expérience dans le tableau de bord va changer : ils n’auront plus accès aux sections Utilisateurs et Connexions).
2. Rendez-vous à [Dashboard > Membres du locataire > Avancés](%24%7Bmanage_url%7D/#/tenant/advanced) et, sous **Migrations**, désactivez l’option de migration **Rôle d’administrateur d’application**.
...
1. Rendez-vous à [Dashboard > Paramètres de locataire > Membres du locataire](%24%7Bmanage_url%7D/#/tenant/admins) et identifiez les membres auxquels le rôle **Administrateur d’application** est attribué.

1. Rendez-vous à [Dashboard > Suivi > Journaux](%24%7Bmanage_url%7D/#/logs). Vérifiez quels sont les membres qui ont utilisé tableau de bord récemment.
