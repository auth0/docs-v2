...
### Activer le runtime Node 12 {#enable-node-12-runtime}
...
### Ajouter les nouvelles URL à la liste d’autorisation {#allowlist-new-urls}
...
### Republier la règle Authorization Extension {#republish-authorization-extension-rule}
...
### Configurer les URL de Delegated Administration {#configure-delegated-administration-urls}
...
### Configurer les URL du SSO Dashboard {#configure-sso-dashboard-urls}
...
### Mettre à jour les modules verrouillés {#update-pinned-modules}
