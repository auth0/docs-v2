...
## Vérifier la migration des requêtes {#verify-query-migration}
...
### validation du paramètre `q` {#q-parameter-validation}
...
## Activer Tenant Log Search v3 {#enable-tenant-log-search-v3}
