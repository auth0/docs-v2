---
description: Décrit comment migrer vos appels d’API et les réponses associées de /oauth/ro vers /oauth/token.
...
### Modifications apportées aux requêtes {#change-requests}
...
### Modifications des réponses {#response-changes}
