---
description: Décrit la migration des claims avec espace de noms Legacy vers des claims personnalisés.
...
### Taille maximale du jeton {#maximum-token-size}
...
### Audience restreinte des jetons {#restricted-token-audience}
...
## Restriction sur les espaces de noms Auth0 et Webtask {#restriction-on-auth0-and-webtask-namespaces}
...
### Claims du profil utilisateur OIDC {#oidc-user-profile-claims}
...
### Mappage d’attributs du module complémentaire SAML2 et du protocole Web Service Federation (WS-Fed) avec Auth0 Rules {#saml2-add-on-and-web-service-federation-protocol-ws-fed-attribute-mapping-with-auth0-rules}
...
### Ajouter des claims personnalisés privés sans espace de noms aux jetons {#add-private-non-namespace-claims-to-tokens}
...
### Revendications privées sans espace de noms dans /userinfo {#private-non-namespace-claims-to-userinfo}
...
### Vérifier les journaux du tenant {#review-tenant-logs}
...
### Corriger les règles Auth0 pour le module complémentaire SAML2 et le protocole Web Service Federation (Ws-Fed) {#fix-auth0-rules-for-saml2-add-on-and-web-service-federation-protocol-ws-fed}
...
### Désactiver le comportement hérité {#disable-legacy-behavior}
