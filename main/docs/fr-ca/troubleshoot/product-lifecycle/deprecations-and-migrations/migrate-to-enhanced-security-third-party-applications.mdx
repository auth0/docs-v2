...
## En quoi êtes-vous concerné ? {#how-are-you-affected}

Cette migration vous touche de deux façons :

### 1. Valeur par défaut de la Management API (dépréciation) {#1-management-api-default-the-deprecation}
...
### 2. Dynamic Client Registration (configuration indépendante) {#2-dynamic-client-registration-independent-configuration}
...
### Passez en revue vos applications tierces {#review-your-third-party-applications}
...
### Étape 1 : Choisissez comment créer de nouvelles applications tierces {#step-1-choose-how-to-create-new-third-party-applications}
...
#### Option A: Terminer la migration (recommandée) {#option-a-complete-the-migration-recommended}
...
##### 1. Testez les contrôles de sécurité renforcés {#1-test-enhanced-security-controls}
...
##### 2. Configurer les permissions d’API par défaut {#2-set-up-default-api-permissions}
...
##### 3. Valider la compatibilité {#3-validate-compatibility}
...
##### 4. Terminez la migration {#4-complete-the-migration}
...
#### Option B : Conserver le comportement actuel par défaut {#option-b-preserve-existing-behavior-as-the-default}
...
##### Avant l’échéance {#before-the-deadline}
...
##### Après la date limite {#after-the-deadline}
...
### Étape 2 : Choisissez comment gérer Dynamic Client Registration {#step-2-choose-how-to-handle-dynamic-client-registration}
...
#### Vérifier le comportement actuel de DCR {#review-current-dcr-behavior}
...
#### Configurer le mode de sécurité de DCR {#configure-dcr-security-mode}
...
### Scénario 1 : Intégrations partenaires utilisant OAuth moderne {#scenario-1-partner-integrations-using-modern-oauth}
...
### Scénario 2 : applications nécessitant OIDC {#scenario-2-applications-requiring-oidc}
...
### Scénario 3 : Dynamic Client Registration (MCP, agents d’IA) {#scenario-3-dynamic-client-registration-mcp-ai-agents}
...
### Scénario 4 : Applications utilisant Classic Login {#scenario-4-applications-using-classic-login}
...
### Scénario 5 : Applications tierces avec Organizations {#scenario-5-third-party-applications-with-organizations}
...
### Puis-je modifier le mode de sécurité d’une application existante ? {#can-i-change-the-security-mode-on-an-existing-application}
...
### Qu’arrive-t-il à mes applications tierces existantes ? {#what-happens-to-my-existing-third-party-applications}
...
### Puis-je utiliser les deux modes de sécurité dans le même tenant? {#can-i-use-both-security-modes-in-the-same-tenant}
...
### Qu’en est-il de Dynamic Client Registration? {#what-about-dynamic-client-registration}
...
### Puis-je créer des applications avec le comportement existant après la date limite? {#can-i-create-applications-with-existing-behavior-after-the-deadline}
...
### Les fonctionnalités futures fonctionneront-elles avec le comportement existant? {#will-future-features-work-with-existing-behavior}
