...
## Identifier les tenants concernés {#identify-affected-tenants}
...
## Identifier les intégrations touchées {#identify-affected-integrations}
...
## Mettre à jour les autorisations d’application {#update-application-grants}
