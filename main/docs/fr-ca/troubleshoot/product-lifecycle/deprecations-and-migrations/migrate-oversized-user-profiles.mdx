...
## Vérifier les tenants touchés {#verify-affected-tenants}
...
### Différences fonctionnelles dans les tenants non migrés {#functional-differences-in-unmigrated-tenants}
...
## Repérer les profils utilisateur surdimensionnés {#identify-oversized-user-profiles}
...
### Interroger les logs de deprecation liés aux données de user profile non plafonnées {#query-uncapped-user-profile-data-deprecation-logs}
...
### Calcul ponctuel de la taille d&#39;un profil utilisateur {#ad-hoc-calculation-of-user-profile-size}
...
## Traiter la cause fondamentale des profils utilisateur trop volumineux {#address-the-root-cause-of-oversized-user-profiles}
...
### Empêcher le stockage d&#39;attributs inutiles provenant d&#39;identity providers externes {#prevent-storage-of-unneeded-attributes-from-external-identity-providers}
...
### Utiliser l’extensibilité pour interroger dynamiquement des données métier supplémentaires {#use-extensibility-to-query-additional-business-data-dynamically}
...
### Utiliser les Enterprise Groups pour synchroniser l&#39;information de groupe {#use-enterprise-groups-to-sync-group-information}
...
## Désactiver pour terminer la migration {#opt-out-to-complete-migration}
