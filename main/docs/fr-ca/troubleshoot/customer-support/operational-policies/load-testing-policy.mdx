...
## Fenêtres de test autorisées {#acceptable-testing-windows}
...
## Politique de tests de charge pendant la période des Fêtes {#holiday-load-testing-policy}
...
## Soumettre une demande de test de charge {#submit-load-testing-request}
...
### Renseignements requis pour la demande de test de charge {#required-load-testing-information}
...
#### Estimations de charge {#load-estimates}
...
## Exigences du test {#test-requirements}
...
### Configurer le fournisseur de courriel {#configure-email-provider}
