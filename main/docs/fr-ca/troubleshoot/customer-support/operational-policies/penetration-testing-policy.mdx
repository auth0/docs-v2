...
## Soumettre une demande de test d’intrusion {#submit-penetration-testing-request}
...
### Informations requises {#information-required}
...
## Politique relative au gel des modifications {#change-freeze-policy}
...
## Exigences de test {#test-requirements}
...
## Signalement des vulnérabilités repérées {#reporting-identified-vulnerabilities}
...
## Clients de Private Cloud {#private-cloud-customers}
