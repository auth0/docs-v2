...
#### Limites de débit des API {#api-rate-limits}
...
#### Limites de connexion pour les bases de données {#database-login-limits}
...
#### Limites de simultanéité de l’extensibilité {#extensibility-concurrency-limits}
