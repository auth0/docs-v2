...
| --- | --- | --- |
| Dashboard de sécurité | Surveiller le trafic de connexion des locataires, y compris la connexion, la création de compte et les mesures de détection d’anomalie. | [Auth0SecDashboard.json](https://cdn.auth0.com/website/docs/logs/streams/datadog/Auth0SecurityDashboard.json) |
