---
description: Découvrez comment stocker les identifiants d’intégration de Flows dans le Vault afin d’y faire référence lors de l’exécution de Forms.
title: Vaults
sidebarTitle: Aperçu
---
...
## Créer et modifier des connexions Vault {#create-and-modify-vault-connections}
...
### Créer des connexions Vault depuis la page Vault {#create-vault-connections-from-the-vault-page}
...
### Créer des connexions Vault à partir de l’éditeur de flux {#create-vault-connections-from-the-flow-editor}
