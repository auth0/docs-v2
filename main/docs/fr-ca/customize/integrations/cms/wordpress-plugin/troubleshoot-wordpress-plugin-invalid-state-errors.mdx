...
## Fonctionnement de la validation de `state` {#how-state-validation-works}
...
## Causes courantes de l’erreur d’état invalide {#common-causes-of-the-invalid-state-error}
...
### URL de rappel mises en cache {#cached-callback-urls}
...
### Cookies mis en cache et paramètres d’URL {#cached-cookies-and-url-parameters}
...
### Actualisation de la page après un message d’erreur {#page-refresh-after-error-message}
...
### Exigence relative aux noms des cookies {#cookie-names-requirement}
...
### Universal Login Page et création manuelle du lien {#universal-login-page-and-link-building}
...
### Accéder directement à l’URL de rappel {#visiting-the-callback-url-directly}
...
## Résoudre les erreurs « invalid state » {#troubleshoot-invalid-state-errors}
