---
description: Découvrez comment configurer le plugin WordPress Login by Auth0 pour votre application. 
...
## Configuration d’Auth0 {#auth0-configuration}
...
### Autoriser l’application à accéder à la Management API {#authorize-the-application-for-the-management-api}
...
### Configuration de la connexion de base de données {#database-connection-setup}
...
### Configuration de la connexion sociale {#social-connection-setup}
...
### Configuration de la connexion d’entreprise {#enterprise-connection-setup}
...
## Configuration de WordPress {#wordpress-configuration}
...
## Stockage des paramètres à l’aide de constantes PHP {#php-constant-setting-storage}
