...
## Mise en place et configuration {#set-up-and-configuration}
...
### Mauvaise adresse courriel ou mauvais mot de passe {#wrong-email-or-password}
...
### Non autorisé : en-tête Authorization manquant {#unauthorized-missing-authorization-header}
...
### Impossible de modifier l’adresse courriel ou données utilisateur incorrectes {#cannot-change-email-or-incorrect-user-data}
