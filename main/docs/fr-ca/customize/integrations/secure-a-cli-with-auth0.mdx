---
description: Découvrez comment sécuriser un outil de ligne de commande avec Auth0 à l’aide des flux d’autorisation d’appareil et d’octroi des informations d’identification client.
...
## Flux d’autorisation d’appareil {#device-authorization-flow}
...
## Resource Owner Password Grant Flow {#resource-owner-password-grant-flow}
