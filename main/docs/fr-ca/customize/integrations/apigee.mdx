...
1. Accédez à [Auth0 Dashboard > Applications](%24%7Bmanage_url%7D/#/applications), puis cliquez sur le nom de votre application de test.
...
Pour apprendre à vous connecter et obtenir un jeton d’accès qui peut être utilisé pour appeler Apigee Edge, consultez [Appeler l’API en utilisant le Flux des identifiants client](/login/flows/call-your-api-using-the-client-credentials-flow).
