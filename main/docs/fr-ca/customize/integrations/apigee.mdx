...
## Créer une API personnalisée {#create-a-custom-api}
...
## Notez les variables de l’application de test {#note-variables-from-the-test-application}
...
## Mettre en œuvre le flux Client Credentials {#implement-the-client-credentials-flow}
