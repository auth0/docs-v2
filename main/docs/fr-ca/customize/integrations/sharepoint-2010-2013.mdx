...
### Étape 1. Ajout de l’intégration à votre compte {#step-1-adding-the-integration-to-your-account}
...
### Étape 2. Suivez la documentation interactive {#step-2-follow-the-live-documentation}
...
### Étape 3. SharePoint est maintenant configuré {#step-3-you-now-have-sharepoint-configured}
...
## Personnaliser la page de connexion {#customizing-the-login-page}
...
### Journaux de SP2010 {#logs-in-sp2010}
...
### Journaux dans SP2013 {#logs-in-sp2013}
...
### Synchronisation du profil utilisateur {#user-profile-synchronization}
