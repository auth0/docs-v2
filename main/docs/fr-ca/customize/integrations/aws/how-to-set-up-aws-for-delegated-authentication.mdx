...
## Créer un fournisseur SAML dans AWS {#create-a-saml-provider-in-aws}
...
## Créer un rôle pour votre fournisseur SAML {#create-a-role-for-your-saml-provider}
