...
Suivez le tutoriel intitulé [Comment configurer AWS pour l’authentification déléguée](/aws-api-setup) afin de configurer l’accès délégué à AWS par le biais du protocole SAML. Quelques mises en garde :
