...
### Step 1. Création de la table Amazon DynamoDB
...
### Step 2. Création de la politique qui accorde aux fonctions AWS Lambda l’accès à la table DynamoDB Animaux de compagnie
...
### Step 2. Création des fonctions AWS Lambda
...
### Step 3. Création de l’API de la passerelle API Amazon
