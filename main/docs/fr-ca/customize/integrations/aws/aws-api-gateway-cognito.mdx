---
description: Comment sécuriser le tutoriel API Gateway à l’aide de Cognito plutôt qu’avec des rôles IAM et des politiques.
...
## Intégrer le Cognito User Pool à l’API API Gateway {#integrate-the-cognito-user-pool-with-the-api-gateway-api}
...
## Activer le User Pool authorizer sur les méthodes {#enable-the-user-pool-authorizer-on-methods}
