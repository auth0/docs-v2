...
## Configurer Amazon Web Services {#configure-amazon-web-services}

### Obtenir les détails de l’application Auth0 {#get-auth0-application-details}
...
### Créer un nouveau fournisseur OpenID Connect (OIDC) {#create-new-openid-connect-oidc-provider}
...
### Créer un groupe d’identités {#create-identity-pool}
...
### &quot;Jeton de connexion invalide&quot; {#invalid-login-token-error}
