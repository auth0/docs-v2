...
### Créer une Regular Web Application {#create-a-regular-web-application}
...
### Créer et activer une connexion {#create-and-enable-a-connection}
...
## Configurer Azure {#configure-azure}

### Créer Azure API Management Service {#create-azure-api-management-service}
...
### Importer l’API d’exemple {#import-the-sample-api}
...
### Configurer un serveur d’autorisation OAuth 2.0 {#configure-an-oauth-20-authorization-server}
...
### Configurer l’API Azure pour utiliser Auth0 {#configure-azure-api-to-use-auth0}
...
## Définir l’Allowed Callback URL dans Auth0 {#set-the-allowed-callback-url-in-auth0}
...
## Testez l’intégration {#test-the-integration}
...
### Configurer une politique de validation JWT pour les jetons d’accès {#configure-a-jwt-validation-policy-for-access-tokens}
