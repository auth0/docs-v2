...
description: Découvrez comment migrer de l’ancienne configuration téléphonique de Guardian vers Unified Phone Experience à l’aide de l’Auth0 Terraform Provider.
---
...
## Activer la ressource de fournisseur de téléphonie et supprimer la configuration Legacy {#enable-the-phone-provider-resource-and-remove-legacy-configuration}
...
### Définir l’indicateur d’expérience consolidée {#set-the-consolidated-experience-flag}
...
### Ajouter la ressource `auth0_branding_phone_notification_template` (facultatif) {#add-the-auth0_branding_phone_notification_template-resource-optional}
...
### Nettoyez le bloc phone de la ressource Auth0 Guardian {#clean-up-the-auth0-guardian-resource-phone-block}
...
### Erreurs 403 Forbidden lors de terraform apply {#403-forbidden-errors-during-terraform-apply}
...
### Erreur 409 Conflict : le type de message n’est pas pris en charge par le fournisseur de téléphonie configuré {#409-conflict-error-message-type-is-not-supported-by-the-configured-phone-provider}
...
### Erreur Terraform apply : impossible de spécifier Provider ou options {#terraform-apply-error-provider-or-options-cannot-be-specified}
...
### Le fournisseur de téléphonie personnalisé n’achemine pas les messages {#custom-phone-provider-not-delivering-messages}
...
### Les messages OTP n’arrivent pas après la migration {#otp-messages-not-arriving-after-migration}
