...
## Configurer le DAE {#configure-the-dae}
...
### Enregistrez l’application dans Auth0 {#register-the-application-with-auth0}
...
### Créer une connexion de base de données {#create-a-database-connection}
...
### Désactiver toutes les autres connexions pour l’application Auth0 {#disable-all-other-connections-for-the-auth0-application}
...
### Créer des utilisateurs pour la connexion de base de données {#create-users-for-the-database-connection}
...
## Installer et configurer l’extension {#install-and-configure-the-extension}
