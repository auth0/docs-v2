...
## Ajouter des claims personnalisées au jeton émis {#add-custom-claims-to-the-issued-token}
...
## Contrôler l’accès à l’application {#control-app-access}
...
### Définir les rôles requis dans les métadonnées de l’application {#set-app-metadata-required-roles}
...
### Créer une règle qui applique les rôles de l’application {#create-rule-enforcing-app-roles}
