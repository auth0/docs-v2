---
description: Découvrez comment installer Authorization Extension pour mettre en œuvre le contrôle d’accès basé sur les rôles à l’aide du Dashboard.
...
### Webtask Storage {#webtask-storage}
