...
3. La section **Configuration de la règle** de la page **Configuration** s’affiche. Toutes les modifications que vous apporterez dans les sections sous **Contenu du jeton**, telles celles concernant les groupes, rôles et autorisations, seront appliquées à la règle que vous exporterez une fois cette étape terminée.
   ...
   <Frame>![Authorization Extension Configuration](/docs/images/fr-ca/cdy7uua7fh8z/4ydHJBdKGs4XVLnRst66A3/1f61ad2e087252c6c3aa10add13d99cd/configuration0auth.png)</Frame>
...
<Frame>![Authorization Extension - Configuration - Persistence](/docs/images/fr-ca/cdy7uua7fh8z/5kfgcLhwwZkQ2Oh5uxaGxF/de5cf05429d1d1730a0165f4c61ac629/persistence.png)</Frame>
