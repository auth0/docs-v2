---
description: Découvrez comment configurer l’Authorization Extension pour mettre en œuvre le contrôle d’accès basé sur les rôles.
...
## Configurer l’extension {#configure-extension}
...
## Ajouter des données d’autorisation au jeton émis {#add-authorization-information-to-the-token-issued}
...
### Fusionner les données d’autorisation provenant de l’IdP {#merge-authorization-data-from-idp}
...
### Stocker les informations d’autorisation dans les profils utilisateur {#store-authorization-information-in-user-profiles}
...
## Enregistrer les modifications apportées à la règle {#save-changes-to-rule}
