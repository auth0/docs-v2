...
## Champs prédéfinis {#predefined-fields}
...
### Champs d’information de l’utilisateur {#user-info-fields}
...
### Créer et modifier les champs utilisateur {#create-and-edit-user-fields}
...
### Exemple d’utilisation {#sample-use-2}
...
### Exemple : fournir un lien vers le fichier du dictionnaire de langue {#example-provide-link-to-language-dictionary-file}
...
### Exemple : fournir un objet de dictionnaire de langue {#example-provide-language-dictionary-object}
