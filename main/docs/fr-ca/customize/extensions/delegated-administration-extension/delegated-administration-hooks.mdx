...
Pour ajouter un message aux Journaux d'actions en temps réel (que vous pouvez consulter en utilisant Journaux d'actions en temps réel), faites appel à la méthode **log** :
