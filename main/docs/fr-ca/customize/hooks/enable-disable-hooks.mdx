...
| Valeur | Description |
| --- | --- |
| `HOOK_ID` | ID du crochet à mettre à jour. |
| `MGMT_API_ACCESS_TOKEN` | Jeton d’accès pour Management API avec la [Permission](/docs/fr-ca/glossary?term=scope) `create:hooks`. Pour en savoir plus, consultez [Jetons d’accès à Management API](/docs/fr-ca/api/management/v2/tokens). |
