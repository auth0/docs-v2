...
1. Allez à [Dashboard Auth0 > Pipelin](/docs/images/ooks](https://manage.auth0.com/#/) et cliquez sur l’icône de crayon à côté du hook que vous souhaitez mettre à jour.
