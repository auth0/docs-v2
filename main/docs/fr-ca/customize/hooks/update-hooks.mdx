...
1. Allez à [Dashboard Auth0 > Pipeline auth > Hooks](https://manage.auth0.com/#/hooks) et cliquez sur l’icône de roue dentée à côté du hook que vous souhaitez renommer.
...
1. Allez à [Dashboard Auth0 > Pipeline auth > Hooks](https://manage.auth0.com/#/hooks) et cliquez sur l’icône de crayon à côté du hook que vous souhaitez mettre à jour.
