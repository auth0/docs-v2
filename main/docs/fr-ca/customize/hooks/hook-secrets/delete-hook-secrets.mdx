...
| `MGMT_API_ACCESS_TOKEN` | Jetons d’accès à Management API avec le <dfn>scope</dfn> `update:hooks`. Pour en savoir plus, lisez [Jetons d’accès à Management API] (/api/management/v2/tokens). |
