...
| Valeur | Description |
| --- | --- |
| `MGMT_API_ACCESS_TOKEN` | Jeton d’accès à Management API avec la <dfn>permission</dfn> `create:hooks`. Pour en savoir plus, consultez [Jetons d’accès à Management API](/docs/fr-ca/api/management/v2/tokens). |