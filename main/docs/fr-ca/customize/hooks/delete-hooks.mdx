...
| Valeur | Description |
| --- | --- |
| `HOOK_ID` | Identifiant de l’appel à supprimer. |
| `MGMT_API_ACCESS_TOKEN` | Jetons d’accès à Management API avec la <dfn>permission</dfn> `update:hooks`. Pour en savoir plus, consultez [Jetons d’accès à Management API](/docs/fr-ca/api/management/v2/tokens). |