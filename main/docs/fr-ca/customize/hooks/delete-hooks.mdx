...
<td>Jetons d’accès à Management API avec la <dfn id="react-containers-DefinitionTooltip-1"><span class="tooltip-portal-underlined-word" data-react-universal-portal="">permission</span></dfn> `update:hooks`. Pour en savoir plus, consultez <a href="/docs/fr-ca/api/management/v2/tokens">Jetons d’accès à Management API</a>.</td>
</tr>
</tbody>
</table>