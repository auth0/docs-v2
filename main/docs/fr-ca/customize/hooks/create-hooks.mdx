...
<td>Jeton d’accès à Management API avec la <dfn id="react-containers-DefinitionTooltip-1"><span class="tooltip-portal-underlined-word" data-react-universal-portal="">permission</span></dfn> `create:hooks`. Pour en savoir plus, lisez <a href="/docs/fr-ca/api/management/v2/tokens">Jeton d’accès à Management API</a>.</td>
</tr>
<tr>
<td>`HOOK_NAME`</td>
