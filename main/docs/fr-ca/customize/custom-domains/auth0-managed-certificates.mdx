...
1. Allez à [Dashboard > Image de marque > Domaines personnalisés](https://manage.auth0.com/#/branding/custom_domains) et ajoutez l’enregistrement de vérification CNAME listé dans Dashboard à l’enregistrement DNS de votre domaine.
   ...
   <Frame>![Auth0 - Branding (Image de marque) - Custom Domains (Domaines personnalisés) - Auth0-Managed Certificate (Certificats gérés par Auth0) - Verify Domain (Vérifier le domaine)](/docs/images/fr-ca/cdy7uua7fh8z/3dz8ii70nm0a5amS0PNJ5K/f44d8e6e53e5c5678dcd9c045760b830/2025-02-27_10-56-49.png)</Frame>
...
| **Valeur** | Collez la valeur **CNAME** fournie par Auth0 Dashboard pour l’enregistrement DNS de votre domaine. |
