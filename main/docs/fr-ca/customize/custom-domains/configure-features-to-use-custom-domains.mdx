...
| --- | --- |
| [Connexion universelle](/docs/glossary?term=universal-login) avec une page de connexion personnalisée | [Connexion universelle](#universal-login) |
| Lock intégré dans votre application. | [Lock intégré](#embedded-lock) |
| Trousse SDK Auth0 pour les applications à page unique (SPA), Auth0.js, ou autres trousses SDK d’Auth0 | [Trousse SDK Auth0 pour les applications à page unique (SPA), Auth0.js, et autres trousses SDK](#auth0-spa-sdk-auth0-js-and-other-sdks) |
| Domaine personnalisé avec courriels Auth0 | [Utiliser des domaines personnalisés dans les courriels](#use-custom-domains-in-emails) |
| Fournisseurs d’identité sociale | [Configurer les fournisseurs d’identité sociale](#configure-social-identity-providers) |
...
| Émettre des jetons d’accès pour vos API ou accéder des API Auth0 depuis votre application | [APIs](#apis) |
| Fournisseurs d’identité [SAML](/docs/glossary?term=security-assertion-markup-language) | [Configurer des fournisseurs d’identité SAML](#configure-saml-identity-providers) |
| Applications SAML | [Configurer des applications SAML ](#configure-saml-applications) |
| Applications Web Service Federation (WS-Fed) | [Configurer des applications WS-Fed ](#configure-ws-fed-applications) |
| Connexions Entra ID | [Configurer des connexions Entra ID](#configure-azure-ad-connections) |
| Connexions ADFS | [Configurer des connexions ADFS ](#configure-adfs-connections) |
| Connexions Entra ID/LAP avec prise en charge Kerberos | [Configurer des connexions Entra ID/LAP ](#configure-ad-ldap-connections) |
