---
description: "Migrez votre connexion de fédération SAML existante d’un domaine personnalisé Auth0 hérité vers un nouveau domaine personnalisé Auth0, afin de permettre à vos tenants de tirer parti des capacités de Multiple Custom Domain (MCD)."
...
## Préparation et configuration {#setup-and-configuration}
...
### Déployer le Cloudflare Worker {#deploy-the-cloudflare-worker}
...
### Mettre temporairement à jour les paramètres de la connexion SAML {#temporarily-update-saml-connection-parameters}
