...
## Vérifier la propriété des domaines {#verify-ownership-of-domains}
...
## Planification et architecture {#planning-and-architecture}

### Choisir une stratégie de domaine {#choose-a-domain-strategy}
...
### Prévoir l’évolutivité {#plan-for-scale}
...
## Utilisez les métadonnées pour mieux vous organiser {#use-metadata-to-stay-organized}
...
### Validation de domaine dans Actions {#domain-validation-in-actions}
...
### Contrôle d’accès par organisation {#organization-based-access-control}
...
### Utiliser des domaines régionaux {#use-regional-domains}
...
## Image de marque et expérience utilisateur {#branding-and-user-experience}

### Assurez la cohérence de votre image de marque {#keep-branding-consistent}
...
### Communication avec les utilisateurs {#user-communication}
...
## Opérations et maintenance {#operations-and-maintenance}
...
## Pièges courants à éviter {#common-pitfalls-to-avoid}

### Ne compliquez pas trop la structure des domaines {#dont-over-complicate-domain-structure}
...
### N&#39;oubliez pas de mettre à jour tous les points d’intégration {#dont-forget-to-update-all-integration-points}
...
### Ne négligez pas la documentation {#dont-neglect-documentation}
...
### N’ignorez pas la gestion des certificats {#dont-ignore-certificate-management}
...
### Ne mélangez pas les contextes d’authentification {#dont-mix-authentication-contexts}
