...
<tbody>
<tr>
<td><strong><a href="https://auth0.com/docs/fr-ca/customize/custom-domains/auth0-managed-certificates">Auth0-Managed</a></strong></td>
<td>CNAME DNS record</td>
<td>Configure this record to confirm domain ownership and activate your domain.</td>
</tr>
<tr>
<td><strong><a href="https://auth0.com/docs/fr-ca/customize/custom-domains/self-managed-certificates">Self-Managed</a></strong></td>
