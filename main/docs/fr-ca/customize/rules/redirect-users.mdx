...
## Rediriger à partir de Start et reprendre l’authentification {#start-redirect-and-resume-authentication}
...
## Valider une connexion reprise {#validate-resumed-login}
...
## Exemple pour forcer un changement de mot de passe {#force-password-change-example}
...
## Où stocker les données {#where-to-store-data}
...
### S&#39;assurer que l&#39;application ouvre une session pour le même utilisateur {#ensure-app-is-logging-into-the-same-user}
...
### Renvoyer de l’information à la Rule {#pass-information-back-to-the-rule}
...
### Délai d’expiration de la session {#session-timeout}
