...
### Adresse d’expéditeur {#from-address}
...
### URL lifetime et Redirect To {#url-lifetime-and-redirect-to}
...
## Tester les modèles mis à jour {#test-updated-templates}
...
Vous pouvez déclencher manuellement des courriels de vérification pour des applications et des utilisateurs précis à l’aide du point de terminaison [Send an email address verification email](https://auth0.com/docs/api/management/v2/jobs/post-verification-email) de la Management API.

## Exemples de cas d’utilisation de personnalisation {#example-customization-use-cases}
