...
'description': "Apprenez à utiliser l’objet API custom-email-provider."
---
...
| Paramètre | Description |
| --- | --- |
| `reason` | *Chaîne*. Cela sera inclus dans l’entrée du journal et vous aidera à analyser l’erreur plus en profondeur. Veuillez noter que ce champ se limite à 1 024 caractères et sera tronqué s’il est plus long. |
