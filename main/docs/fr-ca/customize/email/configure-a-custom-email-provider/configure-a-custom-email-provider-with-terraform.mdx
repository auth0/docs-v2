...
**Scenario: Custom email provider configured using Terraform is not taking effect, and the <Tooltip href="/docs/fr-CA/glossary?term=auth0-dashboard" tip="Auth0 Dashboard
