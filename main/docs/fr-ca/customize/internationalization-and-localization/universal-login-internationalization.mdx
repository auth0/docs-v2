---
description: Découvrez comment ajouter la prise en charge de la localisation à Auth0 Universal Login afin qu’elle corresponde aux paramètres régionaux de votre application.
...
## Localisation d’Universal Login {#universal-login-localization}
...
## Localisation de Classic Login {#classic-login-localization}
