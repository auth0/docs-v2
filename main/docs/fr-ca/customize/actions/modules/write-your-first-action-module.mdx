  ...
  <Step title="Créer un module d’action" titleSize="h3" stepNumber={1}>
    ...
    <Tabs>
      {/* 
                          ...
                          1. Obtenez un jeton d’accès de l’Auth0 Management API.
                          2. Effectuez une request vers [Create Module](https://auth0.com/docs/api/management/v2/actions/post-action-module):
                          <Tabs><Tab title="Auth0 CLI">

                          <Callout icon="file-lines" color="#0EA5E9" iconType="regular">Vous utilisez l’Auth0 CLI? Si ce n’est pas déjà fait, [configurez et authentifiez votre session CLI](/docs/deploy-monitor/auth0-cli) avant d’exécuter cette commande.</Callout>
