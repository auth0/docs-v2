---
description: Le **package Actions NPM (`@auth0/actions`)** permet le développement en TypeScript dans des projets externes, ce qui aide les développeurs à suivre les pratiques exemplaires et à améliorer leurs **tests unitaires** grâce aux définitions TypeScript.
