...
### Réinitialisation sécurisée du mot de passe avec des facteurs MFA supplémentaires {#secure-password-reset-with-additional-mfa-factors}
...
### Rediriger les utilisateurs vers une application tierce {#redirect-users-to-a-third-party-application}
