...
## Échange de jetons personnalisé et Actions post-connexion {#custom-token-exchange-vs-post-login-actions}
...
## Prise en charge de l’acteur pour la délégation {#actor-support-for-delegation}
...
## Partager des données avec les Actions post-connexion {#share-data-with-post-login-actions}
