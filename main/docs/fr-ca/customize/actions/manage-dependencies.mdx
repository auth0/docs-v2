---
description: Ajoutez des packages du registre `npm` comme dépendances à Auth0 Actions à l’aide de l’Actions Code Editor dans Auth0 Dashboard ou de la Management API, puis consultez les recommandations de sécurité et les limites liées aux modules natifs et privés.
...
## Ajouter une dépendance à l’aide de l’Actions Code Editor {#add-a-dependency-using-the-actions-code-editor}
...
## Ajouter une dépendance à l’aide de l’Auth0 Management API {#add-a-dependency-using-the-auth0-management-api}
...
## Limites des dépendances dans Actions {#limitations-for-dependencies-in-actions}

### Aucune prise en charge des modules natifs {#no-native-module-support}
...
### Les modules privés et les registres privés ne sont pas pris en charge {#no-private-module-or-private-registry-support}
