---
og:description: Describes how to pass user or application metadata between login and
  post-login Actions.
og:image: https://cdn2.auth0.com/docs/1.14553.0/img/share-image.png
og:title: Métadonnées de transaction d'actions
og:url: https://auth0.com/docs/
permalink: transaction-metadata
title: Métadonnées de transaction d'actions
twitter:description: Describes how to pass user or application metadata between login
  and post-login Actions.
twitter:title: Métadonnées de transaction d'actions
---
