...
## Afficher une page d’erreur personnalisée {#display-a-custom-error-page}
...
### Rediriger les utilisateurs vers une page d’erreur personnalisée à l’aide du Dashboard {#redirect-users-to-a-custom-error-page-using-the-dashboard}

Utilisez le Dashboard pour configurer Auth0 afin qu’il redirige les utilisateurs vers une page d’erreur personnalisée :

1. Accédez à [Auth0 Dashboard &gt; Settings](https://manage.auth0.com/#/tenant/).
...
### Rediriger les utilisateurs vers une page d’erreur personnalisée à l’aide de la Management API {#redirect-users-to-a-custom-error-page-using-the-management-api}
...
### Afficher une page d’erreur personnalisée {#render-a-custom-error-page}
