---
description: Découvrez comment ajouter des champs personnalisés et du texte aux prompts d'inscription et de connexion d'Auth0 Universal Login. 
...
## Utilisez Auth0 Dashboard pour gérer les Partials {#use-the-auth0-dashboard-to-manage-partials}
...
## Gérer les Partials par programmation {#manage-partials-programmatically}
...
## Styliser et valider les champs de formulaire {#style-and-validate-form-inputs}
...
## Localiser le contenu {#localize-content}
...
### Créer ou mettre à jour une variable de texte personnalisée {#create-or-update-a-custom-text-variable}
...
### Utiliser une variable de texte personnalisée dans un Partial {#use-a-custom-text-variable-in-a-partial}
...
## Valider et enregistrer les données capturées {#validate-and-save-captured-data}
...
### Enregistrer dans les métadonnées utilisateur {#save-to-user-metadata}
