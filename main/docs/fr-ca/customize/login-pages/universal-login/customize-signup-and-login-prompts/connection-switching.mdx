---
description: Découvrez comment mettre en œuvre le basculement flexible entre les connexions dans Universal Login
...
## Mettre en œuvre le basculement flexible entre les connexions {#implement-flexible-connection-switching}
...
### Configurer l’écran d’inscription {#configure-signup-prompt}
...
### Configurer les prompts de connexion {#configure-login-prompts}
