...
* Enable the following for your application:
  ...
  + [Identifier First authentication](/docs/fr-ca/authenticate/login/auth0-universal-login/identifier-first)
  + [Database connection](/docs/fr-ca/authenticate/database-connections)
  + [Email or SMS passwordless authentication](/docs/fr-ca/authenticate/login/auth0-universal-login/passwordless-login/email-or-sms)
