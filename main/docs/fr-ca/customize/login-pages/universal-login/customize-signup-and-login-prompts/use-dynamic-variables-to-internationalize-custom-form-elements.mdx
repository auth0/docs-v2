---
description: Découvrez comment utiliser des variables dynamiques pour afficher des prompts d’inscription et de connexion Universal Login localisés.
...
### Activer les locales fr et es {#enable-fr-and-es-locales}
...
### Afficher conditionnellement des champs personnalisés {#conditionally-render-custom-fields}
...
### Ajouter la validation {#add-validation}
