...
The Classe d’écran de réinitialisation de mot de passe is part of the [Identifier First Authentication](/docs/authenticate/login/auth0-universal-login/identifier-first) flow and resets the user's password.
...
The Classe d’écran de réinitialisation de mot de passe method is:
...
The Classe d’écran de courriel de réinitialisation de mot de passe is part of the [Identifier First Authentication](/docs/authenticate/login/auth0-universal-login/identifier-first) flow and sends the user email instructions to reset their password.
...
The Classe d’écran d’erreur de réinitialisation de mot de passe is part of the [Identifier First Authentication](/docs/authenticate/login/auth0-universal-login/identifier-first) flow and sends the user back to your application.
...
The Classe d’écran de demande de réinitialisation de mot de passe is part of the [Identifier First Authentication](/docs/authenticate/login/auth0-universal-login/identifier-first) flow and prompts the user for an email to send reset password instructions.
...
The Classe d’écran de succès de réinitialisation de mot de passe is part of the [Identifier First Authentication](/docs/authenticate/login/auth0-universal-login/identifier-first) flow and confirms the password change and returns the user to your application.
...
<Frame>![](/images/cdy7uua7fh8z/3syDeetKM505pFoJ1ND8M3/a8d25ad3d0ba2af508af9a9aa0d5d25e/Screenshot_2025-03-26_at_09.16.08.png)</Frame>
...
<Frame>![](/images/cdy7uua7fh8z/4llG8aTJRKxkgGSgZBhFOa/327e242fda0888af45f56286fc6d6098/Screenshot_2025-03-26_at_09.15.22.png)</Frame>
...
<Frame>![](/images/cdy7uua7fh8z/5nxfRZqcpBBwzZGlJ7wm8y/a8b3a66ec4ffc07dd934b734e021c306/Screenshot_2025-04-24_at_09.53.31.png)</Frame>
...
<Frame>![](/images/cdy7uua7fh8z/5ANIhgOJURo2z0YXmWKp7M/5f266f0a935c047d6159874cbfc2001a/Screenshot_2025-03-26_at_09.15.46.png)</Frame>
...
<Frame>![](/images/cdy7uua7fh8z/7mRIJkXjAxcU7umESGV64m/0e896869def1890baa49525f4c5bb626/Screenshot_2025-04-24_at_10.21.01.png)</Frame>
...
<Frame>![](/images/cdy7uua7fh8z/5OG4dIYE3SdDFB6UFllA8I/71aa4814218a2361ec2947c59af9ff9c/Screenshot_2025-03-26_at_09.16.29.png)</Frame>
...
<Frame>![](/images/cdy7uua7fh8z/7EFAO2d9zl0TPuIcIh48he/1894ee8d140bd9fd47f1e303110e474f/Screenshot_2025-04-24_at_10.38.50.png)</Frame>
...
<Frame>![](/images/cdy7uua7fh8z/7aNLJSP1f1xmQI9RIc7bQh/98db8a7a627e84896b50cf219497c345/Screenshot_2025-05-28_at_12.43.54.png)</Frame>
...
<Frame>![](/images/cdy7uua7fh8z/oisvWlYTRgpQ030322WZk/23921a030cdb6f1cf7b147da5315ea8e/Screenshot_2025-05-28_at_13.12.43.png)</Frame>
