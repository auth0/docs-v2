---
description: Déployez un projet Auth0 Advanced Customizations for Universal Login en production en téléversant le lot généré sur votre CDN et en mettant à jour la configuration de chaque écran dans Auth0.
...
### 1. Configuration d’Auth0 {#1-auth0-configuration}
...
### 2. Téléversez et diffusez vos ressources avec Amazon Web Services {#2-upload-and-serve-your-assets-with-amazon-web-services}
...
### 3. Créez un rôle AWS IAM pour GitHub Actions {#3-create-an-aws-iam-role-for-github-action}
...
### 4. Configurer votre dépôt GitHub {#4-configure-your-github-repository}
...
### 5. Configurer votre déploiement {#5-configure-your-deployment}
