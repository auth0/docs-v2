...
## Utilisation du widget Lock {#using-the-lock-widget}
...
### Exemples de scripts de personnalisation de la connexion {#sample-login-customization-scripts}

#### Personnaliser le logo de l’application {#customize-the-application-logo}
...
#### Personnaliser les conditions d’inscription {#customize-the-signup-terms}
...
## Utiliser Auth0 SDK for Web {#using-the-auth0-sdk-for-web}
