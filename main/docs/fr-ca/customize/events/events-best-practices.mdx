...
### Utilisez des files d’attente asynchrones pour traiter les événements {#use-asynchronous-queues-to-process-events}
...
### Ignorer les événements en double {#ignore-duplicate-events}
...
### Gérer les événements hors séquence {#handle-out-of-sequence-events}
...
### Écouter certains types d’événements {#listen-for-specific-event-types}
...
### Comportement du système lors des échecs de livraison d’événements {#system-behavior-during-failed-event-deliveries}
...
### Désactiver les flux d’événements défaillants {#disable-failing-event-streams}
