...
## Pourquoi corréler les changements d’identité {#why-correlate-identity-changes}
...
## Mettre en place la corrélation des identités {#implement-identity-correlation}
...
### Mapper les utilisateurs Auth0 à des enregistrements externes {#map-auth0-users-to-external-records}
...
### Gérer user.created {#handle-usercreated}
...
## Gérer les cas particuliers {#handle-edge-cases}
...
## Exemple : Corréler avec HubSpot CRM {#example-correlate-with-hubspot-crm}
...
## Vérifier la corrélation {#verify-correlation}
