...
description: Demandez, au moyen d’un dossier de soutien, l’exportation chiffrée avec PGP des hachages de mot de passe et des secrets MFA de votre tenant Auth0.
---
...
## Générez votre paire de clés PGP {#generate-your-pgp-key-pair}

Cette section utilise [GnuPG (`gpg`)](https://gnupg.org/), l’outil standard en ligne de commande pour OpenPGP. Pour d’autres outils ou des options avancées, consultez le [manuel de GnuPG](https://www.gnupg.org/gph/en/manual.html).

### Installer GnuPG {#install-gnupg}
...
<Callout icon="file-lines" color="#0EA5E9" iconType="regular">
  * Utilisez l’adresse courriel exacte enregistrée pour votre compte d’administrateur de tenant lors de la génération de la clé. Les alias ou une casse différente peuvent faire échouer la validation. La requête de soutien doit également être soumise par le même administrateur de tenant qui a généré la clé.
...
### Exportez votre clé publique {#export-your-public-key}
...
## Processus de demande {#request-process}

<Steps>
  <Step title="Soumettre une demande de soutien">
    [Ouvrez un dossier de soutien](https://support.auth0.com/center/s/) pour demander une exportation des hachages de mots de passe ou des secrets MFA. Incluez les éléments suivants dans votre demande :
...
## Rappels de sécurité {#security-reminders}
