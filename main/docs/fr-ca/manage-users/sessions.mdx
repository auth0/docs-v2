---
description: Découvrez comment les sessions Auth0 peuvent vous aider à gérer le statut d’authentification de vos utilisateurs. 
...
## Cas d’utilisation des sessions {#session-use-cases}
...
#### L’utilisateur se connecte avec son nom d’utilisateur et son mot de passe {#user-logs-in-with-username-and-password}
...
#### L’utilisateur se connecte avec un fournisseur d’identité {#user-logs-in-with-identity-provider}
...
### Gestion des sessions pour les SPA {#session-management-for-spas}
