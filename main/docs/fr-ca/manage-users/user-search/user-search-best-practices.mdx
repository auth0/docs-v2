...
* Un jeton est nécessaire pour effectuer des requêtes auprès de Management API. Pour en savoir plus, lisez [Jetons d’accès à Management API](/security/tokens/access-tokens/management-api-access-tokens).
