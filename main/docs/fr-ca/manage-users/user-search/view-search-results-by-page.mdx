...
| --- | --- |
| `page` | Le numéro de page, basé sur zéro. Si ce paramètre n’est pas défini, nous renvoyons un maximum de 50 enregistrements, quel que soit le nombre d’enregistrements existants. |
| `per_page` | Le nombre d’utilisateurs par page. |
| `include_totals` | Défini à `true` pour inclure un résumé de la requête dans le résultat. |
