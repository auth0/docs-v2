...
Ces paramètres sont configurés sur le locataire; vous pouvez les configurer à l’aide de [Auth0 Dashboard](/users/sessions/configure-session-lifetime-settings) ou de Management API.
