...
## Durée de vie de la session {#session-lifetime}
...
### Délai d’inactivité {#idle-timeout}
...
### Délai d’expiration absolu (maximum) {#absolute-timeout-maximum}
...
## Limites de durée de vie de la session {#session-lifetime-limits}
...
## Expiration des sessions des fournisseurs d’identité en amont {#session-expiry-from-upstream-identity-providers}
