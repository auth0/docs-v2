---
description: Gérez les sessions utilisateur avec l’Auth0 Management API pour répertorier les sessions actives, révoquer des sessions individuelles ou mettre fin à toutes les sessions.
...
## Points de terminaison de la Management API {#management-api-endpoints}
...
### Ressource de session {#session-resource}
...
### Ressource utilisateur {#user-resource}
...
## Propriétés de la session {#session-properties}
...
## OIDC Back-Channel Logout Initiators {#oidc-back-channel-logout-initiators}
...
## Sessions et jetons d’actualisation {#sessions-and-refresh-tokens}
