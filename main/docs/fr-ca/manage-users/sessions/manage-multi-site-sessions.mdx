...
## Sessions de courte durée {#short-lived-sessions}
...
### Fonctionnalités du SDK {#sdk-features}
...
#### Avertissez les utilisateurs pour qu’ils poursuivent leur session {#warn-users-to-continue-their-sessions}
...
### Exemple de flux de travail {#example-workflow}
...
#### Authentification initiale {#initial-authentication}
...
#### Maintenir la session Auth0 {#maintain-auth0-session}
...
#### Demander à l’utilisateur de prolonger la session {#prompt-user-to-extend-session}
...
#### L’utilisateur se déconnecte explicitement de l’application {#user-explicitly-logs-out-of-application}
...
#### L’utilisateur revient à l’application initiale après s’être déconnecté {#user-returns-to-initial-application-after-logging-out}
...
## Sessions de longue durée {#long-lived-sessions}
