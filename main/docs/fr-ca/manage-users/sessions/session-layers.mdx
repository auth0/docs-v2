---
description: Découvrez les couches de session Auth0 créées lorsqu’un utilisateur se connecte, soit la session d’application, la session Auth0 et la couche de session IdP.
...
#### URL de redirection {#redirect-urls}
...
#### Durée de vie de la session et délai d’expiration de la session {#session-lifetime-and-session-timeout}
