---
description: Configurez les flux de connexion Auth0 Organizations, y compris les paramètres d’invite, l’authentification Identifier First, la découverte de domaine et l’auto-adhésion.
...
## Configurez l’expérience de connexion de votre application {#configure-the-login-experience-of-your-application}
...
## Configurez le flux de connexion de votre application {#configure-the-login-flow-for-your-application}
...
## Identifier First Authentication avec demande des identifiants {#identifier-first-authentication-with-prompt-for-credentials}
...
## Identifier First Authentication avec invite pour l’Organization {#identifier-first-authentication-with-prompt-for-organization}
...
### Organization Domain Discovery (facultatif) {#organization-domain-discovery-optional}
