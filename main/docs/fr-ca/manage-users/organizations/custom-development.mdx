---
description: Personnalisez le comportement des organisations Auth0 avec les Actions et les SDKs, notamment les flux de connexion adaptés aux organisations, l’attribution de rôles et les jetons de contexte des membres.
...
### Objet d’événement des Actions {#actions-event-object}
...
### Je veux que les utilisateurs se connectent à une organisation précise {#i-want-users-to-log-in-to-a-specified-organization}
...
### Depuis mon application, je veux obtenir l’organisation à laquelle l’utilisateur authentifié s’est connecté {#from-my-application-i-want-to-get-the-organization-to-which-the-authenticated-user-logged-in}
...
### Dans mon API, je veux récupérer l’organisation pour laquelle le jeton d’accès a été émis {#from-my-api-i-want-to-get-the-organization-with-which-the-access-token-was-issued}
