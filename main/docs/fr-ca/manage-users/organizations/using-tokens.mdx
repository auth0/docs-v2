...
## Authentifier les utilisateurs par l’intermédiaire d’une organisation {#authenticate-users-through-an-organization}
...
## Autorisations des rôles d’organisation {#organization-role-permissions}
...
## Accès machine à machine à une Organisation {#machine-to-machine-access-to-an-organization}
...
## Valider les jetons {#validate-tokens}
