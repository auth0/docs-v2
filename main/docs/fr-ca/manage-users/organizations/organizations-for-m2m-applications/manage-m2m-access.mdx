...
## Autoriser l’accès M2M {#authorize-m2m-access}
...
## Révoquer l’accès M2M {#revoke-m2m-access}
...
## Auditer l’accès M2M {#audit-m2m-access}
...
### Accès accordé par association directe {#access-granted-via-direct-association}
...
### Accès accordé à toute organisation {#access-granted-to-any-organization}
...
### Rechercher des applications selon l’accès de l’organisation {#search-applications-based-on-organization-access}
...
### Journaux du locataire {#tenant-logs}
