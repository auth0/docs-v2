...
### Tableau du comportement de l’organisation {#define-organization-behavior-table}
...
### Définir le comportement de l’organisation pour une application {#define-organization-behavior-for-an-application}
...
## Définir l’organisation par défaut {#set-default-organization}
...
### Tableau de définition de l’organisation par défaut {#set-default-organization-table}
...
### Définir l’organisation par défaut pour une application {#set-default-organization-for-an-application}
...
<Tabs>
  <Tab title="Auth0 Dashboard">
    ...
    <Frame>![Auth0 Dashboard > Applications > sélectionner l’expérience de connexion](/docs/images/cdy7uua7fh8z/29rhTFMnYDp7TbGS9S6b5J/19241fae86a5fa01a90eeb364e96b0ca/2025-07-18_15-49-47.png)</Frame>
  </Tab>
