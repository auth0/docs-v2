...
<td><a href="/docs/fr-ca/secure/tokens/access-tokens/management-api-access-tokens">Jetons d’accès pour Management API</a> avec la permission `create:organization_members`.</td>
</tr>
<tr>
<td>`USER_ID`</td>
