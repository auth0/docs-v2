...
| `MGMT_API_ACCESS_TOKEN` | [Jetons d’accès pour Management API](/docs/fr-ca/tokens/management-api-access-tokens) avec la permission `create:organization_members`. |
