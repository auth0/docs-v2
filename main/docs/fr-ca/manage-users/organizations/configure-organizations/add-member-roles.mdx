...
<td><a href="/docs/fr-ca/secure/tokens/access-tokens/management-api-access-tokens">Jeton d’accès à Management API</a> avec la permission `create:organization_member_roles`.</td>
</tr>
<tr>
<td>`USER_ID`</td>
