...
<td><a href="/docs/fr-ca/secure/tokens/access-tokens/management-api-access-tokens">Jeton d’accès pour Management API</a> avec la permission `delete:organization_members`.</td>
</tr>
<tr>
<td>`USER_ID`</td>
