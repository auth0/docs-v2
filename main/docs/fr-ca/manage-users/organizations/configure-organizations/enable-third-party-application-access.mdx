...
## Activer l’accès aux applications tierces pour l’Organisation {#enable-third-party-application-access-on-the-organization}

Vous pouvez activer l’accès aux applications tierces à l’aide d’Auth0 Dashboard ou de l’API Management.
...
<Tabs>
  <Tab title="Auth0 Dashboard">
    ...
    3. Sous **accès aux applications tierces**, sélectionnez **Allow Third-Party Application Access**.
    4. Sélectionnez **Save**.
    ...
    <Frame>![Paramètres de l’Organisation affichant les options d’accès aux applications tierces](/docs/images/third-party-applications/org-third-party-access-settings.png)</Frame>
  </Tab>
...
## Exigences relatives aux connexions {#connection-requirements}
...
## Flux de connexion des organisations pour les applications tierces {#organization-login-flows-for-third-party-applications}
...
## Accès machine à machine {#machine-to-machine-access}
