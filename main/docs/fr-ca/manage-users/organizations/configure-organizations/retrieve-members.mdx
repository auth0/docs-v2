...
<td><a href="/docs/fr-ca/secure/tokens/access-tokens/management-api-access-tokens">Jeton d’accès à Management API</a> avec la permission `read:organization_members`.</td>
</tr>
</tbody>
</table>
