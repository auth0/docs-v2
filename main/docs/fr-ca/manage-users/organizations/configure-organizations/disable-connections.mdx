...
<td><a href="/docs/fr-ca/secure/tokens/access-tokens/management-api-access-tokens">Jeton d’accès pour Management API</a> avec la permission `delete:organization_connections`.</td>
</tr>
<tr>
<td>`CONNECTION_ID`</td>
