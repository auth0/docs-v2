...
<td><a href="/docs/fr-ca/secure/tokens/access-tokens/management-api-access-tokens">Jetons d’accès pour Management API</a> avec la permission `update:clients`.</td>
</tr>
<tr>
