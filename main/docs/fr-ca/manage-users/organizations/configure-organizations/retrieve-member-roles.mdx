...
<td><a href="/docs/fr-ca/secure/tokens/access-tokens/management-api-access-tokens">Jeton d’accès pour Management API</a> avec la permission `read:organization_member_roles`.</td>
</tr>
</tbody>
</table>
