...
* **Auth0 Dashboard** : Sélectionnez [Paramètres](/tenant-settings) dans le menu de gauche et choisissez l’onglet **Avancé**. Dans la section **Réglages**, activez la bascule **Autoriser les noms d’organisation dans Authentication API**.
