...
## Considérations et recommandations {#considerations-and-recommendations}
...
### Considérations relatives à la facilité d’utilisation et à la sécurité {#usability-and-security-considerations}
...
### Pratiques exemplaires recommandées {#recommended-best-practices}
