...
| --- | --- |
| [Configurer votre application pour l’accès M2M](/docs/fr-ca/manage-users/organizations/organizations-for-m2m-applications/configure-your-application-for-m2m-access) | Paramètres généraux de l’application pour contrôler l’accès M2M aux organisations pour chaque API de votre locataire. |
| [Autoriser l’accès M2M](/docs/fr-ca/manage-users/organizations/organizations-for-m2m-applications/authorize-m2m-access) | Comment accorder l’accès par une application à une ou plusieurs organisations spécifiques. |
| [Révoquer l’accès M2M](/docs/fr-ca/manage-users/organizations/organizations-for-m2m-applications/revoke-m2m-access) | Comment révoquer une autorisation d’accès par une application à une ou plusieurs organisations spécifiques. |
| [Auditer l’accès M2M](/docs/fr-ca/manage-users/organizations/organizations-for-m2m-applications/audit-m2m-access) | Comment vérifier l’accès M2M actuellement configuré pour chaque application et organisation de votre locataire. |
...
<Frame>![](/docs/images/fr-ca/cdy7uua7fh8z/6LksrBOcNzo2RXI3Tp6mCo/68f23a60fc0e3a50ceaea8e6e0bbdd8c/image4.png)</Frame>
...
<Frame>![](/docs/images/fr-ca/cdy7uua7fh8z/5bMEPlmTLGgBn8fq5Fp59S/62b73352d8c23e979994ee24266357c5/image7.png)</Frame>
