...
## Autoriser l’accès uniquement aux utilisateurs se trouvant à l’intérieur du réseau d’entreprise {#allow-access-only-to-users-who-are-inside-the-corporate-network}
...
## Rejeter l’accès à quiconque appelle une API {#deny-access-to-anyone-calling-an-api}
...
## Ajouter les rôles d’un utilisateur aux jetons {#add-user-roles-to-tokens}
...
## Gérer les rôles de Delegated Administration Extension à l’aide de l’ensemble de fonctionnalités Authorization Core {#manage-delegated-administration-extension-roles-using-the-authorization-core-feature-set}
