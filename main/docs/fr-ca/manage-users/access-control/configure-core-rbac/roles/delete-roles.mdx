---
description: Découvrez comment supprimer un rôle dans l’Auth0 Dashboard ou avec la Management API.
...
1. Allez à [Dashboard &gt; User Management &gt; Roles](https://manage.auth0.com/#/roles), puis cliquez sur le nom du rôle à afficher.
