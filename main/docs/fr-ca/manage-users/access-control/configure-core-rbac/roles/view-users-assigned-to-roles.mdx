...
| Colonne | Description |
| --- | --- |
| Photo | Photo de l’utilisateur depuis son profil. |
| Nom | Nom d’utilisateur à partir du profil utilisateur. |
| Adresse courriel | Adresse courriel de l’utilisateur à partir du profil utilisateur. |
