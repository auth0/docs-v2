...
| Valeur                  | Description                                                                                                           |
| ----------------------- | --------------------------------------------------------------------------------------------------------------------- |
| `ROLE_ID`               | ID du rôle pour lequel vous voulez modifier la définition.                                                            |
| `MGMT_API_ACCESS_TOKEN` | [Access Token for the Management API](https://auth0.com/docs/api/management/v2/tokens) avec la portée `update:roles`. |
| `ROLE_NAME`             | Nom du rôle.                                                                                                          |
| `ROLE_DESC`             | Description du rôle facile à comprendre.                                                                              |

<div id="learn-more">
  ## En savoir plus
</div>

* [Assigner des Roles aux Users](/docs/fr-ca/manage-users/access-control/configure-core-rbac/rbac-users/assign-roles-to-users)