...
| Colonne | Description |
| --- | --- |
| Nom | Nom de l’autorisation, tiré de la définition de l’autorisation. |
| Description | Description de l’autorisation tirée de la définition de l’autorisation. |
| API | Nom de l’API à laquelle est jointe l’autorisation. |
...
| Valeur | Description |
| --- | --- |
| `ROLE_ID` | Identifiant du rôle pour lequel vous voulez obtenir des autorisations. |
| `MGMT_API_ACCESS_TOKEN` | [Jeton d’accès à Management API](https://auth0.com/docs/api/management/v2/tokens) avec la permission `read:users`. |
