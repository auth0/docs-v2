...
Vous pouvez supprimer les [autorisations](/docs/fr-ca/manage-users/access-control/rbac) attribuées à un rôle en utilisant Dashboard ou <Tooltip href="/docs/fr-ca/glossary?term=management-api" tip="Management API
...
| `MGMT_API_ACCESS_TOKEN` | [Jeton d’accès à Management API](https://auth0.com/docs/api/management/v2/tokens) avec la permission `update:roles`. |
