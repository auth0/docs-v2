---
description: Apprenez à supprimer des permissions ajoutées à un rôle à l’aide de l’Auth0 Dashboard ou de la Management API.
...
1. Accédez à [Dashboard &gt; User Management &gt; Roles](https://manage.auth0.com/#/roles), puis cliquez sur le nom du rôle pour l’afficher.
...
Faites une requête `DELETE` vers le [point de terminaison Delete Role Permissions](https://auth0.com/docs/api/management/v2#!/Roles/delete_role_permission_assignment). Assurez-vous de remplacer les valeurs de l’espace réservé `ROLE_ID`, `MGMT_API_ACCESS_TOKEN`, `API_ID` et `PERMISSION_NAME` par l’ID de votre rôle, votre jeton d’accès Management API <Tooltip tip="Jeton d’accès : information d’authentification, sous la forme d’une chaîne opaque ou d’un JWT, utilisée pour accéder à une API." cta="Voir le glossaire" href="/docs/fr-ca/glossary?term=access+token">jeton d’accès</Tooltip>, le ou les ID d’API et le ou les noms de permissions, respectivement.
...
| Valeur                  | Description                                                                                                            |
| ----------------------- | ---------------------------------------------------------------------------------------------------------------------- |
| `ROLE_ID`               | L’ID du rôle dont vous souhaitez supprimer des permissions.                                                            |
...
| `API_ID`                | ID de la ou des API associées à la ou aux permissions que vous souhaitez supprimer pour le rôle indiqué.               |
| `PERMISSION_NAME`       | Nom de la ou des permissions que vous souhaitez supprimer pour le rôle indiqué.                                        |
