...
### Attribuer des rôles dans la liste des utilisateurs {#assign-roles-in-user-list}
...
### Attribuer des rôles dans le profil de l’utilisateur {#assign-roles-in-user-profile}
