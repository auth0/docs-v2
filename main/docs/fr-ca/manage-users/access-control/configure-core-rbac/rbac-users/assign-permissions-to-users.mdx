...
### Attribuer une autorisation dans la liste des utilisateurs {#assign-permission-in-user-list}
...
### Attribuer des permissions dans le profil utilisateur {#assign-permissions-in-user-profile}
