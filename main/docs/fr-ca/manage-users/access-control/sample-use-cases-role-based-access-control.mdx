...
Examinons un exemple des raisons pour lesquelles vous pourriez avoir besoin du [contrôle d'accès basé sur les rôles (RBAC)](/rbac) dans votre flux d’autorisation et comment vous pourriez l’utiliser.
...
Au lieu de cela, vous mettez en œuvre l’autorisation basée sur les rôles, [ en créant quelques permissions](/apis/add-api-permissions) dont les utilisateurs de votre module de point de vente de boutique de cadeaux auront besoin :

* `read:catalog-item`
* `read:customer-profile`
* `create:invoice`

Pour faciliter la gestion de ces autorisations, vous [créez un rôle](/rbac/roles/create-roles) appelé `Gift Shop Manager` et [ajoutez ces autorisations à ce rôle](/rbac/roles/add-permissions-to-roles).
