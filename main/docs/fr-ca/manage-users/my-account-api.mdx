...
Vous ne pouvez pas mettre à jour les application, API et politique pour client et accès dans My Account API, ce qui signifie que vous ne pouvez pas <span accès My Account API en utilisant flux des identifiants client.
