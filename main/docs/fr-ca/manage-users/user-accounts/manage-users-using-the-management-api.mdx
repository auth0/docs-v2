...
<tr>
<td>`create:users`</td>
<td>Les applications peuvent créer des utilisateurs dans n’importe quelle base de données ou connexion sans mot de passe dans un locataire Auth0. Cela inclut la création via les points de terminaison `/api/v2/users` et `/api/v2/jobs/users-import`.</td>
</tr>
<tr>
<td>`update:users`</td>
