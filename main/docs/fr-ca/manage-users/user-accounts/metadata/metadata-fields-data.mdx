...
## Noms de champ des métadonnées {#metadata-field-names}

### Caractères acceptés {#accepted-characters}
...
### Noms de champ dynamiques {#dynamic-field-names}
...
### Collision de noms {#name-collision}
...
## Types de données des métadonnées {#metadata-data-types}
...
## Limites et restrictions {#limitations-and-restrictions}
...
### Limites de taille et stockage {#size-limits-and-storage}
