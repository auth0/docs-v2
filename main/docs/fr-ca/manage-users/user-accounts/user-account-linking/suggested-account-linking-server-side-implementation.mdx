...
3. Invitez l’utilisateur à associer les comptes.
   ...
   2. Si l’utilisateur souhaite associer un compte donné, il peut cliquer sur **Associer** à côté du compte concerné.
      ...
      <Frame>![Example application with server-side account linking page](/docs/images/fr-ca/cdy7uua7fh8z/7unQjUtxTZUc4tRFOxhaP3/050fb853d2b3be37795ce88b8a60ffed/account-linking-webapp-small__1_.png)</Frame>
