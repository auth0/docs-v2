...
## Avantages de la liaison de comptes {#advantages-of-linking-accounts}
...
### Fusion des métadonnées {#metadata-merge}
...
### Liaison de comptes initiée par l’utilisateur {#user-initiated-account-linking}
...
### Liaison de comptes suggérée {#suggested-account-linking}
