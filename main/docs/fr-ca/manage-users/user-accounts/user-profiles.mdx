...
description: Comprendre le fonctionnement des profils utilisateur dans Auth0.
---
...
## Sources de données utilisateur {#user-data-sources}
...
Si certains attributs utilisateur ne doivent pas être stockés par Auth0, vous pouvez [ajouter des attributs utilisateur à la DenyList](/docs/fr-ca/secure/security-guidance/data-security/denylist).

### Normalisation des données utilisateur {#user-data-normalization}
...
### Mappage des attributs du profil d’utilisateur {#user-profile-attribute-mapping}

#### Connecteur AD/LDAP {#adldap-connector}
...
#### Assertions SAML {#saml-assertions}
...
### Mise en cache des profils utilisateur {#caching-user-profiles}
...
## Données personnalisées du profil utilisateur {#custom-user-profile-data}
...
## Modifier les données du profil utilisateur {#change-user-profile-data}
...
## Accéder aux profils utilisateur {#access-user-profiles}
...
### Accéder aux profils utilisateur à partir des applications {#access-user-profiles-from-apps}
...
### Accéder aux profils utilisateur depuis la Management API {#access-user-profiles-from-the-management-api}
...
## La différence entre les profils utilisateur et les jetons {#the-difference-between-user-profiles-and-tokens}
