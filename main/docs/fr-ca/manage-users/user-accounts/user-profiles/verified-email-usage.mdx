...
## Quand Auth0 considère-t-il les courriels comme vérifiés? {#when-does-auth0-set-emails-as-verified}
...
## Adresses courriel vérifiées et liaison de comptes {#verified-emails-and-account-linking}
...
## Adresses courriel vérifiées et décisions d’autorisation {#verified-emails-and-authorization-decisions}
