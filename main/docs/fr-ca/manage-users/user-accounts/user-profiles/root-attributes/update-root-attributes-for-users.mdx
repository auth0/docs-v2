...
| `MGMT_API_ACCESS_TOKEN` | [Jeton d’accès à Management API] (/api/management/v2/tokens) avec la <dfn>permission</dfn> `update:users`. |
| `GIVEN_NAME_VALUE` | Nom donné de l’utilisateur à mettre à jour. |
