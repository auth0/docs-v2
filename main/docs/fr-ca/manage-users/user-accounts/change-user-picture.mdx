---
description: Apprenez à utiliser les métadonnées utilisateur pour modifier le champ picture d’un utilisateur ainsi que la photo par défaut de tous les utilisateurs.
...
## Changer la photo par défaut pour tous les utilisateurs {#change-default-picture-for-all-users}
