...
* Si vous utilisez des [connexions par réseau social](/docs/fr-ca/authenticate/identity-providers), assurez-vous d’obtenir vos propres identifiants auprès du fournisseur et ajoutez-les à la configuration de la connexion par réseau social.
