...
Si vous utilisez les [règles](/docs/fr-ca/customize/rules) ou des [connexions personnalisées à la base de données](/docs/fr-ca/authenticate/database-connections/custom-db) ou d’autres points d’extension, la ou les transactions synthétiques doivent être configurées de manière à utiliser les règles et/ou les scripts personnalisés de la base de données afin de garantir le bon fonctionnement de cet aspect du système.
