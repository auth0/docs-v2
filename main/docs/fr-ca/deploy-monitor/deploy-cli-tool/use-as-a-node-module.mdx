...
Pour une liste complète des paramètres de configuration, veuillez consulter [Configurer l’outil Deploy CLI](/configure-the-deploy-cli).
...
Objet. Configure le comportement de l’utilitaire. Pour en savoir plus, consultez [Configurer l’outil Deploy CLI](/configure-the-deploy-cli).
