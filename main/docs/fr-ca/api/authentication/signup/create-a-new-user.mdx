...
<ParamField body="client_id" type="string">
  Le `client_id` de votre client. S’il est omis, la requête utilise l’ID client global du tenant.
</ParamField>
...
<ParamField body="user_metadata" type="object">
  Les métadonnées utilisateur à associer à l’utilisateur. Si ce champ est défini, il doit s’agir d’un objet ne contenant pas plus de dix propriétés. Les noms de propriété peuvent comporter au maximum 100 caractères, et les valeurs de propriété doivent être des chaînes de caractères d’au plus 500 caractères.
</ParamField>
