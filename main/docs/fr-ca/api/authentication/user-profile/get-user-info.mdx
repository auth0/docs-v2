...
* Les claims standard renvoient la valeur la plus récente pour l’utilisateur (sauf si la valeur provient d’un IdP externe).
...
<ParamField header="Authorization" type="string" required>
  Jeton porteur. Par exemple : `Bearer {yourAccessToken}`
</ParamField>
