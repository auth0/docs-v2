...
description: "Vérifier l’AMF au moyen d’un code de récupération lorsque l’appareil inscrit de l’utilisateur n’est pas disponible."
---
...
<ResponseSchema>
  <ResponseField name="access_token" type="string">
    Le jeton d’accès obtenu après une vérification réussie.
  </ResponseField>
...
| Statut | Description                                                               |
| ------ | ------------------------------------------------------------------------- |
| 200    | Réponse indiquant la réussite de la vérification du code de récupération. |
