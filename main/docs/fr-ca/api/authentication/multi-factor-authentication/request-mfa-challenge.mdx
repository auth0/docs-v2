---
title: "requête de défi"
description: "Demander un défi MFA (OTP ou OOB) afin de poursuivre l’authentification au point de terminaison des jetons."
---
...
## requête de défi {#challenge-request}
