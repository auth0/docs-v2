---
description: Découvrez comment le Sender Constraining lie les jetons d’accès à un client précis au moyen d’empreintes de certificat mTLS ou de clés de preuve DPoP afin d’empêcher le vol de jetons.
sidebarTitle: Aperçu
