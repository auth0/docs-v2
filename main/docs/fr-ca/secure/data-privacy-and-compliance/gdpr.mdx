...
| Contrôleur de données | L’entité qui collecte et traite les données sur les sujets ([référez-vous au RGPD pour une définition exacte](https://gdpr-info.eu/art-4-gdpr/)) |
| Responsable du traitement des données | L’entité qui traite les données pour le compte d’un contrôleur de données ([référez-vous au RGPD pour une définition exacte](https://gdpr-info.eu/art-4-gdpr/)) |
