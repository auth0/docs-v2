...
### Notifications et consentement {#notifications-and-consent}
...
### Droits des personnes {#rights-of-individuals}
...
### Protection de la vie privée dès la conception et par défaut {#privacy-by-design-and-privacy-by-default}
...
### Exigences applicables aux sous-traitants et aux responsables du traitement {#requirements-for-data-processors-and-controllers}
...
## Rôles et responsabilités dans le cadre du GDPR {#roles-and-responsibilities-under-gdpr}

De manière générale**,** les clients d’Auth0 (Okta) sont des **responsables du traitement**, et Auth0 (Okta) est un **sous-traitant**.

### Données personnelles traitées par Auth0 {#personal-data-handled-by-auth0}

Auth0 traite les données des utilisateurs finaux figurant dans les profils utilisateur, y compris les métadonnées.

### Responsabilités du responsable du traitement (client) {#data-controller-customer-responsibilities}
...
### Responsabilités du sous-traitant (Auth0) {#data-processor-auth0-responsibilities}
...
## Traitement des données d’Auth0 {#auth0-data-processing}
...
### Quand les données d’Auth0 sont stockées {#when-auth0-data-is-stored}
...
### Comment Auth0 utilise les données qu’il stocke {#how-auth0-uses-the-data-it-stores}
...
### Que deviennent les données lorsqu’un compte d’utilisateur final est supprimé {#what-happens-to-data-when-an-end-users-account-is-deleted}
...
## Fonctionnalités d’Auth0 favorisant la conformité au GDPR {#auth0-features-aiding-gdpr-compliance}

Voici une liste des exigences du GDPR et de la façon dont Auth0 peut vous aider à vous y conformer.

### Conditions du consentement {#conditions-for-consent}
...
### Droit d’accès, de rectification et d’effacement des données {#right-to-access-correct-and-erase-data}
...
### protection et sécurisation des données utilisateur {#protect-and-secure-user-data}
...
## Conseils de sécurité {#security-advice}
