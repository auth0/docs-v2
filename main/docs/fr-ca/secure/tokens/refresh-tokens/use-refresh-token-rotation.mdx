...
[Configurer la rotation des jetons d’actualisation](/docs/fr-ca/secure/tokens/refresh-tokens/configure-refresh-token-rotation) pour activer l’accès hors ligne et demander le scope offline&#95;access dans le SDK client.

## Activer useRefreshTokens {#enable-userefreshtokens}
