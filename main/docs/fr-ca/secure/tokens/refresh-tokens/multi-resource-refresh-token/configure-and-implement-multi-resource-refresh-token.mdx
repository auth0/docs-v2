---
description: Configurez et mettez en œuvre les jetons d’actualisation multi-ressource Auth0 à l’aide de la Management API. 
title: Configurer et utiliser Implement jeton d’actualisation multi-ressource
---
...
## Implement jeton d’actualisation multiressource {#implement-multi-resource-refresh-token}
...
### Étape 1 : S’authentifier et demander un jeton d’actualisation {#step-1-authenticate-and-request-a-refresh-token}
...
### Étape 2 : Échanger le jeton d’actualisation pour accéder à une autre API {#step-2-exchange-the-refresh-token-for-a-different-api}
...
### Étape 3 : Appeler l’API à l’aide du jeton d’accès {#step-3-call-the-api-using-the-access-token}
...
## Utiliser le jeton d’actualisation multi-ressource avec Actions {#use-multi-resource-refresh-token-with-actions}
...
#### Logique d’évaluation {#evaluation-logic}
