...
To use Multi-Resource <Tooltip href="/docs/fr-ca/glossary?term=refresh-token" tip="Jeton d’actualisation
...
| --- | --- | --- |
| `audience` | string | The Auth0 API [identifier](https://auth0.com/docs/fr-ca/get-started/apis/api-settings#general-settings) of the application that will have access to using the refresh token. |
...
Once you configure your application’s refresh token with MRRT policies, you can start to  exchange a single refresh token for <Tooltip href="/docs/fr-ca/glossary?term=access-token" tip="Jeton d’accès
