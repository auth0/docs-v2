...
## Choisissez si la révocation d’un jeton supprime les grants {#choose-whether-token-revocation-deletes-grants}
...
### Utilisation de l’Authentication API {#using-the-authentication-api}
...
### Utilisation des points de terminaison des identifiants d’appareil de la Management API {#using-the-management-api-device-credentials-endpoints}
...
### Utilisation des points de terminaison des jetons d’actualisation de la Management API {#using-the-management-api-refresh-token-endpoints}
...
## Considérations et limites {#considerations-and-limitations}
