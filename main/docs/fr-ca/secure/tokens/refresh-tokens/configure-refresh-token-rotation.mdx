---
description: Découvrez comment configurer la rotation des jetons d’actualisation Auth0 afin de migrer un jeton d’actualisation sans rotation vers un jeton d’actualisation avec rotation, et vice-versa.
...
## Configurer dans le Dashboard {#configure-in-the-dashboard}
...
## Configurer avec l’Auth0 SPA SDK {#configure-with-the-auth0-spa-sdk}
...
## Détection automatique de la réutilisation {#automatic-reuse-detection}
