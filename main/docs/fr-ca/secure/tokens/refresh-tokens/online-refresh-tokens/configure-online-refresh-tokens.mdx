...
## Configurer les ORT {#configure-orts}
...
### Configurer à l’aide du Dashboard {#configure-using-the-dashboard}
...
3. Dans l’onglet **Settings**, activez la bascule **Allow Online Access**.
   ...
   <Frame>![Dashboard Applications API Settings Allow Online Access](/docs/images/refresh-tokens/allow-online-access.png)</Frame>
...
### Configurer à l’aide de la Management API {#configure-using-the-management-api}
...
### Comportement de la prolongation de session {#session-extension-behavior}
...
## Utiliser les ORT avec Actions {#use-orts-with-actions}
