...
description: Gérez les jetons d’actualisation Auth0 avec Actions pour lire ou modifier les revendications de jetons d’actualisation, définir des expirations personnalisées ou révoquer des jetons.
---
...
## Révoquer des jetons d’actualisation avec Actions {#revoke-refresh-tokens-with-actions}
...
### Surveiller les événements de journal liés à la révocation {#monitor-revoke-log-events}
...
## Modifier les dates d’expiration des jetons d’actualisation avec Actions {#change-refresh-tokens-expiry-dates-with-actions}
...
## Cas d’utilisation : Révoquer un jeton d’actualisation {#use-cases-revoke-a-refresh-token}
...
### Révoquer les jetons d’actualisation en raison d’ImpossibleTravel {#revoke-refresh-tokens-due-to-impossibletravel}
...
### Révoquer des jetons d’actualisation en raison d’une liaison à l’adresse IP {#revoke-refresh-tokens-due-to-ip-binding}
...
## Cas d’utilisation : Personnaliser les dates d’expiration des jetons d’actualisation {#use-cases-customize-refresh-token-expiry-dates}
...
### Personnaliser la date d’expiration absolue du jeton d’actualisation en fonction de l’organisation {#customize-absolute-refresh-token-expiration-date-based-on-organization}
...
### Personnaliser le délai d’inactivité du jeton d’actualisation selon le rôle d’appartenance {#customize-refresh-token-inactivity-timeout-based-on-membership-role}
