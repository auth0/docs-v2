...
<td>Indique le <a href="/docs/fr-ca/authenticate/protocols/oauth#grant-types">flux OAuth 2.0</a> que vous souhaitez exécuter. Pour la communication entre machines, utilisez la valeur `client_credentials`.</td>
</tr>
<tr>
