...
## Scopes et points de terminaison disponibles {#available-scopes-and-endpoints}
...
## Utiliser un jeton de la Management API pour appeler la Management API depuis une SPA {#use-management-api-token-to-call-management-api-from-a-spa}
