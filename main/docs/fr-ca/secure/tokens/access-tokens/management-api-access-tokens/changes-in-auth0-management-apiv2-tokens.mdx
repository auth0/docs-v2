...
## Ce qui a changé et pourquoi {#what-changed-and-why}

### L’expérience utilisateur {#the-user-experience}
...
#### Pourquoi cela a changé {#why-this-changed}
...
### La période de validité {#the-validity-period}
...
#### Pourquoi ce changement {#why-this-changed-2}
