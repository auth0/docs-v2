...
## Contrôler l’audience du jeton d’accès {#control-access-token-audience}
...
### Audiences multiples {#multiple-audiences}
...
### Domaines personnalisés et l’Auth0 Management API {#custom-domains-and-the-auth0-management-api}
...
## Renouveler les jetons d’accès {#renew-access-tokens}
