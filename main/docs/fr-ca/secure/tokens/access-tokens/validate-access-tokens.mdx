---
description: Validez les jetons d’accès Auth0 dans votre API en vérifiant la signature, l’audience, les permissions et les claims standard du JSON Web Token (JWT).
