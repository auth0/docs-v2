---
description: Validez les jetons d’identité Auth0 dans votre application en vérifiant leur signature, les claims standard et le nonce facultatif afin de confirmer l’identité de l’utilisateur.
