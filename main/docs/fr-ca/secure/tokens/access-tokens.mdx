...
## Jetons d’accès opaques {#opaque-access-tokens}
...
## Jetons d’accès JWT {#jwt-access-tokens}
...
### Jetons d’accès de la Management API {#management-api-access-tokens}
...
### Jetons d’accès à une API personnalisée {#custom-api-access-tokens}
...
## Exemple de jeton d’accès {#sample-access-token}
...
## Sécurité des jetons d’accès {#access-token-security}
...
## Durée de vie du jeton d’accès {#access-token-lifetime}

### Durée de vie du jeton d’accès de l’API personnalisée {#custom-api-token-lifetime}
...
### durée de vie du jeton du point de terminaison /userinfo {#userinfo-endpoint-token-lifetime}
