---
description: Découvrez ce que sont les JSON Web Tokens (JWT), comment ils sont structurés et comment Auth0 les utilise pour l’authentification et l’autorisation.
sidebarTitle: Aperçu
