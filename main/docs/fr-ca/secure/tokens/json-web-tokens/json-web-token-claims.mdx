---
description: Découvrez les claims enregistré et personnalisé des JSON Web Tokens (JWT), leur structure dans les jetons Auth0 et comment éviter les collisions de noms grâce aux claims avec espace de noms.
...
## Claims enregistrées {#registered-claims}
...
## Claims personnalisées {#custom-claims}
...
## Restrictions d’Auth0 {#auth0-restrictions}
