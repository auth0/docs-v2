---
description: Ajoutez des claims personnalisés aux jetons d’accès et d’identité Auth0 à l’aide de clés avec espace de noms dans une Action afin de transmettre des données supplémentaires sur l’utilisateur ou l’application à votre API.
...
## Restrictions générales {#general-restrictions}
...
### Claims non restreintes {#non-restricted-claims}
...
## Directives relatives aux espaces de noms {#namespaced-guidelines}
...
## Directives pour les claims personnalisées sans espace de noms {#non-namespaced-guidelines}
...
## Créer des claims personnalisées {#create-custom-claims}
