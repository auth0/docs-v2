---
description: Validez les JSON Web Tokens (JWTs) en vérifiant la signature, en décodant le payload et en vérifiant les claims à l’aide d’un Auth0 SDK ou d’une bibliothèque tierce.
...
## Analyser et valider {#parse-and-validate}
...
## Effectuer manuellement les vérifications {#manually-implement-checks}
...
## Vérifier les jetons signés avec RS256 {#verify-rs256-signed-tokens}
