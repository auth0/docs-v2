...
## Principales fonctionnalités {#key-capabilities}
...
## Listes de blocage sélectionnées offertes {#available-curated-blocklists}
...
## Configurer des règles avec des listes de blocage sélectionnées {#configure-rules-with-curated-blocklists}
...
### Bloquer le trafic à l’aide de listes de blocage sélectionnées {#block-traffic-from-curated-blocklists}
...
### Combiner avec d’autres critères {#combine-with-other-matchers}
...
### Exclure le trafic des listes de blocage sélectionnées {#exclude-curated-blocklist-traffic}
