...
## Types de grant d’application pris en charge {#supported-application-grant-types}
...
## Lier des jetons à l’émetteur à l’aide de DPoP dans Auth0 {#sender-constrain-tokens-using-dpop-in-auth0}
...
### Revendications de l’en-tête JWT {#jwt-header-claims}
...
### Claims du payload JWT {#jwt-payload-claims}
