...
## Configurer Bot Detection {#configure-bot-detection}
...
## Configurer le niveau de Bot Detection {#configure-bot-detection-level}
...
## Permettre aux adresses IP de confiance de contourner Bot Detection {#allow-trusted-ip-addresses-to-bypass-bot-detection}
...
## Configurer le modèle de détection des inscriptions pour la Custom Login Page et l’expérience Classic Login {#configure-signup-detection-model-for-custom-login-page-and-classic-login-experience}
...
## Restrictions et limitations {#restrictions-and-limitations}

### Limites des flux {#flow-limitations}
...
### Limitations des types de connexion {#connection-type-limitations}
...
### Soutien pour les pages de connexion personnalisées {#custom-login-page-support}
...
### Soutien des applications natives {#native-application-support}
