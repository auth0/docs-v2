...
1. Accédez à [Dashboard > Sécurité > Protection contre les attaques](%24%7Bmanage_url%7D/#/security/attack-protection) et sélectionnez **Protection contre les attaques exhaustives**. Activez le bouton à bascule en haut de la page s’il est désactivé.
...
Pour en apprendre davantage, veuillez consulter [Éviter les problèmes courants liés au flux de mot de passe du propriétaire de ressource et à la protection contre les attaques](/login/flows/avoid-common-issues-with-resource-owner-password-flow-and-attack-protection).