...
Nous vous recommandons fortement de laisser la protection contre les attaques par force brute activée pour vos connexions et d’avoir un administrateur de tenant secondaire afin de débloquer les autres comptes d’administrateur.

<Callout icon="file-lines" color="#0EA5E9" iconType="regular">
  La protection contre les attaques par force brute s’applique uniquement aux tentatives de connexion. Si un identifiant est bloqué en raison de tentatives de connexion infructueuses répétées, les nouveaux utilisateurs peuvent tout de même s’inscrire avec cet identifiant et recevoir un courriel de vérification.
</Callout>

## Configurer la protection contre les attaques par force brute {#configure-brute-force-protection}
...
### Seuil de force brute {#brute-force-threshold}
...
### Paramètres de blocage {#block-settings}
...
Auth0 envoie un courriel à l’utilisateur si une adresse courriel est associée à son compte. Les notifications par courriel sont limitées à 1 par heure et par adresse IP unique. Par défaut, les [notifications par courriel de compte bloqué](/docs/fr-ca/customize/email/email-templates/customize-email-templates) contiennent un lien permettant à l’utilisateur de débloquer son compte.

## Supprimer les blocages liés à la protection contre les attaques par force brute {#remove-brute-force-protection-blocks}
...
* [Personnaliser les courriels pour les comptes bloqués](/docs/fr-ca/customize/email/email-templates/customize-email-templates)
