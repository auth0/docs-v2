...
## Taux d’erreurs dans le flux de connexion {#rate-of-errors-in-login-flow}
...
## Fréquence des événements de protection contre les attaques {#rate-of-attack-protection-events}
...
## Nombre d’IP générant des erreurs et leur provenance géographique {#number-of-ips-producing-errors-and-their-locations}
