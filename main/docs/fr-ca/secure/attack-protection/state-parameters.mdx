...
### Définir et comparer les valeurs du paramètre `state` {#set-and-compare-state-parameter-values}
...
## Rediriger les utilisateurs {#redirect-users}
...
### Utiliser l’URL stockée pour rediriger les utilisateurs {#use-the-stored-url-to-redirect-users}
...
### Méthode de redirection alternative {#alternate-redirect-method}
