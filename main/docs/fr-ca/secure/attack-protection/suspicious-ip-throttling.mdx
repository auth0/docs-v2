...
## Configurer Suspicious IP Throttling {#configure-suspicious-ip-throttling}
...
## Autoriser les adresses IP de confiance à dépasser les seuils de limitation {#allow-trusted-ip-addresses-exceed-throttling-limits}
...
## Configurer la réponse {#configure-response}
...
## Configurer les limites et les taux de limitation {#configure-throttling-limits-and-rates}
...
### Fonctionnement de Suspicious IP Throttling {#how-suspicious-ip-throttling-works}
...
#### Requêtes malformées et erreurs de validation du schéma {#malformed-requests-and-schema-validation-errors}
