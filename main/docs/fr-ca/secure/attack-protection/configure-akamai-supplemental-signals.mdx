...
## Flux de connexion pris en charge {#supported-login-flows}
...
# Étape 1 : Enregistrer une API dans Akamai {#step-1-register-an-api-in-akamai}
...
### Ajouter une ressource API {#add-api-resource}
...
### Ajouter des paramètres aux méthodes {#add-parameters-to-methods}
...
### Ajouter une ressource API {#add-api-resource-2}
...
### Ajouter des paramètres aux méthodes {#add-parameters-to-methods-2}
...
### Ajouter une ressource d’API {#add-api-resource-3}
...
### Ajouter des paramètres aux méthodes {#add-parameters-to-methods-3}
...
# Étape 2 : Transmettre à Auth0 les résultats de détection des bots d’Akamai {#step-2-forward-bot-results-from-akamai-to-auth0}
...
# Étape 3 : Activer le traitement des en-têtes Akamai dans Auth0 {#step-3-enable-processing-of-akamai-headers-in-auth0}
...
# Étape 4 : Testez et vérifiez la configuration {#step-4-test-and-verify-configuration}
