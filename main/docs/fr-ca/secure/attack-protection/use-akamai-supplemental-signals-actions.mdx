---
title: Utiliser les Supplemental Signals d’Akamai dans Actions
description: Utilisez les Actions Auth0 avec les signaux Akamai Account Protector afin d’enrichir les décisions de connexion avec les scores de bot, de fraude et de risque du réseau périphérique d’Akamai.
---
...
## Supplemental Signals pris en charge par déclencheur d’Action {#supported-supplemental-signals-by-action-trigger}
...
## Schémas d’objet de Supplemental Signal {#supplemental-signal-object-schemas}
...
#### Nettoyer les métadonnées d’application {#clean-up-app-metadata}
