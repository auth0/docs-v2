...
## Détectez plus rapidement les fuites avec Credential Guard {#detect-breaches-faster-with-credential-guard}
...
## Configurer la détection des mots de passe compromis {#configure-breached-password-detection}
...
### Configurer la méthode de détection {#configure-detection-method}
...
### Configurer les scénarios de réponse {#configure-response-scenarios}
...
### Comportement de la limitation {#throttling-behavior}
...
#### Personnaliser les notifications par courriel envoyées aux utilisateurs {#customize-email-notifications-to-users}
...
## Vérifier la configuration de détection {#verify-detection-configuration}
...
### Flux d’inscription {#signup-flow}
...
### Flux de réinitialisation {#reset-flow}
