---
og:description: Playbook for using Auth0's Bot Detection monitoring feature in the
  Security Center
...
twitter:description: Playbook for using Auth0's Bot Detection monitoring feature in
  the Security Center
