...
### Communiquer les détails de la transaction et rediriger vers Auth0 {#communicate-transaction-details-and-redirect-to-auth0}
...
### Appliquer une politique dynamique {#apply-dynamic-policy}
...
### Soumettre l’utilisateur à un défi pour obtenir l’approbation des détails de la transaction {#challenge-the-user-to-get-transaction-details-approval}
...
#### SMS, courriel ou WebAuthn {#sms-email-or-webauthn}
...
### Terminer l’opération {#complete-the-operation}
