...
<td><ParamField path="verification_id" type="string">
  Verification ID <a href="https://www.npmjs.com/package/short-uuid">(UUIDv4)</a> as received from the verification initiation. This ID is used for subsequent interactions with the verification API, such as polling for status.
</ParamField><ParamField path="engagement" type="string">
  MDoc URI for the Web API protocol. This URI should be presented to the user to initiate the wallet interaction using the protocols. It conforms to the structure defined in <a href="https://www.iso.org/standard/82772.html">ISO/IEC DTS 18013-7 (Annex 4)</a>
</ParamField></td>
</tr>
</tbody>
</table>
