...
## Méthodes d’authentification de l’application {#application-authentication-methods}
...
### Authentification par Client Secret {#client-secret-authentication}
...
### Authentification par Private Key JWT {#private-key-jwt-authentication}
...
### Enregistrement des clés et des certificats {#key-and-certificate-registration}
...
## Mettre à jour la méthode d’authentification d’une application {#update-application-authentication-method}
