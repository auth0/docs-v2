...
| --- | --- |
| [Jetons d’actualisation avec les actions](/docs/fr-ca/secure/tokens/refresh-tokens/manage-refresh-tokens-actions) | Comment gérer les jetons d’actualisation avec les actions |
| [Sessions avec les actions](/docs/fr-ca/manage-users/sessions/manage-sessions-actions) | Comment gérer les sessions avec les actions. |