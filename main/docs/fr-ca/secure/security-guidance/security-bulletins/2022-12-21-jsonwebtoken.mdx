...
* Un algorithme par défaut non sécurisé dans jwt.verify() pourrait entraîner un contournement de la validation de la signature : [CVE-2022-23540](https://github.com/auth0/node-jsonwebtoken/security/advisories/GHSA-qwph-4952-7xr6)
