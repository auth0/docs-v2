...
og:title: Bulletin de sécurité Auth0 pour l’affectation des permissions en fonction
  de l’adresse courriel
og:url: https://auth0.com/docs/
permalink: 2019-09-05-scopes
title: Bulletin de sécurité Auth0 pour l’affectation des permissions en fonction de
  l’adresse courriel
twitter:description: Cases where improper custom rule code may create vulnerabilities
  in the authentication flow.
twitter:title: Bulletin de sécurité Auth0 pour l’affectation des permissions en fonction
  de l’adresse courriel
---
