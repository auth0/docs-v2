...
#### Scénarios de site statique Next.js {#nextjs-static-site-scenarios}
...
### Scénarios de stockage en mémoire dans le navigateur {#browser-in-memory-scenarios}
...
### Scénarios liés au stockage local dans le navigateur {#browser-local-storage-scenarios}
