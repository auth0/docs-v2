---
description: Découvrez comment utiliser les journaux du tenant Auth0 dans le cadre de votre plan de réponse aux incidents pour enquêter sur des connexions suspectes, déterminer la portée d’une violation et produire une chronologie d’audit.
...
## Consulter les journaux Auth0 {#check-auth0-logs}
...
### Structure des logs {#log-structure}
...
### Exemple d’événement de journal pour un échec de connexion {#example-of-failed-login-log-event}
...
## Indicateurs d’une attaque {#indicators-of-an-attack}
...
## Identifier les comptes d’utilisateur compromis {#identify-compromised-user-accounts}
...
## Vérifier l’activité d’un compte d’utilisateur compromis {#check-compromised-user-account-activity}
...
## Supprimer ou bloquer des utilisateurs depuis le dashboard {#delete-or-block-users-from-the-dashboard}
