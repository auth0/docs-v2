...
Auth0 possède des [fonctions de protection](/attack-protection) contre certains types d'attaques.
...
Une façon de vérifier les demandes envoyées est d’utiliser le [paramètre d’état](/attack-protection/state-parameters) du protocole OAuth 2.0pour authentifier la réponse.