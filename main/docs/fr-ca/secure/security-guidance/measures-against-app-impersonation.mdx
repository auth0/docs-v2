...
## Mesures d’atténuation recommandées pour les applications mobiles {#recommended-mitigations-for-mobile-applications}

### URI HTTPS revendiquées (Universal Links / App Links) {#claimed-https-uris-universal-links-app-links}
...
## Mesures d’atténuation recommandées pour toutes les applications {#recommended-mitigations-for-all-application}
...
#### Personnalisation de l’invite {#prompt-customization}
