...
| Option | Description |
| --- | --- |
| Alert | Une valeur numérique obligatoire qui génère un avis d’alerte lorsque la métrique évaluée dépasse la valeur fournie. |
| Warn | Une valeur numérique facultative qui crée un avis d’avertissement lorsque la métrique évaluée dépasse la valeur, si elle est fournie. |
| Recovery | Une valeur numérique facultative qui crée un avis de récupération lorsque la métrique évaluée est revenue à une valeur non dépassée, si elle est fournie. |
...
<Frame>![A second screenshot of our Security Center Thresholds product](/docs/images/fr-ca/cdy7uua7fh8z/1Kd9d33WUCdlVa1SwEFkKQ/636590a83539eef74613813bfc4389b7/MFA_success_rate_threshold_editor_-_french.png)</Frame>
...
<Frame>![A third screenshot of our Thresholds product ](/docs/images/fr-ca/cdy7uua7fh8z/2E22W6hrzfVAxF0h3H1eR8/80a96ab40094370c21ef7e81b05c44fe/MFA_success_rate_threshold_picker_-_French.png)</Frame>
...
<Frame>![Example of how the Alert History tab looks like](/docs/images/fr-ca/cdy7uua7fh8z/3FJRKIjDJor1Z2AEWh9C0e/61b068bcf242e66753d2fd3136af406e/image.png)</Frame>
