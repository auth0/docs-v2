...
## Installer Guardian Android SDK {#install-guardian-android-sdk}
...
### Activer les notifications push de Guardian {#enable-guardian-push-notifications}
...
### Autoriser les requêtes de connexion {#allow-login-requests}
...
### Rejeter les requêtes de connexion {#reject-login-requests}
...
### Configurer l’enrôlement OTP sur mobile uniquement {#set-up-mobile-only-otp-enrollment}
...
#### Connecter une ressource {#connect-a-resource}

Vous pouvez connecter une ressource à l’aide d’Auth0 Dashboard ou du Guardian SDK.

##### Utiliser Auth0 Dashboard {#use-auth0-dashboard}
...
##### Utiliser Guardian SDK {#use-guardian-sdk}
...
#### Entrez le code à usage unique {#enter-one-time-code}
...
#### Connectez-vous avec votre application {#log-in-with-your-app}
