...
## Installer le SDK Guardian pour iOS {#install-guardian-ios-sdk}
...
#### Clés de signature et de vérification {#signing-and-verification-keys}
...
### Configurer l’inscription OTP sur mobile uniquement {#set-up-mobile-only-otp-enrollment}
