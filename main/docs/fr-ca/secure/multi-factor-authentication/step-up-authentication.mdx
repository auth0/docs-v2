...
## Authentification renforcée pour les API {#step-up-authentication-for-apis}
...
## Authentification renforcée pour les applications web {#step-up-authentication-for-web-apps}
