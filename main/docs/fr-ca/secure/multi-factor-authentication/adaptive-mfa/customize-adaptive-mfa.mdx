...
description: Personnalisez l’Adaptive MFA d’Auth0 avec Actions afin d’utiliser le niveau de confiance et les détails de l’évaluation des risques pour déterminer s’il faut demander une vérification, autoriser ou bloquer une tentative de connexion.
...
## Quand personnaliser Adaptive AMF {#when-to-customize-adaptive-mfa}
...
## Résultats des Actions {#action-result-outcomes}
...
## Modèles d’Action {#action-templates}
...
### Modèle Adaptive MFA {#adaptive-mfa-template}
...
### Modèle Require MFA Enrollment {#require-mfa-enrollment-template}
...
## Cas d’utilisation d’Action {#action-use-cases}
