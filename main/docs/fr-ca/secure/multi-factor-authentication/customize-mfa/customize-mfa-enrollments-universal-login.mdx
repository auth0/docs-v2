...
### Flux séquencés et contextuels {#sequenced-and-contextual-flows}
...
## Personnaliser les flux d’enrôlement MFA {#customize-mfa-enrollment-flows}
...
### Proposer aux utilisateurs des options de MFA pour l’enrôlement {#prompt-users-with-mfa-options-for-enrollment}
...
Les journaux du tenant sont accessibles dans l’Auth0 Dashboard sous [Monitoring &gt; Logs](https://manage.auth0.com/#/logs). Vous pouvez aussi récupérer les journaux à l’aide de la [Management API](/docs/fr-ca/api/management/v2).
...
### Liste de vérification pour la résolution des problèmes {#troubleshooting-checklist}
