...
## Inscription avec le courriel {#enroll-with-email}
...
### Enregistrer l’authentificateur {#enroll-authenticator}
...
### Confirmer l’inscription par courriel {#confirm-email-enrollment}

L’utilisateur devrait recevoir un courriel contenant le code à usage unique qu’il peut saisir dans l’application.

<Callout icon="file-lines" color="#0EA5E9" iconType="regular">
  La longueur par défaut de l’OTP est de 6 chiffres. Vous pouvez configurer la longueur du code OTP par courriel et son délai d’expiration dans le Auth0 Dashboard ou à l’aide de la Management API. Pour en savoir plus, lisez [Configurer les paramètres OTP](/docs/fr-ca/secure/multi-factor-authentication/multi-factor-authentication-factors/configure-email-notifications-for-mfa#configure-otp-settings).
</Callout>
...
## Vérification par courriel {#challenge-with-email}
...
### Soumettre l’utilisateur à une vérification par OTP {#challenge-user-with-otp}
...
### Terminez l’authentification à l’aide du code reçu {#complete-authentication-using-received-code}
