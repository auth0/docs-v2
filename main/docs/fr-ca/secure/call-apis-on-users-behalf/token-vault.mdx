...
## Fournisseurs externes pris en charge {#supported-external-providers}
...
## Utilisation avec Organizations {#use-with-organizations}
...
## Échanges de jetons pris en charge {#supported-token-exchanges}
