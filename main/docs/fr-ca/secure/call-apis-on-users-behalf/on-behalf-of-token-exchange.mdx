...
<Tabs>
  ...
  <Tab title="Management API">
    Pour créer un client d’API personnalisé avec le même identifiant que votre serveur de ressources, envoyez une requête `POST` au point de terminaison [`/api/v2/clients`](https://auth0.com/docs/api/management/v2/clients/post-clients) avec le corps de la requête suivant :
