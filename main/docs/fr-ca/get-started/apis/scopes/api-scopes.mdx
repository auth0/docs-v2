...
2. Définir ces niveaux d’accès en tant que champs d’application personnalisés. (Pour savoir ce que sont les permissions, lisez [Permissions](/apis/scopes).)
...
Pour un exemple montrant comment demander un accès personnalisé à l’API pour votre application, consultez [Exemples de cas d’utilisation : Permissions et demandes](/apis/scopes/sample-use-cases-scopes-and-claims).
