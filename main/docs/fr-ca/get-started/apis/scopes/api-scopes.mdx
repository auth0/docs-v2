---
description: Définir et utiliser des scopes personnalisés sur votre API Auth0 pour mettre en œuvre le contrôle d’accès et appliquer les permissions dans votre application.
title: scopes d’API
...
## Façons d’utiliser les scopes d’API {#ways-to-use-api-scopes}
...
### Exemple : une API appelée par une application tierce {#example-an-api-called-by-a-third-party-application}
...
### Exemple : une API appelée par une application de première partie {#example-an-api-called-by-a-first-party-application}
...
### Exemple : une API appelée par un service back-end {#example-an-api-called-by-a-back-end-service}
...
## Limiter les scopes d’API {#limit-api-scopes}
