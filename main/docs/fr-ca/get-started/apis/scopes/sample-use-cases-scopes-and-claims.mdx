---
description: Découvrez, à l’aide d’exemples pratiques, comment les portées OAuth 2.0 et les claims JWT déterminent les données et les actions auxquelles les applications peuvent accéder au nom des utilisateurs.
title: "Exemples de cas d’utilisation : Portées and claims"
---
...
## Authentifier un utilisateur et demander des claims standard {#authenticate-a-user-and-request-standard-claims}
...
## Demander un accès à une API personnalisée {#request-custom-api-access}
...
## Authentifier un utilisateur et demander des claims standards ainsi qu’un accès à une API personnalisée {#authenticate-a-user-and-request-standard-claims-and-custom-api-access}
...
## Ajouter des claims personnalisés à un jeton {#add-custom-claims-to-a-token}
