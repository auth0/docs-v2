---
description: Configurez un profil de jeton d’accès pour votre API afin de contrôler le format et les claims des jetons d’accès émis.
...
## Configurer le profil de jeton d’accès d’une API {#configure-access-token-profile-for-an-api}
