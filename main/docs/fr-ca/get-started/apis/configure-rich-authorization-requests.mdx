...
## Enregistrer les types `authorization_details` {#register-authorization_details-types}
...
### Autres canaux de notification {#other-notification-channels}
...
## Configurer les politiques d’accès à l’API {#configure-the-api-access-policies}

Les [politiques d’accès à l’API for Applications](/docs/fr-ca/get-started/apis/api-access-policies-for-applications) définissent quelles applications peuvent accéder à vos API et à quels scopes ou types `authorization_details` elles sont autorisées à accéder.
...
## Définir l’invite de consentement personnalisée {#set-customized-consent-prompt}
...
Pour en savoir plus sur la personnalisation de l’invite de consentement personnalisé, consultez :
...
## Facultatif : Configurer la politique de consentement pour le serveur de ressources {#optional-configure-consent-policy-for-the-resource-server}
...
| Flux                                                     | Notification push envoyée | Comportement                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| -------------------------------------------------------- | ------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| flux du code d’autorisation avec des requêtes d’autorisation poussées (PAR)                         | Non                       | L’invite de consentement personnalisée s’affiche.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
