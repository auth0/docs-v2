...
| Valeur | Description |
| --- | --- |
| `API_ID` | ID de l’API pour laquelle vous souhaitez supprimer les autorisations. |
...
| `PERMISSION_DESC` | Description(s) conviviales de la ou des autorisations que vous souhaitez conserver pour l’API spécifiée. |
...
* nickname
* offline_access
* <Tooltip href="/docs/fr-ca/glossary?term=openid" tip="OpenID Norme ouverte d’authentification qui permet aux applications de vérifier l’identité des utilisateurs sans avoir à collecter leurs informations de connexion." cta="Voir le glossaire">openid</Tooltip>
* phone
* image
* profile
