...
description: Contrôlez les applications qui peuvent accéder à vos API à l’aide de politiques d’autorisation globale, Per-app authorization ou de refus global, tant pour les flux délégués par l’utilisateur que pour les flux Client Credential.
...
## Politiques d’accès aux API des applications {#application-api-access-policies}
...
## Configurer la politique d&#39;accès des applications à l&#39;API {#configure-api-application-access-policy}
...
## Politiques d&#39;accès aux API et applications tierces {#api-access-policies-and-third-party-applications}
