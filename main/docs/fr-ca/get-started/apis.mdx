...
## Déterminer l’autorisation au moyen du contrôle d’accès {#determine-authorization-through-access-control}
...
## Permissions d’API {#api-permissions}
