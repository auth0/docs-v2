...
| Valeur | Description |
| --- | --- |
| `{yourClientId}` | Identifiant de l’application à mettre à jour. |
| `MGMT_API_ACCESS_TOKEN` | [Jetons d’accès à Management API](/docs/fr-ca/api/management/v2/tokens) avec la <dfn>permission</dfn> `read:clients`. |
