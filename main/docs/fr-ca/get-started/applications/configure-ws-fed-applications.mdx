...
## Configurer les claims inclus dans la réponse de jeton WS-Fed {#configure-claims-included-in-the-ws-fed-token-response}
...
## Réponses chiffrées {#encrypted-responses}
