...
## Configurer l’authentification d’origine croisée {#configure-cross-origin-authentication}
...
## Créer une page de vérification inter-origines {#create-cross-origin-verification-page}
...
## Prise en charge des tests dans les navigateurs {#browser-testing-support}
