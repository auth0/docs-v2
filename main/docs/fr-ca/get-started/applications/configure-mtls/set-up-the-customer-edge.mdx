---
description: Configurez votre réseau de périphérie pour effectuer la négociation mTLS, valider les certificats client et transmettre les requêtes à Auth0 pour l’émission de jetons.
...
## Vérifier le certificat client {#verify-the-client-certificate}
...
### Certificats signés par une autorité de certification {#ca-signed-certificates}
...
## Transférer la requête {#forward-the-request}
