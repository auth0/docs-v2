---
description: Décrit comment configurer des applications nouvelles ou existantes pour utiliser l’authentification Private Key JWT.
...
## Configurer Private Key JWT {#configure-private-key-jwt}
...
#### Configurer une nouvelle application pour `private_key_jwt` {#configure-a-new-application-for-private_key_jwt}
...
#### Configurer une application pour utiliser l’authentification Client Secret {#configure-an-application-to-use-client-secret-authentication}
...
#### Mettre à jour l’expiration d’un identifiant {#update-credential-expiration}
...
#### Configurer une nouvelle application pour « private_key_jwt » {#configure-a-new-application-for-private_key_jwt-2}
...
#### Configurer une application existante {#configure-an-existing-application-2}
...
##### Associer les informations d’identification {#associate-the-credential}
...
#### Configurer une application pour utiliser l’authentification par secret client {#configure-an-application-to-use-client-secret-authentication-2}
...
#### Mettre à jour les informations d’identification avec un champ d’expiration {#patch-credentials-with-an-expiration-field}
...
## Limites des identifiants {#credential-limits}
...
## Effectuer la rotation des identifiants {#rotate-credentials}
