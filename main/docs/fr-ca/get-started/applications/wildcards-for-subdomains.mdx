...
## Fonctionnement de l’évaluation des URL {#how-url-evaluation-works}
...
## Espaces réservés génériques dans les URL {#wildcard-url-placeholders}
...
## Espaces réservés d’URL pour organisation {#organization-url-placeholders}

### Espace réservé pour le nom de l’organisation {#organization-name-placeholder}
...
### Espace réservé des métadonnées de l’organisation {#organization-metadata-placeholder}
...
## Espaces réservés d’URL pour les domaines personnalisés {#custom-domain-url-placeholders}
...
### Champs pris en charge {#supported-fields}
...
### Utilisation avec les espaces réservés d’organisation {#using-with-organization-placeholders}
