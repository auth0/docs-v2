...
Gérez ces paramètres dans [Dashboard > Applications > Applications](%24%7Bmanage_url%7D/#/applications) dans les champs suivants :
...
* **Origines Web autorisées** : Liste des URL d’où peut provenir une demande d’autorisation utilisant l’[Authentification cross-origin](/login/cross-origin-authentication), le [Flux de l’appareil](/login/flows/device-authorization-flow) et [web_message comme mode de réponse](/protocols/oauth).
