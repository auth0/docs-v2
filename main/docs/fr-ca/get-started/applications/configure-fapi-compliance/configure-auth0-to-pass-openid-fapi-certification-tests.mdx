---
description: Apprenez à configurer Auth0 pour réussir les OpenID FAPI Conformance Tests.
...
#### Configurer les claims ACR pris en charge pour le tenant {#configure-supported-acr-claims-for-the-tenant}
...
#### Ajouter une Action pour exiger un scope et redirect_uri {#add-action-to-require-scope-and-redirect_uri}
