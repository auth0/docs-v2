...
* Soit [Configurez mTLS](/configure-mtls) (y compris [les alias mTLS](/get-started/applications/configure-mtls/configure-mtls-for-a-tenant#enable-mtls-aliases)) soit [Configurez la clé privée JWT](/applications/configure-private-key-jwt)
* [Configurez la liaison de jeton mTLS](/get-started/applications/configure-mtls/configure-mtls-for-a-client#enable-token-binding)
