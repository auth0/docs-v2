...
description: "Découvrez le mode permissif pour les applications tierces et en quoi il diffère des contrôles de sécurité stricts par défaut."
---
...
## Qui peut utiliser le mode permissif {#who-can-use-permissive-mode}
...
## Ce que signifie le mode permissif {#what-permissive-mode-means}
...
## La propriété `third_party_security_mode` {#the-third_party_security_mode-property}
...
## Dynamic Client Registration en mode permissif {#dynamic-client-registration-in-permissive-mode}
...
<Tabs>
  <Tab title="Auth0 Dashboard">
    ...
    <Frame>![Paramètres avancés du tenant dans l’Auth0 Dashboard avec le menu déroulant DCR Security Mode](/docs/images/third-party-applications/dcr-security-mode.png)</Frame>
  </Tab>
...
## Adopter des contrôles de sécurité renforcés {#adopt-enhanced-security-controls}
