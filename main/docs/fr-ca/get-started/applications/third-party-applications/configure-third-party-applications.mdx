...
When both per-application permissions and default permissions for third-party applications exist for the same API, per-application permissions take precedence.
