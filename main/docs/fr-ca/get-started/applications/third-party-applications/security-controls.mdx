...
## Normes OAuth 2.1 {#oauth-21-standards}
...
## Autorisation explicite de l’API {#explicit-api-authorization}
...
## De machine à machine (Client Credentials) {#machine-to-machine-client-credentials}
...
## Configuration restreinte du client {#restricted-client-configuration}
...
## Format du Client ID {#client-id-format}
...
## Paramètres des jetons d’actualisation {#refresh-token-settings}
...
## Protection contre les redirections {#redirect-protection}
...
## Validation des paramètres de `/authorize` {#authorize-parameter-validation}
