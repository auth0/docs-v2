...
## Qu’est-ce que la gestion des identités et des accès (IAM) ? {#what-is-identity-and-access-management-iam}
...
## Concepts de base de l’IAM {#iam-basic-concepts}
...
## La différence entre l’authentification et l’autorisation {#the-difference-between-authentication-and-authorization}
...
## Comment fonctionne l’IAM? {#how-does-iam-work}
...
### Normes d’authentification et d’autorisation {#authentication-and-authorization-standards}
...
#### Web Services Federation (WS-Fed) {#web-services-federation-ws-fed}
...
## Pourquoi utiliser une plateforme IAM? {#why-use-an-iam-platform}
