...
5. Select **Update**.
   ...
   In this view, you can select the drop-down and choose the scopes you want to add. We will learn more about scopes when discussing access tokens under the Authentification section.
...
* Update the scopes for your Jetons d’accès M2M
...
Before any non-interactive clients or services call your API, you need to define the permissions or Permissions your API allows. You can set the scopes in Auth0 Dashboard to include in your authentication request to Authentification API. To read more examples of ways to use API scopes, read [API Scopes](/docs/get-started/apis/scopes/api-scopes).
...
To mitigate these mismatch errors, you can use the Outil Deploy CLI to help you integrate your Auth0 instance with your existing CI/CD pipeline.  With dynamic keyword replacement, you can replace environmental variables on tenants sharing similar configurations. To learn more, read [Deploy CLI Tool](/docs/deploy-monitor/deploy-cli-tool) and [Keyword Replacement](/docs/deploy-monitor/deploy-cli-tool/keyword-replacement).
