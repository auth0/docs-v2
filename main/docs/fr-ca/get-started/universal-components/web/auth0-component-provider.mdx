...
<Tabs>
  ...
  <Tab title="Next.js">
    ...
    ***
    ...
    <div id="state-and-performance-2">
      ## État et rendement
    </div>
  ...
  <Tab title="shadcn">
    ...
    ***
    ...
    <div id="state-and-performance-3">
