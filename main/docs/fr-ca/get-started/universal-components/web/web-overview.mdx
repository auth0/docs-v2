...
<Tabs>
  <Tab title="React">
## Installer Universal Components {#install-universal-components}
...
## Configurer votre application {#configure-your-application}
...
## Configurer Universal Components {#configure-universal-components}
...
## Composants de style {#style-components}
  ...
  <Tab title="Next.js">
## Installer Universal Components {#install-universal-components-2}
...
## Configurer votre application {#configure-your-application-2}
...
## Configurer Universal Components {#configure-universal-components-2}
...
## Composants de style {#style-components-2}
  ...
  <Tab title="shadcn">
## Installer Universal Components {#install-universal-components-3}
    ...
    Ensuite, installez chaque composant Universal Components à l’aide de la CLI shadcn en utilisant le registre GitHub :
    ...
    <Callout icon="file-lines" color="#0EA5E9" iconType="regular">
      ...
      `@auth0/universal-components-core`, qui fournit des utilitaires partagés et l’intégration Auth0. Nécessite **shadcn CLI v2.5.0+** (prise en charge du registre GitHub).
    </Callout>

    <Callout icon="clock" color="#f59e0b" iconType="regular">
      **Registre Vercel Legacy** : les utilisateurs existants du chemin hébergé par Vercel
      (`https://auth0-universal-components.vercel.app/r/...`) n’ont pas besoin de migrer
      immédiatement. Le registre Vercel reste disponible jusqu’au **17 septembre 2026**.
      Les nouveaux projets doivent utiliser le chemin du registre GitHub ci-dessus.
    </Callout>

## Configurez votre application {#configure-your-application-3}
...
## Configurer Universal Components {#configure-universal-components-3}
...
## Composants de style {#style-components-3}
...
## Exemples de mise en œuvre {#example-implementations}
...
<CardGroup cols={2}>
  ...
  <Card title="Dépôt de démarrage SaaS" icon="github" href="https://github.com/auth0/saas-start-universal-components">
...
<CardGroup cols={2}>
  ...
  <Card title="Créer une interface libre-service de sécurité du compte" icon="key" href="/docs/fr-ca/get-started/universal-components/web/components/my-account-overview">
    Utilisez l’API My Account pour permettre à vos utilisateurs de gérer eux-mêmes leurs facteurs MFA et leurs clés d’identification.
  </Card>
</CardGroup>