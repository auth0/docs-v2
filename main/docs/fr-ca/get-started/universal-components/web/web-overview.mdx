...
<Tabs>
  <Tab title="React">
    <div id="install-universal-components">
    ...
    <div id="configure-universal-components">
  ...
  <Tab title="Next.js">
    <div id="install-universal-components-2">
      ## Installer Universal Components
    </div>
    ...
    <div id="configure-your-application-2">
      ## Configurer votre application
    </div>
    ...
    <div id="configure-universal-components-2">
      ## Configurer Universal Components
    </div>
  ...
  <Tab title="shadcn">
    <div id="install-universal-components-3">
      ## Installer Universal Components
    </div>
    ...
    <div id="configure-your-application-3">
    ...
    <div id="configure-universal-components-3">
      ## Configurer Universal Components
    </div>
