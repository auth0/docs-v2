...
## Préréglages de thème {#theme-presets}
...
## Remplacement par composant {#override-per-component}
...
## Personnalisations courantes {#common-customizations}

### Couleur de l&#39;image de marque {#brand-color}
...
### Typographie compacte {#compact-typography}
...
## Préréglages de thème {#theme-presets-tailwind}
...
## Référence des variables CSS {#css-variables-reference}
...
## Override via l&#39;API JS {#js-api-tailwind}
...
## Exception par composant {#override-per-component-tailwind}
...
## Personnalisations courantes {#common-customizations-tailwind}

### Couleur de l&#39;image de marque {#brand-color-tailwind}
...
### Coins arrondis {#soft-corners-tailwind}
...
### Typographie compacte {#compact-typography-tailwind}
...
## Mode sombre {#dark-mode-tailwind}
