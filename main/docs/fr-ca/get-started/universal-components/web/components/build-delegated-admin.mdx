...
<Tabs>
  <Tab title="React">
    ...
    <div id="enable-the-my-organization-api">
    ...
    <div id="configure-application-access">
    ...
    <div id="set-up-the-database-and-user">
  ...
  <Tab title="Next.js">
    ...
    <div id="create-the-application-2">
      ## Créer l&#39;application
    </div>
    ...
    <div id="enable-the-my-organization-api-2">
      ## Activer l&#39;API My Organization
    </div>
    ...
    <div id="configure-application-access-2">
      ## Configurer l&#39;accès à l&#39;application
    </div>
    ...
    <div id="set-up-the-database-and-user-2">
      ## Configurer la base de données et l&#39;utilisateur
    </div>
    ...
    <div id="create-an-organization-2">
      ## Créer une Organization
    </div>
    ...
    <div id="configure-environment-variables-2">
      ## Configurer les variables d&#39;environnement
    </div>
  ...
  <Tab title="shadcn">
    ...
    <div id="create-the-application-3">
      ## Créer l&#39;application
    </div>
    ...
    <div id="enable-the-my-organization-api-3">
      ## Activer l&#39;API My Organization
    </div>
    ...
    <div id="configure-application-access-3">
      ## Configurer l&#39;accès à l&#39;application
    </div>
    ...
    <div id="set-up-the-database-and-user-3">
      ## Configurer la base de données et l&#39;utilisateur
    </div>
    ...
    <div id="create-an-organization-3">
      ## Créer une Organization
    </div>
    ...
    <div id="configure-environment-variables-3">
      ## Configurer les variables d&#39;environnement
    </div>
