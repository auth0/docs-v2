...
### Activer My Account API {#enable-my-account-api}
...
### Créer l’application et configurer les permissions de My Account API {#create-the-application-and-configure-my-account-api-permissions}
...
### Activer My Account API {#enable-my-account-api-2}

    1. Accédez à [**Dashboard &gt; Applications &gt; APIs**](https://manage.auth0.com/#/apis).
    2. Sélectionnez **Activate My Account API** pour l’activer dans votre tenant.

### Créer l’application et configurer les permissions de My Account API {#create-the-application-and-configure-my-account-api-permissions-2}
...
### Configurer la base de données et l’utilisateur de test {#set-up-the-database-and-test-user}
...
### Configurer Universal Components {#configure-universal-components-2}
  ...
  <Tab title="shadcn">
## Prérequis {#prerequisites-3}

### Activer My Account API {#enable-my-account-api-3}

    1. Accédez à [**Dashboard &gt; Applications &gt; APIs**](https://manage.auth0.com/#/apis).
    2. Sélectionnez **Activate My Account API** pour l’activer dans votre locataire.

### Créer l’application et configurer les permissions de My Account API {#create-the-application-and-configure-my-account-api-permissions-3}
...
### Configurer la base de données et l’utilisateur de test {#set-up-the-database-and-test-user-2}
...
## Configurer votre application {#configure-your-application-3}

### Installer le composant {#install-the-component-3}
