...
### Activer les méthodes et les portées MFA {#enable-mfa-methods-and-scopes}
...
### Activer les méthodes et les portées MFA {#enable-mfa-methods-and-scopes-2}
...
### Activer les méthodes et les portées MFA {#enable-mfa-methods-and-scopes-3}
...
## Installer le composant {#install-the-component-3}
    ...
    <details>
      <summary>Ancien registre Vercel (obsolète)</summary>
...
### Propriétés d’Action {#action-props}
...
### Personnaliser les propriétés {#customize-props}
