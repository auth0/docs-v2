...
## Accès des applications tierces et accès interapplications {#third-party-application-access-and-cross-app-access}
      ...
      export default function App() {
        ...
        return (
          <Auth0Provider
            ...
            interactiveErrorHandler="popup" // Requis pour gérer les défis d’authentification renforcée au moyen de la fenêtre contextuelle de connexion universelle
          >
...
### Actions de l’onglet SSO {#sso-tab-actions}
...
### Actions de l’onglet Provisionnement {#provisioning-tab-actions}
...
### Actions de l’onglet Domaines {#domains-tab-actions}
...
### Propriétés d’affichage {#display-props-2}
...
### Actions de l’onglet SSO {#sso-tab-actions-2}
    ...
    **Type :** `ComponentAction<IdentityProvider>`
    ...
    Permet de retirer le fournisseur de l’organisation. Le fournisseur est dissocié de l’organisation, mais demeure dans le locataire et peut être ajouté de nouveau ultérieurement.
...
### Actions de l’onglet Provisionnement {#provisioning-tab-actions-2}
...
### Actions de l’onglet Domaines {#domains-tab-actions-2}
...
### Propriétés de personnalisation {#customization-props-2}
...
### Actions de l’onglet SSO {#sso-tab-actions-3}
...
### Actions de l’onglet d’approvisionnement {#provisioning-tab-actions-3}
...
### Actions de l’onglet Domaines {#domains-tab-actions-3}
