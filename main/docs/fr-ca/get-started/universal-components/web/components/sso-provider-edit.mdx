...
<Tabs>
    ...
    <table class="table">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            Retirer le fournisseur de l’organization sans le supprimer du tenant.
          </td>
        </tr>
      </tbody>
    </table>
  ...
  <Tab title="shadcn">
    ...
    **Type :** `ComponentAction<IdentityProvider>`
    ...
    Permet de retirer le fournisseur de l’organisation. Le fournisseur est dissocié de l’organisation, mais reste dans le tenant et peut être ajouté de nouveau ultérieurement.
