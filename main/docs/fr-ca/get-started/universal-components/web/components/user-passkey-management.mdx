...
<Tabs>
  <Tab title="React (SPA)">
## Installez le composant {#install-the-component}
...
## Installez le composant {#install-the-component-2}
...
## Pour commencer {#get-started-2}
  ...
  <Tab title="shadcn">
## Installez le composant {#install-the-component-3}
    ...
    <details>
      <summary>Ancien registre Vercel (déconseillé)</summary>
...
### Personnaliser les props {#customize-props}
