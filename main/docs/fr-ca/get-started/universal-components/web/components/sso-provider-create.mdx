...
## Accès des applications tierces et Cross App Access {#third-party-application-access-and-cross-app-access}
...
## Pour commencer {#get-started}
  ...
  <Tab title="Next.js">
## Configuration requise {#setup-requirements-2}
...
## Pour commencer {#get-started-2}
  ...
  <Tab title="shadcn">
## Prérequis de configuration {#setup-requirements-3}
...
## Installation {#installation-3}
    ...
    <Accordion title="Registre Vercel Legacy (obsolète)">
