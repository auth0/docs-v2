...
## Fournisseurs d’identité d’entreprise {#enterprise-providers}
...
## Groupes et rôles {#groups-and-roles}
...
## Traduction du profil {#profile-translation}
...
## Extensibilité avec des profils utilisateur enrichis {#extensibility-with-augmented-user-profiles}
...
## Intégrations d’authentification unique {#single-sign-on-integrations}
...
## Exportation des logs {#logs-export}
