...
## Étape 1. Définir le point de terminaison de l’API {#step-1-define-the-api-endpoint}
...
### Implémentez le point de terminaison {#implement-the-endpoint}
...
## Étape 2. Sécuriser le point de terminaison de l’API {#step-2-secure-the-api-endpoint}
...
## Étape 3. Vérifier les permissions du client {#step-3-check-the-client-permissions}
