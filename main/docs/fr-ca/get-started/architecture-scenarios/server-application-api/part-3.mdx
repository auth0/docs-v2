---
description: Mise en œuvre de l’application pour le scénario d’architecture serveur + API
...
### Sécuriser les points de terminaison d’API {#secure-the-api-endpoints}
...
## Vérifiez les permissions de l’application {#check-the-application-permissions}
...
### Mettre en place l’application machine à machine {#implement-the-machine-to-machine-application}

Dans cette section, nous verrons comment mettre en place une application machine à machine pour notre scénario.

### Obtenir un jeton d’accès {#get-an-access-token-2}
