...
## Configurer l’API {#configure-the-api}
...
### Profil de JSON Web Token {#json-web-token-profile}
...
## Configurer les scopes {#configure-the-scopes}
...
## Configurer l’accès de l’application à l’API {#configure-applications-access-to-the-api}
