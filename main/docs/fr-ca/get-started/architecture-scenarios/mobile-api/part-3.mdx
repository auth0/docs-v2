...
## Définir les API points de terminaison {#define-the-api-endpoints}
...
### Sécuriser les points de terminaison {#secure-the-endpoints}
...
### Vérifier les permissions du client {#check-the-clients-permissions}
...
### Déterminer l’identité de l’utilisateur {#determine-user-identity}
...
## Mettre en œuvre l’application mobile {#implement-the-mobile-app}
...
### Autoriser l’utilisateur {#authorize-the-user}
...
### Obtenir les identifiants {#get-the-credentials}
...
### Récupérer le profil de l’utilisateur {#get-the-user-profile}
...
### Afficher des éléments de l’interface utilisateur de façon conditionnelle selon le scope {#display-ui-elements-conditionally-based-on-scope}
...
### Actualiser le jeton {#renew-the-token}
...
| **client&#95;id**     | La valeur de votre Auth0 Client Id. Vous pouvez l’obtenir dans les Settings de votre Application dans l’[Auth0 Dashboard](https://manage.auth0.com/#/applications). |
| **refresh&#95;token** | le Refresh Token à utiliser, provenant du résultat d’authentification précédent.                                                                            |
