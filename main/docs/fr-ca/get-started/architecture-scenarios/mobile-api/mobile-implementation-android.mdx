---
description: La mise en œuvre Android de l’API pour le scénario d’architecture Mobile + API
...
## Étape 1. Configurer l’application {#step-1-set-up-the-application}

### Projet d’exemple {#sample-project}
...
### Configurer les dépendances {#set-the-dependencies}
...
### Mettre à jour le Manifest {#update-the-manifest}
...
### Définir les valeurs de configuration {#set-configuration-values}
...
## Étape 2. Autoriser l’utilisateur {#step-2-authorize-the-user}

### Mettre à jour le Manifest {#update-the-manifest-2}
...
### Créer l’Activity Login {#create-the-login-activity}
...
### Stocker les identifiants {#store-the-credentials}
...
## Étape 3. Récupérer le profil utilisateur {#step-3-get-the-user-profile}

### Créez le modèle User {#create-the-user-model}
...
### Stocker le profil utilisateur {#store-the-user-profile}
...
## Étape 4. Afficher des éléments d’interface conditionnellement selon le scope {#step-4-display-ui-elements-conditionally-based-on-scope}
...
### Stocker les scopes {#store-the-scope}
...
### Afficher le menu d’approbation en fonction du scope {#display-approval-menu-based-on-scope}
...
## Étape 5. Faire une requête à l’API {#step-5-call-the-api}

### Mettre à jour le Manifest {#update-the-manifest-3}
...
### Créez les mises en page de l’Activity Timesheets {#create-the-timesheets-activity-layouts}
...
### Créer le modèle de feuille de temps {#create-the-timesheet-model}
...
### Créer l’adaptateur Timesheet {#create-the-timesheet-adapter}
...
### Créer l’Activity Timesheet {#create-the-timesheet-activity}
...
## Étape 6. Afficher le profil de l’utilisateur {#step-6-view-the-user-profile}
...
### Mettre à jour le Manifest {#update-the-manifest-4}
...
#### Créer les mises en page de User Activity {#create-the-user-activity-layouts}
...
### Charger la photo de profil depuis l’URL {#load-the-profile-picture-from-url}
...
### Créer la User Activity {#create-the-user-activity}
...
## Étape 7. Formulaire pour les nouvelles feuilles de temps {#step-7-form-for-new-timesheets}

Créez ensuite `FormActivity` et le fichier de mise en page pour gérer la création de nouvelles entrées de feuille de temps.

### Mettre à jour le Manifest {#update-the-manifest-5}
...
### Créer les mises en page de l’Activity de formulaire {#create-the-form-activity-layouts}
...
### Créer la Form Activity {#create-the-form-activity}
