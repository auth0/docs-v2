---
description: La mise en œuvre de l’API en Node.js pour le scénario d’architecture applications mobiles + API
...
##### Créez un fichier package.json {#create-a-packagejson-file}
...
##### Ajouter votre Action au Trigger Post-Login {#add-your-action-to-the-post-login-trigger}
...
##### Récupérer l’identifiant unique {#retrieve-the-unique-identifier}
