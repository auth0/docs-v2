...
* **Organizations Auth0** : fait référence à la fonctionnalité de locataire Auth0 conçue pour soutenir les organizations. Une instance d’une [organization Auth0](/organizations/organizations-overview) fera généralement référence à un de vos clients en particulier.
