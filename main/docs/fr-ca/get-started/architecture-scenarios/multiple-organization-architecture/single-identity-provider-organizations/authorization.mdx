...
<td><ul><li>Must automate the creation of an API for every organization.</li><li>Independent roles may need to be created if using RBAC.</li>Must automate the provisioning of Rôles to Membership.<li>API implementation has to process for multiple audiences.</li></ul></td>
</tr>
<tr>
<td>Custom Claim</td>
