---
title: Image de marque interentreprises
sidebarTitle: Image de marque
...
## Universal Login et les pages de connexion {#universal-login-and-login-pages}
...
## Image de marque de la connexion selon l’organisation {#branding-login-by-organization}
...
## Noms de domaines personnalisés {#custom-domain-naming}
...
## Personnalisation des modèles de courriel {#email-template-customization}
...
## Personnalisation de la page de réinitialisation du mot de passe {#password-reset-page-customization}
...
## Personnalisation de la page multifacteur Guardian {#guardian-multi-factor-page-customization}
