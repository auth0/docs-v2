---
title: Gestion du profil interentreprises
sidebarTitle: Gestion du profil
...
### Métadonnées d’application {#app-metadata}
...
## Guide de planification du projet {#project-planning-guide}
...
## Architecture pour organisations multiples (multitenance) {#multiple-organization-architecture-multitenancy}
