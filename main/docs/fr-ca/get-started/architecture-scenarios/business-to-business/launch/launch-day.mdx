---
description: Coordonnez le jour du lancement de votre déploiement Auth0 B2B à l’aide d’un plan couvrant les avis aux parties prenantes, les étapes de basculement et de retour arrière, les critères de go/no-go, les contacts de garde et les indicateurs de réussite afin d’assurer une mise en production fluide et réversible.
title: Préparation du jour du lancement (B2B)
---

## Notifications / annonces {#notifications-announcements}
...
### Parties à aviser {#parties-to-notify}
...
## Plan de notification {#notification-plan}
...
## Distribution des notifications {#notification-distribution}
...
## Fenêtres d’indisponibilité (au besoin) {#outage-windows-if-needed}
...
## Plan de basculement (au besoin) {#cutover-plan-if-needed}
...
## Critères de go / no-go {#go-no-go-criteria}
...
## Personnes-ressources de garde {#standby-contacts}
...
## Plan des risques et mesures d’atténuation {#risks-mitigations-plan}
