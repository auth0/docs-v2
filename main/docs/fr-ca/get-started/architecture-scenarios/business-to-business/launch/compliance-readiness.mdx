...
## Publier une politique de confidentialité et obtenir le consentement de l’utilisateur {#publish-privacy-policy-and-obtain-user-consent}
...
## Permettre l’accès à la consultation, à la correction et à l’effacement des données {#provide-access-to-view-correct-and-erase-data}
...
## Donnez accès à la portabilité des données {#provide-access-to-data-portability}
...
## Prenez des mesures pour minimiser les renseignements personnels {#take-steps-to-minimize-personal-data}
...
## Application automatisée de la politique de conservation des données {#data-retention-policy-enforcement-automated}
...
## Protéger les renseignements personnels {#protect-personal-data}
...
## Évaluation des fournisseurs {#supplier-evaluation}
