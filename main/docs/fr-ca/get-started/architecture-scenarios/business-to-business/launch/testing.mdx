---
description: Confirmez que votre mise en œuvre B2B d’Auth0 est prête pour le lancement en effectuant des tests unitaires, d’intégration, de simulation, d’intrusion et de charge dans l’ensemble de vos tenants, conformément aux politiques de test d’Auth0, avant que vos clients n’en dépendent.
...
## Tests avec simulation {#mock-testing}
...
## Tests d’intrusion (facultatif) {#pen-testing-optional}
...
## Tests de charge (facultatif) {#load-testing-optional}
