---
title: Déconnexion interentreprises
sidebarTitle: Déconnexion
description: Concevez la déconnexion pour votre application B2B Auth0 en déterminant quelles sessions locales, Auth0 et d’IdP d’organisation terminer, ainsi que la façon de mettre en œuvre la déconnexion unique, la déconnexion fédérée et les redirections après déconnexion dans plusieurs applications.
---
...
## Où rediriger les utilisateurs après la déconnexion {#where-to-send-users-after-logout}
...
## Expiration automatique des sessions {#automatic-termination-of-sessions}
...
### Jetons à courte durée de vie {#short-lived-tokens}
...
### Créer un service de déconnexion {#build-a-logout-service}
...
## Déconnexion fédérée {#federated-logout}
