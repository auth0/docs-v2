---
title: Assurance qualité Business-to-Consumer
sidebarTitle: Assurance qualité
description: Planifiez l’assurance qualité d’une mise en œuvre Auth0 B2C IAM en définissant les environnements de test ainsi que la couverture de régression et les étapes d’approbation que chaque version doit franchir.
---
