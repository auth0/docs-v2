...
Service de stockage et de gestion des identités numériques." cta="Voir le glossaire">IdP</Tooltip>) dans Auth0 (c-à-d., au moyen de [SAML](/docs/fr-ca/authenticate/protocols/saml/saml-sso-integrations/configure-auth0-saml-service-provider) ou d’[OIDC](/docs/fr-ca/authenticate/identity-providers/social-identity-providers)).
