---
title: Déconnexion Business-to-Consumer
sidebarTitle: Déconnexion
description: Planifiez la déconnexion des utilisateurs dans une mise en œuvre Auth0 B2C IAM en déterminant quelles couches de session doivent être terminées à chaque déconnexion, de l’application au fournisseur d’identité.
---
