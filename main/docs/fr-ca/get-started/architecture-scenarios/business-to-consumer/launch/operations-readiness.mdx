---
title: Préparation opérationnelle Business-to-Consumer
sidebarTitle: Préparation opérationnelle
...
## Configuration du fournisseur de courriel {#email-provider-setup}
...
## Vérification des délais d’expiration de LoadBalancer {#loadbalancer-timeouts-checked}
...
## Configuration de LoadBalancer {#loadbalancer-configuration}
...
## Notifications d’Auth0 {#auth0-notifications}
...
### Notifications du Dashboard {#dashboard-notifications}
...
## Déploiement automatisé, contrôle de version {#automated-deployment-version-control}
...
<Warning>
  L’outil Deploy CLI et les source control extensions peuvent tous deux entraîner des changements destructifs; les changements manuels apportés directement dans le dashboard entre des déploiements automatisés pourraient être perdus! Pour cette raison, si l’un ou l’autre est utilisé, **tous** les changements doivent être déployés à partir du sous-système de contrôle de version référencé par l’outil, et non effectués manuellement.
</Warning>
...
## Variables propres au tenant {#tenant-specific-variables}
...
## Versions à jour {#versions-up-to-date}
...
## Plan de rotation des certificats {#certificate-rollover-plan}
...
### Connexions SAML {#saml-connections}
...
### Connexions WS-Fed {#ws-fed-connections}
...
## Plan de reprise après sinistre / plan de continuité des activités en place {#disaster-recovery-business-continuity-plan-in-place}
...
## Processus documentés {#processes-documented}
