---
title: Tests Business-to-Consumer terminés
sidebarTitle: Tests terminés
description: Planifiez les tests pour un lancement Auth0 B2C IAM en couvrant les flux Universal Login, les connexions sociales et la configuration d’inscription propre aux consommateurs utilisée par chaque application.
---
