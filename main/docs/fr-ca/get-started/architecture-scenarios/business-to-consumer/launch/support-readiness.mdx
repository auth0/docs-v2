...
Nous vous recommandons « Actions real-time log » (journal d'actions en temps réel) et de vous familiariser avec son utilisation pour visualiser le résultat du journal de votre code personnalisé en tant qu’outil de débogage et de soutien.
