...
description: Passez en revue les éléments à prendre en compte le jour du lancement d’une mise en œuvre Auth0 B2C IAM, notamment la coordination des scénarios de bascule et de retour arrière pour les applications destinées aux consommateurs mises en production.
---
...
## Plan de bascule (au besoin) {#cutover-plan-if-needed}
...
## Critères de décision go / no-go {#go-no-go-criteria}
...
## Plan des risques et des mesures d’atténuation {#risks-mitigations-plan}
