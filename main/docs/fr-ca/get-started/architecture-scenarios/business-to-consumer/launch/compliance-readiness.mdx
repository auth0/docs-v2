---
title: Préparation à la conformité Business-to-Consumer
sidebarTitle: Préparation à la conformité
...
## Publier la politique de confidentialité et obtenir le consentement de l’utilisateur {#publish-privacy-policy-and-obtain-user-consent}
...
## Donner accès à la portabilité des données {#provide-access-to-data-portability}
...
## Prenez des mesures pour minimiser les données personnelles {#take-steps-to-minimize-personal-data}
...
## Protégez les données personnelles {#protect-personal-data}
