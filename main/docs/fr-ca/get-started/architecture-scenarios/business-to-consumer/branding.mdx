...
### Meilleure pratique Pour fournir des ressources utiles aux utilisateurs qui rencontrent des problèmes, vous devez également configurer un nom facilement identifiable et un logo, ainsi qu’indiquer l’adresse courriel de support et l’URL de votre organisation. Pour en savoir plus, voir [Tableau de bord paramètres du locataire](https://manage.auth0.com/#/tenant/general). :::
