...
## Configurer le cookie et le middleware OIDC {#configure-the-cookie-and-oidc-middleware}
...
## Implement le Logout {#implement-the-logout}
...
## Autorisations Admin d’Implement {#implement-admin-permissions}
