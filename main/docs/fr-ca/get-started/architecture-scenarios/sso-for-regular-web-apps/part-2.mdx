...
<Info>
  ### Fournisseurs d’identité pris en charge {#supported-identity-providers}
...
### Créer une connexion Active Directory / LDAP {#create-an-active-directory-ldap-connection}
...
<Info>
  ### Prise en charge de Kerberos {#kerberos-support}
