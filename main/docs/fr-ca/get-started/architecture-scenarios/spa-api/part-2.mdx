...
### Définir les rôles {#define-roles}
...
### Attribuer des rôles aux utilisateurs {#assign-users-to-roles}
...
### Configurer l’Authorization Extension {#configuring-the-authorization-extension}
...
### Créer une Rule pour valider les scopes du token {#create-a-rule-to-validate-token-scopes}
