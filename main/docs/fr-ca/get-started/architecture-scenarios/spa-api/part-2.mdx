...
Accédez à la  [section API](%24%7Bmanage_url%7D/#/apis) du tableau de bord, puis cliquez sur le bouton **Créer une API**.
...
Pour créer une nouvelle application, accédez à [Tableau de bord](%24%7Bmanage_url%7D) et cliquez sur l’option de menu [Applications](%24%7Bmanage_url%7D/#/applications) sur la gauche. Cliquez sur le bouton **+ Créer une application**.
...
Vous devrez vous assurer que Authorization Extension est installée pour votre locataire. Vous pouvez consulter la [Documentation d’Authorization Extension](/extensions/authorization-extension) pour obtenir plus de détails sur la façon de procéder.
