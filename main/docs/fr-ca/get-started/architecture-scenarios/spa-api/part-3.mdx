...
## Définir les points de terminaison de l’API {#define-the-api-endpoints}
...
### Vérifier les permissions de l’application {#check-the-applications-permissions}
...
## Mettre en place la SPA {#implement-the-spa}
...
### Afficher conditionnellement des éléments de l’interface utilisateur en fonction du scope {#display-ui-elements-conditionally-based-on-scope}
...
### Faire une requête à l’API {#call-the-api}
...
### Renouveler le jeton d’accès {#renew-the-access-token}
