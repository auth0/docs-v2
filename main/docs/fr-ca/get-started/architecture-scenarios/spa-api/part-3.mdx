...
* **clientID** : La valeur de votre ID client Auth0. Vous pouvez la récupérer à partir des Paramètres de votre application dans le [Dashboard](https://manage.auth0.com/#/applications}).
* **Domaine**  : La valeur de votre domaine Auth0. Vous pouvez la récupérer à partir des Paramètres de votre application dans le [Dashboard](https://manage.auth0.com/#/applications}).
...
* **<Tooltip data-tooltip-id="react-containers-DefinitionTooltip-1" tip="">audience</Tooltip>** : Valeur de l’identifiant de votre API. Vous pouvez la récupérer à partir des [Paramètres de votre API](https://manage.auth0.com/#/apis}) dans le Tableau de bord.
