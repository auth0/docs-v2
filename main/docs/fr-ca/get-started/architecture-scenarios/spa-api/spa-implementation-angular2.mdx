---
description: La mise en œuvre Angular 2 du SPA pour le scénario d’architecture SPA + API
title: Mise en œuvre Angular 2 du SPA (SPAs + API)
---
...
## Étape 1. Configuration {#step-1-configuration}
...
### Créer un service d’autorisation {#create-an-authorization-service}
...
### Traiter le résultat de l’authentification {#process-the-authentication-result}
...
### Ajouter le composant Callback {#add-the-callback-component}
...
## Étape 3. Obtenir le profil de l’utilisateur {#step-3-get-the-user-profile}
...
## Étape 4. Afficher les éléments de l’UI de façon conditionnelle selon la portée {#step-4-display-ui-elements-conditionally-based-on-scope}
...
## Étape 5. Appeler l’API {#step-5-call-the-api}
...
## Étape 6. Renouveler le jeton d’accès {#step-6-renew-the-access-token}
