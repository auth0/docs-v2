...
# Mise en œuvre de l’API en Node.js (SPAs + API) {#nodejs-api-implementation-spas-api}
...
## Étape 1. Définir les points de terminaison de l’API {#step-1-define-the-api-endpoints}

Nous utiliserons le [framework d’applications web Express](http://expressjs.com/) pour créer notre API Node.js.

### Créer un fichier package.json {#create-a-packagejson-file}
...
### Implémentez les points de terminaison {#implement-the-endpoints}
...
## Étape 2. Sécuriser les points de terminaison de l’API {#step-2-secure-the-api-endpoints}
...
## Étape 3. Vérifier les permissions de l’application {#step-3-check-the-application-permissions}
...
## Étape 4. Déterminer l’identité de l’utilisateur {#step-4-determine-the-user-identity}
