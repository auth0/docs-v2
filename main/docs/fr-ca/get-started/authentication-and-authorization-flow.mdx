...
## Flux de code d’autorisation avec clé de preuve pour l’échange de code (PKCE) {#authorization-code-flow-with-proof-key-for-code-exchange-pkce}
...
## Flux de code d’autorisation avec une protection renforcée de la confidentialité {#authorization-code-flow-with-enhanced-privacy-protection}
...
## Flux implicite avec Form Post {#implicit-flow-with-form-post}
...
## Flux d’autorisation de l’appareil {#device-authorization-flow}
...
## Flux de mot de passe du propriétaire de la ressource {#resource-owner-password-flow}
...
## Échange de jetons personnalisé {#custom-token-exchange}
