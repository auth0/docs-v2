...
description: Importez vos propres clés publiques de signature dans votre tenant Auth0 afin que les jetons soient signés avec des clés que vous contrôlez plutôt qu’avec des clés générées par Auth0.
---
...
## Configurez vos clés personnalisées avec Management API {#configure-your-custom-keys-with-management-api}
