---
description: Découvrez comment faire la rotation de la clé de signature de l’application ou de l’API de votre tenant à l’aide de l’Auth0 Dashboard ou de la Management API.
...
3. Cliquez sur **Rotate** pour confirmer.
   ...
   <Frame>![Dashboard Settings onglet Signing Keys confirmation de la rotation](/docs/images/cdy7uua7fh8z/6Ofp24mgt8ZrvaxF2wLA5N/5cca1a3267ffdc07f61d7990b4e85989/Rotating_Key_Warning_-_English.png)</Frame>
...
## Impact de la rotation des clés {#key-rotation-impact}

### API et passerelles d’API acceptant des jetons d’accès {#apis-and-api-gateways-accepting-access-tokens}
...
### Auth0 comme IdP SAML ou WS-Fed {#auth0-as-a-saml-or-ws-fed-idp}
