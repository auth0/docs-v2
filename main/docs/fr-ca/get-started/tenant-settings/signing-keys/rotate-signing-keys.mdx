...
| Valeur | Description |
| --- | --- |
| `MGMT_API_ACCESS_TOKEN` | [Access Token for the Management API (Jeton d’accès pour Management API)](https://auth0.com/docs/api/management/v2/tokens) avec les permissions `create:signing_keys` et `update:signing_keys`. |
