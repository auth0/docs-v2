...
sidebarTitle: Aperçu
description: Auth0 utilise des paires de clés de signature RS256 pour signer les jetons d’identité, les jetons d’accès et les assertions SAML. Découvrez comment la rotation permet à vos applications de continuer à faire confiance aux clés valides.
---
