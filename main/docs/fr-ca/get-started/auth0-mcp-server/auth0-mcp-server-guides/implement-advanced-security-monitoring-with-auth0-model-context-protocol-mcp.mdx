---
description: Utilisez Auth0 Model Context Protocol (MCP) Server et Claude pour mettre en place un système sophistiqué de surveillance de la sécurité et de réponse automatique.
title: Mettre en place une surveillance avancée de la sécurité avec Auth0 Model Context Protocol (MCP) Server
sidebarTitle: Mettre en place une surveillance avancée de la sécurité
...
<Card title="Aperçu">
  ...
  3. Mettre en place des défis d’authentification adaptatifs en fonction de l’évaluation des risques
...
### Étape 1 : Mettre en place la surveillance avancée des journaux {#step-1-set-up-advanced-log-monitoring}

La première étape pour bâtir un système de surveillance de la sécurité consiste à comprendre à quoi ressemblent les schémas d’authentification normaux dans votre environnement. Avec Auth0 MCP Server, vous pouvez analyser rapidement vos journaux afin d’établir ce point de référence.
...
Claude utilisera l’outil `auth0_list_logs` pour récupérer et analyser vos journaux. Cette analyse vous donne un point de référence pour comprendre les schémas normaux d’authentification, ce qui est essentiel pour repérer les anomalies.

### Étape 2 : Créer des Actions de détection de sécurité {#step-2-create-security-detection-actions}
...
### Étape 3 : Créer des Actions de réponse automatique {#step-3-create-automated-response-actions}
...
### Étape 4 : Déployer les Actions de sécurité {#step-4-deploy-the-security-actions}
...
### Étape 5 : Créer des Forms de défi de sécurité personnalisés {#step-5-create-custom-security-challenge-forms}
...
Claude utilisera l’outil `auth0_create_form` pour créer un Form personnalisé.

## Étape 6 : Surveillez les événements de sécurité {#step-6-monitor-security-events}
...
## Étape 7 : Peaufinez le système de sécurité {#step-7-fine-tune-the-security-system}
