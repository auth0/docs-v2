...
Your browser will automatically open to initiate the <Tooltip href="/docs/fr-ca/glossary?term=oath2" tip="OAuth 2.0
Cadre d’applications d’autorisation qui définit les protocoles d’autorisation et les flux de production." cta="Voir le glossaire">OAuth 2.0</Tooltip> device <Tooltip href="/docs/fr-ca/glossary?term=authorization-flow" tip="Flux d’autorisation
