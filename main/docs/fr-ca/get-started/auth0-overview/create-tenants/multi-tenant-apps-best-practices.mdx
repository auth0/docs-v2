...
## Solutions héritées {#legacy-solutions}
...
### Utiliser les connexions Auth0 {#use-auth0-connections}
...
### Utiliser des applications Auth0 {#use-auth0-applications}
...
### Utiliser des tenants Auth0 {#use-auth0-tenants}
...
### Stocker les détails du tenant dans le profil de l&#39;utilisateur {#store-tenant-details-in-the-users-profile}
