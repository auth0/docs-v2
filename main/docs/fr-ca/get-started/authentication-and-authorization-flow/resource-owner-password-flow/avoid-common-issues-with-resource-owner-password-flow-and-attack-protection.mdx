...
## Protection contre les attaques et API côté serveur {#attack-protection-and-server-side-apis}
...
## Configurez votre application pour faire confiance à l’adresse IP {#configure-your-application-to-trust-the-ip-address}
...
## Envoyez l&#39;adresse IP de l&#39;utilisateur depuis votre serveur {#send-the-users-ip-address-from-your-server}
...
## Gérer les réponses de Breached Password Detection {#handle-breached-password-detection-responses}
...
## Valider à l’aide des journaux {#validate-with-logs}
