---
description: Découvrez comment effectuer une requête vers votre propre API depuis des applications hautement fiables à l’aide du flux Resource Owner Password.
title: Effectuer une requête vers votre API à l’aide du flux Resource Owner Password
---
...
### Configurer le tenant {#configure-tenant}
...
#### Exemple de requête POST vers l’URL du jeton {#example-post-to-token-url}
...
### Configurer la prise en charge des realms {#configure-realm-support}
...
### Configurer l’authentification multifacteur {#configure-mfa}
...
### Configurer la protection contre les attaques {#configure-attack-protection}
