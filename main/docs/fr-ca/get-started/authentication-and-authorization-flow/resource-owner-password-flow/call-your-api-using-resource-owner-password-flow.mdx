...
Toute connexion qui prend en charge l’authentification active peut être configurée comme une partition, notamment les [connexions à des bases de données](/docs/fr-ca/authenticate/database-connections), les [connexions sans mot de passe](/docs/fr-ca/authenticate/passwordless) et les connexions d’entreprise [AD/LDAP](/docs/fr-ca/connections/enterprise/active-directory-ldap), [ADFS](/docs/fr-ca/connections/enterprise/adfs) et [Azure Active Directory](/docs/fr-ca/connections/enterprise/azure-active-directory).
