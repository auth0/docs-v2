...
| Nom du paramètre | Description |
| --- | --- |
| `grant_type` | Définir cette option sur « urn:ietf:params:oauth:grant-type:device_code ». Il s’agit d’un type de subvention d’extension (tel que défini par la section 4.5 de [RFC6749](https://tools.ietf.org/html/rfc6749#section-4.5)). Notez que cela doit être encodé en URL. |
