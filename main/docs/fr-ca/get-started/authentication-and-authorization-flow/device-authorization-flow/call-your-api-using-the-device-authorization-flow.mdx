...
#### Exemple de requête POST à l’URL du code d’appareil {#example-post-to-device-code-url}
...
#### Réponse de code d’appareil {#device-code-response}
...
#### Exemple de requête POST à l’URL du jeton {#example-request-token-post-to-token-url}
...
##### Paramètres de la demande de jeton {#token-request-parameters}
...
#### Réponses de jeton {#token-responses}
...
### Effectuer une requête à votre API {#call-your-api}
...
#### Exemple de requête POST de jeton d’actualisation à l’URL de jeton {#example-refresh-token-post-to-token-url}
...
### Détecter l’utilisation du flux d’autorisation d’appareil {#detect-device-authorization-flow-use}
