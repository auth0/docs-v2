...
## Étape 4 : L’application mobile reçoit la notification push {#step-4-mobile-application-receives-the-push-notification}
...
## Étape 5 : L’application mobile récupère les détails de consentement {#step-5-mobile-application-retrieves-the-consent-details}
...
## Étape 7 : L’application mobile renvoie la réponse de l’utilisateur à Auth0 {#step-7-mobile-application-sends-the-user-response-back-to-auth0}
