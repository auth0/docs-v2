---
description: Découvrez comment utiliser requête d’autorisation enrichi avec le flux backchannel initié par le client.
...
## Étape 1 : L’application cliente lance une requête CIBA {#step-1-client-application-initiates-a-ciba-request}
...
## Étape 2 : le tenant Auth0 reçoit la requête CIBA {#step-2-auth0-tenant-acknowledges-the-ciba-request}
...
## Étape 4 : l’appareil d’authentification reçoit la notification {#step-4-authentication-device-receives-the-notification}
...
## Étape 5 : l’appareil d’authentification récupère les détails du consentement {#step-5-authentication-device-retrieves-the-consent-details}
...
## Étape 6 : L’appareil d’authentification présente à l’utilisateur les détails du consentement {#step-6-authentication-device-presents-the-consent-details-to-the-user}
...
## Étape 7 : L’appareil d’authentification renvoie la réponse de l’utilisateur à Auth0 {#step-7-authentication-device-sends-the-user-response-back-to-auth0}
...
## Étape 9 : Auth0 renvoie le jeton d’accès à l’application cliente {#step-9-auth0-returns-access-token-to-client-application}
...
## Interroger authorization_details {#query-authorization_details}
