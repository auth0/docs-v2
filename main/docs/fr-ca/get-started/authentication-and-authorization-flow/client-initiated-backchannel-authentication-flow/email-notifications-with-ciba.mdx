---
description: Découvrez comment authentifier les utilisateurs avec le flux Client-Initiated Backchannel Authentication au moyen de notifications par courriel.
...
## Étape 1 : L’application cliente lance une demande CIBA {#step-1-client-application-initiates-a-ciba-request}
...
## Étape 2 : le tenant Auth0 confirme la réception de la requête CIBA {#step-2-auth0-tenant-acknowledges-the-ciba-request}
...
## Étape 3 : L’application cliente interroge périodiquement pour obtenir une réponse {#step-3-client-application-polls-for-a-response}
...
## Étape 4 : Auth0 envoie un lien à l’adresse courriel de l’utilisateur {#step-4-auth0-sends-a-link-to-the-users-email-address}
...
## Étape 5 : L’utilisateur s’authentifie dans le navigateur {#step-5-user-authenticates-in-the-browser}
...
## Étape 6 : Le navigateur renvoie la réponse de l’utilisateur à Auth0 {#step-6-browser-sends-the-user-response-back-to-auth0}
...
### L’utilisateur accepte la requête d’authentification {#user-accepts-the-authentication-request}
...
### L’utilisateur refuse la requête d’authentification {#user-rejects-the-authentication-request}
...
## Étape 7 : Auth0 reçoit la réponse de l’utilisateur une fois le flux terminé {#step-7-auth0-receives-user-response-after-the-flow-completes}
...
## Étape 8 : Auth0 renvoie le jeton d’accès à l’application cliente {#step-8-auth0-returns-access-token-to-client-application}
