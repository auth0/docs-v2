...
## Code de départ et paramètres {#starter-code-and-parameters}
...
### Réponse par défaut {#default-response}
...
### Réponse du code de départ {#starter-code-response}
...
## Exemple de script : Ajouter un scope supplémentaire au jeton d’accès {#sample-script-add-an-additional-scope-to-the-access-token}
...
## Exemple de script : Ajouter un claim au jeton d’accès {#sample-script-add-a-claim-to-the-access-token}
...
## Exemple de script : générer une erreur ou rejeter un jeton d’accès {#sample-script-raise-an-error-or-deny-an-access-token}
