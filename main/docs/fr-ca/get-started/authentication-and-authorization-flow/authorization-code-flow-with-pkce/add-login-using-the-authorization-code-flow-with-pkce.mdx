---
description: Découvrez comment ajouter la fonctionnalité de connexion à votre application native, mobile ou monopage à l’aide du flux du code d’autorisation avec la clé de preuve pour l’échange de code (PKCE).
...
### Exemple d’URL d’autorisation {#authorization-url-example}
...
### Exemple de requête POST à l’URL du jeton {#post-to-token-url-example}
...
### Requête d’authentification de base {#basic-authentication-request}
...
### Demander le nom et la photo de profil de l’utilisateur {#request-users-name-and-profile-picture}
...
### Demander à l’utilisateur de se connecter avec GitHub {#request-user-log-in-with-github}
