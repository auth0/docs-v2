...
<Frame>![](/docs/images/fr-ca/cdy7uua7fh8z/4MAnVR9sNU2OtlGQ12taaV/1b620f339336c1f591957157e4913bb1/Screenshot_2025-01-13_at_4.15.04_PM.png)</Frame>
...
| Lire... | Pour apprendre... |
| --- | --- |
| [Configurer une authentification Back-channel initiée par le client](/docs/fr-ca/get-started/applications/configure-client-initiated-backchannel-authentication) | Comment configurer le type d’autorisation CIBA pour votre application. |
| [Authentification des utilisateurs avec CIBA](/docs/fr-ca/get-started/authentication-and-authorization-flow/client-initiated-backchannel-authentication-flow/user-authentication-with-ciba) | Comment authentifier des utilisateurs avec le flux CIBA, étape par étape. |