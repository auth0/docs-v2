---
description: Découvrez comment le flux CIBA permet à un service backend d’amorcer l’authentification sur un appareil distinct, comme une application mobile, sans interaction avec un navigateur.
sidebarTitle: Aperçu
...
## Limites des entités {#entity-limits}
