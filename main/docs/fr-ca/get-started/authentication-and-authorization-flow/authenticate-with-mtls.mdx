---
description: Découvrez comment le protocole TLS mutuel (mTLS) sécurise les flux OAuth en remplaçant les secrets client partagés par des certificats X.509 et, facultativement, en liant les jetons d’accès au client.
title: S’authentifier avec mTLS
---

## mTLS dans OAuth/OIDC {#mtls-in-oauthoidc}
...
## Appeler le serveur d’autorisation {#call-the-authorization-server}
...
## Appeler le serveur de ressources {#call-the-resource-server}
