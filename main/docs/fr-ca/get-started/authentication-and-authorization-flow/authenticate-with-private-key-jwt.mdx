...
## Créer l’assertion {#build-the-assertion}
...
## Échanger une assertion contre des jetons d’accès {#exchange-assertion-for-access-tokens}
...
## Limites de l’assertion {#assertion-limits}
