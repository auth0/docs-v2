...
## Générer un nonce cryptographiquement aléatoire {#generate-a-cryptographically-random-nonce}
...
## Enregistrer les nonces d’une requête à l’autre {#persist-nonces-across-requests}
...
## Valider l’ID token {#validate-id-token}
