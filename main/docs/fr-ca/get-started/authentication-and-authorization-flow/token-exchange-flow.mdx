---
description: Comprendre le flux d’échange de jetons (RFC 8693) dans Auth0, y compris comment configurer des profils et des Actions d’échange de jeton personnalisé afin d’émettre des jetons Auth0.
