---
description: Découvrez comment appeler votre API avec un jeton de sujet afin de l’échanger contre des jetons d’accès, ID et d’actualisation Auth0 à l’aide de Custom Token Exchange.
sidebarTitle: Appeler votre API à l’aide du flux d’échange de jeton personnalisé
title: Appeler votre API à l’aide du flux d’échange de jeton personnalisé
---
...
## Exemple de requête avec un jeton d’acteur {#sample-request-with-actor-token}
