---
description: Découvrez comment ajouter la connexion à votre application Web traditionnelle au moyen du flux de code d’autorisation.
title: Ajouter la connexion au moyen du flux de code d’autorisation
---
...
## Obtenir des jetons {#request-tokens}
...
### Demander le nom de l’utilisateur et sa photo de profil {#request-users-name-and-profile-picture}
