---
description: Découvrez comment utiliser Rich Authorization Requests (RAR) avec le flux du code d’autorisation.
title: Flux du code d’autorisation avec Rich Authorization Requests (RAR)
...
## Configurer RAR pour le flux du code d’autorisation {#configure-rar-for-the-authorization-code-flow}
...
## Accéder à `authorization_details` dans Actions {#access-authorization_details-in-actions}
...
## Qu’est-ce qui n’est pas pris en charge par Auth0? {#what-doesnt-auth0-support}
