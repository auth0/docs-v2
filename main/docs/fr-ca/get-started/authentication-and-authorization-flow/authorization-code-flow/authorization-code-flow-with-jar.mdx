...
## Générer la requête JAR {#generate-the-jar-request}
...
## Exemple de code : générer et signer un JAR {#code-sample-generate-and-sign-jar}
...
### Requête JAR standard {#standard-jar-request}
...
### Requête d’autorisation poussée {#pushed-authorization-request}
