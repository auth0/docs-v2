...
## Effectuer une requête vers le point de terminaison PAR {#call-the-par-endpoint}
...
### Exemple de requête PAR {#example-par-request}
...
### Exemple de réponse PAR {#example-par-response}
...
## Appeler le point de terminaison d’autorisation {#call-the-authorization-endpoint}
