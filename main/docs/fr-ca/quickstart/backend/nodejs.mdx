...
description: Ce guide explique comment protéger les points de terminaison d’une API Express.js à l’aide de jetons d’accès JWT avec le SDK express-oauth2-jwt-bearer.
mode: wide
---
...
### Valeur &quot;iss&quot; ou &quot;aud&quot; inattendue {#unexpected-iss-or-aud-value}
...
### &quot;You must provide an issuerBaseURL&quot; ou &quot;audience is required&quot; {#you-must-provide-an-issuerbaseurl-or-audience-is-required}
...
### 401 Unauthorized pour toutes les requêtes {#401-unauthorized-on-all-requests}
...
### 403 Forbidden avec &quot;insufficient_scope&quot; {#403-forbidden-with-insufficient_scope}
