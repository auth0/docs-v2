...
<AccordionGroup>
  <Accordion title="Problèmes courants et solutions">
    ...
    **Solutions :**
    ...
    <div id="unexpected-iss-or-aud-value">
    ...
    **Solutions :**
    ...
    <div id="you-must-provide-an-issuerbaseurl-or-audience-is-required">
    ...
    **Solutions :**
    ...
    <div id="401-unauthorized-on-all-requests">
    ...
    **Étapes de débogage :**
    ...
    <div id="403-forbidden-with-insufficient_scope">
