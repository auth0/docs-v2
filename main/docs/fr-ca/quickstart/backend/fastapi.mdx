---
mode: wide
description: 'Découvrez comment ajouter l’authentification JWT d’Auth0 à un backend FastAPI en Python, en validant les jetons d’accès et en protégeant les points de terminaison selon l’audience et la scope.'
...
### Interrogez votre API {#call-your-api}
