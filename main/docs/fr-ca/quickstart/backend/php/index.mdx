...
## Configurer les API Auth0 {#configure-auth0-apis}
...
## Intégration de votre API backend PHP {#integrating-your-php-backend-api}
...
### Authentifier l’utilisateur {#authenticating-the-user}
...
### Autoriser un jeton d’accès {#authorizing-an-access-token}
