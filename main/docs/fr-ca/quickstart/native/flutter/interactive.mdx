...
<QuickstartButtons githubLink="https://github.com/auth0-samples/auth0-flutter-samples/tree/main/sample" lang="fr-ca" />
...
<Recipe>
  <Content>
    ...
    Vous devez également être familiarisé avec [Outil de ligne de commande Flutter](https://docs.flutter.dev/reference/flutter-cli).
      ...
      Allez à la [page des paramètres](https://manage.auth0.com/#/applications/{yourClientId}/settings) de votre application Auth0, faites défiler jusqu’en bas, et ouvrez **Advanced Settings (Paramètres avancés) > Device Settings (Paramètres de l’appareil)**. Dans la section **iOS**, définissez **Team ID** sur votre [Apple Team ID](https://developer.apple.com/help/account/manage-your-team/locate-your-team-id/) et **App ID** sur l’identificateur du bundle de votre application.
