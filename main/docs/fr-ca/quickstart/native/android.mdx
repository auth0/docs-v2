...
<Accordion title="Problèmes courants et solutions">
  <div id="chrome-custom-tab-doesnt-redirect-back-to-app">
  ...
  **Solutions :**
  ...
  <div id="app-crashes-auth0-domain-not-found">
  ...
  **Correctif :**
  ...
  <div id="build-errors-with-dependencies">
  ...
  **Correctif :**
  ...
  <div id="authentication-cancelled-by-user">
  ...
  <div id="no-compatible-browser-error">
...
<Accordion title="Configurer Android App Links">
  ...
  <div id="get-your-signing-certificate-fingerprint">
    ### Obtenez l’empreinte de votre certificat de signature
  </div>
  ...
  <div id="configure-in-the-auth0-dashboard">
  ...
  <div id="verify-the-configuration">
...
<Accordion title="Intégration Android avancée">
  <div id="enhanced-credential-security">
  ...
  <div id="custom-scopes-and-audience">
