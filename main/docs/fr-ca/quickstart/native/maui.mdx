...
<Accordion title="Jetons d’actualisation">
  ...
  ### Activer les jetons d’actualisation {#enable-refresh-tokens}
  ...
  ### Utiliser les jetons d’actualisation {#use-refresh-tokens}
...
<Accordion title="Personnaliser Universal Login">
  ...
  Pour en savoir plus, consultez [Customize Universal Login](/docs/fr-ca/customize/login-pages).
</Accordion>
