---
title: Ajouter la fonctionnalité de connexion à votre application Expo
sidebarTitle: Expo
description: Ce guide explique comment intégrer Auth0 à n’importe quelle application Expo à l’aide du SDK Auth0 pour React Native.
mode: wide
---
...
<Accordion title="Problèmes courants et solutions">
  ### &quot;Invariant Violation: Native module cannot be null&quot; {#invariant-violation-native-module-cannot-be-null}
  ...
  **Correctif :**
  ...
  ### Le prebuild échoue ou le plugin n’est pas appliqué {#prebuild-fails-or-plugin-not-applied}
  ...
  **Correctif :**
  ...
  ### La build iOS échoue avec des erreurs Pod {#ios-build-fails-with-pod-errors}
