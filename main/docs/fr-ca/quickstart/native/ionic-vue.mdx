...
<Accordion title="Problèmes courants et solutions">
  ### Erreur de non-correspondance de l’URL de rappel {#callback-url-mismatch-error}
  ...
  **Correctif :**
  ...
  ### Le login fonctionne, mais l’utilisateur reste non authentifié après le redémarrage de l’application {#login-works-but-user-stays-unauthenticated-after-app-restart}
  ...
  ### Le navigateur ne se ferme pas après le login {#browser-doesnt-close-after-login}
  ...
  ### La page de connexion s’ouvre dans l’application de navigateur par défaut de l’appareil {#login-page-opens-in-the-devices-default-browser-app}
