...
<Accordion title="Problèmes courants et solutions">
  <div id="browser-doesnt-redirect-back-to-app">
  ...
  **Solutions :**
  ...
  <div id="authentication-fails-with-invalid-callback-url-error">
  ...
  * Vérifiez que le `Domain` dans votre code correspond au `Domain` dans l’Auth0 Dashboard
  ...
  <div id="loginasync-hangs-or-never-completes">
  ...
  * Vérifiez la connectivité réseau
  ...
  <div id="error-default-app-must-use-token-endpoint-authentication-method-none">
  ...
  **Correctif :**
  ...
  <div id="ios-browser-doesnt-open">
...
<Accordion title="Configuration avancée">
  ...
  <div id="platform-specific-browser-configuration">
