...
## Accéder aux renseignements de l’utilisateur {#access-user-information}
...
### Résultat d’authentification {#authentication-result}
...
### Parcourir l’ensemble des claims {#iterate-through-all-claims}
...
### Demander des scopes personnalisés {#request-custom-scopes}
...
<Accordion title="Problèmes courants et solutions">
  ### Le navigateur ne redirige pas vers l’application {#browser-doesnt-redirect-back-to-app}
  ...
  **Solutions :**
  ...
  ### L’authentication échoue avec l’erreur « Invalid Callback URL » {#authentication-fails-with-invalid-callback-url-error}
  ...
  * Vérifiez que le `Domain` dans votre code correspond au `Domain` dans l’Auth0 Dashboard
  ...
  ### LoginAsync() se bloque ou ne se termine jamais {#loginasync-hangs-or-never-completes}
  ...
  * Vérifiez la connectivité réseau
  ...
  ### Error : « Default App must use Token Endpoint Authentication Method &#39;None&#39; » {#error-default-app-must-use-token-endpoint-authentication-method-none}
  ...
  **Correctif :**
  ...
  ### iOS : le navigateur ne s’ouvre pas {#ios-browser-doesnt-open}
...
<Accordion title="Considérations pour la production">
  ...
  * **ProGuard/obscurcissement du code** : ajoutez les règles appropriées si vous utilisez l’obscurcissement du code sur Android
  ...
  ### Exigences des boutiques d’applications {#app-store-requirements}
...
<Accordion title="Configuration avancée">
  ...
  ### Configuration du navigateur propre à la plateforme {#platform-specific-browser-configuration}
