...
## Dépannage et utilisation avancée {#troubleshoot-advanced-use}

<Accordion title="Problèmes courants et solutions">
  ### Le navigateur s’ouvre, mais l’application ne reçoit pas le callback {#browser-opens-but-app-doesnt-receive-callback}
  ...
  **Correctif :**
  ...
  ### L’authentication expire après 5 minutes {#authentication-times-out-after-5-minutes}
  ...
  **Correctif :** L’application n’a jamais reçu l’URI de callback. Vérifiez :
  ...
  ### Une deuxième instance de l’application se lance au lieu de transmettre l’URI {#second-app-instance-launches-instead-of-forwarding-uri}
  ...
  **Correctif :**
  ...
  ### WindowsWebAuthentication est introuvable {#windowswebauthentication-not-found}
  ...
  **Correctif :** Assurez-vous que votre `pubspec.yaml` précise la version bêta :
  ...
  ### Erreur de non-correspondance de l’URL de callback {#callback-url-mismatch-error}
...
* [Quickstart Flutter (Android, iOS, macOS, Web)](/docs/fr-ca/quickstart/native/flutter) — guides pour d’autres plateformes.
* [Bonnes pratiques de stockage des jetons](/docs/fr-ca/secure/security-guidance/data-security/token-storage) — gestion sécurisée des identifiants.
* [Auth0 Universal Login](/docs/fr-ca/authenticate/login/auth0-universal-login) — personnaliser l’expérience de connexion.