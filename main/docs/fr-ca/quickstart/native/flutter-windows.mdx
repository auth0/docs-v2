...
<Accordion title="Problèmes courants et solutions">
  <div id="browser-opens-but-app-doesnt-receive-callback">
  ...
  **Correctif :**
  ...
  <div id="authentication-times-out-after-5-minutes">
  ...
  **Correctif :** L’application n’a jamais reçu l’URI de callback. Vérifiez :
  ...
  <div id="second-app-instance-launches-instead-of-forwarding-uri">
  ...
  **Correctif :**
  ...
  <div id="windowswebauthentication-not-found">
