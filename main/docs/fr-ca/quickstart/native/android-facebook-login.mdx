...
<Accordion title="Problèmes courants et solutions">
  ### L&#39;échange de jetons échoue avec une erreur d&#39;authentication {#token-exchange-fails-with-authentication-error}
  ...
  * Vérifiez que votre application Facebook n&#39;est pas en mode développement si vous faites des tests avec des utilisateurs non administrateurs
  ...
  ### `AuthenticationException` : &quot;Connection not found&quot; {#authenticationexception-connection-not-found}
