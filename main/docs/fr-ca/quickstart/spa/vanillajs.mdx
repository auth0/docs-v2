---
mode: wide
description: Ce guide montre comment intégrer Auth0, ajouter l’authentification et afficher les renseignements du profil utilisateur dans une application monopage (SPA) qui utilise JavaScript pur, au moyen du Auth0 SPA SDK.
