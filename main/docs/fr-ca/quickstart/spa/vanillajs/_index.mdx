  ...
  <Content>
    ...
    * Disposer d’un projet fonctionnel avec lequel vous souhaitez vous intégrer. Vous pouvez également consulter ou télécharger une application faisant office d’exemple lorsque vous vous connectez.
    ...
    <Section id={sections[3].id} title={sections[3].title} stepNumber="4" isSingleColumn>
      ...
      - your application redirects you to the [Auth0 Universal Login](/features/universal-login) page
    ...
    <Section id={sections[5].id} title={sections[5].title} stepNumber="6" isSingleColumn>
      Users who log in to your project will also need [a way to log out](/docs/authenticate/login/logout/log-users-out-of-auth0). The Auth0 client provides a `logout()` method that you can use
