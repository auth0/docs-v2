...
description: "Ajoutez la connexion Auth0 à une application Web Spring Boot à l’aide du Okta Spring Boot Starter."
---
...
<Accordion title="Contrôle d’accès basé sur les rôles">
  ...
  ### Ajouter des rôles aux jetons {#add-roles-to-tokens}
  ...
  ### Configurer l’autorisation {#configure-authorization}
...
## Application d’exemple {#sample-application}
