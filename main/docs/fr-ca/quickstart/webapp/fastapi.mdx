...
<Accordion title="Prompt d’IA" defaultOpen icon="microchip-ai" iconType="sharp-solid">
  **Vous utilisez l&#39;IA pour intégrer Auth0 ?** Ajoutez ce prompt à Cursor, Windsurf, Copilot, Claude Code ou à votre IDE préféré alimenté par l&#39;IA pour accélérer le développement.
  ...
  Replace or create main.py with this complete, production-ready code:
    ...
    async def home(request: Request, response: Response):
        ...
        if session:
            ...
            <html>
            <head>
                <title>Exemple Auth0 FastAPI</title>
                <style>
                    body {{
            ...
            <body>
                <div class="container">
                    ...
                    <h1>Bienvenue sur Auth0 FastAPI</h1>
            ...
            <body>
                <div class="container">
                    ...
                    <div class="action-card">
                        ...
                        <a href="/auth/login" class="button login">Se connecter</a>
                    </div>
                </div>
            </body>
            </html>
  ...
  1.  Ne jamais coder en dur les identifiants Auth0 directement dans le code. Utilisez toujours des variables d'environnement.
