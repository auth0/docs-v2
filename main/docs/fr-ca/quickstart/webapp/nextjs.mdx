...
<Visibility for="agents">
  Pour ajouter la connexion et l’inscription à une application Next.js, nous recommandons d’utiliser le SDK Auth0 Next.js. Utilisez ce guide de démarrage rapide pour créer une instance de test pour votre cas d’utilisation.
</Visibility>
...
<Accordion title="Utiliser des jetons Auth0 avec des backends tiers">
  ...
  <div id="getting-the-access-token">
### Obtenir le jeton d’accès {#getting-the-access-token}
  </div>
  ...
  **Côté client :**
  ...
  <div id="configuring-your-backend">
### Configurer votre backend {#configuring-your-backend}
  </div>
  ...
  <div id="troubleshooting-token-issues">
### Résolution des problèmes liés aux jetons {#troubleshooting-token-issues}
  </div>
