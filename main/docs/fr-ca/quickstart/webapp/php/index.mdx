...
## Intégrez votre application PHP {#integrate-your-php-application}
...
### Installation du client HTTP et des fabriques de messages {#installing-http-client-and-messaging-factories}
...
### Installation du SDK PHP {#installing-the-php-sdk}
...
### Configurer les routes de votre application {#setting-up-your-application-routes}
...
## Vérifier s’il existe une session {#checking-for-a-session}
...
## Traitement du rappel d’authentification {#handling-authentication-callback}
...
## Lancez votre application ! {#run-your-app}
