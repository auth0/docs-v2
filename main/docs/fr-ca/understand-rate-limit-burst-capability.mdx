---
og:description: Describes Auth0's burst capability and provides examples of rate limit
  calculations.
...
twitter:description: Describes Auth0's burst capability and provides examples of rate
  limit calculations.
...
En gardant à l’esprit la façon dont un exemple de réceptacle de point de terminaison est configuré, examinons les limites de charge subite de Management API Auth0 par type d’abonnement :
