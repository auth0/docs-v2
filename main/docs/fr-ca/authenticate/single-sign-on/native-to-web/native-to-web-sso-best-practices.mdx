---
description: Appliquez les meilleures pratiques d’Auth0 Native to Web SSO relatives à la durée de vie de la session et à la gestion des jetons d’actualisation afin d’assurer un transfert fluide de l’application native au navigateur.
...
## Utiliser les Actions Post Login pour limiter la durée de vie de la session {#use-post-login-actions-to-limit-session-lifetime}
...
## Associer session_transfer_token à l’appareil ou à l’adresse IP {#bind-session_transfer_token-to-the-device-or-ip-address}
...
## Utilisez des cookies sécurisés plutôt que des paramètres de requête {#use-secure-cookies-over-query-parameters}
...
## Évitez d’émettre des jetons d’actualisation pour les applications web, sauf si c’est nécessaire {#avoid-issuing-refresh-tokens-to-web-apps-unless-necessary}
...
## Activez Allow Refresh Tokens, au besoin, pour définir les jetons d’actualisation comme « online » {#enable-allow-refresh-tokens-when-appropriate-to-set-the-refresh-tokens-as-online}
...
## Activer la révocation en cascade {#enable-enforce-cascade-revocation}
