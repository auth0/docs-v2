---
og:description: Seamlessly transition users from your iOS or Android app into a secure,
  authenticated subscription flow in your web app using Native to Web Single Sign-On
...
twitter:title: 'Use Case: Configure mobile-to-web payment flows using Native to Web
  SSO'
---
