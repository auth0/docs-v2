...
* Determines if the user is authenticated. If not, it will redirect the user to the <Tooltip href="/docs/fr-ca/glossary?term=universal-login" tip="Connexion universelle
...
* Explore more configuration options for Native to Web SSO:Dive deeper into session lifetime, <Tooltip href="/docs/fr-ca/glossary?term=refresh-token" tip="Jeton d’actualisation
