---
description: Auth0 Native to Web SSO transfère une session authentifiée d’une application iOS ou Android vers une application accessible dans un navigateur afin d’éviter aux utilisateurs de devoir se connecter une deuxième fois.
...
## Sessions et révocation des jetons d’actualisation {#sessions-and-refresh-token-revocation}
