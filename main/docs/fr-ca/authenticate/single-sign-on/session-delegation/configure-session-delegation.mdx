...
## Configurez vos applications {#configure-your-applications}

### Configurer l’application demandeuse {#configure-the-requesting-application}
...
### Configurer l’application Web cible {#configure-the-target-web-application}
