...
## Obtenir un jeton de transfert de session {#get-a-session-transfer-token}
...
## Échanger le jeton de transfert de session {#redeem-the-session-transfer-token}
...
## Traiter les jetons obtenus {#handle-the-resulting-tokens}
...
## Dépannage d’un échange ayant échoué {#troubleshooting-a-failed-redemption}
