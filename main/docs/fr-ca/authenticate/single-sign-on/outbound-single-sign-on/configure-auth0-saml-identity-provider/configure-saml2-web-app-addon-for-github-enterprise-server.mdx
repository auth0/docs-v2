---
description: Découvrez comment configurer Auth0 comme fournisseur d’identité à l’aide du module complémentaire SAML2 Web App pour une instance privée de GitHub Enterprise Server.
...
## Configurer SAML SSO sur Auth0 {#configure-saml-sso-on-auth0}
