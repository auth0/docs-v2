...
## Configurer SAML SSO dans Auth0 {#configure-saml-sso-on-auth0}
...
3. Dans l’onglet **Settings**, définissez **Application Callback URL** sur : `https://github.com/orgs/{YOUR_GITHUB_ORG_NAME}/saml/consume`.
   ...
   <Frame>![Onglet Settings de Dashboard Applications Applications Addons SAML2 Web App](/docs/images/cdy7uua7fh8z/6dJgYkcOgMZ73HVTkAWt1x/fe9dbbf306e6c587cb3326c00a3b4e1f/2025-02-27_13-59-00.png)</Frame>
...
## Configurer SAML SSO sur GitHub {#configure-saml-sso-on-github}
