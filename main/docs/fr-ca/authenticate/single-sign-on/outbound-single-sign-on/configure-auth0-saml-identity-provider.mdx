...
## Intégrations SSO avec prise en charge intégrée par Auth0 {#sso-integrations-with-built-in-auth0-support}
...
## Configurer manuellement les intégrations SSO {#manually-configure-sso-integrations}
...
### Obtenir l’URL de rappel de l’application auprès du fournisseur de services {#obtain-the-application-callback-url-from-the-service-provider}
...
### Configurer le SAML SSO dans Auth0 {#configure-saml-sso-in-auth0}
...
### Configurer SAML SSO chez le fournisseur de services {#configure-saml-sso-on-the-service-provider}
