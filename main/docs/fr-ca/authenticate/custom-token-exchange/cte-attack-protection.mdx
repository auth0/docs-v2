---
description: Configurez Brute-force protection et Suspicious IP Throttling pour l’Échange de jetons personnalisé afin de bloquer les jetons du sujet non valides avant qu’ils n’atteignent votre application.
...
## Configurer Suspicious IP Throttling pour échange de jetons personnalisé {#configure-suspicious-ip-throttling-for-custom-token-exchange}

Vous pouvez configurer un seuil personnalisé et un taux de limitation pour échange de jetons personnalisé à l’aide de la Management API.
