---
description: Découvrez comment Auth0 met en œuvre le cadre d'autorisation OAuth 2.0, y compris les types d'octroi pris en charge et les points de terminaison clés pour sécuriser vos API et vos applications.
...
## Paramètres d’état {#state-parameters}
