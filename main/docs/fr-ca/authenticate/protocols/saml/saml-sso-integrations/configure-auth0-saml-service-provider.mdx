...
description: Découvrez comment configurer Auth0 pour qu’il serve de fournisseur de services dans une fédération SAML.
---
...
## Obtenir les métadonnées et le certificat de l’IdP {#get-metadata-and-certificate-from-the-idp}
...
## Créer une connexion d’entreprise SAML dans Auth0 {#create-saml-enterprise-connection-in-auth0}
...
### Configurer une connexion SAML pour les passerelles proxy {#configure-saml-connection-for-proxy-gateways}
...
### Personnaliser le modèle de requête {#customize-the-request-template}
...
#### Variables du modèle {#template-variables}
...
| Nom                              | Description                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| -------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `AssertionConsumerServiceURL`    | L’URL à laquelle l’IdP envoie la réponse après la connexion de l’utilisateur. Assurez-vous que la `AuthnRequest` est signée et que l’attribut `ProtocolBinding` est inclus dans le modèle de requête si vous utilisez cette variable.                                                                                                                                                                                                                                |
...
## Configurer l’IdP {#configure-the-idp}
...
## Résoudre les problèmes de connexion {#troubleshoot-connection}
