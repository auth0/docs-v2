...
### Flux IdP-Initiated d’OpenID Connect {#openid-connect-idp-initiated-flow}
...
## Configurer le SSO initié par l’IdP {#set-up-idp-initiated-sso}
...
## Liste déroulante d’applications limitée à 100 {#application-drop-down-list-limited-to-100}
