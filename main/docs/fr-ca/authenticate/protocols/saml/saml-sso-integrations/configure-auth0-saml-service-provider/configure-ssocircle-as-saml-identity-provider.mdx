...
## Obtenir les métadonnées de SSOCircle {#obtain-ssocircle-metadata}
...
## Configurer la connexion d’entreprise dans Auth0 {#configure-enterprise-connection-in-auth0}
...
## Configurer SSOCircle comme fournisseur d&#39;identité {#configure-ssocircle-as-identity-provider}
...
### Tester la connexion d’entreprise {#test-enterprise-connection}
