---
description: Découvrez comment configurer Okta comme fournisseur d’identité (IdP) SAML dans Auth0.
...
## Configurer l’intégration d’application SAML d’Okta {#configure-okta-saml-app-integration}

Vous pouvez créer une intégration d’application SAML dans l’Okta Developer Console.

### Créer une intégration d’application {#create-app-integration}
...
### Notez l’URL SSO et téléchargez le certificat {#record-sso-url-and-download-certificate}
...
## Configurer une connexion d’entreprise SAML dans Auth0 {#configure-saml-connection-in-auth0}
...
## Activer la connexion d’entreprise SAML dans Auth0 {#enable-saml-enterprise-connection-in-auth0}

Vous pouvez activer votre connexion d’entreprise SAML dans l’Auth0 Dashboard.

### Activer une connexion d’entreprise SAML lors de l’utilisation d’Organizations {#enable-saml-enterprise-connection-when-using-organizations}
...
### Activer la connexion d’entreprise SAML lorsque vous n’utilisez pas Organizations {#enable-saml-enterprise-connection-when-not-using-organizations}
