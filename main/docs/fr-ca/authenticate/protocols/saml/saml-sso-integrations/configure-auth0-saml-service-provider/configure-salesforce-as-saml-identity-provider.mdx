...
## Obtenir le certificat et les métadonnées Salesforce {#obtain-salesforce-certificate-and-metadata}
...
## Configurer Auth0 comme fournisseur de services {#set-up-auth0-as-a-service-provider}
...
## Configurer Salesforce comme fournisseur d’identité {#configure-salesforce-as-an-identity-provider}
...
## Accorder des privilèges aux utilisateurs dans Salesforce {#grant-privileges-to-users-in-salesforce}
...
## Tester la connexion à Salesforce {#test-connection-to-salesforce}
