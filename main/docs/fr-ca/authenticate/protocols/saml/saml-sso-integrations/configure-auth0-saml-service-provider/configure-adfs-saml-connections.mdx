---
description: Créez une connexion SAML personnalisée à Microsoft Active Directory Federation Services (ADFS), avec Auth0 comme fournisseur de services, y compris la configuration du mappage des revendications.
...
## Configurer ADFS {#configure-adfs}

### Ajouter une approbation de partie de confiance {#add-relying-party-trust}
...
#### Créer à l’aide des métadonnées de fédération {#create-using-federation-metadata}
...
### Modifier la politique d’émission des revendications {#edit-claim-issuance-policy}
...
### Exporter le certificat de signature {#export-signing-certificate}
...
## Créer une connexion SAML avec Auth0 comme fournisseur de services {#create-saml-connection-with-auth0-as-service-provider}
...
## Modifier l’approbation de la partie de confiance {#edit-relying-party-trust}
...
## Activer la signature des requêtes (facultatif) {#enable-sign-requests-optional}
...
## Activez et testez l’intégration {#enable-and-test-the-integration}
