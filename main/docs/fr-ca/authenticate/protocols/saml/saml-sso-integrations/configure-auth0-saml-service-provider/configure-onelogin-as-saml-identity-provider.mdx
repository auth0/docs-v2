...
## Configurer OneLogin {#configure-onelogin}
...
## Configurer la connexion Auth0 {#configure-auth0-connection}
...
### Valeurs de configuration Auth0 {#auth0-configuration-values}
...
## Modifier les mappages de la connexion {#edit-connection-mappings}
...
### Ajouter un nouveau paramètre à l’assertion SAML {#add-new-parameter-to-saml-assertion}
