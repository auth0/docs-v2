...
## Auth0 en tant que fournisseur de services SAML {#auth0-as-the-saml-service-provider}
...
### Signer la requête d&#39;authentification SAML {#sign-the-saml-authentication-request}
...
#### Activer/désactiver l’encodage deflate {#enabledisable-deflate-encoding}
...
### Utiliser une clé personnalisée pour signer les requêtes {#use-a-custom-key-to-sign-requests}
...
### Recevoir des réponses d’authentification SAML signées {#receive-signed-saml-authentication-responses}
...
### Recevoir des assertions d’authentification SAML chiffrées {#receive-encrypted-saml-authentication-assertions}
...
#### Définir les algorithmes de déchiffrement du contenu {#set-content-decryption-algorithms}
...
### Utilisez votre paire de clés pour déchiffrer les réponses chiffrées {#use-your-key-pair-to-decrypt-encrypted-responses}
...
## Auth0 comme fournisseur d’identité SAML {#auth0-as-the-saml-identity-provider}
...
### Signer les réponses/assertions SAML {#sign-the-saml-responsesassertions}
...
#### Changer la clé de signature pour les réponses SAML {#change-the-signing-key-for-saml-responses}
...
#### Effectuer la rotation de la clé de signature du tenant {#rotate-the-tenant-signing-key}
...
### Recevoir des requêtes d&#39;authentification SAML signées {#receive-signed-saml-authentication-requests}
...
### Envoyer des assertions d’authentification SAML chiffrées {#send-encrypted-saml-authentication-assertions}
