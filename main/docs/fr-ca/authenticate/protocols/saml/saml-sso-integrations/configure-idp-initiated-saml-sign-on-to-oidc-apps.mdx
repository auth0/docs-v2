...
<Frame>![Diagramme de flux de connexion aux applications OIDC via SAML initié par fournisseur d’identité](/docs/images/fr-CA/cdy7uua7fh8z/5vinAB4pSSwaKDgliTkAhh/3b39f7c011ca7a8b971e04204c283d1b/idp-provider-init-saml-sign-in0.png)</Frame>
