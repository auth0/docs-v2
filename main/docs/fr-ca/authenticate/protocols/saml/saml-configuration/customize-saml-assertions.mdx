...
## Auth0 comme fournisseur d’identité {#auth0-as-identity-provider}
...
#### Exemple : modifier la durée de validité du jeton SAML et utiliser l’UPN comme NameID {#example-changing-the-saml-token-lifetime-and-use-upn-as-nameid}
...
#### Exemple : inclure des attributs de user_metadata dans une assertion {#example-include-user_metadata-attributes-in-an-assertion}
...
## Attributs des assertions SAML {#saml-assertion-attributes}
