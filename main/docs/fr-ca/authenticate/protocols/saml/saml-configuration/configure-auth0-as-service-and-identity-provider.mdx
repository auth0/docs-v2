...
## Créer le tenant IdP {#create-idp-tenant}
...
## Configurer le tenant IdP {#configure-idp-tenant}
...
## Créer un utilisateur pour tester la séquence SAML {#create-user-to-test-saml-sequence}
...
## Configurer le tenant SP {#configure-service-provider-tenant}
...
## Ajouter les métadonnées du fournisseur de services à l’IdP {#add-service-provider-metadata-to-idp}
...
## Créer une application pour tester la connexion SAML {#create-application-to-test-saml-connection}
...
## Tester la connexion entre le service et le fournisseur d’identité {#test-connection-between-service-and-identity-provider}
...
## Créer une page web pour l’application de test {#create-a-web-page-for-test-application}
...
## Tester l’application exemple {#test-sample-application}
...
## Résolution des problèmes liés au scénario de test {#troubleshoot-test-scenario}
