...
Vous pouvez créer un identifiant d’entité personnalisé à l’aide de la propriété `connection.options.entityId`. Pour en savoir plus, lisez [Indiquer un identifiant d’entité personnalisé](/docs/fr-ca/authenticate/identity-providers/enterprise-identity-providers/saml#specify-a-custom-entity-id).
