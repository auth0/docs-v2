...
## Fournisseurs de services SAML {#saml-service-providers}
...
## Fournisseurs d’identité SAML {#saml-identity-providers}
...
## Auth0 comme fournisseur de services {#auth0-as-service-provider}
