...
## Pour les applications {#for-applications}
...
### Importer le fichier de métadonnées de fédération {#import-federation-metadata-file}
...
### Activer le point de terminaison Federation Metadata {#enable-the-federation-metadata-endpoint}
