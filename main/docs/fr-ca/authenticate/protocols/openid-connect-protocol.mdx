---
description: Découvrez comment OpenID Connect (OIDC) s’appuie sur OAuth 2.0 pour vérifier l’identité de l’utilisateur et renvoyer les renseignements du profil sous forme de JSON Web Token (JWT).
title: Protocole OpenID Connect
---

## Qu’est-ce qu’OpenID Connect (OIDC)? {#what-is-openid-connect-oidc}
...
## OpenID et OAuth2 {#openid-vs-oauth2}
...
## OpenID et JWTs {#openid-and-jwts}
...
## Configurer les applications avec OIDC et OAuth2 {#configure-applications-with-oidc-and-oauth2}
