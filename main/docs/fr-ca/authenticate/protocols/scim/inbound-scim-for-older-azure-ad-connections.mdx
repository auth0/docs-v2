...
description: Configurez SCIM entrant pour les anciennes connexions Azure AD qui utilisent des identifiants de sujet pairwise, en utilisant le mode de provisionnement mise à jour et suppression seulement.
---
...
## Récupérer l’URL du point de terminaison SCIM et le jeton {#retrieve-scim-endpoint-url-and-token}
