...
description: Configurez Inbound SCIM sur une connexion Auth0 Okta Workforce qui se connecte avec OpenID Connect afin qu’Okta provisionne et déprovisionne ses utilisateurs dans Auth0.
---
...
## Configurer SCIM dans Okta Workforce pour les applications OIDC {#configure-scim-in-okta-workforce-for-oidc-apps}
