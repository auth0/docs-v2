...
description: Configurez Inbound SCIM sur une connexion Auth0 Okta Workforce qui s’authentifie avec SAML afin qu’Okta provisionne et déprovisionne ses utilisateurs dans Auth0.
---
...
## Configurer les paramètres SCIM dans Auth0 {#configure-scim-settings-in-auth0}
...
## Récupérer la SCIM Endpoint URL et le jeton {#retrieve-scim-endpoint-url-and-token}
...
## Configurer SCIM dans Okta Workforce pour les applications SAML {#configure-scim-in-okta-workforce-for-saml-apps}
...
### Application SAML Okta {#okta-saml-application}
...
8. Collez le jeton SCIM dans le champ **Authorization**, puis choisissez **Test Connection Configuration** si vous souhaitez tester la nouvelle connexion. Sélectionnez **Save**.
   ...
   <Frame>![Configuration WIC Inbound SCIM](/docs/images/cdy7uua7fh8z/4kEFIeW8qbRqGb46KYuXJH/067213e99fbca35baab9bb104d1047f3/supersaas.jpg)</Frame>
...
### Application modèle SCIM d’Okta {#okta-scim-template-application}
