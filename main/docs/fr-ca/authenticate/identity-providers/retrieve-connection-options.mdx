...
| Valeur | Description |
| --- | --- |
| `CONNECTION_ID` | L'ID de la connexion pour laquelle vous voulez récupérer l’objet `options`. |
| `MGMT_API_ACCESS_TOKEN` | [Jeton d’accès à Management API](/docs/fr-ca/api/management/v2/tokens) avec la permission `read:connections`. |