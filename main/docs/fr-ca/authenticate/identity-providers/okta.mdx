...
## Créer une intégration d’application OIDC Okta {#create-okta-oidc-app-integration}
...
## Ajouter un utilisateur test à l’intégration d’application Okta {#add-test-user-to-okta-app-integration}
...
## Créer une connexion Okta Workforce Enterprise dans Auth0 {#create-okta-workforce-enterprise-connection-in-auth0}
...
## Activer la connexion pour les applications Auth0 {#enable-connection-for-auth0-applications}
