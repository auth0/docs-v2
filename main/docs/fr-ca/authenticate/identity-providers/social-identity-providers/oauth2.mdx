...
## Mettre à jour le flux d’authentification {#update-authentication-flow}
...
## Script Fetch User Profile {#fetch-user-profile-script}
...
## Se connecter à l’aide de la connexion personnalisée {#log-in-using-the-custom-connection}
...
## Modifier l’icône et le nom d’affichage {#modify-the-icon-and-display-name}
...
## Transmettre des paramètres propres au fournisseur {#pass-provider-specific-parameters}
...
### Transmettre des paramètres statiques {#pass-static-parameters}
...
### Transmettre des paramètres dynamiques {#pass-dynamic-parameters}
...
## Ajouter des en-têtes supplémentaires {#pass-extra-headers}
