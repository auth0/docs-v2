...
## Configurer TikTok {#configure-tiktok}
...
5. Configurez le [Fetch User Profile Script](/docs/fr-ca/authenticate/identity-providers/social-identity-providers/oauth2#fetch-user-profile-script) pour récupérer les renseignements de profil à partir du [endpoint user&#95;info de TikTok](https://developers.tiktok.com/doc/tiktok-api-v2-get-user-info/). Mappez les attributs au profil utilisateur normalisé d’Auth0.
...
## Transmettre des paramètres personnalisés à TikTok avec la Management API {#pass-customs-parameters-to-tiktok-with-the-management-api}
...
### Configurer le champ `client_key` {#configure-the-client_key-field}
...
## Requête de jeton d’accès {#access-token-request}
...
### Déployer le proxy d’intégration TikTok {#deploy-tiktok-integration-proxy}
