...
### Fonctionnalités et considérations relatives à la connexion {#connection-features-and-considerations}
...
### Configuration des groupes {#group-configuration}
...
### Fonctionnalités et considérations relatives à la connexion {#connection-features-and-considerations-2}
...
### Configuration des groupes {#group-configuration-2}
...
## Enterprise OIDC {#enterprise-oidc}
...
### Fonctionnalités et considérations de la connexion {#connection-features-and-considerations-3}
...
### Configuration des groupes {#group-configuration-3}
