...
## Enregistrer votre application auprès de Google {#register-your-application-with-google}
...
## Configurer une connexion d’entreprise Google Workspace dans Auth0 {#configure-a-google-workspace-enterprise-connection-in-auth0}
...
### Personnaliser ou automatiser la synchronisation des profils utilisateur {#customize-or-automate-user-profile-synchronization}
...
### Obtenir des jetons d’accès et d’actualisation {#get-access-and-refresh-tokens}
...
### Récupérer des renseignements supplémentaires sur l’utilisateur et les groupes {#retrieve-additional-user-and-group-details}
...
### Valider l’authentification avec Actions {#validate-authentication-with-actions}
