...
## Installer le connecteur pour Windows {#install-the-connector-for-windows}

### Téléchargez et exécutez le programme d’installation {#download-and-run-the-installer}
...
## Installer le connecteur pour d’autres plateformes {#install-the-connector-for-other-platforms}
