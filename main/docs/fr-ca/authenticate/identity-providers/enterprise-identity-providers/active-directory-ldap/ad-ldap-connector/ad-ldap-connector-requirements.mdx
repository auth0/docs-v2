...
Le connecteur doit être installé sur un serveur doté d’une connectivité sortante vers le service Auth0 à l’adresse :  `https://${account.namespace}` sur le port 443.
...
Pour en savoir plus, consultez [Configurer l’authentification du connecteur AD/LDAP avec Kerberos](/extensions/ad-ldap-connector/configure-ad-ldap-connector-with-kerberos) ou [Configurer l’authentification du connecteur AD/LDAP avec des certificats clients](/extensions/ad-ldap-connector/configure-ad-ldap-connector-client-certificates).
