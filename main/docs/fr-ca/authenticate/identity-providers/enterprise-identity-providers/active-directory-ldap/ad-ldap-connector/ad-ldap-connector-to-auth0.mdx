...
1. Créez la nouvelle connexion AD/LDAP dans le Auth0 Dashboard et copiez le **TICKET URL résultant**. Si vous utilisez les domaines personnalisés, vous devrez remplacer la partie `${account.namespace}` du **TICKET URL** par votre domaine personnalisé, tel que `identity.fabrikam.com`.
