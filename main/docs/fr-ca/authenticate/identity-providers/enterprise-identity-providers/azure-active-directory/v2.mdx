...
### Enregistrez votre application dans Azure AD {#register-your-app-with-azure-ad}
...
#### Ajouter des permissions {#add-permissions}
...
### Activer la connexion d’entreprise pour votre application Auth0 {#enable-the-enterprise-connection-for-your-auth0-application}
...
### Testez la connexion {#test-the-connection}
...
**Lorsque les utilisateurs essaient de se connecter, nous recevons le message d’erreur suivant : &quot;invalid&#95;request; failed to obtain <Tooltip tip="Jeton d’accès : donnée d’autorisation, sous la forme d’une chaîne opaque ou d’un JWT, utilisée pour accéder à une API." cta="Voir le glossaire" href="/docs/fr-ca/glossary?term=access+token">jeton d’accès</Tooltip>&quot;.**
...
## Rotation des clés de signature dans Azure AD {#signing-key-rollover-in-azure-ad}
...
## Supprimer la mention « non vérifié » {#remove-unverified-label}
