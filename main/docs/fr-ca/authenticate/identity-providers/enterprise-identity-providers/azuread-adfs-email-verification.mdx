...
## Paramètre de migration de Email Verification pour les connexions Azure AD/ADFS {#azure-adadfs-email-verification-migration-setting}
...
## Flux de vérification du courriel pour les connexions Azure AD/ADFS {#email-verification-flow-for-azure-adadfs-connections}
