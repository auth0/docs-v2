...
## Configurez votre application pour Express Configuration {#configure-your-application-for-express-configuration}
...
### Enregistrer une application avec Initiate Login URI Template {#register-an-application-with-initiate-login-uri-template}
...
#### User Attribute Profile {#user-attribute-profile}
...
### Paramètres de connexion de l’organisation {#organization-login-settings}
...
### Paramètres de connexion et de consentement de l’administrateur {#administrator-login-and-consent-settings}
...
## Attribuer des permissions aux utilisateurs {#assign-permissions-to-users}
...
### Attribuer des permissions à un rôle utilisateur d’application existant {#assign-permissions-to-a-pre-existing-application-user-role}
...
### Attribuer un nouveau rôle aux utilisateurs de l’application {#assign-a-new-role-to-application-users}
...
#### Attribuer des permissions au rôle {#assign-permissions-to-the-role}
...
### Attribuer des permissions en fonction des attributs utilisateur à l’aide d’une Action post-login {#assign-permissions-based-on-user-attributes-using-a-post-login-action}
...
## Activer Home Realm Discovery {#enable-home-realm-discovery}
...
### Maintenir la correspondance des comptes d’administrateur entre les connexions {#maintain-admin-account-matching-across-connections}
...
## Activer plusieurs applications dans une seule intégration {#enable-multiple-applications-under-a-single-integration}
...
<Tabs>
  <Tab title="Auth0 CLI">
    ...
    ```bash
    auth0 api get "clients/{yourAppId}"
    ```
  </Tab>
...
<Tabs>
  <Tab title="Auth0 CLI">
    ```bash
    auth0 api patch "clients/{yourAppId}" \
      --data '{
...
## Publiez votre intégration dans l’OIN {#publish-your-integration-to-the-oin}
...
### Enregistrez votre application dans l’OIN {#register-your-application-in-the-oin}
...
#### Ajouter Express Configuration à votre intégration OIN {#add-express-configuration-to-your-oin-integration}
...
#### Configurer votre clé publique OIN {#configure-your-oin-public-key}
...
#### ​Terminez la configuration de votre intégration {#complete-your-integration-configuration}
...
### Tester et vérifier votre intégration {#test-and-verify-your-integration}
...
### Finalisez votre soumission {#finalize-your-submission}
...
## Activation client {#customer-enablement}
...
### Exemple de flux d’activation client {#example-customer-enablement-flow}
...
#### Exemple avec Auth0 CLI {#auth0-cli-example}
...
### Recommandations pour provisionner des comptes Admin {#recommendations-to-provision-admin-accounts}
...
#### Utiliser une adresse courriel professionnelle {#use-work-email}
...
#### Utiliser l’authentification multifacteur {#use-multi-factor-authentication}
...
### Surveiller l’utilisation d’Express Configuration {#monitor-express-configuration-usage}
...
## Référence de la Management API {#management-api-reference}
...
### Créer l’API système Okta OIN Express Configuration {#create-the-okta-oin-express-configuration-system-api}
...
### Créer un User Attribute Profile {#create-user-attribute-profile}
...
### Créer un Connection Profile {#create-connection-profile}
...
### Créer un client OIN Express Configuration {#create-oin-express-configuration-client}
...
### Configurer les propriétés de l’application SaaS {#configure-saas-application-properties}
...
### Téléverser la clé publique {#upload-public-key}
...
### Attribuer des clés à l’application cliente OIN {#assign-keys-to-oin-client-application}
...
### Personnalisez l’écran de consentement de vos tenants {#customize-your-tenants-consent-prompt}
