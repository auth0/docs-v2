...
<td>Pour découvrir comment modifier votre profil de connexion, consultez <a href="https://auth0.com/docs/fr-ca/authenticate/identity-providers/enterprise-identity-providers/configure-pkce-claim-mapping-for-oidc">Configurer PKCE et le mappage de demandes pour les connexions OIDC.</a></td>
</tr>
</tbody>
</table>
