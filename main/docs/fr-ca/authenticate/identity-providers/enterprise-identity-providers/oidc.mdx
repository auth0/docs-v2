...
## Configurez votre application dans le fournisseur d’identité OpenID Connect {#set-up-your-app-in-the-openid-connect-identity-provider}
...
## Créer une Enterprise Connection dans Auth0 {#create-an-enterprise-connection-in-auth0}
...
### Créer une connexion d’entreprise à l’aide de l’Auth0 Dashboard {#create-an-enterprise-connection-using-the-auth0-dashboard}
...
| **Communication Channel**                      | Réglez-le sur <strong>canal frontal</strong> ou <strong>canal arrière</strong>. canal frontal utilise le protocole OIDC avec <code>response&#95;mode=form&#95;post</code> et <code>response&#95;type=id&#95;token</code>. Le canal arrière utilise <code>response&#95;type=code</code>.                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
...
### Créer une connexion d’entreprise à l’aide de la Management API {#create-an-enterprise-connection-using-the-management-api}
...
#### Utiliser le front-channel avec le point de terminaison de découverte {#use-front-channel-with-discovery-endpoint}
...
#### Utiliser le back-channel avec le point de terminaison de découverte {#use-back-channel-with-discovery-endpoint}
...
#### Utiliser le back-channel en précisant les paramètres de l’émetteur {#use-back-channel-specifying-issuer-settings}
...
#### Utiliser le front-channel en indiquant les paramètres de l’émetteur {#use-front-channel-specifying-issuer-settings}
...
## Configurer PKCE et le mappage des claims {#configure-pkce-and-claims-mapping}
...
## Activez la connexion d’entreprise pour votre application Auth0 {#enable-the-enterprise-connection-for-your-auth0-application}
...
## Configurer manuellement les métadonnées de l’émetteur {#manually-configure-issuer-metadata}
...
## Fédérer avec Auth0 {#federate-with-auth0}
...
## Configurer Global Token Revocation {#configure-global-token-revocation}
