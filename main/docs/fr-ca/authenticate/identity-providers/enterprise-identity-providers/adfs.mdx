...
## Configuration par script {#scripted-setup}
...
## Configuration manuelle, partie 1 : ajouter un Relying Party Trust {#manual-setup-part-1-add-a-relying-party-trust}
...
## Configuration manuelle, partie 2 : Ajouter une règle de stratégie d’émission de claims {#manual-setup-part-2-add-a-claim-issuance-policy-rule}
...
### Ajouter des attributs LDAP supplémentaires {#add-additional-ldap-attributes}
