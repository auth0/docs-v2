...
## Configurez vos applications dans le portail Microsoft Azure {#set-up-your-applications-in-the-microsoft-azure-portal}
...
### Enregistrer une nouvelle application web {#register-a-new-web-application}
...
### Configurez votre application web pour exposer une API {#configure-your-web-application-to-expose-an-api}
...
### Enregistrer une nouvelle application native {#register-a-new-native-application}
...
### Créer un secret client pour votre application native {#create-a-client-secret-for-your-native-application}
...
### Ajouter des permissions pour votre application native {#add-permissions-for-your-native-application}
...
## Configurer la connexion dans Auth0 {#configure-the-connection-in-auth0}
...
## Appartenance à des groupes et informations de profil avancées {#group-memberships-and-advanced-profile-information}
