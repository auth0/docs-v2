...
## Modifier les paramètres du fournisseur d’identité {#change-identity-provider-settings}
...
## Transmettre des scopes au point de terminaison Authorize {#pass-scopes-to-authorize-endpoint}
