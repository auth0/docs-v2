...
## Appliquer le pipeline conforme à OIDC {#apply-the-oidc-conformant-pipeline}
...
### Tenants plus anciens {#older-tenants}
...
### Flux d’autorisation {#authorization-flows}
