...
## Rediriger les utilisateurs vers des URL de rappel figurant dans l’AllowList {#redirect-users-to-callback-urls-on-the-allowlist}
...
## Rediriger les utilisateurs vers d’autres URL {#redirect-users-to-other-urls}
