...
## URI de connexion dynamiques avec des espaces réservés de métadonnées {#dynamic-login-uris-with-metadata-placeholders}
...
### Espaces réservés pris en charge {#supported-placeholders}
...
### Comportement de secours {#fallback-behavior}
...
## Scénarios de redirection pour la route de connexion par défaut {#redirect-default-login-route-scenarios}

### Les utilisateurs ajoutent la page de connexion à leurs signets {#users-bookmark-login-page}
...
### Flux complet de réinitialisation du mot de passe {#complete-password-reset-flow}
...
### Processus complet de vérification du courriel {#complete-email-verification-flow}
...
### Inviter des membres d’une organisation {#invite-organization-members}
