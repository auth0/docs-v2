...
## Connexion via le navigateur {#browser-based-login}

* [Quickstart Android](/docs/fr-ca/quickstart/native/android)
* [Quickstart iOS Swift](/docs/fr-ca/quickstart/native/ios-swift)

## Connexion intégrée dans une application native {#native-embedded-login}
...
## Connexion sociale native {#native-social-login}
...
#### Limites applicables aux tenants de production des clients payants {#limits-for-production-tenants-of-paying-customers}
...
#### Limites pour les tenants hors production des clients payants et tous les tenants des clients Free {#limits-for-non-production-tenants-of-paying-customers-and-all-tenants-of-free-customers}
