...
<Frame>![User workflow using Universal Logout](/docs/images/fr-ca/cdy7uua7fh8z/4tcRn1VmydyBGORCHlKuvt/725b95df1cddae8ed3b2d36f0c3495bb/universal_logout_flow_diagram.png)</Frame>
...
3. Sous l’onglet **General (Général)**, sélectionnez **Logout (Déconnexion) > Edit (Modifier)**.
   ...
   <Frame>![Okta Dashboard image for Universal Logout configuration](/docs/images/fr-ca/cdy7uua7fh8z/M957prYUhjyMxXgpdA8pB/224812ce3a76ac9d032abe50c4be3a1d/2025-01-23_13-03-21.png)</Frame>
...
3. Sélectionnez **More Actions (Autres actions) > Clear User Sessions (Supprimer les sessions d’utilisateur)**.
   ...
   <Frame>![Test Universal Logout in Okta Dashboard](/docs/images/fr-ca/cdy7uua7fh8z/Z8an5lN6WAlSAdgiBkKLa/fde264f71615c5eb7e07e0c48d8426bf/2025-01-23_13-08-29.png)</Frame>
