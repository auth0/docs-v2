...
## Fonctionnement des initiateurs de la déconnexion OIDC par canal arrière {#how-oidc-back-channel-logout-initiators-work}
...
## Configurer les initiateurs de la déconnexion OIDC par canal arrière {#configure-oidc-back-channel-logout-initiators}
...
##### Propriété `selected_initiators` {#selected_initiators-property}
...
##### Abonner une application à tous les initiateurs actuels et à venir {#subscribe-an-application-to-all-current-and-future-initiators}
...
##### Abonner une application uniquement à l’initiateur `password-changed` (`rp-logout` et `idp-logout` sont requis) {#subscribe-an-application-to-password-changed-initiator-only-rp-logout-and-idp-logout-are-required}
...
##### Désinscrire tous les initiateurs (rp-logout reste l’option par défaut) {#unsubscribe-all-initiators-rp-logout-remains-the-default}
...
#### Initiateurs sélectionnés uniquement {#selected-initiators-only}
...
#### Tous les initiateurs pris en charge {#all-supported-initiators}
