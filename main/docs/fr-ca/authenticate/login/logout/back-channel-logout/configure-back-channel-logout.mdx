...
## Restrictions liées à Back-Channel Logout {#back-channel-logout-restrictions}
...
#### Abonnement des applications {#subscribe-applications}
...
#### Désabonnement des applications {#unsubscribe-applications}
...
#### Abonnement d’une application {#subscribe-application}
...
#### Désabonnement d’une application {#unsubscribe-application}
...
## Configurez votre application {#configure-your-application}
...
## Exemple de demande de Back-Channel Logout OIDC {#oidc-back-channel-logout-request-example}
...
## Réponses attendues {#expected-responses}
...
## Résolution des problèmes {#troubleshoot-issues}

### L’application n’a pas reçu les événements de déconnexion {#application-did-not-receive-the-logout-events}
...
#### Je ne trouve pas le journal du tenant d’OIDC Back-Channel Logout {#i-cant-find-oidc-back-channel-logout-tenant-logs}
...
### L’application cliente ne peut pas vérifier le Logout Token reçu {#client-app-cannot-verify-the-received-logout-token}
...
### Erreurs de délai d’attente de réponse {#response-timeout-errors}
