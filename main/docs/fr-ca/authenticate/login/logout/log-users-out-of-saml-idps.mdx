---
description: Découvrez comment déconnecter les utilisateurs d’un IdP SAML externe lorsqu’ils se déconnectent en configurant l’URL de rappel SLO de l’application.
...
## Configurer le SLO lorsque l’application est connectée à un IdP SAML {#configure-slo-when-application-is-connected-to-a-saml-idp}
...
## Configurer le SLO lorsque Auth0 est le SAML IdP {#configure-slo-when-auth0-is-the-saml-idp}
...
### Déconnexion initiée par l’application {#application-initiated-logout}
...
### Déconnexion initiée par l’IdP {#idp-initiated-logout}
