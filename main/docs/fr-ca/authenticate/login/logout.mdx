...
description: Découvrez comment déconnecter les utilisateurs de votre application en mettant fin à leur session ainsi qu’à la session SSO ou IdP upstream associée.
---

## Couches de session de déconnexion {#logout-session-layers}
...
## Rediriger les utilisateurs après la déconnexion {#redirect-users-after-logout}
