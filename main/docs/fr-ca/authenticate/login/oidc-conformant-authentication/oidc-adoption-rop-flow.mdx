...
* Le jeton d’ID sera signé de force à l’aide de `RS256` si une application publique le demande. To learn more, read [Confidential and Public Applications](/docs/get-started/applications/confidential-and-public-applications).
