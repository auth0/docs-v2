---
description: Découvrez comment le pipeline conforme à OIDC d’Auth0 modifie le comportement du flux implicite et met à jour les applications existantes sans perturber la gestion des jetons.
...
## Structure du jeton d’ID {#id-token-structure}
