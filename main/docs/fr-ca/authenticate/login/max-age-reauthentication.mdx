...
## Limites du paramètre prompt=login {#limitations-of-promptlogin-parameters}
...
## paramètre de requête d’authentification `max_age` {#max_age-authentication-request-parameter}
...
## Utiliser les claims `auth_time` {#use-auth_time-claims}
...
### Exemple de validation de `auth_time` {#auth_time-validation-example}
