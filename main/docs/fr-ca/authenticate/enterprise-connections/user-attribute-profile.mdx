...
## Mappage d’attributs et dérogation {#attribute-mapping-and-override}
...
### Dérogations de stratégie {#strategy-overrides}
...
### Attribut de l’adresse courriel {#email-attribute}
...
## Créer un User Attribute Profile {#create-a-user-attribute-profile}
...
### Configurer avec Auth0 Dashboard {#configure-with-auth0-dashboard}
...
### Configurer avec la Management API {#configure-with-management-api}

Pour gérer les User Attribute Profiles, les points de terminaison suivants de la [Management API](/docs/fr-ca/api/management/v2) sont offerts :
