...
## Fournisseurs pris en charge par Self-Service Enterprise Configuration {#self-service-enterprise-configuration-supported-providers}
...
### flux de travail de Self-Service Enterprise Configuration {#self-service-enterprise-configuration-workflow}
...
## Expérience de l’assistant en libre-service {#self-service-assistant-experience}
...
### Exemple de flux de l’assistant en libre-service {#example-self-service-assistant-flow}
...
<AccordionGroup>
  ...
  <Accordion title="2. Sélectionner le fournisseur d’identité">
    <Frame>![La première étape de l’assistant en libre-service utilisée par les administrateurs du client pour configurer le SSO. ](/docs/images/cdy7uua7fh8z/OktaDB-EnterpriseConnections.png)</Frame>
  </Accordion>

  <Accordion title="3. Créer une application (tronqué)">
    <Frame>![La deuxième étape de l’assistant en libre-service utilisée par les administrateurs du client pour configurer le SSO. ](/docs/images/cdy7uua7fh8z/Self-Service-SSO-create-application.png)</Frame>
  </Accordion>

  <Accordion title="4. Configurer la connexion">
    <Frame>![La troisième étape de l’assistant en libre-service utilisée par les administrateurs du client pour configurer le SSO. ](/docs/images/cdy7uua7fh8z/Self-Service-SSO-configure-connection.png)</Frame>
  </Accordion>

  <Accordion title="5. Mappage des claims">
    <Frame>![La quatrième étape de l’assistant en libre-service utilisée par les administrateurs du client pour configurer le SSO. ](/docs/images/cdy7uua7fh8z/Self-Service-SSO-claims-mapping.png)</Frame>
  </Accordion>

  <Accordion title="6. Attribuer l’accès">
    <Frame>![La cinquième étape de l’assistant en libre-service utilisée par les administrateurs du client pour configurer le SSO. ](/docs/images/enterprise-config-assign-access.png)</Frame>
  </Accordion>

  <Accordion title="7. tester le SSO">
    <Frame>![La sixième étape de l’assistant en libre-service utilisée par les administrateurs du client pour configurer le SSO. ](/docs/images/cdy7uua7fh8z/Self-Service-SSO-Test-SSO.png)</Frame>
  </Accordion>
  ...
  <Accordion title="11. Configurer les groupes">
    <Frame>![Provisionner les Enterprise Groups](/docs/images/enterprise-config-configure-groups.png)</Frame>
  </Accordion>

  <Accordion title="12. Vérification du domaine">
    <Frame>![La dernière étape de l’assistant en libre-service utilisée par les administrateurs du client pour configurer le SSO. ](/docs/images/cdy7uua7fh8z/Self-Service-SSO-domain-verification.png)</Frame>
  </Accordion>
</AccordionGroup>