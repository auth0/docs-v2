...
## Créer des profils en libre-service {#create-self-service-profiles}
...
## Gérer les tickets d&#39;accès en libre-service {#manage-self-service-access-tickets}
...
### SSO SAML initié par l’IdP {#saml-idp-initiated-sso}
...
### Vérification du domaine de courriel et domaines prévérifiés {#email-domain-verification-and-pre-verified-domains}
...
#### Domaine prévérifié {#pre-verified-domain}
...
#### domaines à vérifier {#domains-to-be-verified}
...
#### Vérification du domaine de courriel {#email-domain-verification}
...
#### Supprimer un domaine {#remove-a-domain}
...
### Générer des tickets d’accès pour de nouvelles connexions {#generate-access-tickets-for-new-connections}
...
### Générer des tickets d’accès pour les connexions existantes {#generate-access-tickets-for-existing-connections}
...
### Révoquer un ticket d&#39;accès {#revoke-an-access-ticket}
