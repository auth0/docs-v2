...
Pour en savoir plus, lisez [Réduire les frictions avec les clés d’identification](/docs/fr-ca/customize/actions/explore-triggers/signup-and-login-triggers/login-trigger#reduce-friction-with-passkeys) et [Authentification multifacteur (MFA)](/docs/fr-ca/secure/multi-factor-authentication).
