...
#### Exigences relatives à l’identifiant principal {#primary-identifier-requirements}
...
#### Réinitialisations de mot de passe {#password-resets}
...
#### Paramètres irréversibles {#irreversible-settings}
...
#### Identifiants flexibles {#flexible-identifiers}
...
### Changements de comportement de l’API {#api-behavior-changes}
...
### Activer Non-Unique Emails dans l’Auth0 Dashboard {#enable-non-unique-emails-in-the-auth0-dashboard}
...
### Activer Non-Unique Emails au moyen de la Management API {#enable-non-unique-emails-via-the-management-api}
...
### Avertissement sur les risques liés aux adresses courriel partagées {#shared-email-risk-disclaimer}
