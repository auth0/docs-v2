---
title: Configurer Flexible Password Policy pour les connexions de base de données d’Auth0
sidebarTitle: Configurer Flexible Password Policy
description: Utilisez Flexible Password Policy pour définir la robustesse et les règles de composition des mots de passe pour les connexions de base de données d’Auth0.
---
...
## Activer la Flexible Password Policy {#enable-the-flexible-password-policy}
...
## Rétablir les politiques de mot de passe héritées {#revert-to-the-legacy-password-policies}
