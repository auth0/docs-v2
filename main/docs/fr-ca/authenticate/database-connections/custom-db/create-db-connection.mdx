...
### Activer la migration automatique {#enable-automatic-migration}
...
### Activer le contexte de l’organisation {#enable-organization-context}
...
## Limites et considérations {#limits-and-considerations}
