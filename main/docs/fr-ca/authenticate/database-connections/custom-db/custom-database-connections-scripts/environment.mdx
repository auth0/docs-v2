...
* Assurez-vous que votre base de données possède les champs appropriés pour stocker les attributs des profils utilisateurs, tels que **id**, **nickname**, **email**, et **password**. Pour en savoir plus sur le schéma de profil utilisateur d’Auth0 et les champs attendus, consultez [Profils utilisateurs normalisés](/users/user-profiles/normalized-user-profiles). Pour apprendre à mettre à jour des profils utilisateurs, consultez [Mise à jour des profils utilisateurs à l’aide de votre base de données](/users/user-profiles/update-user-profiles-using-your-database).
