...
## Fonction ChangePassword {#changepassword-function}
...
### Retourner une réussite et mettre à jour l’attribut last_password_reset {#return-a-success-and-update-last_password_reset-attribute}
...
### Signaler un échec {#return-a-failure}
...
## Exemples de scripts propres à chaque langage {#language-specific-script-examples}
