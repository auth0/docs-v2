...
### Renvoyer le profil de l’utilisateur {#return-the-user-profile}
...
### Objet de type d’erreur personnalisé WrongUsernameOrPasswordError {#wrongusernameorpassworderror-type-object}
...
### Renvoyer une erreur {#return-an-error}
...
## Synchroniser les attributs du profil utilisateur à chaque connexion {#sync-user-profile-attributes-at-each-login}
