...
description: Appliquer des politiques de mot de passe dans une connexion de base de données afin d’empêcher la réutilisation des mots de passe, l’utilisation de mots de passe courants, l’inclusion de données personnelles dans les mots de passe et l’usage de mots de passe insuffisamment complexes.
---

## Politiques de mot de passe disponibles {#available-password-policies}
...
## Appliquer des politiques de mot de passe dans l’Auth0 Dashboard {#enforce-password-policies-with-the-auth0-dashboard}
...
## Appliquer des politiques de mot de passe avec la Management API {#enforce-password-policies-with-the-management-api}
...
* [point de terminaison Create a connection](/docs/fr-ca/api/management/v2/connections/post-connections)
* [point de terminaison Update a connection](/docs/fr-ca/api/management/v2/connections/patch-connections-by-id).

Vous pouvez consulter les politiques de mot de passe actuellement configurées pour une connexion de base de données dans l’objet `options` renvoyé par le [point de terminaison Get a connection](/docs/fr-ca/api/management/v2/connections/get-connections-by-id).