...
Vous pouvez désactiver les connexions d’[organisations](/docs/fr-CA/fr-ca/manage-users/organizations/organizations-overview) à l’aide d’<Tooltip href="/docs/fr-CA/fr-ca/glossary?term=auth0-dashboard" tip="Auth0 Dashboard
...
<table class="table">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><a href="/docs/fr-CA/fr-ca/tokens/management-api-access-tokens">Jeton d’accès pour Management API</a> avec la permission `delete:organization_connections`.</td>
    </tr>
