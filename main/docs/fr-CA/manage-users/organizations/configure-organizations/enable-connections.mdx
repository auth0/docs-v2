...
Vous pouvez activer des connexions spécifiques pour chaque [organisation](/docs/fr-CA/fr-ca/manage-users/organizations/organizations-overview) afin de fournir différentes options de connexion aux utilisateurs. Après avoir activé une connexion, elle est ajoutée à l’invite de connexion de l’organisation et les utilisateurs peuvent s’authentifier via cette connexion pour accéder à vos applications.

Pour activer une connexion pour une organisation, la connexion **doit** déjà exister dans votre locataire. Les connexions prises en charge comprennent les [connexions de base de données](/docs/fr-CA/fr-ca/connections/database), [connexions via un réseau social](/docs/fr-CA/fr-ca/connections/identity-providers-social) et [connexions d’entreprise](/docs/fr-CA/fr-ca/connections/identity-providers-enterprise).
...
Vous pouvez configurer les connexions pour les organisations à l’aide du <Tooltip href="/docs/fr-CA/fr-ca/glossary?term=auth0-dashboard" tip="Auth0 Dashboard
    ...
    <table class="table">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td><a href="/docs/fr-CA/fr-ca/tokens/management-api-access-tokens">Jeton d’accès à Management API</a> avec la permission `create:organization_connections`.</td>
        </tr>
