...
Pour affecter un membre à votre [organisation](/docs/fr-CA/fr-ca/manage-users/organizations/organizations-overview), vous devez déjà avoir [créé l’utilisateur](/docs/fr-CA/fr-ca/manage-users/user-accounts/create-users) dans votre locataire. Si vous n’arrivez pas à trouver un utilisateur, vous pouvez [l’inviter](/docs/fr-CA/fr-ca/manage-users/organizations/configure-organizations/invite-members).

Pour gérer les membres directement, vous pouvez utiliser le <Tooltip href="/docs/fr-CA/fr-ca/glossary?term=auth0-dashboard" tip="Auth0 Dashboard
Principal produit d’Auth0 pour configurer vos services." cta="Voir le glossaire">Auth0 Dashboard</Tooltip> (Tableau de bord Auth0) ou <Tooltip href="/docs/fr-CA/fr-ca/glossary?term=management-api" tip="Management API
...
<table class="table">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><a href="/docs/fr-CA/fr-ca/tokens/management-api-access-tokens">Jetons d’accès pour Management API</a> avec la permission `create:organization_members`.</td>
    </tr>
