...
Lorsque vous travaillez de manière programmatique avec des [organisations](/docs/fr-CA/fr-ca/manage-users/organizations/organizations-overview), il se peut que vous ayez besoin de récupérer la liste des connexions qui lui sont associées.

Vous pouvez afficher les connexions associées à un membre d’une organisation à l’aide d’<Tooltip href="/docs/fr-CA/fr-ca/glossary?term=auth0-dashboard" tip="Auth0 Dashboard
...
<table class="table">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><a href="/docs/fr-CA/fr-ca/tokens/management-api-access-tokens">Jeton d’accès à Management API</a> avec la permission `read:organization_connections`.</td>
    </tr>
  </tbody>
</table>
