...
Vous pouvez créer des [organisations](/docs/fr-CA/fr-ca/manage-users/organizations/organizations-overview) à l’aide du Tableau de bord Auth0 ou de <Tooltip href="/docs/fr-CA/fr-ca/glossary?term=management-api" tip="Management API
...
Pour créer une organisation via le <Tooltip href="/docs/fr-CA/fr-ca/glossary?term=auth0-dashboard" tip="Auth0 Dashboard
...
<table class="table">
  ...
  <tbody>
    <tr>
      ...
      <td><a href="/docs/fr-CA/fr-ca/tokens/management-api-access-tokens">Jeton d’accès pour le Management API</a> avec la permission `create:organizations`.</td>
    </tr>
