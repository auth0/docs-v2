...
Vous pouvez retirer des rôles aux membres de l’[organization](/docs/fr-CA/fr-ca/manage-users/organizations/organizations-overview) à l’aide de l’Auth0 Dashboard ou de Management API. La suppression d’un utilisateur d’une organisation ne supprime que son affiliation à l’organisation en question; elle ne le supprime pas de la connexion ou du locataire d’Auth0. La suppression prend en moyenne entre 5 et 10 secondes.
...
<table class="table">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><a href="/docs/fr-CA/fr-ca/tokens/management-api-access-tokens">Jeton d’accès pour Management API</a> avec la permission `delete:organization_members`.</td>
    </tr>
