...
Vous pouvez activer cette fonctionnalité via votre <Tooltip href="/docs/fr-CA/fr-ca/glossary?term=auth0-dashboard" tip="Auth0 Dashboard
...
* **Auth0 Dashboard** : Sélectionnez [Paramètres](/docs/fr-CA/fr-ca/get-started/tenant-settings) dans le menu de gauche et choisissez l’onglet **Avancé**. Dans la section **Réglages**, activez la bascule **Autoriser les noms d’organisation dans Authentication API**.
