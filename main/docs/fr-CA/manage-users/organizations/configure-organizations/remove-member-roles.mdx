...
Vous pouvez retirer des rôles aux membres de l’ [organisation](/docs/fr-CA/fr-ca/manage-users/organizations/organizations-overview) à l’aide d’<Tooltip href="/docs/fr-CA/fr-ca/glossary?term=auth0-dashboard" tip="Auth0 Dashboard
...
<table class="table">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><a href="/docs/fr-CA/fr-ca/tokens/management-api-access-tokens">Jeton d’accès à Management API</a> avec la permission `delete:organization_member_roles`.</td>
    </tr>
