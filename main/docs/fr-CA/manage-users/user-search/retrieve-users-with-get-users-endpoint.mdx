...
Le point de terminaison [`GET /api/v2/users`](/docs/fr-CA/fr-ca/api/management/v2#!/Users/get_users) vous permet de récupérer une liste d’utilisateurs. Ce point de terminaison permet ce qui suit :
...
Les données utilisateur qui peuvent être indexées, interrogées et renvoyées par le [point de terminaison de recherche utilisateur](https://auth0.com/docs/api/management/v2/users/get-users) sont limitées à 1 Mo par utilisateur. Pour plus d’informations sur la manière dont cela affecte les métadonnées personnalisées de plus de 1 Mo, consultez [Noms des champs de métadonnées et types de données](/docs/fr-CA/fr-ca/manage-users/user-accounts/metadata/metadata-fields-data#size-limits-and-storage). [Le point de terminaison obtenir utilisateur](https://auth0.com/docs/api/management/v2/users/get-users-by-id) doit être utilisé pour récupérer tous les attributs de l’utilisateur pour les profils utilisateurs surdimensionnés.

Si vous avez besoin d’une exportation complète de tous vos utilisateurs, utilisez la [tâche d’exportation](/docs/fr-CA/fr-ca/api/management/v2#!/Jobs/post_users_exports) ou [l’extension Importation/Exportation des utilisateurs.](/docs/fr-CA/fr-ca/customize/extensions/user-import-export).
...
* Les opérations qui nécessitent une cohérence immédiate. Utilisez plutôt le point de terminaison [Obtenir des utilisateurs par courriel](/docs/fr-CA/fr-ca/manage-users/user-search/retrieve-users-with-get-users-by-email-endpoint) ou [Obtenir des utilisateurs par identifiant](/docs/fr-CA/fr-ca/manage-users/user-search/retrieve-users-with-get-users-by-id-endpoint).
* Les exportations d’utilisateurs. Utilisez plutôt le point de terminaison [Exportation utilisateur](/docs/fr-CA/fr-ca/manage-users/user-migration/bulk-user-exports).
...
* La recherche d’utilisateurs pour l’[association de comptes](/docs/fr-CA/fr-ca/manage-users/user-accounts/user-account-linking) par courriel. Utilisez plutôt le point de terminaison Obtenir des utilisateurs par courriel.

<div id="learn-more">
  ## En savoir plus
</div>

* [Syntaxe de la requête de recherche de l’utilisateur](/docs/fr-CA/fr-ca/manage-users/user-search/user-search-query-syntax)
* [Trier les résultats de recherche](/docs/fr-CA/fr-ca/manage-users/user-search/sort-search-results)
* [Afficher les résultats de la recherche par page](/docs/fr-CA/fr-ca/manage-users/user-search/view-search-results-by-page)
* [Exportations d’utilisateurs en masse](/docs/fr-CA/fr-ca/manage-users/user-migration/bulk-user-exports)
