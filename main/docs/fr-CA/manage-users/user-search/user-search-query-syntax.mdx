...
* Un terme sans nom de champ ne correspondra pas au texte des champs [métadonnées utilisateur](/docs/fr-CA/fr-ca/manage-users/user-accounts/metadata).
...
Vous pouvez rechercher des utilisateurs à l’aide de tous les [champs de profil utilisateur normalisé](/docs/fr-CA/fr-ca/manage-users/user-accounts/user-profiles/normalized-user-profile-schema) et des champs ci-dessous :
...
* [Récupérer des utilisateurs avec le point de terminaison Obtenir utilisateur](/docs/fr-CA/fr-ca/manage-users/user-search/retrieve-users-with-get-users-endpoint)