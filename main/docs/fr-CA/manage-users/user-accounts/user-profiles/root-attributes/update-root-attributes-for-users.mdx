...
Vous pouvez mettre à jour les attributs racine d’un profil utilisateur existant à l’aide de <Tooltip href="/docs/fr-CA/fr-ca/glossary?term=management-api" tip="Management API
...
La fonctionnalité [Profil utilisateur normalisé](/docs/fr-CA/fr-ca/manage-users/user-accounts/user-profiles/user-profile-structure) de Auth0, présente des attributs racine que vous pouvez mettre à jour. Les attributs racine spécifiques que vous pouvez mettre à jour dépendent du type de [connexion](/docs/fr-CA/fr-ca/identityproviders) que vous utilisez. Pour plus de détails concernant la connexion que vous utilisez, veuillez consulter [Mettre à jour les attributs racine du profil utilisateur](/docs/fr-CA/fr-ca/manage-users/user-accounts/user-profiles/root-attributes/update-root-attributes-for-users).
