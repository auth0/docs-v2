...
3. Ajoutez un gestionnaire de clic pour chaque bouton afin de déclencher l&#39;authentification via réseau social.
   ...
   1. Remplacez l&#39;identifiant du bouton dont vous avez pris connaissance précédemment et le [nom de connexion](/docs/fr-CA/fr-ca/authenticate/identity-providers/locate-the-connection-id). Par exemple, pour Google, vous utiliserez `google-oauth2` et pour LinkedIn, `linkedin`.
