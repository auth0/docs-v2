...
Vous pouvez supprimer les [autorisations](/docs/fr-CA/fr-ca/manage-users/access-control/rbac) attribuées à un rôle en utilisant Dashboard ou <Tooltip href="/docs/fr-CA/fr-ca/glossary?term=management-api" tip="Management API
...
* [Supprimer les autorisations de l’API](/docs/fr-CA/fr-ca/get-started/apis/delete-api-permissions)
