...
Vous pouvez attribuer des [autorisations](/docs/fr-CA/fr-ca/manage-users/access-control/rbac) à un utilisateur en utilisant <Tooltip href="/docs/fr-CA/fr-ca/glossary?term=auth0-dashboard" tip="Auth0 Dashboard
...
* [Configurez une API](/docs/fr-CA/fr-ca/get-started/auth0-overview/set-up-apis) dans Auth0 Dashboard.
* Les autorisations sont sélectionnées à partir de valeurs prédéfinies. Si votre liste de rôles est vide, vous devez [ajouter des autorisations](/docs/fr-CA/fr-ca/get-started/apis/add-api-permissions) à votre API.
...
* [Supprimer les autorisations des utilisateurs](/docs/fr-CA/fr-ca/manage-users/access-control/configure-core-rbac/rbac-users/remove-permissions-from-users)
* [Afficher les autorisations d’un utilisateur](/docs/fr-CA/fr-ca/manage-users/access-control/configure-core-rbac/rbac-users/view-user-permissions)