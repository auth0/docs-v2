...
Vous pouvez supprimer les [roles](/docs/fr-CA/fr-ca/manage-users/access-control/rbac) (rôles) attribués à un utilisateur en utilisant le Tableau de bord Auth0 ou <Tooltip href="/docs/fr-CA/fr-ca/glossary?term=management-api" tip="Management API
...
* [Afficher les utilisateurs affectés à des rôles](/docs/fr-CA/fr-ca/manage-users/access-control/configure-core-rbac/roles/view-users-assigned-to-roles)