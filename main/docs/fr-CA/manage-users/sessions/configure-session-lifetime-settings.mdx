...
**Expiration absolue** L’expiration absolue d’une session est définie lors de la création de la session. Vous pouvez ajuster l’Expiration absolue en configurant les paramètres de session à l’aide du <Tooltip href="/docs/fr-CA/fr-ca/glossary?term=auth0-dashboard" tip="Auth0 Dashboard
...
Pour obtenir une aide au dépannage, consultez [Vérifier les appels d’API](/docs/fr-CA/fr-ca/troubleshoot/authentication-issues/check-api-calls).

<div id="learn-more">
  ## En savoir plus
</div>

* [Couches de sessions](/docs/fr-CA/fr-ca/manage-users/sessions/session-layers)
* [Sessions non persistantes](/docs/fr-CA/fr-ca/manage-users/sessions/non-persistent-sessions)