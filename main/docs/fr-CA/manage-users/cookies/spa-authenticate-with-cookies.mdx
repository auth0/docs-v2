...
Lorsque l’application est ouverte à [http://localhost:3000](/docs/fr-CA/images/), cliquez sur le bouton **Call API (Appeler l’API)**. Un message devrait s’afficher à l’écran.
...
* [Flux implicite avec Form Post](/docs/fr-CA/fr-ca/get-started/authentication-and-authorization-flow/implicit-flow-with-form-post)
* [Sécuriser](/docs/fr-CA/fr-ca/secure)
