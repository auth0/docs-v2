...
L’utilisation des jetons d’ID pour appeler les points de terminaison de <Tooltip href="/docs/fr-CA/fr-ca/glossary?term=management-api" tip="Management API
...
* [Migrate to Access Tokens for Account Linking (Migrer vers des jetons d’accès pour associer les comptes)](/docs/fr-CA/fr-ca/troubleshoot/product-lifecycle/past-migrations/link-user-accounts-with-access-tokens-migration)