...
* [Migration du Flux de mot de passe du propriétaire de ressource](/docs/fr-CA/fr-ca/troubleshoot/product-lifecycle/past-migrations/migration-oauthro-oauthtoken)