...
2. En haut à gauche de l’écran, sélectionnez **{"{tenantName}"} > Vault (Coffre-fort)** pour ouvrir la page Vault.
   ...
   <Frame>![Dashboard > Forms > Vault](/docs/images/fr-CA/cdy7uua7fh8z/1sPNPKO6nuEDCuiYGRWSur/d85dc616170eaf2d7d5f321750863ccf/vault-connections-example.png)</Frame>
...
3. Dans le paramètre **Vault connection (Connexion au coffre-fort)** de l’action, sélectionnez l’icône **+**.
   ...
   <Frame>![Dashboard > Forms > Vault ](/docs/images/fr-CA/cdy7uua7fh8z/1AsaznhRKxm5LZxPlcbfUw/10e5a8af700aab909f5b03fcd266da7e/twilio-vault-connection.png)</Frame>
...
5. Saisissez les identifiants.
   ...
   <Frame>![Dashboard > Forms > Vault > Twilio connection settings](/docs/images/fr-CA/cdy7uua7fh8z/yobXanutPRCO3FWek8cOk/bc29e39fb8593cff35e2738234bfe6fe/twilio-vault-settings.png)</Frame>
