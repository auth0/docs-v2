...
Vous pouvez mettre à jour les hooks en utilisant Dashboard ou <Tooltip href="/docs/fr-CA/fr-ca/glossary?term=management-api" tip="Management API
Un produit permettant aux clients d’effectuer des tâches administratives." cta="Voir le glossaire">Management API</Tooltip>.

Vous pouvez également importer et exporter des hooks à l’aide de l’outil [Deploy CLI](/docs/fr-CA/fr-ca/deploy-monitor/deploy-cli-tool).
...
1. Allez à [Dashboard Auth0 &gt; Auth Pipeline &gt; Hooks](https://manage.auth0.com/#/hooks) et cliquez sur l’icône de roue dentée à côté du hook que vous souhaitez renommer.
2. Cliquez sur **Renommer**.
3. Saisissez un nouveau nom po](/docs/images/ et cliquez sur **Renommer**.

   <Frame>![Auth0 Rename Hooks](/docs/images/fr-ca/cdy7uua7fh8z/2Xp8Z3uYGoGZrF5EGXLPLQ/6c68c77f97133b2066219a68540b1e73/Screen_Shot_2021-05-19_at_12.08.00_PM.png)</Frame>

<div id="update-hook-scripts-using-the-dashboard">
  ## Mettre à jour les scripts d’appels en utilisant Dashboard
</div>

1. Allez à [Dashboard Auth0 &gt; Auth Pipeline &gt; Hooks](https://manage.auth0.com/#/hooks) et cliquez sur l’icône de crayon à côté du hook que vous souhaitez mettre à jour.
...
2. Mettez à jour le crochet e](/docs/images/t l’Éditeur de crochet et cliquez sur l’icône de disque pour enregistrer votre changement.
...
Effectuez une requête `PATCH` au [point de terminaison Mise à jour d’un hook](/docs/fr-CA/fr-ca/api/management/v2/#!/Hooks/patch_hooks_by_id). Assurez-vous de remplacer les valeurs des paramètres fictifs `HOOK_ID` et `MGMT_API_ACCESS_TOKEN` avec l’ID de votre appel et votre jeton d’accès de Management API, respectivement.
