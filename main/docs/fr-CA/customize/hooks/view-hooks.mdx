...
Pour voir les hooks configurés, vous pouvez les afficher à l’aide du Dashboard ou en récupérer une liste à l’aide de <Tooltip href="/docs/fr-CA/fr-ca/glossary?term=management-api" tip="Management API
...
Effectuez un appel `GET` au point de terminaison [Obtenir les hooks](/docs/fr-CA/fr-ca/api/management/v2/#!/Hooks/get_hooks). Veillez à remplacer le paramètre fictif `MGMT_API_ACCESS_TOKEN` par votre jeton d’accès à Management API.
...
<table class="table">
  ...
  <tbody>
    <tr>
      ...
      <td>Jeton d’accès à Management API avec la <dfn id="react-containers-DefinitionTooltip-1"><span class="tooltip-portal-underlined-word" data-react-universal-portal="">permission</span></dfn> `create:hooks`. Pour en savoir plus, consultez <a href="/docs/fr-CA/fr-ca/api/management/v2/tokens">Jetons d’accès à Management API</a>.</td>
    </tr>
  </tbody>
</table>