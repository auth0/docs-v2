...
1. Les clés API;
2. IAM;
3. [Amazon Cognito](/docs/fr-CA/fr-ca/integrations/aws-api-gateway/secure-api-with-cognito).
...
Suivez le tutoriel intitulé [Comment configurer AWS pour l’authentification déléguée](/docs/fr-CA/fr-ca/aws-api-setup) afin de configurer l’accès délégué à AWS par le biais du protocole SAML. Quelques mises en garde :
