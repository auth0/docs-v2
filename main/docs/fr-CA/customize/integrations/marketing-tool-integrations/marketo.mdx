...
Vous pouvez vérifier l’état de votre importation en utilisant l’API [Obtenir l’état de l’importation d’un prospect](/docs/fr-CA/fr-ca/)et le `batchId` de votre tâche d’importation. Par exemple :
