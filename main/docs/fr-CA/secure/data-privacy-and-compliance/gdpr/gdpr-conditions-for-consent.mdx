...
Pour rechercher un utilisateur à l’aide de son adresse courriel, utilisez le [point de terminaison](/docs/fr-CA/fr-ca/manage-users/user-search/user-search-best-practices) [**Rechercher un utilisateur par courriel**](/docs/fr-CA/fr-ca/manage-users/user-search/user-search-best-practices).

<div id="search-for-users-by-email-address">
  ### Recherche d’utilisateurs par adresse courriel
</div>

Pour rechercher un utilisateur à l’aide de son adresse courriel, utilisez le [point de terminaison **Rechercher un utilisateur par courriel**](/docs/fr-CA/fr-ca/manage-users/user-search/user-search-best-practices).
...
Pour rechercher un utilisateur à l’aide de son ID, utilisez le [point de terminaison **Obtenir un utilisateur**](/docs/fr-CA/fr-ca/manage-users/user-search/user-search-best-practices).
...
Pour mettre à jour la valeur des `user_metadata` d’un utilisateur, utilisez le [point de terminaison **Mettre à jour un utilisateur**](/docs/fr-CA/fr-ca/api/management/v2#!/Users/patch_users_by_id).
...
Pour exporter une liste de vos utilisateurs à l’aide de Management API, utilisez le [point de terminaison](/docs/fr-CA/fr-ca/manage-users/user-search/user-search-best-practices) [**User Export (Exportation d’utilisateurs)**](/docs/fr-CA/fr-ca/manage-users/user-search/user-search-best-practices).

<div id="export-consent-information">
  ### Exporter l’information sur le consentement
</div>

Pour exporter une liste de vos utilisateurs à l’aide de Management API, utilisez le point de terminaison [**User Export**](/docs/fr-CA/fr-ca/manage-users/user-search/user-search-best-practices).

Ce point de terminaison crée une tâche qui exporte tous les utilisateurs associés à une connexion. Vous aurez besoin de l’ID de la connexion. Pour trouver cet ID, utilisez le [point de terminaison **Obtenir les connexions**](/docs/fr-CA/fr-ca/api/management/v2#!/Connections/get_connections). Vous pouvez définir le paramètre **name** sur le nom de la connexion pour récupérer uniquement celle-ci.

Une fois que vous disposez de l’ID de connexion et d’un jeton d’accès pour Management API, vous êtes prêt à commencer à exporter des utilisateurs. Pour voir un exemple de requête et de réponse, veuillez consulter l’article [Importer et exporter des utilisateurs](/docs/fr-CA/fr-ca/manage-users/user-migration). Pour savoir comment obtenir un jeton d’accès pour Management API, veuillez consulter l’article [Jetons d’accès à Management API](/docs/fr-CA/fr-ca/secure/tokens/access-tokens/management-api-access-tokens).
...
Pour supprimer un utilisateur, utilisez le [point de terminaison **Supprimer un utilisateur**](/docs/fr-CA/fr-ca/api/management/v2#!/Users/delete_users_by_id).
...
Si vous ne souhaitez pas supprimer l’utilisateur, marquez son profil comme supprimé à l’aide du [point de terminaison **app&#95;metadata**](/docs/fr-CA/fr-ca/api/management/v2#!/Users/patch_users_by_id). Ajoutez ensuite du code qui fera échouer le processus d’authentification pour tout utilisateur dont le profil est marqué comme supprimé.
...
Pour mettre à jour les métadonnées d’un utilisateur, utilisez le [point de terminaison **Mettre à jour un utilisateur**](/docs/fr-CA/fr-ca/api/management/v2#!/Users/patch_users_by_id).
...
* [RGPD : Minimisation des données](/docs/fr-CA/fr-ca/secure/data-privacy-and-compliance/gdpr/gdpr-data-minimization)
