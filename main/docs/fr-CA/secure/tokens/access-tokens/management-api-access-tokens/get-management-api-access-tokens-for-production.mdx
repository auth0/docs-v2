...
* [Enregistrer les applications de communication entre machines](/docs/fr-CA/fr-ca/get-started/auth0-overview/create-applications/machine-to-machine-apps).

<div id="get-access-tokens">
  ## Obtenir des jetons d’accès
</div>

Pour demander à Auth0 un jeton de <Tooltip href="/docs/fr-CA/fr-ca/glossary?term=management-api" tip="Management API
...
<table class="table">
  ...
  <tbody>
    <tr>
      ...
      <td>Indique le <a href="/docs/fr-CA/fr-ca/protocols/oauth2#grant-types">flux OAuth 2.0</a> que vous souhaitez exécuter. Pour la communication entre machines, utilisez la valeur `client_credentials`.</td>
    </tr>
...
La réponse contiendra un [jeton JSON Web (JWT) signé](/docs/fr-CA/fr-ca/secure/tokens/json-web-tokens), un délai d’expiration, les permissions accordées et le type de jeton.
...
Par exemple, pour [obtenir toutes les applications](/docs/fr-CA/fr-ca/api/management/v2#!/Clients/get_clients) procédez comme suit :
...
Ce script python obtient un jeton d’accès à Management API v2, l’utilise pour appeler le point de terminaison [Obtenir toutes les applications](/docs/fr-CA/fr-ca/api/management/v2#!/Clients/get_clients) et affiche la réponse dans la console.
...
* [Obtenir des jetons d’accès à Management API pour les tests](/docs/fr-CA/fr-ca/secure/tokens/access-tokens/management-api-access-tokens/get-management-api-access-tokens-for-testing)
* [Obtenir des jetons d’accès à Management API pour les applications monopages](/docs/fr-CA/fr-ca/secure/tokens/access-tokens/management-api-access-tokens/get-management-api-tokens-for-single-page-applications)
* [Applications dans Auth0](/docs/fr-CA/fr-ca/get-started/applications)