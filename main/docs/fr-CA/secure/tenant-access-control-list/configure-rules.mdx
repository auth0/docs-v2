...
You can configure Tenant Access Control List (ACL) rules with the Auth0 <Tooltip href="/docs/fr-CA/fr-ca/glossary?term=management-api" tip="Management API
...
<table class="table">
  ...
  <tbody>
    <tr>
      <td>View a rule</td>
      <td><a href="/docs/fr-CA/fr-ca/api/management/v2/network-acls/get-network-acls-by-id">Get a specific access control list entry for a tenant</a></td>
      <td>`read:network_acls`</td>
    </tr>

    <tr>
      <td>View all rules</td>
      <td><a href="/docs/fr-CA/fr-ca/api/management/v2/network-acls/get-network-acls">Get all access control list entries for a tenant</a></td>
      <td>`read:network_acls`</td>
    </tr>

    <tr>
      <td>Create a rule</td>
      <td><a href="/docs/fr-CA/fr-ca/api/management/v2/network-acls/post-network-acls">Create access control list</a></td>
      <td>`create:network_acls`</td>
    </tr>

    <tr>
      <td>Update a rule</td>
      <td><a href="/docs/fr-CA/fr-ca/api/management/v2/network-acls/patch-network-acls-by-id">Partial update for an access control list</a></td>
      <td>`update:network_acls`</td>
    </tr>

    <tr>
      <td>Overwrite a rule</td>
      <td><a href="/docs/fr-CA/fr-ca/api/management/v2/network-acls/put-network-acls-by-id">Update access control list</a></td>
      <td>`update:network_acls`</td>
    </tr>

    <tr>
      <td>Delete a rule</td>
      <td><a href="/docs/fr-CA/fr-ca/api/management/v2/network-acls/delete-network-acls-by-id">Delete access control list</a></td>
...
For detailed information about Tenant ACL parameters and how to use them, read [Reference](/docs/fr-CA/fr-ca/secure/tenant-access-control-list/reference).
...
<Tabs>
  <Tab title="Management API">
    ...
    1. [Get a Management API access token](/docs/fr-CA/fr-ca/secure/tokens/access-tokens/management-api-access-tokens/get-management-api-access-tokens-for-production) with the `create:network_acls` scope.
    2. Call the Management API [Create access control list](/docs/fr-CA/fr-ca/api/management/v2/network-acls/post-network-acls) endpoint with the following body:
...
You can enable or disable [monitoring mode](/docs/fr-CA/fr-ca/secure/tenant-access-control-list) for a Tenant ACL rule by setting the `rule.action.log` object to `true` or `false`, respectively.
...
<Tabs>
  <Tab title="Management API">
    ...
    1. [Get a Management API access token](/docs/fr-CA/fr-ca/secure/tokens/access-tokens/management-api-access-tokens/get-management-api-access-tokens-for-production) with the `update:network_acls` scope.
    2. Call the Management API [Partial update for an access control list](/docs/fr-CA/fr-ca/api/management/v2/network-acls/patch-network-acls-by-id) endpoint with the following body:
