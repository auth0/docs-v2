...
* [Configurez Push](/docs/fr-CA/fr-ca/secure/multi-factor-authentication/multi-factor-authentication-factors/configure-push-notifications-for-mfa) comme facteur d’authentification dans Dashboard ou à l’aide de [Management API](https://auth0.com/docs/api/management/v2#!/Guardian/put_factors_by_name).
...
Obtenez un jeton MFA en suivant les étapes décrites dans [Authentification avec le propriétaire de la ressource Autorisation par mot de passe et MFA](/docs/fr-CA/fr-ca/secure/multi-factor-authentication/authenticate-using-ropg-flow-with-mfa).
...
* [Configuration des notifications poussées pour MFA](/docs/fr-CA/fr-ca/secure/multi-factor-authentication/multi-factor-authentication-factors/configure-push-notifications-for-mfa)
