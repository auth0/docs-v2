...
* [Configurer le courriel](/docs/fr-CA/fr-ca/secure/multi-factor-authentication/multi-factor-authentication-factors/configure-email-notifications-for-mfa) comme facteur d’authentification dans le Dashboard ou à l’aide de la [Management API](https://auth0.com/docs/api/management/v2#!/Guardian/put_factors_by_name).
...
Vous pouvez éventuellement personnaliser les courriels que les utilisateurs reçoivent. Consultez [Personnalisation des modèles de courriel](/docs/fr-CA/fr-ca/customize/email/email-templates) pour en savoir davantage.
