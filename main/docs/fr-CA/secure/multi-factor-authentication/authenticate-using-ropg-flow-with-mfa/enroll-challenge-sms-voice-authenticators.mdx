...
* [Configurez le téléphone comme facteur d’authentification](/docs/fr-CA/fr-ca/secure/multi-factor-authentication/multi-factor-authentication-factors/configure-sms-voice-notifications-mfa) dans Dashboard ou à l’aide de la [Management API](/docs/fr-CA/fr-ca/api/management/v2#!/Guardian/put_factors_by_name).
...
Pour compléter l’inscription, réalisez une requête `POST` au point de terminaison <Tooltip href="/docs/fr-CA/fr-ca/glossary?term=oath2" tip="OAuth 2.0
...
* [Configuration des notifications SMS et vocales pour l’authentification multifacteur (MFA)](/docs/fr-CA/fr-ca/secure/multi-factor-authentication/multi-factor-authentication-factors/configure-sms-voice-notifications-mfa)
