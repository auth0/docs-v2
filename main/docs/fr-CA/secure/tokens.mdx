...
Les [jetons d’accès](/docs/fr-CA/fr-ca/secure/tokens/access-tokens) (qui ne sont pas toujours des <Tooltip href="/docs/fr-CA/fr-ca/glossary?term=json-web-token" tip="Jeton Web JSON (JWT)
...
* **Jetons d’accès des <Tooltip href="/docs/fr-CA/fr-ca/glossary?term=idp" tip="Fournisseur d’identité (IdP)
...
* **Jetons d&#39;accès à l’Auth0 Management API** : jetons de courte durée contenant des demandes spécifiques (permissions) qui vous permettent d’appeler les points de terminaison de <Tooltip href="/docs/fr-CA/fr-ca/glossary?term=management-api" tip="Management API
...
* [Stockage des jetons](/docs/fr-CA/fr-ca/secure/security-guidance/data-security/token-storage)
* [Meilleures pratiques concernant les jetons](/docs/fr-CA/fr-ca/secure/tokens/token-best-practices)