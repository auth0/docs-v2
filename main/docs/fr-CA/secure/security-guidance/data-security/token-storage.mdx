...
3. Le côté client complétera l’échange de code avec Auth0 et récupérera le `id_token` et le `access_token` de l’utilisateur, qui seront sauvegardés dans la mémoire.
   ...
   <Frame>![Diagramme de stockage en mémoire des meilleures pratiques de stockage de jetons](/docs/images/fr-CA/cdy7uua7fh8z/6a4aA0TH8PJQpvhkLaGSIp/a60fc14a74bdb12274c2619d5c7c0f22/in-memory-token-storage.png)</Frame>
