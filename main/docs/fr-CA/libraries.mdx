---
title: "Bibliothèques de trousses SDK"
permalink: "libraries"
...
Les bibliothèques de trousses SDK permettent aux développeurs d’intégrer et d’interagir facilement avec Auth0. Explorez n’importe quelle bibliothèque sur GitHub, téléchargez un exemple d’application ou suivez le démarrage rapide pour obtenir une aide personnalisée.

<div id="single-page-application-spa-sdk-libraries">
  ## Bibliothèques de trousses SDK pour applications à page unique
</div>
...
<div id="regular-web-application-sdk-libraries">
  ## Bibliothèques de trousses SDK pour application Web classiques
</div>
...
<div id="backend-service-and-api-sdk-libraries">
  ## Service dorsal et bibliothèques de trousses SDK et d’API
</div>
...
<div id="nativemobile-app">
  ## Bibliothèques de trousses SDK pour les applications natives et mobiles
</div>
...
<div id="advanced-customization-for-universal-login-acul">
  ## Trousses SDK de Management API
</div>
...
<div id="management-api-sdk-libraries">
  ## Bibliothèques de trousses SDK Lock
</div>
