...
import { InlineImage } from "/snippets/fr-CA/InlineImage.mdx";
...
* Assurez-vous que votre système répond à la [configuration requise](/docs/fr-CA/fr-ca/authenticate/identity-providers/enterprise-identity-providers/active-directory-ldap/ad-ldap-connector/ad-ldap-connector-requirements).
...
* [Dépannage du Connecteur AD/LDAP](/docs/fr-CA/fr-ca/troubleshoot/integration-extensibility-issues/troubleshoot-ad-ldap-connector)
* [Exigences du système du connecteur AD/LDAP](/docs/fr-CA/fr-ca/authenticate/identity-providers/enterprise-identity-providers/active-directory-ldap/ad-ldap-connector/ad-ldap-connector-requirements)
* [Point de connexion AD/LDAP aux connexions Auth0](/docs/fr-CA/fr-ca/authenticate/identity-providers/enterprise-identity-providers/active-directory-ldap/ad-ldap-connector/ad-ldap-connector-to-auth0)
* [Configuration de l’authentification du connecteur AD/LDAP à l’aide de certificats clients](/docs/fr-CA/fr-ca/authenticate/identity-providers/enterprise-identity-providers/active-directory-ldap/ad-ldap-connector/configure-ad-ldap-connector-client-certificates)
* [Configurer l’authentification connecteur AD/LDAP avec Kerberos](/docs/fr-CA/fr-ca/authenticate/identity-providers/enterprise-identity-providers/active-directory-ldap/ad-ldap-connector/configure-ad-ldap-connector-with-kerberos)
* [Mise à jour des Connecteurs AD/LDAP](/docs/fr-CA/fr-ca/authenticate/identity-providers/enterprise-identity-providers/active-directory-ldap/ad-ldap-connector/update-ad-ldap-connectors)