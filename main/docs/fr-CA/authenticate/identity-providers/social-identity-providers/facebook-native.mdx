...
4. En bas de la page des paramètres, sélectionnez **Afficher les paramètres avancés**, puis la vue **Paramètres de l’appareil**. Sous **Connexion sociale native**, activez l’option **Activer la connexion avec Facebook**.
   ...
   <Frame>![Paramètres de connexion des réseaux sociaux natifs](/docs/images/fr-ca/cdy7uua7fh8z/5p2RaaeAtZyJzcoCfkF4tW/7d12b7b441d565124e7915efa972f901/Native_Social_Login_-_French.png)</Frame>
...
Comme l’implémentation de la connexion native n’utilise pas les flux de navigateur standard, les propriétaires des applications doivent veiller à effectuer la déconnexion de manière appropriée. Lorsqu’une application a besoin d’effectuer une déconnexion, elle doit également [Révoquer le jeton d’actualisation Auth0](/docs/fr-CA/fr-ca/api/authentication#revoke-refresh-token).

<div id="keep-reading">
  ## Poursuivre la lecture
</div>

* [Connexion Facebook native avec iOS Swift](/docs/fr-CA/fr-ca/quickstart/native/ios-swift-facebook-login)
* [Connexion Facebook native avec Android](/docs/fr-CA/fr-ca/quickstart/native/android-facebook-login)
* [Limites anti-attaques pour les réseaux sociaux natifs](/docs/fr-CA/fr-ca/troubleshoot/customer-support/operational-policies/rate-limit-policy)