...
Il s’agit des paramètres utilisés pour configurer un fournisseur d’identités (<Tooltip href="/docs/fr-CA/fr-ca/glossary?term=idp" tip="Fournisseur d’identité (IdP)
Service de stockage et de gestion des identités numériques." cta="Voir le glossaire">IdP</Tooltip>) <Tooltip href="/docs/fr-CA/fr-ca/glossary?term=security-assertion-markup-language" tip="Security Assertion Markup Language (SAML)
...
Lorsque vous utilisez la <Tooltip href="/docs/fr-CA/fr-ca/glossary?term=single-sign-on" tip="Authentification unique (SSO)
...
Vous pouvez créer un identifiant d’entité personnalisé à l’aide de la propriété `connection.options.entityId`. Pour en savoir plus, lisez [Indiquer un identifiant d’entité personnalisé](/docs/fr-CA/fr-ca/connections/enterprise/saml#specify-a-custom-entity-id).
...
Pour en savoir plus sur la connexion unique initiée par l’IdP, consultez [Configurer l&#39;authentification unique initiée par l’IdP SAML](/docs/fr-CA/fr-ca/authenticate/protocols/saml/saml-sso-integrations/identity-provider-initiated-single-sign-on).
...
* [Localiser l’identifiant de connexion ou son nom](/docs/fr-CA/fr-ca/authenticate/identity-providers/locate-the-connection-id)
* [Personnaliser les assertions SAML](/docs/fr-CA/fr-ca/authenticate/protocols/saml/saml-configuration/customize-saml-assertions)
