...
Pour utiliser l’Authentication API et <Tooltip href="/docs/fr-CA/fr-ca/glossary?term=management-api" tip="Management API
...
4. Cliquez sur l’onglet **Paramètres** pour obtenir les informations d’identification requises utilisées ci-dessous. Pour en savoir plus, voir [Paramètres de l’application](/docs/fr-CA/fr-ca/get-started/applications/application-settings).
...
* [PHP : Connexion, déconnexion et restitution des profils utilisateurs avec Auth0-PHP](/docs/fr-CA/fr-ca/libraries/auth0-php/auth0-php-basic-use)
* [PHP : Utiliser Management API avec Auth0-PHP](/docs/fr-CA/fr-ca/libraries/auth0-php/using-the-management-api-with-auth0-php)
* [PHP : valider les jetons Web JSON (JWT) avec Auth0-PHP](/docs/fr-CA/fr-ca/libraries/auth0-php/validating-jwts-with-auth0-php)
* [PHP : Dépannage de votre intégration Auth0-PHP](/docs/fr-CA/fr-ca/libraries/auth0-php/troubleshoot-auth0-php-library)