...
Lorsque vous utilisez la fonction d’authentification Web (c’est-à-dire les connexions sociales), Lock sera configuré par défaut pour tenter d’utiliser les liens d’application Android. Cela nécessite un paramètre supplémentaire dans le tableau de bord de l’application Auth0. Utilisez notre [Android Keystores and Key Hashes Guide (Guide des magasins de clés et des hachages de clés Android)](/docs/fr-CA/fr-ca/android-development-keystores-hashes) pour compléter cette étape.

<div id="implementing-lock-social-database-enterprise">
  ## Mise en œuvre de Lock (réseau social, base de données, entreprise)
</div>

Les instructions suivantes décrivent la mise en œuvre de Classic Lock pour Android. Si vous souhaitez implémenter spécifiquement <Tooltip href="/docs/fr-CA/fr-ca/glossary?term=passwordless" tip="Sans mot de passe
Forme d’authentification qui ne repose pas sur un mot de passe comme premier facteur." cta="Voir le glossaire">Passwordless</Tooltip> Lock pour Android (Lock sans mot de passe pour Android), veuillez consulter [Lock.Android : Sans mot de passe](/docs/fr-CA/fr-ca/libraries/lock-android/lock-android-passwordless).
...
Pour une liste complète des options de configuration de Lock, veillez consulter [Lock.Android : Configuration](/docs/fr-CA/fr-ca/libraries/lock-android/lock-android-configuration).

<div id="error-messages">
  ## Messages d’erreur
</div>

Pour obtenir une description des messages d’erreur courants, veuillez consulter la page [Error Messages (Messages d’erreur)](/docs/fr-CA/fr-ca/troubleshoot/basic-issues/check-error-messages). De plus, si votre rappel reçoit une `AuthenticationException (Exception d’authentification)` vous pouvez vérifier [source](https://github.com/auth0/Auth0.Android/blob/main/auth0/src/main/java/com/auth0/android/authentication/AuthenticationException.kt) pour apprendre à identifier chaque scénario d’erreur.

<div id="learn-more">
  ## En savoir plus
</div>

* [Lock.Android: thème personnalisé](/docs/fr-CA/fr-ca/libraries/lock-android/lock-android-custom-theming)
* [Lock.Android: Configuration](/docs/fr-CA/fr-ca/libraries/lock-android/lock-android-configuration)
* [Lock.Android: Champs personnalisés à l’inscription](/docs/fr-CA/fr-ca/lock-android-custom-fields-at-signup)
* [Lock.Android : internationalisation](/docs/fr-CA/fr-ca/customize/internationalization-and-localization/lock-android-internationalization)
* [Déconnexion](/docs/fr-CA/fr-ca/authenticate/login/logout)