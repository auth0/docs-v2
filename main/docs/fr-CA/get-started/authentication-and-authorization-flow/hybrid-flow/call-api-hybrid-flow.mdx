...
<Callout icon="file-lines" color="#0EA5E9" iconType="regular">
  Ce tutoriel vous aidera à appeler votre propre API à l’aide du flux Hybride. Pour en savoir plus sur le fonctionnement du flux et pourquoi l’utiliser, voir [Flux hybride](/docs/fr-CA/fr-ca/get-started/authentication-and-authorization-flow/hybrid-flow).
</Callout>
...
* [Enregistrez votre application auprès d’Auth0](/docs/fr-CA/fr-ca/get-started/auth0-overview/create-applications/regular-web-apps).

  * Sélectionnez le **Type d’application** approprié.
  * Ajoutez une **URL de rappel autorisée** de `{https://yourApp/callback}`.
  * Assurez-vous que les **Types d’autorisation** de votre application englobent **Implicit** (Implicite) et le **code d’autorisation**. Pour en savoir plus, lisez [Mettre à jour les types d’autorisation](/docs/fr-CA/fr-ca/get-started/applications/update-grant-types).
...
* [Enregistrez votre application auprès d’Auth0](/docs/fr-CA/fr-ca/get-started/auth0-overview/set-up-apis)
...
Pour autoriser l’utilisateur, votre application doit envoyer l’utilisateur à l’[URL d’autorisation](/docs/fr-CA/fr-ca/api/authentication#authorization-code-grant).
...
<table class="table">
  ...
  <tbody>
    ...
    <tr>
      <td>`nonce`</td>
      <td>Une chaîne cryptographiquement aléatoire que votre application ajoute à la requête initiale et qu’Auth0 inclut dans le jeton d’ID, <a href="/docs/fr-CA/fr-ca/api-auth/tutorials/nonce">utilisée pour prévenir les attaques par réinsertion de jeton</a>.</td>
    </tr>
...
Maintenant que vous avez un code d’authentification, vous pouvez l’échanger pour des jetons. En utilisant le code d’autorisation (`code`) extrait de l’étape précédente, vous devrez `POST` sur [l’URL du jeton](/docs/fr-CA/fr-ca/api/authentication#authorization-code).
...
<table class="table">
  ...
  <tbody>
    ...
    <tr>
      <td>`client_secret`</td>
      <td>Le secret client de votre application. Vous pouvez trouver cette valeur dans les <a href="https://manage.auth0.com/#/Applications/{yourClientId}/settings">paramètres de votre application</a>.  Pour en savoir plus sur les méthodes d’authentification d’application disponibles, lisez <a href="/docs/fr-CA/fr-ca/secure/application-credentials">Identifiants d’applications</a>.</td>
    </tr>
