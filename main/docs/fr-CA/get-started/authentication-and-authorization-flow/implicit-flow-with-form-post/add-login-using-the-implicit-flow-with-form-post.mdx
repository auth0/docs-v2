...
Après une connexion réussie, votre application aura accès au [jeton d’ID](/docs/fr-CA/fr-ca/secure/tokens/id-tokens) de l’utilisateur. Le jeton d’ID contiendra les renseignements de base du profil utilisateur.

<div id="prerequisites">
  ## Prérequis
</div>

Enregistrez votre application auprès d’Auth0. Pour en apprendre davantage, consultez [Enregistrer les applications Web monopages](/docs/fr-CA/fr-ca/get-started/auth0-overview/create-applications/single-page-web-apps).
...
* Assurez-vous que les **Grant Types (Types d’autorisation)** de votre application comprennent **Implicit (Implicite)**. Pour en savoir plus, lisez [Mettre à jour les types d’autorisation](/docs/fr-CA/fr-ca/get-started/applications/update-grant-types).
...
* [Atténuer les attaques par réinsertion lors de l&#39;utilisation du flux implicite](/docs/fr-CA/fr-ca/get-started/authentication-and-authorization-flow/implicit-flow-with-form-post/mitigate-replay-attacks-when-using-the-implicit-flow)
* [Enregistrement d’applications Web à page unique](/docs/fr-CA/fr-ca/get-started/auth0-overview/create-applications/single-page-web-apps)
