...
3. Si la section **Identifiants Auth0** est disponible, sélectionnez-la et localisez le champ **Méthode d’authentification**.
   ...
   <Frame>![Configuration de l’authentification JWT Private Key (Clé privée JWT) - Instructions pour le Auth0 Dashboard (Tableau de bord Auth0)](/docs/images/fr-CA/cdy7uua7fh8z/33kfi48tkbMIOQJ8PBxj76/3a37d4906b80c31d5427b852f56cdb00/Default_App_-_Creds_-_French.png)</Frame>
