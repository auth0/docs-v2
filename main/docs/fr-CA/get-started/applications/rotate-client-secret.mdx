...
Vous pouvez modifier le secret client d’une application à l’aide de l’<Tooltip href="/docs/fr-CA/fr-ca/glossary?term=auth0-dashboard" tip="Auth0 Dashboard
...
<Callout icon="file-lines" color="#0EA5E9" iconType="regular">
  applications clients publiques. Pour en savoir plus, lisez [Applications confidentielles et publiques](/docs/fr-CA/fr-ca/get-started/applications/confidential-and-public-applications)
</Callout>
...
1. Dans l’Auth0 Dashboard, accédez à [Dashboard &gt; Applications &gt; Applications](https://manage.auth0.com/#/applications), puis sélectionnez le nom de l’application à afficher.
...
<table class="table">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><a href="/docs/fr-CA/fr-ca/api/management/v2/tokens">Jetons d’accès à Management API</a> avec la permission `update:client_keys`.</td>
    </tr>
  </tbody>
</table>
