...
Le logiciel médiateur <Tooltip href="/docs/fr-CA/fr-ca/glossary?term=openid" tip="OpenID
...
Le logiciel médiateur ASP.NET OIDC ajoutera automatiquement toutes les demandes renvoyées dans le <Tooltip href="/docs/fr-CA/fr-ca/glossary?term=json-web-token" tip="Jeton Web JSON (JWT)
