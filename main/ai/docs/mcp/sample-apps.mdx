...
mode: "wide"
og:title: "Auth for MCP Sample Apps"
og:description: "Explore sample MCP apps built using Auth for MCP."
og:url: "https://auth0.com/ai/docs"
twitter:title: "Auth for MCP Sample Apps"
twitter:description: "Explore sample MCP apps built using Auth for MCP."
permalink: "/mcp/sample-apps"
---
...
<Columns cols={2}>
  ...
  >
    Learn how you can use [Auth0's Token Vault](/docs/secure/call-apis-on-users-behalf/token-vault) to call an External MCP Service or API securely to use Google Calendar.
  </Card>
