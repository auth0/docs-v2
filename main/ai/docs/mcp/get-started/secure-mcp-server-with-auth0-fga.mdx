...
import FGACLIInstallation from "/snippets/ai/mcp/get-started/fga/fga-cli-installation.mdx";
import FGAStoreSetupOverview from "/snippets/ai/mcp/get-started/fga/fga-store-setup-overview.mdx";
import SetupFGAStoreCLI from "/snippets/ai/mcp/get-started/fga/setup-fga-store-cli.mdx";
import FGAModelExplanation from "/snippets/ai/mcp/get-started/fga/fga-model-explanation.mdx";
import CreateEnvFileFGA from "/snippets/ai/mcp/get-started/fga/create-env-file-fga.mdx";
import ManagingPermissions from "/snippets/ai/mcp/get-started/fga/managing-permissions.mdx";
...
* Learn how to [test your MCP server with MCP Inspector](/ai/docs/mcp/guides/test-your-mcp-server-with-mcp-inspector)
