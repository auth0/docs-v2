---
title: Call First-Party APIs on a User's Behalf
description: Learn how to call an Auth0-protected API from your MCP server.
sidebarTitle: Call First-Party APIs on a User's Behalf
og:title: "Call First-Party APIs on User's Behalf - Auth for MCP Quickstart"
og:description: "Learn how to call an Auth0-protected API from your MCP server."
og:url: "https://auth0.com/ai/docs"
twitter:title: "Call First-Party APIs on User's Behalf - Auth for MCP Quickstart"
...
import MCPGetStartedPrerequisites from "/snippets/ai/mcp/get-started/pre-reqs/prerequisites.mdx";
import MCPGetStartedConfigTenantSettings from "/snippets/ai/mcp/get-started/config-tenant/config-tenant-settings.mdx";
import MCPGetStartedCreateRoles from "/snippets/ai/mcp/get-started/config-tenant/roles-management.mdx";
import CreateProfile from "/snippets/ai/mcp/get-started/create-custom-token-exchange-profile.mdx";
import CreateMCPAPI from "/snippets/ai/mcp/get-started/create-mcp-api.mdx";
import AssignPermissionsToRoles from "/snippets/ai/mcp/get-started/config-tenant/assign-permissions-to-roles.mdx";
import AssignDownstreamPermissionsToRoles from "/snippets/ai/mcp/get-started/config-tenant/assign-downstream-permissions-to-roles.mdx";
import { DownloadQuickstartButton } from "/snippets/ai/download-quickstart/DownloadQuickstartButton.jsx";
import MCPGetStartedTestingInstructions from "/snippets/ai/mcp/get-started/testing-instructions.mdx";
import CreateEnvFile from "/snippets/ai/mcp/get-started/call-your-apis/create-env-file.mdx";
import CustomTokenExchangeAction from "/snippets/ai/mcp/get-started/call-your-apis/custom-token-exchange-action.mdx";
import RunMcpServerJs from "/snippets/ai/mcp/get-started/call-your-apis/run-mcp-server-js.mdx";
import RunMcpServerPython from "/snippets/ai/mcp/get-started/call-your-apis/run-mcp-server-python.mdx";
import ExchangeAccessTokenJs from "/snippets/ai/mcp/get-started/call-your-apis/exchange-access-token-js.mdx";
import ExchangeAccessTokenPython from "/snippets/ai/mcp/get-started/call-your-apis/exchange-access-token-python.mdx";
...
To call first-party APIs on a user’s behalf, the MCP server must exchange the Auth0 access token it receives from the MCP client for a new access token with a different audience. The original token has the MCP server as its audience, while the new token has your downstream API as its audience.

<Frame>
  <img
    className="hidden dark:block"
    src="/docs/images/ai/mcp/mcp_call_api_obo_exchange_dark.png"
    alt="MCP Diagram"
  />
  <img
    className="block dark:hidden"
    src="/docs/images/ai/mcp/mcp_call_api_obo_exchange_light.png"
    alt="MCP Diagram"
  />
</Frame>
