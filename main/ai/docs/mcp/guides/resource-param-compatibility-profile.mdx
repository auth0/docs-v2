...
og:title: "Resource Parameter Compatibility Profile - Auth for MCP"
og:description: "Learn how to enable the resource parameter in Auth0."
og:url: "https://auth0.com/ai/docs"
twitter:title: "Resource Parameter Compatibility Profile - Auth for MCP"
twitter:description: "Learn how to enable the resource parameter in Auth0."
permalink: "/mcp/guides/resource-param-compatibility-profile"
---

import MCPGetStartedEnableResourceParamStep from "/snippets/ai/mcp/get-started/pre-reqs/enable-resource-param-step.mdx";
...
<Frame>
  <img
    ...
    src="/docs/images/ai/mcp/audience_parameter_at_diagram_dark.png"
    alt="Audience in the access token"
  />
  <img
    className="block dark:hidden"
    src="/docs/images/ai/mcp/audience_parameter_at_diagram_light.png"
    alt="Audience in the access token"
  />
</Frame>
...
<Frame>
  <img
    className="hidden dark:block"
    src="/docs/images/ai/mcp/resource_parameter_at_diagram_dark.png"
    alt="Resource in the access token"
  />
  <img
    className="block dark:hidden"
    src="/docs/images/ai/mcp/resource_parameter_at_diagram_light.png"
    alt="Resource in the access token"
  />
</Frame>
