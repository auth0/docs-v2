...
og:title: "Test MCP Server with MCP Inspector - Auth for MCP"
og:description: "Learn how to test your MCP server with MCP Inspector."
og:url: "https://auth0.com/ai/docs"
twitter:title: "Test MCP Server with MCP Inspector - Auth for MCP"
twitter:description: "Learn how to test your MCP server with MCP Inspector."
permalink: "/mcp/guides/test-your-mcp-server-with-mcp-inspector"
---

import StaticClientRegOrDCR from "/snippets/ai/mcp/get-started/static-cr-or-dcr.mdx";
...
<Frame>
  <img
    src="/docs/images/ai/mcp/mcp_inspector_configured.png"
...
<Frame>
  <img
    class="img-sizing"
    src="/docs/images/ai/mcp/consent_screen_while_logging_in.png"
...
<Frame>
  <img
    src="/docs/images/ai/mcp/mcp_inspector_after_login.png"
    alt="MCP Inspector page after running it"
  />
</Frame>
...
<Frame caption="List of tools available in the MCP Server">
  <img
    src="/docs/images/ai/mcp/tools_list_tool_administrator_role.png"
...
<Frame>
  <img
    src="/docs/images/ai/mcp/whoami_tool_call_through_mcp_inspector.png"
