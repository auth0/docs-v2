...
<Frame>
  <img
    ...
    src="/docs/images/ai/mcp/mcp_diagram_dark.png"
    alt="MCP Diagram"
  />
  <img
    className="block dark:hidden"
    src="/docs/images/ai/mcp/mcp_diagram_light.png"
    alt="MCP Diagram"
  />
</Frame>
...
<Frame caption="MCP Authorization flow with Auth0">
  <img
    className="hidden dark:block"
    src="/docs/images/ai/mcp/mcp_auth_flow_dark.png"
    alt="Auth0 Authentication Flow"
  />
  <img
    className="block dark:hidden"
    src="/docs/images/ai/mcp/mcp_auth_flow_light.png"
    alt="Auth0 Authentication Flow"
  />
</Frame>
...
<Columns>
  <Card
    ...
    />
    <Card
      title="MCP with On-Behalf-Of Token Exchange"
