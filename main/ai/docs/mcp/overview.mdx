...
description: "Enable MCP clients to securely connect to MCP servers with Auth0."
og:title: "Secure MCP with Auth0"
og:description: "Enable MCP clients to securely connect to MCP servers with Auth0 using OAuth 2.1 and OpenID Connect for user authentication, controlled API access, and scoped token exchange."
og:url: "https://auth0.com/ai/docs"
twitter:title: "Secure MCP with Auth0"
twitter:description: "Enable MCP clients to securely connect to MCP servers with Auth0 using OAuth 2.1 and OpenID Connect for user authentication, controlled API access, and scoped token exchange."
permalink: "mcp-oauth-authentication"
---

<Card
  title="Enable MCP clients to securely connect to MCP servers using OAuth 2.1 and OpenID Connect, with user authentication, controlled API access, standards-based client registration, and scoped token exchange."
  icon="sparkles"
  iconType="solid"
  horizontal
/>
...
<Frame>
  <img
    ...
    src="/docs/images/ai/mcp/authentication_for_users_mcp_dark.png"
    alt="MCP Diagram"
  />
  <img
    className="block dark:hidden"
    src="/docs/images/ai/mcp/authentication_for_users_mcp_light.png"
    alt="MCP Diagram"
  />
</Frame>
...
<Card
  ...
  href="/ai/docs/mcp/why-auth-for-mcp"
  icon="book"
  horizontal
  iconType="solid" />
...
<Card
  ...
  href="/ai/docs/mcp/guides/registering-your-mcp-client-application"
  icon="book"
  horizontal
  iconType="solid" />
...
<Card
  title="Use this quickstart to call first-party APIs on a user's behalf from your MCP server"
  href="/ai/docs/mcp/get-started/call-your-apis-on-users-behalf"
  icon="book"
  horizontal
  iconType="solid" />
...
<Columns>
  <Card
    ...
    href="/ai/docs/mcp/get-started/authorization-for-your-mcp-server"
    icon="user"
    iconType="solid"
    horizontal
  />
...
<Columns>
  ...
  <Card
    ...
    href="/ai/docs/mcp/guides/resource-param-compatibility-profile"
    icon="book"
    horizontal
  />
  ...
  <Card
    ...
    href="/ai/docs/mcp/guides/test-your-mcp-server-with-mcp-inspector"
    icon="book"
    horizontal
  />
  ...
  <Card
    ...
    href="/ai/docs/mcp/guides/cloudflare-mcp"
    icon="book"
    horizontal
  />
</Columns>
...
<Columns>
  <Card
    ...
    />
    <Card
      title="MCP with On-Behalf-Of Exchange"
      href="https://github.com/auth0-samples/auth0-ai-samples/tree/main/auth-for-mcp/fastmcp-mcp-on-behalf-of-tokenexchange-js"
      icon="github"
      horizontal
    />
    <Card
