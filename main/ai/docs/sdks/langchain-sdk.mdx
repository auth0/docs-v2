...
description: AI Identity for B2B LangChain & LangGraph SDKs make it easy for developers to integrate with and secure AI agent workflows using LangChain and LangGraph.
sidebarTitle: LangChain
og:title: "LangChain SDKs - AI Identity for B2B"
og:description: "AI Identity for B2B LangChain & LangGraph SDKs make it easy for developers to integrate with and secure AI agent workflows."
og:url: "https://auth0.com/ai/docs"
twitter:title: "LangChain SDKs - AI Identity for B2B"
twitter:description: "AI Identity for B2B LangChain & LangGraph SDKs make it easy for developers to integrate with and secure AI agent workflows."
---
...
This SDK provides building blocks for using AI Identity for B2B with [LangChain](https://www.langchain.com/) and [LangGraph](https://www.langchain.com/langgraph). It supports:
...
This SDK provides building blocks for using AI Identity for B2B with LangChain and LangGraph. Includes a RAG Retriever for using OpenFGA, tools for implementing asynchronous user authentication, tools for getting access tokens for third-party connections, and OpenFGA-based tool authorizers. It supports:
...
<Columns cols={2}>
  ...
  >
    ...
    applications. Each sample demonstrates a specific AI Identity for B2B feature.
  </Card>
  <Card
