---
title: Genkit SDK
description: AI Identity for B2B Genkit SDK makes it easy for developers to integrate with and secure AI agent workflows using Genkit.
sidebarTitle: Genkit
og:title: "Genkit SDK - AI Identity for B2B"
og:description: "AI Identity for B2B Genkit SDK makes it easy for developers to integrate with and secure AI agent workflows."
og:url: "https://auth0.com/ai/docs"
twitter:title: "Genkit SDK - AI Identity for B2B"
twitter:description: "AI Identity for B2B Genkit SDK makes it easy for developers to integrate with and secure AI agent workflows."
---

### [Auth0 AI for Genkit](https://github.com/auth0/auth0-ai-js/tree/main/packages/ai-genkit)

This SDK provides building blocks for using AI Identity for B2B with [Genkit](https://firebase.google.com/docs/genkit). Includes a RAG Retriever for using OpenFGA, tools for implementing asynchronous user authentication, tools for getting access tokens for third-party connections, and [OpenFGA-based](https://openfga.dev/) tool authorizers. It supports:
