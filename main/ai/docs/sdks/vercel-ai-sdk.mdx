...
description: AI Identity for B2B Vercel AI SDKs make it easy for developers to integrate with and secure AI agent workflows using Vercel AI.
sidebarTitle: Vercel AI
og:title: "Vercel AI SDKs - AI Identity for B2B"
og:description: "AI Identity for B2B Vercel AI SDKs make it easy for developers to integrate with and secure AI agent workflows."
og:url: "https://auth0.com/ai/docs"
twitter:title: "Vercel AI SDKs - AI Identity for B2B"
twitter:description: "AI Identity for B2B Vercel AI SDKs make it easy for developers to integrate with and secure AI agent workflows."
---

### [Auth0 AI for Vercel AI SDK](https://github.com/auth0/auth0-ai-js/tree/main/packages/ai-vercel)

This SDK provides building blocks for using AI Identity for B2B with the Vercel AI SDK. It includes tools for implementing asynchronous user authentication, tools for getting access tokens for third-party connections, building blocks to handle interrupts, and [OpenFGA-based](https://openfga.dev/) tool authorizers. It supports:
