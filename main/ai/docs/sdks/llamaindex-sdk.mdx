...
description: AI Identity for B2B LlamaIndex SDKs make it easy for developers to integrate with and secure AI agent workflows using LlamaIndex.
sidebarTitle: LlamaIndex
og:title: "LlamaIndex SDK - AI Identity for B2B"
og:description: "AI Identity for B2B LlamaIndex SDKs make it easy for developers to integrate with and secure AI agent workflows."
og:url: "https://auth0.com/ai/docs"
twitter:title: "LlamaIndex SDK - AI Identity for B2B"
twitter:description: "AI Identity for B2B LlamaIndex SDKs make it easy for developers to integrate with and secure AI agent workflows."
---
...
This SDK provides building blocks for using AI Identity for B2B with LlamaIndex. Includes a RAG Retriever for using OpenFGA, tools for implementing asynchronous user authentication, tools for getting access tokens for third-party connections, and OpenFGA-based tool authorizers. It supports:
...
<Columns cols={2}>
  ...
  >
    ...
    demonstrates different AI Identity for B2B features like User Authentication,
