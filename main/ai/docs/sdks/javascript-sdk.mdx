...
og:title: "JavaScript SDKs - AI Identity for B2B"
og:description: "Auth0 JavaScript SDKs make it easy for developers to integrate with and secure AI agent workflows."
og:url: "https://auth0.com/ai/docs"
twitter:title: "JavaScript SDKs - AI Identity for B2B"
twitter:description: "Auth0 JavaScript SDKs make it easy for developers to integrate with and secure AI agent workflows."
---
...
This library helps to set up the React components that can be used in AI applications using AI Identity for B2B. The components are styled using [Tailwind CSS](https://tailwindcss.com/). It supports:
...
<Columns cols={2}>
  ...
  >
    ...
    different AI Identity for B2B features like User Authentication, Calling APIs
