...
- [Configure Token Vault](/ai/docs/call-apis-on-users-behalf/token-vault/configure-token-vault) for your client application to securely store the access and refresh tokens associated with each connected account in the Token Vault.
