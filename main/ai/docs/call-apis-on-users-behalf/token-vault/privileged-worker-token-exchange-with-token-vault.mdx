...
<ReleaseStageNotice
  feature="Privileged Worker Token Exchange with Token Vault"
  stage="ea"
...
1. [Enable the Token Vault grant type](/ai/docs/call-apis-on-users-behalf/token-vault/configure-token-vault#configure-application) for your client application.
