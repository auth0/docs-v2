...
og:title: "Dropbox Integration - AI Identity for B2B"
...
twitter:title: "Dropbox Integration - AI Identity for B2B"
...
<Steps>
  <Step title="Dropbox setup">
    ...
    3. When creating the app, select **Scoped access**.
    4. Select the type of access you need.
    ...
    9. Configure OAuth redirect URI:
       ...
       <FindDomainInfoBlock />
    10. Select **Add** to save the redirect URI.
