---
title: Salesforce
description: Connect your AI agent to a user's Salesforce account to create or update leads, manage contacts, and automate case management.
og:title: "Salesforce Integration - Auth0 for AI Agents"
og:description: "Connect your AI agent to a user's Salesforce account to create or update leads, manage contacts, and automate case management."
og:url: "https://auth0.com/ai/docs"
twitter:title: "Salesforce Integration - Auth0 for AI Agents"
twitter:description: "Connect your AI agent to a user's Salesforce account to create or update leads, manage contacts, and automate case management."
...
<Steps>
  <Step title="Salesforce setup">
    ...
    6. **Important Token Configuration** (for optimal Token Vault compatibility):
       - **Require Secret for Web Server Flow**: Select this option for enhanced security
       - **Require Secret for Refresh Token Flow**: Select this option to secure token refresh operations
       - **Enable Refresh Token Rotation**: Select this option to enable rotation on each refresh
       - **Issue JSON Web Token (JWT)-based access tokens for named users**: Select this option for longer token validity and better performance
    7. Select **Create** and wait for the app to be created.
