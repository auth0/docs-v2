...
Secure your AI agents with Auth0 to authenticate users, call internal and external APIs on the user's behalf, and handle advanced authorization flows for critical actions that require human approval.
<Columns cols={2}>
...
<Card title ="Call First-Party APIs on User's Behalf" icon="shapes" href="./call-first-party-apis-on-users-behalf" iconType="solid" vertical>
...
<Card title ="Call Third-Party APIs on User's Behalf" icon="plug" href="./call-third-party-apis-on-users-behalf" iconType="solid" vertical>
