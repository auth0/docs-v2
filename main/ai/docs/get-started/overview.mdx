...
<Card title ="Call Your APIs on User's Behalf" icon="shapes" href="./call-first-party-apis-on-users-behalf" iconType="solid" vertical>
...
<Card title ="Call Other's APIs on User's Behalf" icon="plug" href="./call-third-party-apis-on-users-behalf" iconType="solid" vertical>
