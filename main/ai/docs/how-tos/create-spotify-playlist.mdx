...
description: Learn how to use AI Identity for B2B SDKs to create a Spotify playlist.
mode: "wide"
---
...
![Create Spotify Playlist Chat UI](/docs/images/ai/how-tos/create_spotify_playlist_chat_ui.png)
