...
description: Learn how to use AI Identity for B2B SDKs to analyze Strava activities.
mode: "wide"
---
...
![Analyze Strava Activities Chat UI](/docs/images/ai/how-tos/analyze_strava_activities_chat_ui.png)
