---
title: Sample Apps
description: Explore sample apps built using AI Identity for B2B.
sidebarTitle: AI Agent Sample Apps
mode: "wide"
og:title: "AI Identity for B2B Sample Apps"
og:description: "Explore sample apps built using AI Identity for B2B."
og:url: "https://auth0.com/ai/docs"
twitter:title: "AI Identity for B2B Sample Apps"
twitter:description: "Explore sample apps built using AI Identity for B2B."
---
