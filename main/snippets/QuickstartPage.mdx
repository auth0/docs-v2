      ...
      cards: [
        {
          ...
          img: 'https://cdn2.auth0.com/docs-v2/1.14494.0/img/platforms/apache.svg',
        },
        {
          title: 'ASP.NET (OWIN)',
          href: '/docs/quickstart/webapp/aspnet-owin/interactive',
          img: 'https://cdn2.auth0.com/docs-v2/1.14494.0/img/platforms/dotnet.svg',
        },
        {
          title: 'ASP.NET Core Blazor Server',
          href: '/docs/quickstart/webapp/aspnet-core-blazor-server/interactive',
          img: 'https://cdn2.auth0.com/docs-v2/1.14494.0/img/platforms/dotnet-platform.svg',
        },
        {
        ...
        },
        {
          ...
          img: 'https://cdn2.auth0.com/docs-v2/1.14494.0/img/platforms/python.svg',
        },
        {
          title: 'Express',
          href: '/docs/quickstart/webapp/express/interactive',
          img: 'https://cdn2.auth0.com/docs-v2/1.14494.0/img/platforms/javascript.svg',
        },
        {
          title: 'Go',
          href: '/docs/quickstart/webapp/golang/interactive',
          img: 'https://cdn2.auth0.com/docs-v2/1.14494.0/img/platforms/golang.svg',
        },
        {
          title: 'Java',
          href: '/docs/quickstart/webapp/java/interactive',
          img: 'https://cdn2.auth0.com/docs-v2/1.14494.0/img/platforms/java.svg',
        },
        {
          title: 'Java EE',
        ...
        },
        {
          ...
          img: 'https://cdn2.auth0.com/docs-v2/1.14494.0/img/platforms/spring.svg',
        },
        {
          title: 'Laravel',
          href: '/docs/quickstart/webapp/laravel/interactive',
          img: 'https://cdn2.auth0.com/docs-v2/1.14494.0/img/platforms/laravel.svg',
        },
        {
          title: 'Next.js',
          href: '/docs/quickstart/webapp/nextjs/interactive',
          img: 'https://cdn2.auth0.com/docs-v2/1.14494.0/img/platforms/nextjs.svg',
        },
        {
          title: 'NGINX Plus',
          href: '/docs/quickstart/webapp/nginx-plus/interactive',
          img: 'https://cdn2.auth0.com/docs-v2/1.14494.0/img/platforms/nginx.svg',
        },
        {
          title: 'PHP',
          href: '/docs/quickstart/webapp/php/interactive',
          img: 'https://cdn2.auth0.com/docs-v2/1.14494.0/img/platforms/php.svg',
        },
        {
          title: 'Python',
        ...
        },
        {
          ...
          img: 'https://cdn2.auth0.com/docs-v2/1.14494.0/img/platforms/rails.svg',
        },
      ],
    },
    {
      ...
      cards: [
        {
          ...
          img: 'https://cdn2.auth0.com/docs-v2/1.14494.0/img/platforms/angular.svg',
        },
        {
          title: 'Flutter (Web)',
          href: '/docs/quickstart/spa/flutter/interactive',
          img: 'https://cdn2.auth0.com/docs-v2/1.14494.0/img/platforms/flutter.svg',
        },
        {
          title: 'JavaScript',
        ...
        },
        {
          ...
          img: 'https://cdn2.auth0.com/docs-v2/1.14494.0/img/platforms/react.svg',
        },
        {
          title: 'Vue',
          href: '/docs/quickstart/spa/vuejs/interactive',
          img: 'https://cdn2.auth0.com/docs-v2/1.14494.0/img/platforms/vuejs.svg',
        },
      ],
    },
    {
      ...
      cards: [
        ...
        },
        {
          ...
          img: 'https://cdn2.auth0.com/docs-v2/1.14494.0/img/platforms/android.svg',
        },
        {
        ...
        },
        {
          ...
          img: 'https://cdn2.auth0.com/docs-v2/1.14494.0/img/platforms/auth0.svg',
        },
        {
          title: 'Expo',
          href: '/docs/quickstart/native/react-native-expo/interactive',
          img: 'https://cdn2.auth0.com/docs-v2/1.14494.0/img/platforms/expo.svg',
        },
        {
          title: 'Flutter',
        ...
        },
        {
          ...
          img: 'https://cdn2.auth0.com/docs-v2/1.14494.0/img/platforms/ionic.svg',
        },
        {
        ...
        },
        {
          ...
          img: 'https://cdn2.auth0.com/docs-v2/1.14494.0/img/platforms/apple.svg',
        },
        {
          title: 'MAUI',
        ...
        },
        {
          ...
          img: 'https://cdn2.auth0.com/docs-v2/1.14494.0/img/platforms/windows.svg',
        },
        {
          title: 'WPF / Winforms',
        ...
        },
        {
          ...
          img: 'https://cdn2.auth0.com/docs-v2/1.14494.0/img/platforms/xamarin.svg',
        },
      ],
    },
    {
      ...
      cards: [
        ...
        },
        {
          ...
          img: 'https://cdn2.auth0.com/docs-v2/1.14494.0/img/platforms/django.svg',
        },
        {
          title: 'Go API',
        ...
        },
        {
          ...
          img: 'https://cdn2.auth0.com/docs-v2/1.14494.0/img/platforms/nodejs.svg',
        },
        {
          title: 'PHP API',
