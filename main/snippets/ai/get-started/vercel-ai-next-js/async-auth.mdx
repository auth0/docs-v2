import { Prerequisites } from "/snippets/ai/get-started/prerequisites/async-auth.jsx";
...
<Frame>
  <img src="/docs/images/ai/async_auth_diagram.png" alt="CIBA sequence diagram" />
</Frame>
...
If you want to use an API, it must be [registered with Auth0](/docs/get-started/apis) and have a valid audience.
...
You can ask the AI agent to buy a product, for example, "Buy an XYZ phone." Now, look for a push notification from the [Auth0 Guardian app](/docs/secure/multi-factor-authentication/auth0-guardian) or your custom app integrated with the [Auth0 Guardian SDK](/docs/secure/multi-factor-authentication/auth0-guardian) on your mobile device. Once you approve the notification, you should see the tool being executed and a response from the agent.
