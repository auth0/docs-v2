import { Prerequisites } from "/snippets/ai/get-started/prerequisites/user-authentication.jsx";
...
<Frame>
  ![Auth0 login screen](/docs/images/ai/user_authentication_quickstart_login_screen.png)
</Frame>
