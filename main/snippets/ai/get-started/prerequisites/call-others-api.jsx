...
export const Prerequisites = ({
  ...
  steps.push(
    <Step key="my-account-api" title="Configure My Account API">
      The Connected Accounts flow uses the <a href="/docs/manage-users/my-account-api" target="_blank">My Account API</a> to create and manage connected accounts for a user across supported external providers.<br/><br/>
      ...
      <ul>
        ...
        <li>Once activated, select <strong>Auth0 My Account API</strong> and then select the <strong>Application Access</strong> tab.
          <ul>
            <li>Find your client application and select <strong>Edit</strong> to configure its <a href="/docs/get-started/apis/api-access-policies-for-applications" target="_blank">application access policies</a>.</li>
            <li>Select <strong>User Access</strong> and under <strong>Authorization</strong>, select <strong>Authorized</strong>.</li>
            <li>For the permissions, select <strong>All</strong> the <a href="/docs/manage-users/my-account-api#scope" target="_blank">Connected Accounts scopes</a> for the application.</li>
            <li>Select <strong>Save</strong>. This creates a <a href="/docs/get-started/applications/application-access-to-apis-client-grants" target="_blank">client grant</a> that allows your client application to access the My Account API with the Connected Accounts scopes on the user’s behalf.</li>
          </ul>
        </li>
  ...
  steps.push(<Step key="mrrt-policy" title="Define a Multi-Resource Refresh Token policy for your Application">
      After your web application has been granted access to the My Account API, you will also need to leverage the <a href="/docs/secure/tokens/refresh-tokens/multi-resource-refresh-token" target="_blank">Multi-Resource Refresh Token</a> feature, which enables the refresh token delivered to your application to also obtain an access token to call the My Account API. <br/><br/>
      You can quickly define a <a href="/docs/secure/tokens/refresh-tokens/multi-resource-refresh-token/configure-and-implement-multi-resource-refresh-token" target="_blank">refresh token policy</a> for your application to use when requesting access tokens for the My Account API by doing the following:
      <ul>
