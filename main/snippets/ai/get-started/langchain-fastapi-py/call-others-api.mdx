...
Use the [Auth0 AI SDK for LangChain](https://github.com/auth0/auth0-ai-js/tree/main/packages/ai-langchain) to get an access token for the [Google Social Connection](/ai/docs/connections/google) using [Token Vault](/docs/secure/call-apis-on-users-behalf/token-vault):
