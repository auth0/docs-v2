import { Prerequisites } from "/snippets/ai/get-started/prerequisites/auth-for-rag.jsx";
...
import SetupFGAStore from "/snippets/ai/get-started/common/setup-fga-store.mdx";
