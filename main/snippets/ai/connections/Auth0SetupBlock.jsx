  ...
  return (
    <>
      <ol>
        ...
        <li>
          Once you have created your {providerName} social connection, <a href="/docs/authenticate/identity-providers/test-connections">test your connection</a> to ensure the setup is working correctly before using it in your application.
        </li>
      </ol>
    </>
  );
