    ...
    links: [
      {
        header: "開発者",
        items: [
          { label: "開発者ハブ", href: "https://developer.auth0.com" },
          { label: "コードサンプルとガイド", href: "https://developer.auth0.com/resources" },
          { label: "Zero Index ニュースレター", href: "https://auth0.com/blog/newsletter" },
          { label: "ブログ", href: "https://auth0.com/blog" },
          { label: "変更履歴", href: "https://auth0.com/changelog" }
        ]
      },
      {
        header: "ドキュメント",
        items: [
          { label: "ドキュメント", href: "https://auth0.com/docs" },
          { label: "クイックスタート", href: "https://auth0.com/docs/quickstarts" },
          { label: "API", href: "https://auth0.com/docs/api" },
          { label: "SDK ライブラリ", href: "https://auth0.com/docs/libraries" },
          { label: "学習", href: "https://auth0.com/learn" },
          { label: "IAM (CIAM) 入門", href: "https://auth0.com/intro-to-iam" },
          { label: "レポート", href: "https://auth0.com/resources/whitepapers" },
          { label: "ウェビナー", href: "https://auth0.com/resources/webinars" }
        ]
      },
      {
        header: "サポートセンター",
        items: [
          { label: "コミュニティ", href: "https://community.auth0.com" },
          { label: "ヘルプ", href: "https://support.auth0.com" },
          { label: "よくある質問", href: "https://auth0.com/docs/troubleshoot" },
      ...
      },
      {
        header: "会社情報",
        items: [
          { label: "お客様事例", href: "https://auth0.com/customers" },
          { label: "コンプライアンス", href: "https://auth0.com/security" },
          { label: "パートナー", href: "https://auth0.com/partners" },
          { label: "採用情報", href: "https://www.okta.com/company/careers" },
          { label: "Okta + Auth0", href: "https://www.okta.com/okta-and-auth0" },
          { label: "会社概要", href: "https://auth0.com/about" },
          { label: "稼働状況", href: "https://status.auth0.com/" },
          { label: "法的情報", href: "https://www.okta.com/legal/" },
          { label: "プライバシー", href: "https://www.okta.com/legal/privacy-policy/" },
          { label: "利用規約", href: "https://www.okta.com/legal/terms-of-service/" },
          { label: "プライバシー設定", href: "https://auth0.com/your-privacy-choices" }
        ]
      }
    ]
  }
      ...
      <div className="flex w-full flex-col gap-12 justify-between px-8 py-16 md:py-20 lg:py-28 max-w-[984px] z-0">
        <div className="flex flex-col md:flex-row gap-8 justify-between min-h-[76px]">
          ...
          <div className="flex md:flex-col justify-between items-center md:items-start min-w-16 md:min-w-20 lg:min-w-48 md:gap-y-24">
            <a href="/">
              <span className="sr-only">Auth0 Docs ホームページ</span>
