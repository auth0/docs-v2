    ...
    return Column(
      ...
      children: <Widget>[
        if (_credentials == null)
          ElevatedButton(
              onPressed: () async {
                // Utiliser une URL de rappel Universal Link sur iOS 17.4+ / macOS 14.4+
          ...
          Column(
            children: [
              ...
              ElevatedButton(
                  onPressed: () async {
                    // Utiliser une URL de déconnexion Universal Link sur iOS 17.4+ / macOS 14.4+
                    // useHTTPS est ignoré sur Android
