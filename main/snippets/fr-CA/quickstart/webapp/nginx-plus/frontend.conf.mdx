...
server {
    ...
    location / {
        ...
        # Les utilisateurs authentifiés avec succès sont acheminés par proxy vers le serveur principal,
        ...
        proxy_pass http://my_backend; # Le site/l'application du serveur principal
