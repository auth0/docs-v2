    ...
    >
      <div className="w-[min(860px,90vw)] text-center px-0 py-2 md:px-6 md:py-12">
        ...
        <div className="flex justify-center rounded-3xl overflow-hidden shadow-lg mt-4">
          {/* Bannière mobile claire (< 420px, mode clair) */}
          <img
            noZoom
            src="/docs/images/home/banner-mobile.svg"
            alt="Bannière de la documentation d’Auth0"
            className="block w-full h-auto sm:hidden"
          />

          {/* Bannière pour ordinateur claire (>= 420px, mode clair) */}
          <img
            noZoom
          ...
          />
          {/* Bannière pour ordinateur sombre (>= 420px, mode sombre) */}
          <img
            noZoom
            src="/docs/images/home/banner-dark.svg"
            alt="Bannière de la documentation d’Auth0 (sombre)"
...
export const ProductGrid = () => {
  const products = [
    ...
    { label: "Auth0 pour les agents d’IA", href: "https://auth0.com/ai" },
  ];
  ...
  const items = [
    {
      ...
      desc: "Cours complet conçu autour des principes fondamentaux de l’identité.",
    ...
    {
      title: "Communauté",
      desc: "Joignez-vous à la communauté pour poser des questions, soumettre des suggestions et donner votre avis sur le produit.",
    ...
    {
      title: "Assistance",
      desc: "Obtenez de l’assistance pour votre implémentation Auth0.",
