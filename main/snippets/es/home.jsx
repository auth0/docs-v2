    ...
    >
      <div className="w-[min(860px,90vw)] text-center px-0 py-2 md:px-6 md:py-12">
        ...
        <span className="mt-4 mb-10 text-center text-black/50 max-w-2xl mx-auto dark:text-white text-xl tracking-tight">
          Explora el código de ejemplo, los artículos, los tutoriales
        ...
        <div className="flex justify-center rounded-3xl overflow-hidden shadow-lg mt-4">
          ...
          <img
            ...
            alt="Banner de documentación de Auth0"
          ...
          <img
            ...
            alt="Banner de documentación de Auth0 (oscuro)"
...
export const ProductGrid = () => {
  const products = [
    ...
    {
      label: "Autorización granular",
      href: "https://auth0.com/fine-grained-authorization",
    },
    { label: "Auth0 para agentes de IA", href: "https://auth0.com/ai" },
  ];
...
export const LearnBasicsGrid = () => {
  const items = [
    ...
    {
      title: "Recetarios",
      desc: "Colección de código abierto con ejemplos y guías.",
    ...
    {
      title: "Comunidad",
      desc: "Únete a la comunidad para hacer preguntas, sugerencias y compartir comentarios sobre el producto.",
    ...
    {
      title: "Soporte",
      desc: "Obtén ayuda para tu implementación de Auth0.",
