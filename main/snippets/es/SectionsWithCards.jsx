export const SectionsWithCards = ({ sections }) => {
  ...
  const Card = ({ item }) => {
    ...
    const tertiaryLabel = quickstart ? "Quickstart" : docs ? "Documentación" : ""
    ...
    return (
        ...
        <div className="px-5 md:px-6 pt-5 md:pt-6 pb-4">
          <div className="flex items-start justify-between gap-4">
            <div className="flex items-center gap-4 min-w-0">
              {item?.logo && <img noZoom src={item.logo} alt={title} className="!my-0 w-10 h-10 object-contain shrink-0" />}

              <div className="min-w-0">
                <h4 className="text-lg md:text-xl font-semibold text-gray-900 dark:text-white truncate !my-0">{title}</h4>
            ...
            <div className="flex flex-col items-end gap-1 shrink-0">
              ...
              {!!date && <span className="text-sm text-gray-500 dark:text-gray-400">el {date.replace(/^on\s+/i, "")}</span>}
            </div>
          </div>
        </div>
      ...
      "
              ...
              >
                ...
                <span className="leading-none">Aplicación de muestra</span>
              </a>
            )}
    ...
    <main className="w-full flex justify-center px-6 py-12">
      <div className="w-full max-w-[1400px]">
          ...
          <div className="w-full">
            <div
              className="
                ...
                transition-colors
              "
              aria-label="Busca tu tecnología"
            >
        ...
        {filteredSections.length === 0 ? (
          <p className="text-gray-600 dark:text-gray-400">No se encontraron resultados para "{query}".</p>
        ) : (
          ...
          <div className="libraries_cards flex items-center justify-between w-full">
            ...
            {tertiary && (
              <a
                ...
                style={{ borderBottom: "none !important" }}
              >
                {tertiaryLabel === "Quickstart" ? <Icon icon="play" className="w-4 h-4 shrink-0" /> : <Icon icon="file-lines" className="w-4 h-4 shrink-0" />}
                <span className="leading-none">{tertiaryLabel}</span>
              </a>
            )}
          </div>
...
export const SectionCard = ({ item }) => {
  ...
  const tertiary = quickstart || docs
  const tertiaryLabel = quickstart ? "Quickstart" : docs ? "Comenzar" : ""
      ...
      <div className="px-4 md:px-5 pt-4 md:pt-5 pb-3">
        <div className="flex items-start justify-between gap-3">
          ...
          <div className="flex flex-col items-end gap-0.5 shrink-0">
            ...
            {!!date && <span className="mr-[5px] !text-xs font-medium text-gray-500 dark:text-gray-400">el {date.replace(/^on\s+/i, "")}</span>}
          </div>
        </div>
      </div>
          ...
          <div className="libraries_cards flex items-center w-full gap-5">
            ...
            {sample && (
              ...
              >
                ...
                <span className="w-full">Aplicación de ejemplo</span>
              </a>
            )}
          </div>
