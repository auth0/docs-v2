    ...
    return Column(
      ...
      children: <Widget>[
        if (_credentials == null)
          ElevatedButton(
              onPressed: () async {
                // Usa una URL de callback de Universal Link en iOS 17.4+ / macOS 14.4+
          ...
          Column(
            children: [
              ...
              ElevatedButton(
                  onPressed: () async {
                    // Usa una URL de cierre de sesión de Universal Link en iOS 17.4+ / macOS 14.4+
                    // useHTTPS se ignora en Android
