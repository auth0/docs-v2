...
public class LoginServlet extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        // URL donde la aplicación recibirá el authorization code (p. ej., http://localhost:3000/callback)
        ...
        // Crea la URL de autorización a la que redirigir al usuario para iniciar el flujo de autenticación.
