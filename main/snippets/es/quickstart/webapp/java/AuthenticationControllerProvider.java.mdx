---
title: AuthenticationControllerProvider.java
---
...
class AuthenticationControllerProvider {
    ...
    // si múltiples hilos pueden llamar a esto, sincronice este método y considere el doble bloqueo
    static AuthenticationController getInstance(ServletConfig config) throws UnsupportedEncodingException {
        if (INSTANCE == null) {
            ...
            // JwkProvider requerido para tokens RS256. Si usa HS256, no lo utilice.
