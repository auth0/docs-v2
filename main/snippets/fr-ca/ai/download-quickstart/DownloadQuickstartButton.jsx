export const DownloadQuickstartButton = ({
  ...
  const downloadSample = () => {
    ...
    window.open(downloadUrl, '_blank'); // Ouvrir dans un nouvel onglet pour que l’utilisateur reste sur la page de documentation, même en cas d’erreur
  ...
  return (
    <div className="download-button-container">
      <button
        ...
        aria-label={`Télécharger l’exemple de code ${category} ${framework}`}
      >
        {isDownloading ? (
          <>
            <svg 
