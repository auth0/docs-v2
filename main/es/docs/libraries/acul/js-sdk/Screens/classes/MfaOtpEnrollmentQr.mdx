...
description: "Describe todas las propiedades y los métodos disponibles para personalizar la pantalla `mfa-otp-enrollment-qr` de Universal Login."
---
...
<Frame>
  <img style={{maxHeight:"400px"}} src="/docs/images/cdy7uua7fh8z/xgACud9b5L3UQ6OKH5rf8/8c3cce8d90c0b9d2162e2441df85bb01/Screenshot_2025-03-26_at_00.00.27.png" alt="QR de inscripción de MFA OTP de ACUL" />
</Frame>
...
<ParamField body="continue" type="Promise<void>">
  ...
  **Parámetros del método**
  ...
  <Expandable title="Parámetros">
    <ParamField body="options">
      [MfaOtpEnrollmentQrContinueOptions](/es/docs/libraries/acul/js-sdk/Screens/interfaces/MfaOtpEnrollmentQrContinueOptions).
    </ParamField>
