...
description: "Describe todas las propiedades y los métodos disponibles para personalizar la pantalla `mfa-enroll-result` de Universal Login."
---

La clase MfaEnrollResult implementa la funcionalidad de la pantalla `mfa-enroll-result`. Esta pantalla muestra el resultado de la inscripción en un factor de MFA.

<Frame>
  <img style={{maxHeight:"400px"}} src="/docs/images/cdy7uua7fh8z/lfXmpkRzf0XoXV12vYMe9/a426e0cce6d405a0314a59e79cb4f918/Screenshot_2025-02-20_at_17.10.00.png" alt="Resultado de inscripción en MFA de ACUL" />
</Frame>
...
Cree una instancia del administrador de la pantalla de resultado de inscripción en MFA:
...
<ParamField body="client" type={<span><a href="/es/docs/libraries/acul/js-sdk/Screens/interfaces/ClientMembers">ClientMembers</a></span>}>
  Proporciona la configuración del cliente, como `id`, `name` y `logoUrl`, para la pantalla `mfa-enroll-result`.
</ParamField>
...
<ParamField body="screen" type={<span><a href="/es/docs/libraries/acul/js-sdk/Screens/interfaces/ScreenMembersOnMfaEnrollResult">ScreenMembersOnMfaEnrollResult</a></span>}>
...
<ParamField body="untrustedData" type={<span><a href="/es/docs/libraries/acul/js-sdk/Screens/interfaces/UntrustedDataMembers">UntrustedDataMembers</a></span>}>
  Contiene datos no confiables que se pasan al SDK, como la entrada del usuario durante la inscripción en MFA.
</ParamField>
