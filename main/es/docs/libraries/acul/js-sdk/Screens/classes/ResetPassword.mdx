---
title: "ResetPassword"
description: "Describe todas las propiedades y los métodos disponibles para personalizar la pantalla `reset-password` de Universal Login."
---
  ...
  **Parámetros del método**
  ...
  <Expandable title="Parámetros">
    ...
    <ParamField body="password-reset" type="string" required>
      La nueva contraseña introducida por el usuario.
    </ParamField>
  ...
  **Parámetros del método**
  ...
  <Expandable title="Parámetros">
    <ParamField body="password" type="string" required>
      La cadena de contraseña que se va a validar.
    </ParamField>
  </Expandable>
</ParamField>