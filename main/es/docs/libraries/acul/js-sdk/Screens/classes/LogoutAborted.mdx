---
title: "LogoutAborted"
description: "Describe las propiedades y métodos disponibles para personalizar la pantalla `logout-aborted` de Universal Login."
---
...
Cree una instancia del administrador de la pantalla LogoutAborted:
...
<ParamField body="client" type={<span><a href="/es/docs/libraries/acul/js-sdk/Screens/interfaces/ClientMembers">ClientMembers</a></span>}>
  Proporciona configuraciones del cliente, como `id`, `name` y `logoUrl`, para la pantalla `logout-aborted`.
</ParamField>
