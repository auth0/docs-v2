...
<Frame>
  <img style={{maxHeight:"400px"}} src="/docs/images/cdy7uua7fh8z/4DKgjU2dGw0mpLJKGfGhp0/470b29266da87f9bfc3e7eef55069620/Login_Passwordless_Email_Code.png" alt="Inicio de sesión sin contraseña con correo electrónico y code" />
</Frame>
  ...
  **Parámetros del método**
  ...
  <Expandable title="Parámetros">
    ...
    <ParamField body="onStatusChange?" type={<span><a href="/es/docs/libraries/acul/js-sdk/Screens/type-aliases/OnStatusChangeCallback">OnStatusChangeCallback</a></span>}>
      Función callback que se invoca cada vez que cambia el estado del reenvío; devuelve los segundos restantes e indica si la funcionalidad de reenvío está deshabilitada en ese momento.
    </ParamField>

    <ParamField body="onTimeout?" type="() => void">
      Función callback que se invoca cuando expira el período de espera y el reenvío vuelve a estar disponible.
    </ParamField>
  </Expandable>
</ParamField>
  ...
  **Parámetros del método**
  ...
  <Expandable title="Parámetros">
    ...
    <ParamField body="captcha?" type="string">
      El code de captcha o la respuesta del proveedor de captcha. Esta propiedad es obligatoria si tu inquilino de Auth0 tiene habilitada la [Detección de bots](/es/docs/secure/attack-protection/bot-detection).
    </ParamField>
  ...
  **Parámetros del método**
  ...
  <Expandable title="Parámetros">
    ...
    <ParamField body="connection" type="string" required>
      El nombre de la conexión a la que quieres cambiar. Usa `'email'` o `'sms'` para sin contraseña, o el nombre de una conexión de base de datos para la autenticación basada en contraseña.
    </ParamField>
