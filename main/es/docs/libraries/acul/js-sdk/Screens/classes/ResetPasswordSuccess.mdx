...
description: "Describe todas las propiedades y los métodos disponibles para personalizar la pantalla `reset-password-success` de Universal Login."
---

La clase ResetPasswordSuccess implementa la funcionalidad de la pantalla `reset-password-success`. Esta pantalla confirma al usuario que su contraseña se restableció correctamente.
...
Cree una instancia del administrador de la pantalla ResetPasswordSuccess:
...
<ParamField body="client" type={<span><a href="/es/docs/libraries/acul/js-sdk/Screens/interfaces/ClientMembers">ClientMembers</a></span>}>
  Proporciona configuraciones relacionadas con el cliente, como `id`, `name` y `logoUrl`, para la pantalla `reset-password-success`.
</ParamField>
...
<ParamField body="screen" type={<span><a href="/es/docs/libraries/acul/js-sdk/Screens/interfaces/ScreenMembers">ScreenMembers</a></span>}>
  Contiene detalles específicos de la pantalla `reset-password-success`, incluida su configuración y contexto.
</ParamField>
...
<ParamField body="transaction" type={<span><a href="/es/docs/libraries/acul/js-sdk/Screens/interfaces/TransactionMembers">TransactionMembers</a></span>}>
  Proporciona datos específicos de la transacción para la pantalla `reset-password-success`, como identificadores activos y estados de flujo.
</ParamField>
...
<ParamField body="untrustedData" type={<span><a href="/es/docs/libraries/acul/js-sdk/Screens/interfaces/UntrustedDataMembers">UntrustedDataMembers</a></span>}>
  Contiene datos no confiables que se pasan al SDK, como la entrada del usuario durante el flujo de restablecimiento de contraseña.
</ParamField>
