...
description: "Describe todas las propiedades y los métodos disponibles para personalizar la pantalla `interstitial-captcha` de Universal Login."
---

La clase InterstitialCaptcha implementa la funcionalidad de la pantalla `interstitial-captcha`. Esta pantalla solicita al usuario que complete un captcha durante el flujo de autenticación.
...
Cree una instancia del gestor de la pantalla InterstitialCaptcha:
...
<ParamField body="client" type={<span><a href="/es/docs/libraries/acul/js-sdk/Screens/interfaces/ClientMembers">ClientMembers</a></span>}>
  Proporciona configuraciones relacionadas con el cliente, como `id`, `name` y `logoUrl`, para la pantalla `interstitial-captcha`.
</ParamField>
...
<ParamField body="screen" type={<span><a href="/es/docs/libraries/acul/js-sdk/Screens/interfaces/ScreenMembers">ScreenMembers</a></span>}>
  Contiene detalles específicos de la pantalla `interstitial-captcha`, incluida su configuración y contexto.
</ParamField>
...
<ParamField body="transaction" type={<span><a href="/es/docs/libraries/acul/js-sdk/Screens/interfaces/TransactionMembers">TransactionMembers</a></span>}>
  Proporciona datos específicos de la transacción para la pantalla `interstitial-captcha`, como identificadores activos y estados del flujo.
</ParamField>
...
<ParamField body="untrustedData" type={<span><a href="/es/docs/libraries/acul/js-sdk/Screens/interfaces/UntrustedDataMembers">UntrustedDataMembers</a></span>}>
  Gestiona datos no confiables que se pasan al SDK, como la entrada del usuario durante el flujo del desafío CAPTCHA.
</ParamField>
...
<ParamField body="submitCaptcha" type="Promise<void>">
  Este método envía la respuesta del captcha para continuar el flujo de autenticación.
