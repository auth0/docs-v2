...
description: "Describe todas las propiedades y métodos disponibles para personalizar la pantalla `passkey-enrollment-local` de Universal Login."
---
  ...
  **Parámetros del método**
  ...
  <Expandable title="Parámetros">
    ...
    <ParamField body="doNotShowAgain?" type="boolean">
      Cuando se establece en `true`, oculta la pantalla de inscripción de clave de acceso en futuras sesiones.
    </ParamField>
  </Expandable>
</ParamField>
  ...
  **Parámetros del método**
  ...
  <Expandable title="Parámetros">
    ...
    <ParamField body="language" type="string" required>
      El código de idioma o configuración regional deseado (por ejemplo, `'en'`, `'fr'`, `'es'`).
    </ParamField>
