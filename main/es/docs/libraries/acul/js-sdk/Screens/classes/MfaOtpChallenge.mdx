...
description: "Describe todas las propiedades y los métodos disponibles para personalizar la pantalla `mfa-otp-challenge` de Universal Login."
---
...
<Frame>
  <img style={{maxHeight:"400px"}} src="/docs/images/cdy7uua7fh8z/4EcKVu4uEjsNEpVcI5bW0b/e6fb47c9addc1c07f1f39516aafa5e0e/Screenshot_2025-03-26_at_00.01.07.png" alt="Pantalla de desafío OTP de MFA de ACUL" />
</Frame>
...
<ParamField body="continue" type="Promise<void>">
  ...
  **Parámetros del método**
  ...
  <Expandable title="Parámetros">
    <ParamField body="options">
      [ContinueOTPOptions](/es/docs/libraries/acul/js-sdk/Screens/interfaces/ContinueOTPOptions).
    </ParamField>
