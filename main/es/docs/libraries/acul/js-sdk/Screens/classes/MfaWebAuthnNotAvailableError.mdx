...
La clase MfaWebAuthnNotAvailableError implementa la funcionalidad de la pantalla `mfa-webauthn-not-available-error`. Esta pantalla se muestra cuando WebAuthn no está disponible o no es compatible con el dispositivo o navegador actuales del usuario.
...
Cree una instancia del administrador de la pantalla de error «MFA WebAuthn no disponible»:
...
<ParamField body="branding" type={<span><a href="/es/docs/libraries/acul/js-sdk/Screens/interfaces/BrandingMembers">BrandingMembers</a></span>}>
  Proporciona configuración de marca, como el tema y otros ajustes de marca.
</ParamField>
...
<ParamField body="client" type={<span><a href="/es/docs/libraries/acul/js-sdk/Screens/interfaces/ClientMembers">ClientMembers</a></span>}>
  Proporciona configuración relacionada con el cliente, como `id`, `name` y `logoUrl`, para la pantalla `mfa-webauthn-not-available-error`.
</ParamField>
...
<ParamField body="screen" type={<span><a href="/es/docs/libraries/acul/js-sdk/Screens/interfaces/ScreenMembers">ScreenMembers</a></span>}>
  Contiene detalles específicos de la pantalla `mfa-webauthn-not-available-error`, incluida su configuración y contexto.
</ParamField>
...
<ParamField body="transaction" type={<span><a href="/es/docs/libraries/acul/js-sdk/Screens/interfaces/TransactionMembers">TransactionMembers</a></span>}>
  Proporciona datos específicos de la transacción para la pantalla `mfa-webauthn-not-available-error`, como identificadores activos y estados del flujo.
</ParamField>
...
<ParamField body="untrustedData" type={<span><a href="/es/docs/libraries/acul/js-sdk/Screens/interfaces/UntrustedDataMembers">UntrustedDataMembers</a></span>}>
  Contiene datos no confiables que se pasan al SDK, como la entrada del usuario durante el manejo de errores cuando MFA WebAuthn no está disponible.
</ParamField>
