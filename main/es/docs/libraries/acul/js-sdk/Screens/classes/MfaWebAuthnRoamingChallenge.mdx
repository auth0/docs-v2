...
description: "Describe todas las propiedades y los métodos disponibles para personalizar la pantalla `mfa-webauthn-roaming-challenge` de Universal Login."
---
...
<ParamField body="reportWebAuthnError" type="Promise<void>">
  ...
  **Parámetros del método**
  ...
  <Expandable title="Parámetros">
    <ParamField body="options">
      [MfaWebAuthnRoamingChallengeReportErrorOptions](/es/docs/libraries/acul/js-sdk/Screens/interfaces/MfaWebAuthnRoamingChallengeReportErrorOptions).
    </ParamField>
  ...
  **Parámetros del método**
  ...
  <Expandable title="Parámetros">
    ...
    <ParamField body="rememberDevice?" type="boolean">
      Cuando es `true`, recuerda este navegador para futuros desafíos de MFA. Solo se aplica si `screen.showRememberDevice` es `true`.
    </ParamField>
  </Expandable>
</ParamField>