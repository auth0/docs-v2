...
description: "Describe todas las propiedades y los métodos disponibles para personalizar la pantalla `reset-password-mfa-voice-challenge` de Universal Login."
---
...
<ParamField body="continue" type="Promise<void>">
  ...
  **Parámetros del método**
  ...
  <Expandable title="Parámetros">
    <ParamField body="options">
      [ResetPasswordMfaVoiceChallengeContinueOptions](/es/docs/libraries/acul/js-sdk/Screens/interfaces/ResetPasswordMfaVoiceChallengeContinueOptions).
    </ParamField>
  ...
  **Parámetros del método**
  ...
  <Expandable title="Parámetros">
    ...
    <ParamField body="onTimeout?" type="() => void">
      Función de devolución de llamada que se invoca cuando vence el período de espera y el reenvío vuelve a estar disponible.
    </ParamField>
  </Expandable>
</ParamField>
