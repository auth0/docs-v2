...
description: "Describe todas las propiedades y métodos disponibles para personalizar la pantalla `mfa-country-codes` de Universal Login."
---

La clase MfaCountryCodes implementa la funcionalidad de la pantalla `mfa-country-codes`. Esta pantalla permite a los usuarios seleccionar un código de país para verificar un número de teléfono con MFA.

<Frame>
  <img style={{maxHeight:"400px"}} src="/docs/images/cdy7uua7fh8z/7hp8LeL9cbS3nbxw8wTuqK/3c862b1c47ae18fb43f22f55ea4d695a/Screenshot_2025-02-19_at_13.23.44.png" alt="ACUL MFA Códigos de país" />
</Frame>
...
Cree una instancia del administrador de la pantalla de códigos de país para MFA:
...
<ParamField body="client" type={<span><a href="/es/docs/libraries/acul/js-sdk/Screens/interfaces/ClientMembers">ClientMembers</a></span>}>
  Proporciona configuraciones relacionadas con el cliente, como `id`, `name` y `logoUrl`, para la pantalla `mfa-country-codes`.
</ParamField>
...
<ParamField body="screen" type={<span><a href="/es/docs/libraries/acul/js-sdk/Screens/interfaces/ScreenMembersOnMfaCountryCodes">ScreenMembersOnMfaCountryCodes</a></span>}>
  Contiene detalles específicos de la pantalla `mfa-country-codes`, incluida su configuración y contexto.
</ParamField>
...
<ParamField body="transaction" type={<span><a href="/es/docs/libraries/acul/js-sdk/Screens/interfaces/TransactionMembers">TransactionMembers</a></span>}>
  Proporciona datos específicos de la transacción para la pantalla `mfa-country-codes`, como identificadores activos y estados del flujo.
</ParamField>
...
<ParamField body="untrustedData" type={<span><a href="/es/docs/libraries/acul/js-sdk/Screens/interfaces/UntrustedDataMembers">UntrustedDataMembers</a></span>}>
  Gestiona datos no confiables que se pasan al SDK, como la entrada del usuario durante la selección del código de país para MFA.
</ParamField>
...
<ParamField body="selectCountryCode" type="Promise<void>">
  Este método selecciona un código de país de entre las opciones disponibles.
  ...
  **Parámetros del método**
  ...
  <Expandable title="Parámetros">
    <ParamField body="options">
      [SelectCountryCodeOptions](/es/docs/libraries/acul/js-sdk/Screens/interfaces/SelectCountryCodeOptions).
    </ParamField>

    <ParamField body="country_code" type="string" required>
      El código de país (por ejemplo, `'US'`, `'GB'`).
    </ParamField>

    <ParamField body="phone_prefix" type="string" required>
      El prefijo telefónico (por ejemplo, `'+1'`, `'+44'`).
    </ParamField>
  </Expandable>
</ParamField>