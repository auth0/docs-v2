---
title: "RedeemTicket"
description: "Describe todas las propiedades y los métodos disponibles para personalizar la pantalla `redeem-ticket` de Universal Login."
---
...
Crea una instancia del gestor de pantalla RedeemTicket:
...
<ParamField body="screen" type={<span><a href="/es/docs/libraries/acul/js-sdk/Screens/interfaces/ScreenMembers">ScreenMembers</a></span>}>
  Contiene detalles específicos de la pantalla `redeem-ticket`, incluida su configuración y su contexto.
</ParamField>
...
<ParamField body="untrustedData" type={<span><a href="/es/docs/libraries/acul/js-sdk/Screens/interfaces/UntrustedDataMembers">UntrustedDataMembers</a></span>}>
  Gestiona datos no confiables que se pasan al SDK, como la entrada del usuario durante el flujo de canje de tickets.
</ParamField>
  ...
  **Parámetros del método**
  ...
  <Expandable title="Parámetros">
    ...
    <ParamField body="language" type="string" required>
      El código de idioma de la configuración regional deseada (por ejemplo, `'en'`, `'fr'`, `'es'`).
    </ParamField>
...
<ParamField body="getErrors" type={<span><a href="/es/docs/libraries/acul/js-sdk/Screens/interfaces/Error">Error</a>[]</span>}>
  Este método recupera la lista de errores de transacción del contexto, o una lista vacía si no hay ninguno.
</ParamField>