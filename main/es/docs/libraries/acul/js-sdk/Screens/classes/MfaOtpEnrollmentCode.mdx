...
description: "Describe todas las propiedades y los métodos disponibles para personalizar la pantalla `mfa-otp-enrollment-code` de Universal Login."
---
...
<Frame>
  <img style={{maxHeight:"400px"}} src="/docs/images/cdy7uua7fh8z/5x7zKvx9RtgMzJqkIgvE5Z/17d50fc705c6e0bf0bd75444d2b486ff/Screenshot_2025-03-26_at_00.01.21.png" alt="Código de inscripción OTP para MFA de ACUL" />
</Frame>
...
<ParamField body="continue" type="Promise<void>">
  ...
  **Parámetros del método**
  ...
  <Expandable title="Parámetros">
    <ParamField body="options">
      [MfaOtpContinueOptions](/es/docs/libraries/acul/js-sdk/Screens/interfaces/MfaOtpContinueOptions).
    </ParamField>
