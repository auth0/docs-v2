...
description: "Describe todas las propiedades y los métodos disponibles para personalizar la pantalla `mfa-detect-browser-capabilities` de Universal Login."
---

La clase MfaDetectBrowserCapabilities implementa la funcionalidad de la pantalla `mfa-detect-browser-capabilities`. Esta pantalla detecta las capacidades del navegador para los métodos de autenticación con MFA.
...
Cree una instancia del administrador de la pantalla MFA Detect Browser Capabilities:
...
<ParamField body="untrustedData" type={<span><a href="/es/docs/libraries/acul/js-sdk/Screens/interfaces/UntrustedDataMembers">UntrustedDataMembers</a></span>}>
  Gestiona datos no confiables que se pasan al SDK, como la entrada del usuario durante la detección de capacidades del navegador para MFA.
</ParamField>
...
<ParamField body="getErrors" type={<span><a href="/es/docs/libraries/acul/js-sdk/Screens/interfaces/Error">Error</a>[]</span>}>
  Este método obtiene la lista de errores de la transacción desde el contexto, o una lista vacía si no hay ninguno.
</ParamField>