...
La clase BruteForceProtectionUnblockSuccess implementa la funcionalidad de la pantalla `brute-force-protection-unblock-success`. Esta pantalla se muestra después de que se envía correctamente una solicitud de desbloqueo de cuenta mediante la protección contra ataques de fuerza bruta.

<Frame>
  <img style={{maxHeight:"400px"}} src="https://mintlify.s3.us-west-1.amazonaws.com/auth0/docs/images/cdy7uua7fh8z/ACUL/brute-force-protection-unblock-success.png" alt="ACUL Protección contra ataques de fuerza bruta: desbloqueo correcto" />
</Frame>
...
<ParamField body="client" type={<span><a href="/es/docs/libraries/acul/js-sdk/Screens/interfaces/ClientMembers">ClientMembers</a></span>}>
  Proporciona configuraciones relacionadas con el cliente, como `id`, `name` y `logoUrl`, para la pantalla `brute-force-protection-unblock-success`.
</ParamField>
...
<ParamField body="screen" type={<span><a href="/es/docs/libraries/acul/js-sdk/Screens/interfaces/ScreenMembersOnBruteForceProtectionUnblockSuccess">ScreenMembersOnBruteForceProtectionUnblockSuccess</a></span>}>
...
<ParamField body="untrustedData" type={<span><a href="/es/docs/libraries/acul/js-sdk/Screens/interfaces/UntrustedDataMembers">UntrustedDataMembers</a></span>}>
  Gestiona los datos no confiables que se pasan al SDK, como los datos introducidos por el usuario durante el flujo de desbloqueo de la cuenta.
</ParamField>
