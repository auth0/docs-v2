...
description: "Describe las propiedades y métodos disponibles para personalizar la pantalla `reset-password-mfa-email-challenge` de Universal Login."
---
...
<ParamField body="screen" type={<span><a href="/es/docs/libraries/acul/js-sdk/Screens/interfaces/ScreenMembersOnResetPasswordMfaEmailChallenge">ScreenMembersOnResetPasswordMfaEmailChallenge</a></span>}>
...
<ParamField body="continue" type="Promise<void>">
  ...
  **Parámetros del método**
  ...
  <Expandable title="Parámetros">
    <ParamField body="options">
      [ContinueOptions](/es/docs/libraries/acul/js-sdk/Screens/interfaces/ContinueOptions).
    </ParamField>
    ...
    <ParamField body="rememberDevice?" type="boolean">
      Indica si se debe recordar el dispositivo para futuros desafíos de MFA.
    </ParamField>
  </Expandable>
</ParamField>
  ...
  **Parámetros del método**
  ...
  <Expandable title="Parámetros">
    ...
    <ParamField body="onStatusChange?" type={<span><a href="/es/docs/libraries/acul/js-sdk/Screens/type-aliases/OnStatusChangeCallback">OnStatusChangeCallback</a></span>}>
      Función que se invoca cada vez que cambia el estado del reenvío; devuelve los segundos restantes y si la funcionalidad de reenvío está deshabilitada en ese momento.
    </ParamField>

    <ParamField body="onTimeout?" type="void">
      Función que se ejecuta cuando expira el tiempo de espera y el botón de reenvío pasa a estar disponible.
    </ParamField>
  </Expandable>
</ParamField>
