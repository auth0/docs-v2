...
description: "Describe todas las propiedades y métodos disponibles para personalizar la pantalla `device-code-confirmation` de Universal Login."
---

La clase DeviceCodeConfirmation implementa la funcionalidad de la pantalla `device-code-confirmation`. Esta pantalla se muestra cuando el usuario necesita confirmar o cancelar la activación del código de dispositivo.
...
Cree una instancia del administrador de la pantalla DeviceCodeConfirmation:
...
<ParamField body="client" type={<span><a href="/es/docs/libraries/acul/js-sdk/Screens/interfaces/ClientMembers">ClientMembers</a></span>}>
  Proporciona configuraciones relacionadas con el cliente, como `id`, `name` y `logoUrl`, para la pantalla `device-code-confirmation`.
</ParamField>
...
<ParamField body="screen" type={<span><a href="/es/docs/libraries/acul/js-sdk/Screens/interfaces/ScreenMembersOnDeviceCodeConfirmation">ScreenMembersOnDeviceCodeConfirmation</a></span>}>
  Contiene detalles específicos de la pantalla `device-code-confirmation`, incluida su configuración y contexto.
</ParamField>
...
<ParamField body="transaction" type={<span><a href="/es/docs/libraries/acul/js-sdk/Screens/interfaces/TransactionMembers">TransactionMembers</a></span>}>
  Proporciona datos específicos de la transacción para la pantalla `device-code-confirmation`, como identificadores activos y estados del flujo.
</ParamField>
...
<ParamField body="untrustedData" type={<span><a href="/es/docs/libraries/acul/js-sdk/Screens/interfaces/UntrustedDataMembers">UntrustedDataMembers</a></span>}>
  Gestiona datos no confiables que se pasan al SDK, como la entrada del usuario durante el flujo de confirmación del código del dispositivo.
</ParamField>
...
<ParamField body="cancel" type="Promise<void>">
  Este método cancela el flujo de activación del código de dispositivo.
...
<ParamField body="confirm" type="Promise<void>">
  Este método confirma el código de dispositivo y continúa con la activación.
...
<ParamField body="getErrors" type={<span><a href="/es/docs/libraries/acul/js-sdk/Screens/interfaces/Error">Error</a>[]</span>}>
  Este método recupera el array de errores de la transacción del contexto, o un array vacío si no existe ninguno.
</ParamField>