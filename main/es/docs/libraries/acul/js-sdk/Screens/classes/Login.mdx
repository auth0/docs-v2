...
<Frame>
  <img style={{maxHeight:"400px"}} src="/docs/images/cdy7uua7fh8z/5be9XfnulShqeXa4MXfXky/f3a5dded3539d4d683a525dfb6ad8042/Screenshot_2025-01-28_at_10.49.07.png" alt="Inicio de sesión de ACUL" />
</Frame>
  ...
  **Parámetros del método**
  ...
  <Expandable title="Parámetros">
    ...
    <ParamField body="captcha?" type="string">
      El código captcha o la respuesta del proveedor de CAPTCHA. Esta propiedad es obligatoria si tu inquilino de Auth0 tiene [Bot Detection](/es/docs/secure/attack-protection/bot-detection) habilitado.
    </ParamField>
