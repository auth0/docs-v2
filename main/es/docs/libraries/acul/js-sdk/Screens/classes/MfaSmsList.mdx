...
La clase MfaSmsList implementa la funcionalidad de la pantalla `mfa-sms-list`. Esta pantalla se muestra cuando el usuario necesita seleccionar un número de teléfono inscrito para MFA por SMS.
...
Cree una instancia del administrador de la pantalla de lista de SMS para MFA:
...
<ParamField body="untrustedData" type={<span><a href="/es/docs/libraries/acul/js-sdk/Screens/interfaces/UntrustedDataMembers">UntrustedDataMembers</a></span>}>
  Gestiona los datos no confiables que se pasan al SDK, como la entrada del usuario durante la selección de la lista de SMS de MFA.
</ParamField>
...
<ParamField body="selectPhoneNumber" type="Promise<void>">
  Este método selecciona un número de teléfono de la lista de números inscritos.
