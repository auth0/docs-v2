...
description: "Describe todas las propiedades y los métodos disponibles para personalizar la pantalla `mfa-push-welcome` de Universal Login."
---
...
<ParamField body="screen" type={<span><a href="/es/docs/libraries/acul/js-sdk/Screens/interfaces/ScreenMembersOnMfaPushWelcome">ScreenMembersOnMfaPushWelcome</a></span>}>
...
<ParamField body="untrustedData" type={<span><a href="/es/docs/libraries/acul/js-sdk/Screens/interfaces/UntrustedDataMembers">UntrustedDataMembers</a></span>}>
  Gestiona los datos no confiables que se pasan al SDK, como los datos introducidos por el usuario durante la pantalla de bienvenida de MFA push.
</ParamField>
...
<ParamField body="getErrors" type={<span><a href="/es/docs/libraries/acul/js-sdk/Screens/interfaces/Error">Error</a>[]</span>}>
  Este método recupera la matriz de errores de la transacción del contexto, o una matriz vacía si no hay errores.
</ParamField>
