...
description: "Describe todas las propiedades y los métodos disponibles para personalizar la pantalla `email-verification-result` de Universal Login."
---
...
Cree una instancia del administrador de la pantalla EmailVerificationResult:
...
<ParamField body="untrustedData" type={<span><a href="/es/docs/libraries/acul/js-sdk/Screens/interfaces/UntrustedDataMembers">UntrustedDataMembers</a></span>}>
  Gestiona datos no confiables que se pasan al SDK, como la entrada del usuario durante el flujo de verificación de correo electrónico.
</ParamField>
...
<ParamField body="getErrors" type={<span><a href="/es/docs/libraries/acul/js-sdk/Screens/interfaces/Error">Error</a>[]</span>}>
  Este método devuelve el array de errores de la transacción desde el contexto, o un array vacío si no hay ninguno.
</ParamField>