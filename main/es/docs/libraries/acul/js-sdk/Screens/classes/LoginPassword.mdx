---
title: "LoginPassword"
description: "Describe todas las propiedades y métodos disponibles para personalizar la pantalla `login-password` de Universal Login."
---
...
<ParamField body="screen" type={<span><a href="/es/docs/libraries/acul/js-sdk/Screens/interfaces/ScreenMembersOnLoginPassword">ScreenMembersOnLoginPassword</a></span>}>
...
<ParamField body="transaction" type={<span><a href="/es/docs/libraries/acul/js-sdk/Screens/interfaces/TransactionMembersOnLoginPassword">TransactionMembersOnLoginPassword</a></span>}>
...
<ParamField body="federatedLogin" type="Promise<void>">
  ...
  **Parámetros del método**
  ...
  <Expandable title="Parámetros">
    <ParamField body="options">
      [FederatedLoginPayloadOptions](/es/docs/libraries/acul/js-sdk/Screens/interfaces/FederatedLoginPayloadOptions).
    </ParamField>
...
<ParamField body="login" type="Promise<void>">
  ...
  **Parámetros del método**
  ...
  <Expandable title="Parámetros">
    <ParamField body="options">
      [LoginPayloadOptions](/es/docs/libraries/acul/js-sdk/Screens/interfaces/LoginPayloadOptions).
    </ParamField>
    ...
    <ParamField body="captcha?" type="string">
      El código o la respuesta del captcha del proveedor de CAPTCHA. Esta propiedad es obligatoria si tu inquilino de Auth0 tiene habilitada la [detección de bots](/es/docs/secure/attack-protection/bot-detection).
    </ParamField>
...
<ParamField body="switchConnection" type="Promise<void>">
  ...
  **Parámetros del método**
  ...
  <Expandable title="Parámetros">
    <ParamField body="options">
      [SwitchConnectionOptionsLoginPassword](/es/docs/libraries/acul/js-sdk/Screens/interfaces/SwitchConnectionOptionsLoginPassword).
    </ParamField>

    <ParamField body="connection" type="string" required>
      El nombre de la conexión a la que se cambiará. Usa `'email'` o `'sms'` para la autenticación sin contraseña, o el nombre de una conexión de base de datos para la autenticación con contraseña.
    </ParamField>
