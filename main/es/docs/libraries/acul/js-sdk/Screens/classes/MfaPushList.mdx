---
title: "MfaPushList"
description: "Describe todas las propiedades y los métodos disponibles para personalizar la pantalla `mfa-push-list` de Universal Login."
---
...
Cree una instancia del administrador de la pantalla de listado de MFA push:
...
<ParamField body="client" type={<span><a href="/es/docs/libraries/acul/js-sdk/Screens/interfaces/ClientMembers">ClientMembers</a></span>}>
  Proporciona la configuración del cliente, como `id`, `name` y `logoUrl`, para la pantalla `mfa-push-list`.
</ParamField>
...
<ParamField body="untrustedData" type={<span><a href="/es/docs/libraries/acul/js-sdk/Screens/interfaces/UntrustedDataMembers">UntrustedDataMembers</a></span>}>
  Gestiona los datos no confiables que se pasan al SDK, como la entrada del usuario durante la pantalla de lista de MFA push.
</ParamField>
...
<ParamField body="getErrors" type={<span><a href="/es/docs/libraries/acul/js-sdk/Screens/interfaces/Error">Error</a>[]</span>}>
  Este método devuelve el array de errores de la transacción del contexto, o un array vacío si no hay ninguno.
</ParamField>
...
<ParamField body="selectMfaPushDevice" type="Promise<void>">
  ...
  **Parámetros del método**
  ...
  <Expandable title="Parámetros">
    <ParamField body="options">
      [SelectMfaPushDeviceOptions](/es/docs/libraries/acul/js-sdk/Screens/interfaces/SelectMfaPushDeviceOptions).
    </ParamField>

    <ParamField body="deviceIndex" type="number" required>
      El índice del dispositivo que se va a seleccionar de la lista de dispositivos inscritos. El índice empieza en 0.
    </ParamField>
  </Expandable>
</ParamField>