...
La clase LogoutComplete implementa la funcionalidad de la pantalla `logout-complete`. Esta pantalla se muestra cuando un usuario completa el proceso de cierre de sesión.
...
Crea una instancia del administrador de la pantalla LogoutComplete:
