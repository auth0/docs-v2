...
description: "Describe todas las propiedades y los métodos disponibles para personalizar la pantalla `reset-password-mfa-otp-challenge` de Universal Login."
---
...
<ParamField body="screen" type={<span><a href="/es/docs/libraries/acul/js-sdk/Screens/interfaces/ScreenMembersOnResetPasswordMfaOtpChallenge">ScreenMembersOnResetPasswordMfaOtpChallenge</a></span>}>
...
<ParamField body="continue" type="Promise<void>">
  ...
  **Parámetros del método**
  ...
  <Expandable title="Parámetros">
    <ParamField body="options">
      [ResetPasswordMfaOtpChallengeContinueOptions](/es/docs/libraries/acul/js-sdk/Screens/interfaces/ResetPasswordMfaOtpChallengeContinueOptions).
    </ParamField>
