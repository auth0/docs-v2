...
description: "Describe todas las propiedades y métodos disponibles para personalizar la pantalla `mfa-recovery-code-challenge` de Universal Login."
---
...
<ParamField body="continue" type="Promise<void>">
  ...
  **Parámetros del método**
  ...
  <Expandable title="Parámetros">
    <ParamField body="options">
      [MfaRecoveryCodeChallengeContinueOptions](/es/docs/libraries/acul/js-sdk/Screens/interfaces/MfaRecoveryCodeChallengeContinueOptions).
    </ParamField>
