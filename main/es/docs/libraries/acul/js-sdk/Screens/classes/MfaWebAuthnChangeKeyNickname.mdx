...
description: "Describe todas las propiedades y los métodos disponibles para personalizar la pantalla `mfa-webauthn-change-key-nickname` de Universal Login."
---
...
Cree una instancia del administrador de la pantalla para cambiar el alias de la clave de MFA WebAuthn:
...
<ParamField body="screen" type={<span><a href="/es/docs/libraries/acul/js-sdk/Screens/interfaces/ScreenMembersOnMfaWebAuthnChangeKeyNickname">ScreenMembersOnMfaWebAuthnChangeKeyNickname</a></span>}>
  Contiene detalles específicos de la pantalla `mfa-webauthn-change-key-nickname`, incluida su configuración y contexto.
</ParamField>
...
<ParamField body="untrustedData" type={<span><a href="/es/docs/libraries/acul/js-sdk/Screens/interfaces/UntrustedDataMembers">UntrustedDataMembers</a></span>}>
  Contiene datos no confiables que se pasan al SDK, como la entrada del usuario durante el cambio del apodo de la clave WebAuthn para MFA.
</ParamField>
...
<ParamField body="continueWithNewNickname" type="Promise<void>">
  Este método envía el nuevo alias de la clave de seguridad WebAuthn del usuario.
