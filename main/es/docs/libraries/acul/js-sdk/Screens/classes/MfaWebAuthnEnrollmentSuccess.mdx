...
description: "Describe todas las propiedades y métodos disponibles para personalizar la pantalla `mfa-webauthn-enrollment-success` de Universal Login."
---

La clase MfaWebAuthnEnrollmentSuccess implementa la funcionalidad de la pantalla `mfa-webauthn-enrollment-success`. Esta pantalla se muestra cuando el usuario ha inscrito correctamente una clave de seguridad WebAuthn.
...
Cree una instancia del administrador de la pantalla de éxito de inscripción de MFA WebAuthn:
...
<ParamField body="untrustedData" type={<span><a href="/es/docs/libraries/acul/js-sdk/Screens/interfaces/UntrustedDataMembers">UntrustedDataMembers</a></span>}>
  Contiene datos no confiables que se pasan al SDK, como la entrada del usuario durante la inscripción en MFA con WebAuthn.
</ParamField>
...
<ParamField body="continue" type="Promise<void>">
  Este método continúa el flujo de autenticación después de completar correctamente la inscripción en WebAuthn.
