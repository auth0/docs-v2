...
<ParamField body="screen" type={<span><a href="/es/docs/libraries/acul/js-sdk/Screens/interfaces/ScreenMembersOnLoginId">ScreenMembersOnLoginId</a></span>}>
...
<ParamField body="transaction" type={<span><a href="/es/docs/libraries/acul/js-sdk/Screens/interfaces/TransactionMembersOnLoginId">TransactionMembersOnLoginId</a></span>}>
...
<ParamField body="getLoginIdentifiers" type={<span><a href="/es/docs/libraries/acul/js-sdk/Screens/type-aliases/ScreenIdentifierType">ScreenIdentifierType</a>[] | null</span>}>
  ...
  **Parámetros del método**
  ...
  <Expandable title="Parámetros">
    ...
    <ParamField body="captcha?" type="string">
      El código o la respuesta del captcha del proveedor correspondiente. Esta propiedad es obligatoria si tu inquilino de Auth0 tiene [Bot Detection](/es/docs/secure/attack-protection/bot-detection) habilitado.
    </ParamField>
  ...
  **Parámetros del método**
  ...
  <Expandable title="Parámetros">
    <ParamField body="inputId?" type="string">
      ID opcional del elemento `<input>` del username (sin `#`). Ejemplo: `"username"`. Si se omite, el desarrollador debe asegurarse manualmente de que el elemento input tenga los atributos `autocomplete` correctos.
    </ParamField>
  </Expandable>
</ParamField>