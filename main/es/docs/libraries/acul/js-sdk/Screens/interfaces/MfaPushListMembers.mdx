...
<ParamField body="selectMfaPushDevice" type="Promise<void>">
  ...
  <Expandable title="Parámetros">
    <ParamField body="payload" type={<span><a href="/es/docs/libraries/acul/js-sdk/Screens/interfaces/SelectMfaPushDeviceOptions">SelectMfaPushDeviceOptions</a></span>}>
