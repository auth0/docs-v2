...
<ParamField body="continue" type="Promise<void>">
  ...
  Una promesa que se resuelve cuando la operación finaliza correctamente.

  <Expandable title="Parámetros">
    <ParamField body="payload" type={<span><a href="/es/docs/libraries/acul/js-sdk/Screens/interfaces/MfaRecoveryCodeChallengeContinueOptions">MfaRecoveryCodeChallengeContinueOptions</a></span>}>
      Las opciones de continuación que contienen el código de recuperación y opciones personalizadas opcionales.
