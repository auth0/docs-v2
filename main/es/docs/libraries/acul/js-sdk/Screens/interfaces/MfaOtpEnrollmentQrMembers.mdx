...
export interface MfaOtpEnrollmentQrMembers extends BaseMembers {
   ...
   * @param payload Carga útil que contiene el code y opciones personalizadas adicionales
   */
...
<ParamField body="screen" type={<span><a href="/es/docs/libraries/acul/js-sdk/Screens/interfaces/ScreenMembersOnMfaOtpEnrollmentQr">ScreenMembersOnMfaOtpEnrollmentQr</a></span>} />
...
<ParamField body="continue" type="Promise<void>">
  ...
  <Expandable title="Parámetros">
    <ParamField body="payload" type={<span><a href="/es/docs/libraries/acul/js-sdk/Screens/interfaces/MfaOtpEnrollmentQrContinueOptions">MfaOtpEnrollmentQrContinueOptions</a></span>}>
      Carga útil con code y opciones personalizadas opcionales
