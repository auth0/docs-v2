...
Interfaz que define los métodos y propiedades disponibles para la pantalla `mfa-detect-browser-capabilities`
...
<ParamField body="detectCapabilities" type="Promise<void>">
  ...
  <Expandable title="Parámetros">
    <ParamField body="payload" type={<span><a href="/es/docs/libraries/acul/js-sdk/Screens/interfaces/CustomOptions">CustomOptions</a></span>}>
      Opciones que contienen indicadores de las capacidades del navegador
    </ParamField>
  </Expandable>
</ParamField>