...
Interfaz que describe las propiedades de la pantalla de inscripción por voz de MFA.
...
<ParamField body="continue" type="Promise<void>">
  ...
  Promesa que se resuelve cuando continúa la inscripción.

  <Expandable title="Parámetros">
    <ParamField body="payload" type={<span><a href="/es/docs/libraries/acul/js-sdk/Screens/interfaces/MfaVoiceEnrollmentContinueOptions">MfaVoiceEnrollmentContinueOptions</a></span>}>
...
<ParamField body="selectPhoneCountryCode" type="Promise<void>">
  Permite seleccionar el código de país del número de teléfono.
