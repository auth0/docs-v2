...
<ParamField body="selectPhoneNumber" type="Promise<void>">
  Selecciona un número de teléfono de la lista de números ya inscritos.
  ...
  <Expandable title="Parámetros">
    <ParamField body="payload?" type={<span><a href="/es/docs/libraries/acul/js-sdk/Screens/interfaces/MfaSmsListOptions">MfaSmsListOptions</a></span>}>
      Payload opcional para la acción.
