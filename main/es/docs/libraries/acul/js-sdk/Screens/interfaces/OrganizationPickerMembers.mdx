...
export interface OrganizationPickerMembers extends BaseMembers {
   ...
   * @param payload Opciones personalizadas adicionales opcionales para incluir en la solicitud.
   */
...
<ParamField body="skipOrganizationSelection" type="Promise<void>">
  Omite la selección de la organización y continúa con la cuenta personal del usuario.
