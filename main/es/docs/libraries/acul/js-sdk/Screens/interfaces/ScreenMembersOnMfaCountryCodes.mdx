...
<ParamField body="data" type={<span><a href="/es/docs/libraries/acul/js-sdk/Screens/interfaces/PhonePrefix">PhonePrefix</a></span>}>
  #### Declaración de tipo

  &#123; `phone_prefixes`: [`PhonePrefix`](/es/docs/libraries/acul/js-sdk/Screens/interfaces/PhonePrefix)[]; &#125;
