...
<ParamField body="continueEnrollment" type="Promise<void>">
  Continúa el proceso de inscripción con el tipo y el número de teléfono proporcionados (SMS o voz).

  <Expandable title="Parámetros">
    <ParamField body="payload" type={<span><a href="/es/docs/libraries/acul/js-sdk/Screens/interfaces/MfaPhoneEnrollmentContinueOptions">MfaPhoneEnrollmentContinueOptions</a></span>}>
      El número de teléfono, el tipo y las opciones personalizadas.
