...
export interface ScreenMembersOnMfaWebAuthnChangeKeyNickname extends ScreenMembers {
  /**
   * Datos específicos de la pantalla que contienen el alias actual de la clave WebAuthn.
   * @type {{ nickname: string; } | null}
   */
  data: {
    /**
     * El alias actual de la clave de seguridad WebAuthn que el usuario está a punto de cambiar.
