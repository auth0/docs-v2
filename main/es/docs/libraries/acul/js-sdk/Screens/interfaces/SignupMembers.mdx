...
<ParamField body="federatedSignup" type="Promise<void>">
  <Expandable title="Parámetros">
    <ParamField body="payload" type={<span><a href="/es/docs/libraries/acul/js-sdk/Screens/interfaces/FederatedSignupPayloadOptions">FederatedSignupPayloadOptions</a></span>}>
      **Propiedades**
...
<ParamField body="getSignupIdentifiers" type={<span><a href="/es/docs/libraries/acul/js-sdk/Screens/interfaces/Identifier">Identifier</a>[]</span>}>
  **`Función de utilidad`**
  ...
  Un array de objetos [Identifier](/es/docs/libraries/acul/js-sdk/Screens/interfaces/Identifier) habilitados, o `null` si la transacción no está inicializada.
...
<ParamField body="signup" type="Promise<void>">
  <Expandable title="Parámetros">
    <ParamField body="payload" type={<span><a href="/es/docs/libraries/acul/js-sdk/Screens/interfaces/SignupPayloadOptions">SignupPayloadOptions</a></span>}>
      **Propiedades**
