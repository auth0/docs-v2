  ...
  <Expandable title="Parámetros">
    <ParamField body="options" type={<span><a href="/es/docs/libraries/acul/js-sdk/Screens/type-aliases/MfaPollingOptions">MfaPollingOptions</a></span>}>
      <ParamField body="MfaPollingOptions" type="object">
        ...
        con la que se consulta el endpoint de desafío y cómo se gestionan los casos de éxito o error.
        ...
        <Expandable title="Propiedades">
          ...
          <ParamField body="onCompleted()?" type="() => void">
            Callback opcional que se ejecuta cuando el desafío MFA push
            se aprueba correctamente y el sondeo finaliza.
