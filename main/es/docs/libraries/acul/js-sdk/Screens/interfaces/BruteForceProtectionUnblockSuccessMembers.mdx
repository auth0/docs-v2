...
Interfaz que define los métodos y las propiedades disponibles de la pantalla `brute-force-protection-unblock-success`.
...
<ParamField body="changeLanguage" type="void">
  ...
  <Expandable title="Parámetros">
    <ParamField body="options" type={<span><a href="/es/docs/libraries/acul/js-sdk/Screens/interfaces/LanguageChangeOptions">LanguageChangeOptions</a></span>} required>
      Opciones para cambiar el idioma de la pantalla.
    </ParamField>
  </Expandable>
</ParamField>
