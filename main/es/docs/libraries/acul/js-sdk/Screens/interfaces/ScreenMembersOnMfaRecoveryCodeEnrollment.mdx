...
Interfaz que describe los datos disponibles en la pantalla de inscripción del código de recuperación de MFA.
...
<ParamField body="data" type="textCode">
  ...
  El código de recuperación para mostrar al usuario.
