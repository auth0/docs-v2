...
<ParamField body="continueWithOrganizationName" type="Promise<void>">
  ...
  <Expandable title="Parámetros">
    <ParamField body="payload" type={<span><a href="/es/docs/libraries/acul/js-sdk/Screens/interfaces/ContinueWithOrganizationNameOptions">ContinueWithOrganizationNameOptions</a></span>}>
