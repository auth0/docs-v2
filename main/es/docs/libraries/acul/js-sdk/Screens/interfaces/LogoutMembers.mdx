...
Interfaz que define los métodos y propiedades disponibles de la pantalla de cierre de sesión
...
<ParamField body="confirmLogout" type="Promise<void>">
  ...
  <Expandable title="Parámetros">
    <ParamField body="payload" type={<span><a href="/es/docs/libraries/acul/js-sdk/Screens/interfaces/ConfirmLogoutOptions">ConfirmLogoutOptions</a></span>}>
