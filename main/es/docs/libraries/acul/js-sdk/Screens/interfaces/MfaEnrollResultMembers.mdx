...
export interface MfaEnrollResultMembers extends BaseMembers {
   ...
   * incluido el `estado de inscripción` (a través de `screen.data.status`).
  ...
  // Es posible que el usuario sea redirigido automáticamente o que se le proporcione un botón para continuar,
