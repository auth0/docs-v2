...
La pantalla `reset-password-mfa-webauthn-platform-challenge` se muestra durante el flujo de restablecimiento de contraseña cuando se requiere MFA mediante una clave de acceso de plataforma. Solicita al usuario que se autentique con la clave de acceso almacenada en su dispositivo para continuar el proceso de restablecimiento.

<Frame>
  <img style={{maxHeight:"400px"}} src="/docs/images/cdy7uua7fh8z/7aNLJSP1f1xmQI9RIc7bQh/98db8a7a627e84896b50cf219497c345/Screenshot_2025-05-28_at_12.43.54.png" alt="ACUL Desafío de plataforma de WebAuthn para MFA de restablecimiento de contraseña" />
</Frame>
...
Hooks para la pantalla que proporcionan acceso de solo lectura a los datos de contexto de Auth0 en la pantalla `reset-password-mfa-webauthn-platform-challenge`. Impórtalos desde `@auth0/auth0-acul-react/reset-password-mfa-webauthn-platform-challenge`.
...
<ParamField body="useBranding" type={<span>() =&gt; <a href="/es/docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/BrandingMembers">BrandingMembers</a></span>}>
  Este hook proporciona configuraciones de marca, como el logotipo, los colores y los ajustes de tema que se muestran en la pantalla `reset-password-mfa-webauthn-platform-challenge`.
...
<ParamField body="useScreen" type={<span>() =&gt; <a href="/es/docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/ScreenMembersOnResetPasswordMfaWebAuthnPlatformChallenge">ScreenMembersOnResetPasswordMfaWebAuthnPlatformChallenge</a></span>}>
  Este hook contiene detalles específicos de la pantalla `reset-password-mfa-webauthn-platform-challenge`, incluida su configuración y su contexto.
...
<ParamField body="useUntrustedData" type={<span>() =&gt; <a href="/es/docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/UntrustedDataMembers">UntrustedDataMembers</a></span>}>
  Este hook procesa los datos no confiables que recibe la pantalla, como un correo electrónico o un nombre de usuario precargados a partir de parámetros de la URL.
...
<ParamField body="useResetPasswordMfaWebAuthnPlatformChallenge" type={<a href="/es/docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/ResetPasswordMfaWebAuthnPlatformChallengeMembers">ResetPasswordMfaWebAuthnPlatformChallengeMembers</a>}>
  Este hook devuelve todos los métodos y el contexto disponibles para la pantalla `reset-password-mfa-webauthn-platform-challenge`.
</ParamField>
...
<ParamField body="continueWithPasskey" type="Promise<void>">
  Este método inicia el desafío de clave de acceso de la plataforma para continuar el paso de MFA en el flujo de restablecimiento de contraseña.
  ...
  **Parámetros del método**
  ...
  <Expandable title="Parámetros">
    <ParamField body="options">
      [ResetPasswordMfaWebAuthnPlatformChallengeContinueOptions](/es/docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/ResetPasswordMfaWebAuthnPlatformChallengeContinueOptions).
    </ParamField>
...
<ParamField body="reportBrowserError" type="Promise<void>">
  Este método notifica a Auth0 un error del navegador relacionado con WebAuthn cuando el desafío de clave de acceso falla en el dispositivo del usuario.
  ...
  **Parámetros del método**
  ...
  <Expandable title="Parámetros">
    <ParamField body="options">
      [ResetPasswordMfaWebAuthnPlatformChallengeReportErrorOptions](/es/docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/ResetPasswordMfaWebAuthnPlatformChallengeReportErrorOptions).
    </ParamField>
