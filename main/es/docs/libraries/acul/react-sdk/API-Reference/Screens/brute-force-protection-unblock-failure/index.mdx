...
<Frame>
  <img style={{maxHeight:"400px"}} src="/docs/images/cdy7uua7fh8z/ACUL/brute-force-protection-unblock-failure.png" alt="ACUL Error al desbloquear la protección contra fuerza bruta" />
</Frame>
...
<ParamField body="useScreen" type={<span>() =&gt; <a href="/es/docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/ScreenMembersOnBruteForceProtectionUnblockFailure">ScreenMembersOnBruteForceProtectionUnblockFailure</a></span>}>
...
<ParamField body="useBruteForceProtectionUnblockFailure" type={<a href="/es/docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/BruteForceProtectionUnblockFailureMembers">BruteForceProtectionUnblockFailureMembers</a>}>
