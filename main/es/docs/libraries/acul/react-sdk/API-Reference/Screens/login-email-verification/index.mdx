---
title: "Verificación del correo electrónico al iniciar sesión"
...
<Frame>
  <img style={{maxHeight:"400px"}} src="/docs/images/cdy7uua7fh8z/2kIZmIlrAHoSTyaD8thnIL/515c6f940036953d2989c7b37b7f1fe2/Screenshot_2025-05-15_at_21.18.53.png" alt="Verificación del correo electrónico al iniciar sesión" />
</Frame>
...
* La importación raíz le permite cargar todas las pantallas desde un único paquete, lo que resulta útil cuando desea una compilación unificada para gestionar todas las pantallas posibles.
...
Hooks de ámbito de pantalla que proporcionan acceso de solo lectura a los datos de contexto de Auth0 en la pantalla `login-email-verification`. Impórtelos desde `@auth0/auth0-acul-react/login-email-verification`.
...
<ParamField body="useBranding" type={<span>() =&gt; <a href="/docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/BrandingMembers">BrandingMembers</a></span>}>
  Este hook proporciona la configuración de marca, como el logotipo, los colores y los ajustes del tema que se muestran en la pantalla `login-email-verification`.
...
<ParamField body="useUntrustedData" type={<span>() =&gt; <a href="/docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/UntrustedDataMembers">UntrustedDataMembers</a></span>}>
  Este hook gestiona los datos no confiables que se pasan a la pantalla, como los parámetros de la cadena de consulta de la URL.
...
<ParamField body="useLoginEmailVerification" type={<a href="/docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/LoginEmailVerificationMembers">LoginEmailVerificationMembers</a>}>
  Este hook devuelve todos los métodos y el contexto disponibles para la pantalla `login-email-verification`.
</ParamField>
...
<ParamField body="continueWithCode" type="Promise<void>">
  Este método envía el código de verificación introducido por el usuario para continuar con la verificación del correo electrónico.
...
<ParamField body="resendCode" type="Promise<void>">
  Este método solicita que se envíe un nuevo código de verificación al correo electrónico del usuario.
...
<ParamField body={<a href="/docs/libraries/acul/react-sdk/API-Reference/Hooks/useAuth0Themes">useAuth0Themes</a>} type="Hooks">
  Este hook obtiene las opciones del tema actual con la configuración unificada del contexto de marca.
</ParamField>
...
<ParamField body={<a href="/docs/libraries/acul/react-sdk/API-Reference/Hooks/useResend">useResend</a>} type="Hooks">
  Este hook administra el tiempo de espera entre reenvíos y la disponibilidad de las acciones para reenviar el código.
</ParamField>