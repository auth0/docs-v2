...
La pantalla `accept-invitation` aparece cuando se invita a un usuario a unirse a una Organización. Permite al usuario aceptar la invitación y continuar con el flujo de autenticación.
...
Hooks con ámbito de pantalla que proporcionan acceso de solo lectura a los datos de contexto de Auth0 en la pantalla `accept-invitation`. Impórtalos desde `@auth0/auth0-acul-react/accept-invitation`.
...
<ParamField body="useBranding" type={<span>() =&gt; <a href="/es/docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/BrandingMembers">BrandingMembers</a></span>}>
  Este hook proporciona la configuración de marca, como el logotipo, los colores y los ajustes del tema que se muestran en la pantalla `accept-invitation`.
...
<ParamField body="useClient" type={<span>() =&gt; <a href="/es/docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/ClientMembers">ClientMembers</a></span>}>
  Este hook proporciona la configuración relacionada con el cliente, como `id`, `name` y `logoUrl`, para la pantalla `accept-invitation`.
...
<ParamField body="useScreen" type={<span>() =&gt; <a href="/es/docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/ScreenMembersOnAcceptInvitation">ScreenMembersOnAcceptInvitation</a></span>}>
...
<ParamField body="useUntrustedData" type={<span>() =&gt; <a href="/es/docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/UntrustedDataMembers">UntrustedDataMembers</a></span>}>
  Este hook gestiona los datos no confiables que se pasan a la pantalla, como los parámetros precargados de la cadena de consulta de la URL.
...
<ParamField body="useAcceptInvitation" type={<a href="/es/docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/AcceptInvitationMembers">AcceptInvitationMembers</a>}>
