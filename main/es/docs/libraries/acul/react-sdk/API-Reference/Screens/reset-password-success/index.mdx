...
description: "Describe todos los hooks y métodos disponibles para personalizar la pantalla `reset-password-success` en Universal Login."
---

La pantalla `reset-password-success` se muestra al final del flujo de restablecimiento de contraseña. Confirma al usuario que su contraseña se ha cambiado correctamente.

<Frame>
  <img style={{maxHeight:"400px"}} src="/docs/images/cdy7uua7fh8z/5eQfQYCZSu4ZaYaYz3ln8j/d6fdc02e205c14388aa13f868fa747a3/Screenshot_2025-01-28_at_10.16.09.png" alt="ACUL Restablecimiento de contraseña completado" />
</Frame>
...
<ParamField body="useBranding" type={<span>() =&gt; <a href="/es/docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/BrandingMembers">BrandingMembers</a></span>}>
  Este hook proporciona configuración de marca, como el logotipo, los colores y los ajustes de tema que se muestran en la pantalla `reset-password-success`.
...
<ParamField body="useClient" type={<span>() =&gt; <a href="/es/docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/ClientMembers">ClientMembers</a></span>}>
  Este hook proporciona configuración relacionada con el cliente, como `id`, `name` y `logoUrl`, para la pantalla `reset-password-success`.
...
<ParamField body="useScreen" type={<span>() =&gt; <a href="/es/docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/ScreenMembersOnResetPasswordSuccess">ScreenMembersOnResetPasswordSuccess</a></span>}>
...
<ParamField body="useUntrustedData" type={<span>() =&gt; <a href="/es/docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/UntrustedDataMembers">UntrustedDataMembers</a></span>}>
  Este hook administra los datos no confiables que se pasan a la pantalla, como un correo electrónico o un username completados previamente a partir de parámetros de URL.
...
<ParamField body="useResetPasswordSuccess" type={<a href="/es/docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/ResetPasswordSuccessMembers">ResetPasswordSuccessMembers</a>}>
