...
Hooks del ámbito de la pantalla que proporcionan acceso de solo lectura a los datos de contexto de Auth0 en la pantalla `mfa-email-challenge`. Impórtalos desde `@auth0/auth0-acul-react/mfa-email-challenge`.
...
<ParamField body="useBranding" type={<span>() =&gt; <a href="/docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/BrandingMembers">BrandingMembers</a></span>}>
  Este hook proporciona configuraciones de marca, como el logotipo, los colores y los ajustes del tema que se muestran en la pantalla `mfa-email-challenge`.
...
<ParamField body="useUntrustedData" type={<span>() =&gt; <a href="/docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/UntrustedDataMembersOnMfaEmailChallenge">UntrustedDataMembersOnMfaEmailChallenge</a></span>}>
  Este hook contiene los datos no confiables que se pasan a la pantalla, como valores rellenados previamente a partir de parámetros de URL.
...
<ParamField body="continueMethod" type="Promise<void>">
  Este método envía el código de un solo uso introducido por el usuario para completar el desafío de MFA por correo electrónico.
...
<ParamField body="pickEmail" type="Promise<void>">
  Este método navega a la pantalla de selección de correo electrónico si hay varias direcciones de correo electrónico disponibles para el desafío.
...
<ParamField body={<a href="/docs/libraries/acul/react-sdk/API-Reference/Hooks/useResend">useResend</a>} type="Hooks">
  Este hook gestiona el estado y la lógica del período de espera para el reenvío en pantallas con funcionalidad de reenvío de código.
</ParamField>

<ParamField body={<a href="/docs/libraries/acul/react-sdk/API-Reference/Hooks/useAuth0Themes">useAuth0Themes</a>} type="Hooks">
  Este hook obtiene las opciones del tema actual con una configuración consolidada a partir del contexto de marca.
</ParamField>
...
<ParamField body={<a href="/docs/libraries/acul/react-sdk/API-Reference/Hooks/useErrors">useErrors</a>} type="Hooks">
  Este hook permite consultar y gestionar los errores del servidor, del cliente y del desarrollador en la pantalla.
</ParamField>