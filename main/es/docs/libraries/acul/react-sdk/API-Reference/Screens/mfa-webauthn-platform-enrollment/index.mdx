...
description: "Describe todos los hooks y métodos disponibles para personalizar la pantalla `mfa-webauthn-platform-enrollment` de Inicio de Sesión Universal."
---
...
Hooks con alcance a nivel de pantalla que proporcionan acceso de solo lectura a los datos de contexto de Auth0 en la pantalla `mfa-webauthn-platform-enrollment`. Impórtalos desde `@auth0/auth0-acul-react/mfa-webauthn-platform-enrollment`.
...
<ParamField body="useBranding" type={<span>() =&gt; <a href="/es/docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/BrandingMembers">BrandingMembers</a></span>}>
  Este hook proporciona la configuración de marca, como el logotipo, los colores y los ajustes de tema que se muestran en la pantalla `mfa-webauthn-platform-enrollment`.
...
<ParamField body="useOrganization" type={<span>() =&gt; <a href="/es/docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/OrganizationMembers">OrganizationMembers</a></span>}>
  Este hook proporciona información sobre la organización del usuario si el flujo de MFA está limitado a una Organization. Devuelve `null` cuando no hay contexto de Organization.
...
<ParamField body="useScreen" type={<span>() =&gt; <a href="/es/docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/ScreenMembersOnMfaWebAuthnPlatformEnrollment">ScreenMembersOnMfaWebAuthnPlatformEnrollment</a></span>}>
...
<ParamField body="useMfaWebAuthnPlatformEnrollment" type={<a href="/es/docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/MfaWebAuthnPlatformEnrollmentMembers">MfaWebAuthnPlatformEnrollmentMembers</a>}>
...
<ParamField body="refuseEnrollmentOnThisDevice" type="Promise<void>">
  Este método rechaza la inscripción del autenticador de plataforma en el dispositivo actual.
...
<ParamField body="reportBrowserError" type="Promise<void>">
  Este método reporta un error de WebAuthn a nivel del navegador detectado durante la inscripción del autenticador de plataforma.
  ...
  **Parámetros del método**
  ...
  <Expandable title="Parámetros">
    <ParamField body="options">
      [ReportBrowserErrorOptions](/es/docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/ReportBrowserErrorOptions).
    </ParamField>
    ...
    <ParamField body="error" type={<span><a href="/es/docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/WebAuthnErrorDetails">WebAuthnErrorDetails</a></span>} required>
      El objeto de error de la API de WebAuthn (`navigator.credentials.create()`) que se va a reportar.
...
<ParamField body="snoozeEnrollment" type="Promise<void>">
  Este método pospone la inscripción del autenticador de plataforma para otro momento.
...
<ParamField body="submitPasskeyCredential" type="Promise<void>">
  Este método envía la credencial de passkey creada por el autenticador de plataforma para completar la inscripción.
