...
La pantalla `mfa-detect-browser-capabilities` detecta automáticamente las capacidades de MFA que admite el navegador y dirige al usuario al flujo correspondiente de inscripción o verificación del factor.
...
Hooks con ámbito de pantalla que proporcionan acceso de solo lectura a los datos de contexto de Auth0 en la pantalla `mfa-detect-browser-capabilities`. Impórtalos desde `@auth0/auth0-acul-react/mfa-detect-browser-capabilities`.
...
<ParamField body="useBranding" type={<span>() =&gt; <a href="/es/docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/BrandingMembers">BrandingMembers</a></span>}>
  Este hook proporciona la configuración de marca, como el logotipo, los colores y los ajustes del tema que se muestran en la pantalla `mfa-detect-browser-capabilities`.
...
<ParamField body="useScreen" type={<span>() =&gt; <a href="/es/docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/ScreenMembers">ScreenMembers</a></span>}>
  Este hook contiene detalles específicos de la pantalla `mfa-detect-browser-capabilities`, incluida su configuración y su contexto.
...
<ParamField body="useUntrustedData" type={<span>() =&gt; <a href="/es/docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/UntrustedDataMembers">UntrustedDataMembers</a></span>}>
  Este hook proporciona acceso a los datos no confiables que se pasan a la pantalla, como valores completados previamente a partir de parámetros de URL.
...
<ParamField body="useMfaDetectBrowserCapabilities" type={<a href="/es/docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/MfaDetectBrowserCapabilitiesMembers">MfaDetectBrowserCapabilitiesMembers</a>}>
...
<ParamField body="detectCapabilities" type="Promise<void>">
  Este método detecta las capacidades del navegador para determinar qué factores de MFA son compatibles y avanza el flujo en consecuencia.
