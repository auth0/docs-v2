...
La pantalla `login-password` recopila la contraseña del usuario como segundo paso de un flujo de autenticación de tipo identifier-first. También permite cambiar a un proveedor de identidad federado o a otra conexión.
...
* Usar una importación desde la raíz te permite cargar todas las pantallas desde un único paquete, lo que resulta útil cuando quieres una compilación unificada para gestionar todas las pantallas posibles.
...
Hooks con ámbito de pantalla que proporcionan acceso de solo lectura a los datos de contexto de Auth0 en la pantalla `login-password`. Impórtalos desde `@auth0/auth0-acul-react/login-password`.
...
<ParamField body="useBranding" type={<span>() =&gt; <a href="/docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/BrandingMembers">BrandingMembers</a></span>}>
  Este hook proporciona la configuración de marca, como el logotipo, los colores y los ajustes de tema que se muestran en la pantalla `login-password`.
...
<ParamField body="useClient" type={<span>() =&gt; <a href="/docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/ClientMembers">ClientMembers</a></span>}>
  Este hook proporciona la configuración del cliente, como `id`, `name` y `logoUrl`, para la pantalla `login-password`.
...
<ParamField body="useUntrustedData" type={<span>() =&gt; <a href="/docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/UntrustedDataMembers">UntrustedDataMembers</a></span>}>
  Este hook proporciona acceso a los datos no confiables que se pasan a la pantalla, como un identificador rellenado previamente a partir de parámetros de URL.
  ...
  **Parámetros del método**
  ...
  <Expandable title="Parámetros">
    ...
    <ParamField body="username" type="string" required>
      El identificador (correo electrónico, número de teléfono o username) con el que autenticarse.
    </ParamField>
...
<ParamField body={<a href="/docs/libraries/acul/react-sdk/API-Reference/Hooks/useAuth0Themes">useAuth0Themes</a>} type="Hooks">
  Este hook obtiene las opciones del tema actual con la configuración del contexto de marca simplificada.
</ParamField>
