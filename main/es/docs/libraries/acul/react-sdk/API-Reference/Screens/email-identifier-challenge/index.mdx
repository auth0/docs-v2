...
La pantalla `email-identifier-challenge` se muestra cuando un usuario necesita verificar su identidad introduciendo el code enviado a su dirección de correo electrónico. Permite al usuario enviar el code, volver a enviarlo o regresar al paso anterior.
...
<ParamField body="useBranding" type={<span>() =&gt; <a href="/es/docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/BrandingMembers">BrandingMembers</a></span>}>
  Este hook proporciona configuraciones de marca, como el logotipo, los colores y los ajustes de tema que se muestran en la pantalla `email-identifier-challenge`.
...
<ParamField body="useOrganization" type={<span>() =&gt; <a href="/es/docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/OrganizationMembers">OrganizationMembers</a></span>}>
  Este hook proporciona información sobre la Organización del usuario si el desafío de correo electrónico está limitado a una Organización. Devuelve `null` cuando no hay contexto de Organización.
...
<ParamField body="useScreen" type={<span>() =&gt; <a href="/es/docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/ScreenMembersOnEmailIdentifierChallenge">ScreenMembersOnEmailIdentifierChallenge</a></span>}>
  Este hook contiene detalles específicos de la pantalla `email-identifier-challenge`, incluida su configuración y contexto.
...
<ParamField body="useUser" type={<span>() =&gt; <a href="/es/docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/UserMembers">UserMembers</a></span>}>
  Este hook ofrece información sobre el usuario actual, incluidos `username`, `email` y los métodos de autenticación disponibles.
...
<ParamField body="useEmailIdentifierChallenge" type={<a href="/es/docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/EmailIdentifierChallengeMembers">EmailIdentifierChallengeMembers</a>}>
...
<ParamField body="resendCode" type="Promise<void>">
  Este método reenvía el code de verificación a la dirección de correo electrónico del usuario.
...
<ParamField body="submitEmailChallenge" type="Promise<void>">
  Este método envía el code de verificación por correo electrónico que introdujo el usuario.
  ...
  **Parámetros del método**
  ...
  <Expandable title="Parámetros">
    ...
    <ParamField body="code" type="string" required>
      El code de verificación enviado a la dirección de correo electrónico del usuario.
    </ParamField>

    <ParamField body="captcha?" type="string">
      El token de respuesta del CAPTCHA, si CAPTCHA está habilitado para este inquilino.
    </ParamField>
  </Expandable>
</ParamField>
