...
* La importación desde la raíz te permite cargar todas las pantallas desde un único bundle, lo que resulta útil cuando quieres una sola compilación para manejar todas las pantallas posibles.
...
Hooks del ámbito de la pantalla que proporcionan acceso de solo lectura a los datos de contexto de Auth0 en la pantalla `reset-password-mfa-push-challenge-push`. Impórtelos desde `@auth0/auth0-acul-react/reset-password-mfa-push-challenge-push`.
...
<ParamField body="useBranding" type={<span>() =&gt; <a href="/es/docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/BrandingMembers">BrandingMembers</a></span>}>
  Este hook proporciona configuración de marca, como el logotipo, los colores y la configuración del tema que se muestran en la pantalla `reset-password-mfa-push-challenge-push`.
...
<ParamField body="useClient" type={<span>() =&gt; <a href="/es/docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/ClientMembers">ClientMembers</a></span>}>
  Este hook proporciona configuración relacionada con el cliente, como `id`, `name` y `logoUrl`, para la pantalla `reset-password-mfa-push-challenge-push`.
...
<ParamField body="useScreen" type={<span>() =&gt; <a href="/es/docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/ScreenMembersOnResetPasswordMfaPushChallengePush">ScreenMembersOnResetPasswordMfaPushChallengePush</a></span>}>
...
<ParamField body="useUntrustedData" type={<span>() =&gt; <a href="/es/docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/UntrustedDataMembers">UntrustedDataMembers</a></span>}>
  Este hook gestiona los datos no confiables que se pasan a la pantalla, como un correo electrónico o un `username` completados previamente mediante parámetros de la URL.
...
<ParamField body="useResetPasswordMfaPushChallengePush" type={<a href="/es/docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/ResetPasswordMfaPushChallengePushMembers">ResetPasswordMfaPushChallengePushMembers</a>}>
  Este hook devuelve todos los métodos y el contexto disponibles para la pantalla `reset-password-mfa-push-challenge-push`.
</ParamField>
...
<ParamField body="enterCodeManually" type="Promise<void>">
  Este método dirige al usuario para que introduzca manualmente el código OTP en lugar de esperar la aprobación de la notificación push.
...
<ParamField body="resendPushNotification" type="Promise<void>">
  Este método reenvía la notificación push al dispositivo móvil inscrito del usuario.
...
<ParamField body="tryAnotherMethod" type="Promise<void>">
  Este método dirige al usuario para que seleccione otro método de MFA.
...
<ParamField body={<a href="/es/docs/libraries/acul/react-sdk/API-Reference/Hooks/useMfaPolling">useMfaPolling</a>} type="Hooks">
  Este hook gestiona el sondeo de las notificaciones push de MFA y comprueba repetidamente el endpoint del desafío push hasta que el usuario aprueba o rechaza la solicitud.
</ParamField>
...
<ParamField body={<a href="/es/docs/libraries/acul/react-sdk/API-Reference/Hooks/useErrors">useErrors</a>} type="Hooks">
  Este hook lee y gestiona los errores de servidor, cliente y desarrollador en la pantalla.
</ParamField>