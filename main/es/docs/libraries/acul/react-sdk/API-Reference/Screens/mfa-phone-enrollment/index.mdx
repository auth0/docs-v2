...
La pantalla `mfa-phone-enrollment` permite al usuario inscribir un número de teléfono para MFA por SMS o voz introduciendo su número y seleccionando un método de entrega.
...
Hooks con alcance de pantalla que proporcionan acceso de solo lectura a los datos de contexto de Auth0 en la pantalla `mfa-phone-enrollment`. Impórtalos desde `@auth0/auth0-acul-react/mfa-phone-enrollment`.
...
<ParamField body="useBranding" type={<span>() =&gt; <a href="/es/docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/BrandingMembers">BrandingMembers</a></span>}>
  Este hook proporciona configuración de marca, como el logotipo, los colores y los ajustes del tema que se muestran en la pantalla `mfa-phone-enrollment`.
...
<ParamField body="useClient" type={<span>() =&gt; <a href="/es/docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/ClientMembers">ClientMembers</a></span>}>
  Este hook proporciona configuración relacionada con el cliente, como `id`, `name` y `logoUrl`, para la pantalla `mfa-phone-enrollment`.
...
<ParamField body="useUntrustedData" type={<span>() =&gt; <a href="/es/docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/UntrustedDataMembers">UntrustedDataMembers</a></span>}>
  Este hook maneja datos no confiables que se pasan a la pantalla, como valores precompletados a partir de parámetros de URL.
...
<ParamField body="useMfaPhoneEnrollment" type={<a href="/es/docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/MfaPhoneEnrollmentMembers">MfaPhoneEnrollmentMembers</a>}>
...
<ParamField body="continueEnrollment" type="Promise<void>">
  Este método envía el número de teléfono del usuario y el método de entrega seleccionado para inscribir el teléfono en MFA.
  ...
  **Parámetros del método**
  ...
  <Expandable title="Parámetros">
    <ParamField body="options">
      [MfaPhoneEnrollmentContinueOptions](/es/docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/MfaPhoneEnrollmentContinueOptions).
    </ParamField>

    <ParamField body="phone" type="string" required>
      El número de teléfono que se inscribirá en MFA.
    </ParamField>
...
<ParamField body="pickCountryCode" type="Promise<void>">
  Este método lleva a la pantalla de selección de código de país para que el usuario pueda elegir el código de país de su número de teléfono.
