...
La pantalla `login-passwordless-email-code` solicita al usuario que introduzca un code de un solo uso enviado a su correo electrónico para completar la autenticación sin contraseña.

<Frame>
  <img style={{maxHeight:"400px"}} src="/docs/images/cdy7uua7fh8z/4DKgjU2dGw0mpLJKGfGhp0/470b29266da87f9bfc3e7eef55069620/Login_Passwordless_Email_Code.png" alt="Code por correo electrónico para inicio de sesión sin contraseña" />
</Frame>
...
Hooks específicos de pantalla que proporcionan acceso de solo lectura a los datos de contexto de Auth0 en la pantalla `login-passwordless-email-code`. Impórtalos desde `@auth0/auth0-acul-react/login-passwordless-email-code`.
...
<ParamField body="useBranding" type={<span>() =&gt; <a href="/es/docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/BrandingMembers">BrandingMembers</a></span>}>
  Este hook proporciona configuraciones de marca, como el logotipo, los colores y los ajustes del tema que se muestran en la pantalla `login-passwordless-email-code`.
...
<ParamField body="useOrganization" type={<span>() =&gt; <a href="/es/docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/OrganizationMembers">OrganizationMembers</a></span>}>
  Este hook proporciona información sobre la Organización del usuario si el inicio de sesión está dentro del ámbito de una Organización. Devuelve `null` cuando no hay contexto de Organización.
...
<ParamField body="useScreen" type={<span>() =&gt; <a href="/es/docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/ScreenMembersOnLoginPasswordlessEmailCode">ScreenMembersOnLoginPasswordlessEmailCode</a></span>}>
...
<ParamField body="useTransaction" type={<span>() =&gt; <a href="/es/docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/TransactionMembersOnLoginPasswordlessEmailCode">TransactionMembersOnLoginPasswordlessEmailCode</a></span>}>
...
<ParamField body="useUntrustedData" type={<span>() =&gt; <a href="/es/docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/UntrustedDataMembers">UntrustedDataMembers</a></span>}>
  Este hook proporciona acceso a los datos no confiables que se pasan a la pantalla, como una dirección de correo electrónico rellenada previamente a partir de parámetros de URL.
...
<ParamField body="useLoginPasswordlessEmailCode" type={<a href="/es/docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/LoginPasswordlessEmailCodeMembers">LoginPasswordlessEmailCodeMembers</a>}>
...
<ParamField body="resendCode" type="Promise<void>">
  Este método reenvía el code de un solo uso a la dirección de correo electrónico del usuario.
...
<ParamField body="submitCode" type="Promise<void>">
  Este método envía el code de un solo uso para completar la autenticación sin contraseña por correo electrónico.
  ...
  **Parámetros del método**
  ...
  <Expandable title="Parámetros">
    ...
    <ParamField body="code" type="string | number" required>
      El code de un solo uso enviado a la dirección de correo electrónico del usuario.
    </ParamField>
...
<ParamField body="switchConnection" type="Promise<void>">
  ...
  **Parámetros del método**
  ...
  <Expandable title="Parámetros">
    <ParamField body="options">
      [SwitchConnectionOptionsEmailCode](/es/docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/SwitchConnectionOptionsEmailCode).
    </ParamField>

    <ParamField body="connection" type="string" required>
      El nombre de la conexión a la que se cambiará. Use &#39;email&#39; o &#39;sms&#39; para autenticación sin contraseña, o un nombre de conexión de base de datos para la autenticación con contraseña.
    </ParamField>
...
<ParamField body={<a href="/es/docs/libraries/acul/react-sdk/API-Reference/Hooks/useResend">useResend</a>} type="Hooks">
  Este hook administra el estado de espera para el reenvío y la disponibilidad de las acciones de reenvío de code.
</ParamField>