...
La pantalla `passkey-enrollment-local` se muestra cuando se le pide a un usuario que inscriba una clave de acceso en su dispositivo actual. Permite al usuario continuar con la inscripción de la clave de acceso o cancelar el proceso y, opcionalmente, evitar que se muestren solicitudes en el futuro.
...
Hooks con ámbito de pantalla que proporcionan acceso de solo lectura a los datos de contexto de Auth0 en la pantalla `passkey-enrollment-local`. Impórtalos desde `@auth0/auth0-acul-react/passkey-enrollment-local`.
...
<ParamField body="useBranding" type={<span>() =&gt; <a href="/es/docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/BrandingMembers">BrandingMembers</a></span>}>
  Este hook proporciona configuraciones de marca, como el logotipo, los colores y la configuración del tema que se muestran en la pantalla `passkey-enrollment-local`.
...
<ParamField body="useOrganization" type={<span>() =&gt; <a href="/es/docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/OrganizationMembers">OrganizationMembers</a></span>}>
  Este hook proporciona información sobre la organización del usuario si la inscripción de clave de acceso está dentro del ámbito de una organización. Devuelve `null` cuando no hay contexto de organización.
...
<ParamField body="useScreen" type={<span>() =&gt; <a href="/es/docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/ScreenMembersOnPasskeyEnrollmentLocal">ScreenMembersOnPasskeyEnrollmentLocal</a></span>}>
...
<ParamField body="useUntrustedData" type={<span>() =&gt; <a href="/es/docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/UntrustedDataMembers">UntrustedDataMembers</a></span>}>
  Este hook administra los datos no confiables que se pasan a la pantalla, como los parámetros precompletados de la cadena de consulta de la URL.
...
<ParamField body="usePasskeyEnrollmentLocal" type={<a href="/es/docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/PasskeyEnrollmentLocalMembers">PasskeyEnrollmentLocalMembers</a>}>
...
<ParamField body="continuePasskeyEnrollment" type="Promise<void>">
  Este método inicia el proceso de inscripción de una clave de acceso en el dispositivo actual y continúa el flujo de autenticación.
  ...
  function SkipButton() {
    ...
    return (
      <button onClick={() => abortPasskeyEnrollment({ doNotShowAgain: true })}>
        Omitir y no volver a preguntar
      </button>
    );
  }
  ```
  ...
  **Parámetros del método**
  ...
  <Expandable title="Parámetros">
    ...
    <ParamField body="doNotShowAgain" type="boolean">
      Cuando es `true`, suprime futuras solicitudes de inscripción de claves de acceso para este usuario.
    </ParamField>
  </Expandable>
</ParamField>
