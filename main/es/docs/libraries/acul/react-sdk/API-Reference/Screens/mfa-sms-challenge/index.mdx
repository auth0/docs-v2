...
La pantalla `mfa-sms-challenge` solicita al usuario que introduzca un código de un solo uso enviado a su teléfono por SMS para completar la verificación MFA.
...
Hooks con ámbito de pantalla que proporcionan acceso de solo lectura a los datos de contexto de Auth0 en la pantalla `mfa-sms-challenge`. Impórtalos desde `@auth0/auth0-acul-react/mfa-sms-challenge`.
...
<ParamField body="useBranding" type={<span>() =&gt; <a href="/docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/BrandingMembers">BrandingMembers</a></span>}>
  Este hook proporciona la configuración de marca, como el logotipo, los colores y los ajustes del tema que se muestran en la pantalla `mfa-sms-challenge`.
...
<ParamField body="continueMfaSmsChallenge" type="Promise<void>">
  Este método envía el código de un solo uso recibido por SMS para completar la verificación de MFA.
...
<ParamField body="getACall" type="Promise<void>">
  Este método cambia la verificación de MFA a una llamada de voz en lugar de un SMS.
...
<ParamField body={<a href="/docs/libraries/acul/react-sdk/API-Reference/Hooks/useResend">useResend</a>} type="Hooks">
  Este hook gestiona el estado y la lógica del período de espera para reenviar en pantallas con funcionalidad de reenvío de código.
</ParamField>
