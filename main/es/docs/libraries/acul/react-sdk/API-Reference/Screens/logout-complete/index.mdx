...
La pantalla `logout-complete` se muestra después de que un usuario complete correctamente el proceso de cierre de sesión.
...
* Con la importación parcial, puede incluir solo el código que necesita para su caso de uso específico.
* Con la importación desde la raíz, puede cargar todas las pantallas desde un único paquete, lo que resulta útil si quiere una compilación unificada para gestionar todas las pantallas posibles.
...
Hooks específicos de la pantalla que proporcionan acceso de solo lectura a los datos de contexto de Auth0 en la pantalla `logout-complete`. Impórtalos desde `@auth0/auth0-acul-react/logout-complete`.
...
<ParamField body="useBranding" type={<span>() =&gt; <a href="/es/docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/BrandingMembers">BrandingMembers</a></span>}>
  Este hook proporciona la configuración de marca, como el logotipo, los colores y los ajustes de tema que se muestran en la pantalla `logout-complete`.
...
<ParamField body="useOrganization" type={<span>() =&gt; <a href="/es/docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/OrganizationMembers">OrganizationMembers</a></span>}>
  Este hook proporciona información sobre la Organización del usuario si la sesión está asociada a una Organización. Devuelve `null` cuando no hay contexto de Organización.
...
<ParamField body="usePrompt" type={<span>() =&gt; <a href="/es/docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/PromptMembers">PromptMembers</a></span>}>
  Este hook contiene datos sobre la pantalla actual dentro del flujo de autenticación.
...
<ParamField body="useUntrustedData" type={<span>() =&gt; <a href="/es/docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/UntrustedDataMembers">UntrustedDataMembers</a></span>}>
  Este hook gestiona los datos no confiables que se pasan a la pantalla, como los parámetros de consulta de la URL.
...
<ParamField body="useLogoutComplete" type={<a href="/es/docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/LogoutCompleteMembers">LogoutCompleteMembers</a>}>
