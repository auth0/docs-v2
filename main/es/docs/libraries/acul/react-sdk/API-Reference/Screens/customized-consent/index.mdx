---
title: "Consentimiento personalizado"
description: "Describe todos los hooks y métodos disponibles para personalizar la pantalla `customized-consent` de Universal Login."
---

La pantalla `customized-consent` se muestra durante el flujo de autorización cuando un usuario debe conceder o denegar permisos a una aplicación con una experiencia de consentimiento personalizada. Muestra los alcances solicitados y permite al usuario aceptar o rechazar la solicitud de consentimiento.

<Frame>
  <img style={{maxHeight:"400px"}} src="/docs/images/cdy7uua7fh8z/6cK6DkpOJYTjubOGu2vpID/80c03b32275a2c332fe3216df0eca5c7/Consent.png" alt="ACUL Consentimiento personalizado" />
</Frame>
...
* La importación desde la raíz te permite cargar todas las pantallas desde un único bundle, lo que resulta útil cuando quieres una compilación unificada para gestionar todas las pantallas posibles.
...
Hooks con ámbito de pantalla que proporcionan acceso de solo lectura a los datos de contexto de Auth0 en la pantalla `customized-consent`. Impórtalos desde `@auth0/auth0-acul-react/customized-consent`.
...
<ParamField body="useBranding" type={<span>() =&gt; <a href="/es/docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/BrandingMembers">BrandingMembers</a></span>}>
  Este hook proporciona la configuración de marca, como el logotipo, los colores y los ajustes del tema que se muestran en la pantalla `customized-consent`.
...
<ParamField body="useClient" type={<span>() =&gt; <a href="/es/docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/ClientMembers">ClientMembers</a></span>}>
  Este hook proporciona configuraciones relacionadas con el cliente, como `id`, `name` y `logoUrl`, para la pantalla `customized-consent`.
...
<ParamField body="useScreen" type={<span>() =&gt; <a href="/es/docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/ScreenMembersOnCustomizedConsent">ScreenMembersOnCustomizedConsent</a></span>}>
  Este hook contiene detalles específicos de la pantalla `customized-consent`, incluida su configuración y contexto.
...
<ParamField body="useTransaction" type={<span>() =&gt; <a href="/es/docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/TransactionMembers">TransactionMembers</a></span>}>
  Este hook proporciona datos específicos de la transacción para la pantalla `customized-consent`, como las conexiones activas y el estado actual del flujo.
...
<ParamField body="useUntrustedData" type={<span>() =&gt; <a href="/es/docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/UntrustedDataMembers">UntrustedDataMembers</a></span>}>
  Este hook proporciona acceso a los datos no confiables que se pasan a la pantalla, como los parámetros precargados de la cadena de consulta de la URL.
...
<ParamField body="useCustomizedConsent" type={<a href="/es/docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/CustomizedConsentMembers">CustomizedConsentMembers</a>}>
  Este hook devuelve todos los métodos y el contexto disponibles en la pantalla `customized-consent`.
</ParamField>
...
<ParamField body="accept" type="Promise<void>">
  Este método registra el consentimiento del usuario y concede a la aplicación los permisos solicitados.
...
<ParamField body={<a href="/es/docs/libraries/acul/react-sdk/API-Reference/Hooks/useAuth0Themes">useAuth0Themes</a>} type="Hooks">
  Este hook obtiene las opciones del tema actual con la configuración plana desde el contexto de marca.
</ParamField>
...
<ParamField body={<a href="/es/docs/libraries/acul/react-sdk/API-Reference/Hooks/useErrors">useErrors</a>} type="Hooks">
  Este hook permite leer y administrar los errores de servidor, cliente y desarrollador en la pantalla.
</ParamField>