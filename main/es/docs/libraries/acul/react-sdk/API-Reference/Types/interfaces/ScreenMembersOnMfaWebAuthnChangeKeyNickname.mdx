...
export interface ScreenMembersOnMfaWebAuthnChangeKeyNickname extends ScreenMembers {
  /**
   * Datos específicos de la pantalla que contienen el apodo actual de la clave WebAuthn.
   * @type {{ nickname: string; } | null}
   */
  data: {
    /**
     * El apodo actual de la clave de seguridad WebAuthn que el usuario está a punto de cambiar.
     * Este valor debe mostrarse al usuario como referencia.
     * @type {string}
     * @example "My YubiKey"
