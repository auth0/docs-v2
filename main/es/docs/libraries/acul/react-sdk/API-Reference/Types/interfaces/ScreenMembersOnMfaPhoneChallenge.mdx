...
export interface ScreenMembersOnMfaPhoneChallenge extends ScreenMembers {
   ...
   * @property {string} data.phone_number - El número de teléfono (frecuentemente enmascarado) asociado con este desafío de MFA.
   */
  data: {
    /** El número de teléfono (frecuentemente enmascarado) asociado con este desafío de MFA. */
    phoneNumber: string;
  } | null;
}
```
