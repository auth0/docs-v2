---
description: Opciones de estilo y personalización para la apariencia de Lock.Swift
title: 'Lock.swift: Opciones de personalización del estilo'
---

A continuación, se enumeran numerosas opciones para configurar el estilo y la apariencia de Lock. Además, en la página [Opciones de configuración del comportamiento](/es/docs/libraries/lock-swift/lock-swift-configuration-options) también hay varias opciones disponibles para modificar el comportamiento y la funcionalidad de Lock.
...
El estilo de la barra de búsqueda de Lock <Tooltip tip="sin contraseña: forma de autenticación que no depende de una contraseña como primer factor." cta="Ver glosario" href="/es/docs/glossary?term=Passwordless">sin contraseña</Tooltip>.
