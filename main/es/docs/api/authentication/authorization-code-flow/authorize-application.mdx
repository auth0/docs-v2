...
description: "Inicie un flujo de autorización OAuth 2.0 enviando al usuario a la URL de autorización para obtener su consentimiento y un código de autorización."
---
