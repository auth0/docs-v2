...
description: "Verifica la autenticación multifactor (MFA) mediante un desafío fuera de banda (OOB), ya sea una notificación push, un SMS o una llamada de voz. Para verificar MFA con un OOB..."
---
