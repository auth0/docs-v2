...
description: "Una vez que tengas un código de verificación, usa este endpoint para iniciar sesión del usuario con su número de teléfono/correo electrónico y el código de verificación."
---
