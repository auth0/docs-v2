...
description: "Las conexiones sin contraseña no requieren que el usuario recuerde una contraseña. En su lugar, se utiliza otro mecanismo para comprobar la identidad, como un code de un solo uso enviado..."
---
