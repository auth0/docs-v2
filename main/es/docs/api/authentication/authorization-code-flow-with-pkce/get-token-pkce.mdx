...
description: "Este es el flujo que usan las aplicaciones móviles para acceder a una API. Use este endpoint para intercambiar un código de autorización por un token."
---
