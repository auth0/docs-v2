...
description: "Use este endpoint para invalidar un Token de actualización si se ha visto comprometido."
---
...
El comportamiento de este endpoint depende del estado del conmutador [Refresh Token Revocation Deletes Grant](https://auth0.com/docs/tokens/refresh-tokens/revoke-refresh-tokens#refresh-tokens-and-grants).
