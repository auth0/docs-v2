...
description: "Intercambie un código de autorización por un token de acceso después de que se redirija al usuario de vuelta a su URL de callback."
---
...
<ResponseSchema>
  <ResponseField name="access_token" type="string">
    Token de acceso para recursos protegidos.
  </ResponseField>
