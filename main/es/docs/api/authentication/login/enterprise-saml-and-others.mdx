...
description: "Puede conectar su servicio de Auth0 a un proveedor de identidad empresarial y permitir que sus usuarios inicien sesión en su aplicación mediante Microsoft Azure Active Directory, Google Workspace, Okta Workforce u otros proveedores compatibles..."
---
