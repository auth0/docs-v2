...
* Solicitud HTTP
* Comando de cURL
* JavaScript: según el endpoint, cada fragmento puede usar la [biblioteca Auth0.js](https://auth0.com/docs/libraries/auth0js), código de Node.js o JavaScript simple
