---
description: Aprenda a usar la Management API de Auth0 para gestionar los métodos de autenticación MFA de sus usuarios.
title: Gestionar métodos de autenticación con Management API
---
...
<Card title="Antes de comenzar">
  * Configure una [aplicación de máquina a máquina (M2M)](/es/docs/get-started/auth0-overview/create-applications/machine-to-machine-apps) y [otórguele acceso a la Management API de Auth0](/es/docs/secure/tokens/access-tokens/management-api-access-tokens/get-management-api-access-tokens-for-production) con los siguientes alcances:
...
La [Management API de Auth0](https://auth0.com/docs/api/management/v2) proporciona varios endpoints que puede usar para administrar los métodos de autenticación de <Tooltip tip="Autenticación multifactor (MFA): proceso de autenticación del usuario que utiliza un factor adicional al nombre de usuario y la contraseña, como un código por SMS." cta="Ver glosario" href="/es/docs/glossary?term=MFA">MFA</Tooltip> de sus usuarios.

Este método se basa en la autenticación mediante una aplicación confidencial. Para obtener más información sobre las aplicaciones confidenciales y públicas, consulte [Aplicaciones confidenciales y públicas](/es/docs/get-started/applications/confidential-and-public-applications).

<div id="get-all-authentication-methods">
  ## Obtener todos los métodos de autenticación
</div>

Usa el endpoint [Gets a list of authentication methods](https://auth0.com/docs/api/management/v2#!/Users/get_authentication_methods) para obtener una lista de todos los métodos de autenticación en los que un usuario se ha inscrito de forma total o parcial.
...
Para cada solicitud válida, la <Tooltip tip="Management API: Un producto que permite a los clientes realizar tareas administrativas." cta="Ver glosario" href="/es/docs/glossary?term=Management+API">Management API</Tooltip> devuelve una respuesta en formato JSON.
...
Utilice el endpoint [Obtiene un método de autenticación por ID](https://auth0.com/docs/api/management/v2#!/Users/get_authentication_methods_by_authentication_method_id) para obtener un método de autenticación individual de un usuario especificado por el ID del método de autenticación.
...
Permita que los usuarios usen claves de seguridad compatibles con FIDO (por ejemplo, [Yubikey](https://www.yubico.com/) o [Google Titan](https://cloud.google.com/titan-security-key)) para realizar la autenticación multifactor.
...
Use el endpoint [Updates all authentication methods by replacing them with the given ones](https://auth0.com/docs/api/management/v2#!/Users/put_authentication_methods) para sustituir todos los métodos de autenticación existentes por los proporcionados.
...
Usa el endpoint [Actualizar un método de autenticación](https://auth0.com/docs/api/management/v2#!/Users/patch_authentication_methods_by_authentication_method_id) para actualizar un método de autenticación individual de un usuario.
...
Use el endpoint [Elimina todos los métodos de autenticación del usuario especificado](https://auth0.com/docs/api/management/v2#!/Users/delete_authentication_methods) para eliminar todos los métodos de autenticación de un usuario.
...
Use el endpoint [Eliminar un método de autenticación por ID](https://auth0.com/docs/api/management/v2#!/Users/delete_authentication_methods_by_authentication_method_id) para eliminar un método de autenticación de un usuario.
...
* [Obtener tokens de acceso para producción de la Management API](/es/docs/secure/tokens/access-tokens/management-api-access-tokens/get-management-api-access-tokens-for-production)
