---
title: Referencia de parámetros de la Management API para las reglas de Tenant Access Control List
sidebarTitle: Parámetros de la API
description: Consulte las descripciones de todos los parámetros de los endpoints de Tenant ACL en la Management API.
---

Cuando administra Tenant Access Control List (ACL) con la [Management API](/es/docs/api/management/v2), los siguientes parámetros de las reglas definen su comportamiento.
