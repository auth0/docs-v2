---
description: Usa My Organization API para permitir que los administradores de Organización de Auth0 administren sus propios proveedores de identidad y dominios verificados desde dentro de tu aplicación.
sidebarTitle: My Organization API
title: My Organization API y componentes de UI integrables
