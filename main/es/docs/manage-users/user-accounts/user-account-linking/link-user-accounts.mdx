...
Puede usar la biblioteca de Auth0.js para realizar la vinculación de cuentas en el cliente. Lea [Referencia de Auth0.js &gt; User Management](/es/docs/libraries/auth0js#user-management) para obtener más información.
