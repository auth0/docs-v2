---
description: Ejemplos de perfiles de usuario.
title: Perfiles de usuario de muestra
---

<div id="google-user-profile">
  ## Perfil de usuario de Google
</div>

Este es un ejemplo de perfil de un usuario que inició sesión con **Google**:
...
<div id="microsoft-account-user-profile">
  ## Perfil de usuario de Microsoft Account
</div>

Este es un perfil de ejemplo de **Microsoft Account**:
...
<div id="office-365-user-profile">
  ## Perfil de usuario de Office 365
</div>

Este es un ejemplo de perfil de **Office 365 (Microsoft Azure Active Directory)**:
...
<div id="adfs-user-profile">
  ## Perfil de usuario de ADFS
</div>

Este es un ejemplo de perfil de **ADFS (Active Directory Federation Services)**:
