---
description: Aprenda a identificar de forma única a los usuarios.
...
Para las conexiones de base de datos [regulares](/es/docs/authenticate/database-connections/auth0-user-store) y [personalizadas](/es/docs/authenticate/database-connections/custom-db), evite crear `user_id` duplicados dentro de un inquilino para distintas conexiones de base de datos. Si prevé posibles colisiones entre ID de diferentes conexiones, debe usar un prefijo que identifique la conexión.
