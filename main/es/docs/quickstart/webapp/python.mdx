---
mode: wide
description: 'Añade la autenticación de Auth0 a una aplicación web de Flask con inicio de sesión, rutas protegidas y perfiles de usuario'
sidebarTitle: Flask
title: 'Añade el inicio de sesión a tu aplicación Flask'
---
...
<AccordionGroup>
  ...
  <Accordion title="Error de URL de callback inválida">
    **Problema:** Aparece el error &quot;Callback URL mismatch&quot; o &quot;invalid&#95;request&quot; durante el inicio de sesión
  ...
  <Accordion title="Token caducado o inválido">
    **Problema:** Aparece el error &quot;Token has expired&quot; o &quot;invalid&#95;token&quot;
