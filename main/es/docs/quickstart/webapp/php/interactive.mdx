---
mode: wide
description: Esta guía muestra cómo integrar Auth0, añadir autenticación y mostrar la información del perfil del usuario en cualquier aplicación PHP mediante el SDK de Auth0 para PHP.
sidebarTitle: PHP
