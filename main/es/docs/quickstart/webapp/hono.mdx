...
mode: wide
sidebarTitle: Hono
description: "Esta guía de inicio rápido muestra cómo proteger tus aplicaciones Hono con la autenticación de Auth0. Sigue los pasos para añadir inicio de sesión, cierre de sesión y rutas protegidas a una aplicación Hono."
---
