---
title: Agrega el inicio de sesión a tu aplicación Next.js
sidebarTitle: Next.js
description: Esta guía muestra cómo integrar Auth0 en cualquier aplicación Next.js nueva o existente mediante el SDK de Auth0 Next.js v4.
mode: wide
