---
mode: wide
description: Esta guía de inicio rápido muestra cómo agregar la autenticación de Auth0 a una aplicación Java Servlet. Creará una aplicación web segura con funciones de inicio de sesión, cierre de sesión y perfil de usuario mediante el SDK Auth0 Java MVC Commons.
sidebarTitle: Java
title: Agregue el inicio de sesión a su aplicación Java Servlet
---
...
<Accordion title="Solución de problemas">
  ...
  * Verifique que se use HTTPS en los entornos de producción
  ...
  Para obtener soporte adicional, visite la [Comunidad de Auth0](https://community.auth0.com/) o consulte el [Centro de soporte de Auth0](https://support.auth0.com/).
</Accordion>