...
* **[Agregar autorización](https://auth0.com/docs/quickstart/webapp/express/02-user-profile)** - Implementa el control de acceso basado en roles
* **[Llamar a API protegidas](https://auth0.com/docs/quickstart/webapp/express/03-authorization)** - Usa tokens de acceso para llamar a tus API de backend
