---
title: Agrega el inicio de sesión a tu aplicación de Vue
sidebarTitle: Vue
description: Esta guía muestra cómo integrar Auth0, agregar autenticación y mostrar información del perfil del usuario en cualquier aplicación de Vue mediante el SDK de Auth0 para Vue.
mode: wide
---
...
<Accordion title="Usa IA para integrar Auth0" icon="microchip-ai" iconType="solid" defaultOpen>
  ...
  **Luego, pídele a tu asistente de IA:**
  ...
  Tu asistente de IA creará automáticamente tu aplicación de Auth0, recuperará las credenciales, instalará `@auth0/auth0-vue`, creará el plugin de autenticación y configurará tus rutas. [Documentación completa sobre agent skills →](/es/docs/quickstart/agent-skills)
</Accordion>
...
<Note>
  ...
  **Compatibilidad de versiones de Vue:** Esta guía de inicio rápido funciona con **Vue 3.x** y versiones posteriores.
</Note>
...
<Steps>
  ...
  <Step title="Configura tu aplicación de Auth0" stepNumber={3}>
    A continuación, debes crear una nueva aplicación en tu inquilino de Auth0 y agregar las variables de entorno a tu proyecto.

    Tienes tres opciones para configurar tu aplicación de Auth0: usar la herramienta de configuración rápida (recomendado), ejecutar un comando de la CLI o configurarla manualmente desde el Dashboard:

    <Tabs>
      <Tab title="Configuración rápida (recomendado)">
      ...
      <Tab title="CLI">
        ...
        <Note>
          ...
          2. Creará una aplicación web de una sola página de Auth0 configurada para `http://localhost:5173`
      ...
      <Tab title="Dashboard">
        ...
        **Allowed Web Origins:**
        ...
        <Info>
          ...
          **Allowed Logout URLs** son esenciales para ofrecer una experiencia fluida al cerrar sesión. Sin una URL coincidente, los usuarios no serán redirigidos de vuelta a tu aplicación después de cerrar sesión y se quedarán en una página genérica de Auth0.
