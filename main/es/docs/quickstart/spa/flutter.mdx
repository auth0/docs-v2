---
mode: wide
description: Esta guía muestra cómo integrar Auth0 con una aplicación web de Flutter mediante el SDK de Auth0 para Flutter.
...
<Accordion title="Usa IA para integrar Auth0" icon="microchip-ai" iconType="solid" defaultOpen>
  Si usas un asistente de código con IA como Claude Code, Cursor o GitHub Copilot, puedes agregar la autenticación de Auth0 automáticamente en cuestión de minutos con [Agent Skills](https://agentskills.io/home).
  ...
  **Luego pídele a tu asistente de IA:**
  ...
  Tu asistente de IA creará automáticamente tu aplicación de Auth0, obtendrá las credenciales, agregará la dependencia del SDK auth0&#95;flutter, configurará web/index.html, establecerá las URL de devolución de llamada e implementará los flujos de Login/Logout. [Documentación completa de Agent Skills →](/es/quickstart/agent-skills)
</Accordion>

<Note>
  **Requisitos previos:** Antes de comenzar, asegúrate de tener instalado lo siguiente:

  * **[Flutter](https://flutter.dev/)** 3.0 o una versión posterior configurada para web
  * **[Dart](https://dart.dev/)** 2.17 o una versión posterior
  * Conocimientos básicos de la [CLI de Flutter](https://docs.flutter.dev/reference/flutter-cli)
...
<Steps>
  ...
  <Step title="Configura tu aplicación de Auth0" stepNumber={3}>
    A continuación, debes crear una nueva aplicación en tu inquilino de Auth0.
    ...
    <Tabs>
      ...
      <Tab title="Dashboard">
        ...
        2. Navega hasta **Applications** → **Applications** → **Create Application**
        ...
        <Info>
          **Allowed Callback URLs** es una medida de seguridad fundamental para garantizar que los usuarios regresen de forma segura a tu aplicación después de autenticarse.
  ...
  <Step title="Configura el SDK" stepNumber={4}>
    Cree una instancia de la clase `Auth0Web` con los valores de **dominio** e **ID de cliente** de Auth0.

    Cree un nuevo archivo: `lib/auth0_service.dart`
  ...
  <Step title="Crear la vista principal" stepNumber={5}>
...
<Check>
  **Comprobación**
  ...
  Ahora deberías tener una página de inicio de sesión de Auth0 completamente funcional ejecutándose en [http://localhost:3000](http://localhost:3000). Al:
...
<Accordion title="Manejo de errores de inicio de sesión">
...
<AccordionGroup>
  <Accordion title="Problemas comunes y soluciones">
    ...
    **Problema:** La URL de callback no coincide con la configurada en Auth0.

    **Solución:** Asegúrate de que la URL de callback en tu código coincida exactamente con la configurada en Auth0 Dashboard:
    ...
    **Problema:** La sesión del usuario no se mantiene entre recargas de la página.
    ...
    **Problema:** El estado no coincide durante el callback de autenticación.
    ...
    **Problema:** Errores de uso compartido de recursos entre orígenes cruzados.
...
* **[Inicio rápido para aplicaciones nativas con Flutter](/es/docs/quickstart/native/flutter/interactive)** - Cree una aplicación móvil nativa con Auth0
* **[Llamar a APIs protegidas](https://auth0.com/docs/secure/tokens/access-tokens)** - Use tokens de acceso para llamar a las API de su backend
* **[Personalizar Universal Login](https://auth0.com/docs/customize/universal-login-pages)** - Personalice la experiencia de inicio de sesión con su marca
* **[Agregar conexiones sociales](https://auth0.com/docs/connections/social)** - Habilite el inicio de sesión con Google, GitHub y otros proveedores sociales
* **[Implementar MFA](https://auth0.com/docs/secure/multi-factor-authentication)** - Agregue autenticación multifactor
...
* **[Documentación de Flutter](https://docs.flutter.dev/)** - Más información sobre Flutter
