---
mode: wide
description: Esta guía muestra cómo integrar Auth0, añadir autenticación y mostrar información del perfil de usuario en una aplicación de página única (SPA) que usa Svelte con el SDK Auth0 SPA JS.
sidebarTitle: Svelte
title: Añade Login a tu aplicación de Svelte
---
