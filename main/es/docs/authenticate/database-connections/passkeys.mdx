---
title: Autenticación con passkey en conexiones de base de datos
sidebarTitle: passkey
description: Obtén información sobre la implementación de passkey de Auth0, una credencial de dispositivo WebAuthn resistente al phishing con ventajas frente a los métodos de autenticación tradicionales.
---
