---
title: Habilitar y configurar la autenticación con claves de acceso para conexiones de base de datos
sidebarTitle: Configurar claves de acceso
description: Use el Auth0 Dashboard para habilitar las claves de acceso como método de autenticación en una conexión de base de datos y configurar la interfaz de usuario de autenticación con claves de acceso, la inscripción progresiva y la inscripción local.
---
