---
description: Proporciona un script de callback personalizado para quienes integran IBM DB2.
title: Script de inicio de sesión para IBM DB2
---

Si está integrando Auth0 con [IBM DB2](https://www.ibm.com/analytics/us/en/technology/db2), puede usar el siguiente script para el proceso de inicio de sesión.
