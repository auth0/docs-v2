...
Al solucionar problemas de SSO, suele ser útil capturar una traza HTTP de la interacción y guardarla en un archivo HAR. Para obtener más información, lea [Generar y analizar archivos HAR](https://support.auth0.com/center/s/article/generate-and-analyze-har-files-to-troubleshoot-auth0-issues).
