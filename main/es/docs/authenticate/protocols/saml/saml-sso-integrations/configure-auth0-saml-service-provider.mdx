...
* [Captura un archivo HAR](https://support.auth0.com/center/s/article/generate-and-analyze-har-files-to-troubleshoot-auth0-issues) de la transacción y, a continuación, usa la [herramienta SAML de Auth0](http://samltool.io/) para decodificar la aserción SAML e inspeccionar su contenido.