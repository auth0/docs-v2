...
#
description: Información sobre el objeto API del trigger custom-token-exchange de Actions.
title: 'Desencadenadores de Actions: custom-token-exchange - objeto API'
...
se rechace con el código de error &quot;invalid&#95;request&quot;.
...
Nota: La acción Custom Token Exchange debe llamar exactamente a una de estas opciones: `api.authentication.setUserByConnection` o `api.authentication.setUserById`.
  ...
  * `updateBehavior` - comportamiento que se aplicará si un usuario con el user&#95;id especificado ya existe en la conexión.
  ...
  <Expandable title="propiedades de options" defaultOpen>
    ...
    <ResponseField name="updateBehavior" type="string">
      Comportamiento que se aplicará si un usuario con el user&#95;id especificado ya existe en la conexión. Puede ser &#39;replace&#39;, lo que hará que los atributos del usuario existente se reemplacen por los atributos de usuario especificados; o &#39;none&#39;, lo que significa que el usuario existente no se modificará.
