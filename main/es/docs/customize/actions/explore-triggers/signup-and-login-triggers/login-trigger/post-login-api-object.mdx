...
Obtiene información sobre la pertenencia del usuario a grupos.

<div id="apigroupsgetusergroupsparams">
  ### `api.groups.getUserGroups(params)`
</div>

Obtiene la lista paginada de grupos a los que pertenece el usuario.
...
sobre los grupos que coinciden si el usuario es miembro.

<ResponseField name="groups" type="array de cadenas">
  * Un array de identificadores de grupo (ID o nombres) para comprobar la membresía.
</ResponseField>