...
#
description: Obtén información sobre el objeto de la API del trigger post-user-registration de Actions.
title: 'Actions Triggers: post-user-registration - Objeto de la API'
validatedOn: 2026-05-22
---

El objeto de la API del trigger post-user-registration de Actions incluye:
...
de `ttl` o `expires_at` especificados. Si no se especifica ninguna duración,
se usará una duración predeterminada de 15 minutos. La duración no puede superar la duración máxima
...
disponibles en transacciones posteriores, incluso si todavía están dentro del período de vigencia indicado.
