---
description: Obtén información sobre el flujo Machine to Machine de Actions y el disparador de Action credentials-exchange, que se ejecuta como parte del flujo Machine to Machine.
title: disparador de Machine to Machine
---
...
<Frame>![Diagrama que muestra el flujo Machine to Machine de Actions y cuándo se ejecutan los disparadores dentro de él.](/docs/images/cdy7uua7fh8z/1JPl54LFWCUh5StuglZS2o/41f89372526574c3b8cdac4d5ba38072/Machine_to_Machine_Flow.png)</Frame>
