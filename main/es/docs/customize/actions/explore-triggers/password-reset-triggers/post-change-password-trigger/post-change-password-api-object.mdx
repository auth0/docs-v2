...
#
description: Obtén información sobre el objeto de API del trigger post-change-password de Actions.
title: 'Triggers de Actions: post-change-password - Objeto de API'
validatedOn: 2026-05-22
---

El objeto de API del trigger post-change-password de Actions incluye:
...
Almacena o actualiza un valor de cadena en la caché bajo la clave especificada.
...
disponibles en transacciones posteriores aunque todavía estén dentro del período de vigencia especificado.
