...
#
description: Obtenga información sobre el objeto `event` del disparador post-change-password de Actions, que proporciona información contextual sobre la ejecución del disparador.
title: 'Disparadores de Actions: post-change-password - Objeto de evento'
validatedOn: 2026-05-25
---

El objeto `event` del disparador post-change-password de Actions proporciona información contextual sobre la ejecución del disparador.
...
<ResponseField name="event.authentication" type="dictionary" post={["optional"]}>
  Detalles sobre las señales de autenticación complementarias obtenidas durante el flujo de cambio de contraseña.
  ...
  <Expandable title="propiedades de authentication" defaultOpen>
    <ResponseField name="riskAssessment" type="dictionary" post={["optional"]}>
      Detalles sobre la información de evaluación de riesgos para distintos flujos.
                ...
                <ResponseField name="akamaiBot" type="object" post={["optional"]}>
                  ...
                  <Expandable title="propiedades de akamaiBot">
                    ...
                    <ResponseField name="botnetId" type="string" post={["optional"]}>
                      El ID de botnet del resultado de Akamai Bot Manager.
                    </ResponseField>
                  </Expandable>
                </ResponseField>
...
<ResponseField name="event.connection" type="dictionary">
  Detalles sobre la Conexión utilizada para la transacción actual.
...
<ResponseField name="event.transaction" type="object" post={["optional"]}>
  ...
  <Expandable title="propiedades de la transacción" defaultOpen>
    <ResponseField name="correlation_id" type="string" post={["optional"]}>
      El ID de correlación puede proporcionarse en la solicitud de autenticación inicial cuando la aplicación redirige a Universal Login. Puede usar este valor para correlacionar los registros y las solicitudes de su código de Action con el flujo del usuario.
    </ResponseField>
  </Expandable>
</ResponseField>
...
<ResponseField name="event.user" type="object">
  ...
  <Expandable title="propiedades del usuario" defaultOpen>
    ...
    <ResponseField name="last_password_reset" type="string" post={["optional"]}>
      Marca temporal que indica la última vez que se restableció o cambió la contraseña del usuario. Cuando se crea el usuario, este campo no existe. Esta propiedad solo está disponible para conexiones de base de datos.
    </ResponseField>
