...
<Callout icon="file-lines" color="#0EA5E9" iconType="regular">
  Para obtener más información sobre los límites de entidades, consulta: [Límites de entidades de Actions](/es/docs/troubleshoot/customer-support/operational-policies/entity-limit-policy#actions).
</Callout>
...
<Warning>
  ...
  *Si tu módulo de Action usa llamadas a la API de Node.js que están obsoletas en Node.js 22, las Actions que usan el runtime de Node.js 18 funcionarán sin problemas, pero las Actions que usan el runtime de Node.js 22 fallarán.*
</Warning>
...
* Cada ejecución de un trigger debe completarse en 20 segundos o menos; de lo contrario, el procesamiento finalizará con un error. Para no superar este límite de tiempo, es necesario limitar los procesos de larga duración, como las peticiones HTTP salientes sin un tiempo de espera configurado. Una Action que [redirige a los usuarios a una página externa](/es/docs/customize/actions/explore-triggers/signup-and-login-triggers/login-trigger/redirect-with-actions) tiene tiempos de espera independientes antes de la redirección y después de ella.
...
* Las llamadas realizadas a la <Tooltip tip="Security Assertion Markup Language (SAML): Protocolo estandarizado que permite a dos partes intercambiar información de autenticación sin una contraseña." cta="Ver glosario" href="/es/docs/glossary?term=Management+API">Management API</Tooltip> de Auth0 y las actualizaciones de metadatos de usuario están [sujetas a limitación de tasa](/es/docs/troubleshoot/customer-support/operational-policies/rate-limit-policy/management-api-endpoint-rate-limits).
* Las llamadas HTTP a servicios externos se originan en [estas direcciones IP](/es/docs/secure/security-guidance/data-security/allowlist).

<div id="transaction-metadata">
  ## Metadatos de la transacción
</div>

* Solo está disponible en las [Actions de post-login](/es/docs/customize/actions/explore-triggers/signup-and-login-triggers/login-trigger).
...
* [Comprenda cómo funcionan las Actions de Auth0](/es/docs/customize/actions/actions-overview)