---
description: Programa las Actions de tu proyecto con el paquete NPM @auth0/actions.
title: Actions NPM
---

El paquete NPM [**`@auth0/actions`**](https://www.npmjs.com/package/@auth0/actions) es la **biblioteca oficial de Actions** e incluye las **definiciones de TypeScript para Auth0 Actions**. Esto te permite programar y probar las Actions de tu proyecto en editores externos e IDE.

<Callout icon="file-lines" color="#0EA5E9" iconType="regular">
  El [**repositorio público `@auth0/actions`**](https://github.com/auth0/auth0-actions) proporciona acceso al código en el que se basa el paquete NPM.
</Callout>
...
<Tabs>
  ...
  <Tab title="TypeScript import">
    Use esta alternativa si desarrolla con TypeScript para obtener una comprobación de tipos completa y una sintaxis moderna:
...
Para obtener más información sobre el código de `@auth0/actions`, visita el [repositorio de Auth0 Actions](https://github.com/auth0/auth0-actions).
