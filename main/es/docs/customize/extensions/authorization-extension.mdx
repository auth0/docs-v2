...
Consulte nuestra página de [solución de problemas](/es/docs/troubleshoot/authentication-issues/troubleshoot-authorization-extension) para ver los problemas más comunes.
...
* [Resolver problemas de Authorization Extension](/es/docs/troubleshoot/authentication-issues/troubleshoot-authorization-extension)