...
* Un archivo HAR que registre todo el proceso, desde la carga de la página con el formulario de inicio de sesión hasta el mensaje &quot;Estado no válido&quot;. Para obtener más información sobre los archivos HAR, consulta [Generate and Analyze HAR Files](/es/docs/troubleshoot/troubleshooting-tools/generate-and-analyze-har-files).
