---
description: Aprende a rotar el secreto del cliente de una aplicación mediante el Dashboard de Auth0 o la Management API.
title: Rotar secretos del cliente
---
...
4. Consulta tu nuevo secreto; para ello, localiza **Secreto del cliente** y selecciona el ícono del ojo.
   ...
   <Frame>![Dashboard Applications: pestaña de configuración de la aplicación e información básica](/docs/images/cdy7uua7fh8z/2GPUw7BODYuYYH3658Upz3/92a49ec57e6b4d07be96093989baac03/2023-04-11_15-34-58.png)</Frame>
