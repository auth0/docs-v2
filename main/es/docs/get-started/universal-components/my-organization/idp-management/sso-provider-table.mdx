...
<Tabs>
  <Tab title="React">
    ...
    **Type:** `ComponentAction<IdentityProvider>`
    ...
    Controla la eliminación de un proveedor de la organización sin eliminarlo del inquilino. El proveedor sigue estando disponible para volver a agregarse más adelante.
    ...
    <table class="table">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>Modal de confirmación para eliminar la organización</td>
        </tr>
        ...
        <tr>
          ...
          <td>Componente para habilitar o deshabilitar</td>
        </tr>
  ...
  <Tab title="Next.js">
    ...
    <table class="table">
      ...
      <tbody>
        <tr>
          ...
          <td>
            <strong>Obligatorio.</strong> Navega a la página para crear el proveedor.
          </td>
        </tr>
        ...
        <tr>
          ...
          <td>
            <strong>Obligatorio.</strong> Navega a la página para editar el proveedor.
          </td>
        </tr>
      </tbody>
    </table>
    ...
    **Type:** `ComponentAction<IdentityProvider>`
    ...
    La prop `editAction` es obligatoria porque controla a dónde se redirige a los usuarios cuando hacen clic en una fila de proveedor. El callback recibe los datos del proveedor para que puedas navegar a la página de edición correspondiente.
    ...
    **Type:** `ComponentAction<IdentityProvider>`
    ...
    Controla la eliminación permanente de un proveedor SSO. Esta operación es destructiva: el proveedor se elimina por completo del tenant de Auth0.
    ...
    **schema**
    ...
    Define reglas de validación personalizadas para los diálogos de confirmación (por ejemplo, escribir el nombre del proveedor para confirmar la eliminación).

    <Accordion title="Campos del esquema disponibles">
      Todos los campos del esquema admiten: `regex`, `errorMessage`

      **delete.providerName** - Confirmación para eliminar permanentemente
    ...
    <table class="table">
      ...
      <tbody>
        <tr>
          ...
          <td>Fila de proveedor con acciones</td>
        </tr>
        ...
        <tr>
          ...
          <td>Modal de confirmación para la eliminación de la organización</td>
        </tr>
        ...
        <tr>
          ...
          <td>Interruptor para habilitar o deshabilitar</td>
        </tr>
    ...
    <table class="table">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>Estado de interacción de la UI y controladores (modales, acciones)</td>
        </tr>
      </tbody>
    </table>
  </Tab>
