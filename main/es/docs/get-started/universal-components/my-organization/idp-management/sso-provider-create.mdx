...
description: Asistente paso a paso para crear proveedores de SSO con selección de proveedor, configuración de detalles y configuración de autenticación
---
...
<Tabs>
  ...
  <Tab title="shadcn">
    ...
    <Callout icon="file-lines" color="#0EA5E9" iconType="regular">
      **Se requiere configuración en Auth0** - Asegúrese de que su inquilino esté configurado con la
      API My Organization. [Ver la guía de configuración
      →](/es/docs/get-started/universal-components/my-organization/build-delegated-admin#configure-auth0-dashboard)
    </Callout>
