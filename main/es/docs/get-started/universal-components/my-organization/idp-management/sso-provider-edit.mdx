---
title: Edición del proveedor de SSO
...
El componente `SsoProviderEdit` ofrece una interfaz unificada para editar proveedores de [Single Sign-On](/es/docs/authenticate/enterprise-connections/self-service-enterprise-configuration).

<ComponentLoader componentSelector="sso-provider-edit" componentPreviewText="Vista previa del componente de edición de proveedores de SSO" />
...
<Tabs>
  <Tab title="React">
    ...
    <Accordion title="Ejemplo de integración completa">
      ```tsx
    ...
    <table class="table">
      ...
      <tbody>
        <tr>
          ...
          <td>
            <strong>Obligatorio.</strong> ID del proveedor de SSO que se va a editar.
          </td>
        </tr>
      </tbody>
    </table>
    ...
    <table class="table">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            Acciones de la pestaña de SSO. <a href="#sso-tab-actions">Detalles</a>
          </td>
        </tr>
    ...
    <table class="table">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            Elimina el proveedor permanentemente.
          </td>
        </tr>
    ...
    **Type:** `ComponentAction<IdentityProvider, IdentityProvider>`
    ...
    Controla el guardado de cambios en la configuración del proveedor (ID de cliente, secretos, certificados, etc.).
    ...
    **Type:** `ComponentAction<IdentityProvider>`
    ...
    Controla la eliminación del proveedor de la organización sin borrarlo. El proveedor seguirá disponible para volver a añadirse más adelante.
    ...
    **Type:** `ComponentAction<IdentityProvider, CreateIdPProvisioningConfigResponseContent>`
    ...
    Habilita el aprovisionamiento SCIM para el proveedor. Una vez habilitado, puedes generar un token SCIM para que lo use tu proveedor de identidad.
    ...
    **Type:** `ComponentAction<IdentityProvider, CreateIdpProvisioningScimTokenResponseContent>`
    ...
    Genera un nuevo token SCIM de portador para que tu proveedor de identidad se autentique con Auth0.
    ...
    <table class="table">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            Verifica la titularidad del dominio.
          </td>
        </tr>
    ...
    **schema**
    ...
    <Accordion title="Campos de esquema disponibles">
      ...
      **provider.*** - Campos de configuración del proveedor según la estrategia
    ...
    **styling**
    ...
    Personaliza la apariencia con variables CSS y sobreescritura de clases. Compatible con estilos según el tema.
    ...
    <table class="table">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>Gestión del aprovisionamiento de SCIM</td>
        </tr>
        ...
        <tr>
          ...
          <td>Visualización del token de SCIM con función de copia</td>
        </tr>
      </tbody>
    </table>
    ...
    <table class="table">
      ...
      <tbody>
        <tr>
          ...
          <td>Lógica de carga y actualización del proveedor</td>
        </tr>
  ...
  <Tab title="Next.js">
    ...
    <Callout icon="file-lines" color="#0EA5E9" iconType="regular">
      **Se requiere configurar Auth0** - Asegúrate de que tu tenant esté configurado con la
    ...
    <table class="table">
      ...
      <tbody>
        <tr>
          ...
          <td>
            <strong>Obligatorio.</strong> El ID del proveedor de SSO que deseas editar.
          </td>
        </tr>
      </tbody>
    </table>
    ...
    * `disabled` - Deshabilita el botón Guardar
    * `onBefore(provider)` - Se ejecuta antes de la actualización. Devuelve `false` para impedir que se guarde (p. ej., para mostrar un cuadro de diálogo de confirmación).
    * `onAfter(provider, result)` - Se ejecuta después de que el proveedor se haya actualizado correctamente. Úsalo para mostrar una notificación o hacer un seguimiento del evento.
    ...
    ***
    ...
    La propiedad `provisioning` configura las acciones para la pestaña de aprovisionamiento SCIM. Esta pestaña administra el aprovisionamiento automatizado de usuarios mediante el protocolo SCIM.
    ...
    <table class="table">
      ...
      <tbody>
        <tr>
          ...
          <td>
            Habilita el aprovisionamiento de SCIM.
          </td>
        </tr>
        ...
        <tr>
          ...
          <td>
            Deshabilita el aprovisionamiento de SCIM.
          </td>
        </tr>
    ...
    **Type:** `ComponentAction<IdentityProvider, CreateIdPProvisioningConfigResponseContent>`
    ...
    Habilita el aprovisionamiento SCIM para el proveedor. Una vez habilitado, puedes generar un token SCIM para tu proveedor de identidad.
    ...
    <table class="table">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            Personalizaciones de texto de i18n.
          </td>
        </tr>
    ...
    ***
    ...
    El componente `SsoProviderEdit` está compuesto por subcomponentes y hooks más pequeños. Puedes importarlos de forma individual para crear flujos de trabajo personalizados de edición de proveedores.
    ...
    <table class="table">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>Campos de formulario dinámicos por estrategia</td>
        </tr>
        ...
        <tr>
          ...
          <td>Visualización del token SCIM con opción de copia</td>
        </tr>
      </tbody>
    </table>
    ...
    <table class="table">
      ...
      <tbody>
        <tr>
          ...
          <td>Lógica para cargar y actualizar el proveedor</td>
        </tr>
  ...
  <Tab title="shadcn">
    ...
    <Callout icon="file-lines" color="#0EA5E9" iconType="regular">
      Al ejecutar el comando de shadcn, también se instala la dependencia @auth0/universal-components-core para utilidades compartidas y la integración con Auth0.
    </Callout>
    ...
    <table class="table">
      ...
      <tbody>
        <tr>
          ...
          <td>
            <strong>Obligatorio.</strong> El ID del proveedor de SSO que quieres editar.
          </td>
        </tr>
      </tbody>
    </table>
    ...
    * `disabled` - Desactiva el botón de guardar
    * `onBefore(provider)` - Se ejecuta antes de la actualización. Devuelve `false` para impedir que se guarde (p. ej., para mostrar un cuadro de diálogo de confirmación).
    * `onAfter(provider, result)` - Se ejecuta después de que el proveedor se haya actualizado correctamente. Úsalo para mostrar una notificación o hacer seguimiento del evento.
    ...
    **styling**
    ...
    Personaliza la apariencia con variables CSS y sobreescritura de clases. Compatible con estilos adaptados al tema.
    ...
    ***
    ...
    El componente `SsoProviderEdit` está compuesto por subcomponentes y hooks más pequeños. Puedes importarlos individualmente para crear flujos de trabajo personalizados de gestión de proveedores SSO si utilizas shadcn.
    ...
    <table class="table">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>Pestaña de asociaciones de dominio</td>
        </tr>
      </tbody>
    </table>
    ...
    <table class="table">
      ...
      <tbody>
        <tr>
          ...
          <td>Lógica para cargar y editar el proveedor</td>
        </tr>
        ...
        <tr>
          ...
          <td>Estado de las pestañas y manejadores de acciones</td>
        </tr>
      </tbody>
    </table>
  </Tab>
