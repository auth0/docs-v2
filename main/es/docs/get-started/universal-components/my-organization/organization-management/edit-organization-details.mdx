...
description: Edita los detalles de la organización, incluidos el nombre, el nombre para mostrar, los colores de marca y el logotipo.
---

import Spinner from "/snippets/es/Spinner.jsx";
import { ComponentLoader } from "/snippets/es/ComponentLoader.jsx";

El componente `OrganizationDetailsEdit` proporciona una interfaz unificada para editar los datos de su [organización](/es/docs/manage-users/organizations).

<ComponentLoader componentSelector="organization-details-edit" componentPreviewText="Vista previa del componente Organization Details Edit" />
...
<Tabs>
  <Tab title="React">
    ...
    <Callout icon="file-lines" color="#0EA5E9" iconType="regular">
      **Configuración de Auth0 requerida** - Asegúrese de que su inquilino tenga configurada la
    ...
    **Type:** `ComponentAction<OrganizationPrivate>`
    ...
    Controla el flujo de guardado cuando los usuarios envían cambios en la organización. Usa `onAfter` para redirigir al usuario tras un guardado exitoso.
    ...
    **Type:** `ComponentAction<OrganizationPrivate>`
    ...
    Controla el flujo de cancelación/descarte. Usa esta acción para gestionar los cambios descartados.
    ...
    **Type:** `{ icon?: LucideIcon; onClick: (e: MouseEvent) => void }`
    ...
    Configura el botón de retroceso en el encabezado del componente. Úsalo para volver a la descripción general de tu organización o a la página anterior.
    ...
    **customMessages**
    ...
    Personaliza todos los textos y traducciones. Todos los campos son opcionales y, si no se especifican, se usan los valores predeterminados.
    ...
    <table class="table">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>Campo de selección del color de la marca</td>
        </tr>
        ...
        <tr>
          ...
          <td>Campo de URL del logotipo con vista previa</td>
        </tr>
      </tbody>
    </table>
    ...
    <table class="table">
      ...
      <tbody>
        <tr>
          ...
          <td>Lógica de edición de organizaciones e integración con la API</td>
        </tr>
      </tbody>
    </table>
  </Tab>
  ...
  <Tab title="Next.js">
    ...
    <Callout icon="file-lines" color="#0EA5E9" iconType="regular">
      **Se requiere configuración de Auth0** - Asegúrese de que su inquilino tenga configurada la
      API My Organization. [Ver la guía de configuración
    ...
    **Type:** `ComponentAction<OrganizationPrivate>`
    ...
    Controla el flujo de guardado cuando los usuarios envían cambios en la organización. Usa `onAfter` para navegar a otra página tras guardar correctamente.
    ...
    ***
    ...
    Para casos de uso avanzados, puede importar subcomponentes individuales para crear interfaces de edición de organización personalizadas.
    ...
    <table class="table">
      ...
      <tbody>
        <tr>
          ...
          <td>Componente de formulario principal con todos los campos</td>
        </tr>
  ...
  <Tab title="shadcn">
    ...
    <Callout icon="file-lines" color="#0EA5E9" iconType="regular">
      **Se requiere la configuración de Auth0** - Asegúrese de que su inquilino tenga configurada la
      API My Organization. [Ver la guía de configuración
      →](/es/docs/get-started/universal-components/my-organization/build-delegated-admin#configure-auth0-dashboard)
    </Callout>
