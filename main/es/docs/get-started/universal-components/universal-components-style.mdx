---
title: Personalice el estilo y los temas con Auth0 Universal Components
description: Personalice el sistema de diseño de Auth0 Universal Components con Tailwind CSS, variables CSS y preajustes de tema integrados.
sidebarTitle: Personalizar estilo y temas
---
...
<Warning>
  ...
  Suscripción de Okta](https://www.okta.com/agreements/). Para obtener más
  información, consulte [Etapas de lanzamiento del
  producto](/es/docs/troubleshoot/product-lifecycle/product-release-stages).
</Warning>

Auth0 Universal Components se basa en un sistema de diseño flexible que utiliza [Tailwind CSS](https://tailwindcss.com/docs/installation/using-vite) y [primitivas de Radix UI](https://www.radix-ui.com/primitives/docs/overview/introduction). La personalización de estilos se gestiona mediante [`Auth0ComponentProvider`](/es/docs/get-started/universal-components/auth0-component-provider), lo que le permite elegir entre preajustes generales o ajustes detallados de variables CSS.
...
<Tabs>
  ...
  <Tab title="Next.js">
    ...
    <Callout icon="file-lines" color="#0EA5E9" iconType="regular">
      ...
      **Usuarios de Shadcn:** No es necesario importar nada; los estilos ya están incluidos en su compilación de Tailwind.
    </Callout>

    2. Agregue el color de su marca.
    ...
    <table class="table">
      ...
      <tbody>
        <tr>
          ...
          <td>Estilo estándar de Auth0 con sombras y bordes equilibrados</td>
        </tr>
        ...
        <tr>
          ...
          <td>Menos peso visual, con menos sombras y bordes más sutiles</td>
        </tr>
    ...
    ***
    ...
    Todas las propiedades visuales están controladas por propiedades personalizadas de CSS. Puedes sobreescribirlas en tu hoja de estilos o a través de la prop `themeSettings.variables`.
    ...
    ***
    ...
    Cada componente acepta una prop `styling` para sobrescrituras específicas sin afectar los estilos globales.
    ...
    * `variables` - sobrescrituras de propiedades personalizadas de CSS con alcance limitado al componente
    * `classes` - Clases de Tailwind o clases personalizadas aplicadas a partes específicas del componente

    <Accordion title="Clases disponibles por componente">
      Cada componente expone clases objetivo para sus secciones principales:
    ...
    ***
    ...
    Convierte el color hexadecimal de tu marca al formato de CSS:
  ...
  <Tab title="shadcn">
    ...
    Con Shadcn, los estilos ya están incluidos en tu compilación de Tailwind. No es necesario realizar importaciones adicionales.
    ...
    ***
    ...
    Pasa `themeSettings` a `Auth0ComponentProvider` para alternar entre temas integrados.
    ...
    <table class="table">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>Menor carga visual, con menos sombras y bordes más sutiles</td>
        </tr>
        ...
        <tr>
          ...
          <td>Mayor redondeo de los bordes para una apariencia más suave</td>
        </tr>
      </tbody>
    </table>
    ...
    ***
    ...
    Cada componente acepta una prop `styling` para sobrescribir estilos de forma específica sin afectar los estilos globales.
