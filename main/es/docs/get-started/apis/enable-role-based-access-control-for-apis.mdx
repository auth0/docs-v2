---
description: Aprenda a habilitar el control de acceso basado en roles (RBAC) para una API mediante Auth0 Dashboard o la Management API.
title: Habilitar el control de acceso basado en roles para APIs
---
