...
* **Habilitar RBAC**: Habilite esta configuración para que se apliquen las políticas de RBAC a la API. Para obtener más información, consulte [Control de acceso basado en roles](/es/docs/manage-users/access-control/rbac) y [Habilitar el control de acceso basado en roles para las API](/es/docs/get-started/apis/enable-role-based-access-control-for-apis). Si necesita ayuda para solucionar problemas, consulte [Solucionar problemas del control de acceso basado en roles y la autorización](/es/docs/troubleshoot/authentication-issues/troubleshoot-rbac-authorization).
...
Para obtener ayuda con la solución de problemas, revise [Verifique las llamadas a la API](/es/docs/troubleshoot/authentication-issues/check-api-calls).
