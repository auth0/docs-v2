...
<QuickstartButtons githubLink="https://github.com/auth0-samples/auth0-aspnet-owin-webapi-samples/tree/master/Quickstart/Sample" downloadLink="https://auth0.auth0.com/u/login/"/>
  ...
  <Content>
    ...
    **New to Auth0?** Learn how Auth0 works and
    ...
    <Section id={sections[1].id} title={sections[1].title} stepNumber="2">
      ...
      <AuthCodeBlock icon="file-code" language="ps" lines="true">
