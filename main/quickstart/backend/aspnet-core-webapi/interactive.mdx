...
<QuickstartButtons githubLink="https://github.com/auth0-samples/auth0-aspnetcore-webapi-samples/tree/master/Quickstart/01-Authorization" downloadLink="https://auth0.auth0.com/u/login/"/>
