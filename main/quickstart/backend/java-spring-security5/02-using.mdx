...
<CodeGroup>
<AuthCodeBlock filename="Bash" icon="file-code" language="bash" lines="true">
...
[* Part 3: Troubleshooting Your API](/quickstart/backend/java-spring-security5/03-troubleshooting)
