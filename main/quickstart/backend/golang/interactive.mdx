...
<QuickstartButtons githubLink="https://github.com/auth0-samples/auth0-golang-api-samples/tree/master/01-Authorization-RS256" downloadLink="https://auth0.auth0.com/u/login/"/>
  ...
  <Content>
    ...
    **New to Auth0?** Learn how Auth0 works and
    ...
    <Section id={sections[1].id} title={sections[1].title} stepNumber="2">
      ...
      <AuthCodeBlock icon="file-code" language="mod" lines="true">
