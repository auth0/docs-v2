...
mode: wide
description: This guide demonstrates how to integrate Auth0 with a Flutter application
...
<<<<<<< HEAD:main/docs/quickstart/spa/flutter/index.mdx
      ```js
...
>>>>>>> aec509f5 (chore: removes docs folder to remove /docs from url):main/quickstart/spa/flutter/index.mdx
