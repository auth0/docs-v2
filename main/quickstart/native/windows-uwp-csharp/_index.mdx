...
<Recipe isSingleColumn>
  <Content>
    ...
    <Section id={sections[3].id} title={sections[3].title} stepNumber="4" isSingleColumn>
      ...
      This loads the Auth0 login page into a web view. You can learn how to customize the login page at [this document](/authenticate/login/auth0-universal-login#simple-customization).
