...
'og:title': 'Auth0 MAUI SDK Quickstarts: Add Login to Your MAUI Application'
...
'twitter:description': This tutorial demonstrates how to add user login with Auth0
  to a .NET MAUI application.
'twitter:title': 'Auth0 MAUI SDK Quickstarts: Add Login to Your MAUI Application'
---
...
<QuickstartButtons githubLink="https://github.com/auth0-samples/auth0-maui-samples/tree/master/Sample" downloadLink="https://auth0.auth0.com/u/login/"/>
