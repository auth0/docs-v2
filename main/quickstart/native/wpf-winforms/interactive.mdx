...
<QuickstartButtons githubLink="https://github.com/auth0-samples/auth0-WinFormsWPF-oidc-samples/tree/master/Quickstart/00-Starter-Seed" downloadLink="https://auth0.auth0.com/u/login/"/>
