...
<QuickstartButtons githubLink="https://github.com/auth0-samples/auth0-react-native-sample/tree/master/00-Login" downloadLink="https://auth0.auth0.com/u/login/"/>
...
<Recipe>
  <Content>
    ...
    <Section id={sections[2].id} title={sections[2].title} stepNumber="3">
      ...
      <AuthCodeBlock icon="file-code" language="groovy" lines="true">
      AUTH0_SECRET='use [openssl rand -hex 32] to generate a 32 bytes value'
      APP_BASE_URL='http://localhost:3000'
      AUTH0_DOMAIN='https://{USER_DOMAIN}'
      AUTH0_CLIENT_ID='{USER_CLIENT_ID}'
    ...
    <Section id={sections[3].id} title={sections[3].title} stepNumber="4">
      ...
      <AuthCodeBlock icon="file-code" language="jsx" lines="true">
      AUTH0_SECRET='use [openssl rand -hex 32] to generate a 32 bytes value'
      APP_BASE_URL='http://localhost:3000'
      AUTH0_DOMAIN='https://{USER_DOMAIN}'
      AUTH0_CLIENT_ID='{USER_CLIENT_ID}'
