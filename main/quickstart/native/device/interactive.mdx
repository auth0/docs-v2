...
<Recipe>
  <Content>
    ...
    <Section id={sections[6].id} title={sections[6].title} stepNumber="7">
      ...
      ID tokens contain user information that must be [decoded and extracted](/secure/tokens/id-tokens#id-token-payload). The Authentication API
    ...
    <Section id={sections[11].id} title={sections[11].title} stepNumber="12">
      ...
      - Have the [Authentication Method](/secure/application-credentials#application-authentication-methods) set to **None**
