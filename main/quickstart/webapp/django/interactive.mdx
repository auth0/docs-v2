...
mode: wide
description: This guide demonstrates how to integrate Auth0 with a Python Django
  application using the Authlib SDK.
'og:image': https://cdn2.auth0.com/docs/1.14553.0/img/share-image.png
'og:title': 'Auth0 Django SDK Quickstarts: Add Login to your Django Application'
...
'twitter:title': 'Auth0 Django SDK Quickstarts: Add Login to your Django Application'
---
...
<QuickstartButtons githubLink="https://github.com/auth0-samples/auth0-django-web-app/tree/master/01-Login" downloadLink="https://auth0.auth0.com/u/login/"/>
