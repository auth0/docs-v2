...
mode: wide
description: This guide demonstrates how to integrate Auth0, add authentication,
  and display user profile information in any PHP application using the Auth0 PHP
  SDK.
'og:image': https://cdn2.auth0.com/docs/1.14553.0/img/share-image.png
'og:title': 'Auth0 PHP SDK Quickstarts: Add Login to Your PHP Application'
...
'twitter:description': This guide demonstrates how to integrate Auth0, add authentication,
  and display user profile information in any PHP application using the Auth0 PHP
  SDK.
'twitter:title': 'Auth0 PHP SDK Quickstarts: Add Login to Your PHP Application'
---
...
<QuickstartButtons githubLink="https://github.com/auth0-samples/auth0-php-web-app/tree/main/app" downloadLink="https://auth0.auth0.com/u/login/"/>
