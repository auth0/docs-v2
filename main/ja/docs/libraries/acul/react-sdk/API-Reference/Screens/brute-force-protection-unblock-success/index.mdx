...
description: "Universal Login の `brute-force-protection-unblock-success` 画面をカスタマイズするために使用できる、すべてのフックとメソッドについて説明します。"
---

`brute-force-protection-unblock-success` 画面は、総当たり攻撃対策によるロックアウトの後、ユーザーがアカウントのブロック解除に成功すると表示されます。

<Frame>
  <img style={{maxHeight:"400px"}} src="/docs/images/cdy7uua7fh8z/ACUL/brute-force-protection-unblock-success.png" alt="ACUL 総当たり攻撃対策のブロック解除成功" />
</Frame>
...
<ParamField body="useClient" type={<span>() =&gt; <a href="/ja/docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/ClientMembers">ClientMembers</a></span>}>
  このフックは、`brute-force-protection-unblock-success` 画面に関する `id`、`name`、`logoUrl` などのクライアント関連の設定を提供します。
...
<ParamField body="useScreen" type={<span>() =&gt; <a href="/ja/docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/ScreenMembersOnBruteForceProtectionUnblockSuccess">ScreenMembersOnBruteForceProtectionUnblockSuccess</a></span>}>
...
<ParamField body="useBruteForceProtectionUnblockSuccess" type={<a href="/ja/docs/libraries/acul/react-sdk/API-Reference/Types/interfaces/BruteForceProtectionUnblockSuccessMembers">BruteForceProtectionUnblockSuccessMembers</a>}>
