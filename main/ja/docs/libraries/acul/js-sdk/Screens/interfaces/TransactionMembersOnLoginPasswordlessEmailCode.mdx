...
<ParamField body="alternateConnections" type={<span><a href="/docs/libraries/acul/js-sdk/Screens/interfaces/Connection">接続</a></span>} />
...
<ParamField body="currentConnection" type={<span><a href="/docs/libraries/acul/js-sdk/Screens/interfaces/Connection">接続</a></span>} />
