...
<ParamField body="screen" type={<span><a href="/ja/docs/libraries/acul/js-sdk/Screens/interfaces/ScreenMembersOnEmailOTPChallenge">ScreenMembersOnEmailOTPChallenge</a></span>} />
...
<ParamField body="resendCode" type="Promise<void>">
  ...
  <Expandable title="パラメータ">
    <ParamField body="options?" type={<span><a href="/ja/docs/libraries/acul/js-sdk/Screens/interfaces/CustomOptions">CustomOptions</a></span>}>
...
<ParamField body="submitCode" type="Promise<void>">
  ...
  <Expandable title="パラメータ">
    <ParamField body="options" type={<span><a href="/ja/docs/libraries/acul/js-sdk/Screens/interfaces/OtpCodeOptions">OtpCodeOptions</a></span>}>
      送信時に含める省略可能なパラメータです。
