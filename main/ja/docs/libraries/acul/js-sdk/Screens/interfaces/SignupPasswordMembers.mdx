...
<ParamField body="federatedSignup" type="Promise<void>">
  <Expandable title="パラメータ">
    <ParamField body="payload" type={<span><a href="/ja/docs/libraries/acul/js-sdk/Screens/interfaces/FederatedSignupPasswordPayloadOptions">FederatedSignupPasswordPayloadOptions</a></span>}>
      **プロパティ**
...
<ParamField body="signup" type="Promise<void>">
  <Expandable title="パラメータ">
    <ParamField body="payload" type={<span><a href="/ja/docs/libraries/acul/js-sdk/Screens/interfaces/SignupPasswordOptions">SignupPasswordOptions</a></span>}>
      **プロパティ**
