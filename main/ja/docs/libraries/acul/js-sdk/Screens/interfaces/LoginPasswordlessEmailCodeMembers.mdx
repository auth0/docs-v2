---
title: "ログインパスワードレスメールアドレスcodeメンバー"
---
...
<ParamField body="submitCode" type="Promise<void>">
  <Expandable title="パラメーター">
    <ParamField body="payload" type={<span><a href="/ja/docs/libraries/acul/js-sdk/Screens/interfaces/SubmitCodeOptions">SubmitCodeOptions</a></span>}>
      **プロパティ**
