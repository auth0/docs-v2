...
<ParamField body="data" type={<span><a href="/ja/docs/libraries/acul/js-sdk/Screens/interfaces/PhonePrefix">PhonePrefix</a></span>}>
  #### 型宣言

  &#123; `phone_prefixes`: [`PhonePrefix`](/ja/docs/libraries/acul/js-sdk/Screens/interfaces/PhonePrefix)[]; &#125;
