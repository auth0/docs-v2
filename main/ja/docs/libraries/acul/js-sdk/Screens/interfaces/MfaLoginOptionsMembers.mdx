...
mfa-login-options 画面で使用可能なメソッドとプロパティを定義するインターフェイス
...
<ParamField body="enroll" type="Promise<void>">
  ...
  <Expandable title="パラメーター">
    <ParamField body="payload" type={<span><a href="/ja/docs/libraries/acul/js-sdk/Screens/interfaces/LoginEnrollOptions">LoginEnrollOptions</a></span>}>
      選択した認証要素を指定するオプション
