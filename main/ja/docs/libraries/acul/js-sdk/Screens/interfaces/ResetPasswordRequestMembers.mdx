...
<ParamField body="resetPassword" type="Promise<void>">
  <Expandable title="パラメータ">
    <ParamField body="payload" type={<span><a href="/ja/docs/libraries/acul/js-sdk/Screens/interfaces/ResetPasswordRequestOptions">ResetPasswordRequestOptions</a></span>}>
      **プロパティ**
