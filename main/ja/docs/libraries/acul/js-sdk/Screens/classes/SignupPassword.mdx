...
description: "Universal Login の `signup-password` 画面をカスタマイズするために使用できるプロパティとメソッドをすべて説明します。"
---

SignupPassword クラスは、`signup-password` 画面の機能を実装します。この画面では、ユーザーがパスワードを入力します。
...
SignupPassword 画面マネージャーのインスタンスを作成します：
...
<ParamField body="client" type={<span><a href="/ja/docs/libraries/acul/js-sdk/Screens/interfaces/ClientMembers">ClientMembers</a></span>}>
  `signup-password` 画面の `id`、`name`、`logoUrl` など、クライアント関連の設定を提供します。
</ParamField>
...
<ParamField body="screen" type={<span><a href="/ja/docs/libraries/acul/js-sdk/Screens/interfaces/ScreenMembersOnSignupPassword">ScreenMembersOnSignupPassword</a></span>}>
...
<ParamField body="transaction" type={<span><a href="/ja/docs/libraries/acul/js-sdk/Screens/interfaces/TransactionMembersOnSignupPassword">TransactionMembersOnSignupPassword</a></span>}>
  ...
  **メソッドパラメーター**
  ...
  <Expandable title="パラメーター">
    ...
    <ParamField body="[`key`: `string`]" type="&#x22;string&#x22; | &#x22;number&#x22; | &#x22;boolean&#x22; | &#x22;undefined&#x22;">
      `ulp-` を接頭辞とする追加のカスタムフィールドです (例: `'ulp-custom-field'`) 。
    </ParamField>
  </Expandable>
</ParamField>

<ParamField body="federatedSignup" type="Promise<void>">
  このメソッドでは、Google や Facebook などの各種ソーシャル ID を使ってサインアップできます。
  ...
  **メソッドパラメーター**
  ...
  <Expandable title="パラメーター">
    ...
    <ParamField body="captcha?" type="string">
      キャプチャのコード、またはキャプチャプロバイダーからのレスポンスです。Auth0 テナントで [Bot Detection](/ja/docs/secure/attack-protection/bot-detection) が有効になっている場合、このプロパティは必須です。
    </ParamField>
...
<ParamField body="switchConnection" type="Promise<void>">
  このメソッドは、signup-password フロー中に認証接続を切り替えます。
  ...
  **メソッドパラメーター**
  ...
  <Expandable title="パラメーター">
    <ParamField body="options">
      [SwitchConnectionOptionsSignupPassword](/ja/docs/libraries/acul/js-sdk/Screens/interfaces/SwitchConnectionOptionsSignupPassword)。
    </ParamField>
