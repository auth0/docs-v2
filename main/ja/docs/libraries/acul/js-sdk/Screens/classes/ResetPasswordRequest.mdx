...
ResetPasswordRequest 画面マネージャーのインスタンスを生成します。
...
<ParamField body="client" type={<span><a href="/ja/docs/libraries/acul/js-sdk/Screens/interfaces/ClientMembers">ClientMembers</a></span>}>
  `reset-password-request` 画面向けの、`id`、`name`、`logoUrl` などのクライアント関連の構成を提供します。
</ParamField>
...
<ParamField body="screen" type={<span><a href="/ja/docs/libraries/acul/js-sdk/Screens/interfaces/ScreenMembersOnResetPasswordRequest">ScreenMembersOnResetPasswordRequest</a></span>}>
  設定やコンテキストなど、`reset-password-request` 画面固有の詳細を含みます。
</ParamField>
...
<ParamField body="transaction" type={<span><a href="/ja/docs/libraries/acul/js-sdk/Screens/interfaces/TransactionMembersOnResetPasswordRequest">TransactionMembersOnResetPasswordRequest</a></span>}>
  アクティブな識別子やフローの状態など、`reset-password-request` 画面のトランザクション固有のデータを提供します。
</ParamField>
...
<ParamField body="untrustedData" type={<span><a href="/ja/docs/libraries/acul/js-sdk/Screens/interfaces/UntrustedDataMembers">UntrustedDataMembers</a></span>}>
  パスワードリセット要求フロー中のユーザー入力など、SDK に渡される信頼できないデータを含みます。
</ParamField>
...
<ParamField body="getLoginIdentifiers" type={<span><a href="/ja/docs/libraries/acul/js-sdk/Screens/type-aliases/ScreenIdentifierType">ScreenIdentifierType</a>[]</span>}>
  このメソッドは、`reset-password-request` 画面に設定されている有効な識別子タイプ (`username` や `email` など) を返します。
  ...
  **メソッドパラメーター**
  ...
  <Expandable title="パラメーター">
    ...
    <ParamField body="username" type="string" required>
      リセット対象のアカウントの username またはメールアドレス。
    </ParamField>
