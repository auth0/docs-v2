...
description: "Universal Login の `mfa-otp-challenge` 画面をカスタマイズするために利用できる、すべてのプロパティとメソッドについて説明します。"
---

MfaOtpChallenge クラスは、`mfa-otp-challenge` 画面の機能を実装します。この画面は、MFA でユーザーが OTP コードを入力する必要がある場合に表示されます。
...
MFA OTP Challenge画面マネージャーのインスタンスを作成します。
...
<ParamField body="client" type={<span><a href="/ja/docs/libraries/acul/js-sdk/Screens/interfaces/ClientMembers">ClientMembers</a></span>}>
  `mfa-otp-challenge` 画面の `id`、`name`、`logoUrl` など、クライアントに関する構成を提供します。
</ParamField>
...
<ParamField body="screen" type={<span><a href="/ja/docs/libraries/acul/js-sdk/Screens/interfaces/ScreenMembersOnMfaOtpChallenge">ScreenMembersOnMfaOtpChallenge</a></span>}>
  設定やコンテキストなど、`mfa-otp-challenge` 画面に固有の詳細が含まれます。
</ParamField>
...
<ParamField body="transaction" type={<span><a href="/ja/docs/libraries/acul/js-sdk/Screens/interfaces/TransactionMembers">TransactionMembers</a></span>}>
  アクティブな識別子やフローの状態など、`mfa-otp-challenge` 画面のトランザクション固有のデータを提供します。
</ParamField>

<ParamField body="untrustedData" type={<span><a href="/ja/docs/libraries/acul/js-sdk/Screens/interfaces/UntrustedDataMembersOnMfaOtpChallenge">UntrustedDataMembersOnMfaOtpChallenge</a></span>}>
...
<ParamField body="continue" type="Promise<void>">
  このメソッドは、指定された code を使用して OTP チャレンジを続行します。
  ...
  **メソッド パラメーター**
  ...
  <Expandable title="パラメーター">
    <ParamField body="options">
      [ContinueOTPOptions](/ja/docs/libraries/acul/js-sdk/Screens/interfaces/ContinueOTPOptions)。
    </ParamField>

    <ParamField body="code" type="string" required>
      ユーザーが入力した OTP コード です。
    </ParamField>
