...
MFA Recovery Code Challenge New Code 画面マネージャーのインスタンスを作成します：
...
<ParamField body="client" type={<span><a href="/ja/docs/libraries/acul/js-sdk/Screens/interfaces/ClientMembers">ClientMembers</a></span>}>
  `mfa-recovery-code-challenge-new-code` 画面で使用される、`id`、`name`、`logoUrl` などのクライアント関連の設定を提供します。
</ParamField>
...
<ParamField body="screen" type={<span><a href="/ja/docs/libraries/acul/js-sdk/Screens/interfaces/ScreenMembersOnMfaRecoveryCodeChallengeNewCode">ScreenMembersOnMfaRecoveryCodeChallengeNewCode</a></span>}>
  設定やコンテキストを含む、`mfa-recovery-code-challenge-new-code` 画面固有の詳細を含みます。
</ParamField>
...
<ParamField body="transaction" type={<span><a href="/ja/docs/libraries/acul/js-sdk/Screens/interfaces/TransactionMembers">TransactionMembers</a></span>}>
  アクティブな識別子やフローの状態など、`mfa-recovery-code-challenge-new-code` 画面に固有のトランザクションデータを提供します。
</ParamField>
...
<ParamField body="untrustedData" type={<span><a href="/ja/docs/libraries/acul/js-sdk/Screens/interfaces/UntrustedDataMembers">UntrustedDataMembers</a></span>}>
  MFA リカバリー code チャレンジ中のユーザー入力など、SDK に渡される未検証データを扱います。
</ParamField>
