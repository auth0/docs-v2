...
デバイスやリカバリーコードを紛失したユーザーの MFA をリセットする方法については、[Reset Multi-Factor Authentication and Recovery Codes](/ja/docs/secure/multi-factor-authentication/reset-user-mfa) を参照してください。追加のサポートが必要な場合は、[Troubleshooting Multi-Factor Authentication Issues](/ja/docs/troubleshoot/authentication-issues/troubleshoot-mfa-issues) を参照してください。
