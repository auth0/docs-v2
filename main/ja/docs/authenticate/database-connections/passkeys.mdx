...
sidebarTitle: パスキー
description: 認証方法としてのパスキーと、Auth0 での動作について説明します。
---

import { ReleaseStageNotice } from "/snippets/ja/ReleaseStageNotice.jsx"

パスキーは、[FIDO2 (WebAuthn および CTAP) 標準](https://en.wikipedia.org/wiki/WebAuthn)に基づく、安全なパスワードレス認証方式です。従来の ID/パスワード認証と比べて、次のような利点があります。
