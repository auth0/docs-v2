---
description: IBM DB2 と連携する場合に使用するカスタムコールバックスクリプトを提供します。
title: IBM DB2 用ログインスクリプト
---

Auth0 を [IBM DB2](https://www.ibm.com/analytics/us/en/technology/db2) と連携する場合は、ログイン処理に次のスクリプトを使用できます。
