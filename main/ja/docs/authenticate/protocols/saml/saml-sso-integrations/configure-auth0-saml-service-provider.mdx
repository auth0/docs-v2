...
* トランザクションの [HAR ファイルを取得](https://support.auth0.com/center/s/article/generate-and-analyze-har-files-to-troubleshoot-auth0-issues) し、[Auth0 SAML Tool](http://samltool.io/) を使用して SAML アサーションをデコードして内容を確認してください。