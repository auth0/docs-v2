---
description: Workday 用の SAML2 Web App アドオンを使用して、Auth0 を IDプロバイダーとして設定する方法を説明します。
title: Workday を SAML サービスプロバイダーとして設定する
---

Workday には、次の <Tooltip tip="Security Assertion Markup Language (SAML): パスワードを使用せずに 2 者間で認証情報を交換できるようにする標準化されたプロトコル。" cta="用語集を表示" href="/ja/docs/glossary?term=SAML">SAML</Tooltip> 設定を使用します。
