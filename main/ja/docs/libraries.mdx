...
links: [
  ...
  { label: "クイックスタート", url: "/docs/quickstart/spa/react/interactive" },
],
}}
  />
...
links: [
  ...
  { label: "クイックスタート", url: "/docs/quickstart/spa/vuejs/interactive" },
],
}}
  />
...
links: [
  ...
  { label: "クイックスタート", url: "/docs/quickstart/spa/angular/interactive" },
],
}}
  />
...
links: [
  ...
  { label: "クイックスタート", url: "/docs/quickstart/spa/vanillajs/interactive" },
],
}}
  />
...
links: [
  ...
  { label: "クイックスタート", url: "/docs/quickstart/spa/flutter/interactive" },
],
}}
  />
</Columns>
...
<div id="regular-web-application-sdk-libraries">
  ## 従来型 Web アプリケーション向け SDK ライブラリ
</div>

サーバー上で動作する従来型の Web アプリケーションをお使いですか？Auth0 では、主要な言語と環境向けに、これらの SDK ライブラリを提供しています。
...
links: [
  ...
  { label: "サンプルアプリ", url: "https://github.com/auth0-samples/auth0-acul-samples" },
  { label: "利用を開始", url: "/docs/libraries/acul/js-sdk" }
],
}}
  />
...
links: [
  ...
  { label: "サンプルアプリ", url: "https://github.com/auth0-samples/auth0-acul-samples" },
  { label: "利用を開始", url: "/docs/libraries/acul/react-sdk" }
],
}}
  />
</Columns>
...
links: [
  ...
  { label: "利用を開始", url: "/docs/libraries/lock-android" }
],
}}
  />
...
links: [
  ...
  { label: "利用を開始", url: "/docs/libraries/lock-ios" }
],
}}
  />
...
links: [
  ...
  { label: "利用を開始", url: "/docs/libraries/lock" }
],
}}
  />
</Columns>