...
title: Lock のパスワードオプションの翻訳をカスタマイズする
---

独自のコードで、以下の Lock パスワード機能の翻訳をカスタマイズできます。

* パスワード強度
* パスワード履歴
* Change Password ウィジェット

これらの機能をカスタマイズするには、Change Password ウィジェットライブラリのバージョン 1.1 以降を含める必要があります。

`<script src="https://cdn.auth0.com/js/change-password-1.1.min.js"></script>`

各 Lock パスワード機能のテキストを翻訳するには、次のコードを追加し、すべての文字列を目的の言語のテキストに置き換えます。
