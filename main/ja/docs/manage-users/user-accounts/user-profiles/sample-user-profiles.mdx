---
description: ユーザープロファイルの例。
title: ユーザープロファイルのサンプル
---
...
これは、**Google** 経由でログインしたユーザーのプロファイルのサンプルです:
...
<div id="microsoft-account-user-profile">
  ## Microsoft Account ユーザープロファイル
</div>

以下は、**Microsoft Account** のユーザープロファイル例です。
...
<div id="office-365-user-profile">
  ## Office 365 のユーザープロファイル
</div>

これは、**Office 365 (Microsoft Azure Active Directory)** のサンプルユーザープロファイルです。
...
以下は、**ADFS (Active Directory Federation Services)** のユーザープロファイル例です。
