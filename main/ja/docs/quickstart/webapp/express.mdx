...
* **[認可を追加する](https://auth0.com/docs/quickstart/webapp/express/02-user-profile)** - ロールベースアクセス制御を実装します
* **[保護された API を呼び出す](https://auth0.com/docs/quickstart/webapp/express/03-authorization)** - アクセストークンを使用してバックエンド API を呼び出します
